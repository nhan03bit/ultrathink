 ...
 */
export function encodeAAAK(content, opts = {}) {
 ...
 */
export function formatAdaptationsAAAK(adaptations) {
  ...
  const lines = [`☸ TEKIŌ(${adaptations.length}spins)`];
  // Group by category
 ...
 */
export function formatRecallAAAK(memories) {
