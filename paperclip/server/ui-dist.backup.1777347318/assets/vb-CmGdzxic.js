...
var b = new RegExp("^[\\+\\-\\*/%&\\\\|\\^~<>!]"),
  ...
  m = new RegExp("^((\\+=)|(\\-=)|(\\*=)|(%=)|(/=)|(&=)|(\\|=)|(\\^=))"),
  I = new RegExp("^((//=)|(>>=)|(<<=)|(\\*\\*=))"),
  R = new RegExp("^[_A-Za-z][_A-Za-z0-9]*"),
  a = [
    "class",
    "module",
    "sub",
  ...
  f = ["else", "elseif", "case", "catch", "finally"],
  h = ["next", "loop"],
  s = ["and", "andalso", "or", "orelse", "xor", "in", "not", "is", "isnot", "like"],
  O = o(s),
  v = [
    "#const",
    "#else",
...
function d(e, n) {
  ...
  return e.match(C)
    ? ((n.tokenize = F(e.current())), n.tokenize(e, n))
    : e.match(I) || e.match(m)
      ? null
      : e.match(x) || e.match(b) || e.match(O)
        ? "operator"
        : e.match(k)
          ? null
          : e.match(T)
            ? (l(e, n), (n.doInCurrentLine = !0), "keyword")
            : e.match(S)
              ? (n.doInCurrentLine ? (n.doInCurrentLine = !1) : l(e, n), "keyword")
              : e.match(g)
                ? "keyword"
                : e.match(w)
                  ? (c(e, n), c(e, n), "keyword")
...
const L = {
  name: "vb",
  startState: function () {
    return { tokenize: d, lastToken: null, currentIndent: 0, nextLineIndent: 0, doInCurrentLine: !1 };
  },
  token: function (e, n) {
  ...
  indent: function (e, n, i) {
    ...
    return r.match(y) || r.match(w) || r.match(g)
      ? i.unit * (e.currentIndent - 1)
      : e.currentIndent < 0
        ? 0
        : e.currentIndent * i.unit;
  },
  languageData: {
