var t = ["exten", "same", "include", "ignorepat", "switch"],
  o = ["#include", "#exec"],
  c = [
    "addqueuemember",
    "adsiprog",
  ...
  if (n.blockComment)
    return (
      a == "-" && e.match("-;", !0)
        ? (n.blockComment = !1)
        : e.skipTo("--;")
          ? (e.next(), e.next(), e.next(), (n.blockComment = !1))
          : e.skipToEnd(),
      "comment"
    );
  if (a == ";")
  ...
  token: function (e, n) {
    ...
    if (n.extenStart)
      return (
        ...
        (i = e.current()),
        /^=>?$/.test(i)
          ? ((n.extenExten = !0), (n.extenStart = !1), "strong")
          : ((n.extenStart = !1), e.skipToEnd(), "error")
      );
    if (n.extenExten)
      return (
        (n.extenExten = !1),
        (n.extenPriority = !0),
        e.eatWhile(/[^,]/),
        n.extenInclude && (e.skipToEnd(), (n.extenPriority = !1), (n.extenInclude = !1)),
        n.extenSame && ((n.extenPriority = !1), (n.extenSame = !1), (n.extenApplication = !0)),
        "tag"
      );
    if (n.extenPriority)
      return (
        (n.extenPriority = !1),
        (n.extenApplication = !0),
        e.next(),
        n.extenSame ? null : (e.eatWhile(/[^,]/), "number")
      );
