import { L as s } from "./index-BCpNKgwK.js";
import { s as n, t as r, a as o, L as P, i as Q, c as a, f as i, j as c } from "./index-BSvjNLKU.js";
const g = n({
    String: r.string,
    Number: r.number,
    "True False": r.bool,
...
const u = P.define({
  name: "json",
  parser: p.configure({
    props: [Q.add({ Object: a({ except: /^\s*\}/ }), Array: a({ except: /^\s*\]/ }) }), i.add({ "Object Array": c })],
  }),
...
export { T as json, u as jsonLanguage, d as jsonParseLinter };
