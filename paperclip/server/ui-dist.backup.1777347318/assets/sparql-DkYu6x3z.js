...
const m = {
  ...
  token: function (n, e) {
    ...
    if (
      (t != "comment" && e.context && e.context.align == null && e.context.type != "pattern" && (e.context.align = !0),
      u == "(")
    )
      o(e, ")", n.column());
      ...
      u == "." && e.context && e.context.type == "pattern"
        ? c(e)
