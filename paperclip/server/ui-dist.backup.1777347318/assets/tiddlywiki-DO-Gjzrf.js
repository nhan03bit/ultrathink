...
function i(e, t) {
  ...
  if (((t.block = !1), r && /[<\/\*{}\-]/.test(n))) {
    if (e.match(S)) return ((t.block = !0), o(e, t, u));
  ...
  if (
    /[hf]/i.test(n) &&
    /[ti]/i.test(e.peek()) &&
    e.match(/\b(ttps?|tp|ile):\/\/[\-A-Z0-9+&@#\/%?=~_|$!:,.;]*[A-Z0-9+&@#\/%=~_|$]/i)
  )
    return "link";
  if (n == '"') return "string";
  ...
  return n == "'" && e.eat("'")
    ...
    : n == "<" && e.eat("<")
      ? o(e, t, T)
      : (e.eatWhile(/[\w\$_]/), c.propertyIsEnumerable(e.current()) ? "keyword" : null);
}
function z(e, t) {
...
function u(e, t) {
  ...
  return r && e.current()
    ? "comment"
    : (!r && e.match($)) || (r && e.sol() && e.match(y))
      ? ((t.tokenize = i), "comment")
      : (e.next(), "comment");
}
function W(e, t) {
  for (var r = !1, n; (n = e.next()); ) {
...
function T(e, t) {
  ...
  return r
    ? r == ">" && e.peek() == ">"
      ? (e.next(), (t.tokenize = i), "meta")
      : (e.eatWhile(/[\w\$_]/), l.propertyIsEnumerable(e.current()) ? "keyword" : null)
    : ((t.tokenize = i), null);
}
const m = {
  name: "tiddlywiki",
