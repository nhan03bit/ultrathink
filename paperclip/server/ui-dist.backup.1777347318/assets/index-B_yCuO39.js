...
import { E as me, L as ue } from "./index-BCpNKgwK.js";
const pe = 36,
  X = 1,
  fe = 2,
  b = 3,
  ...
  e: for (;;) {
    ...
    if (t.next == 36) {
      ...
      for (let a = 0; a < e.length; a++) {
        if (t.next != e.charCodeAt(a)) continue e;
        t.advance();
      }
      if (t.next == 36) {
        t.advance();
...
function Ue(t, e) {
  let a = "[{<(".indexOf(String.fromCharCode(e)),
    r = a < 0 ? e : "]}>)".charCodeAt(a);
  for (;;) {
    if (t.next < 0) return;
...
function P(t, e) {
  for (; !(t.next != 95 && !q(t.next)); ) (e != null && (e += String.fromCharCode(t.next)), t.advance());
  return e;
}
function Le(t) {
...
function Z(t, e) {
  ...
  if (t.next == 69 || t.next == 101)
    for (t.advance(), (t.next == 43 || t.next == 45) && t.advance(); t.next >= 48 && t.next <= 57; ) t.advance();
}
function N(t) {
  for (; !(t.next < 0 || t.next == 10); ) t.advance();
}
function _(t, e) {
  for (let a = 0; a < e.length; a++) if (e.charCodeAt(a) == t) return !0;
  return !1;
}
const S = ` 	\r
`;
function M(t, e, a) {
  ...
  ((r.true = r.false = _e), (r.null = r.unknown = ge));
  for (let n of t.split(" ")) n && (r[n] = E);
  for (let n of e.split(" ")) n && (r[n] = W);
  for (let n of (a || "").split(" ")) n && (r[n] = Te);
  return r;
}
const h =
...
function Be(t, e, a, r) {
  let n = {};
  for (let s in T) n[s] = (t.hasOwnProperty(s) ? t : T)[s];
  return (e && (n.words = M(e, a || "", r)), n);
}
function K(t) {
  return new me((e) => {
    var a;
    let { next: r } = e;
    if ((e.advance(), _(r, S))) {
      for (; _(e.next, S); ) e.advance();
      e.acceptToken(pe);
    } else if (r == 36 && t.doubleDollarQuotedStrings) {
      let n = P(e, "");
      e.next == 36 && (e.advance(), je(e, n), e.acceptToken(b));
    } else if (r == 39 || (r == 34 && t.doubleQuotedStrings)) (g(e, r, t.backslashEscapes), e.acceptToken(b));
    else if ((r == 35 && t.hashComments) || (r == 47 && e.next == 47 && t.slashComments)) (N(e), e.acceptToken(X));
    else if (r == 45 && e.next == 45 && (!t.spaceAfterDashes || e.peek(1) == 32)) (N(e), e.acceptToken(X));
      ...
      e.acceptToken(fe);
    } else if ((r == 101 || r == 69) && e.next == 39) (e.advance(), g(e, 39, !0), e.acceptToken(b));
    else if ((r == 110 || r == 78) && e.next == 39 && t.charSetCasts)
      (e.advance(), g(e, 39, t.backslashEscapes), e.acceptToken(b));
    ...
    else if (t.plsqlQuotingMechanism && (r == 113 || r == 81) && e.next == 39 && e.peek(1) > 0 && !_(e.peek(1), S)) {
      let n = e.peek(1);
      (e.advance(2), Ue(e, n), e.acceptToken(b));
    } else if (_(r, t.identifierQuotes)) {
      const n = r == 91 ? 93 : r;
      (g(e, n, !1), e.acceptToken(qe));
    } else if (r == 40) e.acceptToken(he);
    else if (r == 41) e.acceptToken(ye);
    else if (r == 123) e.acceptToken(be);
    else if (r == 125) e.acceptToken(ve);
    else if (r == 91) e.acceptToken(ke);
    else if (r == 93) e.acceptToken(xe);
    else if (r == 59) e.acceptToken(Oe);
    else if (t.unquotedBitLiterals && r == 48 && e.next == 98) (e.advance(), D(e), e.acceptToken(R));
    else if ((r == 98 || r == 66) && (e.next == 39 || e.next == 34)) {
      const n = e.next;
      (e.advance(),
        t.treatBitsAsBytes ? (g(e, n, t.backslashEscapes), e.acceptToken(Pe)) : (D(e, n), e.acceptToken(R)));
    } else if ((r == 48 && (e.next == 120 || e.next == 88)) || ((r == 120 || r == 88) && e.next == 39)) {
      let n = e.next == 39;
      for (e.advance(); ze(e.next); ) e.advance();
      (n && e.next == 39 && e.advance(), e.acceptToken(C));
    } else if (r == 46 && e.next >= 48 && e.next <= 57) (Z(e, !0), e.acceptToken(C));
    else if (r == 46) e.acceptToken(we);
    else if (r >= 48 && r <= 57) (Z(e, !1), e.acceptToken(C));
    else if (_(r, t.operatorChars)) {
      for (; _(e.next, t.operatorChars); ) e.advance();
      e.acceptToken(Qe);
    } else if (_(r, t.specialVar)) (e.next == r && e.advance(), Le(e), e.acceptToken(Se));
    else if (r == 58 || r == 44) e.acceptToken(Ce);
    else if (q(r)) {
      let n = P(e, String.fromCharCode(r));
      e.acceptToken(
        e.next == 46 || e.peek(-n.length - 1) == 46
          ? I
          : (a = t.words[n.toLowerCase()]) !== null && a !== void 0
            ? a
            : I
      );
    }
...
function x(t, e) {
  let a = t.sliceString(e.from, e.to),
    r = /^([`'"\[])(.*)([`'"\]])$/.exec(a);
  return r ? r[2] : a;
}
function Q(t) {
...
function Ie(t, e) {
  if (e.name == "CompositeIdentifier") {
    let a = [];
    for (let r = e.firstChild; r; r = r.nextSibling) Q(r) && a.push(x(t, r));
    return a;
  }
  return [x(t, e)];
}
function V(t, e) {
  for (let a = []; ; ) {
    if (!e || e.name != ".") return a;
    let r = z(e);
    if (!Q(r)) return a;
    (a.unshift(x(t, r)), (e = z(r)));
  }
}
function Re(t, e) {
  let a = de(t).resolveInner(e, -1),
    r = Ze(t.doc, a);
  return a.name == "Identifier" || a.name == "QuotedIdentifier" || a.name == "Keyword"
    ? {
        from: a.from,
        quoted: a.name == "QuotedIdentifier" ? t.doc.sliceString(a.from, a.from + 1) : null,
        parents: V(t.doc, z(a)),
        aliases: r,
      }
    : a.name == "."
      ? { from: e, quoted: null, parents: V(t.doc, a), aliases: r }
      : { from: e, quoted: null, parents: [], empty: !0, aliases: r };
}
const De = new Set("where group having order union intersect except all distinct limit offset fetch for".split(" "));
function Ze(t, e) {
  let a;
  for (let n = e; !a; n = n.parent) {
    if (!n) return null;
    n.name == "Statement" && (a = n);
  }
  let r = null;
  for (let n = a.firstChild, s = !1, c = null; n; n = n.nextSibling) {
    let l = n.name == "Keyword" ? t.sliceString(n.from, n.to).toLowerCase() : null,
      o = null;
    if (!s) s = l == "from";
    else if (l == "as" && c && Q(n.nextSibling)) o = x(t, n.nextSibling);
    else {
      if (l && De.has(l)) break;
      c && Q(n) && (o = x(t, n));
    }
    (o && (r || (r = Object.create(null)), (r[o] = Ie(t, c))), (c = /Identifier$/.test(n.name) ? n : null));
  }
  return r;
}
function Ne(t, e, a) {
  return a.map((r) => ({ ...r, label: r.label[0] == t ? r.label : t + r.label + e, apply: void 0 }));
}
const Ve = /^\w*$/,
  $e = /^[`'"\[]?\w*[`'"\]]?$/;
function $(t) {
...
class j {
  ...
  child(e) {
    let a = this.children || (this.children = Object.create(null)),
      r = a[e];
    return (
      r ||
      (e && !this.list.some((n) => n.label == e) && this.list.push(A(e, "type", this.idQuote, this.idCaseInsensitive)),
      (a[e] = new j(this.idQuote, this.idCaseInsensitive)))
    );
  }
  maybeChild(e) {
  ...
  addCompletion(e) {
    let a = this.list.findIndex((r) => r.label == e.label);
    a > -1 ? (this.list[a] = e) : this.list.push(e);
  }
  addCompletions(e) {
    for (let a of e)
      this.addCompletion(typeof a == "string" ? A(a, "property", this.idQuote, this.idCaseInsensitive) : a);
  }
  addNamespace(e) {
    Array.isArray(e) ? this.addCompletions(e) : $(e) ? this.addNamespace(e.children) : this.addNamespaceObject(e);
  }
  addNamespaceObject(e) {
    for (let a of Object.keys(e)) {
      let r = e[a],
        n = null,
        s = a.replace(/\\?\./g, (l) => (l == "." ? "\0" : l)).split("\0"),
        c = this;
      $(r) && ((n = r.self), (r = r.children));
      for (let l = 0; l < s.length; l++)
        (n && l == s.length - 1 && c.addCompletion(n), (c = c.child(s[l].replace(/\\\./g, "."))));
      c.addNamespace(r);
    }
  }
}
function A(t, e, a, r) {
  return new RegExp("^[a-z_][a-z_\\d]*$", r ? "i" : "").test(t)
    ? { label: t, type: e }
    : { label: t, type: e, apply: a + t + G(a) };
}
function G(t) {
  return t === "[" ? "]" : t;
}
function Ae(t, e, a, r, n, s) {
  var c;
  let l = ((c = s == null ? void 0 : s.spec.identifierQuotes) === null || c === void 0 ? void 0 : c[0]) || '"',
    o = new j(l, !!(s != null && s.spec.caseInsensitiveIdentifiers)),
    u = n ? o.child(n) : null;
  return (
    o.addNamespace(t),
    e && (u || o).addCompletions(e),
    a && o.addCompletions(a),
    u && o.addCompletions(u.list),
    r && o.addCompletions((u || o).child(r).list),
    (p) => {
      let { parents: v, from: L, quoted: B, empty: ee, aliases: O } = Re(p.state, p.pos);
      if (ee && !p.explicit) return null;
      O && v.length == 1 && (v = O[v[0]] || v);
      let d = o;
      for (let f of v) {
        for (; !d.children || !d.children[f]; )
          if (d == o && u) d = u;
          else if (d == u && r) d = d.child(r);
          else return null;
        let k = d.maybeChild(f);
        if (!k) return null;
        d = k;
      }
      let w = d.list;
      if ((d == o && O && (w = w.concat(Object.keys(O).map((f) => ({ label: f, type: "constant" })))), B)) {
        let f = B[0],
          k = G(f),
          te = p.state.sliceDoc(p.pos, p.pos + 1) == k;
        return { from: L, to: te ? p.pos + 1 : void 0, options: Ne(f, k, w), validFor: $e };
      } else return { from: L, options: w, validFor: Ve };
    }
  );
}
function Ee(t) {
  return t == W ? "type" : t == E ? "keyword" : "variable";
}
function We(t, e, a) {
  let r = Object.keys(t).map((n) => a(e ? n.toUpperCase() : n, Ee(t[n])));
  return le(["QuotedIdentifier", "String", "LineComment", "BlockComment", "."], ce(r));
}
let Me = Xe.configure({
  props: [
    ne.add({ Statement: ie() }),
    ...
    oe({
      ...
      String: i.string,
      Identifier: i.name,
      QuotedIdentifier: i.special(i.string),
      SpecialVar: i.special(i.name),
      LineComment: i.lineComment,
      BlockComment: i.blockComment,
      Operator: i.operator,
      "Semi Punctuation": i.punctuation,
      "( )": i.paren,
      "{ }": i.brace,
      "[ ]": i.squareBracket,
    }),
...
class m {
  constructor(e, a, r) {
    ((this.dialect = e), (this.language = a), (this.spec = r));
  }
  get extension() {
    return this.language.extension;
  }
  configureLanguage(e, a) {
    return new m(this.dialect, this.language.configure(e, a), this.spec);
  }
  static define(e) {
    let a = Be(e, e.keywords, e.types, e.builtin),
      r = re.define({
        name: "sql",
        parser: Me.configure({ tokenizers: [{ from: F, to: K(a) }] }),
        languageData: {
...
function Fe(t, e = !1, a) {
  return We(t.dialect.words, e, a || Ke);
}
function Ge(t) {
  return t.schema ? Ae(t.schema, t.tables, t.schemas, t.defaultTable, t.defaultSchema, t.dialect || U) : () => null;
}
function Ye(t) {
  return t.schema ? (t.dialect || U).language.data.of({ autocomplete: Ge(t) }) : [];
}
function tt(t = {}) {
  let e = t.dialect || U;
  return new ae(e.language, [
    Ye(t),
    e.language.data.of({ autocomplete: Fe(e, t.upperCaseKeywords, t.keywordCompletion) }),
  ]);
}
const U = m.define({}),
  rt = m.define({
  ...
  J = "charset clear edit ego help nopager notee nowarning pager print prompt quit rehash source status system tee",
  at = m.define({
    operatorChars: "*+-%<>!=&|^",
    charSetCasts: !0,
  ...
  nt = m.define({
    ...
    specialVar: "@?",
    identifierQuotes: "`",
    keywords: y + "always generated groupby_concat hard persistent shutdown soft virtual " + Y,
    types: H,
    builtin: J,
  });
let He =
...
const it = m.define({
  ...
  ot = m.define({
    ...
    types: h + "ascii bigint blob counter frozen inet list map static text timeuuid tuple uuid varint",
    slashComments: !0,
  }),
  lt = m.define({
    keywords:
...
export {
  ...
  st as SQLite,
  U as StandardSQL,
  Fe as keywordCompletionSource,
  Ge as schemaCompletionSource,
  tt as sql,
};
