var d = { term: !0, method: !0, accu: !0, rule: !0, then: !0, is: !0, and: !0, or: !0, if: !0, default: !0 },
  f = { var_input: !0, var_output: !0, fuzzify: !0, defuzzify: !0, function_block: !0, ruleblock: !0 },
  o = { end_ruleblock: !0, end_defuzzify: !0, end_function_block: !0, end_fuzzify: !0, end_var: !0 },
  p = { true: !0, false: !0, nan: !0, real: !0, min: !0, max: !0, cog: !0, cogs: !0 },
  l = /[+\-*&^%:=<>!|\/]/;
function i(e, n) {
  var t = e.next();
  if (/[\d\.]/.test(t))
  ...
  return d.propertyIsEnumerable(r) || f.propertyIsEnumerable(r) || o.propertyIsEnumerable(r)
    ? "keyword"
    : p.propertyIsEnumerable(r)
      ? "atom"
      : "variable";
}
function c(e, n) {
...
const x = {
  ...
  startState: function (e) {
    return { tokenize: null, context: new a(-e, 0, "top", !1), indented: 0, startOfLine: !0 };
  },
  token: function (e, n) {
    var t = n.context;
    if (
    ...
    return (
      f.propertyIsEnumerable(u) ? k(n, e.column(), "end_block") : o.propertyIsEnumerable(u) && v(n),
      (n.startOfLine = !1),
      r
    );
  },
