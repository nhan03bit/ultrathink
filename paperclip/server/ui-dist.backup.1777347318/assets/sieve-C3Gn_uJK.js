...
var f = l("if elsif else stop require"),
  p = l("true false not");
function t(n, e) {
  var i = n.next();
...
function k(n, e) {
  return (
    (e._multiLineString = !0),
    n.sol()
      ? (n.next() == "." && n.eol() && ((e._multiLineString = !1), (e.tokenize = t)), "string")
      : (n.eatSpace(), n.peek() == "#" ? (n.skipToEnd(), "comment") : (n.skipToEnd(), "string"))
  );
}
function o(n, e) {
...
function d(n) {
  return function (e, i) {
    for (var r = !1, u; (u = e.next()) != null && !(u == n && !r); ) r = !r && u == "\\";
