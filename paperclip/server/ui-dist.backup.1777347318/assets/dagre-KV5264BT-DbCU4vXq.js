...
import { i as x, G as B } from "./graph-Cx_Z1KsE.js";
import { l as I } from "./layout-8vbnOAdQ.js";
import { c as L } from "./clone-Cv7fhgWn.js";
import { m as A } from "./min-C2jNAqws.js";
    ...
    for (const r of n)
      if (
        ...
        (i.warn("Old graph before copy", E(e)),
          ...
          i.warn("New graph after copy node: (", r, ")", E(v)),
      ...
      e.edges.forEach((g) => {
        if (g.start === g.end) {
          ...
          ((s.label = ""),
            ...
            n.setEdge(h, p, s, h + "-cyclic-special-0"),
            n.setEdge(p, y, w, h + "-cyclic-special-1"),
