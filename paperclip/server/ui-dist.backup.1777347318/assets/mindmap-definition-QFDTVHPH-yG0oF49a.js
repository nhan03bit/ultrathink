import { g as le } from "./chunk-55IACEB6-DlzlJx7n.js";
import { s as he } from "./chunk-EDXVE4YY-DhIHJTeF.js";
import {
  _ as h,
  l as R,
  p as de,
...
const _ = [];
for (let t = 0; t < 256; ++t) _.push((t + 256).toString(16).slice(1));
function Ee(t, e = 0) {
  return (
    _[t[e + 0]] +
    _[t[e + 1]] +
...
function Se(t, e, a) {
  var n;
  if (ie.randomUUID && !t) return ie.randomUUID();
  t = t || {};
  const l = t.random ?? ((n = t.rng) == null ? void 0 : n.call(t)) ?? be();
  if (l.length < 16) throw new Error("Random bytes length must be >= 16");
  return ((l[6] = (l[6] & 15) | 64), (l[8] = (l[8] & 63) | 128), Ee(l));
}
var Q = (function () {
  var t = h(function (I, s, i, o) {
      for (i = i || {}, o = I.length; o--; i[I[o]] = s);
      return i;
    }, "o"),
    e = [1, 4],
    a = [1, 13],
    ...
    z = {
      ...
      performAction: h(function (s, i, o, c, u, r, P) {
        var g = r.length - 1;
        switch (u) {
          case 6:
          case 7:
      ...
      table: [
        ...
        { 1: [2, 1] },
        { 4: 6, 6: [1, 7], 7: [1, 8], 8: e },
        { 6: a, 7: [1, 10], 9: 9, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y },
        t(E, [2, 3]),
        { 1: [2, 2] },
        t(E, [2, 4]),
        t(E, [2, 5]),
        { 1: [2, 6], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y },
        { 6: a, 9: 22, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y },
        { 6: k, 7: L, 10: 23, 11: N },
        t(b, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: p, 22: y }),
        t(b, [2, 18]),
        t(b, [2, 19]),
        t(b, [2, 20]),
        t(b, [2, 21]),
        ...
        { 20: [1, 31] },
        { 6: k, 7: L, 10: 32, 11: N },
        { 1: [2, 7], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y },
        t($, [2, 14], { 7: f, 11: U }),
        t(B, [2, 8]),
        t(B, [2, 9]),
        t(B, [2, 10]),
      ...
      parse: h(function (s) {
        var i = this,
          ...
          re = 2,
          ee = 1,
          oe = r.slice.call(arguments, 1),
          m = Object.create(this.lexer),
          O = { yy: {} };
        for (var X in this.yy) Object.prototype.hasOwnProperty.call(this.yy, X) && (O.yy[X] = this.yy[X]);
        (m.setInput(s, O.yy), (O.yy.lexer = m), (O.yy.parser = this), typeof m.yylloc > "u" && (m.yylloc = {}));
        var Y = m.yylloc;
        r.push(Y);
        ...
        function ce(x) {
          ((o.length = o.length - 2 * x), (u.length = u.length - x), (r.length = r.length - x));
        }
        h(ce, "popStack");
        function te() {
          var x;
          return (
            (x = c.pop() || m.lex() || ee),
            typeof x != "number" && (x instanceof Array && ((c = x), (x = c.pop())), (x = i.symbols_[x] || x)),
            x
          );
        }
        h(te, "lex");
        for (var S, C, D, q, w = {}, G, v, ne, j; ; ) {
          if (
            ((C = o[o.length - 1]),
            this.defaultActions[C]
              ? (D = this.defaultActions[C])
              : ((S === null || typeof S > "u") && (S = te()), (D = P[C] && P[C][S])),
            typeof D > "u" || !D.length || !D[0])
          ) {
            var J = "";
            j = [];
            for (G in P[C]) this.terminals_[G] && G > re && j.push("'" + this.terminals_[G] + "'");
            (m.showPosition
              ? (J =
                  "Parse error on line " +
                  (F + 1) +
...
Expecting ` +
              ...
              : (J =
                  ...
                  (F + 1) +
                  ": Unexpected " +
                  (S == ee ? "end of input" : "'" + (this.terminals_[S] || S) + "'")),
              this.parseError(J, {
                text: m.match,
          ...
          switch (D[0]) {
            ...
            case 2:
              if (
                ...
                ae && (w._$.range = [r[r.length - (v || 1)].range[0], r[r.length - 1].range[1]]),
                (q = this.performAction.apply(w, [g, Z, F, O.yy, D[1], u, r].concat(oe))),
                typeof q < "u")
              )
                return q;
              (v && ((o = o.slice(0, -1 * v * 2)), (u = u.slice(0, -1 * v)), (r = r.slice(0, -1 * v))),
                o.push(this.productions_[D[1]][0]),
                u.push(w.$),
                r.push(w._$),
                (ne = P[o[o.length - 2]][o[o.length - 1]]),
                o.push(ne));
              break;
            case 3:
              return !0;
    ...
    se = (function () {
      var I = {
        EOF: 1,
        parseError: h(function (i, o) {
          if (this.yy.parser) this.yy.parser.parseError(i, o);
        ...
        unput: h(function (s) {
          ...
          ((this.match = this.match.substr(0, this.match.length - 1)),
            ...
            o.length - 1 && (this.yylineno -= o.length - 1));
          ...
          return (
            (this.yylloc = {
              ...
              last_column: o
                ? (o.length === c.length ? this.yylloc.first_column : 0) + c[c.length - o.length].length - o[0].length
...
` +
        ...
        test_match: h(function (s, i) {
          ...
          if (
            ...
            (this.matched += s[0]),
            (o = this.performAction.call(this, this.yy, this, i, this.conditionStack[this.conditionStack.length - 1])),
            this.done && this._input && (this.done = !1),
            o)
          )
            return o;
          if (this._backtrack) {
            for (var r in u) this[r] = u[r];
            return !1;
          }
          return !1;
        }, "test_match"),
        next: h(function () {
          ...
          for (var u = this._currentRules(), r = 0; r < u.length; r++)
            if (((o = this._input.match(this.rules[u[r]])), o && (!i || o[0].length > i[0].length))) {
              if (((i = o), (c = r), this.options.backtrack_lexer)) {
                if (((s = this.test_match(o, u[r])), s !== !1)) return s;
                if (this._backtrack) {
                  i = !1;
                  continue;
                } else return !1;
          ...
          return i
            ? ((s = this.test_match(i, u[c])), s !== !1 ? s : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: h(function (i, o, c, u) {
          switch (c) {
            case 0:
  ...
  return (h(V, "Parser"), (V.prototype = z), (z.Parser = V), new V());
})();
Q.parser = Q;
var xe = Q,
  De = 12,
  ...
  Ne =
    ((A = class {
      ...
      getParent(e) {
        for (let a = this.nodes.length - 1; a >= 0; a--) if (this.nodes[a].level < e) return this.nodes[a];
        return null;
      }
      getMindmap() {
      ...
      addNode(e, a, l, n) {
        var L, N;
        R.info("addNode", e, a, l, n);
        let d = !1;
        this.nodes.length === 0
          ? ((this.baseLevel = e), (e = 0), (d = !0))
          : this.baseLevel !== void 0 && ((e = e - this.baseLevel), (d = !1));
        const p = M();
        let y = ((L = p.mindmap) == null ? void 0 : L.padding) ?? W.mindmap.padding;
        switch (n) {
        ...
        const E = {
            ...
            type: n,
            children: [],
            width: ((N = p.mindmap) == null ? void 0 : N.maxNodeWidth) ?? W.mindmap.maxNodeWidth,
            padding: y,
            isRoot: d,
          },
          k = this.getParent(e);
        if (k) (k.children.push(E), this.nodes.push(E));
        else if (d) this.nodes.push(E);
        else throw new Error(`There can be only one root. No parent could be found for ("${E.descr}")`);
      }
      getType(e, a) {
        switch ((R.debug("In get type", e, a), e)) {
          case "[":
      ...
      decorateNode(e) {
        if (!e) return;
        const a = M(),
          l = this.nodes[this.nodes.length - 1];
        (e.icon && (l.icon = H(e.icon, a)), e.class && (l.class = H(e.class, a)));
      }
      type2Str(e) {
        switch (e) {
      ...
      flattenNodes(e, a) {
        ...
        const d = n.join(" "),
          p = h((E) => {
            var N;
            const L = (((N = l.theme) == null ? void 0 : N.toLowerCase()) ?? "").includes("redux");
            switch (E) {
              case T.CIRCLE:
              ...
              case T.HEXAGON:
                return "hexagon";
              case T.DEFAULT:
                return L ? "rounded" : "defaultMindmapNode";
              case T.NO_BORDER:
              default:
                return "rect";
            }
        ...
        if ((a.push(y), e.children)) for (const E of e.children) this.flattenNodes(E, a);
      }
      generateEdges(e, a) {
      ...
      getData() {
        const e = this.getMindmap(),
          ...
          n = pe().layout !== void 0,
          d = a;
        if ((n || (d.layout = "cose-bilkent"), !e)) return { nodes: [], edges: [], config: d };
        (R.debug("getData: mindmapRoot", e, a), this.assignSections(e));
        const p = [],
          y = [];
        (this.flattenNodes(e, p),
          this.generateEdges(e, y),
          R.debug(`getData: processed ${p.length} nodes and ${y.length} edges`));
        const E = new Map();
        for (const k of p) E.set(k.id, { shape: k.shape, width: k.width, height: k.height, padding: k.padding });
        return {
          nodes: p,
          edges: y,
          config: d,
...
` + t
    ...
    const n = l.db,
      d = n.getData(),
      p = le(e, d.config.securityLevel);
    if (
      ((d.type = l.type),
      (d.layoutAlgorithm = de(d.config.layout, { fallback: "cose-bilkent" })),
      (d.diagramId = e),
      !n.getMindmap())
    )
      return;
    (d.nodes.forEach((f) => {
      f.shape === "rounded"
        ? ((f.radius = 15), (f.taper = 15), (f.stroke = "none"), (f.width = 0), (f.padding = 15))
        : f.shape === "circle"
          ? (f.padding = 10)
          : f.shape === "rect"
            ? ((f.width = 0), (f.padding = 10))
            : f.shape === "hexagon" && ((f.width = 0), (f.height = 0));
    }),
      await ge(d, p));
    const { themeVariables: E } = ue(),
      { useGradient: k, gradientStart: L, gradientStop: N } = E;
    if (k && L && N) {
      const f = p.attr("id"),
        U = p
          .append("defs")
          ...
          .attr("x2", "100%")
          .attr("y2", "0%");
      (U.append("stop").attr("offset", "0%").attr("stop-color", L).attr("stop-opacity", 1),
        U.append("stop").attr("offset", "100%").attr("stop-color", N).attr("stop-opacity", 1));
    }
    he(
      p,
      ((b = d.config.mindmap) == null ? void 0 : b.padding) ?? W.mindmap.padding,
      "mindmapDiagram",
      (($ = d.config.mindmap) == null ? void 0 : $.useMaxWidth) ?? W.mindmap.useMaxWidth
    );
  }, "draw"),
  ve = { draw: Le },
  Te = h((t) => {
    ...
    for (let n = 0; n < t.THEME_COLOR_LIMIT; n++)
      ((t["lineColor" + n] = t["lineColor" + n] || t["cScaleInv" + n]),
        fe(t["lineColor" + n])
          ? (t["lineColor" + n] = me(t["lineColor" + n], 20))
          : (t["lineColor" + n] = ye(t["lineColor" + n], 20)));
    for (let n = 0; n < t.THEME_COLOR_LIMIT; n++) {
  ...
  Oe = h((t) => {
    const { theme: e } = t,
      a = t.svgId,
      l = t.dropShadow ? t.dropShadow.replace("url(#drop-shadow)", `url(${a}-drop-shadow)`) : "none";
    return `
  .edge {
    stroke-width: 3;
  }
  ...
  ${t.useGradient && a && t.mainBkg ? Ie(t.THEME_COLOR_LIMIT, a, t.mainBkg) : ""}
`;
  }, "getStyles"),
  Ce = Oe,
  Ue = {
