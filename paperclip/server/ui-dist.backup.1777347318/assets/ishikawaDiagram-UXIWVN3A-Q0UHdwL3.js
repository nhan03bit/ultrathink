...
var tt = (function () {
  var e = o(function (M, t, s, i) {
    ...
    N = {
      ...
      performAction: o(function (t, s, i, u, p, n, v) {
        var w = n.length - 1;
        switch (p) {
          case 6:
          case 7:
            return u;
          case 15:
            u.addNode(n[w - 1].length, n[w].trim());
            break;
          case 16:
            u.addNode(0, n[w].trim());
            break;
        }
      }, "anonymous"),
      table: [
      ...
      parse: o(function (t) {
        var s = this,
          ...
          L = 2,
          E = 1,
          R = n.slice.call(arguments, 1),
          b = Object.create(this.lexer),
          C = { yy: {} };
        for (var F in this.yy) Object.prototype.hasOwnProperty.call(this.yy, F) && (C.yy[F] = this.yy[F]);
        ...
        function z() {
          ...
          return (
            (P = u.pop() || b.lex() || E),
            typeof P != "number" && (P instanceof Array && ((u = P), (P = u.pop())), (P = s.symbols_[P] || P)),
            P
          );
        }
        o(z, "lex");
        for (var A, W, B, K, H = {}, X, V, et, Y; ; ) {
          if (
            ...
            this.defaultActions[W]
              ...
              : ((A === null || typeof A > "u") && (A = z()), (B = v[W] && v[W][A])),
            typeof B > "u" || !B.length || !B[0])
          ) {
            var Q = "";
            Y = [];
            for (X in v[W]) this.terminals_[X] && X > L && Y.push("'" + this.terminals_[X] + "'");
            (b.showPosition
              ? (Q =
                  "Parse error on line " +
                  (I + 1) +
...
Expecting ` +
              ...
              : (Q =
                  ...
                  (I + 1) +
                  ": Unexpected " +
                  (A == E ? "end of input" : "'" + (this.terminals_[A] || A) + "'")),
              this.parseError(Q, {
                text: b.match,
          ...
          switch (B[0]) {
            ...
            case 2:
              if (
                ...
                D && (H._$.range = [n[n.length - (V || 1)].range[0], n[n.length - 1].range[1]]),
                (K = this.performAction.apply(H, [w, S, I, C.yy, B[1], p, n].concat(R))),
                typeof K < "u")
              )
                return K;
              (V && ((i = i.slice(0, -1 * V * 2)), (p = p.slice(0, -1 * V)), (n = n.slice(0, -1 * V))),
                i.push(this.productions_[B[1]][0]),
                p.push(H.$),
                n.push(H._$),
                (et = v[i[i.length - 2]][i[i.length - 1]]),
                i.push(et));
              break;
            case 3:
              return !0;
        ...
        unput: o(function (t) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: i
                ? (i.length === u.length ? this.yylloc.first_column : 0) + u[u.length - i.length].length - i[0].length
...
` +
        ...
        next: o(function () {
          ...
          return s
            ? ((t = this.test_match(s, p[u])), t !== !1 ? t : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: o(function (s, i, u, p) {
          switch (u) {
            case 0:
              return 6;
            case 1:
...
var xt = tt,
  ...
  It = o((e, h, r, a) => {
    ...
    if (!y) return;
    const f = ot(),
      { look: d, handDrawnSeed: m, themeVariables: c } = f,
      k = ut(f.fontSize)[0] ?? St,
      g = d === "handDrawn",
      _ = y.children ?? [],
      x = ((C = f.ishikawa) == null ? void 0 : C.diagramPadding) ?? 20,
      N = ((F = f.ishikawa) == null ? void 0 : F.useMaxWidth) ?? !1,
      O = dt(h),
      $ = O.append("g").attr("class", "ishikawa"),
      M = g ? yt.svg(O.node()) : void 0,
      t = M
        ? {
            roughSvg: M,
            seed: m ?? 0,
    ...
    i -= 20;
    const n = _.filter((T, D) => D % 2 === 0),
      v = _.filter((T, D) => D % 2 === 1),
      w = rt(n),
      I = rt(v),
      S = w.total + I.total;
    let L = G,
    ...
    if (S > 0) {
      const T = G * 2,
        D = G * 0.3;
      ((L = Math.max(D, T * (w.total / S))), (E = Math.max(D, T * (I.total / S))));
    }
    const R = k * 2;
    ((L = Math.max(L, w.max * R)),
      (E = Math.max(E, I.max * R)),
      (u = Math.max(L, G)),
      p && p.attr("y1", u).attr("y2", u),
      $.select(".ishikawa-head-group").attr("transform", `translate(0,${u})`));
    ...
    for (let T = 0; T < b; T++) {
      ...
      i = D.selectAll("text")
        .nodes()
        .reduce((j, z) => Math.min(j, z.getBBox().x), 1 / 0);
    }
    if (g) U($, i, u, 0, u, "ishikawa-spine", t);
    else {
      p.attr("x1", i);
      const T = `url(#${s})`;
  ...
  rt = o((e) => {
    const h = o((r) => r.children.reduce((a, l) => a + 1 + h(l), 0), "countDescendants");
    return e.reduce(
      (r, a) => {
        const l = h(a);
  ...
  Lt = o((e, h, r, a, l, y) => {
    const f = Math.max(6, Math.floor(110 / (l * 0.6))),
      d = e.append("g").attr("class", "ishikawa-head-group").attr("transform", `translate(${h},${r})`),
      m = q(d, ct(a, f), 0, 0, "ishikawa-head-label", "start", l),
      c = m.node().getBBox(),
      k = Math.max(60, c.width + 6),
      g = Math.max(40, c.height * 2 + 40),
      _ = `M 0 ${-g / 2} L 0 ${g / 2} Q ${k * 2.4} 0 0 ${-g / 2} Z`;
    if (y) {
    ...
    } else d.insert("path", ":first-child").attr("class", "ishikawa-head").attr("d", _);
    m.attr("transform", `translate(${(k - c.width) / 2 - c.x + 3},${-c.y - c.height / 2})`);
  }, "drawHead"),
  Tt = o((e, h) => {
    const r = [],
      a = [],
      l = o((y, f, d) => {
        ...
        for (const c of m) {
          const k = r.length,
            g = c.children ?? [];
          (r.push({ depth: d, text: ct(c.text, 15), parentIndex: f, childCount: g.length }),
  ...
  Mt = o((e, h, r, a, l, y, f) => {
    const d = e.append("g").attr("class", "ishikawa-label-group"),
      c = q(d, h, r, a + 11 * l, "ishikawa-label cause", "middle", y)
        .node()
        .getBBox();
    if (f) {
      const k = f.roughSvg.rectangle(c.x - 20, c.y - 2, c.width + 40, c.height + 4, {
        roughness: 1.5,
        seed: f.seed,
        fill: f.fillColor,
        fillStyle: "hachure",
      ...
      d.insert("rect", ":first-child")
        ...
        .attr("x", c.x - 20)
        .attr("y", c.y - 2)
        .attr("width", c.width + 40)
        .attr("height", c.height + 4);
  }, "drawCauseLabel"),
  J = o((e, h, r, a, l, y) => {
    ...
    const d = a / f,
      ...
      _ = h,
      x = r,
      N = `M ${_} ${x} L ${_ - d * c * 2 + k} ${x - m * c * 2 + g} L ${_ - d * c * 2 - k} ${x - m * c * 2 - g} Z`,
      O = y.roughSvg.path(N, {
        roughness: 1,
        seed: y.seed,
        fill: y.lineColor,
  ...
  Pt = o((e, h, r, a, l, y, f, d) => {
    const m = h.children ?? [],
      ...
      x = a + g;
    if (
      (U(e, r, a, _, x, "ishikawa-branch", d),
      d && J(e, r, a, r - _, a - x, d),
      Mt(e, h.text, _, x, l, f, d),
      !m.length)
    )
      return;
    const { entries: N, yOrder: O } = Tt(m, l),
      $ = N.length,
      M = new Array($);
    for (const [p, n] of O.entries()) M[n] = a + g * ((p + 1) / ($ + 1));
    const t = new Map();
    t.set(-1, { x0: r, y0: a, x1: _, y1: x, childCount: m.length, childrenDrawn: 0 });
    const s = -st,
      i = nt * l,
      u = l < 0 ? "ishikawa-label up" : "ishikawa-label down";
    for (const [p, n] of N.entries()) {
      const v = M[p],
        w = t.get(n.parentIndex),
      ...
      if (n.depth % 2 === 0) {
        const R = w.y1 - w.y0;
        ((S = lt(w.x0, w.x1, R ? (v - w.y0) / R : 0.5)),
          (L = v),
          (E = S - (n.childCount > 0 ? Et + n.childCount * At : $t)),
          U(I, S, v, E, v, "ishikawa-sub-branch", d),
          d && J(I, S, v, 1, 0, d),
          q(I, n.text, E, v, "ishikawa-label align", "end", f));
      } else {
        const R = w.childrenDrawn++;
        ((S = lt(w.x0, w.x1, (w.childCount - R) / (w.childCount + 1))),
          (L = w.y0),
          (E = S + s * ((v - L) / i)),
          U(I, S, L, E, v, "ishikawa-sub-branch", d),
          d && J(I, S, L, S - E, L - v, d),
          q(I, n.text, E, v, u, "end", f));
      }
      n.childCount > 0 && t.set(p, { x0: S, y0: L, x1: E, y1: v, childCount: n.childCount, childrenDrawn: 0 });
    }
  }, "drawBranch"),
  Bt = o((e) => e.split(/<br\s*\/?>|\n/), "splitLines"),
  ct = o((e, h) => {
...
`);
  ...
  lt = o((e, h, r) => e + (h - e) * r, "lerp"),
  U = o((e, h, r, a, l, y, f) => {
    if (f) {
      const d = f.roughSvg.line(h, r, a, l, { roughness: 1.5, seed: f.seed, stroke: f.lineColor, strokeWidth: 2 });
