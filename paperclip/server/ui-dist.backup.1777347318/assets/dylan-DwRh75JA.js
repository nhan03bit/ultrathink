...
function s(e, i) {
  ...
  if (n == "/") {
    ...
    if (n == "#")
      return (
        ...
        (n = e.peek()),
        n == '"'
          ? (e.next(), d(e, i, h('"', "string")))
          : n == "b"
            ? (e.next(), e.eatWhile(/[01]/), "number")
            : n == "x"
              ? (e.next(), e.eatWhile(/[\da-f]/i), "number")
              : n == "o"
                ? (e.next(), e.eatWhile(/[0-7]/), "number")
                : n == "#"
                  ? (e.next(), "punctuation")
                  : n == "[" || n == "("
                    ? (e.next(), "bracket")
                    : e.match(/f|t|all-keys|include|key|next|rest/i)
                      ? "atom"
                      : (e.eatWhile(/[-a-zA-Z]/), "error")
      );
    if (n == "~")
      return (
        e.next(),
        (n = e.peek()),
        n == "=" ? (e.next(), (n = e.peek()), n == "=" && e.next(), "operator") : "operator"
      );
    if (n == ":") {
  ...
  return /[+\-*\/^=<>&|]/.test(n)
    ...
    : e.match("define")
      ? "def"
      : (e.eatWhile(/[\w\-]/),
        y.hasOwnProperty(e.current())
          ? k[e.current()]
          : e.current().match(v)
            ? "variable"
            : (e.next(), "variableName.standard"));
}
function D(e, i) {
