...
import { K as oe } from "./index-BSvjNLKU.js";
import { b as jn, t as Ne, c as Qn, a as Jn, l as Kn } from "./linear-BjC7_CiK.js";
import { i as tr } from "./init-Gi6I4Gst.js";
...
function fn(t, e) {
  ...
  function _(S) {
    var Z = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()),
      A = i ?? (e.tickFormat ? e.tickFormat.apply(e, n) : rr),
      U = Math.max(a, 0) + m,
      E = e.range(),
      N = +E[0] + Y,
      W = +E[E.length - 1] + Y,
      q = (e.bandwidth ? or : ar)(e.copy(), Y),
...
function kn(t) {
  ...
  return (
    e === n && n === r
      ? (a = c = i)
      : ((a = fe((0.4360747 * e + 0.3850649 * n + 0.1430804 * r) / dn)),
        (c = fe((0.0139322 * e + 0.0971045 * n + 0.7141733 * r) / mn))),
...
function et(t, e, n, r) {
  ...
  return (
    ...
    n &&
      ((i.count = (a, c) => (ge.setTime(+a), ye.setTime(+c), t(ge), t(ye), Math.floor(n(ge, ye)))),
      (i.every = (a) => (
        (a = Math.floor(a)),
        !isFinite(a) || !(a > 0)
          ? null
...
function Yr(t) {
  ...
  function p(M, H) {
    return function (R) {
      var l = [],
        ...
        it,
        at;
      for (R instanceof Date || (R = new Date(+R)); ++J < Q; )
        M.charCodeAt(J) === 37 &&
          (l.push(M.slice($, J)),
    ...
    return function (R) {
      ...
      if (
        ...
        ("W" in l || "U" in l) &&
          ...
          (Q = "Z" in l ? ve(At(l.y, 0, 1)).getUTCDay() : pe(At(l.y, 0, 1)).getDay()),
          (l.m = 0),
  ...
  function y(M, H, R, l) {
    for (var J = 0, $ = H.length, Q = R.length, G, it; J < $; ) {
      ...
      } else if (G != R.charCodeAt(l++)) return -1;
    }
    return l;
  }
  function h(M, H, R) {
...
function _n(t, e, n, r, i, a, c, m, Y, C) {
  ...
  function j(p) {
    return (
      Y(p) < p ? S : m(p) < p ? Z : c(p) < p ? A : a(p) < p ? U : r(p) < p ? (i(p) < p ? E : N) : n(p) < p ? W : q
    )(p);
  }
  return (
    (k.invert = function (p) {
...
function Ei() {
  return tr.apply(
    _n(_r, Fr, kt, Pt, Rt, xt, Ht, Ot, vt, ie).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments
  );
}
var jt = { exports: {} },
      ...
      (function (t, e) {
        (function (n, r) {
              ...
              Do: [
                ...
                function (U) {
                  var E = Y.ordinal,
                    N = U.match(/\d+/);
                  if (((this.day = N[0]), E))
                    for (var W = 1; W <= 31; W += 1) E(W).replace(/\[|\]/g, "") === U && (this.day = W);
                },
              ],
              w: [c, k("week")],
              ww: [a, k("week")],
          ...
          function A(U) {
            ...
            ((E = U), (N = Y && Y.formats));
            for (
              var W = (U = E.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function (D, w, T) {
                  var v = T && T.toUpperCase();
                  return (
                    w ||
                    N[T] ||
                    n[T] ||
                    N[v].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function (u, f, x) {
                      return f || x.slice(1);
                    })
                  );
                })).match(r),
              ...
              return (
                ...
                (g.parseFromMilliseconds = function () {
                  ...
                  ((this.$d.years = E(y / C)),
                    ...
                    (this.$d.hours = E(y / c)),
                    (y %= c),
                    (this.$d.minutes = E(y / a)),
                    (y %= a),
                    (this.$d.seconds = E(y / i)),
                    (y %= i),
                ...
                (g.toISOString = function () {
                  ...
                  var f = W(u, "S"),
                    x = y.negative || h.negative || w.negative || T.negative || v.negative || f.negative,
                    b = T.format || v.format || f.format ? "T" : "",
                    F = (x ? "-" : "") + "P" + y.format + h.format + w.format + b + T.format + v.format + f.format;
...
var we = (function () {
  var t = d(function (v, u, f, x) {
    ...
    D = {
      ...
      performAction: d(function (u, f, x, b, F, o, X) {
        var s = o.length - 1;
        switch (F) {
          case 1:
            return o[s - 1];
      ...
      parse: d(function (u) {
        ...
        function J() {
          ...
          return (
            (ot = b.pop() || O.lex() || P),
            typeof ot != "number" && (ot instanceof Array && ((b = ot), (ot = b.pop())), (ot = f.symbols_[ot] || ot)),
            ot
          );
        }
        d(J, "lex");
        for (var $, Q, G, it, at = {}, pt, ut, He, Zt; ; ) {
          if (
            ...
            var ce = "";
            Zt = [];
            for (pt in X[Q]) this.terminals_[pt] && pt > V && Zt.push("'" + this.terminals_[pt] + "'");
            (O.showPosition
              ? (ce =
                  "Parse error on line " +
                  (I + 1) +
...
Expecting ` +
          ...
          switch (G[0]) {
            ...
            case 2:
              if (
                ...
                R && (at._$.range = [o[o.length - (ut || 1)].range[0], o[o.length - 1].range[1]]),
                (it = this.performAction.apply(at, [s, z, I, st.yy, G[1], F, o].concat(K))),
                typeof it < "u")
              )
                return it;
              (ut && ((x = x.slice(0, -1 * ut * 2)), (F = F.slice(0, -1 * ut)), (o = o.slice(0, -1 * ut))),
                x.push(this.productions_[G[1]][0]),
                F.push(at.$),
                o.push(at._$),
                (He = X[x[x.length - 2]][x[x.length - 1]]),
                x.push(He));
              break;
            case 3:
              return !0;
    ...
    w = (function () {
      var v = {
        EOF: 1,
        parseError: d(function (f, x) {
          if (this.yy.parser) this.yy.parser.parseError(f, x);
        ...
        unput: d(function (u) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: x
                ? (x.length === b.length ? this.yylloc.first_column : 0) + b[b.length - x.length].length - x[0].length
...
` +
        ...
        test_match: d(function (u, f) {
          ...
          if (
            ...
            (this.matched += u[0]),
            (x = this.performAction.call(this, this.yy, this, f, this.conditionStack[this.conditionStack.length - 1])),
        ...
        next: d(function () {
          ...
          for (var F = this._currentRules(), o = 0; o < F.length; o++)
            if (((x = this._input.match(this.rules[F[o]])), x && (!f || x[0].length > f[0].length))) {
              if (((f = x), (b = o), this.options.backtrack_lexer)) {
                if (((u = this.test_match(x, F[o])), u !== !1)) return u;
                if (this._backtrack) {
                  f = !1;
                  continue;
                } else return !1;
          ...
          return f
            ? ((u = this.test_match(f, F[b])), u !== !1 ? u : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: d(function (f, x, b, F) {
          switch (b) {
            case 0:
...
var rn = { friday: 5, saturday: 6 },
  ...
  Lt = "",
  Le = "",
  Fn = ["active", "done", "crit", "milestone", "vert"],
  Ae = [],
  _t = "",
  qt = !1,
  We = !1,
  ...
  Un = d(function (t, e, n, r) {
    ...
    const [c, m] = Ds(i, a, e, n, r);
    ((t.endTime = c.toDate()), (t.renderEndTime = m));
  }, "checkTaskDates"),
  Ds = d(function (t, e, n, r, i) {
    let a = !1,
      c = null;
    for (; t <= e; ) (a || (c = e.toDate()), (a = Yn(t, n, r, i)), a && (e = e.add(1, "d")), (t = t.add(1, "d")));
    return [e, c];
  }, "fixTaskDates"),
  Me = d(function (t, e, n) {
    if (
  ...
  Ms = d(function (t, e) {
    ...
    return (
      a &&
        ((i.endTime = En(i.startTime, lt, a, qt)),
  ...
  _s = d(function (t, e) {
    const n = { section: Lt, type: Lt, description: t, task: t, classes: [] },
      r = Ms(Ce, e);
  ...
  sn = d(function () {
    const t = d(function (n) {
      ...
      return (
        tt[n].startTime &&
          ((tt[n].endTime = En(tt[n].startTime, lt, tt[n].raw.endTime.data, qt)),
          tt[n].endTime &&
            ((tt[n].processed = !0),
  ...
  Fs = d(function (t, e) {
    let n = e;
    (Ft().securityLevel !== "loose" && (n = Bn.sanitizeUrl(e)),
  ...
  Ys = d(function (t, e, n) {
    if (Ft().securityLevel !== "loose" || e === void 0) return;
    let r = [];
    if (typeof n == "string") {
      r = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
  ...
  Es = {
    getConfig: d(() => Ft().gantt, "getConfig"),
    clear: Qi,
    setDateFormat: ss,
    getDateFormat: ds,
...
var Ls = d(function () {
  ...
  an = { monday: Nt, tuesday: vn, wednesday: Tn, thursday: bt, friday: xn, saturday: bn, sunday: Rt },
  As = d((t, e) => {
    let n = [...t].map(() => -1 / 0),
  ...
  dt,
  Te = 1e4,
  Ws = d(function (t, e, n, r) {
    const i = Ft().gantt;
    r.db.setDiagramId(e);
    const a = Ft().securityLevel;
    let c;
    a === "sandbox" && (c = Bt("#i" + e));
    const m = a === "sandbox" ? Bt(c.nodes()[0].contentDocument.body) : Bt("body"),
    ...
    function E(h, D, w) {
      const T = i.barHeight,
        ...
        u = i.topPadding,
        f = i.leftPadding,
        x = Kn().domain([0, L.length]).range(["#00B9FA", "#F95002"]).interpolate(kr);
    ...
    function N(h, D, w, T, v, u, f) {
      ...
      Z.append("g")
        ...
        .attr("class", function (s) {
          for (const [I, z] of L.entries()) if (s.type === z) return "section section" + (I % i.numberSectionStyles);
      ...
      if (
        (F.append("rect")
          ...
          .attr("class", function (s) {
            ...
            let V = 0;
            for (const [K, O] of L.entries()) s.type === O && (V = K % i.numberSectionStyles);
            let P = "";
            return (
              s.active
                ? s.crit
        ...
        F.append("text")
          ...
          .attr("y", function (s, I) {
            return s.vert
              ...
              : ((I = s.order), I * D + i.barHeight / 2 + (i.fontSize / 2 - 2) + w);
          })
          .attr("text-height", v)
          .attr("class", function (s) {
            ...
            return (
              ...
              s.vert && (O += " vertText"),
              V > z - I
                ? z + V + 1.5 * i.leftPadding > f
                  ? P + " taskTextOutsideLeft taskTextOutside" + K + " " + O
                  : P + " taskTextOutsideRight taskTextOutside" + K + " " + O + " width-" + V
                : P + " taskText taskText" + K + " " + O + " width-" + V
            );
          }),
        ...
        F.filter(function (z) {
          ...
          var V = I.querySelector("#" + CSS.escape(e + "-" + z.id)),
            P = I.querySelector("#" + CSS.escape(e + "-" + z.id + "-text"));
          const K = V.parentNode;
          var O = I.createElement("a");
          (O.setAttribute("xlink:href", o.get(z.id)),
    ...
    function W(h, D, w, T, v, u, f, x) {
      ...
      let s = null,
        I = rt(b);
      for (; I.valueOf() <= F; )
        (r.db.isInvalidDate(I, o, f, x) ? (s ? (s.end = I) : (s = { start: I, end: I })) : s && (X.push(s), (s = null)),
          (I = I.add(1, "d")));
      Z.append("g")
        .selectAll("rect")
        .data(X)
        .enter()
        .append("rect")
        .attr("id", (V) => e + "-exclude-" + V.start.format("YYYY-MM-DD"))
        .attr("x", (V) => A(V.start.startOf("day")) + w)
        .attr("y", i.gridLineStartPadding)
        .attr("width", (V) => A(V.end.endOf("day")) - A(V.start.startOf("day")))
        .attr("height", v - D - i.gridLineStartPadding)
        .attr("transform-origin", function (V, P) {
          return (
            (A(V.start) + w + 0.5 * (A(V.end) - A(V.start))).toString() + "px " + (P * h + 0.5 * v).toString() + "px"
          );
        })
    ...
    function p(h, D) {
      ...
      Z.append("g")
        ...
        .enter()
        .append(function (v) {
          const u = v[0].split(Zn.lineBreakRegex),
            f = -(u.length - 1) / 2,
...
`,
  ...
  Hs = Os,
  qs = { parser: ji, db: Es, renderer: $s, styles: Hs };
