...
var P = o("keyword a"),
  ...
  y = { type: "attribute", style: "attribute" },
  c = o("typedef"),
  B = {
    if: P,
    while: P,
...
function A(e, r) {
  ...
  if (n == "/")
    return e.eat("*")
      ...
      : e.eat("/")
        ...
        : (e.eatWhile(E), p("operator", null, e.current()));
  ...
  e.eatWhile(/[\w_]/);
  var i = e.current(),
    u = B.propertyIsEnumerable(i) && B[i];
...
function R(e, r) {
  for (var n = e.localVars; n; n = n.next) if (n.name == r) return !0;
}
function X(e, r, n, i, u) {
  var s = e.cc;
  for (
    a.state = e, a.stream = u, a.marked = null, a.cc = s, e.lexical.hasOwnProperty("align") || (e.lexical.align = !0);
    ;
  ) {
...
function Y(e, r) {
  if (/[a-z]/.test(r.charAt(0))) return !1;
  for (var n = e.importedtypes.length, i = 0; i < n; i++) if (e.importedtypes[i] == r) return !0;
}
function F(e) {
...
function H(e, r) {
  for (var n = r; n; n = n.next) if (n.name == e) return !0;
  return !1;
}
function S(e) {
  var r = a.state;
            ...
            : e == ";"
              ...
              : e == "attribute"
                ...
                : e == "function"
                  ? t(w)
                  : e == "for"
                    ? t(l("form"), d("("), l(")"), ae, d(")"), f, x, f)
                    : e == "variable"
                      ? t(l("stat"), te)
                      : e == "switch"
                        ? t(l("form"), h, l("}", "switch"), d("{"), _, f, f)
                        : e == "case"
                          ? t(h, d(":"))
                          : e == "default"
                            ? t(d(":"))
                            : e == "catch"
                              ? t(l("form"), D, d("("), J, d(")"), x, f, V)
                              : e == "import"
                                ? t(q, d(";"))
                                : e == "typedef"
                                  ? t(ne)
...
function h(e) {
  return $.hasOwnProperty(e) || e == "type"
    ? t(v)
    : e == "function"
      ? t(w)
      : e == "keyword c"
...
const ce = {
    ...
    token: function (e, r) {
      if (
        (e.sol() && (r.lexical.hasOwnProperty("align") || (r.lexical.align = !1), (r.indented = e.indentation())),
        e.eatSpace())
      )
        return null;
      ...
      return c == "comment"
        ? n
        : ((r.reAllowed = !!(c == "operator" || c == "keyword c" || c.match(/^[\[{}\(,;:]$/))),
          (r.kwAllowed = c != "."),
          X(r, n, c, N, e));
    },
      ...
      return s == "vardef"
        ...
        : s == "form" && i == "{"
          ...
          : s == "stat" || s == "form"
            ? u.indented + n.unit
            : u.info == "switch" && !k
              ? u.indented + (/^(?:case|default)\b/.test(r) ? n.unit : 2 * n.unit)
              : u.align
                ? u.column + (k ? 0 : 1)
                : u.indented + (k ? 0 : n.unit);
    },
  ...
  se = {
    ...
    token: function (e, r) {
      ...
      if (n && u == "-") {
        ...
        return (
          e.eat(/-/),
          e.peek() == "-" && (e.eat(/-/), (i = "keyword a")),
          e.peek() == "D" && (e.eat(/[D]/), (i = "keyword c"), (r.define = !0)),
          e.eatWhile(/[A-Z]/i),
          i
        );
      }
      var u = e.peek();
      return (
        r.inString == !1 && u == "'" && ((r.inString = !0), e.next()),
        r.inString == !0
          ? (e.skipTo("'") || e.skipToEnd(), e.peek() == "'" && (e.next(), (r.inString = !1)), "string")
          : (e.next(), null)
      );
    },
    languageData: { commentTokens: { line: "#" } },
  };
export { ce as haxe, se as hxml };
