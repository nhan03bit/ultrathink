import { aM as j, aN as p, aO as w, aP as k, aQ as q } from "./mermaid.core-oBaSCxHz.js";
import { i as D } from "./init-Gi6I4Gst.js";
import { e as M, f as F, a as P, b as z } from "./defaultLocale-DX6XiGOO.js";
function g(n, r) {
...
function R(n) {
  let r, t, e;
  n.length !== 2
    ? ((r = g), (t = (o, c) => g(n(o), c)), (e = (o, c) => n(o) - c))
    : ((r = n === g || n === B ? n : I), (t = n), (e = n));
...
function an(n, r, t, e) {
  ...
  switch (((e = F(e ?? ",f")), e.type)) {
    ...
    case "r": {
      e.precision == null &&
        !isNaN((f = Y(u, Math.max(Math.abs(n), Math.abs(r))))) &&
...
export { en as a, R as b, un as c, fn as l, E as t };
