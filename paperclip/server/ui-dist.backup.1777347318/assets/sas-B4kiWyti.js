var t = {},
  ...
  p = /[=\(:\),{}.*<>+\-\/^\[\]]/;
function s(e, r, o) {
  if (o) for (var i = r.split(" "), n = 0; n < i.length; n++) t[i[n]] = { style: e, state: o };
}
...
function d(e, r) {
  var o = e.next();
  if (o === "/" && e.eat("*")) return ((r.continueComment = !0), "comment");
  ...
  if (o == "*" && e.column() == e.indentation()) return (e.skipToEnd(), "comment");
  var i = o + e.peek();
  if ((o === '"' || o === "'") && !r.continueString) return ((r.continueString = o), "string");
  if (r.continueString)
    return (
      r.continueString == o
  ...
  if (r.continueString !== null && e.eol()) return (e.skipTo(r.continueString) || e.skipToEnd(), "string");
  if (/[\d\.]/.test(o))
    return (
      o === "."
        ? e.match(/^[0-9]+([eE][\-+]?[0-9]+)?/)
  ...
  if (c.test(o + e.peek())) return (e.next(), "operator");
  if (l.hasOwnProperty(i)) {
    if ((e.next(), e.peek() === " ")) return l[i.toLowerCase()];
  } else if (p.test(o)) return "operator";
  var n;
  if (e.match(/[%&;\w]+/, !1) != null) {
  ...
  if (((n = n.toLowerCase()), r.inDataStep)) {
    ...
    if (n && e.next() === ".") return /\w/.test(e.peek()) ? "variableName.special" : "variable";
  ...
  return r.inMacro
    ? n === "%mend"
      ...
      : n && t.hasOwnProperty(n) && (t[n].state.indexOf("inMacro") !== -1 || t[n].state.indexOf("ALL") !== -1)
        ? (e.match(/[\w]+/), t[n].style)
        : "atom"
...
const f = {
  name: "sas",
  startState: function () {
    return { inDataStep: !1, inProc: !1, inMacro: !1, nextword: !1, continueString: null, continueComment: !1 };
  },
  token: function (e, r) {
