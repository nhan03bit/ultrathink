import { g as gt } from "./chunk-FMBD7UC4-OcsiQGBm.js";
import { a as mt, g as lt, h as xt, d as kt } from "./chunk-YZCP3GAM-DHV1QABU.js";
import {
  g as _t,
  s as vt,
  a as bt,
...
import { d as it } from "./arc-AHY2ASty.js";
import "./index-BSvjNLKU.js";
var U = (function () {
  var t = s(function (h, r, n, l) {
    ...
    g = {
      ...
      performAction: s(function (r, n, l, y, d, c, v) {
        var k = c.length - 1;
        switch (d) {
          case 1:
            return c[k - 1];
      ...
      table: [
        ...
        { 1: [3] },
        t(e, [2, 2], { 5: 3 }),
        { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: a, 12: f, 14: i, 16: u, 17: p, 18: o },
        t(e, [2, 7], { 1: [2, 1] }),
        t(e, [2, 3]),
        { 9: 15, 11: a, 12: f, 14: i, 16: u, 17: p, 18: o },
        t(e, [2, 5]),
        t(e, [2, 6]),
        t(e, [2, 8]),
        { 13: [1, 16] },
      ...
      parse: s(function (r) {
        ...
        function tt() {
          ...
          return (
            (w = y.pop() || _.lex() || D),
            typeof w != "number" && (w instanceof Array && ((y = w), (w = y.pop())), (w = n.symbols_[w] || w)),
            w
          );
        }
        s(tt, "lex");
        for (var b, A, T, q, F = {}, N, M, et, z; ; ) {
          if (
            ...
            this.defaultActions[A]
              ...
              : ((b === null || typeof b > "u") && (b = tt()), (T = v[A] && v[A][b])),
            typeof T > "u" || !T.length || !T[0])
          ) {
            var H = "";
            z = [];
            for (N in v[A]) this.terminals_[N] && N > yt && z.push("'" + this.terminals_[N] + "'");
            (_.showPosition
              ? (H =
                  "Parse error on line " +
                  (C + 1) +
...
Expecting ` +
              ...
              : (H =
                  ...
                  (C + 1) +
                  ": Unexpected " +
                  (b == D ? "end of input" : "'" + (this.terminals_[b] || b) + "'")),
              this.parseError(H, {
                text: _.match,
          ...
          switch (T[0]) {
            ...
            case 2:
              if (
                ...
                ft && (F._$.range = [c[c.length - (M || 1)].range[0], c[c.length - 1].range[1]]),
                (q = this.performAction.apply(F, [k, Q, C, I.yy, T[1], d, c].concat(dt))),
                typeof q < "u")
              )
                return q;
              (M && ((l = l.slice(0, -1 * M * 2)), (d = d.slice(0, -1 * M)), (c = c.slice(0, -1 * M))),
                l.push(this.productions_[T[1]][0]),
                d.push(F.$),
                c.push(F._$),
                (et = v[l[l.length - 2]][l[l.length - 1]]),
                l.push(et));
              break;
            case 3:
              return !0;
        ...
        unput: s(function (r) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: l
                ? (l.length === y.length ? this.yylloc.first_column : 0) + y[y.length - l.length].length - l[0].length
                : this.yylloc.first_column - n,
            }),
            this.options.ranges && (this.yylloc.range = [d[0], d[0] + this.yyleng - n]),
...
` +
        ...
        next: s(function () {
          ...
          for (var d = this._currentRules(), c = 0; c < d.length; c++)
            if (((l = this._input.match(this.rules[d[c]])), l && (!n || l[0].length > n[0].length))) {
              if (((n = l), (y = c), this.options.backtrack_lexer)) {
                if (((r = this.test_match(l, d[c])), r !== !1)) return r;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((r = this.test_match(n, d[y])), r !== !1 ? r : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: s(function (n) {
          return ((n = this.conditionStack.length - 1 - Math.abs(n || 0)), n >= 0 ? this.conditionStack[n] : "INITIAL");
        }, "topState"),
        pushState: s(function (n) {
          this.begin(n);
        }, "pushState"),
        ...
        performAction: s(function (n, l, y, d) {
          switch (y) {
            case 0:
              break;
            case 1:
...
var Et = U,
  ...
  Vt = s(function (t, e) {
    ...
    const u = i.map((o) => o.trim()),
      p = { section: V, type: V, people: u, task: t, score: f };
    B.push(p);
  }, "addTask"),
  Rt = s(function (t) {
    const e = { section: V, type: V, description: t, task: t, classes: [] };
    L.push(e);
  }, "addTaskOrg"),
  rt = s(function () {
    ...
    let e = !0;
    for (const [a, f] of B.entries()) (t(a), (e = e && f.processed));
    return e;
  }, "compileTasks"),
  Lt = s(function () {
    return Ft();
  ...
  nt = {
    getConfig: s(() => R().journey, "getConfig"),
    clear: Ct,
    setDiagramTitle: St,
    getDiagramTitle: Tt,
    setAccTitle: wt,
...
`,
  ...
  ot = s(function (t, e) {
    ...
    return (
      a.attr("cx", e.cx),
      a.attr("cy", e.cy),
      a.attr("class", "actor-" + e.pos),
      a.attr("fill", e.fill),
      a.attr("stroke", e.stroke),
      a.attr("r", e.r),
      a.class !== void 0 && a.attr("class", a.class),
      e.title !== void 0 && a.append("title").text(e.title),
      a
    );
  }, "drawCircle"),
  ct = s(function (t, e) {
  ...
  zt = s(function (t, e) {
    ...
    (f.attr("points", a(e.x, e.y, 50, 20, 7)),
      f.attr("class", "labelBox"),
  ...
  Wt = s(function (t, e, a) {
    ...
    ((i.x = e.x),
      (i.y = e.y),
      (i.fill = e.fill),
      (i.width = a.width * e.taskCount + a.diagramMarginX * (e.taskCount - 1)),
      (i.height = a.height),
      (i.class = "journey-section section-type-" + e.num),
      (i.rx = 3),
      (i.ry = 3),
      K(f, i),
      ht(a)(e.text, f, i.x, i.y, i.width, i.height, { class: "journey-section section-type-" + e.num }, a, e.colour));
  }, "drawSection"),
  Z = -1,
  Ot = s(function (t, e, a, f) {
    const i = e.x + a.width / 2,
      u = t.append("g");
    (Z++,
      u
        .append("line")
        ...
        .attr("stroke", "#666"),
      Nt(u, { cx: i, cy: 300 + (5 - e.score) * 30, score: e.score }));
    const o = lt();
    ((o.x = e.x),
      (o.y = e.y),
      (o.fill = e.fill),
    ...
    let g = e.x + 14;
    (e.people.forEach((m) => {
      const x = e.actors[m].color,
        h = { cx: g, cy: e.y, r: 7, fill: x, stroke: "#000", title: m, pos: e.actors[m].position };
      (ot(u, h), (g += 10));
    }),
      ht(a)(e.task, u, o.x, o.y, o.width, o.height, { class: "task" }, a, e.colour));
  }, "drawTask"),
  Yt = s(function (t, e) {
    mt(t, e);
  }, "drawBackgroundRect"),
  ht = (function () {
    ...
    function e(i, u, p, o, g, m, x, h, r) {
      const { taskFontSize: n, taskFontFamily: l } = h,
        y = i.split(/<br\s*\/?>/gi);
      for (let d = 0; d < y.length; d++) {
        const c = d * n - (n * (y.length - 1)) / 2,
          v = u
            .append("text")
            .attr("x", p + g / 2)
            .attr("y", o)
    ...
    s(a, "byFo");
    function f(i, u) {
      for (const p in u) p in u && i.attr(p, u[p]);
    }
    return (
      s(f, "_setTextAttrs"),
      function (i) {
...
function ut(t) {
  ...
  Object.keys(E).forEach((i) => {
    const u = E[i].color,
      p = { cx: 20, cy: f, r: 7, fill: u, stroke: "#000", pos: E[i].position };
    j.drawCircle(t, p);
    ...
    if (g <= a) m = [i];
      ...
      const x = i.split(" ");
      let h = "";
      ((o = t.append("text").attr("visibility", "hidden")),
        x.forEach((r) => {
          const n = h ? `${h} ${r}` : r;
          if ((o.text(n), o.node().getBoundingClientRect().width > a)) {
            if ((h && m.push(h), (h = r), o.text(r), o.node().getBoundingClientRect().width > a)) {
              ...
              for (const d of r)
                ((y += d),
                  o.text(y + "-"),
                  o.node().getBoundingClientRect().width > a && (m.push(y.slice(0, -1) + "-"), (y = d)));
              h = y;
            }
          } else h = n;
        }),
    ...
    (m.forEach((x, h) => {
      const r = { x: 40, y: f + 7 + h * 20, fill: "#666", text: x, textMargin: e.boxTextMargin ?? 5 },
...
var $ = R().journey,
  P = 0,
  Xt = s(function (t, e, a, f) {
    const i = R(),
      u = i.journey.titleColor,
      p = i.journey.titleFontSize,
      o = i.journey.titleFontFamily,
      g = i.securityLevel;
    let m;
    g === "sandbox" && (m = X("#i" + e));
    ...
    const h = x.select("#" + e);
    j.initGraphics(h, e);
    const r = f.db.getTasks(),
      n = f.db.getDiagramTitle(),
      l = f.db.getActors();
    for (const C in E) delete E[C];
    let y = 0;
    (l.forEach((C) => {
      ((E[C] = { color: $.actorColours[y % $.actorColours.length], position: y }), y++);
    }),
      ut(h),
      (P = $.leftMargin + W),
    ...
    n &&
      h
        ...
        .attr("fill", u)
        .attr("font-family", o);
    const c = d.stopy - d.starty + 2 * $.diagramMarginY,
      v = P + d.stopx + 2 * $.diagramMarginX;
    ($t(h, c, v, $.useMaxWidth),
      h
        .append("line")
        .attr("x1", P)
        ...
        .attr("stroke-width", 4)
        .attr("stroke", "black")
        .attr("marker-end", "url(#" + e + "-arrowhead)"));
    const k = n ? 70 : 0;
    (h.attr("viewBox", `${d.startx} -25 ${v} ${c + k}`),
      h.attr("preserveAspectRatio", "xMinYMin meet"),
      h.attr("height", c + k + 25));
  }, "draw"),
  S = {
    ...
    updateVal: s(function (t, e, a, f) {
      t[e] === void 0 ? (t[e] = a) : (t[e] = f(a, t[e]));
    }, "updateVal"),
    updateBounds: s(function (t, e, a, f) {
      const i = R().journey,
        u = this;
      let p = 0;
      function o(g) {
        return s(function (x) {
          ...
          (u.updateVal(x, "starty", e - h * i.boxMargin, Math.min),
            u.updateVal(x, "stopy", f + h * i.boxMargin, Math.max),
            u.updateVal(S.data, "startx", t - h * i.boxMargin, Math.min),
            u.updateVal(S.data, "stopx", a + h * i.boxMargin, Math.max),
            g !== "activation" &&
              (u.updateVal(x, "startx", t - h * i.boxMargin, Math.min),
              u.updateVal(x, "stopx", a + h * i.boxMargin, Math.max),
              u.updateVal(S.data, "starty", e - h * i.boxMargin, Math.min),
              u.updateVal(S.data, "stopy", f + h * i.boxMargin, Math.max)));
        }, "updateItemBounds");
      }
      (s(o, "updateFn"), this.sequenceItems.forEach(o()));
    }, "updateBounds"),
    insert: s(function (t, e, a, f) {
      const i = Math.min(t, a),
        u = Math.max(t, a),
        p = Math.min(e, f),
        o = Math.max(e, f);
      (this.updateVal(S.data, "startx", i, Math.min),
        this.updateVal(S.data, "starty", p, Math.min),
        this.updateVal(S.data, "stopx", u, Math.max),
        this.updateVal(S.data, "stopy", o, Math.max),
        this.updateBounds(i, p, u, o));
    }, "insert"),
    bumpVerticalPos: s(function (t) {
      ((this.verticalPos = this.verticalPos + t), (this.data.stopy = this.verticalPos));
    }, "bumpVerticalPos"),
    getVerticalPos: s(function () {
      return this.verticalPos;
    }, "getVerticalPos"),
    getBounds: s(function () {
      return this.data;
    }, "getBounds"),
  },
  G = $.sectionFills,
  st = $.sectionColours,
  Gt = s(function (t, e, a, f) {
    const i = R().journey;
    let u = "";
    const p = i.height * 2 + i.diagramMarginY,
      o = a + p;
    let g = 0,
      m = "#CCC",
      x = "black",
    ...
    for (const [r, n] of e.entries()) {
      if (u !== n.section) {
        ...
        let y = 0;
        const d = n.section;
        for (let v = r; v < e.length && e[v].section == d; v++) y = y + 1;
        const c = {
      ...
      ((n.x = r * i.taskMargin + r * i.width + P),
        (n.y = o),
        (n.width = i.diagramMarginX),
        (n.height = i.diagramMarginY),
        (n.colour = x),
        (n.fill = m),
        (n.num = h),
        (n.actors = l),
        j.drawTask(t, n, i, f),
        S.insert(n.x, n.y, n.x + n.width + i.taskMargin, 450));
    }
  }, "drawTasks"),
  at = { setConf: Ht, draw: Xt },
  Dt = {
    parser: Et,
    db: nt,
    renderer: at,
