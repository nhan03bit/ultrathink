        ...
        for (var A, z, I, n, f = {}, u, c, r, k; ; ) {
          if (
            ...
            this.defaultActions[z]
              ...
              : ((A === null || typeof A > "u") && (A = E()), (I = b[z] && b[z][A])),
            typeof I > "u" || !I.length || !I[0])
          ) {
            var w = "";
            k = [];
            for (u in b[z]) this.terminals_[u] && u > C && k.push("'" + this.terminals_[u] + "'");
            (S.showPosition
              ? (w =
                  "Parse error on line " +
                  (T + 1) +
...
Expecting ` +
              ...
              : (w =
                  ...
                  (T + 1) +
                  ": Unexpected " +
                  (A == $ ? "end of input" : "'" + (this.terminals_[A] || A) + "'")),
              this.parseError(w, {
                text: S.match,
          ...
          switch (I[0]) {
            ...
            case 2:
              if (
                ...
                D && (f._$.range = [y[y.length - (c || 1)].range[0], y[y.length - 1].range[1]]),
...
var K = at,
  ...
  gt =
    ...
    (j.count = 0),
    j),
  ae = { left: Ct, right: Ot, center: Dt, justify: mt },
...
${b}${Math.round(E * 100) / 100}${M}`
    ...
    switch (O) {
      case "gradient":
        D = p((g) => g.uid, "coloring");
        break;
      case "source":
        D = p((g) => S(g.source.id), "coloring");
        break;
      case "target":
        D = p((g) => S(g.target.id), "coloring");
        break;
      default:
        D = O;
    }
