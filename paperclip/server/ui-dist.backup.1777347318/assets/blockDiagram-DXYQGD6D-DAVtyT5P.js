import { g as ge } from "./chunk-FMBD7UC4-OcsiQGBm.js";
import {
  _ as d,
  F as lt,
  d as C,
...
import { c as ve } from "./clone-Cv7fhgWn.js";
import { G as Ee } from "./graph-Cx_Z1KsE.js";
import { c as _e } from "./channel-DTVduNhT.js";
import "./index-BSvjNLKU.js";
import "./_baseUniq-CZeyoqSD.js";
var bt = (function () {
  var e = d(function (N, y, u, p) {
    ...
    f = [1, 23],
    w = [1, 24],
    b = [8, 10, 15, 16, 21, 28, 29, 30, 31, 39, 43, 46],
    m = [8, 10, 15, 16, 21, 27, 28, 29, 30, 31, 39, 43, 46],
    _ = [1, 49],
    L = {
      ...
      performAction: d(function (y, u, p, S, E, o, k) {
        var g = o.length - 1;
        switch (E) {
          case 4:
          ...
          case 11:
            ...
            break;
          case 12:
            (S.getLogger().debug("Rule: statement: ", o[g]),
              typeof o[g].length == "number" ? (this.$ = o[g]) : (this.$ = [o[g]]));
            break;
          case 13:
          ...
          case 14:
            ...
            break;
          case 15:
            (S.getLogger().debug("Rule: LABEL link: ", o[g - 3], o[g - 1], o[g]),
              (this.$ = { edgeTypeStr: o[g], label: o[g - 1] }));
            break;
          case 18:
            const D = parseInt(o[g]),
              T = S.generateId();
          ...
          case 23:
            ...
            break;
          case 24:
            (S.getLogger().debug("Rule: nodeStatement (abc88 node size) ", o[g - 1], o[g]),
              (this.$ = {
                id: o[g - 1].id,
                label: o[g - 1].label,
                type: S.typeStr2Type(o[g - 1].typeStr),
                directions: o[g - 1].directions,
                widthInColumns: parseInt(o[g], 10),
              }));
            break;
          case 25:
            (S.getLogger().debug("Rule: nodeStatement (node) ", o[g]),
              (this.$ = {
                id: o[g].id,
                label: o[g].label,
                type: S.typeStr2Type(o[g].typeStr),
                directions: o[g].directions,
                widthInColumns: 1,
              }));
            break;
          case 26:
            (S.getLogger().debug("APA123", this ? this : "na"),
              S.getLogger().debug("COLUMNS: ", o[g]),
              (this.$ = { type: "column-setting", columns: o[g] === "auto" ? -1 : parseInt(o[g]) }));
            break;
          case 27:
            (S.getLogger().debug("Rule: id-block statement : ", o[g - 2], o[g - 1]),
              S.generateId(),
              (this.$ = { ...o[g - 2], type: "composite", children: o[g - 1] }));
            break;
          case 28:
          ...
          case 29:
            ...
            break;
          case 30:
            (S.getLogger().debug("Rule: node (NODE_ID nodeShapeNLabel separator): ", o[g - 1], o[g]),
              (this.$ = { id: o[g - 1], label: o[g].label, typeStr: o[g].typeStr, directions: o[g].directions }));
            break;
          case 31:
          ...
          case 32:
            ...
            break;
          case 33:
            (S.getLogger().debug("Rule: nodeShapeNLabel: ", o[g - 2], o[g - 1], o[g]),
              (this.$ = { typeStr: o[g - 2] + o[g], label: o[g - 1] }));
            break;
          case 34:
            (S.getLogger().debug("Rule: BLOCK_ARROW nodeShapeNLabel: ", o[g - 3], o[g - 2], " #3:", o[g - 1], o[g]),
              (this.$ = { typeStr: o[g - 3] + o[g], label: o[g - 2], directions: o[g - 1] }));
            break;
          case 35:
          case 36:
      ...
      table: [
        ...
        { 44: [1, 30] },
        { 47: [1, 31] },
        e(m, [2, 29], { 32: 32, 35: [1, 33], 37: [1, 34] }),
        { 1: [2, 7] },
        e(x, [2, 13]),
        { 26: 35, 31: s },
        { 31: [2, 14] },
      ...
      parse: d(function (y) {
        var u = this,
          ...
          K = 2,
          P = 1,
          Q = o.slice.call(arguments, 1),
          R = Object.create(this.lexer),
          U = { yy: {} };
        for (var et in this.yy) Object.prototype.hasOwnProperty.call(this.yy, et) && (U.yy[et] = this.yy[et]);
        (R.setInput(y, U.yy), (U.yy.lexer = R), (U.yy.parser = this), typeof R.yylloc > "u" && (R.yylloc = {}));
        var rt = R.yylloc;
        o.push(rt);
        var oe = R.options && R.options.ranges;
        ...
        function It() {
          ...
          return (
            (X = S.pop() || R.lex() || P),
            typeof X != "number" && (X instanceof Array && ((S = X), (X = S.pop())), (X = u.symbols_[X] || X)),
            X
          );
        }
        d(It, "lex");
        for (var H, $, V, ft, tt = {}, ct, J, Bt, ot; ; ) {
          if (
            (($ = p[p.length - 1]),
            this.defaultActions[$]
            ...
            var xt = "";
            ot = [];
            for (ct in k[$]) this.terminals_[ct] && ct > K && ot.push("'" + this.terminals_[ct] + "'");
            (R.showPosition
              ? (xt =
                  "Parse error on line " +
                  (D + 1) +
...
Expecting ` +
              ...
              : (xt =
                  ...
                  (D + 1) +
                  ": Unexpected " +
                  (H == P ? "end of input" : "'" + (this.terminals_[H] || H) + "'")),
              this.parseError(xt, {
                text: R.match,
          ...
          switch (V[0]) {
            ...
            case 2:
              if (
                ...
                oe && (tt._$.range = [o[o.length - (J || 1)].range[0], o[o.length - 1].range[1]]),
                (ft = this.performAction.apply(tt, [g, T, D, U.yy, V[1], E, o].concat(Q))),
                typeof ft < "u")
              )
                return ft;
              (J && ((p = p.slice(0, -1 * J * 2)), (E = E.slice(0, -1 * J)), (o = o.slice(0, -1 * J))),
                p.push(this.productions_[V[1]][0]),
                E.push(tt.$),
                o.push(tt._$),
                (Bt = k[p[p.length - 2]][p[p.length - 1]]),
                p.push(Bt));
              break;
            case 3:
              return !0;
    ...
    B = (function () {
      var N = {
        EOF: 1,
        parseError: d(function (u, p) {
          if (this.yy.parser) this.yy.parser.parseError(u, p);
          else throw new Error(u);
        }, "parseError"),
        setInput: d(function (y, u) {
          return (
            (this.yy = u || this.yy || {}),
            (this._input = y),
        ...
        unput: d(function (y) {
          ...
          ((this.match = this.match.substr(0, this.match.length - 1)),
            ...
            p.length - 1 && (this.yylineno -= p.length - 1));
          ...
          return (
            (this.yylloc = {
              ...
              last_column: p
                ? (p.length === S.length ? this.yylloc.first_column : 0) + S[S.length - p.length].length - p[0].length
                : this.yylloc.first_column - u,
            }),
            this.options.ranges && (this.yylloc.range = [E[0], E[0] + this.yyleng - u]),
...
` +
        ...
        test_match: d(function (y, u) {
          ...
          if (
            ...
            (this.matched += y[0]),
            (p = this.performAction.call(this, this.yy, this, u, this.conditionStack[this.conditionStack.length - 1])),
        ...
        next: d(function () {
          ...
          for (var E = this._currentRules(), o = 0; o < E.length; o++)
            if (((p = this._input.match(this.rules[E[o]])), p && (!u || p[0].length > u[0].length))) {
              if (((u = p), (S = o), this.options.backtrack_lexer)) {
                if (((y = this.test_match(p, E[o])), y !== !1)) return y;
                if (this._backtrack) {
                  u = !1;
                  continue;
                } else return !1;
          ...
          return u
            ? ((y = this.test_match(u, E[S])), y !== !1 ? y : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        options: {},
        performAction: d(function (u, p, S, E) {
          switch (S) {
            case 0:
            ...
            case 7:
              return (
                (p.yytext = p.yytext.replace(/columns\s+/, "")),
                u.getLogger().debug("COLUMNS (LEX)", p.yytext),
                28
              );
            case 8:
            ...
            case 14:
              return (
                (p.yytext = p.yytext.replace(/space\:/, "")),
                u.getLogger().debug("SPACE NUM (LEX)", p.yytext),
                21
              );
            case 15:
            ...
            case 85:
              return (
                (p.yytext = p.yytext.replace(/^,\s*/, "")),
                u.getLogger().debug("Lex (right): dir:", p.yytext),
                "DIR"
              );
            case 86:
            ...
            case 91:
              return (
                (p.yytext = "]>"),
                u.getLogger().debug("Lex (ARROW_DIR end):", p.yytext),
                this.popState(),
                this.popState(),
                "BLOCK_ARROW_END"
              );
...
var ke = bt,
  ...
  gt = new Map(),
  _t = "",
  Ne = d((e) => me.sanitizeText(e, Te), "sanitizeText"),
  Ie = d(function (e, t = "") {
    let a = gt.get(e);
    (a || ((a = { id: e, styles: [], textStyles: [] }), gt.set(e, a)),
      t != null &&
        t.split(Xt).forEach((i) => {
          ...
          if (RegExp(Rt).exec(i)) {
            const r = l.replace(zt, De).replace(Rt, zt);
            a.textStyles.push(r);
          }
          a.styles.push(l);
        }));
  ...
  jt = d((e, t) => {
    const a = e.flat(),
      i = [],
      l = a.find((r) => (r == null ? void 0 : r.type) === "column-setting"),
      s = (l == null ? void 0 : l.columns) ?? -1;
    for (const r of a) {
      if (
        (typeof s == "number" &&
          s > 0 &&
          r.type !== "column-setting" &&
          typeof r.widthInColumns == "number" &&
          r.widthInColumns > s &&
          v.warn(`Block ${r.id} width ${r.widthInColumns} exceeds configured column width ${s}`),
        r.label && (r.label = Ne(r.label)),
        r.type === "classDef")
      ) {
        Ie(r.id, r.css);
        continue;
      ...
      if (r.type === "applyClass") {
        Ce(r.id, (r == null ? void 0 : r.styleClass) ?? "");
        continue;
      }
      if (r.type === "applyStyles") {
        r != null && r.stylesStr && Be(r.id, r == null ? void 0 : r.stylesStr);
        continue;
      }
      if (r.type === "column-setting") t.columns = r.columns ?? -1;
        ...
        if (
          (n === void 0
            ? Z.set(r.id, r)
            : (r.type !== "na" && (n.type = r.type), r.label !== r.id && (n.label = r.label)),
          r.children && jt(r.children, r),
          r.type === "space")
        ) {
          const c = r.width ?? 1;
          for (let x = 0; x < c; x++) {
...
d(Zt, "edgeStrToEdgeData");
var At = 0,
  Re = d(() => (At++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + At), "generateId"),
  ze = d((e) => {
  ...
  Me = d(() => [...Z.values()], "getBlocksFlat"),
  Fe = d(() => kt || [], "getBlocks"),
  Pe = d(() => Et, "getEdges"),
  We = d((e) => Z.get(e), "getBlock"),
  Ye = d((e) => {
    Z.set(e.id, e);
  }, "setBlock"),
  He = d((e) => {
  ...
  Ke = d(() => _t, "getDiagramId"),
  Ue = d(() => v, "getLogger"),
  Xe = d(function () {
    return gt;
  }, "getClasses"),
  je = {
    getConfig: d(() => lt().block, "getConfig"),
    typeStr2Type: Vt,
    edgeTypeStr2Type: Gt,
...
`,
  ...
  Kt,
  Ut,
  A = ((Ut = (Kt = M()) == null ? void 0 : Kt.block) == null ? void 0 : Ut.padding) ?? 8;
function mt(e, t) {
...
var cr = d((e) => {
  ...
  for (const i of e.children) {
    ...
    (v.debug("getMaxChildSize abc95 child:", i.id, "width:", l, "height:", s, "x:", r, "y:", n, i.type),
      i.type !== "space" && (l > t && (t = l / (i.widthInColumns ?? 1)), s > a && (a = s)));
  }
  return { width: t, height: a };
}, "getMaxChildSize");
function dt(e, t, a = 0, i = 0) {
  var r, n, c, x, h, f, w, b, m, _, L;
  (v.debug(
  ...
  if (((c = e.children) == null ? void 0 : c.length) > 0) {
    for (const E of e.children) dt(E, t);
    const B = cr(e);
    ((l = B.width), (s = B.height), v.debug("setBlockSizes abc95 maxWidth of", e.id, ":s children is ", l, s));
    for (const E of e.children)
      E.size &&
        (v.debug(`abc95 Setting size of children of ${e.id} id=${E.id} ${l} ${s} ${JSON.stringify(E.size)}`),
        (E.size.width = l * (E.widthInColumns ?? 1) + A * ((E.widthInColumns ?? 1) - 1)),
        (E.size.height = s),
        (E.size.x = 0),
        (E.size.y = 0),
        v.debug(`abc95 updating size of ${e.id} children child:${E.id} maxWidth:${l} maxHeight:${s}`));
    for (const E of e.children) dt(E, t, l, s);
    const I = e.columns ?? -1;
    let N = 0;
    for (const E of e.children) N += E.widthInColumns ?? 1;
    ...
    let p = y * (l + A) + A,
      S = u * (s + A) + A;
    if (p < a) {
      (v.debug(`Detected to small sibling: abc95 ${e.id} siblingWidth ${a} siblingHeight ${i} width ${p}`),
        (p = a),
        (S = i));
      const E = (a - y * A - A) / y,
        o = (i - u * A - A) / u;
      (v.debug("Size indata abc88", e.id, "childWidth", E, "maxWidth", l),
        v.debug("Size indata abc88", e.id, "childHeight", o, "maxHeight", s),
        v.debug("Size indata abc88 xSize", y, "padding", A));
      for (const k of e.children) k.size && ((k.size.width = E), (k.size.height = o), (k.size.x = 0), (k.size.y = 0));
    }
    if (
      (v.debug(
      ...
      if (E > 0) {
        ...
        for (const k of e.children) k.size && (k.size.width = o);
      }
    }
    e.size = { width: p, height: S, x: 0, y: 0 };
  }
  v.debug(
    ...
    (_ = e == null ? void 0 : e.size) == null ? void 0 : _.y,
    (L = e == null ? void 0 : e.size) == null ? void 0 : L.height
  );
}
d(dt, "setBlockSizes");
function Dt(e, t) {
  var i, l, s, r, n, c, x, h, f, w, b, m, _, L, B, I, N;
  v.debug(
  ...
  const a = e.columns ?? -1;
  if ((v.debug("layoutBlocks columns abc95", e.id, "=>", a, e), e.children && e.children.length > 0)) {
    const y =
        ((n = (r = e == null ? void 0 : e.children[0]) == null ? void 0 : r.size) == null ? void 0 : n.width) ?? 0,
      u = e.children.length * y + (e.children.length - 1) * A;
    ...
    const S = new Map();
    {
      ...
      for (const T of D) (S.set(T, g), (g += (p.get(T) ?? 0) + A));
    }
    let E = 0;
    v.debug("abc91 block?.size?.x", e.id, (c = e == null ? void 0 : e.size) == null ? void 0 : c.x);
    let o =
        (x = e == null ? void 0 : e.size) != null && x.x
          ? ((h = e == null ? void 0 : e.size) == null ? void 0 : h.x) +
            (-((f = e == null ? void 0 : e.size) == null ? void 0 : f.width) / 2 || 0)
          : -A,
      k = 0;
    for (const g of e.children) {
      const D = e;
      if (!g.size) continue;
      const { width: T, height: K } = g.size,
        { px: P, py: Q } = mt(a, E);
      if (
        (Q != k &&
          ((k = Q),
          (o =
            (w = e == null ? void 0 : e.size) != null && w.x
              ? ((b = e == null ? void 0 : e.size) == null ? void 0 : b.x) +
                (-((m = e == null ? void 0 : e.size) == null ? void 0 : m.width) / 2 || 0)
              : -A),
          v.debug("New row in layout for block", e.id, " and child ", g.id, k)),
        v.debug(
          `abc89 layout blocks (child) id: ${g.id} Pos: ${E} (px, py) ${P},${Q} (${(_ = D == null ? void 0 : D.size) == null ? void 0 : _.x},${(L = D == null ? void 0 : D.size) == null ? void 0 : L.y}) parent: ${D.id} width: ${T}${A}`
        ),
        D.size)
      ) {
        const U = T / 2;
        ...
        const et = S.get(Q) ?? 0,
          rt = p.get(Q) ?? K;
        ((g.size.y = D.size.y - D.size.height / 2 + et + rt / 2 + A),
          v.debug(
...
function qt(e) {
  ...
  if (!t) return;
  (dt(t, e, 0, 0), Dt(t), v.debug("getBlocks", JSON.stringify(t, null, 2)));
...
var or = d(async (e, t, a, i = !1, l = !1) => {
    ...
    return await vt(
      e,
      s,
      { style: a, isTitle: i, useHtmlLabels: n, markdown: !1, isNode: l, width: Number.POSITIVE_INFINITY },
      r
    );
  }, "createLabel"),
  G = or,
  hr = d((e, t, a, i, l) => {
    (t.arrowTypeStart && Mt(e, "start", t.arrowTypeStart, a, i, l),
      t.arrowTypeEnd && Mt(e, "end", t.arrowTypeEnd, a, i, l));
  }, "addEdgeMarkers"),
  gr = {
    arrow_cross: "cross",
    arrow_point: "point",
  ...
  dr = d(async (e, t) => {
    const a = M(),
      ...
      s = l.insert("g").attr("class", "label"),
      r = t.labelType === "markdown",
      n = await vt(
        e,
        t.label,
        {
    ...
    let h;
    if (t.startLabelLeft) {
      const f = e.insert("g").attr("class", "edgeTerminals"),
        w = f.insert("g").attr("class", "inner"),
        b = await G(w, t.startLabelLeft, t.labelStyle);
      h = b;
      let m = b.getBBox();
      if (i) {
        const _ = b.children[0],
          L = C(b);
        ((m = _.getBoundingClientRect()), L.attr("width", m.width), L.attr("height", m.height));
      }
    ...
    if (t.startLabelRight) {
      const f = e.insert("g").attr("class", "edgeTerminals"),
        w = f.insert("g").attr("class", "inner"),
        b = await G(f, t.startLabelRight, t.labelStyle);
    ...
    if (t.endLabelLeft) {
      const f = e.insert("g").attr("class", "edgeTerminals"),
        w = f.insert("g").attr("class", "inner"),
        b = await G(w, t.endLabelLeft, t.labelStyle);
      h = b;
      let m = b.getBBox();
      if (i) {
        const _ = b.children[0],
    ...
    if (t.endLabelRight) {
      const f = e.insert("g").attr("class", "edgeTerminals"),
        w = f.insert("g").attr("class", "inner"),
        b = await G(w, t.endLabelRight, t.labelStyle);
      h = b;
      let m = b.getBBox();
      if (i) {
        const _ = b.children[0],
...
var ur = d((e, t) => {
    ...
    const i = M(),
      { subGraphTitleTotalMargin: l } = we(i);
    if (e.label) {
      const s = Lt[e.id];
      let r = e.x,
        n = e.y;
      if (a) {
        ...
        (v.debug("Moving label " + e.label + " from (", r, ",", n, ") to (", c.x, ",", c.y, ") abc88"),
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(l - t.y) * r > Math.abs(i - t.x) * c) {
      ...
      n = (h * f) / x;
      const w = { x: a.x < t.x ? a.x + n : a.x - h + n, y: a.y < t.y ? a.y + x - f : a.y - x + f };
      return (
        n === 0 && ((w.x = t.x), (w.y = t.y)),
        h === 0 && (w.x = t.x),
        x === 0 && (w.y = t.y),
        v.debug(`abc89 topp/bott calc, Q ${x}, q ${f}, R ${h}, r ${n}`, w),
        w
      );
    } else {
      a.x < t.x ? (n = t.x - r - i) : (n = i - r - t.x);
      let f = (x * n) / h,
        w = a.x < t.x ? a.x + h - n : a.x - h + n,
        b = a.y < t.y ? a.y + f : a.y - f;
      return (
        v.debug(`sides calc abc89, Q ${x}, q ${f}, R ${h}, r ${n}`, { _x: w, _y: b }),
        n === 0 && ((w = t.x), (b = t.y)),
        h === 0 && (w = t.x),
        x === 0 && (b = t.y),
        { x: w, y: b }
  ...
  xr = d(function (e, t, a, i, l, s, r) {
    ...
    (h != null &&
      ...
      x != null &&
      x.intersect &&
      ((n = n.slice(1, a.points.length - 1)), n.unshift(x.intersect(n[0])), n.push(h.intersect(n[n.length - 1]))),
      a.toCluster && (v.debug("to cluster abc88", i[a.toCluster]), (n = Ft(a.points, i[a.toCluster].node)), (c = !0)),
      a.fromCluster &&
        (v.debug("from cluster abc88", i[a.fromCluster]),
        (n = Ft(n.reverse(), i[a.fromCluster].node).reverse()),
        (c = !0)));
    const f = n.filter((y) => !Number.isNaN(y.y));
    let w = ye;
    a.curve && (l === "graph" || l === "flowchart") && (w = a.curve);
    const { x: b, y: m } = fe(a),
      _ = xe().x(b).y(m).curve(w);
    let L;
    switch (a.thickness) {
      case "normal":
    ...
    const B = e
      ...
      .attr("d", _(f))
      .attr("id", a.id)
      .attr("class", " " + L + (a.classes ? " " + a.classes : ""))
      .attr("style", a.style);
    let I = "";
    ((M().flowchart.arrowMarkerAbsolute || M().state.arrowMarkerAbsolute) && (I = be(!0)), hr(B, a, I, r, l));
    let N = {};
...
var mr = te;
function ee(e, t, a, i) {
  var l, s, r, n, c, x, h, f, w, b, m, _, L, B, I;
  if (
    ((l = t.y - e.y),
    (r = e.x - t.x),
    (c = t.x * e.y - e.x * t.y),
...
function re(e, t, a) {
  ...
  for (var c = i - e.width / 2 - r, x = l - e.height / 2 - n, h = 0; h < t.length; h++) {
    var f = t[h],
      w = t[h < t.length - 1 ? h + 1 : 0],
      b = Lr(e, a, { x: c + f.x, y: x + f.y }, { x: c + w.x, y: x + w.y });
    b && s.push(b);
  }
  return s.length
    ? (s.length > 1 &&
...
var vr = d((e, t) => {
    ...
    return (
      Math.abs(s) * r > Math.abs(l) * n
        ? (s < 0 && (n = -n), (c = s === 0 ? 0 : (n * l) / s), (x = n))
        : (l < 0 && (r = -r), (c = r), (x = l === 0 ? 0 : (r * s) / l)),
      { x: a + c, y: i + x }
    );
  }, "intersectRect"),
  Er = vr,
  O = { node: wr, circle: mr, ellipse: $t, polygon: Sr, rect: Er },
  F = d(async (e, t, a, i) => {
    const l = M();
    let s;
    ...
    t.labelType === "markdown"
      ...
      : (h = await G(c, Ct(Ot(x), l), t.labelStyle, !1, i));
    let f = h.getBBox();
    const w = t.padding / 2;
    if (Y(l)) {
      const b = h.children[0],
        m = C(h);
      (await Se(b, x), (f = b.getBoundingClientRect()), m.attr("width", f.width), m.attr("height", f.height));
    }
    return (
      r
        ? c.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")")
        : c.attr("transform", "translate(0, " + -f.height / 2 + ")"),
      t.centerLabel && c.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"),
      c.insert("rect", ":first-child"),
      { shapeSvg: n, bbox: f, halfPadding: w, label: c }
    );
  }, "labelHelper"),
  z = d((e, t) => {
...
var _r = d(async (e, t) => {
    ...
    const { shapeSvg: i, bbox: l, halfPadding: s } = await F(e, t, "node " + t.classes, !0);
  ...
  kr = _r,
  Pt = d((e) => (e ? " " + e : ""), "formatClass"),
  j = d((e, t) => `${t || "node default"}${Pt(e.classes)} ${Pt(e.class)}`, "getClassesFromNode"),
  Wt = d(async (e, t) => {
    const { shapeSvg: a, bbox: i } = await F(e, t, j(t, void 0), !0),
      l = i.width + t.padding,
  ...
  Nr = d(async (e, t) => {
    const { shapeSvg: a, bbox: i } = await F(e, t, void 0, !0),
      l = 2,
      s = i.height + 2 * t.padding,
      r = s / l,
      n = i.width + 2 * r + t.padding,
      c = br(t.directions, i, t),
      x = q(a, n, s, c);
    return (
      x.attr("style", t.style),
      z(t, x),
  ...
  Br = d(async (e, t) => {
    const { shapeSvg: a, bbox: i } = await F(e, t, j(t), !0),
      l = i.width + t.padding,
      s = i.height + t.padding,
      r = [
        { x: (-2 * s) / 6, y: 0 },
  ...
  Ar = d(async (e, t) => {
    ...
    return (
      ...
      (t.intersect = function (h) {
        ...
        if (
          s != 0 &&
          (Math.abs(w) < t.width / 2 || (Math.abs(w) == t.width / 2 && Math.abs(f.y - t.y) > t.height / 2 - r))
        ) {
          let b = r * r * (1 - (w * w) / (s * s));
  ...
  Mr = d(async (e, t) => {
    const { shapeSvg: a, bbox: i, halfPadding: l } = await F(e, t, "node " + t.classes + " " + t.class, !0),
      ...
      x = t.positioned ? -n / 2 : -i.height / 2 - l;
    if (
      (s
      ...
      (t.props.borders && (ut(s, t.props.borders, r, n), h.delete("borders")),
        h.forEach((f) => {
  ...
  Fr = d(async (e, t) => {
    const { shapeSvg: a, bbox: i, halfPadding: l } = await F(e, t, "node " + t.classes, !0),
      s = a.insert("rect", ":first-child"),
      r = t.positioned ? t.width : i.width + t.padding,
      n = t.positioned ? t.height : i.height + t.padding,
      c = t.positioned ? -r / 2 : -i.width / 2 - l,
  ...
  Pr = d(async (e, t) => {
    ...
    if ((i.attr("width", l).attr("height", s), a.attr("class", "label edgeLabel"), t.props)) {
      ...
      (t.props.borders && (ut(i, t.props.borders, l, s), r.delete("borders")),
        r.forEach((n) => {
...
function ut(e, t, a, i) {
  ...
  (t.includes("t") ? (v.debug("add top border"), s(a)) : r(a),
    t.includes("r") ? (v.debug("add right border"), s(i)) : r(i),
    t.includes("b") ? (v.debug("add bottom border"), s(a)) : r(a),
    t.includes("l") ? (v.debug("add left border"), s(i)) : r(i),
...
var Wr = d(async (e, t) => {
    ...
    if (Y(M())) {
      const _ = x.children[0],
        L = C(x);
      ((h = _.getBoundingClientRect()), L.attr("width", h.width), L.attr("height", h.height));
    }
    v.info("Text 2", n);
    const f = n.slice(1, n.length);
    let w = x.getBBox();
    const b = await G(r, f.join ? f.join("<br/>") : f, t.labelStyle, !0, !0);
    if (Y(M())) {
      const _ = b.children[0],
        L = C(b);
      ((h = _.getBoundingClientRect()), L.attr("width", h.width), L.attr("height", h.height));
    ...
    return (
      C(b).attr(
        "transform",
        "translate( " + (h.width > w.width ? 0 : (w.width - h.width) / 2) + ", " + (w.height + m + 5) + ")"
      ),
      C(x).attr("transform", "translate( " + (h.width < w.width ? 0 : -(w.width - h.width) / 2) + ", 0)"),
      (h = r.node().getBBox()),
      r.attr("transform", "translate(" + -h.width / 2 + ", " + (-h.height / 2 - m + 3) + ")"),
      l
      ...
      s
        ...
        .attr("x1", -h.width / 2 - m)
        .attr("x2", h.width / 2 + m)
        .attr("y1", -h.height / 2 - m + w.height + m)
        .attr("y2", -h.height / 2 - m + w.height + m),
      z(t, l),
  ...
  Hr = d(async (e, t) => {
    const { shapeSvg: a, bbox: i, halfPadding: l } = await F(e, t, j(t, void 0), !0),
  ...
  Vr = d(async (e, t) => {
    ...
    let b = 0;
    const m = (E = t.classData.annotations) == null ? void 0 : E[0],
      _ = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "",
      L = await G(w, _, t.labelStyle, !0, !0);
    let B = L.getBBox();
    if (Y(M())) {
      const o = L.children[0],
        k = C(L);
      ((B = o.getBoundingClientRect()), k.attr("width", B.width), k.attr("height", B.height));
    }
    t.classData.annotations[0] && ((f += B.height + i), (h += B.width));
    let I = t.classData.label;
    t.classData.type !== void 0 &&
      t.classData.type !== "" &&
      (Y(M()) ? (I += "&lt;" + t.classData.type + "&gt;") : (I += "<" + t.classData.type + ">"));
    const N = await G(w, I, t.labelStyle, !0, !0);
    C(N).attr("class", "classTitle");
    let y = N.getBBox();
    if (Y(M())) {
      const o = N.children[0],
        k = C(N);
      ((y = o.getBoundingClientRect()), k.attr("width", y.width), k.attr("height", y.height));
    }
    ((f += y.height + i), y.width > h && (h = y.width));
    const u = [];
    (t.classData.members.forEach(async (o) => {
      const k = o.getDisplayDetails();
      let g = k.displayText;
      Y(M()) && (g = g.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
      const D = await G(w, g, k.cssStyle ? k.cssStyle : t.labelStyle, !0, !0);
      let T = D.getBBox();
      if (Y(M())) {
    ...
    if (
      ...
      let o = (h - B.width) / 2;
      (C(L).attr("transform", "translate( " + ((-1 * h) / 2 + o) + ", " + (-1 * f) / 2 + ")"), (b = B.height + i));
    }
    let S = (h - y.width) / 2;
    return (
      C(N).attr("transform", "translate( " + ((-1 * h) / 2 + S) + ", " + ((-1 * f) / 2 + b) + ")"),
      (b += y.height + i),
      c
        .attr("class", "divider")
        .attr("x1", -h / 2 - a)
      ...
      (b += l),
      u.forEach((o) => {
        C(o).attr("transform", "translate( " + -h / 2 + ", " + ((-1 * f) / 2 + b + l / 2) + ")");
        const k = o == null ? void 0 : o.getBBox();
        b += ((k == null ? void 0 : k.height) ?? 0) + i;
      }),
      (b += l),
      x
        .attr("class", "divider")
      ...
      (b += l),
      p.forEach((o) => {
        C(o).attr("transform", "translate( " + -h / 2 + ", " + ((-1 * f) / 2 + b) + ")");
        const k = o == null ? void 0 : o.getBBox();
        b += ((k == null ? void 0 : k.height) ?? 0) + i;
      }),
      n
  ...
  Ht = {
    ...
    hexagon: Tr,
    block_arrow: Nr,
    rect_left_inv_arrow: Ir,
    lean_right: Br,
    lean_left: Cr,
    trapezoid: Or,
    inv_trapezoid: Rr,
    rect_right_inv_arrow: zr,
    cylinder: Ar,
    start: Xr,
    end: jr,
    note: kr,
  ...
  ae = d(async (e, t, a) => {
    ...
    if (t.link) {
      let s;
      (M().securityLevel === "sandbox" ? (s = "_top") : t.linkTarget && (s = t.linkTarget || "_blank"),
        (i = e.insert("svg:a").attr("xlink:href", t.link).attr("target", s)),
        (l = await Ht[t.shape](i, t, a)));
    } else ((l = await Ht[t.shape](e, t, a)), (i = l));
    return (
      t.tooltip && l.attr("title", t.tooltip),
      t.class && l.attr("class", "node default " + t.class),
      (ht[t.id] = i),
      t.haveCallback && ht[t.id].attr("class", ht[t.id].attr("class") + " clickable"),
      i
    );
  }, "insertNode"),
  Gr = d((e) => {
    const t = ht[e.id];
    v.trace("Transforming node", e.diff, e, "translate(" + (e.x - e.width / 2 - 5) + ", " + e.width / 2 + ")");
    const a = 8,
      i = e.diff || 0;
    return (
      e.clusterNode
...
function Nt(e, t, a = !1) {
  ...
  ((((b = i == null ? void 0 : i.classes) == null ? void 0 : b.length) || 0) > 0 &&
    (l = ((i == null ? void 0 : i.classes) ?? []).join(" ")),
    (l = l + " flowchart-label"));
  let s = 0,
    r = "",
    n;
  ...
  const c = Le((i == null ? void 0 : i.styles) ?? []),
    x = i.label,
    h = i.size ?? { width: 0, height: 0, x: 0, y: 0 },
    f = t.getDiagramId();
  return {
    ...
    intersect: void 0,
    type: i.type,
    padding: n ?? ((_ = (m = lt()) == null ? void 0 : m.block) == null ? void 0 : _.padding) ?? 0,
  };
}
...
async function ie(e, t, a) {
  ...
  if (a.getBlock(i.id).type !== "space") {
    const s = lt();
    (await ae(e, i, { config: s }), (t.intersect = i == null ? void 0 : i.intersect), Gr(i));
  }
}
d(ie, "insertBlockPositioned");
async function pt(e, t, a, i) {
  for (const l of t) (await i(e, l, a), l.children && (await pt(e, l.children, a, i)));
}
...
async function ce(e, t, a, i, l) {
  const s = new Ee({ multigraph: !0, compound: !0 });
      ...
      if (n != null && n.size && c != null && c.size) {
        ...
        (xr(
          ...
          r.label &&
            ...
            ur({ ...r, x: f[1].x, y: f[1].y }, { originalPath: f })));
      }
    }
}
d(ce, "insertEdges");
var Zr = d(function (e, t) {
    return t.db.getClasses();
  }, "getClasses"),
  qr = d(async function (e, t, a, i) {
    const { securityLevel: l, block: s } = lt(),
      r = i.db;
    r.setDiagramId(t);
    let n;
    l === "sandbox" && (n = C("#i" + t));
    const c = l === "sandbox" ? C(n.nodes()[0].contentDocument.body) : C("body"),
      x = l === "sandbox" ? c.select(`[id="${t}"]`) : C(`[id="${t}"]`);
    lr(x, ["point", "circle", "cross"], i.type, t);
    const f = r.getBlocks(),
      w = r.getBlocksFlat(),
      b = r.getEdges(),
      m = x.insert("g").attr("class", "block");
    await ne(m, f, r);
    const _ = qt(r);
    if ((await le(m, f, r), await ce(m, b, w, r, t), _)) {
      const L = _,
        B = Math.max(1, Math.round(0.125 * (L.width / L.height))),
        I = L.height + B + 10,
        N = L.width + 10,
        { useMaxWidth: y } = s;
      (de(x, I, N, !!y),
        v.debug("Here Bounds", _, L),
        x.attr("viewBox", `${L.x - 5} ${L.y - 5} ${L.width + 10} ${L.height + 10}`));
    }
  }, "draw"),
  Jr = { draw: qr, getClasses: Zr },
