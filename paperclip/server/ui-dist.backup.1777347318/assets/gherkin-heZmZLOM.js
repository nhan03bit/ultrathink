  ...
  token: function (n, e) {
    if (
      (n.sol() &&
        ...
        e.inMultilineTable &&
          ((e.tableHeaderLine = !1),
          n.match(/\s*\|/, !1) || ((e.allowMultilineArgument = !1), (e.inMultilineTable = !1)))),
      n.eatSpace(),
      e.allowMultilineArgument)
    ) {
      if (e.inMultilineString)
        return (
          n.match('"""') ? ((e.inMultilineString = !1), (e.allowMultilineArgument = !1)) : n.match(/.*/),
          "string"
        );
      if (e.inMultilineTable)
        return n.match(/\|\s*/) ? "bracket" : (n.match(/[^\|]*/), e.tableHeaderLine ? "header" : "string");
      if (n.match('"""')) return ((e.inMultilineString = !0), "string");
      if (n.match("|")) return ((e.inMultilineTable = !0), (e.tableHeaderLine = !0), "bracket");
    }
    return n.match(/#.*/)
      ? "comment"
      : !e.inKeywordLine && n.match(/@\S+/)
        ? "tag"
        : !e.inKeywordLine &&
            e.allowFeature &&
            n.match(
          ...
          ? ((e.allowScenario = !0),
            (e.allowBackground = !0),
            (e.allowPlaceholders = !1),
            (e.allowSteps = !1),
            (e.allowMultilineArgument = !1),
            (e.inKeywordLine = !0),
            "keyword")
          : !e.inKeywordLine &&
              e.allowBackground &&
              ...
              : e.allowScenario &&
                ...
                : !e.inKeywordLine &&
                  ...
                  : !e.inKeywordLine &&
                    ...
                    : n.match(/"[^"]*"?/)
                      ? "string"
                      : e.allowPlaceholders && n.match(/<[^>]*>?/)
                        ? "variable"
                        : (n.next(), n.eatWhile(/[^@"<#]/), null);
  },
};
export { a as gherkin };
