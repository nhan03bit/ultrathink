...
function i(e, n) {
  ...
  if (t)
    return (
      n.doInCurrentLine ? (n.doInCurrentLine = !1) : n.currentIndent++,
      t[0] == "proc" || t[0] == "fun"
        ? (n.tokenize = x)
        : t[0] == "class"
          ? (n.tokenize = g)
          : t[0] == "meth" && (n.tokenize = w),
      "keyword"
    );
  ...
  if (/[~\d]/.test(r)) {
    ...
    return (r == "0" && e.match(/^[xX][0-9a-fA-F]+/)) || e.match(/^[0-9]*(\.[0-9]+)?([eE][~+]?[0-9]+)?/)
      ? "number"
      : null;
  }
  return r == "%"
...
function x(e, n) {
  return e.eatSpace()
    ? null
    : !n.hasPassedFirstStage && e.eat("{")
      ? ((n.hasPassedFirstStage = !0), "bracket")
      : n.hasPassedFirstStage
        ? (e.match(/([A-Z][A-Za-z0-9_]*)|(`.+`)|\$/), (n.hasPassedFirstStage = !1), (n.tokenize = i), "def")
        : ((n.tokenize = i), null);
}
function a(e, n) {
...
const I = {
  name: "oz",
  startState: function () {
    return { tokenize: i, currentIndent: 0, doInCurrentLine: !1, hasPassedFirstStage: !1 };
  },
  token: function (e, n) {
  ...
  indent: function (e, n, t) {
    ...
    return r.match(h) || r.match(d) || r.match(/(\[])/)
      ? t.unit * (e.currentIndent - 1)
      : e.currentIndent < 0
        ? 0
        : e.currentIndent * t.unit;
  },
