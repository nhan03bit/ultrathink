import { _ as V, l as $, d as lt } from "./mermaid.core-gIfAqAR1.js";
import { c as tt } from "./cytoscape.esm-CheSGy0x.js";
import { K as gt } from "./index-DsVzfBkh.js";
var k = { exports: {} },
  Z = { exports: {} },
  Q = { exports: {} },
  ut = Q.exports,
        ...
        (function (I, T) {
          ...
          return (function (N) {
            ...
            return (
              ...
              (T.d = function (o, e, t) {
                T.o(o, e) || Object.defineProperty(o, e, { configurable: !1, enumerable: !0, get: t });
              }),
              (T.n = function (o) {
                var e =
                  o && o.__esModule
            ...
            function (N, I, T) {
              function o() {}
              ((o.QUALITY = 1),
                (o.DEFAULT_CREATE_BENDS_AS_NEEDED = !1),
                (o.DEFAULT_INCREMENTAL = !1),
                (o.DEFAULT_ANIMATION_ON_LAYOUT = !0),
                (o.DEFAULT_ANIMATION_DURING_LAYOUT = !1),
                (o.DEFAULT_ANIMATION_PERIOD = 50),
                (o.DEFAULT_UNIFORM_LEAF_NODE_SIZES = !1),
                (o.DEFAULT_GRAPH_MARGIN = 15),
                (o.NODE_DIMENSIONS_INCLUDE_LABELS = !1),
                (o.SIMPLE_NODE_SIZE = 40),
                (o.SIMPLE_NODE_HALF_SIZE = o.SIMPLE_NODE_SIZE / 2),
                (o.EMPTY_COMPOUND_NODE_SIZE = 40),
                (o.MIN_EDGE_LENGTH = 1),
                (o.WORLD_BOUNDARY = 1e6),
                (o.INITIAL_WORLD_BOUNDARY = o.WORLD_BOUNDARY / 1e3),
            ...
            function (N, I, T) {
              ...
              ((h.prototype.getNodes = function () {
                ...
                (h.prototype.updateLeftTop = function () {
                  for (
                    var p = e.MAX_VALUE, v = e.MAX_VALUE, D, u, E, y = this.getNodes(), O = y.length, s = 0;
                    s < O;
                    s++
                  ) {
                    var f = y[s];
                  ...
                  return p == e.MAX_VALUE
                    ? null
                    : (y[0].getParent().paddingLeft != null ? (E = y[0].getParent().paddingLeft) : (E = this.margin),
                      (this.left = v - E),
                      (this.top = p - E),
                ...
                (h.prototype.updateBounds = function (p) {
                  ...
                  var R = new n(v, u, D - v, E - u);
                  (v == e.MAX_VALUE &&
                    ((this.left = this.parent.getLeft()),
                    (this.right = this.parent.getRight()),
                    (this.top = this.parent.getTop()),
                    (this.bottom = this.parent.getBottom())),
                    L[0].getParent().paddingLeft != null ? (c = L[0].getParent().paddingLeft) : (c = this.margin),
                    (this.left = R.x - c),
              ...
              ((t.prototype.addRoot = function () {
                ...
                (t.prototype.add = function (i, l, g, n, d) {
                  if (g == null && n == null && d == null) {
                    ...
                    if (r == h) return ((g.isInterGraph = !1), r.add(g, n, d));
                ...
                (t.prototype.remove = function (i) {
                  if (i instanceof o) {
                    ...
                    for (var n, d = g.length, r = 0; r < d; r++) ((n = g[r]), l.remove(n));
                    var h = [];
                    ...
                    if (((n = i), n == null)) throw "Edge is null!";
                    if (!n.isInterGraph) throw "Not an inter-graph edge!";
                    if (!(n.source != null && n.target != null)) throw "Source and/or target is null!";
                    ...
                    if (
                      ...
                      !(n.source.owner != null && n.source.owner.getGraphManager() != null))
                    )
                ...
                (t.prototype.isOneAncestorOfOther = function (i, l) {
                  ...
                  var g = i.getOwner(),
                    n;
                  do {
                    if (((n = g.getParent()), n == null)) break;
                    if (n == l) return !0;
                    if (((g = n.getOwner()), g == null)) break;
                  } while (!0);
                  g = l.getOwner();
                  do {
                    if (((n = g.getParent()), n == null)) break;
              ...
              ((e.calcSeparationAmount = function (t, i, l, g) {
                ...
                (e.getIntersection2 = function (t, i, l) {
                  var g = t.getCenterX(),
                    ...
                    d = i.getCenterX(),
                    r = i.getCenterY();
                  if (t.intersects(i)) return ((l[0] = g), (l[1] = n), (l[2] = d), (l[3] = r), !0);
                  var h = t.getX(),
                    a = t.getY(),
                    p = t.getRight(),
                    v = t.getX(),
                    ...
                    M = !1;
                  if (g === d) {
                    if (n > r) return ((l[0] = g), (l[1] = a), (l[2] = d), (l[3] = L), !1);
                    if (n < r) return ((l[0] = g), (l[1] = D), (l[2] = d), (l[3] = s), !1);
                  } else if (n === r) {
                    if (g > d) return ((l[0] = h), (l[1] = n), (l[2] = f), (l[3] = r), !1);
                    if (g < d) return ((l[0] = p), (l[1] = n), (l[2] = O), (l[3] = r), !1);
                  } else {
                    ...
                    if (
                      ...
                      -Y === w
                        ? d > g
                          ? ((l[2] = c), (l[3] = L), (M = !0))
                          : ((l[2] = f), (l[3] = s), (M = !0))
                        : Y === w && (d > g ? ((l[2] = O), (l[3] = s), (M = !0)) : ((l[2] = A), (l[3] = L), (M = !0))),
                      R && M)
                    )
                      return !1;
                    if (
                ...
                (e.getIntersection = function (t, i, l, g) {
                  ...
                  return (
                    ...
                    (L = v * p - a * D),
                    (A = y * f - O * s),
                    A === 0 ? null : ((u = (s * L - f * c) / A), (E = (O * c - y * L) / A), new o(u, E))
                  );
                }),
                (e.angleOfVector = function (t, i, l, g) {
                  ...
                  return (
                    t !== l
                      ? ((n = Math.atan((g - i) / (l - t))), l < t ? (n += Math.PI) : g < i && (n += this.TWO_PI))
                      : g < i
                  ...
                  for (var p = 0; p < a.length; p++) {
                    ...
                    if (v.bendpoints.length > 0) {
                      for (var D = this.edgeToDummyNodes.get(v), u = 0; u < D.length; u++) {
                        var E = D[u],
                          y = new n(E.getCenterX(), E.getCenterY()),
              ...
              ((n.prototype.initParameters = function () {
                ...
                (n.prototype.calcRepulsionForce = function (r, h) {
                  ...
                  if (a.intersects(p)) {
                    ...
                    ((r.repulsionForceX -= L * f),
                      (r.repulsionForceY -= L * c),
                      (h.repulsionForceX += L * f),
                      (h.repulsionForceY += L * c));
                  } else
                    (this.uniformLeafNodeSizes && r.getChild() == null && h.getChild() == null
                      ? ((u = p.getCenterX() - a.getCenterX()), (E = p.getCenterY() - a.getCenterY()))
                      : (l.getIntersection(a, p, D), (u = D[2] - D[0]), (E = D[3] - D[1])),
                      Math.abs(u) < t.MIN_REPULSION_DIST && (u = g.sign(u) * t.MIN_REPULSION_DIST),
                      Math.abs(E) < t.MIN_REPULSION_DIST && (E = g.sign(E) * t.MIN_REPULSION_DIST),
                      (y = u * u + E * E),
                      (O = Math.sqrt(y)),
                ...
                (n.prototype.addNodeToGrid = function (r, h, a) {
                  ...
                  for (var E = p; E <= v; E++)
                    for (var y = D; y <= u; y++) (this.grid[E][y].push(r), r.setGridCoordinates(p, v, D, u));
                }),
                ...
                (n.prototype.calculateRepulsionForceOfANode = function (r, h, a, p) {
                      ...
                      for (var y = r.startY - 1; y < r.finishY + 2; y++)
                        if (!(E < 0 || y < 0 || E >= u.length || y >= u[0].length)) {
                          for (var O = 0; O < u[E][y].length; O++)
                            if (
                              ((D = u[E][y][O]), !(r.getOwner() != D.getOwner() || r == D) && !h.has(D) && !v.has(D))
                            ) {
                  ...
                  for (E = 0; E < r.surrounding.length; E++) this.calcRepulsionForce(r, r.surrounding[E]);
                }),
                      ...
                      },
                      {
                        ...
                        value: function (n, d, r) {
                          for (var h = this._get(n, d), a = d, p = r; ; ) {
                            for (; this.compareFunction(h, this._get(n, p)); ) p--;
                            for (; this.compareFunction(this._get(n, a), h); ) a++;
                            if (a < p) (this._swap(n, a, p), a++, p--);
                            else return p;
                          }
                        },
                      },
                ...
                return (
                  o(i, [
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (
                          ...
                          var n = g[0],
                            d = this.tracebackGrid[n.pos[0]][n.pos[1]];
                          (d[0] &&
                            g.push({
                    ...
                    },
                    {
                      key: "getAllIndexes",
                      value: function (g, n) {
                        for (var d = [], r = -1; (r = g.indexOf(n, r + 1)) !== -1; ) d.push(r);
                        return d;
                      },
                    },
                    {
            ...
            function (N, I, T) {
              ...
              ((o.FDLayout = T(18)),
                ...
                (o.LNode = T(3)),
                (o.Layout = T(15)),
                (o.LayoutConstants = T(0)),
                (o.NeedlemanWunsch = T(25)),
                (N.exports = o));
            },
            function (N, I, T) {
              function o() {
          ...
          return (function (I) {
              ...
              ((i.prototype.move = function () {
                ...
                (i.prototype.propogateDisplacementToChildren = function (g, n) {
                  for (var d = this.getChild().getNodes(), r, h = 0; h < d.length; h++)
                    ((r = d[h]),
                      r.getChild() == null
                        ? (r.moveBy(g, n), (r.displacementX += g), (r.displacementY += n))
            ...
            function (I, T, o) {
              var e = o(0).FDLayout,
                ...
                g = o(2),
                n = o(1),
                d = o(0).FDLayoutConstants,
                r = o(0).LayoutConstants,
                h = o(0).Point,
                a = o(0).PointD,
                p = o(0).Layout,
                v = o(0).Integer,
              ...
              ((y.prototype.newGraphManager = function () {
                ...
                (y.prototype.classicLayout = function () {
                  if (
                    ...
                    if (s.length > 0) this.positionNodesRadially(s);
                      ...
                      (this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation());
                      var f = new Set(this.getAllNodes()),
                        c = this.nodesWithGravity.filter(function (L) {
                          return f.has(L);
                        });
                ...
                (y.prototype.getPositionsData = function () {
                  for (var s = this.graphManager.getAllNodes(), f = {}, c = 0; c < s.length; c++) {
                    var L = s[c].rect,
                      A = s[c].id;
                    f[A] = { id: A, x: L.getCenterX(), y: L.getCenterY(), w: L.width, h: L.height };
                  }
                  return f;
                }),
                ...
                (y.prototype.positionNodesRadially = function (s) {
                  for (
                    ...
                    R % c == 0 && ((m = 0), (A = L), R != 0 && (A += n.DEFAULT_COMPONENT_SEPERATION), (L = 0));
                    var M = s[R],
                      S = p.findCenterOfTree(M);
                    ((f.x = m),
                      (f.y = A),
                      (C = y.radialLayout(M, S, f)),
                      C.y > L && (L = Math.floor(C.y)),
                ...
                (y.prototype.clearZeroDegreeMembers = function () {
                  ...
                  Object.keys(this.memberGroups).forEach(function (c) {
                    ...
                    ((f[c] = s.tileNodes(s.memberGroups[c], L.paddingLeft + L.paddingRight)),
                      (L.rect.width = f[c].width),
                      (L.rect.height = f[c].height));
                  });
                }),
                ...
                (y.prototype.tileCompoundMembers = function (s, f) {
                  ...
                  ((this.tiledMemberPack = []),
                    Object.keys(s).forEach(function (L) {
                      var A = f[L];
                      ((c.tiledMemberPack[L] = c.tileNodes(s[L], A.paddingLeft + A.paddingRight)),
                        (A.rect.width = c.tiledMemberPack[L].width),
                        (A.rect.height = c.tiledMemberPack[L].height));
                    }));
                }),
                (y.prototype.tileNodes = function (s, f) {
                  var c = n.TILING_PADDING_VERTICAL,
                    L = n.TILING_PADDING_HORIZONTAL,
                    A = {
                      rows: [],
                      rowWidth: [],
                      rowHeight: [],
                ...
                (y.prototype.shiftToLastRow = function (s) {
                  ...
                  if (s.width - s.rowWidth[c] > m && f != c) {
                    ...
                    for (var C = Number.MIN_VALUE, R = 0; R < L.length; R++) L[R].height > C && (C = L[R].height);
                ...
                (y.prototype.reduceTrees = function () {
                  for (var s = [], f = !0, c; f; ) {
                    var L = this.graphManager.getAllNodes(),
                      A = [];
                    f = !1;
                ...
                (y.prototype.growTree = function (s) {
                  for (var f = s.length, c = s[f - 1], L, A = 0; A < c.length; A++)
                    ((L = c[A]),
                      this.findPlaceforPrunedNode(L),
                      L[2].add(L[0]),
                      L[2].add(L[1], L[1].source, L[1].target));
                ...
                (y.prototype.findPlaceforPrunedNode = function (s) {
                  ...
                  f == 0
                    ? L.setCenter(
                        c.getCenterX(),
                        c.getCenterY() - c.getHeight() / 2 - d.DEFAULT_EDGE_LENGTH - L.getHeight() / 2
                      )
                    : f == 1
                      ? L.setCenter(
                          c.getCenterX() + c.getWidth() / 2 + d.DEFAULT_EDGE_LENGTH + L.getWidth() / 2,
                          c.getCenterY()
                        )
                      : f == 2
                        ? L.setCenter(
      ...
      (function (G, b) {
        (function (I, T) {
          ...
          return (function (I) {
            ...
            function (I, T, o) {
              var e = o(0).layoutBase.LayoutConstants,
                t = o(0).layoutBase.FDLayoutConstants,
                i = o(0).CoSEConstants,
                l = o(0).CoSELayout,
                g = o(0).CoSENode,
                n = o(0).layoutBase.PointD,
                d = o(0).layoutBase.DimensionD,
                r = {
                  ready: function () {},
                  stop: function () {},
                  quality: "default",
              ...
              function h(D, u) {
                var E = {};
                for (var y in D) E[y] = D[y];
                for (var y in u) E[y] = u[y];
                return E;
              }
              function a(D) {
              ...
              ((a.prototype.run = function () {
                ...
                var M = function (w, x) {
                  ...
                  S = function Y() {
                    for (
                      var w = function () {
                          (E.fit && E.cy.fit(E.eles, E.padding),
                            D ||
                              ((D = !0),
                              O.cy.one("layoutready", E.ready),
                    ...
                    if (F) {
                      (y.checkLayoutSuccess() && !y.isSubLayout && y.doPostLayout(),
                        y.tilingPostLayout && y.tilingPostLayout(),
                        (y.isLayoutFinished = !0),
                ...
                return (
                  y.addListener("layoutstarted", function () {
                ...
                (a.prototype.getTopMostNodes = function (D) {
                  for (var u = {}, E = 0; E < D.length; E++) u[D[E].id()] = !0;
                ...
                (a.prototype.processChildrenList = function (D, u, E) {
                  for (var y = u.length, O = 0; O < y; O++) {
                    var s = u[O],
                      f = s.children(),
                      c,
                      L = s.layoutDimensions({ nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels });
                    if (
                      (s.outerWidth() != null && s.outerHeight() != null
                        ? (c = D.add(
                            new g(
                              E.graphManager,
                              new n(s.position("x") - L.w / 2, s.position("y") - L.h / 2),
                              new d(parseFloat(L.w), parseFloat(L.h))
                            )
                          ))
                    ...
                    if (
                      ...
                      var R;
                      ((R = E.getGraphManager().add(E.newGraph(), c)), this.processChildrenList(R, f, E));
                    }
                  }
                }),
...
function it(G) {
  return new Promise((b) => {
    const N = lt("body").append("div").attr("id", "cy").attr("style", "display:none"),
      I = tt({
...
var Lt = V(
    async (
        ...
        await Promise.all(
          G.nodes.map(async (u) => {
            if (u.isGroup) {
              ...
              const E = { ...u };
              g[u.id] = E;
              const y = await e(p, u, { config: G.config, dir: G.direction || "TB" }),
                O = y.node().getBBox();
              ((E.width = O.width),
                (E.height = O.height),
                (E.domId = y),
      ...
      const v = {
          ...
          nodes: G.nodes.map((u) => {
            const E = g[u.id];
            return { ...u, width: E.width, height: E.height };
          }),
        },
      ...
      (t.debug("Positioning nodes based on layout results"),
        D.nodes.forEach((u) => {
          ...
          E != null &&
            E.domId &&
            (E.domId.attr("transform", `translate(${u.x}, ${u.y})`),
            (E.x = u.x),
            (E.y = u.y),
            t.debug(`Positioned node ${E.id} at center (${u.x}, ${u.y})`));
        }),
        D.edges.forEach((u) => {
          ...
          G.edges.map(async (u) => {
            ...
            if (E && y) {
              ...
              if (O) {
                ...
                const s = { ...u },
                  f = I(h, s, n, G.type, E, y, G.diagramId);
                i(s, f);
              } else {
                const s = {
                    ...u,
