function fr(x) {
  var pr = x.statementIndent,
    ur = x.jsonld,
    br = x.json || ur,
    k = x.typescript,
    U = x.wordCharacters || /[\w$\xa1-\uffff]/,
    wr = (function () {
      function r(y) {
    ...
    hr = /[+\-*&%=<>!?|~^@]/,
    Or = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/;
  function qr(r) {
  ...
  function S(r, e) {
    var t = r.next();
    if (t == '"' || t == "'") return ((e.tokenize = Nr(t)), e.tokenize(r, e));
    if (t == "." && r.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return b("number", "number");
    if (t == "." && r.match("..")) return b("spread", "meta");
    if (/[\[\]{}\(\),;\:\.]/.test(t)) return b(t);
    if (t == "=" && r.eat(">")) return b("=>", "operator");
    if (t == "0" && r.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return b("number", "number");
    if (/\d/.test(t)) return (r.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), b("number", "number"));
    if (t == "/")
      return r.eat("*")
        ? ((e.tokenize = H), H(r, e))
        : r.eat("/")
          ? (r.skipToEnd(), b("comment", "comment"))
          : ce(r, e, 1)
            ? (qr(r), r.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), b("regexp", "string.special"))
            : (r.eat("="), b("operator", "operator", r.current()));
    if (t == "`") return ((e.tokenize = L), L(r, e));
    if (t == "#" && r.peek() == "!") return (r.skipToEnd(), b("meta", "meta"));
    if (t == "#" && r.eatWhile(U)) return b("variable", "property");
    ...
    if (hr.test(t))
      return (
        ...
        t == "?" && r.eat(".") ? b(".") : b("operator", "operator", r.current())
      );
    if (U.test(t)) {
      r.eatWhile(U);
      var f = r.current();
      if (e.lastType != ".") {
        ...
        if (f == "async" && r.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)) return b("async", "keyword", f);
      }
  ...
  function Nr(r) {
    return function (e, t) {
      var f = !1,
        u;
      if (ur && e.peek() == "@" && e.match(Or)) return ((t.tokenize = S), b("jsonld-keyword", "meta"));
  ...
  var Fr = { atom: !0, number: !0, variable: !0, string: !0, regexp: !0, this: !0, import: !0, "jsonld-keyword": !0 };
  ...
  function s(r, e) {
    var t = function () {
      ...
      else for (var c = f.lexical; c && c.type == ")" && c.align; c = c.prev) u = c.indented;
            ...
            : r == "debugger"
              ...
              : r == "{"
                ...
                : r == ";"
                  ? n()
                  : r == "if"
                    ? (i.state.lexical.info == "else" && i.state.cc[i.state.cc.length - 1] == a && i.state.cc.pop()(),
                      n(s("form"), sr, w, a, jr))
                    : r == "function"
                      ? n(_)
                      : r == "for"
                        ? n(s("form"), Y, zr, w, T, a)
                        : r == "class" || (k && e == "interface")
                          ? ((i.marked = "keyword"), n(s("form", r == "class" ? r : e), Sr, a))
                          : r == "variable"
                            ? k && e == "declare"
                              ? ((i.marked = "keyword"), n(w))
                              : k && (e == "module" || e == "enum" || e == "type") && i.stream.match(/^\s*\w/, !1)
                                ? ((i.marked = "keyword"),
                                  e == "enum"
                                    ? n($r)
                                    : e == "type"
                                      ? n(_r, l("operator"), d, l(";"))
                                      : n(s("form"), V, l("{"), s("}"), rr, a, a))
                                : k && e == "namespace"
                                  ? ((i.marked = "keyword"), n(s("form"), p, w, a))
                                  : k && e == "abstract"
                                    ? ((i.marked = "keyword"), n(w))
                                    : n(s("stat"), Kr)
                            : r == "switch"
                              ? n(s("form"), sr, l("{"), s("}", "switch"), Y, rr, a, a, T)
                              : r == "case"
                                ? n(p, l(":"))
                                : r == "default"
                                  ? n(l(":"))
  ...
  function yr(r, e, t) {
    ...
    var u = t ? B : I;
    return Fr.hasOwnProperty(r)
      ? n(u)
      : r == "function"
        ? n(_, u)
        : r == "class" || (k && e == "interface")
          ? ((i.marked = "keyword"), n(s("form"), ie, a))
          : r == "keyword c" || r == "async"
            ? n(t ? g : p)
            : r == "("
              ? n(s(")"), N, l(")"), a, u)
  ...
  function B(r, e, t) {
    ...
    if (r == "operator")
      return /\+\+|--/.test(e) || (k && e == "!")
        ? n(f)
        : k && e == "<" && i.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
          ? n(s(">"), h(d, ">"), a, f)
          : e == "?"
            ? n(p, l(":"), u)
            : n(u);
    if (r == "quasi") return o(Z, f);
    if (r != ";") {
      if (r == "(") return R(g, ")", "call", f);
      if (r == ".") return n(Ur, f);
      if (r == "[") return n(s("]"), N, l("]"), a, f);
      if (k && e == "as") return ((i.marked = "keyword"), n(d, f));
      if (r == "regexp")
  ...
  function Pr(r) {
    if (r == "}") return ((i.marked = "string.special"), (i.state.tokenize = L), n(Z));
  }
  function vr(r) {
  ...
  function Rr(r, e) {
    if (e == "target") return ((i.marked = "keyword"), n(I));
  }
  function Wr(r, e) {
    if (e == "target") return ((i.marked = "keyword"), n(B));
  }
  function Kr(r) {
  ...
  function C(r, e) {
    if (r == "async") return ((i.marked = "property"), n(C));
    if (r == "variable" || i.style == "keyword") {
      ...
      if (r == "number" || r == "string") return ((i.marked = ur ? "property" : i.style + " property"), n($));
      if (r == "jsonld-keyword") return n($);
      if (k && X(e)) return ((i.marked = "keyword"), n(C));
      if (r == "[") return n(p, F, l("]"), $);
      if (r == "spread") return n(g, $);
      if (e == "*") return ((i.marked = "keyword"), n(C));
      if (r == ":") return o($);
    }
  }
  function Gr(r) {
  ...
  function Vr(r) {
    if (k && r == ":") return i.stream.match(/^\s*\w+\s+is\b/, !1) ? n(p, Xr, d) : n(d);
  }
  function Xr(r, e) {
  ...
  function d(r, e) {
    ...
    if (r == "variable" || e == "void") return ((i.marked = "type"), n(A));
    if (e == "|" || e == "&") return n(d);
  ...
  function W(r, e) {
    if (r == "variable" || i.style == "keyword") return ((i.marked = "property"), n(W));
    if (e == "?" || r == "number" || r == "string") return n(W);
    if (r == ":") return n(d);
    if (r == "[") return n(l("variable"), Hr, l("]"), W);
    if (r == "(") return o(M, W);
    if (!r.match(/[;\}\)\],]/)) return n();
  }
  function cr(r, e) {
  ...
  function Zr(r) {
    if (r == "}") return ((i.marked = "string.special"), (i.state.tokenize = L), n(cr));
  }
  function dr(r, e) {
  ...
  function V(r, e) {
    if (k && X(e)) return ((i.marked = "keyword"), n(V));
    if (r == "variable") return (q(e), n());
  ...
  function Ar(r, e) {
    return r == "variable" && !i.stream.match(/^\s*:/, !1)
      ...
      : (r == "variable" && (i.marked = "property"),
        r == "spread" ? n(V) : r == "}" ? o() : r == "[" ? n(p, l("]"), l(":"), Ar) : n(l(":"), V, z));
  }
  function ee() {
    return o(V, z);
  }
  ...
  function _(r, e) {
    ...
    if (r == "variable") return (q(e), n(_));
    if (r == "(") return n(E, s(")"), h(O, ")"), a, Vr, w, T);
    if (k && e == "<") return n(s(">"), h(er, ">"), a, _);
  }
  function M(r, e) {
    if (e == "*") return ((i.marked = "keyword"), n(M));
    if (r == "variable") return (q(e), n(M));
    if (r == "(") return n(E, s(")"), h(O, ")"), a, Vr, T);
    if (k && e == "<") return n(s(">"), h(er, ">"), a, M);
  }
  function _r(r, e) {
    if (r == "keyword" || r == "variable") return ((i.marked = "type"), n(_r));
    if (e == "<") return n(s(">"), h(er, ">"), a);
  }
  function O(r, e) {
    return (
      e == "@" && n(p, O),
      r == "spread" ? n(O) : k && X(e) ? ((i.marked = "keyword"), n(O)) : k && r == "this" ? n(F, z) : o(V, F, z)
    );
  }
  function ie(r, e) {
  ...
  function j(r, e) {
    if (
      r == "async" ||
      (r == "variable" &&
        (e == "static" || e == "get" || e == "set" || (k && X(e))) &&
        i.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
    )
      return ((i.marked = "keyword"), n(j));
    if (r == "variable" || i.style == "keyword") return ((i.marked = "property"), n(tr, j));
    if (r == "number" || r == "string") return n(tr, j);
    if (r == "[") return n(p, F, l("]"), tr, j);
    if (e == "*") return ((i.marked = "keyword"), n(j));
    if (k && r == "(") return o(M, j);
    if (r == ";" || r == ",") return n(j);
    if (r == "}") return n();
    if (e == "@") return n(p, j);
  ...
  function fe(r, e) {
    return e == "*"
      ? ((i.marked = "keyword"), n(kr, l(";")))
      : e == "default"
        ? ((i.marked = "keyword"), n(p, l(";")))
        : r == "{"
          ? n(h(Er, "}"), kr, l(";"))
          : o(w);
  }
  ...
  function ae(r, e) {
    if (e == "as") return ((i.marked = "keyword"), n(ir));
  }
  function kr(r, e) {
    if (e == "from") return ((i.marked = "keyword"), n(p));
  }
  function oe(r) {
    return r == "]" ? n() : o(h(g, "]"));
  }
  ...
  function ce(r, e, t) {
    return (
      ...
      (e.lastType == "quasi" && /\{\s*$/.test(r.string.slice(0, r.pos - t)))
    );
  }
  return {
    name: x.name,
    ...
    token: function (r, e) {
      if (
        (r.sol() &&
          (e.lexical.hasOwnProperty("align") || (e.lexical.align = !1), (e.indented = r.indentation()), ar(r, e)),
        e.tokenize != H && r.eatSpace())
      )
        return null;
      var t = e.tokenize(r, e);
      return D == "comment"
        ? t
        : ((e.lastType = D == "operator" && (G == "++" || G == "--") ? "incdec" : D), Mr(e, t, D, G, r));
    },
    indent: function (r, e, t) {
      ...
      for (
        ...
        (f == "}" || ((c = r.cc[r.cc.length - 1]) && (c == I || c == B) && !/^[,\.=+\-*:?[\(]/.test(e)));
      )
        u = u.prev;
      ...
      var v = u.type,
        K = f == v;
      return v == "vardef"
        ? u.indented + (r.lastType == "operator" || r.lastType == "," ? u.info.length + 1 : 0)
        : v == "form" && f == "{"
          ? u.indented
          : v == "form"
            ? u.indented + t.unit
            : v == "stat"
              ? u.indented + (le(r, e) ? pr || t.unit : 0)
              : u.info == "switch" && !K && x.doubleIndentSwitch != !1
                ? u.indented + (/^(?:case|default)\b/.test(e) ? t.unit : 2 * t.unit)
                : u.align
                  ? u.column + (K ? 0 : 1)
                  : u.indented + (K ? 0 : t.unit);
    },
    languageData: {
...
const de = fr({ name: "javascript" }),
  me = fr({ name: "json", json: !0 }),
  ke = fr({ name: "json", jsonld: !0 }),
  pe = fr({ name: "typescript", typescript: !0 });
export { de as javascript, me as json, ke as jsonld, pe as typescript };
