function A(i) {
  var o = i.statementIndentUnit,
    u = i.dontAlignCalls,
    c = i.noIndentKeywords || [],
    s = i.multiLineStrings,
    a = i.hooks || {};
  function g(e) {
  ...
  var h = g(
    ...
    k = /[\[\]{}()]/,
    b = /\d[0-9_]*/,
    I = /\d*\s*'s?d\s*\d[0-9_]*/i,
    O = /\d*\s*'s?b\s*[xz01][xz01_]*/i,
    T = /\d*\s*'s?o\s*[xz0-7][xz0-7_]*/i,
    W = /\d*\s*'s?h\s*[0-9a-fxz?][0-9a-fxz?_]*/i,
    B = /(\d[\d_]*(\.\d[\d_]*)?E-?[\d_]+)|(\d[\d_]*\.\d[\d_]*)/i,
    M = /^((\w+)|[)}\]])/,
    U = /[)}\]]/,
    d,
    v,
  ...
  ((f.begin = "end"),
    ...
    (f.casez = "endcase"),
    (f.do = "while"),
    (f.fork = "join;join_any;join_none"),
    (f.covergroup = "endgroup"));
  for (var V in c) {
    var m = c[V];
    f[m] && (f[m] = void 0);
  }
  ...
  function _(e, n) {
    var t = e.peek(),
      r;
    if ((a[t] && (r = a[t](e, n)) != !1) || (a.tokenBase && (r = a.tokenBase(e, n)) != !1)) return r;
  ...
  return {
    ...
    startState: function (e) {
      var n = { tokenize: null, context: new j(-e, 0, "top", !1), indented: 0, startOfLine: !0 };
      return (a.startState && a.startState(n), n);
    },
    token: function (e, n) {
      var t = n.context;
      if (
        (e.sol() && (t.align == null && (t.align = !1), (n.indented = e.indentation()), (n.startOfLine = !0)), a.token)
      ) {
        var r = a.token(e, n);
      ...
      if ((t.align == null && (t.align = !0), d == t.type)) C(n);
    ...
    indent: function (e, n, t) {
      ...
      return (
        $ && (x = N($[0], l.type)),
        l.type == "statement"
          ? l.indented + (y == "{" ? 0 : o || t.unit)
          : U.test(l.type) && l.align && !u
            ? l.column + (x ? 0 : 1)
            : l.type == ")" && !x
              ? l.indented + (o || t.unit)
              : l.indented + (x ? 0 : t.unit)
      );
    },
...
var z = {
  ...
  E = { "/": "beh-hier", ">": "beh-hier", "-": "phys-hier", "|": "pipe", "?": "when", "@": "stage", "\\": "keyword" },
  S = 3,
  q = /^([~!@#\$%\^&\*-\+=\?\/\\\|'"<>]+)([\d\w_]*)/,
  F = /^[! ] */,
  G = /^\/[\/\*]/;
    ...
    token: function (i, o) {
      ...
      if (i.sol() && !o.tlvInBlockComment) {
        (i.peek() == "\\" &&
          ((u = "def"),
          i.skipToEnd(),
          i.string.match(/\\SV/) ? (o.tlvCodeActive = !1) : i.string.match(/\\TLV/) && (o.tlvCodeActive = !0)),
          o.tlvCodeActive && i.pos == 0 && o.indented == 0 && (c = i.match(F, !1)) && (o.indented = c[0].length));
        var s = o.indented,
          a = s / S;
        if (a <= o.tlvIndentationStyle.length) {
          var g = i.string.length == s,
            h = a * S;
          if (h < i.string.length) {
            var w = i.string.slice(h),
              k = w[0];
            E[k] &&
              (c = w.match(q)) &&
              z[c[1]] &&
              ((s += S), (k == "\\" && h > 0) || ((o.tlvIndentationStyle[a] = E[k]), a++));
          }
      ...
      if (o.tlvCodeActive) {
        var c;
        if (u === void 0)
          if (o.tlvInBlockComment) (i.match(/^.*?\*\//) ? (o.tlvInBlockComment = !1) : i.skipToEnd(), (u = "comment"));
            ...
            i.match(/^\t+/)
              ...
              : i.match(/^[\[\]{}\(\);\:]+/)
                ? (u = "meta")
                : (c = i.match(/^[mM]4([\+_])?[\w\d_]*/))
                  ? (u = c[1] == "+" ? "keyword.special" : "keyword")
                  : i.match(/^ +/)
                    ? i.eol() && (u = "error")
                    : i.match(/^[\w\d_]+/)
                      ? (u = "number")
