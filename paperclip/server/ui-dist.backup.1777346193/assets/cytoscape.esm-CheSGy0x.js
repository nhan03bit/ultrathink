...
function gt(r, e, t) {
  return (e && tc(r.prototype, e), Object.defineProperty(r, "prototype", { writable: !1 }), r);
}
function kr(r, e) {
...
var rr = typeof window > "u" ? null : window,
  To = rr ? rr.navigator : null;
rr && rr.document;
var uc = ar(""),
  ev = ar({}),
  lc = ar(function () {}),
  vc = typeof HTMLElement > "u" ? "undefined" : ar(HTMLElement),
  La = function (e) {
  ...
  bn = function (e) {
    if (vc !== "undefined") return e != null && e instanceof HTMLElement;
  },
  Dr = function (e) {
    return Ia(e) || rv(e);
  },
  ...
  tr = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))",
  mc = "rgb[a]?\\((" + tr + "[%]?)\\s*,\\s*(" + tr + "[%]?)\\s*,\\s*(" + tr + "[%]?)(?:\\s*,\\s*(" + tr + "))?\\)",
  bc =
    "rgb[a]?\\((?:" + tr + "[%]?)\\s*,\\s*(?:" + tr + "[%]?)\\s*,\\s*(?:" + tr + "[%]?)(?:\\s*,\\s*(?:" + tr + "))?\\)",
  wc = "hsl[a]?\\((" + tr + ")\\s*,\\s*(" + tr + "[%])\\s*,\\s*(" + tr + "[%])(?:\\s*,\\s*(" + tr + "))?\\)",
  xc = "hsl[a]?\\((?:" + tr + ")\\s*,\\s*(?:" + tr + "[%])\\s*,\\s*(?:" + tr + "[%])(?:\\s*,\\s*(?:" + tr + "))?\\)",
  Ec = "\\#[0-9a-fA-F]{3}",
  Cc = "\\#[0-9a-fA-F]{6}",
  nv = function (e, t) {
  ...
  Sc = function (e) {
    if (!(!(e.length === 4 || e.length === 7) || e[0] !== "#")) {
      ...
      return (
        t
          ? ((a = parseInt(e[1] + e[1], s)), (n = parseInt(e[2] + e[2], s)), (i = parseInt(e[3] + e[3], s)))
          : ((a = parseInt(e[1] + e[2], s)), (n = parseInt(e[3] + e[4], s)), (i = parseInt(e[5] + e[6], s))),
        [a, n, i]
      );
    }
  },
  kc = function (e) {
    ...
    function v(d, y, g) {
      return (
        g < 0 && (g += 1),
        g > 1 && (g -= 1),
        g < 1 / 6 ? d + (y - d) * 6 * g : g < 1 / 2 ? y : g < 2 / 3 ? d + (y - d) * (2 / 3 - g) * 6 : d
      );
    }
    ...
    if (f) {
      if (
        ((a = parseInt(f[1])),
        a < 0 ? (a = (360 - ((-1 * a) % 360)) % 360) : a > 360 && (a = a % 360),
        (a /= 360),
        (n = parseFloat(f[2])),
        n < 0 ||
          n > 100 ||
          ((n = n / 100), (i = parseFloat(f[3])), i < 0 || i > 100) ||
          ((i = i / 100), (s = f[4]), s !== void 0 && ((s = parseFloat(s)), s < 0 || s > 1)))
      )
        return;
  ...
  Dc = function (e) {
    var t,
      a = new RegExp("^" + mc + "$").exec(e);
    if (a) {
      t = [];
      for (var n = [], i = 1; i <= 3; i++) {
        var s = a[i];
        if (
          (s[s.length - 1] === "%" && (n[i] = !0), (s = parseFloat(s)), n[i] && (s = (s / 100) * 255), s < 0 || s > 255)
        )
          return;
        t.push(Math.floor(s));
      }
  ...
  sv = function (e) {
    for (var t = e.map, a = e.keys, n = a.length, i = 0; i < n; i++) {
      var s = a[i];
      if (Le(s)) throw Error("Tried to set map with object key");
  ...
  ov = function (e) {
    for (var t = e.map, a = e.keys, n = a.length, i = 0; i < n; i++) {
      var s = a[i];
      if (Le(s)) throw Error("Tried to get map with object key");
  ...
  function s(o, l, u) {
    ...
    function P() {
      ...
      if (((v = arguments), (f = this), (y = A), R)) {
        if (d === void 0) return E(y);
        if (m) return (clearTimeout(d), (d = setTimeout(T, l)), w(y));
      }
...
var Vc = Fc(),
  ...
  fv = function (e) {
    for (
      var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Tt, a = t, n;
      (n = e.next()), !n.done;
    )
      a = (a * vv + n.value) | 0;
    return a;
...
function Hc(r, e, t, a, n) {
  var i = (n * Math.PI) / 180,
    s = Math.cos(i) * (r - t) - Math.sin(i) * (e - a) + t,
    o = Math.sin(i) * (r - t) + Math.cos(i) * (e - a) + a;
  return { x: s, y: o };
}
var Wc = function (e, t, a, n, i, s) {
  return { x: (e - a) * i + a, y: (t - n) * s + n };
};
function $c(r, e, t) {
  if (t === 0) return r;
  var a = (e.x1 + e.x2) / 2,
    ...
    s = 1 / i,
    o = Hc(r.x, r.y, a, n, t),
    l = Wc(o.x, o.y, a, n, i, s);
  return { x: l.x, y: l.y };
}
var _o = !0,
  Uc = console.warn != null,
  Kc = console.trace != null,
  ...
  gv = function (e, t) {
    for (
      t = e = "";
      e++ < 36;
      t += (e * 51) & 52 ? (e ^ 15 ? 8 ^ (Math.random() * (e ^ 20 ? 16 : 4)) : 4).toString(16) : "-"
    );
    return t;
  },
  Zc = {},
  ...
  Xr = typeof Map < "u" ? Map : Jc,
  jc = "undefined",
  ed = (function () {
    function r(e) {
      if ((ht(this, r), (this._obj = Object.create(null)), (this.size = 0), e != null)) {
        var t;
  ...
  ra = (typeof Set > "u" ? "undefined" : ar(Set)) !== jc ? Set : ed,
  In = function (e, t) {
    ...
    var n = t.group;
    if (
      (n == null && (t.data && t.data.source != null && t.data.target != null ? (n = "edges") : (n = "nodes")),
      n !== "nodes" && n !== "edges")
    ) {
  ...
  Ho = function (e) {
    return (
      ...
      function (a, n, i) {
        var s;
        (Le(a) && !Dr(a) && ((s = a), (a = s.roots || s.root), (n = s.visit), (i = s.directed)),
          (i = arguments.length === 2 && !Ue(n) ? n : i),
          (n = Ue(n) ? n : function () {}));
        for (
          var o = this._private.cy,
            l = (a = ge(a) ? this.filter(a) : a),
            u = [],
            v = [],
            f = {},
            c = {},
        ...
        for (
          var C = function () {
              ...
              var L = c[R],
                I = f[R],
                M = I != null ? I.source() : null,
                O = I != null ? I.target() : null,
                V = I == null ? void 0 : A.same(M) ? O[0] : M[0],
                G;
              if (((G = n(A, I, V, d++, L)), G === !0)) return ((y = A), 1);
              if (G === !1) return 1;
              for (
                var N = A.connectedEdges().filter(function (j) {
                ...
                var U = N[F],
                  Q = U.connectedNodes().filter(function (j) {
                    return !j.same(A) && p.has(j);
                  }),
                  K = Q.id();
                Q.length !== 0 &&
                  !h[K] &&
                  ((Q = Q[0]), u.push(Q), e.bfs && ((h[K] = !0), v.push(Q)), (f[K] = U), (c[K] = c[R] + 1));
              }
            },
            x;
  ...
  Sa = { breadthFirstSearch: Ho({ bfs: !0 }), depthFirstSearch: Ho({ dfs: !0 }) };
        ...
        (function () {
          ...
          ((n = Math.floor),
            ...
            (v = function (p, m, b, w, E) {
              var C;
              if ((b == null && (b = 0), E == null && (E = a), b < 0)) throw new Error("lo must be non-negative");
              for (w == null && (w = p.length); b < w; ) ((C = n((b + w) / 2)), E(m, p[C]) < 0 ? (w = C) : (b = C + 1));
            ...
            (s = function (p, m) {
              ...
              return (
                m == null && (m = a),
                (b = p.pop()),
                p.length ? ((w = p[0]), (p[0] = b), g(p, 0, m)) : (w = b),
                w
              );
            }),
            (u = function (p, m, b) {
            ...
            (l = function (p, m, b) {
              ...
              return (
                b == null && (b = a),
                p.length && b(p[0], m) < 0 && ((w = [p[0], m]), (m = w[0]), (p[0] = w[1]), g(p, 0, b)),
                m
              );
            }),
            (i = function (p, m) {
              ...
              for (
                m == null && (m = a),
                  C = function () {
                    T = [];
                    for (var k = 0, D = n(p.length / 2); 0 <= D ? k < D : k > D; 0 <= D ? k++ : k--) T.push(k);
                    return T;
                  }
                    .apply(this)
                    .reverse(),
            ...
            (d = function (p, m, b) {
              var w;
              if ((b == null && (b = a), (w = p.indexOf(m)), w !== -1)) return (y(p, 0, w, b), g(p, w, b));
            }),
            (c = function (p, m, b) {
              var w, E, C, x, T;
              if ((b == null && (b = a), (E = p.slice(0, m)), !E.length)) return E;
              for (i(E, b), T = p.slice(m), C = 0, x = T.length; C < x; C++) ((w = T[C]), l(E, w, b));
              return E.sort(b).reverse();
            }),
            (h = function (p, m, b) {
              var w, E, C, x, T, k, D, B, P;
              if ((b == null && (b = a), m * 10 <= p.length)) {
                if (((C = p.slice(0, m).sort(b)), !C.length)) return C;
...
var nd = ad(),
        ...
        if (((c[T] = x), x !== 1 / 0))
          for (var k = C.neighborhood().intersect(d), D = 0; D < k.length; D++) {
            var B = k[D],
              ...
              A = E(C, B),
              R = x + A.dist;
            R < g(B) && (p(B, R), (f[P] = { node: C, edge: A.edge }));
          }
      }
      return {
  ...
  ld = {
    aStar: function (e) {
      ...
      for (var x = 0; d.size() > 0; ) {
        if ((E(), x++, w === v)) {
          for (var T = [], k = i, D = v, B = p[D]; T.unshift(k), B != null && T.unshift(B), (k = g[D]), k != null; )
            ((D = k.id()), (B = p[D]));
          return { found: !0, distance: f[w], path: this.spawn(T), steps: x };
        }
        h[w] = !0;
      ...
      return { found: !1, distance: void 0, path: void 0, steps: x };
    },
  },
  vd = cr({
    weight: function (e) {
        ...
        N = {
          ...
          path: function (U, Q) {
            var K = G(U),
              j = G(Q),
              re = h(K);
            if (K === j) return re.collection();
            if (m[K * v + j] == null) return t.collection();
            var ne = t.collection(),
              J = K,
              z;
            for (ne.merge(re); K !== j; )
    ...
    bellmanFord: function (e) {
      ...
      for (
        var p = f.length,
          ...
          E = function (we) {
            for (
              var ye = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : s, ie = b(we), de = [], he = ie;
              ;
            ) {
              if (he == null) return t.spawn();
              var Ee = m(he),
                pe = Ee.edge,
                Se = Ee.pred;
              if ((de.unshift(he[0]), he.same(ye) && de.length > 0)) break;
      ...
      if (k)
        for (var V = [], G = 0; G < p; G++) {
          ...
          if (K + Q < j || (!i && j + Q < K))
            if (
              (y || (Ve("Graph contains a negative weight cycle for Bellman-Ford"), (y = !0)),
              e.findNegativeWeightCycles !== !1)
            ) {
              var re = [];
              ...
              for (var ne = re.length, J = 0; J < ne; J++) {
                var z = re[J],
                  q = [z];
                q.push(m(z).edge);
                for (var H = m(z).pred; q.indexOf(H) === -1; ) (q.push(H), q.push(m(H).edge), (H = m(H).pred));
  ...
  gd = function (e, t, a) {
    ...
    for (var g = 0; g < t.length; g++) t[g] === l && (t[g] = o);
    return u;
  },
  hi = function (e, t, a, n) {
    for (; a > n; ) {
    ...
    kargerStein: function () {
      ...
      for (
        var c = 1 / 0,
          ...
          g = new Array(i),
          p = function (V, G) {
            for (var N = 0; N < i; N++) G[N] = V[N];
          },
          m = 0;
        m <= o;
        m++
      ) {
        for (var b = 0; b < i; b++) y[b] = b;
        var w = hi(y, u.slice(), i, l),
          E = w.slice();
        p(y, g);
        var C = hi(y, w, l, 2),
          x = hi(g, E, l, 2);
        C.length <= x.length && C.length < c
          ? ((c = C.length), (h = C), p(y, d))
          : x.length <= C.length && x.length < c && ((c = x.length), (h = x), p(g, d));
      }
      for (
        var T = this.spawn(
            h.map(function (O) {
      ...
      var L = function (V) {
        ...
        I = [L(k), L(D)],
        M = { cut: T, components: I, partition1: k, partition2: D };
      return M;
    },
  },
  gi,
  ...
  On = function (e, t, a) {
    return { x: e.x * t + a.x, y: e.y * t + a.y };
  },
  yv = function (e, t, a) {
    return { x: (e.x - a.x) / t, y: (e.y - a.y) / t };
  },
  Wt = function (e) {
    return { x: e[0], y: e[1] };
  },
  md = function (e) {
    for (
      var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0,
        a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : e.length,
        n = 1 / 0,
        i = t;
      i < a;
      i++
  ...
  Kt = function (e, t, a, n) {
    return { x: sr(e.x, t.x, a.x, n), y: sr(e.y, t.y, a.y, n) };
  },
  Td = function (e, t, a, n) {
    var i = { x: t.x - e.x, y: t.y - e.y },
      s = Bt(e, t),
      o = { x: i.x / s, y: i.y / s };
    return ((a = a ?? 0), (n = n ?? a * s), { x: e.x + o.x * n, y: e.y + o.y * n });
  },
  ka = function (e, t, a) {
    return Math.max(e, Math.min(a, t));
  },
  wr = function (e) {
    if (e == null) return { x1: 1 / 0, y1: 1 / 0, x2: -1 / 0, y2: -1 / 0, w: 0, h: 0 };
  ...
  bv = function (e, t) {
    return nt(e, t.x1, t.y1) && nt(e, t.x2, t.y2);
  },
  Bd =
    (gi = Math.hypot) !== null && gi !== void 0
      ? gi
      : function (r, e) {
...
function Pd(r, e) {
  ...
  var t = function (T, k) {
    ...
    i = function (T, k) {
      return T.x * k.y - T.y * k.x;
    },
    s = function (T) {
      var k = Bd(T.x, T.y);
      return k === 0 ? { x: 0, y: 0 } : { x: T.x / k, y: T.y / k };
    },
    o = function (T) {
      for (var k = 0, D = 0; D < T.length; D++) {
        var B = T[D],
          P = T[(D + 1) % T.length];
        k += B.x * P.y - P.x * B.y;
      }
    ...
    l = function (T, k, D, B) {
      var P = a(k, T),
        A = a(B, D),
        R = i(P, A);
      if (Math.abs(R) < 1e-9) return t(T, n(P, 0.5));
      var L = i(a(D, T), A) / R;
      return t(T, n(P, L));
    },
    u = r.map(function (x) {
...
var wv = function (e, t, a, n, i, s, o) {
    ...
    if (c) {
      var y = a - v + u - o,
        ...
        p = a + v - u + o,
        m = g;
      if (((d = it(e, t, a, n, y, g, p, m, !1)), d.length > 0)) return d;
    }
    if (h) {
      var b = a + v + o,
        w = n - f + u - o,
        E = b,
        C = n + f - u + o;
      if (((d = it(e, t, a, n, b, w, E, C, !1)), d.length > 0)) return d;
    }
    if (c) {
      var x = a - v + u - o,
        T = n + f + o,
        k = a + v - u + o,
        D = T;
      if (((d = it(e, t, a, n, x, T, k, D, !1)), d.length > 0)) return d;
    }
    if (h) {
      var B = a - v - o,
        P = n - f + u - o,
        A = B,
        R = n + f - u + o;
      if (((d = it(e, t, a, n, B, P, A, R, !1)), d.length > 0)) return d;
    }
    var L;
    {
      var I = a - v + u,
        M = n - f + u;
      if (((L = ya(e, t, a, n, I, M, u + o)), L.length > 0 && L[0] <= I && L[1] <= M)) return [L[0], L[1]];
    }
    {
      var O = a + v - u,
        V = n - f + u;
      if (((L = ya(e, t, a, n, O, V, u + o)), L.length > 0 && L[0] >= O && L[1] <= V)) return [L[0], L[1]];
    }
    {
      var G = a + v - u,
        N = n + f - u;
      if (((L = ya(e, t, a, n, G, N, u + o)), L.length > 0 && L[0] >= G && L[1] >= N)) return [L[0], L[1]];
    }
    {
      var F = a - v + u,
        U = n + f - u;
      if (((L = ya(e, t, a, n, F, U, u + o)), L.length > 0 && L[0] <= F && L[1] >= U)) return [L[0], L[1]];
    }
    return [];
  },
  Rd = function (e, t, a, n, i, s, o) {
    var l = o,
      u = Math.min(a, i),
      v = Math.max(a, i),
      f = Math.min(n, s),
  ...
  Od = function (e, t, a, n, i, s, o, l) {
    var u =
      ...
      f =
        ...
        2 * s * t -
        l * t,
      c = 1 * a * i - a * a + a * e - i * e + n * s - n * n + n * t - s * t,
      h = [];
    Id(u, v, f, c, h);
    for (var d = 1e-7, y = [], g = 0; g < 6; g += 2) Math.abs(h[g + 1]) < d && h[g] >= 0 && h[g] <= 1 && y.push(h[g]);
    (y.push(1), y.push(0));
  ...
  Sr = function (e, t, a) {
    for (var n, i, s, o, l, u = 0, v = 0; v < a.length / 2; v++)
      if (
        ...
        (i = a[v * 2 + 1]),
        v + 1 < a.length / 2
          ? ((s = a[(v + 1) * 2]), (o = a[(v + 1) * 2 + 1]))
          : ((s = a[(v + 1 - a.length / 2) * 2]), (o = a[(v + 1 - a.length / 2) * 2 + 1])),
        !(n == e && s == e))
      )
        if ((n >= e && e >= s) || (n <= e && e <= s)) ((l = ((e - n) / (s - n)) * (o - i) + i), l > t && u++);
        else continue;
    return u % 2 !== 0;
  },
  ...
  zd = function (e, t, a, n, i, s, o, l) {
    for (var u = new Array(a.length * 2), v = 0; v < l.length; v++) {
      ...
      if (c <= Math.pow(f.radius, 2)) return !0;
    }
    return Sr(e, t, u);
  },
  En = function (e) {
    for (var t = new Array(e.length / 2), a, n, i, s, o, l, u, v, f = 0; f < e.length / 4; f++) {
      ((a = e[f * 4]),
        ...
        (s = e[f * 4 + 3]),
        f < e.length / 4 - 1
          ? ((o = e[(f + 1) * 4]), (l = e[(f + 1) * 4 + 1]), (u = e[(f + 1) * 4 + 2]), (v = e[(f + 1) * 4 + 3]))
          : ((o = e[0]), (l = e[1]), (u = e[2]), (v = e[3])));
      var c = it(a, n, i, s, o, l, u, v, !0);
  ...
  Cn = function (e, t) {
    for (var a = new Array(e.length * 2), n, i, s, o, l = 0; l < e.length / 2; l++) {
      ((n = e[l * 2]),
        (i = e[l * 2 + 1]),
        l < e.length / 2 - 1 ? ((s = e[(l + 1) * 2]), (o = e[(l + 1) * 2 + 1])) : ((s = e[0]), (o = e[1])));
      var u = o - i,
        v = -(s - n),
        f = Math.sqrt(u * u + v * v),
        c = u / f,
  ...
  ya = function (e, t, a, n, i, s, o) {
    ...
    var d = (-f + Math.sqrt(h)) / (2 * v),
      ...
      p = Math.max(d, y),
      m = [];
    if ((g >= 0 && g <= 1 && m.push(g), p >= 0 && p <= 1 && m.push(p), m.length === 0)) return [];
    var b = m[0] * l[0] + e,
      w = m[0] * l[1] + t;
    if (m.length > 1) {
      if (m[0] == m[1]) return [b, w];
      var E = m[1] * l[0] + e,
        C = m[1] * l[1] + t;
      return [b, w, E, C];
    } else return [b, w];
  ...
  Vd = function (e, t, a, n, i) {
    var s = [],
      o = n / 2,
      l = i / 2,
      u = t,
      v = a;
    s.push({ x: u + o * e[0], y: v + l * e[1] });
    for (var f = 1; f < e.length / 2; f++) s.push({ x: u + o * e[f * 2], y: v + l * e[f * 2 + 1] });
    return s;
  },
  Da = function (e, t, a, n, i, s, o, l) {
    ...
    var h;
    if (c) {
      for (var d = 0; d < f.length / 2; d++) ((f[d * 2] = a[d * 2] * s + n), (f[d * 2 + 1] = a[d * 2 + 1] * o + i));
      if (l > 0) {
        var y = Cn(f, -l);
        h = En(y);
      } else h = f;
    ...
    for (var g, p, m, b, w = 0; w < h.length / 2; w++)
      ((g = h[w * 2]),
        (p = h[w * 2 + 1]),
        w < h.length / 2 - 1 ? ((m = h[(w + 1) * 2]), (b = h[(w + 1) * 2 + 1])) : ((m = h[0]), (b = h[1])),
        (v = it(e, t, n, i, g, p, m, b)),
        v.length !== 0 && u.push(v[0], v[1]));
    return u;
  },
  qd = function (e, t, a, n, i, s, o, l, u) {
    var v = [],
      f,
      c = new Array(a.length * 2);
    u.forEach(function (m, b) {
      (b === 0
        ? ((c[c.length - 2] = m.startX), (c[c.length - 1] = m.startY))
        : ((c[b * 4 - 2] = m.startX), (c[b * 4 - 1] = m.startY)),
        (c[b * 4] = m.stopX),
        (c[b * 4 + 1] = m.stopY),
        (f = ya(e, t, n, i, m.cx, m.cy, m.radius)),
        f.length !== 0 && v.push(f[0], f[1]));
    });
    for (var h = 0; h < c.length / 4; h++)
      ((f = it(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], !1)),
        f.length !== 0 && v.push(f[0], f[1]));
    if (v.length > 2) {
      for (var d = [v[0], v[1]], y = Math.pow(d[0] - e, 2) + Math.pow(d[1] - t, 2), g = 1; g < v.length / 2; g++) {
        var p = Math.pow(v[g * 2] - e, 2) + Math.pow(v[g * 2 + 1] - t, 2);
        p <= y && ((d[0] = v[g * 2]), (d[1] = v[g * 2 + 1]), (y = p));
      }
      return d;
    }
    return v;
  ...
  xv = function (e) {
    ...
    for (var v = 2 / (o - i), f = 2 / (l - s), c = 0; c < n; c++)
      ((t = e[2 * c] = e[2 * c] * v),
        ...
        (s = Math.min(s, a)),
        (l = Math.max(l, a)));
    if (s < -1) for (var h = 0; h < n; h++) a = e[2 * h + 1] = e[2 * h + 1] + (-1 - s);
    return e;
  },
  Ps = function (e, t) {
    var a = (1 / e) * 2 * Math.PI,
      n = e % 2 === 0 ? Math.PI / 2 + a / 2 : Math.PI / 2;
    n += t;
...
var Gd = cr({
  ...
  Hd = {
    pageRank: function (e) {
      ...
      for (var O = new Array(f), V = new Array(f), G, N = 0; N < f; N++) O[N] = 1;
      for (var F = 0; F < i; F++) {
        for (var U = 0; U < f; U++) V[U] = 0;
        for (var Q = 0; Q < f; Q++)
          for (var K = 0; K < f; K++) {
            var j = Q * f + K;
            V[Q] += d[j] * O[K];
    ...
    degreeCentralityNormalized: function (e) {
      ...
      if (e.directed) {
        for (var v = {}, f = {}, c = 0, h = 0, d = 0; d < n; d++) {
          ...
          (c < p.indegree && (c = p.indegree),
            h < p.outdegree && (h = p.outdegree),
            (v[g] = p.indegree),
            (f[g] = p.outdegree));
        }
        return {
          indegree: function (b) {
            return c == 0 ? 0 : (ge(b) && (b = t.filter(b)), v[b.id()] / c);
          },
          outdegree: function (b) {
            return h === 0 ? 0 : (ge(b) && (b = t.filter(b)), f[b.id()] / h);
          },
        };
      } else {
    ...
    degreeCentrality: function (e) {
      ...
      if (((i = t.collection(i)[0]), o)) {
        for (
          ...
          m += s(d[w]);
        for (var E = 0; E < y.length; E++) b += s(y[E]);
        return { indegree: Math.pow(g, 1 - l) * Math.pow(m, l), outdegree: Math.pow(p, 1 - l) * Math.pow(b, l) };
      } else {
        for (var u = i.connectedEdges().intersection(a), v = u.length, f = 0, c = 0; c < u.length; c++) f += s(u[c]);
        return { degree: Math.pow(v, 1 - l) * Math.pow(f, l) };
      }
    },
  };
Xt.dc = Xt.degreeCentrality;
Xt.dcn = Xt.degreeCentralityNormalised = Xt.degreeCentralityNormalized;
var Yo = cr({
    harmonic: !0,
    weight: function () {
      return 1;
  ...
  Yt = {
    closenessCentralityNormalized: function (e) {
      for (
        var t = Yo(e),
          ...
          l = 0,
          u = this.nodes(),
          v = this.floydWarshall({ weight: n, directed: i }),
          f = 0;
        f < u.length;
        f++
      ) {
      ...
      return {
        closeness: function (p) {
          return l == 0 ? 0 : (ge(p) ? (p = s.filter(p)[0].id()) : (p = p.id()), o[p] / l);
        },
      };
    },
    closenessCentrality: function (e) {
      ...
      a = this.filter(a)[0];
      for (
        var o = this.dijkstra({ root: a, weight: n, directed: i }), l = 0, u = this.nodes(), v = 0;
        v < u.length;
        v++
      ) {
        var f = u[v];
...
Yt.cc = Yt.closenessCentrality;
Yt.ccn = Yt.closenessCentralityNormalised = Yt.closenessCentralityNormalized;
var Wd = cr({ weight: null, directed: !1 }),
  Rs = {
              ...
              if ((w.push(B), i))
                for (var P = 0; P < l[B].length; P++) {
                  var A = l[B][P],
                    ...
                    L = void 0;
                  R.edgesTo(A).length > 0 ? (L = R.edgesTo(A)[0]) : (L = A.edgesTo(R)[0]);
                  var I = n(L);
                  ((A = A.id()),
                    x[A] > x[B] + I &&
                      ((x[A] = x[B] + I),
                      ...
                      (C[A] = 0),
                      (E[A] = [])),
                    x[A] == x[B] + I && ((C[A] = C[A] + C[B]), E[A].push(B)));
                }
              else
                for (var M = 0; M < l[B].length; M++) {
                  var O = l[B][M].id();
                  (x[O] == 1 / 0 && (T.push(O), (x[O] = x[B] + 1)),
                    x[O] == x[B] + 1 && ((C[O] = C[O] + C[B]), E[O].push(B)));
                }
            }
            for (var V = {}, G = 0; G < o.length; G++) V[o[G].id()] = 0;
            for (; w.length > 0; ) {
              for (var N = w.pop(), F = 0; F < E[N].length; F++) {
                var U = E[N][F];
                V[U] = V[U] + (C[U] / C[N]) * (1 + V[N]);
              }
              N != o[g].id() && f.set(N, f.get(N) + V[N]);
            }
          },
          g = 0;
        g < o.length;
...
var $d = cr({
  ...
  Kd = function (e, t) {
    for (var a = 0, n = 0; n < t.length; n++) a += t[n](e);
    return a;
  },
  Xd = function (e, t, a) {
  ...
  Zd = function (e, t, a) {
    for (var n = e.slice(0), i = 1; i < a; i++) e = Yd(e, n, t);
    return e;
  },
  Qd = function (e, t, a) {
    for (var n = new Array(t * t), i = 0; i < t * t; i++) n[i] = Math.pow(e[i], a);
    return (Cv(n, t), n);
  },
  Jd = function (e, t, a, n) {
    for (var i = 0; i < a; i++) {
      var s = Math.round(e[i] * Math.pow(10, n)) / Math.pow(10, n),
        o = Math.round(t[i] * Math.pow(10, n)) / Math.pow(10, n);
      if (s !== o) return !1;
    }
    return !0;
  },
  ...
  eh = function (e, t) {
    for (var a = 0; a < e.length; a++) if (!t[a] || e[a].id() !== t[a].id()) return !1;
    return !0;
  },
  rh = function (e) {
    for (var t = 0; t < e.length; t++) for (var a = 0; a < e.length; a++) t != a && eh(e[t], e[a]) && e.splice(a, 1);
    return e;
  },
  Zo = function (e) {
    for (var t = this.nodes(), a = this.edges(), n = this.cy(), i = Ud(e), s = {}, o = 0; o < t.length; o++)
      s[t[o].id()] = o;
    for (var l = t.length, u = l * l, v = new Array(u), f, c = 0; c < u; c++) v[c] = 0;
    ...
    (Xd(v, l, i.multFactor), Cv(v, l));
    for (var m = !0, b = 0; m && b < i.maxIterations; )
      ((m = !1), (f = Zd(v, l, i.expandFactor)), (v = Qd(f, l, i.inflateFactor)), Jd(v, f, u, 4) || (m = !0), b++);
    var w = jd(v, l, t, n);
    return ((w = rh(w)), w);
  },
  th = { markovClustering: Zo, mcl: Zo },
  ah = function (e) {
    return e;
  },
  Tv = function (e, t) {
  ...
  ih = function (e, t, a) {
    return Math.max(e, Tv(t, a));
  },
  va = function (e, t, a, n, i) {
    for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : ah, o = n, l, u, v = 0; v < e; v++)
      ((l = t(v)), (u = a(v)), (o = i(o, l, u)));
    return s(o);
  },
  Jt = {
    euclidean: function (e, t, a) {
      return e >= 2 ? va(e, t, a, 0, Jo, nh) : va(e, t, a, 0, Qo);
    },
    squaredEuclidean: function (e, t, a) {
      return va(e, t, a, 0, Jo);
    },
    manhattan: function (e, t, a) {
      return va(e, t, a, 0, Qo);
    },
    max: function (e, t, a) {
      return va(e, t, a, -1 / 0, ih);
    },
  };
...
function Nn(r, e, t, a, n, i) {
  var s;
  return (Ue(r) ? (s = r) : (s = Jt[r] || Jt.euclidean), e === 0 && Ue(r) ? s(n, i) : s(e, t, a, n, i));
}
var sh = cr({
    k: 2,
    m: 2,
  ...
  mi = function (e, t, a) {
    ...
    for (var v = 0; v < t; v++) {
      l = [];
      for (var f = 0; f < n; f++) l[f] = Math.random() * (s[f] - i[f]) + i[f];
      o[v] = l;
    }
    return o;
  },
  Sv = function (e, t, a, n, i) {
  ...
  lh = function (e, t, a) {
    for (var n = 0; n < a; n++) if (e === t[n]) return !0;
    return !1;
  },
  jo = function (e, t) {
    var a = new Array(t);
    if (e.length < 50)
      for (var n = 0; n < t; n++) {
        for (var i = e[Math.floor(Math.random() * e.length)]; lh(i, a, n); )
  ...
  eu = function (e, t, a) {
    for (var n = 0, i = 0; i < t.length; i++) n += Tn("manhattan", t[i], e, a, "kMedoids");
    return n;
  },
  vh = function (e) {
    var t = this.cy(),
      ...
      l;
    i.testMode
      ? typeof i.testCentroids == "number"
        ? (i.testCentroids, (l = mi(a, i.k, i.attributes)))
        : ar(i.testCentroids) === "object"
          ? (l = i.testCentroids)
          : (l = mi(a, i.k, i.attributes))
      : (l = mi(a, i.k, i.attributes));
    for (var u = !0, v = 0; u && v < i.maxIterations; ) {
      for (var f = 0; f < a.length; f++) ((n = a[f]), (o[n.id()] = Sv(n, l, i.distance, i.attributes, "kMeans")));
      u = !1;
      for (var c = 0; c < i.k; c++) {
        var h = kv(c, a, o);
        if (h.length !== 0) {
          for (var d = i.attributes.length, y = l[c], g = new Array(d), p = new Array(d), m = 0; m < d; m++) {
            p[m] = 0;
            for (var b = 0; b < h.length; b++) ((n = h[b]), (p[m] += i.attributes[m](n)));
            ((g[m] = p[m] / h.length), oh(g[m], y[m], i.sensitivityThreshold) || (u = !0));
          }
  ...
  fh = function (e) {
    ...
    i.testMode
      ? typeof i.testCentroids == "number" ||
        (ar(i.testCentroids) === "object" ? (o = i.testCentroids) : (o = jo(a, i.k)))
      : (o = jo(a, i.k));
    for (var f = !0, c = 0; f && c < i.maxIterations; ) {
      for (var h = 0; h < a.length; h++) ((n = a[h]), (l[n.id()] = Sv(n, o, i.distance, i.attributes, "kMedoids")));
      f = !1;
      for (var d = 0; d < o.length; d++) {
        var y = kv(d, a, l);
        if (y.length !== 0) {
          v[d] = eu(o[d], y, i.attributes);
          for (var g = 0; g < y.length; g++)
            ((u = eu(y[g], y, i.attributes)), u < v[d] && ((v[d] = u), (o[d] = y[g]), (f = !0)));
          s[d] = t.collection(y);
        }
      }
      c++;
  ...
  ch = function (e, t, a, n, i) {
    for (var s, o, l = 0; l < t.length; l++) for (var u = 0; u < e.length; u++) n[l][u] = Math.pow(a[l][u], i.m);
    for (var v = 0; v < e.length; v++)
      for (var f = 0; f < i.attributes.length; f++) {
        ((s = 0), (o = 0));
        for (var c = 0; c < t.length; c++) ((s += n[c][v] * i.attributes[f](t[c])), (o += n[c][v]));
        e[v][f] = s / o;
      }
  },
  dh = function (e, t, a, n, i) {
    for (var s = 0; s < e.length; s++) t[s] = e[s].slice();
  ...
  hh = function (e, t, a, n) {
    ...
    for (var o, l, u = 0; u < t.length; u++) {
      ((o = -1 / 0), (l = -1));
      for (var v = 0; v < t[0].length; v++) t[u][v] > o && ((o = t[u][v]), (l = v));
      i[l].push(e[u]);
    }
    for (var f = 0; f < i.length; f++) i[f] = n.collection(i[f]);
    return i;
  },
  ru = function (e) {
    var t = this.cy(),
    ...
    for (var v = 0; v < a.length; v++) l[v] = new Array(n.k);
    o = new Array(a.length);
    for (var f = 0; f < a.length; f++) o[f] = new Array(n.k);
    for (var c = 0; c < a.length; c++) {
      for (var h = 0, d = 0; d < n.k; d++) ((o[c][d] = Math.random()), (h += o[c][d]));
      for (var y = 0; y < n.k; y++) o[c][y] = o[c][y] / h;
    }
    s = new Array(n.k);
    for (var g = 0; g < n.k; g++) s[g] = new Array(n.attributes.length);
    u = new Array(a.length);
    for (var p = 0; p < a.length; p++) u[p] = new Array(n.k);
    for (var m = !0, b = 0; m && b < n.maxIterations; )
      ((m = !1), ch(s, a, o, u, n), dh(o, l, s, a, n), uh(o, l, n.sensitivityThreshold) || (m = !0), b++);
    return ((i = hh(a, o, n, t)), { clusters: i, degreeOfMembership: o });
  },
  gh = { kMeans: vh, kMedoids: fh, fuzzyCMeans: ru, fcm: ru },
  ph = cr({
    distance: "euclidean",
    linkage: "min",
    mode: "threshold",
  ...
  yh = { single: "min", complete: "max" },
  mh = function (e) {
    var t = ph(e),
      a = yh[t.linkage];
    return (a != null && (t.linkage = a), t);
  },
  tu = function (e, t, a, n, i) {
    for (
      var s = 0,
        o = 1 / 0,
        l,
    ...
    if ((i.mode === "threshold" && o >= i.threshold) || (i.mode === "dendrogram" && e.length === 1)) return !1;
    var d = t[s],
      y = t[n[s]],
      g;
    (i.mode === "dendrogram"
    ...
    for (var p = 0; p < e.length; p++) {
      ...
      (d.key === m.key
        ? (l = 1 / 0)
        : i.linkage === "min"
          ? ((l = a[d.key][m.key]), a[d.key][m.key] > a[y.key][m.key] && (l = a[y.key][m.key]))
          : i.linkage === "max"
            ? ((l = a[d.key][m.key]), a[d.key][m.key] < a[y.key][m.key] && (l = a[y.key][m.key]))
            : i.linkage === "mean"
  ...
  $t = function (e, t, a) {
    e && (e.value ? t.push(e.value) : (e.left && $t(e.left, t), e.right && $t(e.right, t)));
  },
  Ms = function (e, t) {
    if (!e) return "";
    if (e.left && e.right) {
      var a = Ms(e.left, t),
        n = Ms(e.right, t),
        i = t.add({ group: "nodes", data: { id: a + "," + n } });
      return (
  ...
  Ls = function (e, t, a) {
    ...
    var n = [],
      ...
      s = [];
    return t === 0
      ? (e.left && $t(e.left, n), e.right && $t(e.right, i), (s = n.concat(i)), [a.collection(s)])
      : t === 1
        ? e.value
          ? [a.collection(e.value)]
          : (e.left && $t(e.left, n), e.right && $t(e.right, i), [a.collection(n), a.collection(i)])
        : e.value
          ? [a.collection(e.value)]
          : (e.left && (n = Ls(e.left, t - 1, a)), e.right && (i = Ls(e.right, t - 1, a)), n.concat(i));
  },
  au = function (e) {
    for (
      var t = this.cy(),
    ...
    for (var h = 0; h < o.length; h++)
      for (var d = 0; d <= h; d++) {
        var y = void 0;
        (n.mode === "dendrogram"
          ? (y = h === d ? 1 / 0 : s(o[h].value, o[d].value))
          : (y = h === d ? 1 / 0 : s(o[h].value[0], o[d].value[0])),
          (l[h][d] = y),
          (l[d][h] = y),
          y < l[h][u[h]] && (u[h] = d));
      }
    for (var g = tu(o, v, l, u, n); g; ) g = tu(o, v, l, u, n);
    var p;
    return (
      n.mode === "dendrogram"
        ? ((p = Ls(o[0], n.dendrogramDepth, t)), n.addDendrogram && Ms(o[0], t))
  ...
  bh = { hierarchicalClustering: au, hca: au },
  wh = cr({
    distance: "euclidean",
    preference: "median",
    damping: 0.8,
  ...
  xh = function (e) {
    var t = e.damping,
      a = e.preference;
    (0.5 <= t && t < 1) || $e("Damping must range on [0.5, 1).  Got: ".concat(t));
  ...
  nu = function (e, t, a) {
    ...
    for (var v = 0; v < a.length; v++) n[a[v]] = a[v];
    return n;
  },
  Sh = function (e, t, a) {
    for (var n = nu(e, t, a), i = 0; i < a.length; i++) {
      for (var s = [], o = 0; o < n.length; o++) n[o] === a[i] && s.push(o);
      for (var l = -1, u = -1 / 0, v = 0; v < s.length; v++) {
        for (var f = 0, c = 0; c < s.length; c++) f += t[s[c] * e + s[v]];
        f > u && ((l = v), (u = f));
      }
      a[i] = s[l];
    }
  ...
  iu = function (e) {
    for (var t = this.cy(), a = this.nodes(), n = xh(e), i = {}, s = 0; s < a.length; s++) i[a[s].id()] = s;
    var o, l, u, v, f, c;
    ((o = a.length), (l = o * o), (u = new Array(l)));
    for (var h = 0; h < l; h++) u[h] = -1 / 0;
    for (var d = 0; d < o; d++)
      for (var y = 0; y < o; y++) d !== y && (u[d * o + y] = Eh(n.distance, a[d], a[y], n.attributes));
    v = Ch(u, n.preference);
    for (var g = 0; g < o; g++) u[g * o + g] = v;
    f = new Array(l);
    for (var p = 0; p < l; p++) f[p] = 0;
    c = new Array(l);
    for (var m = 0; m < l; m++) c[m] = 0;
    for (var b = new Array(o), w = new Array(o), E = new Array(o), C = 0; C < o; C++)
      ((b[C] = 0), (w[C] = 0), (E[C] = 0));
    for (var x = new Array(o * n.minIterations), T = 0; T < x.length; T++) x[T] = 0;
    var k;
    for (k = 0; k < n.maxIterations; k++) {
      for (var D = 0; D < o; D++) {
        for (var B = -1 / 0, P = -1 / 0, A = -1, R = 0, L = 0; L < o; L++)
          ((b[L] = f[D * o + L]),
            (R = c[D * o + L] + u[D * o + L]),
            R >= B ? ((P = B), (B = R), (A = L)) : R > P && (P = R));
        for (var I = 0; I < o; I++) f[D * o + I] = (1 - n.damping) * (u[D * o + I] - B) + n.damping * b[I];
        f[D * o + A] = (1 - n.damping) * (u[D * o + A] - P) + n.damping * b[A];
      }
      for (var M = 0; M < o; M++) {
        for (var O = 0, V = 0; V < o; V++) ((b[V] = c[V * o + M]), (w[V] = Math.max(0, f[V * o + M])), (O += w[V]));
        ((O -= w[M]), (w[M] = f[M * o + M]), (O += w[M]));
        for (var G = 0; G < o; G++) c[G * o + M] = (1 - n.damping) * Math.min(0, O - w[G]) + n.damping * b[G];
        c[M * o + M] = (1 - n.damping) * (O - w[M]) + n.damping * b[M];
      }
      for (var N = 0, F = 0; F < o; F++) {
        var U = c[F * o + F] + f[F * o + F] > 0 ? 1 : 0;
        ((x[(k % n.minIterations) * o + F] = U), (N += U));
      }
      if (N > 0 && (k >= n.minIterations - 1 || k == n.maxIterations - 1)) {
        for (var Q = 0, K = 0; K < o; K++) {
          E[K] = 0;
          for (var j = 0; j < n.minIterations; j++) E[K] += x[j * o + K];
          (E[K] === 0 || E[K] === n.minIterations) && Q++;
        }
        if (Q === o) break;
      }
    }
    for (var re = Th(o, f, c), ne = Sh(o, u, re), J = {}, z = 0; z < re.length; z++) J[re[z]] = [];
    for (var q = 0; q < a.length; q++) {
      var H = i[a[q].id()],
        Y = ne[H];
      Y != null && J[Y].push(a[q]);
    }
    for (var te = new Array(re.length), ce = 0; ce < re.length; ce++) te[ce] = t.collection(J[re[ce]]);
    return te;
  },
  kh = { affinityPropagation: iu, ap: iu },
  Dh = cr({ root: void 0, directed: !1 }),
  Bh = {
    hierholzer: function (e) {
      ...
      var a = Dh(e),
        ...
        u,
        v;
      n && (v = ge(n) ? this.filter(n)[0].id() : n[0].id());
      var f = {},
        c = {};
      i
        ? s.forEach(function (m) {
            ...
            if (m.isNode()) {
              var w = m.indegree(!0),
                ...
                C = w - E,
                x = E - w;
              (C == 1 ? (l ? (o = !0) : (l = b)) : x == 1 ? (u ? (o = !0) : (u = b)) : (x > 1 || C > 1) && (o = !0),
                (f[b] = []),
                m.outgoers().forEach(function (T) {
                  T.isEdge() && f[b].push(T.id());
                }));
            } else c[b] = [void 0, m.target().id()];
          })
        : s.forEach(function (m) {
            var b = m.id();
            if (m.isNode()) {
              ...
              (w % 2 && (l ? (u ? (o = !0) : (u = b)) : (l = b)),
                (f[b] = []),
                m.connectedEdges().forEach(function (E) {
                  return f[b].push(E.id());
                }));
            } else c[b] = [m.source().id(), m.target().id()];
          });
      ...
      var d = function (b) {
          for (var w = b, E = [b], C, x, T; f[w].length; )
            ((C = f[w].shift()),
              ...
              (T = c[C][1]),
              w != T
                ? ((f[T] = f[T].filter(function (k) {
                    return k != C;
                  })),
                  (w = T))
                : !i &&
                  w != x &&
                  ((f[x] = f[x].filter(function (k) {
                    return k != C;
                  })),
                  (w = x)),
              E.unshift(C),
      ...
      for (g = d(v); g.length != 1; )
        f[g[0]].length == 0
          ? (y.unshift(s.getElementById(g.shift())), y.unshift(s.getElementById(g.shift())))
          : (g = d(g.shift()).concat(g));
      y.unshift(s.getElementById(g.shift()));
      for (var p in f) if (f[p].length) return h;
  ...
  Qa = function () {
    var e = this,
      ...
      o = {},
      l = function (c, h) {
        for (var d = s.length - 1, y = [], g = e.spawn(); s[d].x != c || s[d].y != h; ) (y.push(s.pop().edge), d--);
        (y.push(s.pop().edge),
          y.forEach(function (p) {
            ...
            (g.merge(p),
              m.forEach(function (b) {
                var w = b.id(),
                  E = b.connectedEdges().intersection(e);
                (g.merge(b),
                  t[w].cutVertex
                    ? g.merge(
                        E.filter(function (C) {
      ...
      u = function (c, h, d) {
        (c === d && (n += 1), (t[h] = { id: a, low: a++, cutVertex: !1 }));
        var y = e.getElementById(h).connectedEdges().intersection(e);
        if (y.size() === 0) i.push(e.spawn(e.getElementById(h)));
        else {
          var g, p, m, b;
          y.forEach(function (w) {
            ((g = w.source().id()),
              ...
              m !== d &&
                ((b = w.id()),
                o[b] || ((o[b] = !0), s.push({ x: h, y: m, edge: w })),
                m in t
                  ? (t[h].low = Math.min(t[h].low, t[m].id))
                  : (u(c, m, h),
                    (t[h].low = Math.min(t[h].low, t[m].low)),
                    t[h].id <= t[m].low && ((t[h].cutVertex = !0), l(h, m)))));
          });
        }
      };
    ...
    return { cut: e.spawn(v), components: i };
  },
  Ph = { hopcroftTarjanBiconnected: Qa, htbc: Qa, htb: Qa, hopcroftTarjanBiconnectedComponents: Qa },
  Ja = function () {
    var e = this,
      t = {},
      a = 0,
      ...
      s = e.spawn(e),
      o = function (u) {
        (i.push(u), (t[u] = { index: a, low: a++, explored: !1 }));
        ...
        if (
          ...
          for (var f = e.spawn(); ; ) {
            var c = i.pop();
            if ((f.merge(e.getElementById(c)), (t[c].low = t[u].index), (t[c].explored = !0), c === u)) break;
          }
          var h = f.edgesWith(f),
            d = f.merge(h);
  ...
  Ah = { tarjanStronglyConnected: Ja, tsc: Ja, tscc: Ja, tarjanStronglyConnectedComponents: Ja },
  Dv = {};
...
Nr.prototype = {
  fulfill: function (e) {
    return su(this, Pv, "fulfillValue", e);
  },
  reject: function (e) {
    return su(this, Av, "rejectReason", e);
  },
  then: function (e, t) {
    var a = this,
      n = new Nr();
    return (a.onFulfilled.push(uu(e, n, "fulfill")), a.onRejected.push(uu(t, n, "reject")), Rv(a), n.proxy);
  },
};
var su = function (e, t, a, n) {
  ...
  Rv = function (e) {
    e.state === Pv ? ou(e, "onFulfilled", e.fulfillValue) : e.state === Av && ou(e, "onRejected", e.rejectReason);
  },
  ou = function (e, t, a) {
    if (e[t].length !== 0) {
      var n = e[t];
...
var ta = typeof Promise < "u" ? Promise : Nr,
  Is = function (e, t, a) {
    var n = Ys(e),
      i = !n,
      s = (this._private = be({ duration: 1e3 }, t, a));
    if (
      ((s.target = e),
      ...
      (s.completes = []),
      (s.frames = []),
      s.complete && Ue(s.complete) && s.completes.push(s.complete),
      i)
    ) {
      var o = e.position();
    ...
    if (n) {
      var l = e.pan();
      ((s.startPan = { x: l.x, y: l.y }), (s.startZoom = e.zoom()));
    }
    ((this.length = 1), (this[0] = this));
  },
  Pt = Is.prototype;
be(Pt, {
  ...
  hook: function () {
    ...
    if (!e.hooked) {
      var t,
        a = e.target._private.animation;
      (e.queue ? (t = a.queue) : (t = a.current),
        t.push(this),
        Dr(e.target) && e.target.cy().addToAnimationPool(e.target),
        (e.hooked = !0));
    }
    return this;
  },
...
var Rh = {
    ...
    delay: function () {
      return function (t, a) {
        ...
        return n.styleEnabled() ? this.animate({ delay: t, duration: t, complete: a }) : this;
      };
    },
    delayAnimation: function () {
      return function (t, a) {
        var n = this._private.cy || this;
        return n.styleEnabled() ? this.animation({ delay: t, duration: t, complete: a }) : this;
      };
    },
    animation: function () {
      return function (t, a) {
        ...
        if (l && t.fit != null) {
          var b = t.fit,
            w = o.getFitViewport(b.eles || b.boundingBox, b.padding);
    ...
    animate: function () {
      return function (t, a) {
        ...
        for (var l = 0; l < s.length; l++) {
          var u = s[l],
            v = u.animated() && (t.queue === void 0 || t.queue),
            f = u.animation(t, v ? { queue: !0 } : void 0);
          f.play();
        }
        return this;
      };
...
function Mh() {
  ...
  function n(i, s) {
    if (r(i)) return !1;
    var o = typeof i;
    return o == "number" || o == "symbol" || o == "boolean" || i == null || e(i)
      ? !0
      : a.test(i) || !t.test(i) || (s != null && i in Object(s));
  }
  return ((wi = n), wi);
}
var xi, fu;
...
function Ov() {
  ...
  $u = 1;
  function r(e, t) {
    for (var a = -1, n = e == null ? 0 : e.length, i = Array(n); ++a < n; ) i[a] = t(e[a], a, e);
    return i;
  }
  return ((rs = r), rs);
}
...
function dg() {
  ...
  var r = cg();
  function e(t, a, n) {
    a == "__proto__" && r ? r(t, a, { configurable: !0, enumerable: !0, value: n, writable: !0 }) : (t[a] = n);
  }
  return ((ls = e), ls);
}
var vs, el;
...
function pg() {
  ...
  function i(s, o, l, u) {
    if (!a(s)) return s;
    o = e(o, s);
    for (var v = -1, f = o.length, c = f - 1, h = s; h != null && ++v < f; ) {
      var d = n(o[v]),
        y = l;
      if (d === "__proto__" || d === "constructor" || d === "prototype") return s;
      if (v != c) {
        var g = h[d];
        ((y = u ? u(g, d, h) : void 0), y === void 0 && (y = a(g) ? g : t(o[v + 1]) ? [] : {}));
      }
      (r(h, d, y), (h = h[d]));
    }
    return s;
...
function xg() {
  ...
  var r = Ov(),
    ...
    s = Nv();
  function o(l) {
    return t(l) ? r(l, i) : a(l) ? [l] : e(n(s(l)));
  }
  return ((gs = o), gs);
}
var Eg = xg(),
  ...
  Tg = {
          ...
          if (ge(n)) {
            ...
            if (s.allowGetting && i === void 0) {
              ...
              return (
                v &&
                  (s.beforeGet(v),
                  c && v._private[s.field][n] === void 0
                    ? (h = fg(v._private[s.field], c))
                    : (h = v._private[s.field][n])),
                h
              );
              ...
              if (d) {
                ...
                (s.updateStyle && o.updateStyle(),
                  s.onSet(o),
                  s.settingTriggersEvent && o[s.triggerFnName](s.settingEvent));
              }
            }
            ...
            for (var x = 0; x < C.length; x++) {
              ...
              if (T)
                for (var k = 0; k < u.length; k++) {
                  var D = u[k];
                  s.canSet(D) && (D._private[s.field][w] = E);
                }
            }
            (s.updateStyle && o.updateStyle(),
              s.onSet(o),
              s.settingTriggersEvent && o[s.triggerFnName](s.settingEvent));
          } else if (s.allowBinding && Ue(n)) {
            var B = n;
            o.on(s.bindingEvent, B);
          } else if (s.allowGetting && n === void 0) {
            var P;
            return (v && (s.beforeGet(v), (P = v._private[s.field])), P);
          }
          return o;
        }
      );
    ...
    removeData: function (e) {
      var t = { field: "data", event: "data", triggerFnName: "trigger", triggerEvent: !1, immutableKeys: {} };
      return (
        (e = be({}, t, e)),
        function (n) {
          var i = e,
          ...
          if (ge(n)) {
            for (var u = n.split(/\s+/), v = u.length, f = 0; f < v; f++) {
              var c = u[f];
              if (!ut(c)) {
                var h = !i.immutableKeys[c];
                if (h) for (var d = 0, y = l.length; d < y; d++) l[d]._private[i.field][c] = void 0;
              }
            }
  ...
  vn = {
    classes: function (e) {
      ...
      if (e === void 0) {
        var a = [];
        return (
          t[0]._private.classes.forEach(function (d) {
            return a.push(d);
          }),
          a
        );
      ...
      for (var n = [], i = new ra(e), s = 0; s < t.length; s++) {
        ...
        (v || (v = u.size !== e.length), v && ((l.classes = i), n.push(o)));
      }
    ...
    toggleClass: function (e, t) {
      ...
      for (var a = this, n = t === void 0, i = [], s = 0, o = a.length; s < o; s++)
        for (var l = a[s], u = l._private.classes, v = !1, f = 0; f < e.length; f++) {
          var c = e[f],
            h = u.has(c),
            d = !1;
          (t || (n && !h) ? (u.add(c), (d = !0)) : (!t || (n && h)) && (u.delete(c), (d = !0)),
            !v && d && (i.push(l), (v = !0)));
        }
...
vn.className = vn.classNames = vn.classes;
var Me = {
  metaChar: "[\\!\\\"\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\.\\/\\:\\;\\<\\=\\>\\?\\@\\[\\]\\^\\`\\{\\|\\}\\~]",
  comparatorOp: "=|\\!=|>|>=|<|<=|\\$=|\\^=|\\*=",
  boolOp: "\\?|\\!|\\^",
...
(function () {
  var r, e, t;
  for (r = Me.comparatorOp.split("|"), t = 0; t < r.length; t++) ((e = r[t]), (Me.comparatorOp += "|@" + e));
  for (r = Me.comparatorOp.split("|"), t = 0; t < r.length; t++)
    ((e = r[t]), !(e.indexOf("!") >= 0) && e !== "=" && (Me.comparatorOp += "|\\!" + e));
})();
var qe = function () {
    return { checks: [] };
  },
  ...
  Os = [
    ...
    return Tc(r.selector, e.selector);
  }),
  Dg = (function () {
    for (var r = {}, e, t = 0; t < Os.length; t++) ((e = Os[t]), (r[e.selector] = e.matches));
    return r;
  })(),
  Bg = function (e, t) {
    return Dg[e](t);
  ...
  Pg =
    ...
    ")",
  Ot = function (e) {
    return e.replace(new RegExp("\\\\(" + Me.metaChar + ")", "g"), function (t, a) {
      return a;
    });
  },
  rt = function (e, t, a) {
  ...
  Ns = [
    ...
    },
    {
      ...
      populate: function (e, t, a) {
        var n = Je(a, 3),
          ...
          s = n[1],
          o = n[2],
          l = new RegExp("^" + Me.string + "$").exec(o) != null;
        (l ? (o = o.substring(1, o.length - 1)) : (o = parseFloat(o)),
    ...
    },
    {
      ...
      populate: function (e, t) {
        var a = e.currentSubject,
          ...
          i = e.compoundCount,
          s = e[e.length - 1];
        (a != null && ((s.subject = a), (e.currentSubject = null)),
          (s.edgeCount = n),
          (s.compoundCount = i),
          (e.edgeCount = 0),
          (e.compoundCount = 0));
      ...
      populate: function (e, t) {
        if (e.currentSubject == null) {
          var a = qe(),
            n = t,
            i = qe();
          return (a.checks.push({ type: se.DIRECTED_EDGE, source: n, target: i }), rt(e, t, a), e.edgeCount++, i);
        } else {
          var s = qe(),
            o = t,
            l = qe();
          return (s.checks.push({ type: se.NODE_SOURCE, source: o, target: l }), rt(e, t, s), e.edgeCount++, l);
        }
      },
    },
    {
      ...
      populate: function (e, t) {
        if (e.currentSubject == null) {
          var a = qe(),
            n = t,
            i = qe();
          return (a.checks.push({ type: se.UNDIRECTED_EDGE, nodes: [n, i] }), rt(e, t, a), e.edgeCount++, i);
        } else {
          var s = qe(),
            o = t,
            l = qe();
          return (s.checks.push({ type: se.NODE_NEIGHBOR, node: o, neighbor: l }), rt(e, t, s), l);
        }
      },
    },
    {
      ...
      populate: function (e, t) {
        if (e.currentSubject == null) {
          var a = qe(),
            n = qe(),
            i = e[e.length - 1];
          return (a.checks.push({ type: se.CHILD, parent: i, child: n }), rt(e, t, a), e.compoundCount++, n);
          ...
          var c = qe(),
            h = qe(),
            d = [{ type: se.PARENT, parent: c, child: h }];
    ...
    },
    {
      ...
      populate: function (e, t) {
        if (e.currentSubject == null) {
          ...
          var c = qe(),
            h = qe(),
            d = [{ type: se.ANCESTOR, ancestor: c, descendant: h }];
          return ((c.checks = t.checks), (t.checks = d), e.compoundCount++, h);
        }
      },
    },
    {
      ...
      populate: function (e, t) {
        ...
        var a = e[e.length - 1],
          n = a.checks[0],
          i = n == null ? null : n.type;
        i === se.DIRECTED_EDGE
          ? (n.type = se.NODE_TARGET)
          : i === se.UNDIRECTED_EDGE &&
            ((n.type = se.NODE_NEIGHBOR), (n.node = n.nodes[1]), (n.neighbor = n.nodes[0]), (n.nodes = null));
      },
    },
  ];
...
var Ag = function (e) {
  ...
  Mg = function (e) {
    var t = this,
      a = (t.inputText = e),
      n = (t[0] = qe());
    for (t.length = 1, a = Rg(a); ; ) {
      var i = Ag(a);
      if (i.expr == null) return (Ve("The selector `" + e + "`is invalid"), !1);
  ...
  Fv = function (e, t, a) {
    var n,
      ...
      c = !1;
    switch (
      (t.indexOf("!") >= 0 && ((t = t.replace("!", "")), (f = !0)),
      t.indexOf("@") >= 0 && ((t = t.replace("@", "")), (v = !0)),
      (i || o || v) && ((l = !i && !s ? "" : "" + e), (u = "" + a)),
      v && ((e = l = l.toLowerCase()), (a = u = u.toLowerCase())),
      t)
    ) {
      case "*=":
        n = l.indexOf(u) >= 0;
  ...
  We = function (e, t) {
    return e.checks.every(function (a) {
      return Xe[a.type](a, t);
    });
  };
Xe[se.GROUP] = function (r, e) {
  var t = r.value;
  return t === "*" || t === e.group();
};
Xe[se.STATE] = function (r, e) {
  var t = r.value;
  return Bg(t, e);
};
Xe[se.ID] = function (r, e) {
  var t = r.value;
  return e.id() === t;
};
Xe[se.CLASS] = function (r, e) {
  var t = r.value;
  return e.hasClass(t);
};
Xe[se.META_COMPARE] = function (r, e) {
  var t = r.field,
    a = r.operator,
    n = r.value;
...
Xe[se.NODE_NEIGHBOR] = function (r, e) {
  return (
    We(r.node, e) &&
    e.neighborhood().some(function (t) {
      return t.isNode() && We(r.neighbor, t);
    })
  );
};
Xe[se.DIRECTED_EDGE] = function (r, e) {
  return We(r.source, e.source()) && We(r.target, e.target());
};
Xe[se.NODE_SOURCE] = function (r, e) {
  return (
    We(r.source, e) &&
    e.outgoers().some(function (t) {
      return t.isNode() && We(r.target, t);
    })
  );
};
Xe[se.NODE_TARGET] = function (r, e) {
  return (
    We(r.target, e) &&
    e.incomers().some(function (t) {
      return t.isNode() && We(r.source, t);
    })
  );
};
Xe[se.CHILD] = function (r, e) {
  return We(r.child, e) && We(r.parent, e.parent());
};
Xe[se.PARENT] = function (r, e) {
  return (
    We(r.parent, e) &&
...
Xe[se.DESCENDANT] = function (r, e) {
  return (
    We(r.descendant, e) &&
    e.ancestors().some(function (t) {
      return We(r.ancestor, t);
    })
  );
};
Xe[se.ANCESTOR] = function (r, e) {
  return (
    We(r.ancestor, e) &&
    e.descendants().some(function (t) {
      return We(r.descendant, t);
    })
  );
};
Xe[se.COMPOUND_SPLIT] = function (r, e) {
  return We(r.subject, e) && We(r.left, e) && We(r.right, e);
};
Xe[se.TRUE] = function () {
  return !0;
};
Xe[se.COLLECTION] = function (r, e) {
  var t = r.value;
  return t.has(e);
};
Xe[se.FILTER] = function (r, e) {
  var t = r.value;
  return t(e);
};
var Fg = function (e) {
    var t = this;
    if (t.length === 1 && t[0].checks.length === 1 && t[0].checks[0].type === se.ID)
...
ct.sameText = function (r) {
  return !this.invalid && !r.invalid && this.text() === r.text();
};
ct.addQuery = function (r) {
  this[this.length++] = r;
};
ct.selector = ct.toString;
var st = {
  allAre: function (e) {
    var t = new ft(e);
...
st.allAreNeighbours = st.allAreNeighbors;
st.has = st.contains;
st.equal = st.equals = st.same;
var Rr = function (e, t) {
    return function (n, i, s, o) {
      ...
      if ((l == null ? (v = "") : Dr(l) && l.length === 1 && (v = l.id()), u.length === 1 && v)) {
        var f = u[0]._private,
          c = (f.traversalCache = f.traversalCache || {}),
          h = (c[t] = c[t] || []),
          d = Dt(v),
          y = h[d];
  ...
  jt = {
    ...
    children: Rr(function (r) {
      for (var e = [], t = 0; t < this.length; t++)
        for (var a = this[t], n = a._private.children, i = 0; i < n.length; i++) e.push(n[i]);
...
Ba = _v = {
  ...
  removeRscratch: Fe.removeData({ field: "rscratch", triggerEvent: !1 }),
  id: function () {
    var e = this[0];
...
be(_n, {
  degree: ps(function (r, e) {
    return e.source().same(e.target()) ? 2 : 1;
  }),
  indegree: ps(function (r, e) {
    return e.target().same(r) ? 1 : 0;
  }),
  outdegree: ps(function (r, e) {
...
be(_n, {
  minDegree: Nt("degree", function (r, e) {
    return r < e;
  }),
  maxDegree: Nt("degree", function (r, e) {
    return r > e;
  }),
  minIndegree: Nt("indegree", function (r, e) {
    return r < e;
  }),
  maxIndegree: Nt("indegree", function (r, e) {
    return r > e;
  }),
  minOutdegree: Nt("outdegree", function (r, e) {
    return r < e;
  }),
  maxOutdegree: Nt("outdegree", function (r, e) {
    return r > e;
  }),
});
be(_n, {
  totalDegree: function (e) {
    for (var t = 0, a = this.nodes(), n = 0; n < a.length; n++) t += a[n].degree(e);
    return t;
  },
});
var Or,
    ...
    for (var n = 0; n < e.length; n++) {
      ...
      if (!i.locked()) {
        var s = i._private.position,
          o = { x: t.x != null ? t.x - s.x : 0, y: t.y != null ? t.y - s.y : 0 };
...
Or = Gv = {
  ...
  positions: function (e, t) {
    if (Le(e)) t ? this.silentPosition(e) : this.position(e);
    else if (Ue(e)) {
      var a = e,
        n = this.cy();
      n.startBatch();
  ...
  shift: function (e, t, a) {
    ...
    if (
      (Le(e)
        ? ((n = { x: ae(e.x) ? e.x : 0, y: ae(e.y) ? e.y : 0 }), (a = t))
        : ge(e) && ae(t) && ((n = { x: 0, y: 0 }), (n[e] = t)),
      n != null)
    ) {
      var i = this.cy();
      i.startBatch();
  ...
  silentShift: function (e, t) {
    return (Le(e) ? this.shift(e, !0) : ge(e) && ae(t) && this.shift(e, t, !0), this);
  },
  renderedPosition: function (e, t) {
    var a = this[0],
      ...
      s = n.pan(),
      o = Le(e) ? e : void 0,
      l = o !== void 0 || (t !== void 0 && ge(e));
    if (a && a.isNode())
      if (l)
        for (var u = 0; u < this.length; u++) {
          var v = this[u];
          t !== void 0 ? v.position(e, (t - s[e]) / i) : o !== void 0 && v.position(yv(o, i, s));
        }
      else {
        var f = a.position();
    ...
    if (a && a.isNode())
      if (s)
        for (var l = 0; l < this.length; l++) {
          ...
          t !== void 0 ? u.position(e, t + h[e]) : i !== void 0 && u.position({ x: i.x + h.x, y: i.y + h.y });
        }
      else {
        var d = a.position(),
          y = o ? a.parent() : null,
        ...
        return ((i = { x: d.x - m.x, y: d.y - m.y }), e === void 0 ? i : i[e]);
      }
    else if (!s) return;
    return this;
  },
...
var Hg = Gv,
  ...
  pt;
Zt = pt = {};
pt.renderedBoundingBox = function (r) {
...
pt.dirtyCompoundBoundsCache = function () {
...
pt.updateCompoundBounds = function () {
  var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1,
    e = this.cy();
  ...
  function t(s) {
    ...
    var o = s._private,
      l = s.children(),
      u = s.pstyle("compound-sizing-wrt-labels").value === "include",
      v = {
        width: {
      ...
      f = l.boundingBox({ includeLabels: u, includeOverlays: !1, useCache: !1 }),
      c = o.position;
    (f.w === 0 || f.h === 0) &&
    ...
    function h(k, D, B) {
      var P = 0,
        A = 0,
        R = D + B;
      return (k > 0 && R > 0 && ((P = (D / R) * k), (A = (B / R) * k)), { biasDiff: P, biasComplementDiff: A });
    }
    function d(k, D, B, P) {
      if (B.units === "%")
        switch (P) {
    ...
    v.height.bottom.units === "px" && v.height.val > 0 && (m = (m * 100) / v.height.val);
    var b = h(v.width.val - f.w, y, g),
      w = b.biasDiff,
      E = b.biasComplementDiff,
      C = h(v.height.val - f.h, p, m),
      x = C.biasDiff,
      T = C.biasComplementDiff;
...
var Ar = function (e) {
  ...
  ja = function (e, t, a) {
    if (!t.cy().headless()) {
      var n = t._private,
        i = n.rstyle,
        s = i.arrowWidth / 2,
        o = t.pstyle(a + "-arrow-shape").value,
        l,
        u;
      if (o !== "none") {
        a === "source"
  ...
  ys = function (e, t, a) {
    if (!t.cy().headless()) {
      ...
      var i = t._private,
        s = i.rstyle,
        o = t.pstyle(n + "label").strValue;
      if (o) {
        var l = t.pstyle("text-halign"),
          u = t.pstyle("text-valign"),
          v = fa(s, "labelWidth", a),
          f = fa(s, "labelHeight", a),
          c = fa(s, "labelX", a),
          h = fa(s, "labelY", a),
          d = t.pstyle(n + "text-margin-x").pfValue,
          y = t.pstyle(n + "text-margin-y").pfValue,
          g = t.isEdge(),
          p = t.pstyle(n + "text-rotation"),
        ...
        var L = d - Math.max(m, w) - E - C,
          I = d + Math.max(m, w) + E + C,
          M = y - Math.max(m, w) - E - C,
          O = y + Math.max(m, w) + E + C;
        ((B += L), (P += I), (A += M), (R += O));
        var V = a || "main",
          G = i.labelBounds,
          N = (G[V] = G[V] || {});
        ...
        if (F || U) {
          ...
          var J = function (Ce, we) {
              return ((Ce = Ce - re), (we = we - ne), { x: Ce * K - we * j + re, y: Ce * j + we * K + ne });
            },
            z = J(B, A),
            q = J(B, R),
            H = J(P, A),
  ...
  ol = function (e, t) {
    if (!t.cy().headless()) {
      var a = t.pstyle("outline-opacity").value,
        n = t.pstyle("outline-width").value,
        i = t.pstyle("outline-offset").value,
        s = n + i;
      Wv(e, t, a, s, "outside", s / 2);
    }
  },
  Wv = function (e, t, a, n, i, s) {
    if (!(a === 0 || n <= 0 || i === "inside")) {
      var o = t.cy(),
        l = o.renderer(),
        u = l.nodeShapes[l.getNodeShape(t)];
      if (u) {
        var v = t.position(),
          f = v.x,
          c = v.y,
  ...
  $g = function (e, t) {
    var a = e._private.cy,
      ...
      y,
      g = o.rstyle,
      p = l && n ? e.pstyle("bounds-expansion").pfValue : [0],
      m = function (Ae) {
        return Ae.pstyle("display").value !== "none";
      },
    ...
    if (b) {
      ...
      n &&
        t.includeOverlays &&
        ((w = e.pstyle("overlay-opacity").value), w !== 0 && (E = e.pstyle("overlay-padding").value));
      var C = 0,
        x = 0;
      n &&
        t.includeUnderlays &&
        ((C = e.pstyle("underlay-opacity").value), C !== 0 && (x = e.pstyle("underlay-padding").value));
      var T = Math.max(E, x),
        k = 0,
        D = 0;
      if ((n && ((k = e.pstyle("width").pfValue), (D = k / 2)), l && t.includeNodes)) {
        var B = e.position();
        ((d = B.x), (y = B.y));
        var P = e.outerWidth(),
          A = P / 2,
        ...
        if (n && !i) {
          ...
          if (
            ...
            var M = g.haystackPts;
            if (M && M.length === 2) {
              if (((v = M[0].x), (c = M[0].y), (f = M[1].x), (h = M[1].y), v > f)) {
                var O = v;
                ((v = f), (f = O));
              }
              if (c > h) {
          ...
          } else if (I === "bezier" || I === "unbundled-bezier" || at(I, "segments") || at(I, "taxi")) {
            var G;
            switch (I) {
              case "bezier":
            ...
            if (G != null)
              for (var N = 0; N < G.length; N++) {
                var F = G[N];
                ((v = F.x - D), (f = F.x + D), (c = F.y - D), (h = F.y + D), Ir(s, v, c, f, h));
              }
          }
        } else {
          var U = e.source(),
            ...
            K = e.target(),
            j = K.position();
          if (((v = Q.x), (f = j.x), (c = Q.y), (h = j.y), v > f)) {
            var re = v;
            ((v = f), (f = re));
          }
          if (c > h) {
          ...
          ((v -= D), (f += D), (c -= D), (h += D), Ir(s, v, c, f, h));
        }
      if (
        (n &&
          t.includeEdges &&
          u &&
          (ja(s, e, "mid-source"), ja(s, e, "mid-target"), ja(s, e, "source"), ja(s, e, "target")),
        n)
      ) {
        var J = e.pstyle("ghost").value === "yes";
        if (J) {
          var z = e.pstyle("ghost-offset-x").pfValue,
            q = e.pstyle("ghost-offset-y").pfValue;
      ...
      (Uo(H, s),
        ln(H, p),
        un(H, 1),
        n && ((v = s.x1), (f = s.x2), (c = s.y1), (h = s.y2), Ir(s, v - T, c - T, f + T, h + T)));
      var Y = (o.overlayBounds = o.overlayBounds || {});
      (Uo(Y, s), ln(Y, p), un(Y, 1));
      var te = (o.labelBounds = o.labelBounds || {});
      (te.all != null ? kd(te.all) : (te.all = wr()),
        n &&
          t.includeLabels &&
  ...
  ul = function (e, t) {
    var a = e._private,
      ...
      s = t == null ? ll : $v(t),
      o = s === ll;
    if ((a.bbCache == null ? ((n = $g(e, Pa)), (a.bbCache = n), (a.bbCachePosKey = Uv(e))) : (n = a.bbCache), !o)) {
      var l = e.isNode();
      ((n = wr()),
        ((t.includeNodes && l) || (t.includeEdges && !l)) &&
          (t.includeOverlays ? tt(n, a.overlayBounds) : tt(n, a.bodyBounds)),
        t.includeLabels &&
...
pt.boundingBox = function (r) {
  var e,
    t = r === void 0 || r.useCache === void 0 || r.useCache === !0,
    a = Qt(
      function (v) {
        var f = v._private;
        return f.bbCache == null || f.styleDirty || f.bbCachePosKey !== Uv(v);
      },
      function (v) {
        return v.id();
      }
    );
  if (t && this.length === 1 && !a(this[0])) (r === void 0 ? (r = Pa) : (r = vl(r)), (e = ul(this[0], r)));
  else {
    ((e = wr()), (r = r || Pa));
    var n = vl(r),
      i = this,
    ...
    (this.edges().forEach(a),
      ...
      o && this.recalculateRenderedStyle(t),
      this.updateCompoundBounds(!t));
    for (var l = 0; l < i.length; l++) {
      var u = i[l];
      (a(u) && u.dirtyBoundingBoxCache(), tt(e, ul(u, n)));
    }
  }
  return (
    (e.x1 = Ar(e.x1)),
...
pt.boundingBoxAt = function (r) {
  ...
  (t.startBatch(),
    ...
    a && (n.dirtyCompoundBoundsCache(), n.dirtyBoundingBoxCache(), n.updateCompoundBounds(!0)));
  var l = Sd(this.boundingBox({ useCache: !1 }));
  return (
    e.silentPositions(o),
    a && (n.dirtyCompoundBoundsCache(), n.dirtyBoundingBoxCache(), n.updateCompoundBounds(!0)),
    t.endBatch(),
...
Zt.boundingbox = Zt.bb = Zt.boundingBox;
Zt.renderedBoundingbox = Zt.renderedBoundingBox;
var Ug = pt,
  ma,
  qa;
ma = qa = {};
  ...
  ((e.uppercaseName = So(e.name)),
    ...
    (ma["outer" + e.uppercaseName] = function () {
      ...
      if (a)
        if (s) {
          var o = a[e.name](),
            l = a.pstyle("border-position").value,
            u;
          l === "center"
...
qa.padding = function () {
  var r = this[0],
    e = r._private;
  return r.isParent()
    ? (r.updateCompoundBounds(), e.autoPadding !== void 0 ? e.autoPadding : r.pstyle("padding").pfValue)
    : r.pstyle("padding").pfValue;
};
...
var Kg = qa,
  ...
  fl = {
    controlPoints: { get: Qg, mult: !0 },
    segmentPoints: { get: Jg, mult: !0 },
    sourceEndpoint: { get: jg },
    targetEndpoint: { get: ep },
    midpoint: { get: rp },
  },
  tp = function (e) {
    return "rendered" + e[0].toUpperCase() + e.substr(1);
  },
  ap = Object.keys(fl).reduce(function (r, e) {
    var t = fl[e],
      a = tp(e);
    return (
      (r[e] = function () {
...
Xv.prototype = {
  ...
  recycle: function (e, t) {
    if (
      ((this.isImmediatePropagationStopped = this.isPropagationStopped = this.isDefaultPrevented = ca),
      e != null && e.preventDefault
        ? ((this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented ? en : ca))
        : e != null && e.type
          ? (t = e)
          : (this.type = e),
      t != null &&
...
function Gn() {
  for (
    var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : sp,
...
var dt = Gn.prototype,
  Qv = function (e, t, a, n, i, s, o) {
    (Ue(n) && ((i = n), (n = null)), o && (s == null ? (s = o) : (s = be({}, s, o))));
    for (var l = _e(a) ? a : a.split(/\s+/), u = 0; u < l.length; u++) {
      var v = l[u];
      if (!ut(v)) {
        var f = v.match(Yv);
        if (f) {
  ...
  dl = function (e, t) {
    return (e.addEventFields(e.context, t), new Xv(t.type, t));
  },
  op = function (e, t, a) {
    if (dc(a)) {
      t(e, a);
    ...
    for (var n = _e(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
      ...
      if (!ut(s)) {
        ...
        if (o) {
          var l = o[1],
            u = o[2] ? o[2] : null,
            v = dl(e, { type: l, namespace: u, target: e.context });
          t(e, v);
        }
      }
    }
...
dt.on = dt.addListener = function (r, e, t, a, n) {
  return (
    Qv(
      this,
      function (i, s, o, l, u, v, f) {
        Ue(v) && i.listeners.push({ event: s, callback: v, type: o, namespace: l, qualifier: u, conf: f });
      },
      r,
      e,
      t,
...
dt.one = function (r, e, t, a) {
  return this.on(r, e, t, a, { one: !0 });
};
dt.removeListener = dt.off = function (r, e, t, a) {
  var n = this;
  this.emitting !== 0 && (this.listeners = Yc(this.listeners));
  for (
    var i = this.listeners,
      s = function (u) {
        ...
        Qv(
          n,
          function (f, c, h, d, y, g) {
            if (
              (v.type === h || r === "*") &&
              ((!d && v.namespace !== ".*") || v.namespace === d) &&
              (!y || f.qualifierCompare(v.qualifier, y)) &&
              (!g || v.callback === g)
            )
...
dt.removeAllListeners = function () {
  return this.removeListener("*");
};
dt.emit = dt.trigger = function (r, e, t) {
  ...
  return (
    ...
    op(
      this,
      function (i, s) {
        t != null && ((a = [{ event: s.event, type: s.type, namespace: s.namespace, callback: t }]), (n = a.length));
        for (
          var o = function () {
              var v = a[l];
              if (
                v.type === s.type &&
                (!v.namespace || v.namespace === s.namespace || v.namespace === ip) &&
                i.eventMatches(i.context, v, s)
              ) {
                var f = [s];
                (e != null && Qc(f, e),
                  ...
                  v.conf &&
                    v.conf.one &&
                    (i.listeners = i.listeners.filter(function (d) {
                      return d !== v;
                    })));
                var c = i.callbackContext(i.context, v, s),
                  h = v.callback.apply(c, f);
  ...
  Jv = {
    createEmitter: function () {
      for (var e = 0; e < this.length; e++) {
        var t = this[e],
          a = t._private;
        a.emitter || (a.emitter = new Gn(up, t));
      }
      return this;
    },
    emitter: function () {
    ...
    once: function (e, t, a) {
      for (var n = rn(t), i = 0; i < this.length; i++) {
        var s = this[i];
        s.emitter().on(e, n, a, { once: !0, onceCollection: this });
      }
    },
    emit: function (e, t) {
      for (var a = 0; a < this.length; a++) {
...
var jv = {
    ...
    filter: function (e, t) {
      ...
      if (ge(e) || Dr(e)) return new ft(e).filter(this);
      if (Ue(e)) {
        for (var a = this.spawn(), n = this, i = 0; i < n.length; i++) {
          var s = n[i],
            o = t ? e.apply(t, [s, i, n]) : e(s, i, n);
          o && a.push(s);
        }
        return a;
      }
    ...
    intersect: function (e) {
      ...
      for (
        var a = this.spawn(), n = this, i = e, s = this.length < e.length, o = s ? n : i, l = s ? i : n, u = 0;
        u < o.length;
        u++
      ) {
        var v = o[u];
      ...
      var a = this.spawn(),
        ...
        s = function (l, u) {
          for (var v = 0; v < l.length; v++) {
            var f = l[v],
              c = f._private.data.id,
              h = u.hasElementWithId(c);
            h || a.push(f);
          }
        };
      ...
      var a = this.spawn(),
        ...
        l = function (v, f, c) {
          for (var h = 0; h < v.length; h++) {
            var d = v[h],
              y = d._private.data.id,
              g = f.hasElementWithId(y);
            g ? i.merge(d) : c.push(d);
          }
        };
      return (l(s, o, a), l(o, s, n), { left: a, right: n, both: i });
    },
    add: function (e) {
      var t = this._private.cy;
      if (!e) return this;
    ...
    merge: function (e) {
      ...
      for (var i = t.map, s = 0; s < e.length; s++) {
        var o = e[s],
          l = o._private.data.id,
          u = !i.has(l);
        if (u) {
          var v = this.length++;
          ((this[v] = o), i.set(l, { ele: o, index: v }));
        }
      }
      return this;
    },
    unmergeAt: function (e) {
      ...
      if (this.length > 1 && !s) {
        ...
        ((this[o] = void 0), (this[e] = l), i.set(u, { ele: l, index: e }));
      }
    ...
    reduce: function (e, t) {
      for (var a = t, n = this, i = 0; i < n.length; i++) a = e(a, n[i], i, n);
      return a;
    },
    max: function (e, t) {
      for (var a = -1 / 0, n, i = this, s = 0; s < i.length; s++) {
        var o = i[s],
          l = t ? e.apply(t, [o, s, i]) : e(o, s, i);
        l > a && ((a = l), (n = o));
      }
    ...
    forEach: function (e, t) {
      if (Ue(e))
        for (var a = this.length, n = 0; n < a; n++) {
          var i = this[n],
            s = t ? e.apply(t, [i, n, this]) : e(i, n, this);
          if (s === !1) break;
        }
      return this;
    },
...
var vp = function () {
  var e = "undefined",
    t = (typeof Symbol > "u" ? "undefined" : ar(Symbol)) != e && ar(Symbol.iterator) != e;
  t &&
    (Sn[Symbol.iterator] = function () {
      var a = this,
        n = { value: void 0, done: !1 },
        i = 0,
        s = this.length;
      return Jl(
        {
...
vp();
var fp = cr({ nodeDimensionsIncludeLabels: !1 }),
  fn = {
    layoutDimensions: function (e) {
      e = fp(e);
      var t;
      if (!this.takesUpSpace()) t = { w: 0, h: 0 };
    ...
    layoutPositions: function (e, t, a) {
      ...
      var u = function (C, x, T) {
          var k = { x: x.x1 + x.w / 2, y: x.y1 + x.h / 2 },
            D = { x: (T.x - k.x) * C, y: (T.y - k.y) * C };
          return { x: k.x + D.x, y: k.y + D.y };
        },
        v = t.spacingFactor && t.spacingFactor !== 1,
        f = function () {
          if (!v) return null;
      ...
      if (t.animate) {
        for (var d = 0; d < n.length; d++) {
          var y = n[d],
            g = h(y, d),
            p = t.animateFilter == null || t.animateFilter(y, d);
          if (p) {
            var m = y.animation({ position: g, duration: t.animationDuration, easing: t.animationEasing });
            e.animations.push(m);
          } else y.position(g);
        }
        if (t.fit) {
          var b = i.animation({
            fit: { boundingBox: s.boundingBoxAt(h), padding: t.padding },
            duration: t.animationDuration,
            easing: t.animationEasing,
          });
          e.animations.push(b);
        } else if (t.zoom !== void 0 && t.pan !== void 0) {
          var w = i.animation({ zoom: t.zoom, pan: t.pan, duration: t.animationDuration, easing: t.animationEasing });
          e.animations.push(w);
        }
    ...
    layout: function (e) {
      var t = this.cy();
      return t.makeLayout(be({}, e, { eles: this }));
    },
  };
fn.createLayout = fn.makeLayout = fn.layout;
function rf(r, e, t) {
  var a = t._private,
    n = (a.styleCache = a.styleCache || []),
    i;
...
var vr = {
  ...
  updateStyle: function (e) {
    ...
    var s = i;
    return (
      e ? s.emitAndNotify("style") : s.emit("style"),
  ...
  effectiveOpacity: function () {
    ...
    if (a) {
      var n = a._private,
        i = a.pstyle("opacity").value;
      if (!t) return i;
      var s = n.data.parent ? a.parents() : null;
      if (s)
        for (var o = 0; o < s.length; o++) {
          var l = s[o],
            u = l.pstyle("opacity").value;
          i = u * i;
        }
      return i;
    }
...
function ms(r, e) {
  var t = r._private,
    a = t.data.parent ? r.parents() : null;
  if (a)
    for (var n = 0; n < a.length; n++) {
      var i = a[n];
      if (!e(i)) return !1;
...
function vo(r) {
  var e = r.ok,
    t = r.edgeOkViaNode || r.ok,
    a = r.parentOk || r.ok;
  return function () {
    var n = this.cy();
    if (!n.styleEnabled()) return !0;
    var i = this[0],
      s = n.hasCompoundNodes();
    if (i) {
      var o = i._private;
      if (!e(i)) return !1;
      if (i.isNode()) return !s || ms(i, a);
      var l = o.source,
        u = o.target;
...
vr.takesUpSpace = Wn("takesUpSpace", vo({ ok: aa }));
var cp = Hn("eleInteractive", function (r) {
    return r.pstyle("events").value === "yes" && r.pstyle("visibility").value === "visible" && aa(r);
  }),
  dp = Hn("parentInteractive", function (r) {
    return r.pstyle("visibility").value === "visible" && aa(r);
  });
vr.interactive = Wn("interactive", vo({ ok: cp, parentOk: dp, edgeOkViaNode: aa }));
vr.noninteractive = function () {
  var r = this[0];
  if (r) return !r.interactive();
};
var hp = Hn("eleVisible", function (r) {
    return r.pstyle("visibility").value === "visible" && r.pstyle("opacity").pfValue !== 0 && aa(r);
  }),
  gp = aa;
vr.visible = Wn("visible", vo({ ok: hp, edgeOkViaNode: gp }));
vr.hidden = function () {
  var r = this[0];
...
vr.isBundledBezier = Wn("isBundledBezier", function () {
  return this.cy().styleEnabled()
    ? !this.removed() && this.pstyle("curve-style").value === "bezier" && this.takesUpSpace()
    : !1;
});
  ...
  return function () {
    ...
    if (e.length === 2) {
      var a = e[0],
        n = e[1];
      this.on(r.event, a, n);
    } else if (e.length === 1 && Ue(e[0])) {
      var i = e[0];
      this.on(r.event, i);
    } else if (e.length === 0 || (e.length === 1 && _e(e[0]))) {
      for (var s = e.length === 1 ? e[0] : null, o = 0; o < this.length; o++) {
        var l = this[o],
          u = !r.ableField || l._private[r.ableField],
          v = l._private[r.field] != r.value;
        if (r.overrideAble) {
...
function na(r) {
  ((ot[r.field] = function () {
    ...
    (ot[r.on] = hl({ event: r.on, field: r.field, ableField: r.ableField, overrideAble: r.overrideAble, value: !0 })),
    (ot[r.off] = hl({
      event: r.off,
      field: r.field,
...
ot.deselect = ot.unselect;
ot.grabbed = function () {
  var r = this[0];
  if (r) return r._private.grabbed;
};
na({ field: "active", on: "activate", off: "unactivate" });
na({ field: "pannable", on: "panify", off: "unpanify" });
ot.inactive = function () {
  var r = this[0];
...
be(gr, {
  roots: gl({ noIncomingEdges: !0 }),
  leaves: gl({ noOutgoingEdges: !0 }),
  outgoers: Rr(pl({ outgoing: !0 }), "outgoers"),
  successors: yl({ outgoing: !0 }),
  incomers: Rr(pl({ incoming: !0 }), "incomers"),
  predecessors: yl({}),
});
be(gr, {
...
be(gr, {
  ...
  sources: ml({ attr: "source" }),
  targets: ml({ attr: "target" }),
});
function ml(r) {
  return function (t) {
...
be(gr, { edgesWith: Rr(bl(), "edgesWith"), edgesTo: Rr(bl({ thisIsSrc: !0 }), "edgesTo") });
function bl(r) {
  return function (t) {
    var a = [],
      n = this._private.cy,
    ...
    for (var s = 0; s < t.length; s++)
      for (var o = t[s]._private.edges, l = 0; l < o.length; l++) {
        var u = o[l],
          v = u._private.data,
          f = this.hasElementWithId(v.source) && t.hasElementWithId(v.target),
          c = t.hasElementWithId(v.source) && this.hasElementWithId(v.target),
          h = f || c;
...
be(gr, {
  ...
  parallelEdges: Rr(wl(), "parallelEdges"),
  codirectedEdges: Rr(wl({ codirected: !0 }), "codirectedEdges"),
});
function wl(r) {
  var e = { codirected: !1 };
  return (
...
var fr = function (e, t) {
    ...
    if (!t) t = [];
      ...
      for (var o = [], l = new ra(), u = 0, v = t.length; u < v; u++) {
        ...
        f.data == null && (f.data = {});
        var c = f.data;
        if (c.id == null) c.id = gv();
        else if (e.hasElementWithId(c.id) || l.has(c.id)) continue;
        var h = new In(e, f, !1);
        (o.push(h), l.add(c.id));
      }
      t = o;
    ...
    for (var d = 0, y = t.length; d < y; d++) {
      ...
      if (g != null) {
        ...
        (!a || !i.has(p)) && (a && i.set(p, { index: this.length, ele: g }), (this[this.length] = g), this.length++);
      }
    }
    ((this._private = {
      eles: this,
      ...
      rebuildMap: function () {
        for (var b = (this.lazyMap = new Xr()), w = this.eles, E = 0; E < w.length; E++) {
          var C = w[E];
          b.set(C.id(), { index: E, ele: C });
        }
      },
    }),
      a && (this._private.map = i),
      s && !n && this.restore());
  },
  He = (In.prototype = fr.prototype = Object.create(Array.prototype));
...
He.collection = function () {
  return rv(this) ? this : new fr(this._private.cy, [this]);
};
He.unique = function () {
  ...
  if (e != null) {
    ...
    if (Le(r)) {
      if ((t.startBatch(), r.data)) {
        ...
        if (e.isEdge()) {
          var i = !1,
            ...
            o = r.data.source,
            l = r.data.target;
          (o != null && o != n.source && ((s.source = "" + o), (i = !0)),
            l != null && l != n.target && ((s.target = "" + l), (i = !0)),
            i && (e = e.move(s)));
        } else {
          var u = "parent" in r.data,
            v = r.data.parent;
          u &&
            (v != null || n.parent != null) &&
            v != n.parent &&
            (v === void 0 && (v = null), v != null && (v = "" + v), (e = e.move({ parent: v })));
        }
      }
      ...
      return (
        ...
        r.classes != null && e.classes(r.classes),
        t.endBatch(),
        this
      );
    } else if (r === void 0) {
...
He.restore = function () {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if ((h.clearTraversalCache(), !(!e && !d.removed))) {
      if (y.id === void 0) y.id = gv();
      else if (ae(y.id)) y.id = "" + y.id;
      else if (ut(y.id) || !ge(y.id)) {
        ($e("Can not create element with invalid string ID `" + y.id + "`"), c());
        continue;
      } else if (a.hasElementWithId(y.id)) {
        ($e("Can not create second element with ID `" + y.id + "`"), c());
        continue;
      }
    }
    var g = y.id;
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = !1, C = 0; C < w; C++) {
        ...
        (ae(T) && (T = y[x] = "" + y[x]),
          T == null || T === ""
            ? ($e("Can not create edge `" + g + "` with unspecified " + x), (E = !0))
            : a.hasElementWithId(T) ||
              ($e("Can not create edge `" + g + "` with nonexistent " + x + " `" + T + "`"), (E = !0)));
      }
      if (E) {
        c();
        continue;
      ...
      var k = a.getElementById(y.source),
        D = a.getElementById(y.target);
      (k.same(D) ? k._private.edges.push(m) : (k._private.edges.push(m), D._private.edges.push(m)),
        (m._private.source = k),
        (m._private.target = D));
    }
    ((d.map = new Xr()), d.map.set(g, { ele: h, index: 0 }), (d.removed = !1), e && a.addToPool(h));
  }
  for (var B = 0; B < i.length; B++) {
    var P = i[B],
      A = P._private.data;
    ae(A.parent) && (A.parent = "" + A.parent);
    var R = A.parent,
      L = R != null;
    if (L || P._private.parent) {
      var I = P._private.parent ? a.collection().merge(P._private.parent) : a.getElementById(R);
      if (I.empty()) A.parent = void 0;
      else if (I[0].removed())
        (Ve("Node added with missing parent, reference to parent removed"),
          (A.parent = void 0),
          (P._private.parent = null));
      else {
        for (var M = !1, O = I; !O.empty(); ) {
          if (P.same(O)) {
            ((M = !0), (A.parent = void 0));
            break;
          }
        ...
        M || (I[0]._private.children.push(P), (P._private.parent = I[0]), (n.hasCompoundNodes = !0));
      }
    }
  }
  if (o.length > 0) {
    for (var V = o.length === t.length ? t : new fr(a, o), G = 0; G < V.length; G++) {
      var N = V[G];
      N.isNode() ||
        (N.parallelEdges().clearTraversalCache(), N.source().clearTraversalCache(), N.target().clearTraversalCache());
    }
    var F;
    (n.hasCompoundNodes ? (F = a.collection().merge(V).merge(V.connectedNodes()).merge(V.parent())) : (F = V),
      F.dirtyCompoundBoundsCache().dirtyBoundingBoxCache().updateStyle(r),
      r ? V.emitAndNotify("add") : e && V.emit("add"));
  }
  return t;
};
He.removed = function () {
...
He.remove = function () {
  var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0,
    ...
    i = t._private.cy;
  function s(R) {
    for (var L = R._private.edges, I = 0; I < L.length; I++) l(L[I]);
  }
  function o(R) {
    for (var L = R._private.children, I = 0; I < L.length; I++) l(L[I]);
  }
  function l(R) {
    var L = n[R.id()];
    (e && R.removed()) || L || ((n[R.id()] = !0), R.isNode() ? (a.push(R), s(R), o(R)) : a.unshift(R));
  }
  ...
  function y(R, L) {
    ...
    var I = R._private.children,
      M = R.id();
    (lt(I, L), (L._private.parent = null), d.ids[M] || ((d.ids[M] = !0), d.push(R)));
  }
...
He.move = function (r) {
  ...
  if (r.source !== void 0 || r.target !== void 0) {
    var s = i(r.source),
      o = i(r.target),
      l = s != null && e.hasElementWithId(s),
      u = o != null && e.hasElementWithId(o);
    (l || u) &&
      (e.batch(function () {
        ...
        for (var h = 0; h < t.length; h++) {
          var d = t[h],
            y = d._private.data;
          d.isEdge() && (l && (y.source = s), u && (y.target = o));
        }
        t.restore(a, n);
      }),
...
[Dv, kg, vn, st, jt, Gg, _n, np, Jv, jv, lp, Sn, fn, vr, ot, gr].forEach(function (r) {
  be(He, r);
});
var pp = {
  add: function (e) {
    ...
    if (Dr(e)) {
      var n = e;
      if (n._private.cy === a) t = n.restore();
      else {
...
function yp(r, e, t, a) {
  ...
  for (var f = 0; f < 4; ++f)
    if (typeof arguments[f] != "number" || isNaN(arguments[f]) || !isFinite(arguments[f])) return !1;
  ...
  function g(D, B, P) {
    return ((h(B, P) * D + d(B, P)) * D + y(B)) * D;
  }
  function p(D, B, P) {
    return 3 * h(B, P) * D * D + 2 * d(B, P) * D + y(B);
  }
  function m(D, B) {
    for (var P = 0; P < n; ++P) {
      var A = p(B, r, t);
  ...
  function b() {
    for (var D = 0; D < l; ++D) c[D] = g(D * u, r, t);
  }
  function w(D, B, P) {
    var A,
      R,
      L = 0;
    do ((R = B + (P - B) / 2), (A = g(R, r, t) - D), A > 0 ? (P = R) : (B = R));
    while (Math.abs(A) > s && ++L < o);
    return R;
  }
  function E(D) {
    for (var B = 0, P = 1, A = l - 1; P !== A && c[P] <= D; ++P) B += u;
    --P;
  ...
  var T = function (B) {
    return (C || x(), r === e && t === a ? B : B === 0 ? 0 : B === 1 ? 1 : g(E(B), e, a));
  };
...
var mp = (function () {
    ...
    function e(a, n, i) {
      var s = { x: a.x + i.dx * n, v: a.v + i.dv * n, tension: a.tension, friction: a.friction };
      return { dx: s.v, dv: r(s) };
    }
    function t(a, n) {
      var i = { dx: a.v, dv: r(a) },
        s = e(a, n * 0.5, i),
        o = e(a, n * 0.5, s),
        l = e(a, n, o),
        u = (1 / 6) * (i.dx + 2 * (s.dx + o.dx) + l.dx),
        v = (1 / 6) * (i.dv + 2 * (s.dv + o.dv) + l.dv);
    ...
    return function a(n, i, s) {
      ...
      for (
        n = parseFloat(n) || 500,
          ...
          o.friction = i,
          c = s !== null,
          c ? ((u = a(n, i)), (h = (u / s) * f)) : (h = f);
        (d = t(d || o, h)), l.push(1 + d.x), (u += 16), Math.abs(d.x) > v && Math.abs(d.v) > v;
      );
      return c
        ? function (y) {
  ...
  cn = {
    ...
    "ease-in-sine": Ge(0.47, 0, 0.745, 0.715),
    "ease-out-sine": Ge(0.39, 0.575, 0.565, 1),
    "ease-in-out-sine": Ge(0.445, 0.05, 0.55, 0.95),
    "ease-in-quad": Ge(0.55, 0.085, 0.68, 0.53),
    "ease-out-quad": Ge(0.25, 0.46, 0.45, 0.94),
    "ease-in-out-quad": Ge(0.455, 0.03, 0.515, 0.955),
    "ease-in-cubic": Ge(0.55, 0.055, 0.675, 0.19),
    "ease-out-cubic": Ge(0.215, 0.61, 0.355, 1),
    "ease-in-out-cubic": Ge(0.645, 0.045, 0.355, 1),
    "ease-in-quart": Ge(0.895, 0.03, 0.685, 0.22),
    "ease-out-quart": Ge(0.165, 0.84, 0.44, 1),
    "ease-in-out-quart": Ge(0.77, 0, 0.175, 1),
    "ease-in-quint": Ge(0.755, 0.05, 0.855, 0.06),
    "ease-out-quint": Ge(0.23, 1, 0.32, 1),
    "ease-in-out-quint": Ge(0.86, 0, 0.07, 1),
    "ease-in-expo": Ge(0.95, 0.05, 0.795, 0.035),
    "ease-out-expo": Ge(0.19, 1, 0.22, 1),
    "ease-in-out-expo": Ge(1, 0, 0, 1),
    "ease-in-circ": Ge(0.6, 0.04, 0.98, 0.335),
    "ease-out-circ": Ge(0.075, 0.82, 0.165, 1),
    "ease-in-out-circ": Ge(0.785, 0.135, 0.15, 0.86),
    spring: function (e, t, a) {
      if (a === 0) return cn.linear;
      var n = mp(e, t, a);
...
function El(r, e) {
  return r.pfValue != null || r.value != null
    ? r.pfValue != null && (e == null || e.type.units !== "%")
      ? r.pfValue
      : r.value
    : r;
}
function zt(r, e, t, a, n) {
  ...
  var s = El(r, n),
    o = El(e, n);
  if (ae(s) && ae(o)) return xl(i, s, o, t, a);
  if (_e(s) && _e(o)) {
...
function bp(r, e, t, a) {
  var n = !a,
    ...
    v = u.style();
  if (!s.easingImpl)
    if (o == null) s.easingImpl = cn.linear;
    else {
      var f;
      if (ge(o)) {
      ...
      (ge(f)
        ? ((h = f), (d = []))
        : ((h = f[1]),
          (d = f.slice(2).map(function (V) {
            return +V;
          }))),
        d.length > 0
          ? (h === "spring" && d.push(s.duration), (s.easingImpl = cn[h].apply(null, d)))
          : (s.easingImpl = cn[h]));
    }
  var y = s.easingImpl,
    g;
  if (
    (s.duration === 0 ? (g = 1) : (g = (t - l) / s.duration),
    s.applying && (g = s.progress),
    g < 0 ? (g = 0) : g > 1 && (g = 1),
    s.delay == null)
  ) {
    ...
    if (m && n && !r.locked()) {
      var b = {};
      (da(p.x, m.x) && (b.x = zt(p.x, m.x, g, y)), da(p.y, m.y) && (b.y = zt(p.y, m.y, g, y)), r.position(b));
    }
    var w = s.startPan,
      E = s.pan,
      C = i.pan,
      x = E != null && a;
    x && (da(w.x, E.x) && (C.x = zt(w.x, E.x, g, y)), da(w.y, E.y) && (C.y = zt(w.y, E.y, g, y)), r.emit("pan"));
    var T = s.startZoom,
      k = s.zoom,
      D = k != null && a;
    (D && (da(T, k) && (i.zoom = ka(i.minZoom, zt(T, k, g, y), i.maxZoom)), r.emit("zoom")),
      (x || D) && r.emit("viewport"));
    var B = s.style;
    if (B && B.length > 0 && n) {
...
function Cl(r, e) {
  ...
  function n(v, f) {
    ...
    for (
      ...
      (!w.playing && !w.applying) ||
        (w.playing && w.applying && (w.applying = !1),
        w.started || wp(v, b, r),
        bp(v, b, r, f),
        w.applying && (w.applying = !1),
        p(w.frames),
        w.step != null && w.step(r),
        b.completed() && (h.splice(m, 1), (w.hooked = !1), (w.playing = !1), (w.started = !1), p(w.completes)),
        (y = !0));
    }
    return (!f && h.length === 0 && d.length === 0 && a.push(v), y);
  }
...
var xp = {
    ...
    startAnimationLoop: function () {
      ...
      var a = e.renderer();
      a && a.beforeRender
        ? a.beforeRender(function (i, s) {
            Cl(s, e);
          }, a.beforeRenderPriorities.animations)
        : t();
    },
  },
  Ep = {
  ...
  tf = {
    createEmitter: function () {
      var e = this._private;
      return (e.emitter || (e.emitter = new Gn(Ep, this)), this);
    },
    emitter: function () {
      return this._private.emitter;
    },
...
var Cp = {
    ...
    startBatch: function () {
      var e = this._private;
      return (
        e.batchCount == null && (e.batchCount = 0),
        e.batchCount === 0 && ((e.batchStyleEles = this.collection()), (e.batchNotifications = {})),
        e.batchCount++,
        this
      );
    },
  ...
  collection: function (e, t) {
    return ge(e)
      ...
      : Dr(e)
        ? e.collection()
        : _e(e)
          ? (t || (t = {}), new fr(this, e, t.unique, t.removed))
          : new fr(this);
  },
  nodes: function (e) {
...
ur.apply = function (r) {
  for (var e = this, t = e._private, a = t.cy, n = a.collection(), i = 0; i < r.length; i++) {
    var s = r[i],
      o = e.getContextMeta(s);
    if (!o.empty) {
      var l = e.getContextStyle(o),
        u = e.applyContextStyle(o, l, s);
...
ur.getPropertiesDiff = function (r, e) {
  var t = this,
    a = (t._private.propDiffs = t._private.propDiffs || {}),
    n = r + "-" + e,
    i = a[n];
  if (i) return i;
  for (var s = [], o = {}, l = 0; l < t.length; l++) {
    ...
    if (c || (f && h)) {
      ...
      for (var y = 0; y < d.length; y++) {
        for (var g = d[y], p = g.name, m = !1, b = l + 1; b < t.length; b++) {
          var w = t[b],
            E = e[b] === wa;
          if (E && ((m = w.properties[g.name] != null), m)) break;
        }
...
ur.getContextMeta = function (r) {
  for (var e = this, t = "", a, n = r._private.styleCxtKey || "", i = 0; i < e.length; i++) {
    var s = e[i],
      o = s.selector && s.selector.matches(r);
    o ? (t += wa) : (t += Sp);
  }
  return (
    (a = e.getPropertiesDiff(n, t)),
    (r._private.styleCxtKey = t),
    { key: t, diffPropNames: a, empty: a.length === 0 }
  );
};
ur.getContextStyle = function (r) {
  var e = r.key,
    t = this,
    a = (this._private.contextStyles = this._private.contextStyles || {});
  if (a[e]) return a[e];
  for (var n = { _private: { key: e } }, i = 0; i < t.length; i++) {
    var s = t[i],
      o = e[i] === wa;
    if (o)
...
ur.applyContextStyle = function (r, e, t) {
  for (var a = this, n = r.diffPropNames, i = {}, s = a.types, o = 0; o < n.length; o++) {
    var l = n[o],
      ...
      v = t.pstyle(l);
    if (!u)
      if (v) v.bypass ? (u = { name: l, deleteBypassed: !0 }) : (u = { name: l, delete: !0 });
      else continue;
    if (v !== u) {
      if (u.mapped === s.fn && v != null && v.mapping != null && v.mapping.value === u.value) {
        var f = v.mapping,
          c = (f.fnValue = u.value(t));
        if (c === f.prevFnValue) continue;
      }
      var h = (i[l] = { prev: v });
...
ur.updateStyleHints = function (r) {
  var e = r._private,
    t = this,
    a = t.propertyGroupNames,
    n = t.propertyGroupKeys,
    i = function (H, Y, te) {
      return t.getPropertiesHash(H, Y, te);
    },
    s = e.styleKey;
  ...
  for (
    var f = function (H, Y) {
        return (e.styleKeys[Y][0] = Ca(H, e.styleKeys[Y][0]));
      },
      c = function (H, Y) {
        return (e.styleKeys[Y][1] = Ta(H, e.styleKeys[Y][1]));
      },
      h = function (H, Y) {
        (f(H, Y), c(H, Y));
      },
      ...
      y = 2e9,
      g = function (H) {
        return -128 < H && H < 128 && Math.floor(H) !== H ? y - ((H * 1024) | 0) : H;
      },
      p = 0;
    p < a.length;
    p++
    ...
    if (b != null) {
      ...
      if (E.number && B && !E.multiple) {
        var A = k ? x : T;
        (h(g(A), C), !k && P != null && d(P, C));
      } else d(b.strValue, C);
    }
  }
  for (var R = [Tt, Ht], L = 0; L < n.length; L++) {
    var I = n[L],
      M = e.styleKeys[I];
    ((R[0] = Ca(M[0], R[0])), (R[1] = Ta(M[1], R[1])));
  }
  e.styleKey = _c(R[0], R[1]);
  var O = e.styleKeys;
  e.labelDimsKey = et(O.labelDimensions);
  var V = i(r, ["label"], O.labelDimensions);
  if (((e.labelKey = et(V)), (e.labelStyleKey = et(Xa(O.commonLabel, V))), !o)) {
    var G = i(r, ["source-label"], O.labelDimensions);
    ((e.sourceLabelKey = et(G)), (e.sourceLabelStyleKey = et(Xa(O.commonLabel, G))));
...
ur.applyParsedProperty = function (r, e) {
  ...
  if (
    (e.name === "curve-style" &&
      r.isEdge() &&
      ((e.value !== "bezier" && r.isLoop()) ||
        (e.value === "haystack" && (r.source().isParent() || r.target().isParent()))) &&
      (a = e = this.parse(e.name, "bezier", l)),
    a.delete)
  )
    return ((n[a.name] = void 0), d(), !0);
  if (a.deleteBypassed) return u ? (u.bypass ? ((u.bypassed = void 0), d(), !0) : !1) : (d(), !0);
  if (a.deleteBypass) return u ? (u.bypass ? ((n[a.name] = u.bypassed), d(), !0) : !1) : (d(), !0);
  var y = function () {
    Ve(
  ...
  switch (a.mapped) {
    case s.mapData: {
      ...
      if ((w < 0 ? (w = 0) : w > 1 && (w = 1), o.color)) {
        var C = a.valueMin[0],
          ...
          D = a.valueMin[2],
          B = a.valueMax[2],
          P = a.valueMin[3] == null ? 1 : a.valueMin[3],
          A = a.valueMax[3] == null ? 1 : a.valueMax[3],
          R = [
            Math.round(C + (x - C) * w),
            Math.round(T + (k - T) * w),
            Math.round(D + (B - D) * w),
        ...
        var L = a.valueMin + (a.valueMax - a.valueMin) * w;
        i = this.parse(a.name, L, a.bypass, c);
      } else return !1;
      if (!i) return (y(), !1);
      ((i.mapping = a), (a = i));
      break;
    ...
    case s.data: {
      for (var I = a.field.split("."), M = f.data, O = 0; O < I.length && M; O++) {
        var V = I[O];
        M = M[V];
      }
      if ((M != null && (i = this.parse(a.name, M, a.bypass, c)), !i)) return (y(), !1);
      ((i.mapping = a), (a = i));
      break;
    }
    case s.fn: {
      var G = a.value,
        N = a.fnValue != null ? a.fnValue : G(r);
  ...
  return (
    l ? (v ? (a.bypassed = u.bypassed) : (a.bypassed = u), (n[a.name] = a)) : v ? (u.bypassed = a) : (n[a.name] = a),
    d(),
    !0
  );
};
...
ur.updateTransitions = function (r, e) {
  var t = this,
    a = r._private,
    n = r.pstyle("transition-property").value,
    i = r.pstyle("transition-duration").pfValue,
    s = r.pstyle("transition-delay").pfValue;
  if (n.length > 0 && i > 0) {
    for (var o = {}, l = !1, u = 0; u < n.length; u++) {
      ...
      if (c) {
        var h = c.prev,
          d = h,
          y = c.next != null ? c.next : f,
          g = !1,
          p = void 0,
          m = 1e-6;
        d &&
          (ae(d.pfValue) && ae(y.pfValue)
            ? ((g = y.pfValue - d.pfValue), (p = d.pfValue + m * g))
            : ae(d.value) && ae(y.value)
              ? ((g = y.value - d.value), (p = d.value + m * g))
              : _e(d.value) &&
                _e(y.value) &&
                ((g = d.value[0] !== y.value[0] || d.value[1] !== y.value[1] || d.value[2] !== y.value[2]),
                (p = d.strValue)),
          g && ((o[v] = y.strValue), this.applyBypass(r, v, p), (l = !0)));
      }
    }
    if (!l) return;
    ((a.transitioning = !0),
      new ta(function (b) {
        ...
        .then(function () {
          return r
            .animation({ style: o, duration: i, easing: r.pstyle("transition-timing-function").value, queue: !1 })
            .play()
            .promise();
        })
        .then(function () {
...
_a.applyBypass = function (r, e, t, a) {
  ...
  for (var m = !1, b = 0; b < r.length; b++) {
    for (var w = r[b], E = {}, C = void 0, x = 0; x < i.length; x++) {
      ...
      ((m = this.applyParsedProperty(w, qr(T)) || m), a && (C.next = w.pstyle(T.name)));
    }
...
_a.overrideBypass = function (r, e, t) {
  ...
  for (var a = 0; a < r.length; a++) {
    var n = r[a],
      i = n._private.style[e],
      s = this.properties[e].type,
      o = s.color,
      l = s.mutiple,
      u = i ? (i.pfValue != null ? i.pfValue : i.value) : null;
    (!i || !i.bypass
  ...
  if (((r = r[0]), r)) {
    for (var a = {}, n = 0; n < t.properties.length; n++) {
      var i = t.properties[n],
        s = t.getStylePropertyValue(r, i.name, e);
...
_r.getAnimationStartStyle = function (r, e) {
  for (var t = {}, a = 0; a < e.length; a++) {
    var n = e[a],
      i = n.name,
      s = r.pstyle(i);
    (s !== void 0 && (Le(s) ? (s = this.parse(i, s.strValue)) : (s = this.parse(i, s))), s && (t[i] = s));
  }
  return t;
};
...
_r.getNonDefaultPropertiesHash = function (r, e, t) {
  ...
  for (l = 0; l < e.length; l++)
    if (((n = e[l]), (i = r.pstyle(n, !1)), i != null))
      if (i.pfValue != null) ((a[0] = Ca(o, a[0])), (a[1] = Ta(o, a[1])));
      else
...
$n.json = function () {
  for (var r = [], e = this.defaultLength; e < this.length; e++) {
    ...
    r.push({ selector: a ? a.toString() : "core", style: i });
  }
  return r;
};
var co = {};
co.appendFromString = function (r) {
  ...
  for (;;) {
    ...
    if (!v) {
      Ve(
        "Halting stylesheet parsing: String stylesheet contains more to parse but no selector and block found in: " + a
      );
      break;
    }
    n = v[0];
    ...
    if (f !== "core") {
      var c = new ft(f);
      if (c.invalid) {
        (Ve("Skipping parsing of block: Invalid selector found in string stylesheet: " + f), o());
        continue;
      }
    }
    var h = v[2],
    ...
    for (var y = []; ; ) {
      ...
      var m = p[1],
        ...
        w = e.properties[m];
      if (!w) {
        (Ve("Skipping property: Invalid property name in: " + s), l());
        continue;
      }
      var E = t.parse(m, b);
      if (!E) {
        (Ve("Skipping property: Invalid property definition in: " + s), l());
        continue;
      }
      (y.push({ name: m, val: b }), l());
    }
    if (d) {
      o();
      break;
...
(function () {
  ...
  Qe.types = {
    ...
    mapData: { mapping: !0, regex: s("mapData") },
    mapLayoutData: { mapping: !0, regex: s("mapLayoutData") },
    mapScratch: { mapping: !0, regex: s("mapScratch") },
    fn: { mapping: !0, fn: !0 },
    url: { regexes: o, singleRegexMatchValue: !0 },
    urls: { regexes: o, singleRegexMatchValue: !0, multiple: !0 },
    propList: { propList: !0 },
  ...
  var l = {
      zeroNonZero: function (q, H) {
        return ((q == null || H == null) && q !== H) || (q == 0 && H != 0) ? !0 : q != 0 && H == 0;
      },
      any: function (q, H) {
        return q != H;
      },
      emptyNonEmpty: function (q, H) {
        var Y = ut(q),
          te = ut(H);
        return (Y && !te) || (!Y && te);
      },
    ...
    d = [
      ...
      { name: "box-select-labels", type: u.bool, triggersBounds: l.any },
    ],
    y = [
      { name: "events", type: u.bool, triggersZOrder: l.any },
      { name: "text-events", type: u.bool, triggersZOrder: l.any },
      { name: "box-selection", type: u.boxSelection, triggersZOrder: l.any },
    ],
    g = [
      {
        name: "display",
        ...
        triggersBoundsOfParallelEdges: function (q, H, Y) {
          return q === H ? !1 : Y.pstyle("curve-style").value === "bezier";
        },
      },
    ...
    w = function (q, H) {
      return H.value === "label" ? -q.poolIndex() : H.pfValue;
    },
    E = [
    ...
    D = [
      ...
      { name: "line-gradient-stop-positions", type: u.percentages },
      {
        ...
        type: u.curveStyle,
        triggersBounds: l.any,
        triggersBoundsOfParallelEdges: function (q, H) {
          return q === H ? !1 : q === "bezier" || H === "bezier";
        },
      },
      ...
      { name: "radius-type", type: u.radiusType, triggersBounds: l.any },
  ...
  var M = [],
    O = (Qe.arrowPrefixes = ["source", "mid-source", "target", "mid-target"]);
  [
  ...
  var V = (Qe.properties = [].concat(y, b, g, p, m, B, d, h, v, f, c, E, C, x, T, A, L, k, D, M, P)),
    ...
    N = (Qe.propertyGroupNames = {}),
    F = (Qe.propertyGroupKeys = Object.keys(G));
  F.forEach(function (z) {
    ((N[z] = G[z].map(function (q) {
      return q.name;
    })),
      G[z].forEach(function (q) {
        return (q.groupKey = z);
      }));
  });
  var U = (Qe.aliases = [
  ...
  Qe.propertyNames = V.map(function (z) {
    return z.name;
  });
  ...
  for (var j = 0; j < U.length; j++) {
    var re = U[j],
      ne = V[re.pointsTo],
      J = { name: re.name, alias: !0, pointsTo: ne };
    (V.push(J), (V[re.name] = J));
  }
})();
...
Qe.getDefaultProperties = function () {
  ...
  for (
    var e = be(
        ...
        { "pie-size": "100%", "pie-hole": 0, "pie-start-angle": "0deg" },
        [
        ...
        { "stripe-size": "100%", "stripe-direction": "horizontal" },
        [
...
Un.parse = function (r, e, t, a) {
  var n = this;
  if (Ue(e)) return n.parseImplWarn(r, e, t, a);
  var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a,
    s = t ? "t" : "f",
    o = "" + e,
    l = cv(r, o, s, i),
    u = (n.propCache = n.propCache || []),
    v;
  return (
    (v = u[l]) || (v = u[l] = n.parseImplWarn(r, e, t, a)),
    (t || a === "mapping") && ((v = qr(v)), v && (v.value = qr(v.value))),
    v
  );
};
Un.parseImplWarn = function (r, e, t, a) {
  ...
  return (
    !n && e != null && Ve("The style property `".concat(r, ": ").concat(e, "` is invalid")),
    n &&
      (n.name === "width" || n.name === "height") &&
      e === "label" &&
...
Un.parseImpl = function (r, e, t, a) {
  ...
  var u = i.type;
  if (!u) return null;
  if (t && (e === "" || e === null)) return { name: r, value: e, bypass: !0, deleteBypass: !0 };
  if (Ue(e)) return { name: r, value: e, strValue: "fn", mapped: o.fn, bypass: t };
  var v, f;
  if (!(!l || a || e.length < 7 || e[1] !== "a")) {
    if (e.length >= 7 && e[0] === "d" && (v = new RegExp(o.data.regex).exec(e))) {
      if (t) return !1;
      var c = o.data;
      return { name: r, value: v, strValue: "" + e, mapped: c, field: v[1], bypass: t };
    } else if (e.length >= 10 && e[0] === "m" && (f = new RegExp(o.mapData.regex).exec(e))) {
      if (t || u.multiple) return !1;
      var h = o.mapData;
      if (!(u.color || u.number)) return !1;
      var d = this.parse(r, f[4]);
      if (!d || d.mapped) return !1;
  ...
  if (u.multiple && a !== "multiple") {
    var b;
    if ((l ? (b = e.split(/\s+/)) : _e(e) ? (b = e) : (b = [e]), u.evenMultiple && b.length % 2 !== 0)) return null;
    for (var w = [], E = [], C = [], x = "", T = !1, k = 0; k < b.length; k++) {
    ...
    return u.validate && !u.validate(w, E)
      ? null
      : u.singleEnum && T
        ? w.length === 1 && ge(w[0])
          ? { name: r, value: w[0], strValue: w[0], bypass: t }
          : null
        : { name: r, value: w, pfValue: C, strValue: x, bypass: t, units: E };
  }
  var B = function () {
    for (var J = 0; J < u.enums.length; J++) {
      var z = u.enums[J];
      if (z === e) return { name: r, value: e, strValue: "" + e, bypass: t };
    }
    return null;
  };
  if (u.number) {
    var P,
      A = "px";
    if ((u.units && (P = u.units), u.implicitUnits && (A = u.implicitUnits), !u.unitless))
      if (l) {
        var R = "px|em" + (u.allowPercent ? "|\\%" : "");
        P && (R = P);
        var L = e.match("^(" + tr + ")(" + R + ")?$");
        L && ((e = L[1]), (P = L[2] || A));
      } else (!P || u.implicitUnits) && (P = A);
    if (((e = parseFloat(e)), isNaN(e) && u.enums === void 0)) return null;
    if (isNaN(e) && u.enums !== void 0) return ((e = s), B());
    if (
      (u.integer && !cc(e)) ||
      (u.min !== void 0 && (e < u.min || (u.strictMin && e === u.min))) ||
      (u.max !== void 0 && (e > u.max || (u.strictMax && e === u.max)))
    )
      return null;
    var I = { name: r, value: e, strValue: "" + e + (P || ""), units: P, bypass: t };
    return (
      u.unitless || (P !== "px" && P !== "em")
        ? (I.pfValue = e)
        : (I.pfValue = P === "px" || !P ? e : this.getEmSizeInPixels() * e),
      (P === "ms" || P === "s") && (I.pfValue = P === "ms" ? e : 1e3 * e),
      (P === "deg" || P === "rad") && (I.pfValue = P === "rad" ? e : Ed(e)),
      P === "%" && (I.pfValue = e / 100),
      I
    );
  } else if (u.propList) {
    var M = [],
      O = "" + e;
    if (O !== "none") {
      for (var V = O.split(/\s*,\s*|\s+/), G = 0; G < V.length; G++) {
        var N = V[G].trim();
        n.properties[N] ? M.push(N) : Ve("`" + N + "` is not a valid property name");
      }
    ...
    var F = iv(e);
    return F
      ? { name: r, value: F, pfValue: F, strValue: "rgb(" + F[0] + "," + F[1] + "," + F[2] + ")", bypass: t }
      : null;
    ...
    for (var Q = u.regexes ? u.regexes : [u.regex], K = 0; K < Q.length; K++) {
      var j = new RegExp(Q[K]),
        re = j.exec(e);
      if (re) return { name: r, value: u.singleRegexMatchValue ? re[1] : re, strValue: "" + e, bypass: t };
    }
    return null;
  } else return u.string ? { name: r, value: "" + e, strValue: "" + e, bypass: t } : u.enums ? B() : null;
};
var or = function (e) {
...
pr.clear = function () {
  for (var r = this._private, e = r.cy, t = e.elements(), a = 0; a < this.length; a++) this[a] = void 0;
  return (
    (this.length = 0),
    (r.contextStyles = {}),
    (r.propDiffs = {}),
...
pr.selector = function (r) {
  var e = r === "core" ? null : new ft(r),
    t = this.length++;
  return ((this[t] = { selector: e, properties: [], mappedProperties: [], index: t }), this);
};
pr.css = function () {
  var r = this,
    e = arguments;
...
pr.cssRule = function (r, e) {
  ...
  if (t) {
    ...
    (this[a].properties.push(t),
      ...
      t.name.match(/pie-(\d+)-background-size/) && t.value && (this._private.hasPie = !0),
      t.name.match(/stripe-(\d+)-background-size/) && t.value && (this._private.hasStripe = !0),
      t.mapped && this[a].mappedProperties.push(t));
...
pr.append = function (r) {
  return (tv(r) ? r.appendToStyle(this) : _e(r) ? this.appendFromJson(r) : ge(r) && this.appendFromString(r), this);
};
...
var kp = {
  ...
  At = {
    ...
    selectionType: function (e) {
      var t = this._private;
      if ((t.selectionType == null && (t.selectionType = Dp), e !== void 0))
    ...
    panBy: function (e, t) {
      ...
      switch (a.length) {
        case 1:
          Le(e) &&
            ((o = a[0]), (l = o.x), (u = o.y), ae(l) && (n.x += l), ae(u) && (n.y += u), this.emit("pan viewport"));
          break;
        case 2:
    ...
    getFitViewport: function (e, t) {
      if (
        ...
        if (ge(e)) {
          ...
          var i = e;
          ((a = { x1: i.x1, y1: i.y1, x2: i.x2, y2: i.y2 }), (a.w = a.x2 - a.x1), (a.h = a.y2 - a.y1));
        ...
        if (!(Dr(e) && e.empty())) {
          ...
          if (
            ((t = ae(t) ? t : 0),
            !isNaN(s) && !isNaN(o) && s > 0 && o > 0 && !isNaN(a.w) && !isNaN(a.h) && a.w > 0 && a.h > 0)
          ) {
            ...
            var u = { x: (s - l * (a.x1 + a.x2)) / 2, y: (o - l * (a.y1 + a.y2)) / 2 };
            return { zoom: l, pan: u };
          }
        }
      }
    ...
    zoomRange: function (e, t) {
      ...
      return (
        ae(e) && ae(t) && e <= t
          ? ((a.minZoom = e), (a.maxZoom = t))
          : ae(e) && t === void 0 && e <= a.maxZoom
            ? (a.minZoom = e)
            : ae(t) && e === void 0 && t >= a.minZoom && (a.maxZoom = t),
        this
      );
    },
    minZoom: function (e) {
    ...
    getZoomedViewport: function (e) {
      ...
      if (i != null) {
        var l = a,
          u = n,
          v = s,
          f = { x: (-v / u) * (i.x - l.x) + i.x, y: (-v / u) * (i.y - l.y) + i.y };
        return { zoomed: !0, panned: !0, zoom: v, pan: f };
      } else return { zoomed: !0, panned: !1, zoom: s, pan: a };
    },
    zoom: function (e) {
      if (e === void 0) return this._private.zoom;
      var t = this.getZoomedViewport(e),
        a = this._private;
      return t == null || !t.zoomed
        ? this
        : ((a.zoom = t.zoom),
          t.panned && ((a.pan.x = t.pan.x), (a.pan.y = t.pan.y)),
    ...
    viewport: function (e) {
      var t = this._private,
        ...
        o = !1;
      if (!e) return this;
      if ((ae(e.zoom) || (a = !1), Le(e.pan) || (n = !1), !a && !n)) return this;
      if (a) {
        var l = e.zoom;
      ...
      if (n && (!s || !e.cancelOnFailedZoom) && t.panningEnabled) {
        var u = e.pan;
        (ae(u.x) && ((t.pan.x = u.x), (o = !1)), ae(u.y) && ((t.pan.y = u.y), (o = !1)), o || i.push("pan"));
      }
    ...
    getCenterPan: function (e, t) {
      if (this._private.panningEnabled) {
        ...
        if (e.length !== 0) {
          ...
          var o = { x: (i - t * (n.x1 + n.x2)) / 2, y: (s - t * (n.y1 + n.y2)) / 2 };
          return o;
        }
      }
    },
    ...
    extent: function () {
      var e = this._private.pan,
        ...
        a = this.renderedExtent(),
        n = { x1: (a.x1 - e.x) / t, x2: (a.x2 - e.x) / t, y1: (a.y1 - e.y) / t, y2: (a.y2 - e.y) / t };
...
At.centre = At.center;
At.autolockNodes = At.autolock;
At.autoungrabifyNodes = At.autoungrabify;
var Aa = {
  data: Fe.data({
    field: "data",
    bindingEvent: "data",
...
var Ra = function (e) {
    ...
    var l = function (d, y, g) {
      ...
      u = (this._private = {
        ...
        pan: { x: Le(o.pan) && ae(o.pan.x) ? o.pan.x : 0, y: Le(o.pan) && ae(o.pan.y) ? o.pan.y : 0 },
        animation: { current: [], queue: [] },
        hasCompoundNodes: !1,
    ...
    var v = function (d, y) {
      var g = d.some(pc);
      if (g) return ta.all(d).then(y);
      y(d);
    };
    u.styleEnabled && t.setStyle([]);
    var f = be({}, o, o.renderer);
    t.initRenderer(f);
    var c = function (d, y, g) {
      t.notifications(!1);
      var p = t.mutableElements();
      (p.length > 0 && p.remove(),
        d != null && (Le(d) || _e(d)) && t.add(d),
        t
          .one("layoutready", function (b) {
    ...
    v([o.style, o.elements], function (h) {
      var d = h[0],
        y = h[1];
      (u.styleEnabled && t.style().append(d),
        c(
          y,
          function () {
            (t.startAnimationLoop(), (u.ready = !0), Ue(o.ready) && t.on("ready", o.ready));
...
be(kn, {
  ...
  window: function () {
    ...
    return t === void 0 || t == null ? rr : t.defaultView || rr;
  },
  mount: function (e) {
    if (e != null) {
      var t = this,
  ...
  json: function (e) {
    ...
    if (Le(e)) {
      if ((t.startBatch(), e.elements)) {
        var s = {},
          o = function (w, E) {
            for (var C = [], x = [], T = 0; T < w.length; T++) {
              ...
              var D = "" + k.data.id,
                B = t.getElementById(D);
              ((s[D] = !0), B.length !== 0 ? x.push({ ele: B, json: k }) : (E && (k.group = E), C.push(k)));
            }
            t.add(C);
        ...
        (n
          ...
          c.forEach(function (b) {
            return b.children().move({ parent: null });
          }),
          c.forEach(function (b) {
            return i(b).remove();
          }));
      ...
      (e.style && t.style(e.style),
        e.zoom != null && e.zoom !== a.zoom && t.zoom(e.zoom),
        e.pan && (e.pan.x !== a.pan.x || e.pan.y !== a.pan.y) && t.pan(e.pan),
      ...
      var g = !!e,
        p = {};
      (g
        ? (p.elements = this.elements().map(function (b) {
            return b.json();
          }))
        : ((p.elements = {}),
        ...
        this._private.styleEnabled && (p.style = t.style().json()),
        (p.data = qr(t.data())));
      var m = a.options;
      return (
...
[pp, xp, tf, zs, dn, Cp, Fs, hn, kp, At, Aa].forEach(function (r) {
  be(kn, r);
});
var Bp = {
    fit: !0,
...
function af(r) {
  this.options = be({}, Bp, Pp, r);
}
af.prototype.run = function () {
  var r = this.options,
    e = r.cy,
    t = r.eles,
    a = t.nodes().filter(function (ye) {
      return ye.isChildless();
    }),
    n = t,
    i = r.directed,
    s = r.acyclic || r.maximal || r.maximalAdjustments > 0,
    o = !!r.boundingBox,
    l = wr(o ? r.boundingBox : structuredClone(e.extent())),
    u;
  if (Dr(r.roots)) u = r.roots;
  else if (_e(r.roots)) {
    for (var v = [], f = 0; f < r.roots.length; f++) {
      var c = r.roots[f],
        h = e.getElementById(c);
      v.push(h);
    }
    u = e.collection(v);
  } else if (ge(r.roots)) u = e.$(r.roots);
  else if (i) u = a.roots();
  else {
    var d = t.components();
    u = e.collection();
  ...
  var p = [],
    ...
    b = function (ie, de) {
      p[de] == null && (p[de] = []);
      var he = p[de].length;
      (p[de].push(ie), Tl(ie, { index: he, depth: de }));
    },
    w = function (ie, de) {
      var he = Ft(ie),
        Ee = he.depth,
  ...
  var T = function (ie) {
    ...
    k = function (ie, de) {
      for (
        var he = Ft(ie),
          Ee = ie.incomers().filter(function (xe) {
      ...
      if (he.depth <= pe) {
        if (!r.acyclic && de[Se]) return null;
        var ze = pe + 1;
        return (w(ie, ze), (de[Se] = ze), !0);
      }
      return !1;
    };
  if (i && s) {
  ...
  var F = {},
    U = function (ie) {
      if (F[ie.id()]) return F[ie.id()];
      for (var de = Ft(ie).depth, he = ie.neighborhood(), Ee = 0, pe = 0, Se = 0; Se < he.length; Se++) {
        var Re = he[Se];
        if (!(Re.isEdge() || Re.isParent() || !a.has(Re))) {
          var Oe = Ft(Re);
          if (Oe != null) {
            var Ne = Oe.index,
              ze = Oe.depth;
  ...
  r.depthSort !== void 0 && (Q = r.depthSort);
  for (var K = p.length, j = 0; j < K; j++) (p[j].sort(Q), T(j));
  for (var re = [], ne = 0; ne < E.length; ne++) re.push(E[ne]);
  var J = function () {
    for (var ie = 0; ie < K; ie++) T(ie);
  };
  re.length && (p.unshift(re), (K = p.length), J());
  for (var z = 0, q = 0; q < K; q++) z = Math.max(p[q].length, z);
  var H = { x: l.x1 + l.w / 2, y: l.y1 + l.h / 2 },
    Y = a.reduce(
      function (ye, ie) {
        return (function (de) {
          return { w: ye.w === -1 ? de.w : (ye.w + de.w) / 2, h: ye.h === -1 ? de.h : (ye.h + de.h) / 2 };
        })(ie.boundingBox({ includeLabels: r.nodeDimensionsIncludeLabels }));
      },
      { w: -1, h: -1 }
    ),
    te = Math.max(K === 1 ? 0 : o ? (l.h - r.padding * 2 - Y.h) / (K - 1) : (l.h - r.padding * 2 - Y.h) / (K + 1), I),
    ce = p.reduce(function (ye, ie) {
    ...
    Ae = function (ie) {
      var de = Ft(ie),
        ...
        Ee = de.index;
      if (r.circle) {
        var pe = Math.min(l.w / 2 / K, l.h / 2 / K);
        pe = Math.max(pe, I);
        var Se = pe * he + pe - (K > 0 && p[0].length <= 3 ? pe / 2 : 0),
          Re = ((2 * Math.PI) / p[he].length) * Ee;
        return (he === 0 && p[0].length === 1 && (Se = 1), { x: H.x + Se * Math.cos(Re), y: H.y + Se * Math.sin(Re) });
      } else {
        var Oe = p[he].length,
          Ne = Math.max(
            Oe === 1
              ? 0
              : o
                ? (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) - 1)
                : (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) + 1),
            I
          ),
          ze = { x: H.x + (Ee + 1 - (Oe + 1) / 2) * Ne, y: H.y + (he + 1 - (K + 1) / 2) * te };
        return ze;
      }
    },
    Ce = { downward: 0, leftward: 90, upward: 180, rightward: -90 };
  Object.keys(Ce).indexOf(r.direction) === -1 &&
    $e(
      "Invalid direction '"
        .concat(r.direction, "' specified for breadthfirst layout. Valid values are: ")
        .concat(Object.keys(Ce).join(", "))
    );
  var we = function (ie) {
    return $c(Ae(ie), l, Ce[r.direction]);
  };
...
nf.prototype.run = function () {
  var r = this.options,
    ...
    t = r.cy,
    a = e.eles,
    n = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise,
    i = a.nodes().not(":parent");
  e.sort && (i = i.sort(e.sort));
  for (
    var s = wr(e.boundingBox ? e.boundingBox : { x1: 0, y1: 0, w: t.width(), h: t.height() }),
      o = { x: s.x1 + s.w / 2, y: s.y1 + s.h / 2 },
      l = e.sweep === void 0 ? 2 * Math.PI - (2 * Math.PI) / i.length : e.sweep,
      u = l / Math.max(1, i.length - 1),
      v,
      f = 0,
      c = 0;
    c < i.length;
    ...
    var h = i[c],
      d = h.layoutDimensions(e),
      y = d.w,
      g = d.h;
    f = Math.max(f, y, g);
  }
  if (
    (ae(e.radius) ? (v = e.radius) : i.length <= 1 ? (v = 0) : (v = Math.min(s.h, s.w) / 2 - f),
    i.length > 1 && e.avoidOverlap)
  ) {
    f *= 1.75;
    var p = Math.cos(u) - Math.cos(0),
      m = Math.sin(u) - Math.sin(0),
      b = Math.sqrt((f * f) / (p * p + m * m));
    v = Math.max(b, v);
  }
  var w = function (C, x) {
...
function sf(r) {
  this.options = be({}, Rp, r);
}
sf.prototype.run = function () {
  for (
    var r = this.options,
      e = r,
      t = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise,
      a = r.cy,
      n = e.eles,
      i = n.nodes().not(":parent"),
      s = wr(e.boundingBox ? e.boundingBox : { x1: 0, y1: 0, w: a.width(), h: a.height() }),
      o = { x: s.x1 + s.w / 2, y: s.y1 + s.h / 2 },
      l = [],
      u = 0,
      v = 0;
    ...
    var f = i[v],
      c = void 0;
    ((c = e.concentric(f)), l.push({ value: c, node: f }), (f._private.scratch.concentric = c));
  }
  i.updateStyle();
  for (var h = 0; h < i.length; h++) {
    var d = i[h],
      y = d.layoutDimensions(e);
    u = Math.max(u, y.w, y.h);
  }
  l.sort(function (te, ce) {
    return ce.value - te.value;
  });
  ...
  if (!e.avoidOverlap) {
    var x = p.length > 0 && p[0].length > 1,
      T = Math.min(s.w, s.h) / 2 - C,
      k = T / (p.length + x ? 1 : 0);
    C = Math.min(C, k);
  }
  for (var D = 0, B = 0; B < p.length; B++) {
    var P = p[B],
      A = e.sweep === void 0 ? 2 * Math.PI - (2 * Math.PI) / P.length : e.sweep,
      R = (P.dTheta = A / Math.max(1, P.length - 1));
    if (P.length > 1 && e.avoidOverlap) {
      var L = Math.cos(R) - Math.cos(0),
        I = Math.sin(R) - Math.sin(0),
        M = Math.sqrt((C * C) / (L * L + I * I));
      D = Math.max(M, D);
    }
    ((P.r = D), (D += C));
  }
  if (e.equidistant) {
    for (var O = 0, V = 0, G = 0; G < p.length; G++) {
      var N = p[G],
        F = N.r - V;
      O = Math.max(O, F);
    }
  ...
  for (var K = {}, j = 0; j < p.length; j++)
    for (var re = p[j], ne = re.dTheta, J = re.r, z = 0; z < re.length; z++) {
      var q = re[z],
        H = e.startAngle + (t ? 1 : -1) * ne * z,
        Y = { x: o.x + J * Math.cos(H), y: o.y + J * Math.sin(H) };
      K[q.node.id()] = Y;
    }
  return (
    n.nodes().layoutPositions(this, e, function (te) {
      var ce = te.id();
      return K[ce];
    }),
    this
...
function Kn(r) {
  ((this.options = be({}, Mp, r)), (this.options.layout = this));
  var e = this.options.eles.nodes(),
    t = this.options.eles.edges(),
...
Kn.prototype.run = function () {
  var r = this.options,
    ...
    t = this;
  ((t.stopped = !1),
    (r.animate === !0 || r.animate === !1) && t.emit({ type: "layoutstart", layout: t }),
    r.debug === !0 ? (bs = !0) : (bs = !1));
  var a = Lp(e, t, r);
  (bs && Op(a), r.randomize && Np(a));
  var n = Yr(),
    i = function () {
      (zp(a, e, r), r.fit === !0 && e.fit(r.padding));
    },
    s = function (c) {
      return !(
        t.stopped ||
        c >= r.numIter ||
        (Fp(a, r), (a.temperature = a.temperature * r.coolingFactor), a.temperature < r.minTemp)
      );
    },
    o = function () {
      if (r.animate === !0 || r.animate === !1)
        (i(), t.one("layoutstop", r.stop), t.emit({ type: "layoutstop", layout: t }));
      else {
        var c = r.eles.nodes(),
          h = uf(a, r, c);
  ...
  if (r.animate === !0) {
    var v = function () {
      for (var c = 0; u && c < r.refresh; ) ((u = s(l)), l++, c++);
      if (!u) (kl(a, r), o());
      else {
        var h = Yr();
...
var Lp = function (e, t, a) {
    for (
      var n = a.eles.edges(),
        i = a.eles.nodes(),
        s = wr(a.boundingBox ? a.boundingBox : { x1: 0, y1: 0, w: e.width(), h: e.height() }),
        o = {
    ...
    for (var p = [], m = 0, b = -1, w = [], v = 0; v < o.nodeSize; v++) {
    ...
    for (o.graphSet.push(w); m <= b; ) {
      ...
      if (T.length > 0) {
        o.graphSet.push(T);
        for (var v = 0; v < T.length; v++) p[++b] = T[v];
      }
    }
    for (var v = 0; v < o.graphSet.length; v++)
      for (var k = o.graphSet[v], c = 0; c < k.length; c++) {
        var D = o.idToIndex[k[c]];
        o.indexToGraph[D] = v;
      }
    for (var v = 0; v < o.edgeSize; v++) {
      var B = n[v],
        P = {};
      ((P.id = B.data("id")), (P.sourceId = B.data("source")), (P.targetId = B.data("target")));
      var A = Ue(a.idealEdgeLength) ? a.idealEdgeLength(B) : a.idealEdgeLength,
        R = Ue(a.edgeElasticity) ? a.edgeElasticity(B) : a.edgeElasticity,
        L = o.idToIndex[P.sourceId],
        I = o.idToIndex[P.targetId],
        M = o.indexToGraph[L],
        O = o.indexToGraph[I];
      if (M != O) {
        for (
          var V = Ip(P.sourceId, P.targetId, o), G = o.graphSet[V], N = 0, g = o.layoutNodes[L];
          G.indexOf(g.id) === -1;
        )
          ((g = o.layoutNodes[o.idToIndex[g.parentId]]), N++);
        for (g = o.layoutNodes[I]; G.indexOf(g.id) === -1; ) ((g = o.layoutNodes[o.idToIndex[g.parentId]]), N++);
        A *= N * a.nestingFactor;
      }
      ((P.idealLength = A), (P.elasticity = R), o.layoutEdges.push(P));
    }
    return o;
  },
  Ip = function (e, t, a) {
  ...
  of = function (e, t, a, n) {
    var i = n.graphSet[a];
    if (-1 < i.indexOf(e) && -1 < i.indexOf(t)) return { count: 2, graph: a };
    for (var s = 0, o = 0; o < i.length; o++) {
      var l = i[o],
        u = n.idToIndex[l],
        v = n.layoutNodes[u].children;
      if (v.length !== 0) {
  ...
  uf = function (e, t, a) {
    ...
    return (
      ...
      function (s, o) {
        ...
        if (t.boundingBox) {
          var u = i.w === 0 ? 0.5 : (l.positionX - i.x1) / i.w,
            v = i.h === 0 ? 0.5 : (l.positionY - i.y1) / i.h;
  ...
  zp = function (e, t, a) {
    var n = a.layout,
      ...
      s = uf(e, a, i);
    (i.positions(s),
      e.ready !== !0 && ((e.ready = !0), n.one("layoutready", a.ready), n.emit({ type: "layoutready", layout: this })));
  },
  Fp = function (e, t, a) {
    (Vp(e, t), Gp(e), Hp(e, t), Wp(e), $p(e));
  },
  Vp = function (e, t) {
  ...
  qp = function (e, t, a, n) {
    ...
    if (!(i !== s && !a.isCompound)) {
      var o = t.positionX - e.positionX,
        l = t.positionY - e.positionY,
        u = 1;
      o === 0 && l === 0 && ((o = Sl(u)), (l = Sl(u)));
      var v = _p(e, t, o, l);
      if (v > 0)
        ...
        var y = Dn(e, o, l),
          ...
          b = p * p + m * m,
          c = Math.sqrt(b),
          f = (e.nodeRepulsion + t.nodeRepulsion) / b,
          h = (f * p) / c,
          d = (f * m) / c;
  ...
  Dn = function (e, t, a) {
    ...
    return (t === 0 && 0 < a) || (t === 0 && 0 > a)
      ? ((v.x = n), (v.y = i + s / 2), v)
      : 0 < t && -1 * u <= l && l <= u
        ? ((v.x = n + o / 2), (v.y = i + (o * a) / 2 / t), v)
        : 0 > t && -1 * u <= l && l <= u
          ? ((v.x = n - o / 2), (v.y = i - (o * a) / 2 / t), v)
          : 0 < a && (l <= -1 * u || l >= u)
            ? ((v.x = n + (s * t) / 2 / a), (v.y = i + s / 2), v)
            : (0 > a && (l <= -1 * u || l >= u) && ((v.x = n - (s * t) / 2 / a), (v.y = i - s / 2)), v);
  },
  Gp = function (e, t) {
    for (var a = 0; a < e.edgeSize; a++) {
      var n = e.layoutEdges[a],
        ...
        l = e.layoutNodes[o],
        u = l.positionX - s.positionX,
        v = l.positionY - s.positionY;
      if (!(u === 0 && v === 0)) {
        var f = Dn(s, u, v),
          c = Dn(l, -1 * u, -1 * v),
          h = c.x - f.x,
          d = c.y - f.y,
          y = Math.sqrt(h * h + d * d),
          g = Math.pow(n.idealLength - y, 2) / n.elasticity;
        if (y !== 0)
          var p = (g * h) / y,
            m = (g * d) / y;
        else
      ...
      for (var a = 1, n = 0; n < e.graphSet.length; n++) {
        ...
        if (n === 0)
          ...
          var u = e.layoutNodes[e.idToIndex[i[0]]],
            v = e.layoutNodes[e.idToIndex[u.parentId]],
            o = v.positionX,
            l = v.positionY;
        for (var f = 0; f < s; f++) {
  ...
  lf = function (e, t) {
    ...
    if (a != null) {
      var n = t.layoutNodes[t.idToIndex[a]],
        i = !1;
      if (
        ((n.maxX == null || e.maxX + n.padRight > n.maxX) && ((n.maxX = e.maxX + n.padRight), (i = !0)),
        (n.minX == null || e.minX - n.padLeft < n.minX) && ((n.minX = e.minX - n.padLeft), (i = !0)),
        (n.maxY == null || e.maxY + n.padBottom > n.maxY) && ((n.maxY = e.maxY + n.padBottom), (i = !0)),
        (n.minY == null || e.minY - n.padTop < n.minY) && ((n.minY = e.minY - n.padTop), (i = !0)),
        i)
      )
        return lf(n, t);
    }
  ...
  kl = function (e, t) {
    ...
    for (
      var h = 0, d = 0, y = 0, g = 0, p = (Math.sqrt(u) * e.clientWidth) / e.clientHeight, i = 0;
      i < n.length;
      i++
    ) {
      var v = n[i];
      if (v) {
        ...
        ((h += v.w + t.componentSpacing),
          ...
          (g = Math.max(g, v.h)),
          y > p && ((d += g + t.componentSpacing), (h = 0), (y = 0), (g = 0)));
      }
    }
  },
  Kp = {
...
vf.prototype.run = function () {
  var r = this.options,
    ...
    t = r.cy,
    a = e.eles,
    n = a.nodes().not(":parent");
  e.sort && (n = n.sort(e.sort));
  var i = wr(e.boundingBox ? e.boundingBox : { x1: 0, y1: 0, w: t.width(), h: t.height() });
  if (i.h === 0 || i.w === 0)
    ...
    var s = n.size(),
      o = Math.sqrt((s * i.h) / i.w),
      l = Math.round(o),
      u = Math.round((i.w / i.h) * o),
      v = function (Q) {
        if (Q == null) return Math.min(l, u);
        var K = Math.min(l, u);
        K == l ? (l = Q) : (u = Q);
      },
      f = function (Q) {
        if (Q == null) return Math.max(l, u);
        var K = Math.max(l, u);
        K == l ? (l = Q) : (u = Q);
      },
      c = e.rows,
      h = e.cols != null ? e.cols : e.columns;
    if (c != null && h != null) ((l = c), (u = h));
    else if (c != null && h == null) ((l = c), (u = Math.ceil(s / l)));
    else if (c == null && h != null) ((u = h), (l = Math.ceil(s / u)));
    else if (u * l > s) {
      var d = v(),
        y = f();
      (d - 1) * y >= s ? v(d - 1) : (y - 1) * d >= s && f(y - 1);
    } else
      for (; u * l < s; ) {
        var g = v(),
          p = f();
    ...
    if ((e.condense && ((m = 0), (b = 0)), e.avoidOverlap))
      for (var w = 0; w < n.length; w++) {
        var E = n[w],
          C = E._private.position;
        (C.x == null || C.y == null) && ((C.x = 0), (C.y = 0));
        var x = E.layoutDimensions(e),
          T = e.avoidOverlapPadding,
          k = x.w + T,
          D = x.h + T;
        ((m = Math.max(m, k)), (b = Math.max(b, D)));
      }
    for (
      var B = {},
        P = function (Q, K) {
      ...
      if (G && (G.row !== void 0 || G.col !== void 0)) {
        var N = { row: G.row, col: G.col };
        if (N.col === void 0) for (N.col = 0; P(N.row, N.col); ) N.col++;
        else if (N.row === void 0) for (N.row = 0; P(N.row, N.col); ) N.row++;
        ((M[V.id()] = N), A(N.row, N.col));
      }
    }
    var F = function (Q, K) {
      var j, re;
      if (Q.locked() || Q.isParent()) return !1;
      var ne = M[Q.id()];
      if (ne) ((j = ne.col * m + m / 2 + i.x1), (re = ne.row * b + b / 2 + i.y1));
      else {
        for (; P(R, L); ) I();
        ((j = L * m + m / 2 + i.x1), (re = R * b + b / 2 + i.y1), A(R, L), I());
      }
      return { x: j, y: re };
    };
...
var Xp = { ready: function () {}, stop: function () {} };
function ho(r) {
  this.options = be({}, Xp, r);
}
...
ff.prototype.run = function () {
  var r = this.options,
    ...
    a = Ue(r.positions);
  function n(i) {
    if (r.positions == null) return yd(i.position());
    if (a) return r.positions(i);
    var s = r.positions[i._private.data.id];
    return s ?? null;
  }
  return (
    t.layoutPositions(this, r, function (i, s) {
      var o = n(i);
...
function cf(r) {
  this.options = be({}, Zp, r);
}
cf.prototype.run = function () {
  var r = this.options,
    e = r.cy,
    t = r.eles,
    a = wr(r.boundingBox ? r.boundingBox : { x1: 0, y1: 0, w: e.width(), h: e.height() }),
    n = function (s, o) {
      return { x: a.x1 + Math.round(Math.random() * a.w), y: a.y1 + Math.round(Math.random() * a.h) };
    };
  return (t.nodes().layoutPositions(this, r, n), this);
};
var Qp = [
  { name: "breadthfirst", impl: af },
  { name: "circle", impl: nf },
  { name: "concentric", impl: sf },
  { name: "cose", impl: Kn },
  { name: "grid", impl: vf },
  { name: "null", impl: ho },
  { name: "preset", impl: ff },
...
go.registerArrowShapes = function () {
        ...
        (r[u] = be(
          {
            ...
            collide: function (c, h, d, y, g, p) {
              var m = i(n(this.points, d + 2 * p, y, g)),
                b = Sr(c, h, m);
              return b;
            },
            roughCollide: t,
            draw: function (c, h, d, y) {
  ...
  (o("none", { collide: xn, roughCollide: xn, draw: js, spacing: Go, gap: Go }),
    o("triangle", { points: [-0.15, -0.3, 0, 0, 0.15, -0.3] }),
    o("arrow", "triangle"),
    o("triangle-backcurve", {
    ...
    o("triangle-tee", {
      ...
      collide: function (u, v, f, c, h, d, y) {
        var g = i(n(this.points, f + 2 * y, c, h)),
          p = i(n(this.pointsTee, f + 2 * y, c, h)),
          m = Sr(u, v, g) || Sr(u, v, p);
        return m;
      },
      draw: function (u, v, f, c, h) {
    ...
    o("circle-triangle", {
      ...
      collide: function (u, v, f, c, h, d, y) {
        var g = h,
          p = Math.pow(g.x - u, 2) + Math.pow(g.y - v, 2) <= Math.pow((f + 2 * y) * this.radius, 2),
          m = i(n(this.points, f + 2 * y, c, h));
        return Sr(u, v, m) || p;
      },
      draw: function (u, v, f, c, h) {
    ...
    o("triangle-cross", {
      ...
      collide: function (u, v, f, c, h, d, y) {
        var g = i(n(this.points, f + 2 * y, c, h)),
          p = i(n(this.crossLinePts(f, d), f + 2 * y, c, h)),
          m = Sr(u, v, g) || Sr(u, v, p);
        return m;
      },
      draw: function (u, v, f, c, h) {
    ...
    o("square", { points: [-0.15, 0, 0.15, 0, 0.15, -0.3, -0.15, -0.3] }),
    o("diamond", {
...
var Mt = {};
Mt.projectIntoViewport = function (r, e) {
  var t = this.cy,
...
Mt.findContainerClientCoords = function () {
  ...
  var r = this.container,
    ...
    t = this.cy.window().getComputedStyle(r),
    a = function (p) {
      return parseFloat(t.getPropertyValue(p));
    },
    n = { left: a("padding-left"), right: a("padding-right"), top: a("padding-top"), bottom: a("padding-bottom") },
    i = {
    ...
    c = s - l,
    h = o - u,
    d = e.left + n.left + i.left,
    y = e.top + n.top + i.top;
  return (this.containerBB = [d, y, c, h, f]);
};
Mt.invalidateContainerClientCoordsCache = function () {
  this.containerBB = null;
};
Mt.findNearestElement = function (r, e, t, a) {
  return this.findNearestElements(r, e, t, a)[0];
};
Mt.findNearestElements = function (r, e, t, a) {
  var n = this,
    i = this,
    s = i.getCachedZSortedEles(),
    o = [],
    l = i.cy.zoom(),
    u = i.cy.hasCompoundNodes(),
    v = (a ? 24 : 8) / l,
    f = (a ? 8 : 2) / l,
    c = (a ? 8 : 2) / l,
    h = 1 / 0,
  ...
  function g(x, T) {
    ...
    if (x.isEdge() && (T == null || T < h))
      if (d) {
        if (
          d.pstyle("z-compound-depth").value === x.pstyle("z-compound-depth").value &&
          d.pstyle("z-compound-depth").value === x.pstyle("z-compound-depth").value
        ) {
  ...
  function p(x) {
    var T = x.outerWidth() + 2 * f,
      ...
      B = k / 2,
      P = x.position(),
      A = x.pstyle("corner-radius").value === "auto" ? "auto" : x.pstyle("corner-radius").pfValue,
      R = x._private.rscratch;
    if (P.x - D <= r && r <= P.x + D && P.y - B <= e && e <= P.y + B) {
      var L = i.nodeShapes[n.getNodeShape(x)];
      if (L.checkPoint(r, e, 0, T, k, P.x, P.y, A, R)) return (g(x, 0), !0);
    }
  }
  function m(x) {
    var T = x._private,
      k = T.rscratch,
      D = x.pstyle("width").pfValue,
      B = x.pstyle("arrow-scale").value,
      P = D / 2 + v,
      A = P * P,
      R = P * 2,
      O = T.source,
    ...
    if (k.edgeType === "segments" || k.edgeType === "straight" || k.edgeType === "haystack") {
      ...
      k.edgeType === "bezier" ||
      k.edgeType === "multibezier" ||
      k.edgeType === "self" ||
      k.edgeType === "compound"
    ) {
      for (var I = k.allpts, M = 0; M + 5 < k.allpts.length; M += 4)
        if (
          Md(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5], R) &&
          A > (L = Od(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5]))
        )
          return (g(x, L), !0);
    }
    for (
      var O = O || T.source,
        V = V || T.target,
        G = n.getArrowWidth(D, B),
        N = [
          { name: "source", x: k.arrowStartX, y: k.arrowStartY, angle: k.srcArrowAngle },
          { name: "target", x: k.arrowEndX, y: k.arrowEndY, angle: k.tgtArrowAngle },
          { name: "mid-source", x: k.midX, y: k.midY, angle: k.midsrcArrowAngle },
          { name: "mid-target", x: k.midX, y: k.midY, angle: k.midtgtArrowAngle },
        ],
        M = 0;
      M < N.length;
      M++
      ...
      var F = N[M],
        U = i.arrowShapes[x.pstyle(F.name + "-arrow-shape").value],
        Q = x.pstyle("width").pfValue;
      if (
        U.roughCollide(r, e, G, F.angle, { x: F.x, y: F.y }, Q, v) &&
        U.collide(r, e, G, F.angle, { x: F.x, y: F.y }, Q, v)
      )
        return (g(x), !0);
    }
    u && o.length > 0 && (p(O), p(V));
  }
  function b(x, T, k) {
    return Tr(x, T, k);
  }
  function w(x, T) {
    var k = x._private,
      D = c,
      B;
    (T ? (B = T + "-") : (B = ""), x.boundingBox());
    var P = k.labelBounds[T || "main"],
      A = x.pstyle(B + "label").value,
      R = x.pstyle("text-events").strValue === "yes";
    if (!(!R || !A)) {
      var L = b(k.rscratch, "labelX", T),
        I = b(k.rscratch, "labelY", T),
        M = b(k.rscratch, "labelAngle", T),
        O = x.pstyle(B + "text-margin-x").pfValue,
        V = x.pstyle(B + "text-margin-y").pfValue,
        G = P.x1 - D - O,
        N = P.x2 + D - O,
        F = P.y1 - D - V,
        U = P.y2 + D - V;
      if (M) {
        var Q = Math.cos(M),
          K = Math.sin(M),
          j = function (Y, te) {
            return ((Y = Y - L), (te = te - I), { x: Y * Q - te * K + L, y: Y * K + te * Q + I });
          },
          re = j(G, F),
          ne = j(G, U),
          J = j(N, F),
          z = j(N, U),
          q = [re.x + O, re.y + V, J.x + O, J.y + V, z.x + O, z.y + V, ne.x + O, ne.y + V];
        if (Sr(r, e, q)) return (g(x), !0);
      } else if (nt(P, r, e)) return (g(x), !0);
    }
  }
...
Mt.getAllInBox = function (r, e, t, a) {
  ...
  function g(Y, te) {
    var ce = Y._private,
      ...
      Ce = "";
    Y.boundingBox();
    var we = ce.labelBounds.main;
    if (!we) return null;
    var ye = y(ce.rscratch, "labelX", te),
      ie = y(ce.rscratch, "labelY", te),
      de = y(ce.rscratch, "labelAngle", te),
      he = Y.pstyle(Ce + "text-margin-x").pfValue,
      Ee = Y.pstyle(Ce + "text-margin-y").pfValue,
      pe = we.x1 - Ae - he,
      Se = we.x2 + Ae - he,
      Re = we.y1 - Ae - Ee,
      Oe = we.y2 + Ae - Ee;
    if (de) {
      var Ne = Math.cos(de),
        ze = Math.sin(de),
        xe = function (X, S) {
          return ((X = X - ye), (S = S - ie), { x: X * Ne - S * ze + ye, y: X * ze + S * Ne + ie });
        };
  ...
  function p(Y, te, ce, Ae) {
    function Ce(we, ye, ie) {
      return (ie.y - we.y) * (ye.x - we.x) > (ye.y - we.y) * (ie.x - we.x);
    }
    return Ce(Y, ce, Ae) !== Ce(te, ce, Ae) && Ce(Y, te, ce) !== Ce(Y, te, Ae);
  }
  for (var m = 0; m < n.length; m++) {
    var b = n[m];
    if (b.isNode()) {
      var w = b,
        E = w.pstyle("text-events").strValue === "yes",
        C = w.pstyle("box-selection").strValue,
        x = w.pstyle("box-select-labels").strValue === "yes";
      if (C === "none") continue;
      var T = (C === "overlap" || x) && E,
        k = w.boundingBox({ includeNodes: !0, includeEdges: !1, includeLabels: T });
      if (C === "contain") {
        var D = !1;
        if (x && E) {
          var B = g(w);
          B && yi(B, h) && (o.push(w), (D = !0));
        }
        !D && bv(c, k) && o.push(w);
      ...
      var L = b,
        I = L._private,
        M = I.rscratch,
        O = L.pstyle("box-selection").strValue;
      if (O === "none") continue;
      if (O === "contain") {
        if (
          (M.startX != null && M.startY != null && !nt(c, M.startX, M.startY)) ||
          (M.endX != null && M.endY != null && !nt(c, M.endX, M.endY))
        )
          continue;
        if (
          M.edgeType === "bezier" ||
          M.edgeType === "multibezier" ||
          M.edgeType === "self" ||
          M.edgeType === "compound" ||
          M.edgeType === "segments" ||
          M.edgeType === "haystack"
        ) {
          for (var V = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts, G = !0, N = 0; N < V.length; N++)
            if (!Ko(c, V[N])) {
              G = !1;
              break;
            }
          G && o.push(L);
        } else M.edgeType === "straight" && o.push(L);
      } else if (O === "overlap") {
        var F = !1;
        if (
          M.startX != null &&
          ...
          M.endX != null &&
          M.endY != null &&
          (nt(c, M.startX, M.startY) || nt(c, M.endX, M.endY))
        )
          (o.push(L), (F = !0));
        else if (!F && M.edgeType === "haystack") {
          for (var U = I.rstyle.haystackPts, Q = 0; Q < U.length; Q++)
            if (Ko(c, U[Q])) {
              (o.push(L), (F = !0));
              break;
            }
        ...
        if (!F) {
          ...
          for (var j = 0; j < K.length - 1; j++) {
            for (var re = K[j], ne = K[j + 1], J = 0; J < d.length; J++) {
              var z = Je(d[J], 2),
                q = z[0],
                H = z[1];
              if (p(re, ne, q, H)) {
...
Bn.calculateArrowAngles = function (r) {
  var e = r._private.rscratch,
    t = e.edgeType === "haystack",
    a = e.edgeType === "bezier",
    n = e.edgeType === "multibezier",
    i = e.edgeType === "segments",
    s = e.edgeType === "compound",
    o = e.edgeType === "self",
    l,
    u,
    v,
  ...
  if (
    (t
      ? ((v = e.haystackPts[0]), (f = e.haystackPts[1]), (c = e.haystackPts[2]), (h = e.haystackPts[3]))
      : ((v = e.arrowStartX), (f = e.arrowStartY), (c = e.arrowEndX), (h = e.arrowEndY)),
    (p = e.midX),
    (m = e.midY),
    i)
  )
    ...
    var d = e.allpts,
      y = sr(d[0], d[2], d[4], 0.1),
      g = sr(d[1], d[3], d[5], 0.1);
    ((l = v - y), (u = f - g));
  } else ((l = v - p), (u = f - m));
  e.srcArrowAngle = Ya(l, u);
  var p = e.midX,
    m = e.midY;
  if ((t && ((p = (v + c) / 2), (m = (f + h) / 2)), (l = c - v), (u = h - f), i)) {
    var d = e.allpts;
    if ((d.length / 2) % 2 === 0) {
      var b = d.length / 2,
        w = b - 2;
    ...
    if ((E.length / 2) % 2 === 0) {
      ...
      ((C = sr(d[D], d[B], d[P], 0)),
        ...
        (T = sr(d[D], d[B], d[P], 1e-4)),
        (k = sr(d[D + 1], d[B + 1], d[P + 1], 1e-4)));
    } else {
      var B = d.length / 2 - 1,
        D = B - 2,
        P = B + 2;
      ((C = sr(d[D], d[B], d[P], 0.4999)),
        (x = sr(d[D + 1], d[B + 1], d[P + 1], 0.4999)),
        (T = sr(d[D], d[B], d[P], 0.5)),
        (k = sr(d[D + 1], d[B + 1], d[P + 1], 0.5)));
    }
    ((l = T - C), (u = k - x));
  }
  ...
  if (((e.midsrcArrowAngle = Ya(l, u)), i))
    ...
    var d = e.allpts,
      R = d.length,
      y = sr(d[R - 6], d[R - 4], d[R - 2], 0.9),
      g = sr(d[R - 5], d[R - 3], d[R - 1], 0.9);
    ((l = c - y), (u = h - g));
  } else ((l = c - p), (u = h - m));
...
var Vs,
  ...
  jp = function (e, t, a, n, i) {
    if (
      (e !== Rl ? Ml(t, e, Vr) : Jp(Pr, Vr),
      Ml(t, a, Pr),
    ...
    ((St = 1),
      ...
      Al < 0
        ? Ur < 0
          ? (Ur = Math.PI + Ur)
          : ((Ur = Math.PI - Ur), (St = -1), (gn = !0))
        : Ur > 0 && ((St = -1), (gn = !0)),
      t.radius !== void 0 ? (Vt = t.radius) : (Vt = n),
      (wt = Ur / 2),
      ...
      i
        ...
        : ((zr = Math.min(an, Vt)), (Ct = Math.abs((zr * Math.sin(wt)) / Math.cos(wt)))),
      (_s = t.x + Pr.nx * zr),
      (Gs = t.y + Pr.ny * zr),
      (Vs = _s - Pr.ny * Ct * St),
      (qs = Gs + Pr.nx * Ct * St),
    ...
    : (jp(r, e, t, a, n),
      {
        ...
        stopX: _s,
        stopY: Gs,
        startAngle: Vr.ang + (Math.PI / 2) * St,
        endAngle: Pr.ang - (Math.PI / 2) * St,
        counterClockwise: gn,
      });
}
var Ma = 0.01,
...
yr.findMidptPtsEtc = function (r, e) {
  var t = e.posPts,
    a = e.intersectionPts,
    n = e.vectorNormInverse,
    i,
    s = r.pstyle("source-endpoint"),
    o = r.pstyle("target-endpoint"),
    l = s.units != null && o.units != null,
    u = function (E, C, x, T) {
      var k = T - C,
        D = x - E,
        B = Math.sqrt(D * D + k * k);
    ...
    case "endpoints": {
      if (l) {
        var f = this.manualEndptToPx(r.source()[0], s),
          ...
          h = c[0],
          d = c[1],
          y = this.manualEndptToPx(r.target()[0], o),
          g = Je(y, 2),
          p = g[0],
          m = g[1],
          b = { x1: h, y1: d, x2: p, y2: m };
        ((n = u(h, d, p, m)), (i = b));
      } else
        (Ve(
          "Edge ".concat(
  ...
  return { midptPts: i, vectorNormInverse: n };
};
yr.findHaystackPoints = function (r) {
  for (var e = 0; e < r.length; e++) {
    ...
    var s = a.source,
      ...
      c = s.height(),
      h = o.height(),
      d = t.pstyle("haystack-radius").value,
      y = d / 2;
    ((n.haystackPts = n.allpts =
      [n.source.x * v * y + l.x, n.source.y * c * y + l.y, n.target.x * f * y + u.x, n.target.y * h * y + u.y]),
...
yr.findSegmentsPoints = function (r, e) {
  var t = r._private.rscratch,
    a = r.pstyle("segment-weights"),
    n = r.pstyle("segment-distances"),
    i = r.pstyle("segment-radii"),
    s = r.pstyle("radius-type"),
    o = Math.min(a.pfValue.length, n.pfValue.length),
    l = i.pfValue[i.pfValue.length - 1],
    u = s.pfValue[s.pfValue.length - 1];
  ...
  for (var v = 0; v < o; v++) {
    var f = a.pfValue[v],
      ...
      h = 1 - f,
      d = f,
      y = this.findMidptPtsEtc(r, e),
      g = y.midptPts,
      p = y.vectorNormInverse,
      m = { x: g.x1 * h + g.x2 * d, y: g.y1 * h + g.y2 * d };
...
yr.findLoopPoints = function (r, e, t, a) {
  var n = r._private.rscratch,
    i = e.dirCounts,
    s = e.srcPos,
    o = r.pstyle("control-point-distances"),
    l = o ? o.pfValue[0] : void 0,
    u = r.pstyle("loop-direction").pfValue,
    v = r.pstyle("loop-sweep").pfValue,
    f = r.pstyle("control-point-step-size").pfValue;
  n.edgeType = "self";
  var c = t,
    h = f;
  a && ((c = 0), (h = l));
  ...
  ((c = i[p] === void 0 ? (i[p] = 0) : ++i[p]),
    (n.ctrlpts = [
      s.x + Math.cos(y) * 1.4 * h * (c / 3 + 1),
      s.y + Math.sin(y) * 1.4 * h * (c / 3 + 1),
      s.x + Math.cos(g) * 1.4 * h * (c / 3 + 1),
      s.y + Math.sin(g) * 1.4 * h * (c / 3 + 1),
    ]));
};
yr.findCompoundLoopPoints = function (r, e, t, a) {
  ...
  var i = e.srcPos,
    ...
    v = e.tgtH,
    f = r.pstyle("control-point-step-size").pfValue,
    c = r.pstyle("control-point-distances"),
    h = c ? c.pfValue[0] : void 0,
    d = t,
    y = f;
  a && ((d = 0), (y = h));
  var g = 50,
    p = { x: i.x - o / 2, y: i.y - l / 2 },
    m = { x: s.x - u / 2, y: s.y - v / 2 },
    b = { x: Math.min(p.x, m.x), y: Math.min(p.y, m.y) },
    w = 0.5,
    E = Math.max(w, Math.log(o * Ma)),
    C = Math.max(w, Math.log(u * Ma));
  n.ctrlpts = [
    b.x,
    b.y - (1 + Math.pow(g, 1.12) / 100) * y * (d / 3 + 1) * E,
    b.x - (1 + Math.pow(g, 1.12) / 100) * y * (d / 3 + 1) * C,
    b.y,
  ];
};
...
yr.findBezierPoints = function (r, e, t, a, n) {
  var i = r._private.rscratch,
    s = r.pstyle("control-point-step-size").pfValue,
    o = r.pstyle("control-point-distances"),
    l = r.pstyle("control-point-weights"),
    u = o && l ? Math.min(o.value.length, l.value.length) : 1,
    v = o ? o.pfValue[0] : void 0,
    f = l.value[0],
    c = a;
  ((i.edgeType = c ? "multibezier" : "bezier"), (i.ctrlpts = []));
  for (var h = 0; h < u; h++) {
    var d = (0.5 - e.eles.length / 2 + t) * s * (n ? -1 : 1),
      y = void 0,
      g = to(d);
    (c && ((v = o ? o.pfValue[h] : s), (f = l.value[h])), a ? (y = v) : (y = v !== void 0 ? g * v : void 0));
    var p = y !== void 0 ? y : d,
      m = 1 - f,
      b = f,
      w = this.findMidptPtsEtc(r, e),
      E = w.midptPts,
      C = w.vectorNormInverse,
      x = { x: E.x1 * m + E.x2 * b, y: E.y1 * m + E.y2 * b };
...
yr.findTaxiPoints = function (r, e) {
  ...
  var a = "vertical",
    ...
    h = e.tgtW,
    d = e.tgtH,
    y = r.pstyle("edge-distances").value,
    g = y !== "node-position",
    p = r.pstyle("taxi-direction").value,
    m = p,
    b = r.pstyle("taxi-turn"),
    w = b.units === "%",
    E = b.pfValue,
    C = E < 0,
    x = r.pstyle("taxi-turn-min-distance").pfValue,
    T = g ? (f + h) / 2 : 0,
    k = g ? (c + d) / 2 : 0,
    D = v.x2 - v.x1,
    B = v.y2 - v.y1,
    P = function (S, _) {
      return S > 0 ? Math.max(S - _, 0) : Math.min(S + _, 0);
    },
    A = P(D, T),
    R = P(B, k),
    L = !1;
  ...
  var I = p === a,
    ...
    G = !1;
  !(L && (w || C)) &&
    ((m === o && O < 0) || (m === l && O > 0) || (m === i && O > 0) || (m === s && O < 0)) &&
    ((V *= -1), (M = V * Math.abs(M)), (G = !0));
  var N;
  if (w) {
    var F = E < 0 ? 1 + E : E;
    N = F * M;
  ...
  var Q = function (S) {
      return Math.abs(S) < x || Math.abs(S) >= Math.abs(M);
    },
    K = Q(N),
    j = Q(Math.abs(M) - Math.abs(N)),
    re = K || j;
  if (re && !G)
    if (I) {
  ...
  if (t.isRound) {
    var xe = r.pstyle("taxi-radius").value,
      ue = r.pstyle("radius-type").value[0] === "arc-radius";
    ((t.radii = new Array(t.segpts.length / 2).fill(xe)), (t.isArcRadius = new Array(t.segpts.length / 2).fill(ue)));
  }
};
yr.tryToCorrectInvalidPoints = function (r, e) {
  ...
  if (t.edgeType === "bezier") {
    var a = e.srcPos,
      ...
      h = e.srcRs,
      d = e.tgtRs,
      y = !ae(t.startX) || !ae(t.startY),
      g = !ae(t.arrowStartX) || !ae(t.arrowStartY),
      p = !ae(t.endX) || !ae(t.endY),
      m = !ae(t.arrowEndX) || !ae(t.arrowEndY),
      b = 3,
      w = this.getArrowWidth(r.pstyle("width").pfValue, r.pstyle("arrow-scale").value) * this.arrowShapeWidth,
      E = b * w,
      C = Bt({ x: t.ctrlpts[0], y: t.ctrlpts[1] }, { x: t.startX, y: t.startY }),
      x = C < E,
      T = Bt({ x: t.ctrlpts[0], y: t.ctrlpts[1] }, { x: t.endX, y: t.endY }),
      k = T < E,
      D = !1;
    if (y || g || x) {
      D = !0;
      var B = { x: t.ctrlpts[0] - a.x, y: t.ctrlpts[1] - a.y },
        P = Math.sqrt(B.x * B.x + B.y * B.y),
        A = { x: B.x / P, y: B.y / P },
        R = Math.max(i, s),
        L = { x: t.ctrlpts[0] + A.x * 2 * R, y: t.ctrlpts[1] + A.y * 2 * R },
        I = u.intersectLine(a.x, a.y, i, s, L.x, L.y, 0, f, h);
      x
        ? ((t.ctrlpts[0] = t.ctrlpts[0] + A.x * (E - C)), (t.ctrlpts[1] = t.ctrlpts[1] + A.y * (E - C)))
        : ((t.ctrlpts[0] = I[0] + A.x * E), (t.ctrlpts[1] = I[1] + A.y * E));
    }
    if (p || m || k) {
      D = !0;
      var M = { x: t.ctrlpts[0] - n.x, y: t.ctrlpts[1] - n.y },
        ...
        V = { x: M.x / O, y: M.y / O },
        G = Math.max(i, s),
        N = { x: t.ctrlpts[0] + V.x * 2 * G, y: t.ctrlpts[1] + V.y * 2 * G },
        F = v.intersectLine(n.x, n.y, o, l, N.x, N.y, 0, c, d);
      k
        ? ((t.ctrlpts[0] = t.ctrlpts[0] + V.x * (E - T)), (t.ctrlpts[1] = t.ctrlpts[1] + V.y * (E - T)))
        : ((t.ctrlpts[0] = F[0] + V.x * E), (t.ctrlpts[1] = F[1] + V.y * E));
    }
    D && this.findEndpoints(r);
  }
};
  ...
  if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
    ...
    for (var t = 0; t + 1 < e.ctrlpts.length; t += 2)
      (e.allpts.push(e.ctrlpts[t], e.ctrlpts[t + 1]),
        t + 3 < e.ctrlpts.length &&
          e.allpts.push((e.ctrlpts[t] + e.ctrlpts[t + 2]) / 2, (e.ctrlpts[t + 1] + e.ctrlpts[t + 3]) / 2));
    e.allpts.push(e.endX, e.endY);
    var a, n;
    (e.ctrlpts.length / 2) % 2 === 0
      ? ((a = e.allpts.length / 2 - 1), (e.midX = e.allpts[a]), (e.midY = e.allpts[a + 1]))
    ...
    if (
      ...
      e.allpts.push.apply(e.allpts, e.segpts),
      e.allpts.push(e.endX, e.endY),
      e.isRound)
    ) {
      e.roundCorners = [];
      for (var i = 2; i + 3 < e.allpts.length; i += 2) {
        var s = e.radii[i / 2 - 1],
          o = e.isArcRadius[i / 2 - 1];
        e.roundCorners.push(
          po(
            { x: e.allpts[i - 2], y: e.allpts[i - 1] },
            { x: e.allpts[i], y: e.allpts[i + 1], radius: s },
            { x: e.allpts[i + 2], y: e.allpts[i + 3] },
            s,
            o
          )
        );
    ...
    if (e.segpts.length % 4 === 0) {
      ...
      if (!e.isRound) ((e.midX = e.segpts[v]), (e.midY = e.segpts[v + 1]));
      else {
        ...
        if (c.radius === 0) {
          ...
          var d = [f.x - c.cx, f.y - c.cy],
            y = c.radius / Math.sqrt(Math.pow(d[0], 2) + Math.pow(d[1], 2));
          ((d = d.map(function (g) {
            return g * y;
          })),
            (e.midX = c.cx + d[0]),
...
yr.checkForInvalidEdgeWarning = function (r) {
  ...
  e.nodesOverlap || (ae(e.startX) && ae(e.startY) && ae(e.endX) && ae(e.endY))
    ? (e.loggedErr = !1)
    : e.loggedErr ||
      ((e.loggedErr = !0),
      Ve(
    ...
    for (
      ...
      if (!(v.removed() || !v.takesUpSpace())) {
        ...
        var h =
          ...
          w = s(b, h),
          E = i.get(w);
        (E == null && ((E = { eles: [] }), o.push({ pairId: b, edgeIsUnbundled: h }), i.set(w, E)),
          E.eles.push(v),
          h && (E.hasUnbundled = !0),
          d && (E.hasBezier = !0));
      }
    ...
    for (
      var C = function () {
          var k = o[x],
            ...
            R;
          if (!A.hasUnbundled) {
            var L = A.eles[0].parallelEdges().filter(function (ue) {
              return ue.isBundledBezier();
            });
            (eo(A.eles),
              L.forEach(function (ue) {
                return A.eles.push(ue);
              }),
              A.eles.sort(function (ue, X) {
                return ue.poolIndex() - X.poolIndex();
              }));
          }
          var I = A.eles[0],
            M = I.source(),
          ...
          var G = (A.srcPos = M.position()),
            N = (A.tgtPos = O.position()),
            F = (A.srcW = M.outerWidth()),
            U = (A.srcH = M.outerHeight()),
            Q = (A.tgtW = O.outerWidth()),
            K = (A.tgtH = O.outerHeight()),
            j = (A.srcShape = t.nodeShapes[e.getNodeShape(M)]),
            re = (A.tgtShape = t.nodeShapes[e.getNodeShape(O)]),
            ne = (A.srcCornerRadius =
              M.pstyle("corner-radius").value === "auto" ? "auto" : M.pstyle("corner-radius").pfValue),
            J = (A.tgtCornerRadius =
              O.pstyle("corner-radius").value === "auto" ? "auto" : O.pstyle("corner-radius").pfValue),
            z = (A.tgtRs = O._private.rscratch),
          ...
          for (var H = 0; H < A.eles.length; H++) {
            var Y = A.eles[H],
              te = Y[0]._private.rscratch,
              ce = Y.pstyle("curve-style").value,
              Ae = ce === "unbundled-bezier" || at(ce, "segments") || at(ce, "taxi"),
              Ce = !M.same(Y.source());
            if (!A.calculatedIntersection && M !== O && (A.hasBezier || A.hasUnbundled)) {
              ...
              var we = j.intersectLine(G.x, G.y, F, U, N.x, N.y, 0, ne, q),
                ye = (A.srcIntn = we),
                ie = re.intersectLine(N.x, N.y, Q, K, G.x, G.y, 0, J, z),
                de = (A.tgtIntn = ie),
                he = (A.intersectionPts = { x1: we[0], x2: ie[0], y1: we[1], y2: ie[1] }),
                Ee = (A.posPts = { x1: G.x, x2: N.x, y1: G.y, y2: N.y }),
                pe = ie[1] - we[1],
                Se = ie[0] - we[0],
                Re = Math.sqrt(Se * Se + pe * pe);
              (ae(Re) && Re >= ey) || (Re = Math.sqrt(Math.max(Se * Se, Ma) + Math.max(pe * pe, Ma)));
              var Oe = (A.vector = { x: Se, y: pe }),
                Ne = (A.vectorNorm = { x: Oe.x / Re, y: Oe.y / Re }),
                ze = { x: -Ne.y, y: Ne.x };
              ((A.nodesOverlap =
                !ae(Re) ||
                re.checkPoint(we[0], we[1], 0, Q, K, N.x, N.y, J, z) ||
                j.checkPoint(ie[0], ie[1], 0, F, U, G.x, G.y, ne, q)),
                ...
                (R = {
                  ...
                  srcShape: re,
                  tgtShape: j,
                  posPts: { x1: Ee.x2, y1: Ee.y2, x2: Ee.x1, y2: Ee.y1 },
                  intersectionPts: { x1: he.x2, y1: he.y2, x2: he.x1, y2: he.y1 },
                  vector: { x: -Oe.x, y: -Oe.y },
                  vectorNorm: { x: -Ne.x, y: -Ne.y },
                  vectorNormInverse: { x: -ze.x, y: -ze.y },
                }));
            }
            var xe = Ce ? R : A;
            ((te.nodesOverlap = xe.nodesOverlap),
              ...
              n &&
              (M.isParent() || M.isChild() || O.isParent() || O.isChild()) &&
              (M.parents().anySame(O) || O.parents().anySame(M) || (M.same(O) && M.isParent()))
                ? e.findCompoundLoopPoints(Y, xe, H, Ae)
                : M === O
                  ? e.findLoopPoints(Y, xe, H, Ae)
                  : ce.endsWith("segments")
                    ? e.findSegmentsPoints(Y, xe)
                    : ce.endsWith("taxi")
                      ? e.findTaxiPoints(Y, xe)
                      : ce === "straight" || (!Ae && A.eles.length % 2 === 1 && H === Math.floor(A.eles.length / 2))
...
yr.getSegmentPoints = function (r) {
  ...
  var t = e.edgeType;
  if (t === "segments") return yf(e.segpts);
};
yr.getControlPoints = function (r) {
  var e = r[0]._private.rscratch;
  this.recalculateRenderedStyle(r);
  var t = e.edgeType;
  if (t === "bezier" || t === "multibezier" || t === "self" || t === "compound") return yf(e.ctrlpts);
};
yr.getEdgeMidpoint = function (r) {
  var e = r[0]._private.rscratch;
  return (this.recalculateRenderedStyle(r), { x: e.midX, y: e.midY });
};
var Ga = {};
Ga.manualEndptToPx = function (r, e) {
  ...
  if (e.value.length === 2) {
    ...
    var u = 2 * Math.max(n, i),
      v = [a.x + Math.cos(l) * u, a.y + Math.sin(l) * u];
    return t.nodeShapes[this.getNodeShape(r)].intersectLine(
      a.x,
      a.y,
      n,
      i,
      ...
      v[1],
      0,
      r.pstyle("corner-radius").value === "auto" ? "auto" : r.pstyle("corner-radius").pfValue,
      s
    );
  }
};
Ga.findEndpoints = function (r) {
  var e,
    ...
    u = o.position(),
    v = l.position(),
    f = r.pstyle("target-arrow-shape").value,
    c = r.pstyle("source-arrow-shape").value,
    h = r.pstyle("target-distance-from-node").pfValue,
    d = r.pstyle("source-distance-from-node").pfValue,
    y = o._private.rscratch,
    g = l._private.rscratch,
    p = r.pstyle("curve-style").value,
    m = r._private.rscratch,
    b = m.edgeType,
    w = at(p, "taxi"),
    E = b === "self" || b === "compound",
    C = b === "bezier" || b === "multibezier" || E,
    x = b !== "bezier",
    T = b === "straight" || b === "segments",
    k = b === "segments",
    D = C || x || T,
    B = E || w,
    P = r.pstyle("source-endpoint"),
    A = B ? "outside-to-node" : P.value,
    R = o.pstyle("corner-radius").value === "auto" ? "auto" : o.pstyle("corner-radius").pfValue,
    L = r.pstyle("target-endpoint"),
    I = B ? "outside-to-node" : L.value,
    M = l.pstyle("corner-radius").value === "auto" ? "auto" : l.pstyle("corner-radius").pfValue;
  ((m.srcManEndpt = P), (m.tgtManEndpt = L));
  var O,
    V,
    G,
    N,
    F =
      (e = (L == null || (t = L.pfValue) === null || t === void 0 ? void 0 : t.length) === 2 ? L.pfValue : null) !==
        null && e !== void 0
        ? e
        : [0, 0],
    U =
      (a = (P == null || (n = P.pfValue) === null || n === void 0 ? void 0 : n.length) === 2 ? P.pfValue : null) !==
        null && a !== void 0
        ? a
        : [0, 0];
  if (C) {
    var Q = [m.ctrlpts[0], m.ctrlpts[1]],
      K = x ? [m.ctrlpts[m.ctrlpts.length - 2], m.ctrlpts[m.ctrlpts.length - 1]] : Q;
    ((O = K), (V = Q));
  } else if (T) {
    var j = k ? m.segpts.slice(0, 2) : [v.x + F[0], v.y + F[1]],
      re = k ? m.segpts.slice(m.segpts.length - 2) : [u.x + U[0], u.y + U[1]];
    ((O = re), (V = j));
  }
  if (I === "inside-to-node") s = [v.x, v.y];
  else if (L.units) s = this.manualEndptToPx(l, L);
  else if (I === "outside-to-line") s = m.tgtIntn;
  else if (
    (I === "outside-to-node" || I === "outside-to-node-or-label"
      ? (G = O)
      : (I === "outside-to-line" || I === "outside-to-line-or-label") && (G = [u.x, u.y]),
    (s = i.nodeShapes[this.getNodeShape(l)].intersectLine(
      v.x,
      v.y,
      l.outerWidth(),
      l.outerHeight(),
    ...
    I === "outside-to-node-or-label" || I === "outside-to-line-or-label")
  ) {
    var ne = l._private.rscratch,
      ...
      Y = J / 2,
      te = z / 2,
      ce = l.pstyle("text-valign").value;
    ce === "top" ? (H -= te) : ce === "bottom" && (H += te);
    var Ae = l.pstyle("text-halign").value;
    Ae === "left" ? (q -= Y) : Ae === "right" && (q += Y);
    var Ce = Da(G[0], G[1], [q - Y, H - te, q + Y, H - te, q + Y, H + te, q - Y, H + te], v.x, v.y);
    if (Ce.length > 0) {
      var we = u,
        ye = Et(we, Wt(s)),
        ie = Et(we, Wt(Ce)),
  ...
  var Ee = Za(s, O, i.arrowShapes[f].spacing(r) + h),
    pe = Za(s, O, i.arrowShapes[f].gap(r) + h);
  if (((m.endX = pe[0]), (m.endY = pe[1]), (m.arrowEndX = Ee[0]), (m.arrowEndY = Ee[1]), A === "inside-to-node"))
    s = [u.x, u.y];
  else if (P.units) s = this.manualEndptToPx(o, P);
  else if (A === "outside-to-line") s = m.srcIntn;
  else if (
    (A === "outside-to-node" || A === "outside-to-node-or-label"
      ? (N = V)
      : (A === "outside-to-line" || A === "outside-to-line-or-label") && (N = [v.x, v.y]),
    (s = i.nodeShapes[this.getNodeShape(o)].intersectLine(
      u.x,
      u.y,
      o.outerWidth(),
      o.outerHeight(),
    ...
    A === "outside-to-node-or-label" || A === "outside-to-line-or-label")
  ) {
    var Se = o._private.rscratch,
      ...
      xe = Re / 2,
      ue = Oe / 2,
      X = o.pstyle("text-valign").value;
    X === "top" ? (ze -= ue) : X === "bottom" && (ze += ue);
    var S = o.pstyle("text-halign").value;
    S === "left" ? (Ne -= xe) : S === "right" && (Ne += xe);
    var _ = Da(N[0], N[1], [Ne - xe, ze - ue, Ne + xe, ze - ue, Ne + xe, ze + ue, Ne - xe, ze + ue], u.x, u.y);
    if (_.length > 0) {
      var W = v,
        $ = Et(W, Wt(s)),
        Z = Et(W, Wt(_)),
        oe = $;
      if ((Z < $ && ((s = [_[0], _[1]]), (oe = Z)), _.length > 2)) {
  ...
  var ve = Za(s, V, i.arrowShapes[c].spacing(r) + d),
    le = Za(s, V, i.arrowShapes[c].gap(r) + d);
  ((m.startX = le[0]),
    (m.startY = le[1]),
    (m.arrowStartX = ve[0]),
    (m.arrowStartY = ve[1]),
    D && (!ae(m.startX) || !ae(m.startY) || !ae(m.endX) || !ae(m.endY) ? (m.badLine = !0) : (m.badLine = !1)));
};
...
function ry(r, e, t) {
  for (
    var a = function (u, v, f, c) {
        return sr(u, v, f, c);
      },
      n = e._private,
      i = n.rstyle.bezierPts,
      s = 0;
    s < r.bezierProjPcts.length;
    s++
  ) {
    var o = r.bezierProjPcts[s];
    i.push({ x: a(t[0], t[2], t[4], o), y: a(t[1], t[3], t[5], o) });
  }
}
yo.storeEdgeProjections = function (r) {
  ...
  if (
    ...
    a === "multibezier" || a === "bezier" || a === "self" || a === "compound")
  ) {
    e.rstyle.bezierPts = [];
    for (var n = 0; n + 5 < t.allpts.length; n += 4) ry(this, r, t.allpts.slice(n, n + 6));
  } else if (a === "segments")
  ...
  e.rstyle.arrowWidth =
    this.getArrowWidth(r.pstyle("width").pfValue, r.pstyle("arrow-scale").value) * this.arrowShapeWidth;
};
...
Gr.recalculateNodeLabelProjection = function (r) {
  ...
  if (!ut(e)) {
    var t,
      ...
      o = r.padding(),
      l = r.position(),
      u = r.pstyle("text-halign").strValue,
      v = r.pstyle("text-valign").strValue,
      f = n.rscratch,
      c = n.rstyle;
    switch (u) {
      case "left":
...
Gr.recalculateEdgeLabelProjections = function (r) {
  ...
  if (i.mid || i.source || i.target) {
    ...
    var o = mf(a.midDispX, a.midDispY);
    s("labelAutoAngle", null, o);
    var l = function () {
        if (l.cache) return l.cache;
        for (var f = [], c = 0; c + 5 < a.allpts.length; c += 4) {
          var h = { x: a.allpts[c], y: a.allpts[c + 1] },
            d = { x: a.allpts[c + 2], y: a.allpts[c + 3] },
            y = { x: a.allpts[c + 4], y: a.allpts[c + 5] };
          f.push({ p0: h, p1: d, p2: y, startDist: 0, length: 0, segments: [] });
        }
        var g = t.rstyle.bezierPts,
          p = n.bezierProjPcts.length;
        function m(x, T, k, D, B) {
          var P = Bt(T, k),
            A = x.segments[x.segments.length - 1],
            R = { p0: T, p1: k, t0: D, t1: B, startDist: A ? A.startDist + A.length : 0, length: P };
          (x.segments.push(R), (x.length += P));
        }
          ...
          switch (a.edgeType) {
            ...
            case "multibezier": {
              for (var y = l(), g, p = 0, m = 0, b = 0; b < y.length; b++) {
                for (var w = y[h ? b : y.length - 1 - b], E = 0; E < w.segments.length; E++) {
                  var C = w.segments[h ? E : w.segments.length - 1 - E],
                    x = b === y.length - 1 && E === w.segments.length - 1;
              ...
              var T = g.cp,
                ...
                D = (d - p) / k.length,
                B = k.t1 - k.t0,
                P = h ? k.t0 + B * D : k.t1 - B * D;
              ((P = ka(0, P, 1)), (e = Kt(T.p0, T.p1, T.p2, P)), (c = ty(T.p0, T.p1, T.p2, P)));
              break;
            }
            case "straight":
            case "segments":
            case "haystack": {
              for (
                var A = 0, R, L, I, M, O = a.allpts.length, V = 0;
                V + 3 < O &&
                (h
                  ? ((I = { x: a.allpts[V], y: a.allpts[V + 1] }), (M = { x: a.allpts[V + 2], y: a.allpts[V + 3] }))
                  : ((I = { x: a.allpts[O - 2 - V], y: a.allpts[O - 1 - V] }),
                    (M = { x: a.allpts[O - 4 - V], y: a.allpts[O - 3 - V] })),
                (R = Bt(I, M)),
                (L = A),
                (A += R),
                !(A >= d));
              ...
              var G = d - L,
                N = G / R;
              ((N = ka(0, N, 1)), (e = Td(I, M, N)), (c = bf(I, M)));
              break;
            }
          }
...
Gr.applyLabelDimensions = function (r) {
  (this.applyPrefixedLabelDimensions(r),
    r.isEdge() && (this.applyPrefixedLabelDimensions(r, "source"), this.applyPrefixedLabelDimensions(r, "target")));
};
Gr.applyPrefixedLabelDimensions = function (r, e) {
  var t = r._private,
    a = this.getLabelText(r, e),
    n = Dt(a, r._private.labelDimsKey);
  if (Tr(t.rscratch, "prefixedLabelDimsKey", e) !== n) {
    Kr(t.rscratch, "prefixedLabelDimsKey", e, n);
    var i = this.calculateLabelDimensions(r, a),
      s = r.pstyle("line-height").pfValue,
      o = r.pstyle("text-wrap").strValue,
      l = Tr(t.rscratch, "labelWrapCachedLines", e) || [],
      u = o !== "wrap" ? 1 : Math.max(l.length, 1),
      v = i.height / u,
      f = v * s,
      c = i.width,
      h = i.height + (u - 1) * (s - 1) * v;
...
Gr.getLabelText = function (r, e) {
  var t = r._private,
    a = e ? e + "-" : "",
    n = r.pstyle(a + "label").strValue,
    i = r.pstyle("text-transform").value,
    s = function (U, Q) {
      return Q ? (Kr(t.rscratch, U, e, Q), Q) : Tr(t.rscratch, U, e);
    };
  if (!n) return "";
  ...
  if (o === "wrap") {
    ...
    for (
      var u = "​",
        v = n.split(`
`),
        f = r.pstyle("text-max-width").pfValue,
        c = r.pstyle("text-overflow-wrap").value,
        h = c === "anywhere",
        d = [],
        y = /[\s\u200b]+|$/g,
        g = 0;
      ...
      var p = v[g],
        m = this.calculateLabelDimensions(r, p),
        b = m.width;
      if (h) {
      ...
      if (b > f) {
        ...
        try {
          for (T.s(); !(k = T.n()).done; ) {
            var D = k.value,
              B = D[0],
              P = p.substring(x, D.index);
            x = D.index + B.length;
            var A = C.length === 0 ? P : C + P + B,
              R = this.calculateLabelDimensions(r, A),
              L = R.width;
            L <= f ? (C += P + B) : (C && d.push(C), (C = P + B));
          }
        } catch (F) {
          T.e(F);
        } finally {
...
`)
    ...
    var I = r.pstyle("text-max-width").pfValue,
      ...
      O = "…",
      V = !1;
    if (this.calculateLabelDimensions(r, n).width < I) return n;
    for (var G = 0; G < n.length; G++) {
      var N = this.calculateLabelDimensions(r, M + n[G] + O).width;
      if (N > I) break;
      ((M += n[G]), G === n.length - 1 && (V = !0));
    }
    return (V || (M += O), M);
  }
  return n;
...
Gr.getLabelJustification = function (r) {
  var e = r.pstyle("text-justification").strValue,
    t = r.pstyle("text-halign").strValue;
  if (e === "auto")
    if (r.isNode())
      switch (t) {
        case "left":
...
Gr.calculateLabelDimensions = function (r, e) {
  var t = this,
    ...
    n = a.document,
    i = 0,
    s = r.pstyle("font-style").strValue,
    o = r.pstyle("font-size").pfValue,
    l = r.pstyle("font-family").strValue,
    u = r.pstyle("font-weight").strValue,
    v = this.labelCalcCanvas,
    f = this.labelCalcCanvasContext;
  if (!v) {
...
`),
  ...
  return ((h += i), (d += i), { width: h, height: d });
};
...
wf.getNodeShape = function (r) {
  var e = this,
    t = r.pstyle("shape").value;
  if (t === "cutrectangle" && (r.width() < Ll || r.height() < Ll))
    return (
      Il ||
        (Ve("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), (Il = !0)),
      "rectangle"
    );
  if (r.isParent())
    return t === "rectangle" ||
    ...
    if (!this.destroyed) {
      ...
      for (var i = 0; i < r.length; i++) {
        var s = r[i],
          o = s._private,
          l = o.rstyle;
        (s.isEdge() && (!t(s.source()) || !t(s.target())) && (l.clean = !1),
          s.isEdge() &&
            s.isBundledBezier() &&
            s.parallelEdges().some(function (b) {
              return !b._private.rstyle.clean && b.isBundledBezier();
            }) &&
            (l.clean = !1),
          !((e && l.clean) || s.removed()) &&
            s.pstyle("display").value !== "none" &&
            (o.group === "nodes" ? n.push(s) : a.push(s), (l.clean = !0)));
      }
      for (var u = 0; u < n.length; u++) {
        var v = n[u],
          f = v._private,
...
Yn.getCachedZSortedEles = function (r) {
  if (r || !this.cachedZSortedEles) {
    ...
    (e.sort(ef),
      (e.interactive = e.filter(function (t) {
...
var xf = {};
[Mt, Bn, yr, Ga, yo, Gr, wf, Xn, Yn].forEach(function (r) {
  be(xf, r);
});
var Ef = {};
Ef.getCachedImage = function (r, e, t) {
  var a = this,
    n = (a.imageCache = a.imageCache || {}),
    i = n[r];
  ...
  var o = "data:",
    l = r.substring(0, o.length).toLowerCase() === o;
...
ia.binder = function (r) {
  var e = this,
    t = e.cy.window(),
    a = r === t || r === t.document || r === t.document.body || hc(r);
  ...
  var s = function (l, u, v) {
    ...
    return (
      a && e.supportsPassiveEvents && (f[2] = { capture: v ?? !1, passive: !1, once: !1 }),
...
ia.load = function () {
  var r = this,
    ...
    a = function (S) {
      var _ = S.getRootNode();
      if (_ && _.nodeType === 11 && _.host !== void 0) return _;
    },
    n = function (S, _, W, $) {
      S == null && (S = r.cy);
      for (var Z = 0; Z < _.length; Z++) {
        var oe = _[Z];
        S.emit({ originalEvent: W, type: oe, position: $ });
      }
    },
    i = function (S) {
    ...
    h = function (S, _) {
      var W = _.addToList,
        $ = W.has(S);
      !$ && S.grabbable() && !S.locked() && (W.merge(S), o(S));
    },
    d = function (S, _) {
      if (S.cy().hasCompoundNodes() && !(_.inDragLayer == null && _.addToList == null)) {
        var W = S.descendants();
        (_.inDragLayer && (W.forEach(u), W.connectedEdges().forEach(u)), _.addToList && h(W, _));
      }
    },
    y = function (S, _) {
      _ = _ || {};
      var W = S.cy().hasCompoundNodes();
      (_.inDragLayer &&
        (S.forEach(u),
        S.neighborhood()
          .stdFilter(function ($) {
    ...
    m = function (S, _) {
      if (!(_.inDragLayer == null && _.addToList == null) && S.cy().hasCompoundNodes()) {
        var W = S.ancestors().orphans();
        if (!W.same(S)) {
          var $ = W.descendants().spawnSelf().merge(W).unmerge(S).unmerge(S.descendants()),
            Z = $.connectedEdges();
          (_.inDragLayer && (Z.forEach(u), $.forEach(u)),
            _.addToList &&
              $.forEach(function (oe) {
                h(oe, _);
              }));
    ...
    w = typeof MutationObserver < "u",
    E = typeof ResizeObserver < "u";
  w
    ? ((r.removeObserver = new MutationObserver(function (X) {
      ...
      r.container.parentNode && r.removeObserver.observe(r.container.parentNode, { childList: !0 }))
    : r.registerBinding(r.container, "DOMNodeRemoved", function (X) {
        r.destroy();
      });
  var C = Fa(function () {
    r.cy.resize();
  }, 100);
  (w && ((r.styleObserver = new MutationObserver(C)), r.styleObserver.observe(r.container, { attributes: !0 })),
    r.registerBinding(e, "resize", C),
    E && ((r.resizeObserver = new ResizeObserver(C)), r.resizeObserver.observe(r.container)));
  var x = function (S, _) {
      for (; S != null; ) (_(S), (S = S.parentNode));
    },
    T = function () {
  ...
  (x(r.container, function (X) {
    ...
    r.registerBinding(r.container, "contextmenu", function (X) {
      X.preventDefault();
    }));
  var k = function () {
    ...
    D = function (S) {
      for (
        ...
        var me = ee[le];
        if (W <= me.clientX && me.clientX <= W + Z && $ <= me.clientY && me.clientY <= $ + oe) {
          ve = !0;
          break;
        }
      }
      if (!ve) return !1;
      for (var De = r.container, Te = S.target, fe = Te.parentNode, Pe = !1; fe; ) {
        if (fe === De) {
          Pe = !0;
          break;
        }
  ...
  r.registerBinding(
    ...
    "mousedown",
    function (S) {
      if (D(S) && !(r.hoverData.which === 1 && S.which !== 1)) {
        (S.preventDefault(), b(), (r.hoverData.capture = !0), (r.hoverData.which = S.which));
        var _ = r.cy,
          W = [S.clientX, S.clientY],
          $ = r.projectIntoViewport(W[0], W[1]),
          Z = r.selection,
          oe = r.findNearestElements($[0], $[1], !0, !1),
          ee = oe[0],
          ve = r.dragData.possibleDragElements;
        ((r.hoverData.mdownPos = $), (r.hoverData.mdownGPos = W));
        var le = function (Be) {
            return { originalEvent: S, type: Be, position: { x: $[0], y: $[1] } };
          },
          me = function () {
            ((r.hoverData.tapholdCancelled = !1),
              clearTimeout(r.hoverData.tapholdTimeout),
              (r.hoverData.tapholdTimeout = setTimeout(function () {
                if (!r.hoverData.tapholdCancelled) {
                  var Be = r.hoverData.down;
                  Be ? Be.emit(le("taphold")) : _.emit(le("taphold"));
                }
              }, r.tapholdDuration)));
          };
        if (S.which == 3) {
          r.hoverData.cxtStarted = !0;
          var De = { originalEvent: S, type: "cxttapstart", position: { x: $[0], y: $[1] } };
          (ee ? (ee.activate(), ee.emit(De), (r.hoverData.down = ee)) : _.emit(De),
            (r.hoverData.downTime = new Date().getTime()),
            (r.hoverData.cxtDragged = !1));
        } else if (S.which == 1) {
          ee && ee.activate();
          {
            if (ee != null && r.nodeIsGrabbable(ee)) {
              ...
              if ((f(ee), !ee.selected()))
                ...
                (y(fe, { addToList: ve }), ee.emit(le("grabon")), fe.forEach(Te));
              }
              (r.redrawHint("eles", !0), r.redrawHint("drag", !0));
            }
            ((r.hoverData.down = ee), (r.hoverData.downs = oe), (r.hoverData.downTime = new Date().getTime()));
          }
          (n(ee, ["mousedown", "tapstart", "vmousedown"], S, { x: $[0], y: $[1] }),
            ee == null
              ? ((Z[4] = 1), (r.data.bgActivePosistion = { x: $[0], y: $[1] }), r.redrawHint("select", !0), r.redraw())
              : ee.pannable() && (Z[4] = 1),
            me());
        }
        ((Z[0] = Z[2] = $[0]), (Z[1] = Z[3] = $[1]));
    ...
    function (S) {
      ...
      if (!(!_ && !D(S))) {
        var W = !1,
          $ = r.cy,
          Z = $.zoom(),
          oe = [S.clientX, S.clientY],
          ee = r.projectIntoViewport(oe[0], oe[1]),
          ve = r.hoverData.mdownPos,
          le = r.hoverData.mdownGPos,
          me = r.selection,
          De = null;
        !r.hoverData.draggingEles &&
          !r.hoverData.dragging &&
          !r.hoverData.selecting &&
          (De = r.findNearestElement(ee[0], ee[1], !0, !1));
        var Te = r.hoverData.last,
          fe = r.hoverData.down,
          Pe = [ee[0] - me[2], ee[1] - me[3]],
          Be = r.dragData.possibleDragElements,
          je;
        if (le) {
          var Ke = oe[0] - le[0],
            mr = Ke * Ke,
        ...
        var jr = function () {
          ...
          Br.length === 0 ? (Br.push(Pe[0]), Br.push(Pe[1])) : ((Br[0] += Pe[0]), (Br[1] += Pe[1]));
        };
        ((W = !0), n(De, ["mousemove", "vmousemove", "tapdrag"], S, { x: ee[0], y: ee[1] }));
        var Ze = function (Br) {
            return { originalEvent: S, type: Br, position: { x: ee[0], y: ee[1] } };
          },
          Wr = function () {
            ((r.data.bgActivePosistion = void 0),
              r.hoverData.selecting || $.emit(Ze("boxstart")),
              (me[4] = 1),
              (r.hoverData.selecting = !0),
              r.redrawHint("select", !0),
              r.redraw());
          };
        if (r.hoverData.which === 3) {
          if (je) {
            var $r = Ze("cxtdrag");
            (fe ? fe.emit($r) : $.emit($r),
              (r.hoverData.cxtDragged = !0),
              (!r.hoverData.cxtOver || De !== r.hoverData.cxtOver) &&
          ...
          if (((W = !0), $.panningEnabled() && $.userPanningEnabled())) {
            ...
            if (r.hoverData.justStartedPan) {
              ...
              ((It = { x: (ee[0] - $a[0]) * Z, y: (ee[1] - $a[1]) * Z }), (r.hoverData.justStartedPan = !1));
            } else It = { x: Pe[0] * Z, y: Pe[1] * Z };
            ($.panBy(It), $.emit(Ze("dragpan")), (r.hoverData.dragged = !0));
          }
          ...
          if (
            ...
            if (je) {
              if ($.boxSelectionEnabled() && lr)
                ...
                (Er && r.redrawHint("eles", !0),
                  (r.dragData.didDrag = !0),
                  r.hoverData.draggingEles || y(Be, { inDragLayer: !0 }));
                var hr = { x: 0, y: 0 };
                if (ae(Pe[0]) && ae(Pe[1]) && ((hr.x += Pe[0]), (hr.y += Pe[1]), Er)) {
                  var Cr = r.hoverData.dragDelta;
                  Cr && ae(Cr[0]) && ae(Cr[1]) && ((hr.x += Cr[0]), (hr.y += Cr[1]));
                }
                ((r.hoverData.draggingEles = !0),
    ...
    function (S) {
      if (!(r.hoverData.which === 1 && S.which !== 1 && r.hoverData.capture)) {
        ...
        if (_) {
          ...
          var W = r.cy,
            $ = r.projectIntoViewport(S.clientX, S.clientY),
            Z = r.selection,
            oe = r.findNearestElement($[0], $[1], !0, !1),
            ee = r.dragData.possibleDragElements,
            ve = r.hoverData.down,
            le = i(S);
          (r.data.bgActivePosistion && (r.redrawHint("select", !0), r.redraw()),
            (r.hoverData.tapholdCancelled = !0),
            (r.data.bgActivePosistion = void 0),
            ve && ve.unactivate());
          var me = function (Ke) {
            return { originalEvent: S, type: Ke, position: { x: $[0], y: $[1] } };
          };
          if (r.hoverData.which === 3) {
            var De = me("cxttapend");
            if ((ve ? ve.emit(De) : W.emit(De), !r.hoverData.cxtDragged)) {
              var Te = me("cxttap");
              ve ? ve.emit(Te) : W.emit(Te);
            }
            ...
            if (
              ...
              !r.dragData.didDrag &&
                ...
                (A = !1),
                S.timeStamp - R <= W.multiClickDebounceTime()
                  ? (P && clearTimeout(P),
                    (A = !0),
                    (R = null),
                    n(ve, ["dblclick", "dbltap", "vdblclick"], S, { x: $[0], y: $[1] }))
                  : ((P = setTimeout(function () {
                      A || n(ve, ["oneclick", "onetap", "voneclick"], S, { x: $[0], y: $[1] });
                    }, W.multiClickDebounceTime())),
                    (R = S.timeStamp))),
              ve == null &&
                !r.dragData.didDrag &&
                !r.hoverData.selecting &&
                ...
                ee.length > 0 && r.redrawHint("eles", !0),
                (r.dragData.possibleDragElements = ee = W.collection())),
              oe == ve &&
                !r.dragData.didDrag &&
                !r.hoverData.selecting &&
                oe != null &&
                oe._private.selectable &&
                (r.hoverData.dragging ||
                  (W.selectionType() === "additive" || le
                    ? oe.selected()
                      ? oe.unselect(["tapunselect"])
                      : oe.select(["tapselect"])
                    : le || (W.$(t).unmerge(oe).unselect(["tapunselect"]), oe.select(["tapselect"]))),
                r.redrawHint("eles", !0)),
              r.hoverData.selecting)
            ) {
              ...
              (W.selectionType() === "additive" || le || W.$(t).unmerge(fe).unselect(),
                fe.emit(me("box")).stdFilter(Pe).select().emit(me("boxselect")),
                r.redraw());
            }
            if (
              (r.hoverData.dragging &&
                ((r.hoverData.dragging = !1), r.redrawHint("select", !0), r.redrawHint("eles", !0), r.redraw()),
              !Z[4])
            ) {
          ...
          ((Z[4] = 0),
            ...
            (r.hoverData.cxtStarted = !1),
            (r.hoverData.draggingEles = !1),
            (r.hoverData.selecting = !1),
            (r.hoverData.isOverThresholdDrag = !1),
            (r.dragData.didDrag = !1),
            (r.hoverData.dragged = !1),
  ...
  var L = [],
    ...
    O = 1e5,
    V = function (S, _) {
      for (var W = 0; W < S.length; W++) if (S[W] % _ !== 0) return !1;
      return !0;
    },
    G = function (S) {
      for (var _ = Math.abs(S[0]), W = 1; W < S.length; W++) if (Math.abs(S[W]) !== _) return !1;
      return !0;
    },
    N = function (S) {
      var _ = !1,
      ...
      if (
        (W == null &&
          (S.wheelDeltaY != null ? (W = S.wheelDeltaY / 4) : S.wheelDelta != null && (W = S.wheelDelta / 4)),
        W !== 0)
      ) {
        if (M == null)
          if (L.length >= I) {
            ...
            if (M) for (var oe = 0; oe < $.length; oe++) O = Math.min(Math.abs($[oe]), O);
          } else (L.push(W), (_ = !0));
        else M && (O = Math.min(Math.abs(W), O));
        if (!r.scrollingPage) {
          var ee = r.cy,
            ve = ee.zoom(),
            le = ee.pan(),
            me = r.projectIntoViewport(S.clientX, S.clientY),
            De = [me[0] * ve + le.x, me[1] * ve + le.y];
          if (r.hoverData.draggingEles || r.hoverData.dragging || r.hoverData.cxtStarted || k()) {
            S.preventDefault();
            return;
          }
          if (ee.panningEnabled() && ee.userPanningEnabled() && ee.zoomingEnabled() && ee.userZoomingEnabled()) {
            (S.preventDefault(),
              (r.data.wheelZooming = !0),
              clearTimeout(r.data.wheelTimeout),
              (r.data.wheelTimeout = setTimeout(function () {
                ((r.data.wheelZooming = !1), r.redrawHint("eles", !0), r.redraw());
              }, 150)));
            var Te;
            (_ && Math.abs(W) > 5 && (W = to(W) * 5),
              (Te = W / -250),
              M && ((Te /= O), (Te *= 3)),
            ...
            (S.type === "gesturechange" && (Pe = r.gestureStartZoom * S.scale),
  ...
  (r.registerBinding(r.container, "wheel", N, !0),
    r.registerBinding(
      e,
      "scroll",
      function (S) {
    ...
    r.registerBinding(
      ...
      "mouseout",
      function (S) {
        var _ = r.projectIntoViewport(S.clientX, S.clientY);
        r.cy.emit({ originalEvent: S, type: "mouseout", position: { x: _[0], y: _[1] } });
      },
      !1
    ),
    r.registerBinding(
      ...
      function (S) {
        var _ = r.projectIntoViewport(S.clientX, S.clientY);
        r.cy.emit({ originalEvent: S, type: "mouseover", position: { x: _[0], y: _[1] } });
      },
      !1
    ));
  var F,
  ...
  r.registerBinding(
    ...
    (Ce = function (S) {
      if (((r.hasTouchStarted = !0), !!D(S))) {
        ...
        var oe = function (lr) {
          return { originalEvent: S, type: lr, position: { x: W[0], y: W[1] } };
        };
        if (S.touches[1]) {
          ...
          ((z = ee[0]),
            ...
            (te = 0 <= F && F <= H && 0 <= Q && Q <= H && 0 <= U && U <= Y && 0 <= K && K <= Y));
          var ve = _.pan(),
            le = _.zoom();
          ((j = ce(F, U, Q, K)),
            (re = Ae(F, U, Q, K)),
          ...
          if (re < De && !S.touches[2]) {
            var Te = r.findNearestElement(W[0], W[1], !0, !0),
              fe = r.findNearestElement(W[2], W[3], !0, !0);
            (Te && Te.isNode()
              ? (Te.activate().emit(oe("cxttapstart")), (r.touchData.start = Te))
              : fe && fe.isNode()
                ? (fe.activate().emit(oe("cxttapstart")), (r.touchData.start = fe))
                : _.emit(oe("cxttapstart")),
              r.touchData.start && (r.touchData.start._private.grabbed = !1),
              (r.touchData.cxt = !0),
              (r.touchData.cxtDragged = !1),
              (r.data.bgActivePosistion = void 0),
              r.redraw());
            return;
          }
        }
        if (S.touches[2]) _.boxSelectionEnabled() && S.preventDefault();
        else if (!S.touches[1]) {
          if (S.touches[0]) {
            var Pe = r.findNearestElements(W[0], W[1], !0, !0),
              Be = Pe[0];
            if (
              Be != null &&
              (Be.activate(), (r.touchData.start = Be), (r.touchData.starts = Pe), r.nodeIsGrabbable(Be))
            ) {
              ...
              (r.redrawHint("eles", !0),
                ...
                Be.selected()
                  ? ((Ke = _.$(function (er) {
                      return er.selected() && r.nodeIsGrabbable(er);
                    })),
                    y(Ke, { addToList: je }))
                  : g(Be, { addToList: je }),
                f(Be),
                Be.emit(oe("grabon")),
                Ke
                  ? Ke.forEach(function (er) {
                      er.emit(oe("grab"));
                    })
                  : Be.emit(oe("grab")));
            }
            (n(Be, ["touchstart", "tapstart", "vmousedown"], S, { x: W[0], y: W[1] }),
              Be == null && ((r.data.bgActivePosistion = { x: Z[0], y: Z[1] }), r.redrawHint("select", !0), r.redraw()),
              (r.touchData.singleTouchMoved = !1),
  ...
  r.registerBinding(
    ...
    (we = function (S) {
      ...
      if (!(!_ && !D(S))) {
        ...
        var le = function (jf) {
            return { originalEvent: S, type: jf, position: { x: Z[0], y: Z[1] } };
          },
          me = r.touchData.startGPosition,
          De;
        if (_ && S.touches[0] && me) {
          for (var Te = [], fe = 0; fe < Z.length; fe++) Te[fe] = Z[fe] - oe[fe];
          var Pe = S.touches[0].clientX - me[0],
            Be = Pe * Pe,
            je = S.touches[0].clientY - me[1],
            Ke = je * je,
            mr = Be + Ke;
        ...
        if (_ && r.touchData.cxt) {
          ...
          var Ye = S.touches[0].clientX - z,
            ir = S.touches[0].clientY - q,
            er = S.touches[1].clientX - z,
            lr = S.touches[1].clientY - q,
            jr = Ae(Ye, ir, er, lr),
            Ze = jr / re,
            Wr = 150,
            $r = Wr * Wr,
          ...
          if (Ze >= $a || jr >= $r) {
            ...
            var bt = le("cxttapend");
            r.touchData.start ? (r.touchData.start.unactivate().emit(bt), (r.touchData.start = null)) : $.emit(bt);
          }
        }
        if (_ && r.touchData.cxt) {
          var bt = le("cxtdrag");
          ((r.data.bgActivePosistion = void 0),
            r.redrawHint("select", !0),
            r.touchData.start ? r.touchData.start.emit(bt) : $.emit(bt),
            r.touchData.start && (r.touchData.start._private.grabbed = !1),
            (r.touchData.cxtDragged = !0));
          var Er = r.findNearestElement(Z[0], Z[1], !0, !0);
          (!r.touchData.cxtOver || Er !== r.touchData.cxtOver) &&
          ...
          (S.preventDefault(),
            ...
            r.touchData.selecting || $.emit(le("boxstart")),
            (r.touchData.selecting = !0),
            (r.touchData.didSelect = !0),
            (W[4] = 1),
            !W || W.length === 0 || W[0] === void 0
              ? ((W[0] = (Z[0] + Z[2] + Z[4]) / 3),
                (W[1] = (Z[1] + Z[3] + Z[5]) / 3),
                (W[2] = (Z[0] + Z[2] + Z[4]) / 3 + 1),
                (W[3] = (Z[1] + Z[3] + Z[5]) / 3 + 1))
              : ((W[2] = (Z[0] + Z[2] + Z[4]) / 3), (W[3] = (Z[1] + Z[3] + Z[5]) / 3)),
            r.redrawHint("select", !0),
            r.redraw());
        else if (
          _ &&
          ...
          if (te) {
            var $f = Ye - F,
              ...
              xo = J[0] * ua + Ua.x,
              Eo = J[1] * ua + Ua.y,
              Qf = { x: (-Zn / ua) * (xo - Ua.x - Yf) + xo, y: (-Zn / ua) * (Eo - Ua.y - Zf) + Eo };
            if (Br && Br.active()) {
              var hr = r.dragData.touchDragEles;
              (p(hr),
                r.redrawHint("drag", !0),
                ...
                hr.emit(le("free")),
                r.dragData.didDrag && (Br.emit(le("dragfreeon")), hr.emit(le("dragfree"))));
            }
            ($.viewport({ zoom: Zn, pan: Qf, cancelOnFailedZoom: !0 }),
              $.emit(le("pinchzoom")),
              (j = wo),
              (F = Ye),
              (U = ir),
          ...
          var Mr = r.touchData.start,
            ...
            Er;
          if (
            (!r.hoverData.draggingEles && !r.swipePanning && (Er = r.findNearestElement(Z[0], Z[1], !0, !0)),
            _ && Mr != null && S.preventDefault(),
            _ && Mr != null && r.nodeIsDraggable(Mr))
          )
            if (De) {
              var hr = r.dragData.touchDragEles,
                Co = !r.dragData.didDrag;
              (Co && y(hr, { inDragLayer: !0 }), (r.dragData.didDrag = !0));
              var la = { x: 0, y: 0 };
              if (ae(Te[0]) && ae(Te[1]) && ((la.x += Te[0]), (la.y += Te[1]), Co)) {
                r.redrawHint("eles", !0);
                var Lr = r.touchData.dragDelta;
                Lr && ae(Lr[0]) && ae(Lr[1]) && ((la.x += Lr[0]), (la.y += Lr[1]));
              }
              ((r.hoverData.draggingEles = !0),
                hr.silentShift(la).emit(le("position")).emit(le("drag")),
                r.redrawHint("drag", !0),
                r.touchData.startPosition[0] == oe[0] &&
                  r.touchData.startPosition[1] == oe[1] &&
                  r.redrawHint("eles", !0),
                r.redraw());
            } else {
              var Lr = (r.touchData.dragDelta = r.touchData.dragDelta || []);
              Lr.length === 0 ? (Lr.push(Te[0]), Lr.push(Te[1])) : ((Lr[0] += Te[0]), (Lr[1] += Te[1]));
            }
          if (
            (n(Mr || Er, ["touchmove", "tapdrag", "vmousemove"], S, { x: Z[0], y: Z[1] }),
            (!Mr || !Mr.grabbed()) && Er != Qn && (Qn && Qn.emit(le("tapdragout")), Er && Er.emit(le("tapdragover"))),
            (r.touchData.last = Er),
            _)
          )
            for (var Cr = 0; Cr < Z.length; Cr++)
              Z[Cr] && r.touchData.startPosition[Cr] && De && (r.touchData.singleTouchMoved = !0);
          if (_ && (Mr == null || Mr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
            ...
            Jf &&
              ...
              r.swipePanning
                ? ($.panBy({ x: Te[0] * ee, y: Te[1] * ee }), $.emit(le("dragpan")))
                : De &&
                  ((r.swipePanning = !0),
                  $.panBy({ x: Pe * ee, y: je * ee }),
                  $.emit(le("dragpan")),
                  Mr && (Mr.unactivate(), r.redrawHint("select", !0), (r.touchData.start = null))));
            var ve = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
            ((Z[0] = ve[0]), (Z[1] = ve[1]));
          }
        }
        for (var fe = 0; fe < Z.length; fe++) oe[fe] = Z[fe];
        _ &&
          S.touches.length > 0 &&
          !r.hoverData.draggingEles &&
          !r.swipePanning &&
          r.data.bgActivePosistion != null &&
          ((r.data.bgActivePosistion = void 0), r.redrawHint("select", !0), r.redraw());
      }
    }),
    !1
  );
  ...
  if (
    (r.registerBinding(
      ...
      (ie = function (S) {
        var _ = r.touchData.start,
          W = r.touchData.capture;
        if (W) (S.touches.length === 0 && (r.touchData.capture = !1), S.preventDefault());
        else return;
        var $ = r.selection;
        ...
        var me = function ($r) {
          return { originalEvent: S, type: $r, position: { x: ee[0], y: ee[1] } };
        };
        _ && _.unactivate();
        var De;
        if (r.touchData.cxt) {
          if (((De = me("cxttapend")), _ ? _.emit(De) : Z.emit(De), !r.touchData.cxtDragged)) {
            var Te = me("cxttap");
            _ ? _.emit(Te) : Z.emit(Te);
          }
          (r.touchData.start && (r.touchData.start._private.grabbed = !1),
            (r.touchData.cxt = !1),
        ...
        if (!S.touches[2] && Z.boxSelectionEnabled() && r.touchData.selecting) {
          ...
          var fe = Z.collection(r.getAllInBox($[0], $[1], $[2], $[3]));
          (($[0] = void 0),
            ($[1] = void 0),
            ($[2] = void 0),
            ($[3] = void 0),
          ...
          (fe.emit(me("box")).stdFilter(Pe).select().emit(me("boxselect")),
            fe.nonempty() && r.redrawHint("eles", !0),
            r.redraw());
        }
          ...
          if (!S.touches[0]) {
            if (!S.touches[0]) {
              ...
              if (_ != null) {
                ...
                var Ke = r.findNearestElement(ee[0], ee[1], !0, !0);
                n(Ke, ["touchend", "tapend", "vmouseup", "tapdragout"], S, { x: ee[0], y: ee[1] });
              }
              var mr = r.touchData.startPosition[0] - ee[0],
                Ye = mr * mr,
                ir = r.touchData.startPosition[1] - ee[1],
                er = ir * ir,
                lr = Ye + er,
                jr = lr * oe * oe;
              (r.touchData.singleTouchMoved ||
                (_ || Z.$(":selected").unselect(["tapunselect"]),
                n(_, ["tap", "vclick"], S, { x: ee[0], y: ee[1] }),
                (de = !1),
                S.timeStamp - Ee <= Z.multiClickDebounceTime()
                  ? (he && clearTimeout(he),
                    (de = !0),
                    (Ee = null),
                    n(_, ["dbltap", "vdblclick"], S, { x: ee[0], y: ee[1] }))
                  : ((he = setTimeout(function () {
                      de || n(_, ["onetap", "voneclick"], S, { x: ee[0], y: ee[1] });
                    }, Z.multiClickDebounceTime())),
                    (Ee = S.timeStamp))),
                _ != null &&
                  !r.dragData.didDrag &&
                  _._private.selectable &&
                  jr < r.touchTapThreshold2 &&
                  !r.pinching &&
                  (Z.selectionType() === "single"
                    ? (Z.$(t).unmerge(_).unselect(["tapunselect"]), _.select(["tapselect"]))
                    : _.selected()
                      ? _.unselect(["tapunselect"])
                      : _.select(["tapselect"]),
                  r.redrawHint("eles", !0)),
                (r.touchData.singleTouchMoved = !0));
            }
          }
        }
        for (var Ze = 0; Ze < ee.length; Ze++) ve[Ze] = ee[Ze];
        ((r.dragData.didDrag = !1),
          S.touches.length === 0 &&
            ((r.touchData.dragDelta = []),
            (r.touchData.startPosition = [null, null, null, null, null, null]),
            (r.touchData.startGPosition = null),
            (r.touchData.didSelect = !1)),
          S.touches.length < 2 &&
    ...
    var pe = [],
      ...
      Ne = function (S) {
        for (var _ = 0; _ < pe.length; _++) {
          var W = pe[_];
          if (W.event.pointerId === S.pointerId) {
            pe.splice(_, 1);
            return;
          }
        }
      ...
      ze = function (S) {
        var _ = pe.filter(function (W) {
          return W.event.pointerId === S.pointerId;
        })[0];
        ((_.event = S), (_.touch = Se(S)));
      },
      xe = function (S) {
        S.touches = pe.map(function (_) {
          return _.touch;
        });
      },
      ue = function (S) {
    ...
    (r.registerBinding(r.container, "pointerdown", function (X) {
      ue(X) || (X.preventDefault(), Oe(X), xe(X), Ce(X));
    }),
      ...
      r.registerBinding(r.container, "pointermove", function (X) {
        ue(X) || (X.preventDefault(), ze(X), xe(X), we(X));
      }));
  }
};
var Qr = {};
Qr.generatePolygon = function (r, e) {
  return (this.nodeShapes[r] = {
    ...
    miterBounds: function (a, n, i, s, o, l) {
      return Ad(this.points, a, n, i, s, o);
    },
  });
};
Qr.generateEllipse = function () {
  return (this.nodeShapes.ellipse = {
    ...
    intersectLine: function (e, t, a, n, i, s, o, l) {
      return Fd(i, s, e, t, a / 2 + o, n / 2 + o);
    },
    checkPoint: function (e, t, a, n, i, s, o, l) {
      return kt(e, t, n, i, s, o, a);
    },
  });
};
  ...
  return (this.nodeShapes[r] = {
    ...
    getOrCreateCorners: function (a, n, i, s, o, l, u) {
      ...
      var d,
        ...
        p,
        m = c.length;
      for (y = c[m - 1], d = 0; d < m; d++)
        ((g = c[d % m]), (p = c[(d + 1) % m]), (l[u][d] = po(y, g, p, o)), (y = g), (g = p));
      return l[u];
    },
    draw: function (a, n, i, s, o, l, u) {
      this.renderer.nodeShapeImpl(
        ...
        o,
        this.points,
        this.getOrCreateCorners(n, i, s, o, l, u, "drawCorners")
      );
    },
    intersectLine: function (a, n, i, s, o, l, u, v, f) {
      return qd(o, l, this.points, a, n, i, s, u, this.getOrCreateCorners(a, n, i, s, v, f, "corners"));
    },
    checkPoint: function (a, n, i, s, o, l, u, v, f) {
      return zd(a, n, this.points, l, u, s, o, this.getOrCreateCorners(l, u, s, o, v, f, "corners"));
    },
  });
};
  ...
  return (this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle =
    {
      ...
      intersectLine: function (e, t, a, n, i, s, o, l) {
        return wv(i, s, e, t, a, n, o, l);
      },
      checkPoint: function (e, t, a, n, i, s, o, l) {
        var u = n / 2,
          v = i / 2;
        ((l = l === "auto" ? vt(n, i) : l), (l = Math.min(u, v, l)));
        var f = l * 2;
        return !!(
          Zr(e, t, this.points, s, o, n, i - f, [0, -1], a) ||
          Zr(e, t, this.points, s, o, n - f, i, [0, -1], a) ||
          kt(e, t, f, f, s - u + l, o - v + l, a) ||
          kt(e, t, f, f, s + u - l, o - v + l, a) ||
          kt(e, t, f, f, s + u - l, o + v - l, a) ||
          kt(e, t, f, f, s - u + l, o + v - l, a)
        );
  ...
  return (this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle =
    {
      ...
      checkPoint: function (e, t, a, n, i, s, o, l) {
        ...
        if (
          Zr(e, t, this.points, s, o, n, i - 2 * u, [0, -1], a) ||
          Zr(e, t, this.points, s, o, n - 2 * u, i, [0, -1], a)
        )
          return !0;
  ...
  return (this.nodeShapes.barrel = {
    ...
    intersectLine: function (e, t, a, n, i, s, o, l) {
      var u = 0.15,
        v = 0.5,
        f = 0.85,
        c = this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, t),
        h = function (g) {
          var p = Kt({ x: g[0], y: g[1] }, { x: g[2], y: g[3] }, { x: g[4], y: g[5] }, u),
            m = Kt({ x: g[0], y: g[1] }, { x: g[2], y: g[3] }, { x: g[4], y: g[5] }, v),
            b = Kt({ x: g[0], y: g[1] }, { x: g[2], y: g[3] }, { x: g[4], y: g[5] }, f);
    ...
    generateBarrelBezierPts: function (e, t, a, n) {
      ...
      return (
        (y.topLeft.isTop = !0),
        (y.topRight.isTop = !0),
        (y.bottomLeft.isBottom = !0),
        (y.bottomRight.isBottom = !0),
        y
      );
    },
    checkPoint: function (e, t, a, n, i, s, o, l) {
      var u = As(n, i),
        ...
        f = u.widthOffset;
      if (
        Zr(e, t, this.points, s, o, n, i - 2 * v, [0, -1], a) ||
        Zr(e, t, this.points, s, o, n - 2 * f, i, [0, -1], a)
      )
        return !0;
      for (
        ...
        if (m != null) {
          var b = p[5],
            ...
            E = p[1],
            C = sr(b, w, E, m);
          if ((p.isTop && C <= t) || (p.isBottom && t <= C)) return !0;
        }
      }
      return !1;
    },
  ...
  return (this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle =
    {
      ...
      checkPoint: function (e, t, a, n, i, s, o, l) {
        ...
        var v = n / 2 + 2 * a,
          f = i / 2 + 2 * a,
          c = [s - v, o - f, s - v, o, s + v, o, s + v, o - f];
        return !!(
          Sr(e, t, c) ||
          kt(e, t, u, u, s + n / 2 - l, o + i / 2 - l, a) ||
          kt(e, t, u, u, s - n / 2 + l, o + i / 2 - l, a)
        );
      },
    });
...
Ha.redraw = function (r) {
  r = r || pv();
  var e = this;
  (e.averageRedrawTime === void 0 && (e.averageRedrawTime = 0),
    e.lastRedrawTime === void 0 && (e.lastRedrawTime = 0),
    e.lastDrawTime === void 0 && (e.lastDrawTime = 0),
    (e.requestedFrame = !0),
    (e.renderOptions = r));
};
      ...
      if (!r.destroyed) {
        if (!e.batching())
          if (r.requestedFrame && !r.skipFrame) {
            ...
            (r.averageRedrawTime === void 0 && (r.averageRedrawTime = s - i),
              r.redrawCount === void 0 && (r.redrawCount = 0),
              r.redrawCount++,
              r.redrawTotalTime === void 0 && (r.redrawTotalTime = 0));
            var o = s - i;
            ((r.redrawTotalTime += o),
              (r.lastRedrawTime = o),
...
sa.init = function (r) {
  ...
  if (a) {
    var n = a.document,
      i = n.head,
      s = "__________cytoscape_stylesheet",
      o = "__________cytoscape_container",
      l = n.getElementById(s) != null;
    ...
    var v = a.getComputedStyle(t),
      f = v.getPropertyValue("position");
    f === "static" && Ve("A Cytoscape container has style position:static and so can not use UI extensions properly");
  }
  ((e.selection = [void 0, void 0, void 0, void 0, 0]),
    (e.bezierProjPcts = [0.05, 0.225, 0.4, 0.5, 0.6, 0.775, 0.95]),
    (e.hoverData = {
      down: null,
      last: null,
      downTime: null,
...
sa.notify = function (r, e) {
  ...
  if (!this.destroyed) {
    ...
    ((r === "add" ||
      r === "remove" ||
      (r === "move" && a.hasCompoundNodes()) ||
      r === "load" ||
      r === "zorder" ||
      r === "mount") &&
      t.invalidateCachedZSortedEles(),
      r === "viewport" && t.redrawHint("select", !0),
      r === "gc" && t.redrawHint("gc", !0),
      (r === "load" || r === "resize" || r === "mount") &&
        (t.invalidateContainerClientCoordsCache(), t.matchCanvasSize(t.container)),
      t.redrawHint("eles", !0),
      t.redrawHint("drag", !0),
...
sa.destroy = function () {
  ...
  if (
    ...
    r.removeObserver && r.removeObserver.disconnect(),
    r.styleObserver && r.styleObserver.disconnect(),
...
[go, xf, Ef, ia, Qr, Ha].forEach(function (r) {
  be(sa, r);
});
var ws = 1e3 / 60,
  Tf = {
          ...
          var i = Fa(function () {
            ...
            s = function (u, v) {
              ...
              for (u || n.flushRenderedStyleQueue(); ; ) {
                ...
                if (h < ws) {
                  var w = ws - (u ? c : 0);
                  if (b >= e.deqFastCost * w) break;
                } else if (u) {
                  if (m >= e.deqCost * h || m >= e.deqAvgCost * c) break;
                } else if (b >= e.deqNoDrawCost * ws) break;
                var E = e.deq(a, g, y);
                if (E.length > 0) for (var C = 0; C < E.length; C++) d.push(E[C]);
                else break;
              }
              d.length > 0 && (e.onDeqd(a, d), !u && e.shouldRedraw(a, d, g, y) && i());
            },
            o = e.priority || js;
    ...
    return gt(r, [
      {
        key: "getIdsFor",
        value: function (t) {
          t == null && $e("Can not get id list for null key");
          var a = this.idsByKey,
            n = this.idsByKey.get(t);
  ...
  py = 100,
  yy = 1,
  Ut = { dequeue: "dequeue", downscale: "downscale", highQuality: "highQuality" },
  my = cr({
    getKey: null,
  ...
  ba = function (e, t) {
    ...
    var n = my(t);
    (be(a, n), (a.lookup = new ny(n.getKey, n.doesEleInvalidateKey)), a.setupDequeueing());
  },
  nr = ba.prototype;
nr.reasons = Ut;
...
nr.getRetiredTextureQueue = function (r) {
  var e = this,
    t = (e.eleImgCaches.retired = e.eleImgCaches.retired || {}),
    a = (t[r] = t[r] || []);
  return a;
};
...
nr.getElementKeyToQueue = function () {
  var r = this,
    e = (r.eleKeyToCacheQueue = r.eleKeyToCacheQueue || {});
  return e;
};
nr.getElement = function (r, e, t, a, n) {
  ...
  if (
    ...
    !r.visible() ||
    r.removed() ||
    (!i.allowEdgeTxrCaching && r.isEdge()) ||
    (!i.allowParentTxrCaching && r.isParent())
  )
    return null;
  if ((a == null && (a = Math.ceil(ro(o * t))), a < pn)) a = pn;
  else if (o >= Sf || a > Hs) return null;
  var u = Math.pow(2, a),
    v = e.h * u,
    f = e.w * u,
    c = s.eleTextBiggerThanMin(r, u);
  if (!this.isVisible(r, c)) return null;
  var h = l.get(r, a);
  if ((h && h.invalidated && ((h.invalidated = !1), (h.texture.invalidatedWidth -= h.width)), h)) return h;
  var d;
  if ((v <= Nl ? (d = Nl) : v <= nn ? (d = nn) : (d = Math.ceil(v / nn) * nn), v > uy || f > oy)) return null;
  ...
  var k = C && C.level === a + 1 ? C : null,
    D = function () {
      g.context.drawImage(k.texture.canvas, k.x, 0, k.width, k.height, g.usedWidth, 0, f, v);
    };
  if ((g.context.setTransform(1, 0, 0, 1, 0, 0), g.context.clearRect(g.usedWidth, 0, f, d), m(k))) D();
  else if (m(C))
    if (w) {
      for (var B = C.level; B > a; B--) k = i.getElement(r, e, t, B, Ut.downscale);
      D();
    } else return (i.queueElement(r, C.level - 1), C);
  else {
    var P;
    if (!b && !w && !E)
      for (var A = a - 1; A >= pn; A--) {
        var R = l.get(r, A);
        if (R) {
          P = R;
          break;
    ...
    if (m(P)) return (i.queueElement(r, a), P);
    (g.context.translate(g.usedWidth, 0),
      g.context.scale(u, u),
      this.drawElement(g.context, r, e, c, !1),
...
nr.checkTextureUtility = function (r) {
  r.invalidatedWidth >= ly * r.width && this.retireTexture(r);
};
nr.checkTextureFullness = function (r) {
  var e = this,
    t = e.getTextureQueue(r.height);
  r.usedWidth / r.width > vy && r.fullnessChecks >= fy ? lt(t, r) : r.fullnessChecks++;
};
nr.retireTexture = function (r) {
  var e = this,
    t = r.height,
    a = e.getTextureQueue(t),
    n = this.lookup;
  (lt(a, r), (r.retired = !0));
...
nr.queueElement = function (r, e) {
  var t = this,
    a = t.getElementQueue(),
    n = t.getElementKeyToQueue(),
    i = this.getKey(r),
    s = n[i];
  if (s) ((s.level = Math.max(s.level, e)), s.eles.merge(r), s.reqs++, a.updateItem(s));
  else {
...
nr.dequeue = function (r) {
  for (
    var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0;
    s < yy && t.size() > 0;
    s++
  ) {
    var o = t.pop(),
      l = o.key,
      u = o.eles[0],
      v = i.hasCache(u, o.level);
    if (((a[l] = null), v)) continue;
    n.push(o);
    var f = e.getBoundingBox(u);
    e.getElement(u, f, r, o.level, Ut.dequeue);
  }
  return n;
};
...
nr.offDequeue = function (r) {
  lt(this.onDequeues, r);
};
nr.setupDequeueing = Tf.setupDequeueing({
  deqRedrawThreshold: py,
  deqCost: cy,
  deqAvgCost: dy,
  deqNoDrawCost: hy,
  deqFastCost: gy,
  ...
  kf = function (e) {
    ...
    ((t.layersByLevel = {}),
      ...
      a.beforeRender(function (s, o) {
        o - t.lastInvalidationTime <= zl ? (t.skipping = !0) : (t.skipping = !1);
...
dr.makeLayer = function (r, e) {
  var t = Math.pow(2, e),
    a = Math.ceil(r.w * t),
    n = Math.ceil(r.h * t),
    i = this.renderer.makeOffscreenCanvas(a, n),
    s = {
      id: (Vl = ++Vl % Ay),
      bb: r,
      level: e,
...
dr.getLayers = function (r, e, t) {
  ...
  if (((a.firstGet = !1), t == null)) {
    if (((t = Math.ceil(ro(s * e))), t < xa)) t = xa;
    else if (s >= wy || t > Pn) return null;
  }
  ...
  var l = a.layersByLevel,
    ...
    v = (l[t] = l[t] || []),
    f,
    c = a.levelIsComplete(t, r),
    h,
    d = function () {
      var D = function (L) {
          if ((a.validateLayersElesOrdering(L, r), a.levelIsComplete(L, r))) return ((h = l[L]), !0);
        },
        B = function (L) {
          if (!h) for (var I = t + L; xa <= I && I <= Pn && !D(I); I += L);
        };
      (B(1), B(-1));
  ...
  var y = function () {
      if (!f) {
        f = wr();
        for (var D = 0; D < r.length; D++) Dd(f, r[D].boundingBox());
      }
      return f;
    },
    g = function (D) {
      ...
      var P = Math.ceil(f.w * u),
        A = Math.ceil(f.h * u);
      if (P > Fl || A > Fl) return null;
      var R = P * A;
      if (R > By) return null;
      var L = a.makeLayer(f, t);
      if (B != null) {
        var I = v.indexOf(B) + 1;
        v.splice(I, 0, L);
      } else (D.insert === void 0 || D.insert) && v.unshift(L);
      return L;
    };
  if (a.skipping && !o) return null;
  for (var p = null, m = r.length / by, b = !o, w = 0; w < r.length; w++) {
    var E = r[w],
      C = E._private.rscratch,
      x = (C.imgLayerCaches = C.imgLayerCaches || {}),
      T = x[t];
    if (T) {
      p = T;
      continue;
    }
    if ((!p || p.eles.length >= m || !bv(p.bb, E.boundingBox())) && ((p = g({ insert: !0, after: p })), !p))
      return null;
...
dr.drawEleInLayer = function (r, e, t, a) {
  ...
  o.w === 0 ||
    ...
    i.setImgSmoothing(s, !1),
    i.drawCachedElement(s, e, null, null, t, Py),
    i.setImgSmoothing(s, !0));
};
  ...
  for (var t = this, a = Ia(r[0]), n = 0; n < r.length; n++)
    for (
      var i = a ? null : r[n],
        ...
        l = (o.imgLayerCaches = o.imgLayerCaches || {}),
        u = xa;
      u <= Pn;
      u++
    ) {
...
dr.invalidateLayer = function (r) {
  if (((this.lastInvalidationTime = Yr()), !r.invalid)) {
    var e = r.level,
      t = r.eles,
      a = this.layersByLevel[e];
    (lt(a, r), (r.elesQueue = []), (r.invalid = !0), r.replacement && (r.replacement.invalid = !0));
...
dr.refineElementTextures = function (r) {
  ...
  e.updateElementsInLayers(r, function (a, n, i) {
    ...
    if ((s || ((s = a.replacement = e.makeLayer(a.bb, a.level)), (s.replaces = a), (s.eles = a.eles)), !s.reqs))
      for (var o = 0; o < s.eles.length; o++) e.queueLayer(s, s.eles[o]);
  });
};
...
dr.dequeue = function (r) {
  for (var e = this, t = e.layersQueue, a = [], n = 0; n < Dy && t.size() !== 0; ) {
    var i = t.peek();
    if (i.replacement) {
      t.pop();
      continue;
    ...
    (s && (e.drawEleInLayer(i, s, i.level, r), n++),
      a.length === 0 && a.push(!0),
      i.elesQueue.length === 0 && (t.pop(), (i.reqs = 0), i.replaces && e.applyLayerReplacement(i), e.requestRedraw()));
  }
  return a;
};
dr.applyLayerReplacement = function (r) {
  var e = this,
    t = e.layersByLevel[r.level],
    a = r.replaces,
    n = t.indexOf(a);
  if (!(n < 0 || a.invalid)) {
    t[n] = r;
    for (var i = 0; i < r.eles.length; i++) {
      var s = r.eles[i]._private,
        o = (s.imgLayerCaches = s.imgLayerCaches || {});
      o && (o[r.level] = r);
    }
    e.requestRedraw();
  }
...
dr.setupDequeueing = Tf.setupDequeueing({
    ...
    if (v != null) {
      ...
      if (c !== 0) {
        ...
        ((b = C.x),
          ...
          E || l.setImgSmoothing(r, !0));
        var x = t.getRotationOffset(e);
        ((p = x.x), (m = x.y));
      } else ((p = h), (m = d));
      var T;
      (f !== 1 && ((T = r.globalAlpha), (r.globalAlpha = T * f)),
        r.drawImage(v.texture.canvas, v.x, 0, v.width, v.height, p, m, y, g),
        f !== 1 && (r.globalAlpha = T),
        c !== 0 && (r.rotate(-c), r.translate(-b, -w), E || l.setImgSmoothing(r, !1)));
...
Hr.drawCachedElement = function (r, e, t, a, n, i) {
  var s = this,
    ...
    f = o.tlbTxrCache,
    c = e.boundingBox(),
    h = i === !0 ? l.reasons.highQuality : null;
  if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || ao(c, a))) {
    var d = e.isEdge(),
      y = e.element()._private.rscratch.badLine;
    (s.drawElementUnderlay(r, e),
      s.drawCachedElementPortion(r, e, l, t, n, h, Oy, Vy),
      (!d || !y) && s.drawCachedElementPortion(r, e, u, t, n, h, Ny, xs),
      d &&
        !y &&
        (s.drawCachedElementPortion(r, e, v, t, n, h, zy, xs), s.drawCachedElementPortion(r, e, f, t, n, h, Fy, xs)),
...
Hr.drawLayeredElements = function (r, e, t, a) {
  var n = this,
    i = n.data.lyrTxrCache.getLayers(e, t);
  if (i)
    for (var s = 0; s < i.length; s++) {
      var o = i[s],
        l = o.bb;
...
Jr.drawEdge = function (r, e, t) {
  var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
    ...
    i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0,
    s = this,
  ...
  if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
    ...
    var u = i ? e.pstyle("opacity").value : 1,
      v = i ? e.pstyle("line-opacity").value : 1,
      f = e.pstyle("curve-style").value,
      c = e.pstyle("line-style").value,
      h = e.pstyle("width").pfValue,
      d = e.pstyle("line-cap").value,
      y = e.pstyle("line-outline-width").value,
      g = e.pstyle("line-outline-color").value,
      p = u * v,
      m = u * v,
      b = function () {
        var L = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : p;
        f === "straight-triangle"
          ? (s.eleStrokeStyle(r, e, L), s.drawEdgeTrianglePath(e, r, o.allpts))
          : ((r.lineWidth = h),
            (r.lineCap = d),
      ...
      w = function () {
        var L = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : p;
        if (((r.lineWidth = h + y), (r.lineCap = d), y > 0)) s.colorStrokeStyle(r, g[0], g[1], g[2], L);
        else {
          r.lineCap = "butt";
          return;
        }
        f === "straight-triangle"
          ...
          : (s.drawEdgePath(e, r, o.allpts, c), (r.lineCap = "butt"));
      },
      E = function () {
    ...
    if (k) {
      var D = e.pstyle("ghost-offset-x").pfValue,
        B = e.pstyle("ghost-offset-y").pfValue,
        P = e.pstyle("ghost-opacity").value,
        A = p * P;
      (r.translate(D, B), b(A), x(A), r.translate(-D, -B));
    } else w();
    ...
    if (a.visible()) {
      ...
      if (n !== 0) {
        var i = this,
          ...
          l = a.pstyle("".concat(e, "-padding")).pfValue,
          u = 2 * l,
          v = a.pstyle("".concat(e, "-color")).value;
        ((t.lineWidth = u),
          o.edgeType === "self" && !s ? (t.lineCap = "butt") : (t.lineCap = "round"),
...
Jr.drawEdgeOverlay = Bf("overlay");
Jr.drawEdgeUnderlay = Bf("underlay");
Jr.drawEdgePath = function (r, e, t, a) {
  var n = r._private.rscratch,
    ...
    o = !1,
    l = this.usePaths(),
    u = r.pstyle("line-dash-pattern").pfValue,
    v = r.pstyle("line-dash-offset").pfValue;
  if (l) {
    var f = t.join("$"),
      c = n.pathCacheKey && n.pathCacheKey === f;
  ...
  if (!o && !n.badLine)
    switch ((e.beginPath && e.beginPath(), e.moveTo(t[0], t[1]), n.edgeType)) {
      ...
      case "compound":
      case "multibezier":
        for (var h = 2; h + 3 < t.length; h += 4) e.quadraticCurveTo(t[h], t[h + 1], t[h + 2], t[h + 3]);
        break;
      case "straight":
      case "haystack":
        for (var d = 2; d + 1 < t.length; d += 2) e.lineTo(t[d], t[d + 1]);
        break;
      case "segments":
        if (n.isRound) {
        ...
        } else for (var m = 2; m + 1 < t.length; m += 2) e.lineTo(t[m], t[m + 1]);
        break;
    }
...
Jr.drawArrowheads = function (r, e, t) {
  var a = e._private.rscratch,
    n = a.edgeType === "haystack";
  (n || this.drawArrowhead(r, e, "source", a.arrowStartX, a.arrowStartY, a.srcArrowAngle, t),
    ...
    n || this.drawArrowhead(r, e, "target", a.arrowEndX, a.arrowEndY, a.tgtArrowAngle, t));
};
Jr.drawArrowhead = function (r, e, t, a, n, i, s) {
  if (!(isNaN(a) || a == null || isNaN(n) || n == null || isNaN(i) || i == null)) {
    var o = this,
      l = e.pstyle(t + "-arrow-shape").value;
    if (l !== "none") {
      var u = e.pstyle(t + "-arrow-fill").value === "hollow" ? "both" : "filled",
        v = e.pstyle(t + "-arrow-fill").value,
        f = e.pstyle("width").pfValue,
        c = e.pstyle(t + "-arrow-width"),
        h = c.value === "match-line" ? f : c.pfValue;
      c.units === "%" && (h *= f);
...
Jr.drawArrowShape = function (r, e, t, a, n, i, s, o, l) {
  var u = this,
    v = this.usePaths() && n !== "triangle-cross",
    f = !1,
    c,
    h = e,
    d = { x: s, y: o },
    y = r.pstyle("arrow-scale").value,
    g = this.getArrowWidth(a, y),
    p = u.arrowShapes[n];
  if (v) {
    var m = (u.arrowPathCache = u.arrowPathCache || []),
      b = Dt(n),
      w = m[b];
    w != null ? ((c = e = w), (f = !0)) : ((c = e = new Path2D()), (m[b] = c));
  }
  (f ||
    ...
    (e = h),
    v && (e.translate(s, o), e.rotate(l), e.scale(g, g)),
    (t === "filled" || t === "both") && (v ? e.fill(c) : e.fill()),
    (t === "hollow" || t === "both") &&
      ((e.lineWidth = i / (v ? g : 1)), (e.lineJoin = "miter"), v ? e.stroke(c) : e.stroke()),
    v && (e.scale(1 / g, 1 / g), e.rotate(-l), e.translate(-s, -o)));
};
var mo = {};
...
mo.drawInscribedImage = function (r, e, t, a, n) {
  var i = this,
    ...
    l = s.y,
    u = t.cy().style(),
    v = u.getIndexedStyle.bind(u),
    f = v(t, "background-fit", "value", a),
    c = v(t, "background-repeat", "value", a),
    h = t.width(),
    d = t.height(),
    y = t.padding() * 2,
    g = h + (v(t, "background-width-relative-to", "value", a) === "inner" ? 0 : y),
    p = d + (v(t, "background-height-relative-to", "value", a) === "inner" ? 0 : y),
    m = t._private.rscratch,
    b = v(t, "background-clip", "value", a),
    w = b === "node",
    E = v(t, "background-image-opacity", "value", a) * n,
    C = v(t, "background-image-smoothing", "value", a),
    x = t.pstyle("corner-radius").value;
  x !== "auto" && (x = t.pstyle("corner-radius").pfValue);
  var T = e.width || e.cachedW,
    k = e.height || e.cachedH;
  (T == null || k == null) &&
  ...
  var D = T,
    B = k;
  if (
    (v(t, "background-width", "value", a) !== "auto" &&
      (v(t, "background-width", "units", a) === "%"
        ? (D = v(t, "background-width", "pfValue", a) * g)
        : (D = v(t, "background-width", "pfValue", a))),
    v(t, "background-height", "value", a) !== "auto" &&
      (v(t, "background-height", "units", a) === "%"
    ...
    var A = o - g / 2,
      R = v(t, "background-position-x", "units", a),
      L = v(t, "background-position-x", "pfValue", a);
    R === "%" ? (A += (g - D) * L) : (A += L);
    var I = v(t, "background-offset-x", "units", a),
      M = v(t, "background-offset-x", "pfValue", a);
    I === "%" ? (A += (g - D) * M) : (A += M);
    var O = l - p / 2,
      V = v(t, "background-position-y", "units", a),
      G = v(t, "background-position-y", "pfValue", a);
    V === "%" ? (O += (p - B) * G) : (O += G);
    var N = v(t, "background-offset-y", "units", a),
      F = v(t, "background-offset-y", "pfValue", a);
    (N === "%" ? (O += (p - B) * F) : (O += F), m.pathCache && ((A -= o), (O -= l), (o = 0), (l = 0)));
    var U = r.globalAlpha;
    r.globalAlpha = E;
    ...
    if (
      (C === "no" && Q
        ? (i.setImgSmoothing(r, !1), (K = !0))
        : C === "yes" && !Q && (i.setImgSmoothing(r, !0), (K = !0)),
      c === "no-repeat")
    )
      (w &&
        (r.save(),
    ...
    ((r.globalAlpha = U), K && i.setImgSmoothing(r, Q));
  }
};
var Lt = {};
Lt.eleTextBiggerThanMin = function (r, e) {
  if (!e) {
    var t = r.cy().zoom(),
  ...
  var i = r.pstyle("font-size").pfValue * e,
    s = r.pstyle("min-zoomed-font-size").pfValue;
  return !(i < s);
};
Lt.drawElementText = function (r, e, t, a, n) {
  ...
  if (e.isNode()) {
    ...
    var u = e.element()._private.rscratch.badLine,
      v = e.pstyle("label"),
      f = e.pstyle("source-label"),
      c = e.pstyle("target-label");
    if (u || ((!v || !v.value) && (!f || !f.value) && (!c || !c.value))) return;
    ((r.textAlign = "center"), (r.textBaseline = "bottom"));
  }
  var h = !t,
    d;
  (t && ((d = t), r.translate(-d.x1, -d.y1)),
    n == null
      ? (s.drawText(r, e, null, h, i),
        e.isEdge() && (s.drawText(r, e, "source", h, i), s.drawText(r, e, "target", h, i)))
      : s.drawText(r, e, n, h, i),
    t && r.translate(d.x1, d.y1));
};
Lt.getFontCache = function (r) {
  var e;
  this.fontCaches = this.fontCaches || [];
  for (var t = 0; t < this.fontCaches.length; t++) if (((e = this.fontCaches[t]), e.context === r)) return e;
  return ((e = { context: r }), this.fontCaches.push(e), e);
};
Lt.setupTextStyle = function (r, e) {
  var t = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0,
    a = e.pstyle("font-style").strValue,
    n = e.pstyle("font-size").pfValue + "px",
    i = e.pstyle("font-family").strValue,
    s = e.pstyle("font-weight").strValue,
    o = t ? e.effectiveOpacity() * e.pstyle("text-opacity").value : 1,
    l = e.pstyle("text-outline-opacity").value * o,
    u = e.pstyle("color").value,
    v = e.pstyle("text-outline-color").value;
  ((r.font = a + " " + s + " " + n + " " + i),
    (r.lineJoin = "round"),
...
Lt.drawText = function (r, e, t) {
  var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
    n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0,
    i = e._private,
    s = i.rscratch,
    o = n ? e.effectiveOpacity() : 1;
  if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
    ...
    var l = Tr(s, "labelX", t),
      ...
      v,
      f,
      c = this.getLabelText(e, t);
    if (c != null && c !== "" && !isNaN(l) && !isNaN(u)) {
      this.setupTextStyle(r, e, n);
      var h = t ? t + "-" : "",
        d = Tr(s, "labelWidth", t),
        y = Tr(s, "labelHeight", t),
        g = e.pstyle(h + "text-margin-x").pfValue,
        p = e.pstyle(h + "text-margin-y").pfValue,
        m = e.isEdge(),
        b = e.pstyle("text-halign").value,
        w = e.pstyle("text-valign").value;
      (m && ((b = "center"), (w = "center")), (l += g), (u += p));
      var E;
      switch (
        (a ? (E = this.getTextAngle(e, t)) : (E = 0),
        E !== 0 && ((v = l), (f = u), r.translate(v, f), r.rotate(E), (l = 0), (u = 0)),
        w)
      ) {
        case "top":
          break;
      ...
      var C = e.pstyle("text-background-opacity").value,
        x = e.pstyle("text-border-opacity").value,
        T = e.pstyle("text-border-width").pfValue,
        k = e.pstyle("text-background-padding").pfValue,
        D = e.pstyle("text-background-shape").strValue,
        B = D === "round-rectangle" || D === "roundrectangle",
        P = D === "circle",
        A = 2;
      if (C > 0 || (T > 0 && x > 0)) {
        var R = r.fillStyle,
          L = r.strokeStyle,
          I = r.lineWidth,
          M = e.pstyle("text-background-color").value,
          O = e.pstyle("text-border-color").value,
          V = e.pstyle("text-border-style").value,
          G = C > 0,
          N = T > 0 && x > 0,
          F = l - k;
        switch (b) {
        ...
        if (
          (B
            ? (r.beginPath(), Gl(r, F, U, Q, K, A))
            : P
              ? (r.beginPath(), qy(r, F, U, Q, K))
              : (r.beginPath(), r.rect(F, U, Q, K)),
          G && r.fill(),
          N && r.stroke(),
          N && V === "double")
        ) {
          var j = T / 2;
          (r.beginPath(),
            B ? Gl(r, F + j, U + j, Q - 2 * j, K - 2 * j, A) : r.rect(F + j, U + j, Q - 2 * j, K - 2 * j),
            r.stroke());
        }
        ((r.fillStyle = R), (r.strokeStyle = L), (r.lineWidth = I), r.setLineDash && r.setLineDash([]));
      }
      var re = 2 * e.pstyle("text-outline-width").pfValue;
      if ((re > 0 && (r.lineWidth = re), e.pstyle("text-wrap").value === "wrap")) {
        var ne = Tr(s, "labelWrapCachedLines", t),
          J = Tr(s, "labelLineHeight", t),
          z = d / 2,
          q = this.getLabelJustification(e);
        switch (
          (q === "auto" ||
            (b === "left"
              ? q === "left"
              ...
              : b === "center"
                ? q === "left"
                  ? (l += -z)
                  : q === "right" && (l += z)
                : b === "right" && (q === "center" ? (l += z) : q === "right" && (l += d))),
          w)
        ) {
          case "top":
            u -= (ne.length - 1) * J;
        ...
        for (var H = 0; H < ne.length; H++) (re > 0 && r.strokeText(ne[H], l, u), r.fillText(ne[H], l, u), (u += J));
      } else (re > 0 && r.strokeText(c, l, u), r.fillText(c, l, u));
      E !== 0 && (r.rotate(-E), r.translate(-v, -f));
    }
  }
};
var yt = {};
yt.drawNode = function (r, e, t) {
  var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
    n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0,
    i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0,
    s = this,
  ...
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    ...
    for (
      var m = e.pstyle("background-image"), b = m.value, w = new Array(b.length), E = new Array(b.length), C = 0, x = 0;
      x < b.length;
      x++
    ) {
      var T = b[x],
    ...
    var B = e.pstyle("background-blacken").value,
      P = e.pstyle("border-width").pfValue,
      A = e.pstyle("background-opacity").value * c,
      R = e.pstyle("border-color").value,
      L = e.pstyle("border-style").value,
      I = e.pstyle("border-join").value,
      M = e.pstyle("border-cap").value,
      O = e.pstyle("border-position").value,
      V = e.pstyle("border-dash-pattern").pfValue,
      G = e.pstyle("border-dash-offset").pfValue,
      N = e.pstyle("border-opacity").value * c,
      F = e.pstyle("outline-width").pfValue,
      U = e.pstyle("outline-color").value,
      Q = e.pstyle("outline-style").value,
      K = e.pstyle("outline-opacity").value * c,
      j = e.pstyle("outline-offset").value,
      re = e.pstyle("corner-radius").value;
    re !== "auto" && (re = e.pstyle("corner-radius").pfValue);
    var ne = function () {
        var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : A;
      ...
      z = function () {
        var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : K;
        s.colorStrokeStyle(r, U[0], U[1], U[2], ue);
      },
      q = function (ue, X, S, _) {
        var W = (s.nodePathCache = s.nodePathCache || []),
          $ = cv(S === "polygon" ? S + "," + _.join(",") : S, "" + X, "" + ue, "" + re),
          Z = W[$],
          oe,
          ee = !1;
        return (
          Z != null ? ((oe = Z), (ee = !0), (v.pathCache = oe)) : ((oe = new Path2D()), (W[$] = v.pathCache = oe)),
          { path: oe, cacheHit: ee }
        );
      },
      H = e.pstyle("shape").strValue,
      Y = e.pstyle("shape-polygon-points").pfValue;
    if (h) {
      r.translate(f.x, f.y);
      var te = q(o, l, H, Y);
      ((d = te.path), (y = te.cacheHit));
    }
    var ce = function () {
        if (!y) {
          var ue = f;
          (h && (ue = { x: 0, y: 0 }), s.nodeShapes[s.getNodeShape(e)].draw(d || r, ue.x, ue.y, o, l, re, v));
        }
        h ? r.fill(d) : r.fill();
      },
      Ae = function () {
        for (
          var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c,
            X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0,
            S = u.backgrounding,
            _ = 0,
            W = 0;
          W < E.length;
          ...
          w[W] && E[W].complete && !E[W].error && (_++, s.drawInscribedImage(r, E[W], e, W, ue));
        }
        ((u.backgrounding = _ !== C), S !== u.backgrounding && e.updateStyle(!1));
      },
      Ce = function () {
        var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1,
          X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
        s.hasPie(e) &&
          (s.drawPie(r, e, X), ue && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, l, re, v)));
      },
      we = function () {
        var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1,
          X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      ...
      ye = function () {
        var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c,
          X = (B > 0 ? B : -B) * ue,
          S = B > 0 ? 0 : 255;
        B !== 0 && (s.colorFillStyle(r, S, S, S, X), h ? r.fill(d) : r.fill());
      },
      ie = function () {
        if (P > 0) {
          if (((r.lineWidth = P), (r.lineCap = M), (r.lineJoin = I), r.setLineDash))
            switch (L) {
              case "dotted":
                r.setLineDash([1, 1]);
                break;
              case "dashed":
                (r.setLineDash(V), (r.lineDashOffset = G));
                break;
              case "solid":
              case "double":
                r.setLineDash([]);
          ...
          if (O !== "center") {
            if ((r.save(), (r.lineWidth *= 2), O === "inside")) h ? r.clip(d) : r.clip();
            else {
              var ue = new Path2D();
              (ue.rect(-o / 2 - P, -l / 2 - P, o + 2 * P, l + 2 * P), ue.addPath(d), r.clip(ue, "evenodd"));
            }
            (h ? r.stroke(d) : r.stroke(), r.restore());
          } else h ? r.stroke(d) : r.stroke();
          if (L === "double") {
            r.lineWidth = P / 3;
            var X = r.globalCompositeOperation;
            ((r.globalCompositeOperation = "destination-out"),
      ...
      de = function () {
        if (F > 0) {
          ...
          var _ = (o + S + (F + j)) / o,
            ...
            $ = o * _,
            Z = l * W,
            oe = s.nodeShapes[X].points,
            ee;
          if (h) {
            var ve = q($, Z, X, oe);
            ee = ve.path;
          }
          if (X === "ellipse") s.drawEllipsePath(ee || r, ue.x, ue.y, $, Z);
          else if (
            [
              "round-diamond",
              "round-heptagon",
            ...
            (X === "round-diamond"
              ? (le = (S + j + F) * 1.4)
              : X === "round-heptagon"
                ? ((le = (S + j + F) * 1.075), (De = -(S / 2 + j + F) / 35))
                : X === "round-hexagon"
                  ? (le = (S + j + F) * 1.12)
                  : X === "round-pentagon"
                    ? ((le = (S + j + F) * 1.13), (De = -(S / 2 + j + F) / 15))
                    : X === "round-tag"
                      ? ((le = (S + j + F) * 1.12), (me = (S / 2 + F + j) * 0.07))
                      : X === "round-triangle" &&
                        ((le = (S + j + F) * (Math.PI / 2)), (De = -(S + j / 2 + F) / Math.PI)),
              le !== 0 &&
                ((_ = (o + le) / o),
                ($ = o * _),
            ...
            for (
              var Te = $ / 2,
                fe = Z / 2,
                Pe = re + (S + F + j) / 2,
                Be = new Array(oe.length / 2),
                je = new Array(oe.length / 2),
                Ke = 0;
              Ke < oe.length / 2;
              Ke++
            )
            ...
            var mr,
              ...
              er,
              lr = Be.length;
            for (Ye = Be[lr - 1], mr = 0; mr < lr; mr++)
              ((ir = Be[mr % lr]), (er = Be[(mr + 1) % lr]), (je[mr] = po(Ye, ir, er, Pe)), (Ye = ir), (ir = er));
          ...
          else if (X === "barrel") s.drawBarrelPath(ee || r, ue.x, ue.y, $, Z);
          else if (X.startsWith("polygon") || ["rhomboid", "right-rhomboid", "round-tag", "tag", "vee"].includes(X)) {
            var jr = (S + F + j) / o;
            ((oe = En(Cn(oe, jr))), s.drawPolygonPath(ee || r, ue.x, ue.y, o, l, oe));
          } else {
            var Ze = (S + F + j) / o;
            ((oe = En(Cn(oe, -Ze))), s.drawPolygonPath(ee || r, ue.x, ue.y, o, l, oe));
          }
          if ((h ? r.stroke(ee) : r.stroke(), Q === "double")) {
            r.lineWidth = S / 3;
            var Wr = r.globalCompositeOperation;
            ((r.globalCompositeOperation = "destination-out"),
              h ? r.stroke(ee) : r.stroke(),
    ...
    if (Se) {
      var Re = e.pstyle("ghost-offset-x").pfValue,
        Oe = e.pstyle("ghost-offset-y").pfValue,
        Ne = e.pstyle("ghost-opacity").value,
        ze = Ne * c;
      (r.translate(Re, Oe),
        z(),
        de(),
...
var Pf = function (e) {
  ...
  return function (t, a, n, i, s) {
    var o = this;
    if (a.visible()) {
      var l = a.pstyle("".concat(e, "-padding")).pfValue,
        u = a.pstyle("".concat(e, "-opacity")).value,
        v = a.pstyle("".concat(e, "-color")).value,
        f = a.pstyle("".concat(e, "-shape")).value,
        c = a.pstyle("".concat(e, "-corner-radius")).value;
      if (u > 0) {
...
yt.drawNodeOverlay = Pf("overlay");
yt.drawNodeUnderlay = Pf("underlay");
yt.hasPie = function (r) {
...
yt.drawPie = function (r, e, t, a) {
  ...
  var n = e.cy().style(),
    i = e.pstyle("pie-size"),
    s = e.pstyle("pie-hole"),
    o = e.pstyle("pie-start-angle").pfValue,
    l = a.x,
    u = a.y,
    v = e.width(),
    f = e.height(),
  ...
  if (
    (y && ((l = 0), (u = 0)),
    i.units === "%" ? (c = c * i.pfValue) : i.pfValue !== void 0 && (c = i.pfValue / 2),
    s.units === "%" ? (h = c * s.pfValue) : s.pfValue !== void 0 && (h = s.pfValue / 2),
    !(h >= c))
  )
    for (var g = 1; g <= n.pieBackgroundN; g++) {
      var p = e.pstyle("pie-" + g + "-background-size").value,
        m = e.pstyle("pie-" + g + "-background-color").value,
        b = e.pstyle("pie-" + g + "-background-opacity").value * t,
        w = p / 100;
      w + d > 1 && (w = 1 - d);
      ...
      p === 0 ||
        ...
        d + w > 1 ||
        (h === 0
          ? (r.beginPath(), r.moveTo(l, u), r.arc(l, u, c, E, x), r.closePath())
          : (r.beginPath(), r.arc(l, u, c, E, x), r.arc(l, u, h, x, E, !0), r.closePath()),
...
yt.drawStripe = function (r, e, t, a) {
  ...
  var h = o,
    d = l;
  (c.units === "%"
    ? ((h = h * c.pfValue), (d = d * c.pfValue))
    : c.pfValue !== void 0 && ((h = c.pfValue), (d = c.pfValue)),
    v && ((i = 0), (s = 0)),
    (s -= h / 2),
    (i -= d / 2));
  for (var y = 1; y <= n.stripeBackgroundN; y++) {
    var g = e.pstyle("stripe-" + y + "-background-size").value,
      p = e.pstyle("stripe-" + y + "-background-color").value,
      m = e.pstyle("stripe-" + y + "-background-opacity").value * t,
      b = g / 100;
    (b + u > 1 && (b = 1 - u),
      !(g === 0 || u >= 1 || u + b > 1) &&
        (r.beginPath(),
...
xr.paintCache = function (r) {
  ...
  return (t && ((a = { context: r }), e.push(a)), a);
};
xr.createGradientStyleFor = function (r, e, t, a, n) {
  var i,
    s = this.usePaths(),
    o = t.pstyle(e + "-gradient-stop-colors").value,
    l = t.pstyle(e + "-gradient-stop-positions").pfValue;
  if (a === "radial-gradient")
    ...
    var b = s ? { x: 0, y: 0 } : t.position(),
      ...
      C = w / 2,
      x = E / 2,
      T = t.pstyle("background-gradient-direction").value;
    switch (T) {
      case "to-bottom":
  ...
  if (!i) return null;
  for (var k = l.length === o.length, D = o.length, B = 0; B < D; B++)
...
xr.matchCanvasSize = function (r) {
  var e = this,
    t = e.data,
    a = e.findContainerClientCoords(),
    n = a[2],
    i = a[3],
    s = e.getPixelRatio(),
    o = e.motionBlurPxRatio;
  (r === e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE] || r === e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG]) &&
    (s = o);
  var l = n * s,
    u = i * s,
    v;
...
xr.renderTo = function (r, e, t, a) {
  this.render({ forcedContext: r, forcedZoom: e, forcedPan: t, drawAllLayers: !0, forcedPxRatio: a });
};
...
xr.render = function (r) {
  ...
  var t = e.cy,
    a = r.forcedContext,
    n = r.drawAllLayers,
    i = r.drawOnlyNodeLayer,
    s = r.forcedZoom,
    o = r.forcedPan,
    l = r.forcedPxRatio === void 0 ? this.getPixelRatio() : r.forcedPxRatio,
    u = e.data,
    v = u.canvasNeedsRedraw,
    f = e.textureOnViewport && !a && (e.pinching || e.hoverData.dragging || e.swipePanning || e.data.wheelZooming),
    c = r.motionBlur !== void 0 ? r.motionBlur : e.motionBlur,
    h = e.motionBlurPxRatio,
    d = t.hasCompoundNodes(),
    y = e.hoverData.draggingEles,
    g = !!(e.hoverData.selecting || e.touchData.selecting);
  c = c && !a && e.motionBlurEnabled && !g;
  var p = c;
  (a ||
    (e.prevPxRatio !== l &&
      (e.invalidateContainerClientCoordsCache(),
      e.matchCanvasSize(e.container),
      e.redrawHint("eles", !0),
      e.redrawHint("drag", !0)),
    (e.prevPxRatio = l)),
    !a && e.motionBlurTimeout && clearTimeout(e.motionBlurTimeout),
    c &&
      (e.mbFrames == null && (e.mbFrames = 0),
      e.mbFrames++,
      e.mbFrames < 3 && (p = !1),
      e.mbFrames > e.minMbLowQualFrames && (e.motionBlurPxRatio = e.mbPxRBlurry)),
    e.clearingMotionBlur && (e.motionBlurPxRatio = 1),
    e.textureDrawLastFrame && !f && ((v[e.NODE] = !0), (v[e.SELECT_BOX] = !0)));
  var m = t.style(),
    b = t.zoom(),
    w = s !== void 0 ? s : b,
    E = t.pan(),
    C = { x: E.x, y: E.y },
    x = { zoom: b, pan: { x: E.x, y: E.y } },
    T = e.prevViewport,
    k = T === void 0 || x.zoom !== T.zoom || x.pan.x !== T.pan.x || x.pan.y !== T.pan.y;
  (!k && !(y && !d) && (e.motionBlurPxRatio = 1), o && (C = o), (w *= l), (C.x *= l), (C.y *= l));
  var D = e.getCachedZSortedEles();
  function B(J, z, q, H, Y) {
  ...
  function P(J, z) {
    ...
    (J === u.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] || J === u.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG])
      ? ((q = { x: E.x * h, y: E.y * h }), (H = b * h), (Y = e.canvasWidth * h), (te = e.canvasHeight * h))
      : ((q = C), (H = w), (Y = e.canvasWidth), (te = e.canvasHeight)),
      J.setTransform(1, 0, 0, 1, 0, 0),
      z === "motionBlur" ? B(J, 0, 0, Y, te) : !a && (z === void 0 || z) && J.clearRect(0, 0, Y, te),
      n || (J.translate(q.x, q.y), J.scale(H, H)),
      o && J.translate(o.x, o.y),
      s && J.scale(s, s));
  }
  if ((f || (e.textureDrawLastFrame = !1), f)) {
    if (((e.textureDrawLastFrame = !0), !e.textureCache)) {
      ...
      (A.setTransform(1, 0, 0, 1, 0, 0),
        ...
        e.render({ forcedContext: A, drawOnlyNodeLayer: !0, forcedPxRatio: l * e.textureMult }));
      ...
      x.mpan = { x: (0 - x.pan.x) / x.zoom, y: (0 - x.pan.y) / x.zoom };
    }
    ((v[e.DRAG] = !1), (v[e.NODE] = !1));
    var R = u.contexts[e.NODE],
      L = e.textureCache.texture,
      x = e.textureCache.viewport;
    (R.setTransform(1, 0, 0, 1, 0, 0), c ? B(R, 0, 0, x.width, x.height) : R.clearRect(0, 0, x.width, x.height));
    var I = m.core("outside-texture-bg-color").value,
      M = m.core("outside-texture-bg-opacity").value;
    (e.colorFillStyle(R, I[0], I[1], I[2], M), R.fillRect(0, 0, x.width, x.height));
    var b = t.zoom();
    (P(R, !1),
  ...
  var O = t.extent(),
    V =
      ...
      e.cy.animated(),
    G = e.hideEdgesOnViewport && V,
    N = [];
  if (
    ((N[e.NODE] = (!v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE]) || e.clearingMotionBlur),
    N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0),
    (N[e.DRAG] = (!v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG]) || e.clearingMotionBlur),
    N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0),
    v[e.NODE] || n || i || N[e.NODE])
  ) {
    var F = c && !N[e.NODE] && h !== 1,
      R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : u.contexts[e.NODE]),
      U = c && !F ? "motionBlur" : void 0;
    (P(R, U),
      G ? e.drawCachedNodes(R, D.nondrag, l, O) : e.drawLayeredElements(R, D.nondrag, l, O),
      e.debug && e.drawDebugPoints(R, D.nondrag),
      !n && !c && (v[e.NODE] = !1));
  }
  if (!i && (v[e.DRAG] || n || N[e.DRAG])) {
    var F = c && !N[e.DRAG] && h !== 1,
      R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : u.contexts[e.DRAG]);
    (P(R, c && !F ? "motionBlur" : void 0),
      G ? e.drawCachedNodes(R, D.drag, l, O) : e.drawCachedElements(R, D.drag, l, O),
      e.debug && e.drawDebugPoints(R, D.drag),
      !n && !c && (v[e.DRAG] = !1));
  }
  if ((this.drawSelectionRectangle(r, P), c && h !== 1)) {
    var Q = u.contexts[e.NODE],
      K = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE],
      j = u.contexts[e.DRAG],
      re = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG],
      ne = function (z, q, H) {
        (z.setTransform(1, 0, 0, 1, 0, 0),
          H || !p ? z.clearRect(0, 0, e.canvasWidth, e.canvasHeight) : B(z, 0, 0, e.canvasWidth, e.canvasHeight));
        var Y = h;
        z.drawImage(q, 0, 0, e.canvasWidth * Y, e.canvasHeight * Y, 0, 0, e.canvasWidth, e.canvasHeight);
      };
    ((v[e.NODE] || N[e.NODE]) && (ne(Q, K, N[e.NODE]), (v[e.NODE] = !1)),
      (v[e.DRAG] || N[e.DRAG]) && (ne(j, re, N[e.DRAG]), (v[e.DRAG] = !1)));
  }
  ((e.prevViewport = x),
    e.clearingMotionBlur && ((e.clearingMotionBlur = !1), (e.motionBlurCleared = !0), (e.motionBlur = !0)),
    c &&
      (e.motionBlurTimeout = setTimeout(function () {
        ((e.motionBlurTimeout = null),
          (e.clearedForMotionBlur[e.NODE] = !1),
          (e.clearedForMotionBlur[e.DRAG] = !1),
          (e.motionBlur = !1),
...
xr.drawSelectionRectangle = function (r, e) {
  ...
  if (t.showFps || (!s && l[t.SELECT_BOX] && !o)) {
    ...
    if ((e(v), t.selection[4] == 1 && (t.hoverData.selecting || t.touchData.selecting))) {
      var f = t.cy.zoom(),
        c = i.core("selection-box-border-width").value / f;
      ((v.lineWidth = c),
        (v.fillStyle =
          "rgba(" +
          i.core("selection-box-color").value[0] +
          "," +
          i.core("selection-box-color").value[1] +
          "," +
          i.core("selection-box-color").value[2] +
          "," +
          i.core("selection-box-opacity").value +
          ")"),
        v.fillRect(t.selection[0], t.selection[1], t.selection[2] - t.selection[0], t.selection[3] - t.selection[1]),
        c > 0 &&
          ((v.strokeStyle =
            "rgba(" +
            i.core("selection-box-border-color").value[0] +
            "," +
            i.core("selection-box-border-color").value[1] +
            "," +
            i.core("selection-box-border-color").value[2] +
            "," +
            i.core("selection-box-opacity").value +
            ")"),
          v.strokeRect(
            t.selection[0],
            t.selection[1],
            t.selection[2] - t.selection[0],
            t.selection[3] - t.selection[1]
          )));
    }
    if (n.bgActivePosistion && !t.hoverData.selecting) {
      var f = t.cy.zoom(),
        h = n.bgActivePosistion;
      ((v.fillStyle =
        "rgba(" +
        i.core("active-bg-color").value[0] +
        "," +
        i.core("active-bg-color").value[1] +
        "," +
        i.core("active-bg-color").value[2] +
        "," +
        i.core("active-bg-opacity").value +
        ")"),
        v.beginPath(),
    ...
    if (t.showFps && d) {
      d = Math.round(d);
      var y = Math.round(1e3 / d),
        g = "1 frame = " + d + " ms = " + y + " fps";
      if (
      ...
      v.fillText(g, 0, ha);
      var m = 60;
      (v.strokeRect(0, ha + 10, 250, 20), v.fillRect(0, ha + 10, 250 * Math.min(y / m, 1), 20));
    }
    o || (l[t.SELECT_BOX] = !1);
  }
};
...
function Uy(r, e) {
  return e.picking
    ? !0
    : r.pstyle("background-fill").value !== "solid" || r.pstyle("background-image").strValue !== "none"
      ? !1
      : r.pstyle("border-width").value === 0 || r.pstyle("border-opacity").value === 0
        ? !0
        : r.pstyle("border-style").value === "solid";
}
function Ky(r, e) {
...
function Qy(r, e, t, a) {
  ...
  return (
    ...
    o === r.FLOAT ? r.vertexAttribPointer(t, s, o, !1, 0, 0) : o === r.INT && r.vertexAttribIPointer(t, s, o, 0, 0),
...
function Fr(r, e, t, a) {
  ...
  (r.bindBuffer(r.ARRAY_BUFFER, f),
    ...
    o === r.FLOAT ? r.vertexAttribPointer(a, s, o, !1, v, 0) : o === r.INT && r.vertexAttribIPointer(a, s, o, v, 0),
    r.vertexAttribDivisor(a, 1),
    r.bindBuffer(r.ARRAY_BUFFER, null));
  for (var c = new Array(e), h = 0; h < e; h++) c[h] = Zy(r, o, u, v, s, h);
  return (
    (f.dataArray = u),
    (f.stride = v),
    (f.size = s),
    (f.getView = function (d) {
      return c[d];
    }),
    ...
    (f.bufferSubData = function (d) {
      (r.bindBuffer(r.ARRAY_BUFFER, f),
        d ? r.bufferSubData(r.ARRAY_BUFFER, 0, u, 0, d * s) : r.bufferSubData(r.ARRAY_BUFFER, 0, u));
    }),
    f
  );
}
function Jy(r, e, t) {
  ...
  for (var u = 0; u < 3; u++) {
    var v = t + u;
    (r.enableVertexAttribArray(v), r.vertexAttribPointer(v, 3, r.FLOAT, !1, 36, u * 12), r.vertexAttribDivisor(v, 1));
  }
  return (
    r.bindBuffer(r.ARRAY_BUFFER, null),
    (l.getMatrixView = function (f) {
      return i[f];
    }),
...
var Wl = typeof Float32Array < "u" ? Float32Array : Array;
Math.hypot ||
  (Math.hypot = function () {
...
function Es() {
  var r = new Wl(9);
  return (
    Wl != Float32Array && ((r[1] = 0), (r[2] = 0), (r[3] = 0), (r[5] = 0), (r[6] = 0), (r[7] = 0)),
    (r[0] = 1),
    (r[4] = 1),
    (r[8] = 1),
    r
...
var tm = (function () {
    ...
    return gt(r, [
      ...
      },
      {
        ...
        value: function (t) {
          var a = t.w,
            ...
            l = a * o,
            u = n * o;
          return (l > s && ((o = s / a), (l = a * o), (u = n * o)), { scale: o, texW: l, texH: u });
        },
      },
      {
        key: "draw",
            ...
            h = function (b, w) {
              if (n && w) {
                var E = w.context,
                  ...
                  T = C,
                  k = l * x;
                (E.save(), E.translate(T, k), E.scale(v, v), n(E, a), E.restore());
              }
            },
            d = [null, null],
            y = function () {
              (h(i.freePointer, i.canvas),
                ...
                (i.freePointer.x += f),
                i.freePointer.x == s && ((i.freePointer.x = 0), i.freePointer.row++));
            },
            g = function () {
              var b = i.scratch,
                w = i.canvas;
              (b.clear(), h({ x: 0, row: 0 }, b));
              var E = s - i.freePointer.x,
                C = f - E,
                x = l;
              {
                var T = i.freePointer.x,
                  k = i.freePointer.row * l,
                  D = E;
                (w.context.drawImage(b, 0, 0, D, x, T, k, D, x), (d[0] = { x: T, y: k, w: D, h: c }));
              }
              {
                var B = E,
                  P = (i.freePointer.row + 1) * l,
                  A = C;
                (w && w.context.drawImage(b, B, 0, A, x, 0, P, A, x), (d[1] = { x: 0, y: P, w: A, h: c }));
              }
      ...
      },
      {
        key: "bufferIfNeeded",
        value: function (t) {
          (this.texture || (this.texture = Yy(t, this.debugID)),
            this.needsBuffer &&
      ...
      },
      {
        key: "dispose",
        value: function () {
          (this.texture && (this.texture.deleteTexture(), (this.texture = null)),
            (this.canvas = null),
            (this.scratch = null),
            (this.locked = !0));
        },
                  ...
                  for (d.s(); !(y = d.n()).done; ) {
                    ...
                    if (!h.has(g)) {
                      var p = f.getOffsets(g),
                        ...
                        b = m[0],
                        w = m[1];
                      (s.canFit({ w: b.w + w.w, h: b.h }) || (s.lock(), (s = t._createAtlas()), n.push(s)),
                        f.canvas && (t._copyTextureToNewAtlas(g, f, s), i.set(g, s)));
                    }
                  }
                } catch (E) {
                  d.e(E);
      ...
      },
      {
        ...
        value: function (t, a, n) {
          ...
          if (l.w === 0)
            ...
            var v = o.w + l.w,
              f = o.h;
            n.draw(t, { w: v, h: f }, function (c) {
              c.drawImage(u, 0, 0, v, f, 0, 0, v, f);
            });
          }
        },
      },
...
var im = (function () {
    ...
    return gt(r, [
      ...
      },
      {
        ...
        value: function (t, a) {
          var n = this.globalOptions,
            i = n.webglTexSize,
            s = n.createTextureCanvas,
            o = a.texRows,
            l = this._cacheScratchCanvas(s),
            u = new am(this.r, i, o, l);
      ...
      },
      {
        ...
        value: function (t, a) {
          ...
          var i = this.collections.get(n),
            s = be({ type: t, atlasCollection: i }, a);
      ...
      },
      {
        ...
        value: function (t, a, n, i) {
          var s = this.renderTypes.get(a),
            o = this.collections.get(s.collection),
            l = !1,
            u = o.draw(i, n, function (c) {
              (s.drawClipped
                ? (c.save(),
                  c.beginPath(),
                  c.rect(0, 0, n.w, n.h),
                  c.clip(),
                  s.drawElement(c, t, n, !0, !0),
                  c.restore())
                : s.drawElement(c, t, n, !0, !0),
                (l = !0));
            });
      ...
      },
      {
        ...
        value: function (t, a) {
          var n = this,
            i = this.renderTypes.get(a),
            s = i.getKey(t),
            o = Array.isArray(s) ? s : [s];
          return o.map(function (l) {
            var u = i.getBoundingBox(t, l),
              v = n.getOrCreateAtlas(t, a, u, l),
              f = v.getOffsets(l),
              c = Je(f, 2),
              h = c[0],
              d = c[1];
  ...
  sm = (function () {
    ...
    return gt(r, [
      ...
      },
      {
        key: "getIndexArray",
        value: function () {
          return Array.from({ length: this.maxAtlasesPerBatch }, function (t, a) {
            return a;
          });
        },
      },
...
`,
  Ea = { SCREEN: { name: "screen", screen: !0 }, PICKING: { name: "picking", picking: !0 } },
  An = { IGNORE: 1, USE_BB: 2 },
  Cs = 0,
  Kl = 1,
  Xl = 2,
  Ts = 3,
  ...
  fm = (function () {
    ...
    `
            ...
            i = this.batchManager.getIndexArray(),
            s = `#version 300 es
      precision highp float;
    ...
    `
              ...
              for (v.s(); !(f = v.n()).done; ) {
                ...
                for (
                  ...
                  if (w.w != 0) {
                    ...
                    T[0] = g;
                    var k = this.texBuffer.getView(C);
      ...
      },
      {
        ...
        value: function (t, a, n, i) {
          ...
          var f = 0,
            c = l * i;
          return (
            n && i < 1 ? (l = c) : !n && i < 1 && ((f = l - c), (s += f), (l = c)),
            { x1: s, y1: o, w: l, h: u, xOffset: f, yOffset: v }
          );
        },
      },
      {
        ...
        value: function (t, a, n) {
          ...
          this.vertTypeBuffer.getView(s)[0] = _t;
      ...
      },
      {
        ...
        value: function (t, a, n) {
          ...
          if (this._isVisible(t, i)) {
            var s = i.shapeProps,
              o = this._getVertTypeForShape(t, s.shape);
            if (o === void 0 || (i.isSimple && !i.isSimple(t, this.renderTarget))) {
            ...
            if (((this.vertTypeBuffer.getView(l)[0] = o), o === sn || o === ga)) {
              var u = i.getBoundingBox(t),
                v = this._getCornerRadius(t, s.radius, u),
                f = this.cornerRadiusBuffer.getView(l);
              ((f[0] = v), (f[1] = v), (f[2] = v), (f[3] = v), o === ga && ((f[0] = 0), (f[2] = 0)));
            }
            var c = this.indexBuffer.getView(l);
            qt(a, c);
            var h = this.renderTarget.picking ? 1 : t.pstyle(s.opacity).value,
              d = t.pstyle(s.color).value,
              y = this.colorBuffer.getView(l);
            xt(d, h, y);
            ...
            if (((g[0] = 0), (g[1] = 0), s.border)) {
              ...
              if (p > 0) {
                var m = t.pstyle("border-color").value,
                  b = t.pstyle("border-opacity").value,
                  w = this.borderColorBuffer.getView(l);
                xt(m, b, w);
                var E = t.pstyle("border-position").value;
                if (E === "inside") ((g[0] = 0), (g[1] = -p));
                else if (E === "outside") ((g[0] = p), (g[1] = 0));
                else {
                  var C = p / 2;
                  ((g[0] = C), (g[1] = -C));
                }
      ...
      },
      {
        ...
        value: function (t, a, n) {
          var i = n.w,
            s = n.h;
          if (t.pstyle(a).value === "auto") return vt(i, s);
      ...
      },
      {
        ...
        value: function (t, a, n) {
          if (t.visible()) {
            ...
            if (
              (n === "source"
                ? ((s = i.arrowStartX), (o = i.arrowStartY), (l = i.srcArrowAngle))
                : ((s = i.arrowEndX), (o = i.arrowEndY), (l = i.tgtArrowAngle)),
              !(isNaN(s) || s == null || isNaN(o) || o == null || isNaN(l) || l == null))
            ) {
              var u = t.pstyle(n + "-arrow-shape").value;
              if (u !== "none") {
                var v = t.pstyle(n + "-arrow-color").value,
                  f = t.pstyle("opacity").value,
                  c = t.pstyle("line-opacity").value,
                  h = f * c,
                  d = t.pstyle("width").pfValue,
                  y = t.pstyle("arrow-scale").value,
                  g = this.r.getArrowWidth(d, y),
                  p = this.instanceCount,
                  m = this.transformBuffer.getMatrixView(p);
                ($l(m), yn(m, m, [s, o]), Ws(m, m, [g, g]), Ul(m, m, l), (this.vertTypeBuffer.getView(p)[0] = Ts));
                var b = this.indexBuffer.getView(p);
                qt(a, b);
                var w = this.colorBuffer.getView(p);
                (xt(v, h, w), this.instanceCount++, this.instanceCount >= this.maxInstances && this.endBatch());
              }
            }
          }
        },
          ...
          if (t.visible()) {
            ...
            if (n) {
              var i = t.pstyle("opacity").value,
                s = t.pstyle("line-opacity").value,
                o = t.pstyle("width").pfValue,
                l = t.pstyle("line-color").value,
                u = i * s;
              if ((n.length / 2 + this.instanceCount > this.maxInstances && this.endBatch(), n.length == 4)) {
                ...
                for (var y = 0; y < n.length - 2; y += 2) {
                  ...
                  this.vertTypeBuffer.getView(g)[0] = Xl;
                  ...
                  var w = n[y - 2],
                    ...
                    D = n[y + 4],
                    B = n[y + 5];
                  (y == 0 && ((w = 2 * C - T + 0.001), (E = 2 * x - k + 0.001)),
                    y == n.length - 4 && ((D = 2 * T - C + 0.001), (B = 2 * k - x + 0.001)));
      ...
      },
      {
        ...
        value: function () {
          ...
          if (i !== 0) {
            ...
            for (var v = this.batchManager.getAtlases(), f = 0; f < v.length; f++) v[f].bufferIfNeeded(t);
            ...
            (t.uniform1f(s.uZoom, Wy(this.r)),
              t.uniformMatrix3fv(s.uPanZoomMatrix, !1, this.panZoomMatrix),
            ...
            (t.uniform4fv(s.uBGColor, h),
              ...
              this.debug && this.batchDebugInfo.push({ count: i, atlasCount: v.length }),
              this.startBatch());
          }
        },
      },
      {
        ...
        value: function () {
          var t = this.atlasManager.getDebugInfo(),
            a = t.reduce(function (s, o) {
              return s + o.atlasCount;
            }, 0),
            n = this.batchDebugInfo,
...
Mf.initWebgl = function (r, e) {
  ...
  ((r.bgColor = cm(t)),
    ...
    (t.pickingFrameBuffer.needsDraw = !0),
...
function cm(r) {
  var e = r.cy.container(),
    t = (e && e.style && e.style.backgroundColor) || "white";
  return iv(t);
}
function Lf(r, e) {
  var t = r._private.rscratch;
...
function dm(r) {
  {
    ...
    r.render = function (i) {
      i = i || {};
      var s = r.cy;
      r.webgl && (s.zoom() > Sf ? (hm(r), e.call(r, i)) : (gm(r), Of(r, i, Ea.SCREEN)));
    };
  }
  {
  ...
  }
  {
    ...
    r.notify = function (i, s) {
      (n.call(r, i, s),
        i === "viewport" || i === "bounds"
          ? (r.pickingFrameBuffer.needsDraw = !0)
          : i === "background" && r.drawing.invalidate(s, { type: "node-body" }));
    };
  }
}
function hm(r) {
...
function bm(r) {
  var e = function (n, i, s) {
      for (
        var o = n.atlasManager.getAtlasCollection(i), l = r.data.contexts[r.NODE], u = o.atlases, v = 0;
        v < u.length;
        v++
      ) {
        var f = u[v],
...
function xm(r, e, t) {
  ...
  try {
    for (o.s(); !(l = o.n()).done; ) {
      var u = l.value,
        v = n[u];
      if ((!i && v.isNode() && (i = v), !s && v.isEdge() && (s = v), i && s)) break;
    }
  } catch (f) {
    o.e(f);
  } finally {
...
function Of(r, e, t) {
  ...
  var n = r.drawing,
    i = 0;
  if ((t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && ym(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking)) {
    var s = r.data.contexts[r.WEBGL];
    (t.screen
      ? (s.clearColor(0, 0, 0, 0), s.enable(s.BLEND), s.blendFunc(s.ONE, s.ONE_MINUS_SRC_ALPHA))
      : s.disable(s.BLEND),
      s.clear(s.COLOR_BUFFER_BIT | s.DEPTH_BUFFER_BIT),
      s.viewport(0, 0, s.canvas.width, s.canvas.height));
    var o = pm(r),
      l = r.getCachedZSortedEles();
    if (((i = l.length), n.startFrame(o, t), t.screen)) {
      for (var u = 0; u < l.nondrag.length; u++) Ds(r, u, l.nondrag[u]);
      for (var v = 0; v < l.drag.length; v++) Ds(r, v, l.drag[v]);
    } else if (t.picking) for (var f = 0; f < l.length; f++) Ds(r, f, l[f]);
    (n.endFrame(),
      t.screen && r.webglDebugShowAtlases && (mm(r), bm(r)),
      (r.data.canvasNeedsRedraw[r.NODE] = !1),
      (r.data.canvasNeedsRedraw[r.DRAG] = !1));
  }
  if (r.webglDebug) {
    ...
    if (!h) {
      var p = y.atlasInfo,
        ...
        b;
      try {
        for (m.s(); !(b = m.n()).done; ) var w = b.value;
      } catch (E) {
        m.e(E);
      } finally {
        m.f();
  ...
  r.data.gc && ((r.data.gc = !1), n.gc());
}
var mt = {};
mt.drawPolygonPath = function (r, e, t, a, n, i) {
  var s = a / 2,
    o = n / 2;
...
mt.drawRoundRectanglePath = function (r, e, t, a, n, i) {
  var s = a / 2,
    o = n / 2,
    l = i === "auto" ? vt(a, n) : Math.min(i, o, s);
  (r.beginPath && r.beginPath(),
    r.moveTo(e, t - o),
...
var Yl = Math.sin(0),
  ...
  Us = {},
  Nf = Math.PI / 40;
for (var Gt = 0 * Math.PI; Gt < 2 * Math.PI; Gt += Nf) (($s[Gt] = Math.sin(Gt)), (Us[Gt] = Math.cos(Gt)));
mt.drawEllipsePath = function (r, e, t, a, n) {
  if ((r.beginPath && r.beginPath(), r.ellipse)) r.ellipse(e, t, a / 2, n / 2, 0, 0, 2 * Math.PI);
  else
    for (var i, s, o = a / 2, l = n / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += Nf)
      ((i = e - o * $s[u] * Yl + o * Us[u] * Zl),
        (s = t + l * Us[u] * Yl + l * $s[u] * Zl),
        u === 0 ? r.moveTo(i, s) : r.lineTo(i, s));
  r.closePath();
};
var Wa = {};
...
Wa.bufferCanvasImage = function (r) {
  var e = this.cy,
    ...
    i = r.full ? Math.ceil(a.w) : n[2],
    s = r.full ? Math.ceil(a.h) : n[3],
    o = ae(r.maxWidth) || ae(r.maxHeight),
  ...
  if (r.scale !== void 0) ((i *= r.scale), (s *= r.scale), (u = r.scale));
    ...
    var v = 1 / 0,
      f = 1 / 0;
    (ae(r.maxWidth) && (v = (u * r.maxWidth) / i),
      ae(r.maxHeight) && (f = (u * r.maxHeight) / s),
      (u = Math.min(v, f)),
      (i *= u),
      (s *= u));
  }
...
Wa.png = function (r) {
  return zf(r, this.bufferCanvasImage(r), "image/png");
};
Wa.jpg = function (r) {
  return zf(r, this.bufferCanvasImage(r), "image/jpeg");
};
var Ff = {};
Ff.nodeShapeImpl = function (r, e, t, a, n, i, s, o) {
  switch (r) {
    case "ellipse":
...
function Vf(r) {
  var e = this,
    t = e.cy.window(),
    a = t.document;
  (r.webgl && (ke.CANVAS_LAYERS = e.CANVAS_LAYERS = 4),
    (e.data = {
  ...
  ((e.data.topCanvas = e.data.canvases[0]),
    ...
    e.data.canvases[ke.WEBGL] && e.data.canvases[ke.WEBGL].setAttribute("data-id", "layer" + ke.WEBGL + "-webgl"));
  ...
  var c = wr(),
    ...
    d = function (z) {
      return { x: -z.w / 2, y: -z.h / 2 };
    },
    y = function (z) {
      var q = z[0]._private,
        H = q.oldBackgroundTimestamp === q.backgroundTimestamp;
      return !H;
    },
    g = function (z) {
    ...
    w = function (z, q, H, Y, te) {
      return e.drawElement(z, q, H, !1, !1, te);
    },
    E = function (z, q, H, Y, te) {
      return e.drawElementText(z, q, H, Y, "main", te);
    },
    C = function (z, q, H, Y, te) {
      return e.drawElementText(z, q, H, Y, "source", te);
    },
    x = function (z, q, H, Y, te) {
      return e.drawElementText(z, q, H, Y, "target", te);
    },
    T = function (z) {
    ...
    R = function (z, q, H) {
      var Y = z ? z + "-" : "";
      return { x: q.x + H.pstyle(Y + "text-margin-x").pfValue, y: q.y + H.pstyle(Y + "text-margin-y").pfValue };
    },
    L = function (z, q, H) {
      var Y = z[0]._private.rscratch;
      return { x: Y[q], y: Y[H] };
    },
    I = function (z) {
      return R("", L(z, "labelX", "labelY"), z);
    },
    M = function (z) {
      return R("source", L(z, "sourceLabelX", "sourceLabelY"), z);
    },
    O = function (z) {
      return R("target", L(z, "targetLabelX", "targetLabelY"), z);
    },
    V = function (z) {
      return d(T(z));
    },
    ...
    re = (e.data.lyrTxrCache = new kf(e));
  e.onUpdateEleCalcs(function (z, q) {
    ...
    for (var H = 0; H < q.length; H++) {
      var Y = q[H]._private;
      Y.oldBackgroundTimestamp = Y.backgroundTimestamp;
    }
  });
  var ne = function (z) {
    for (var q = 0; q < z.length; q++) re.enqueueElementRefinement(z[q].ele);
  };
  (U.onDequeue(ne),
    Q.onDequeue(ne),
    K.onDequeue(ne),
...
var Tm = typeof Path2D < "u";
ke.path2dEnabled = function (r) {
  if (r === void 0) return this.pathsEnabled;
  this.pathsEnabled = !!r;
};
ke.usePaths = function () {
  return Tm && this.pathsEnabled;
};
ke.setImgSmoothing = function (r, e) {
  r.imageSmoothingEnabled != null
    ? (r.imageSmoothingEnabled = e)
    : ((r.webkitImageSmoothingEnabled = e), (r.mozImageSmoothingEnabled = e), (r.msImageSmoothingEnabled = e));
};
ke.getImgSmoothing = function (r) {
  return r.imageSmoothingEnabled != null
    ? r.imageSmoothingEnabled
    : r.webkitImageSmoothingEnabled || r.mozImageSmoothingEnabled || r.msImageSmoothingEnabled;
};
ke.makeOffscreenCanvas = function (r, e) {
  var t;
  if ((typeof OffscreenCanvas > "u" ? "undefined" : ar(OffscreenCanvas)) !== "undefined") t = new OffscreenCanvas(r, e);
  else {
...
[Df, Hr, Jr, mo, Lt, yt, xr, Mf, mt, Wa, Ff].forEach(function (r) {
  be(ke, r);
});
var Sm = [
    { name: "null", impl: df },
  ...
  km = [
    { type: "layout", extensions: Qp },
    { type: "renderer", extensions: Sm },
  ],
  qf = {},
  _f = {};
function Gf(r, e, t) {
  ...
  if (r === "core") {
    if (Ra.prototype[e]) return n(e);
    Ra.prototype[e] = t;
  } else if (r === "collection") {
    if (fr.prototype[e]) return n(e);
    fr.prototype[e] = t;
  } else if (r === "layout") {
    for (
      var i = function (T) {
          ((this.options = T),
            t.call(this, T),
            Le(this._private) || (this._private = {}),
    ...
    ((s.stop = function () {
      ...
      if (x && x.animate) {
        ...
        if (T) for (var k = 0; k < T.length; k++) T[k].stop();
      }
    ...
    var f = function (T) {
      ...
      c = {
        addEventFields: function (T, k) {
          ((k.layout = T), (k.cy = f(T)), (k.target = T));
        },
        bubble: function () {
          return !0;
        },
    ...
    for (var C in g) m[C] = g[C];
    (d.clientFunctions.forEach(function (x) {
      m[x] =
        m[x] ||
        function () {
          $e("Renderer does not implement `renderer." + x + "()` on its prototype");
        };
    }),
      (a = p));
...
function Hf(r, e) {
  return ov({ map: qf, keys: [r, e] });
}
function Dm(r, e, t, a, n) {
  return sv({ map: _f, keys: [r, e, t, a], value: n });
}
function Bm(r, e, t, a) {
  return ov({ map: _f, keys: [r, e, t, a] });
}
var Ks = function () {
  if (arguments.length === 2) return Hf.apply(null, arguments);
  if (arguments.length === 3) return Gf.apply(null, arguments);
  if (arguments.length === 4) return Bm.apply(null, arguments);
...
Rt.selector = function (r) {
  var e = this.length++;
  return ((this[e] = { selector: r, properties: [] }), this);
};
Rt.css = function (r, e) {
  var t = this.length - 1;
  if (ge(r)) this[t].properties.push({ name: r, value: e });
  else if (Le(r))
...
Rt.style = Rt.css;
Rt.generateStyle = function (r) {
  var e = new or(r);
  return this.appendToStyle(e);
};
Rt.appendToStyle = function (r) {
  for (var e = 0; e < this.length; e++) {
    var t = this[e],
      a = t.selector,
      n = t.properties;
...
var Pm = "3.33.2",
  ea = function (e) {
    if ((e === void 0 && (e = {}), Le(e))) return new Ra(e);
    if (ge(e)) return Ks.apply(Ks, arguments);
  };
ea.use = function (r) {
