...
import { g as Ne } from "./chunk-FMBD7UC4-Br0mr4Zy.js";
import "./index-DsVzfBkh.js";
var $ = (function () {
  var t = c(function (_, s, n, a) {
    ...
    j = [1, 31],
    x = [6, 7, 11, 24],
    P = [1, 6, 13, 16, 17, 20, 23],
    M = [1, 35],
    U = [1, 36],
    A = [1, 6, 7, 11, 13, 16, 17, 20, 23],
    H = [1, 38],
    V = {
      ...
      performAction: c(function (s, n, a, o, u, e, B) {
        var l = e.length - 1;
        switch (u) {
          case 6:
          case 7:
          ...
          case 12:
            ...
            break;
          case 15:
            (o.getLogger().info("Node: ", e[l - 1].id),
              o.addNode(e[l - 2].length, e[l - 1].id, e[l - 1].descr, e[l - 1].type, e[l]));
            break;
          case 16:
          ...
          case 19:
            ...
            break;
          case 20:
            (o.getLogger().trace("Node: ", e[l - 1].id),
              o.addNode(0, e[l - 1].id, e[l - 1].descr, e[l - 1].type, e[l]));
            break;
          case 21:
          ...
          case 22:
            ...
            break;
          case 27:
            (o.getLogger().trace("node found ..", e[l - 2]),
              (this.$ = { id: e[l - 1], descr: e[l - 1], type: o.getType(e[l - 2], e[l]) }));
            break;
          case 28:
            this.$ = { id: e[l], descr: e[l], type: 0 };
            break;
          case 29:
            (o.getLogger().trace("node found ..", e[l - 3]),
              (this.$ = { id: e[l - 3], descr: e[l - 1], type: o.getType(e[l - 2], e[l]) }));
            break;
          case 30:
            this.$ = e[l - 1] + e[l];
            break;
      ...
      table: [
        { 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: g },
        { 1: [3] },
        { 1: [2, 1] },
        { 4: 6, 6: [1, 7], 7: [1, 8], 8: g },
        { 6: d, 7: [1, 10], 9: 9, 12: 11, 13: r, 14: 14, 16: p, 17: k, 18: 17, 19: 18, 20: f, 23: h },
        t(L, [2, 3]),
        { 1: [2, 2] },
        t(L, [2, 4]),
        t(L, [2, 5]),
        { 1: [2, 6], 6: d, 12: 21, 13: r, 14: 14, 16: p, 17: k, 18: 17, 19: 18, 20: f, 23: h },
        { 6: d, 9: 22, 12: 11, 13: r, 14: 14, 16: p, 17: k, 18: 17, 19: 18, 20: f, 23: h },
        { 6: C, 7: w, 10: 23, 11: N },
        t(i, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: f, 23: h }),
        t(i, [2, 19]),
        t(i, [2, 21], { 15: 30, 24: j }),
        t(i, [2, 22]),
        t(i, [2, 23]),
        ...
        { 21: [1, 33] },
        { 6: C, 7: w, 10: 34, 11: N },
        { 1: [2, 7], 6: d, 12: 21, 13: r, 14: 14, 16: p, 17: k, 18: 17, 19: 18, 20: f, 23: h },
        t(P, [2, 14], { 7: M, 11: U }),
        t(A, [2, 8]),
        t(A, [2, 9]),
        t(A, [2, 10]),
      ...
      parse: c(function (s) {
        ...
        var q = m.yylloc;
        e.push(q);
        var de = m.options && m.options.ranges;
        typeof T.yy.parseError == "function"
          ? (this.parseError = T.yy.parseError)
        ...
        function ae() {
          ...
          return (
            (S = o.pop() || m.lex() || re),
            typeof S != "number" && (S instanceof Array && ((o = S), (S = o.pop())), (S = n.symbols_[S] || S)),
            S
          );
        }
        c(ae, "lex");
        for (var E, R, v, Q, F = {}, X, I, oe, K; ; ) {
          if (
            ((R = a[a.length - 1]),
            this.defaultActions[R]
              ? (v = this.defaultActions[R])
              : ((E === null || typeof E > "u") && (E = ae()), (v = B[R] && B[R][E])),
            typeof v > "u" || !v.length || !v[0])
          ) {
            var Z = "";
            K = [];
            for (X in B[R]) this.terminals_[X] && X > ue && K.push("'" + this.terminals_[X] + "'");
            (m.showPosition
              ? (Z =
                  "Parse error on line " +
                  (z + 1) +
...
Expecting ` +
              ...
              : (Z =
                  ...
                  (z + 1) +
                  ": Unexpected " +
                  (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'")),
              this.parseError(Z, {
                text: m.match,
          ...
          if (v[0] instanceof Array && v.length > 1)
            throw new Error("Parse Error: multiple actions possible at state: " + R + ", token: " + E);
          switch (v[0]) {
            case 1:
              (a.push(E),
                u.push(m.yytext),
            ...
            case 2:
              if (
                ...
                de && (F._$.range = [e[e.length - (I || 1)].range[0], e[e.length - 1].range[1]]),
                (Q = this.performAction.apply(F, [l, ie, z, T.yy, v[1], u, e].concat(ge))),
                typeof Q < "u")
              )
                return Q;
              (I && ((a = a.slice(0, -1 * I * 2)), (u = u.slice(0, -1 * I)), (e = e.slice(0, -1 * I))),
                a.push(this.productions_[v[1]][0]),
                u.push(F.$),
                e.push(F._$),
                (oe = B[a[a.length - 2]][a[a.length - 1]]),
                a.push(oe));
              break;
            case 3:
              return !0;
        ...
        unput: c(function (s) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: a
                ? (a.length === o.length ? this.yylloc.first_column : 0) + o[o.length - a.length].length - a[0].length
                : this.yylloc.first_column - n,
            }),
            this.options.ranges && (this.yylloc.range = [u[0], u[0] + this.yyleng - n]),
...
` +
        ...
        test_match: c(function (s, n) {
          ...
          if (
            ...
            (this.yylloc = {
              ...
              last_column: o
                ? o[o.length - 1].length - o[o.length - 1].match(/\r?\n?/)[0].length
        ...
        next: c(function () {
          ...
          for (var u = this._currentRules(), e = 0; e < u.length; e++)
            if (((a = this._input.match(this.rules[u[e]])), a && (!n || a[0].length > n[0].length))) {
              if (((n = a), (o = e), this.options.backtrack_lexer)) {
                if (((s = this.test_match(a, u[e])), s !== !1)) return s;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((s = this.test_match(n, u[o])), s !== !1 ? s : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: c(function (n) {
          return ((n = this.conditionStack.length - 1 - Math.abs(n || 0)), n >= 0 ? this.conditionStack[n] : "INITIAL");
        }, "topState"),
        pushState: c(function (n) {
          this.begin(n);
        }, "pushState"),
        ...
        performAction: c(function (n, a, o, u) {
          switch (o) {
            case 0:
...
var xe = $,
  ...
  Oe = c((t, g, d, r, p) => {
    var C, w;
    const k = W();
    let f = ((C = k.mindmap) == null ? void 0 : C.padding) ?? Y.mindmap.padding;
    switch (r) {
      case b.ROUNDED_RECT:
      case b.RECT:
      case b.HEXAGON:
    ...
    const h = {
      ...
      level: t,
      label: G(d, k),
      width: ((w = k.mindmap) == null ? void 0 : w.maxNodeWidth) ?? Y.mindmap.maxNodeWidth,
      padding: f,
      isGroup: !1,
    };
    if (p !== void 0) {
...
` +
      ...
      (i != null && i.shape && i.shape === "kanbanItem" && (h.shape = i == null ? void 0 : i.shape),
        i != null && i.label && (h.label = i == null ? void 0 : i.label),
        i != null && i.icon && (h.icon = i == null ? void 0 : i.icon.toString()),
        i != null && i.assigned && (h.assigned = i == null ? void 0 : i.assigned.toString()),
        i != null && i.ticket && (h.ticket = i == null ? void 0 : i.ticket.toString()),
        i != null && i.priority && (h.priority = i == null ? void 0 : i.priority));
    }
    const L = De(t);
  ...
  Ie = c((t, g) => {
    switch ((te.debug("In get type", t, g), t)) {
      case "[":
        return b.RECT;
      case "(":
        return g === ")" ? b.ROUNDED_RECT : b.CLOUD;
      case "((":
        return b.CIRCLE;
      case ")":
        return b.CLOUD;
...
` + t
    ...
    f.htmlLabels = !1;
    const h = fe(g);
    for (const y of k.nodes) y.domId = `${g}-${y.id}`;
    const L = h.append("g");
    L.attr("class", "sections");
    const C = h.append("g");
    C.attr("class", "items");
    const w = k.nodes.filter((y) => y.isGroup);
    let N = 0;
    const i = 10,
      j = [];
    let x = 25;
    for (const y of w) {
      ...
      ((N = N + 1),
        ...
        (y.rx = 5),
        (y.ry = 5),
        (y.cssClasses = y.cssClasses + " section-" + N));
      const _ = await ye(L, y);
      ((x = Math.max(x, (U = _ == null ? void 0 : _.labelBBox) == null ? void 0 : U.height)), j.push(_));
    }
    let P = 0;
    for (const y of w) {
      const O = j[P];
      P = P + 1;
      const _ = ((A = f == null ? void 0 : f.kanban) == null ? void 0 : A.sectionWidth) || 200,
        s = (-_ * 3) / 2 + x;
      let n = s;
      const a = k.nodes.filter((e) => e.parentId === y.id);
      for (const e of a) {
        if (e.isGroup) throw new Error("Groups within groups are not allowed in Kanban diagrams");
        ((e.x = y.x), (e.width = _ - 1.5 * i));
        const l = (await be(C, e, { config: f })).node().getBBox();
        ((e.y = n + l.height / 2), await me(e), (n = e.y + l.height / 2 + i / 2));
      }
      const o = O.cluster.select("rect"),
        u = Math.max(n - s + 3 * i, 50) + (x - 25);
      o.attr("height", u);
    }
    _e(
      void 0,
  ...
  Ge = c((t) => {
    ...
    for (let r = 0; r < t.THEME_COLOR_LIMIT; r++)
      ((t["lineColor" + r] = t["lineColor" + r] || t["cScaleInv" + r]),
        Se(t["lineColor" + r])
          ? (t["lineColor" + r] = le(t["lineColor" + r], 20))
          : (t["lineColor" + r] = ce(t["lineColor" + r], 20)));
    const d = c((r, p) => (t.darkMode ? ce(r, p) : le(r, p)), "adjuster");
    for (let r = 0; r < t.THEME_COLOR_LIMIT; r++) {
      const p = "" + (17 - 3 * r);
      g += `
...
`,
  ...
  Me = je,
  ze = { db: Ve, renderer: Fe, parser: xe, styles: Me };
