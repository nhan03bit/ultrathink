...
var b = a(
  ...
  g = a("catch class def do else enum finally for if interface switch trait try while"),
  x = a("return break continue"),
  z = a("null true false this"),
  r;
function k(e, n) {
  var t = e.next();
  ...
  if (t == "/") {
    ...
    if (h(n.lastToken, !1)) return y(t, e, n);
  }
  ...
  var i = e.current();
  return z.propertyIsEnumerable(i)
    ? "atom"
    : b.propertyIsEnumerable(i)
      ? (g.propertyIsEnumerable(i) ? (r = "newstatement") : x.propertyIsEnumerable(i) && (r = "standalone"), "keyword")
      : "variable";
}
k.isBase = !0;
function y(e, n, t) {
  ...
  function o(l, d) {
    for (var f = !1, c, s = !i; (c = l.next()) != null; ) {
      ...
      if (e == '"' && c == "$" && !f) {
        ...
        if (l.match(/^\w/, !1)) return (d.tokenize.push(E), "string");
      }
      f = !f && c == "\\";
    }
...
function E(e, n) {
  var t = e.match(/^(\.|[\w\$_]+)/);
  return (
    (!t || !e.match(t[0] == "." ? /^[\w$_]/ : /^\./)) && n.tokenize.pop(),
    t ? (t[0] == "." ? null : "variable") : n.tokenize[n.tokenize.length - 1](e, n)
  );
}
function v(e, n) {
...
const T = {
  ...
  startState: function (e) {
    return { tokenize: [k], context: new w(-e, 0, "top", !1), indented: 0, startOfLine: !0, lastToken: null };
  },
  token: function (e, n) {
    var t = n.context;
    if (
      (e.sol() &&
        ...
        (n.startOfLine = !0),
        t.type == "statement" && !h(n.lastToken, !0) && (u(n), (t = n.context))),
      e.eatSpace())
    )
      return null;
    r = null;
    ...
    if ((t.align == null && (t.align = !0), (r == ";" || r == ":") && t.type == "statement")) u(n);
    else if (r == "->" && t.type == "statement" && t.prev.type == "}") (u(n), (n.context.align = !1));
      ...
      r == t.type
        ? u(n)
        : (t.type == "}" || t.type == "top" || (t.type == "statement" && r == "newstatement")) &&
  ...
  indent: function (e, n, t) {
    ...
    return o.type == "statement"
      ? o.indented + (i == "{" ? 0 : t.unit)
      : o.align
        ? o.column + (l ? 0 : 1)
        : o.indented + (l ? 0 : t.unit);
  },
  languageData: {
    indentOnInput: /^\s*[{}]$/,
