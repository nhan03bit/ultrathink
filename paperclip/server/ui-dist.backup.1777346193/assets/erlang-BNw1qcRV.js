var S = ["-type", "-spec", "-export_type", "-opaque"],
  x = ["after", "begin", "catch", "case", "cond", "end", "fun", "if", "let", "of", "query", "receive", "try", "when"],
  z = /[\->,;]/,
  E = ["->", ";", ","],
  T = ["and", "andalso", "band", "bnot", "bor", "bsl", "bsr", "bxor", "div", "not", "or", "orelse", "rem", "xor"],
  R = /[\+\-\*\/<>=\|:!]/,
  A = ["=", "+", "-", "*", "/", ">", ">=", "<", "=<", "=:=", "==", "=/=", "/=", "||", "<-", "!"],
  U = /[<\(\[\{]/,
  b = ["<<", "(", "[", "{"],
...
function j(e, n) {
  ...
  if (r == "'") {
    if (!(n.in_atom = !h(e))) {
      if (e.match(/\s*\/\s*[0-9]/, !1)) return (e.match(/\s*\/\s*[0-9]/, !0), t(n, e, "fun"));
      if (e.match(/\s*\(/, !1) || e.match(/\s*:/, !1)) return t(n, e, "function");
    }
    return t(n, e, "atom");
  }
  ...
  if (/[a-z_ß-öø-ÿ]/.test(r)) {
    if ((e.eatWhile(p), e.match(/\s*\/\s*[0-9]/, !1))) return (e.match(/\s*\/\s*[0-9]/, !0), t(n, e, "fun"));
    var i = e.current();
    return u(i, x)
      ? t(n, e, "keyword")
      : u(i, T)
        ? t(n, e, "operator")
        : e.match(/\s*\(/, !1)
          ? u(i, P) && (_(n).token != ":" || _(n, 2).token == "erlang")
            ? t(n, e, "builtin")
            : u(i, m)
              ? t(n, e, "guard")
              : t(n, e, "function")
  ...
  return l.test(r)
    ? (e.eatWhile(l),
      e.eat("#")
        ? e.eatWhile(o) || e.backUp(1)
        : e.eat(".") &&
          (e.eatWhile(l)
            ? e.eat(/[eE]/) && (e.eat(/[-+]/) ? e.eatWhile(l) || e.backUp(2) : e.eatWhile(l) || e.backUp(1))
            : e.backUp(1)),
      t(n, e, "number"))
    : g(e, U, b)
      ? t(n, e, "open_paren")
...
function N(e, n) {
  n.type == "comment" ||
    n.type == "whitespace" ||
    ((e.tokenStack = O(e.tokenStack, n)), (e.tokenStack = $(e.tokenStack)));
}
function O(e, n) {
  var r = e.length - 1;
  return (
        ...
        : l === "when" && c.type === "function"
          ...
          : l === "(" && o.token === "fun"
            ...
            : l === "catch" && (i = s(e, ["try"]))
              ? i.column
              : u(l, ["end", "after", "of"])
                ? ((i = s(e, ["begin", "case", "fun", "if", "receive", "try"])), i ? i.column : null)
                : u(l, y)
                  ? ((i = s(e, b)), i ? i.column : null)
                  : u(o.token, [",", "|", "||"]) || u(l, [",", "|", "||"])
                    ? ((i = F(e)), i ? i.column + i.token.length : r.unit)
                    : o.token == "->"
                      ? u(c.token, ["receive", "case", "if", "try"])
                        ? c.column + r.unit + r.unit
                        : c.column + r.unit
                      : u(o.token, b)
                        ? o.column + o.token.length
                        : ((i = G(e)), f(i) ? i.column + r.unit : 0)
      : 0;
}
function C(e) {
  var n = e.match(/,|[a-z]+|\}|\]|\)|>>|\|+|\(/);
...
function F(e) {
  var n = e.tokenStack.slice(0, -1),
    r = d(n, "type", ["open_paren"]);
  return f(n[r]) ? n[r] : !1;
}
function G(e) {
  var n = e.tokenStack,
    r = d(n, "type", ["open_paren", "separator", "keyword"]),
    i = d(n, "type", ["operator"]);
