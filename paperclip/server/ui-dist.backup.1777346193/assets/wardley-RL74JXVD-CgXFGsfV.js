...
var Eh = (t, e, r) => (e in t ? vh(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r));
var Jt = (t, e, r) => Eh(t, typeof e != "symbol" ? e + "" : e, r);
import { M as Ah, _ as St } from "./index-DsVzfBkh.js";
import { m as Gt, f as $h, d as Ch } from "./min-wbx4F2Qf.js";
import { b as Sh, l as wh, c as kh, m as bh, r as Rc, n as xs } from "./_baseUniq-BM2H-MCK.js";
import { ba as _h } from "./mermaid.core-gIfAqAR1.js";
function Nh(t, e) {
  return Sh(Gt(t, e));
}
function Ih(t, e) {
  return t && t.length ? wh(t, kh(e)) : [];
}
function Fe(t) {
...
class Ef {
  ...
  getReferenceType(e) {
    ...
    if (!n) throw new Error(`Property ${e.property || "undefined"} of type ${e.container.$type} is not a reference.`);
    return n;
  }
  getTypeMetaData(e) {
  ...
  isSubtype(e, r) {
    ...
    if (i !== void 0) return i;
    {
      const a = this.types[e],
        s = a ? a.superTypes.some((o) => this.isSubtype(o, r)) : !1;
      return ((n[r] = s), s);
    }
  }
  getAllSubTypes(e) {
    ...
    if (r) return r;
    {
      const n = this.getAllTypes(),
        i = [];
      for (const a of n) this.isSubtype(a, e) && i.push(a);
...
function $f(t) {
  return Ii(t) && typeof t.fullText == "string";
}
class xe {
  constructor(e, r) {
  ...
  iterator() {
    const e = { state: this.startFn(), next: () => this.nextFn(e.state), [Symbol.iterator]: () => e };
    return e;
  }
  [Symbol.iterator]() {
  ...
  toMap(e, r) {
    const n = this.map((i) => [e ? e(i) : i, r ? r(i) : i]);
    return new Map(n);
  }
  toString() {
    return this.join();
  ...
  join(e = ",") {
    ...
    let n = "",
      i,
      a = !1;
    do ((i = r.next()), i.done || (a && (n += e), (n += Oh(i.value))), (a = !0));
    while (!i.done);
    return n;
  }
  indexOf(e, r = 0) {
  ...
  forEach(e) {
    ...
    let n = 0,
      i = r.next();
    for (; !i.done; ) (e(i.value, n), (i = r.next()), n++);
  }
  map(e) {
  ...
  reduce(e, r) {
    ...
    let i = r,
      a = n.next();
    for (; !a.done; ) (i === void 0 ? (i = a.value) : (i = e(i, a.value)), (a = n.next()));
    return i;
  }
  reduceRight(e, r) {
      ...
      (r) => {
        do {
          if (r.iterator) {
            ...
            if (a.done) r.iterator = void 0;
            else return a;
          }
          const { done: n, value: i } = this.nextFn(r.this);
          if (!n) {
            const a = e(i);
            if (Za(a)) r.iterator = a[Symbol.iterator]();
      ...
      (n) => {
        do {
          if (n.iterator) {
            ...
            if (s.done) n.iterator = void 0;
            else return s;
          }
          const { done: i, value: a } = r.nextFn(n.this);
          if (!i)
            if (Za(a)) n.iterator = a[Symbol.iterator]();
            else return { done: !1, value: a };
        } while (n.iterator);
        return Ze;
      }
  ...
  limit(e) {
    return new xe(
      ...
      (r) => (r.size++, r.size > e ? Ze : this.nextFn(r.state))
    );
  }
  distinct(e) {
    return new xe(
...
const Cf = new xe(
  ...
  Ze = Object.freeze({ done: !0, value: void 0 });
function de(...t) {
  if (t.length === 1) {
    const e = t[0];
    ...
    if (typeof e.length == "number")
      return new xe(
        () => ({ index: 0 }),
        (r) => (r.index < e.length ? { done: !1, value: e[r.index++] } : Ze)
      );
  }
  return t.length > 1
    ? new xe(
        ...
        (e) => {
          do {
            ...
            if (e.collIndex < t.length) {
              ...
              Za(r) ? (e.iterator = r[Symbol.iterator]()) : r && typeof r.length == "number" && (e.array = r);
            }
    ...
    super(
      ...
      (i) => {
        for (i.pruned && (i.iterators.pop(), (i.pruned = !1)); i.iterators.length > 0; ) {
          ...
          if (s.done) i.iterators.pop();
          else return (i.iterators.push(r(s.value)[Symbol.iterator]()), s);
        }
        return Ze;
      }
    );
...
function ho(t, e = {}) {
  for (const [r, n] of Object.entries(t))
    r.startsWith("$") ||
      (Array.isArray(n)
        ? n.forEach((i, a) => {
            Fe(i) && ((i.$container = t), (i.$containerProperty = r), (i.$containerIndex = a), e.deep && ho(i, e));
          })
        : Fe(n) && ((n.$container = t), (n.$containerProperty = r), e.deep && ho(n, e)));
}
function vs(t, e) {
  let r = t;
  for (; r; ) {
...
function vc(t) {
  return ut(t) ? (t.ref ? [t.ref] : []) : Qt(t) ? t.items.map((e) => e.ref) : [];
}
function Jl(t, e) {
    ...
    (n) => {
      for (; n.keyIndex < n.keys.length; ) {
        ...
        if (!i.startsWith("$")) {
          const a = t[i];
          if (Fe(a)) {
            if ((n.keyIndex++, Ec(a, r))) return { done: !1, value: a };
          } else if (Array.isArray(a)) {
            for (; n.arrayIndex < a.length; ) {
              const s = n.arrayIndex++,
                o = a[s];
              if (Fe(o) && Ec(o, r)) return { done: !1, value: o };
            }
            n.arrayIndex = 0;
          }
        }
...
function qi(t, e) {
  ...
  return new Yl(t, (r) => Jl(r, e));
}
function zt(t, e) {
  if (!t) throw new Error("Root node must be an AstNode.");
  return new Yl(t, (r) => Jl(r, e), { includeRoot: !0 });
}
function Ec(t, e) {
  var n;
  if (!e) return !0;
  ...
  return new xe(
    ...
    (e) => {
      for (; e.keyIndex < e.keys.length; ) {
        ...
        if (!r.startsWith("$")) {
          const n = t[r];
          if (ut(n) || Qt(n)) return (e.keyIndex++, { done: !1, value: { reference: n, container: t, property: r } });
          if (Array.isArray(n)) {
            for (; e.arrayIndex < n.length; ) {
              const i = e.arrayIndex++,
                a = n[i];
              if (ut(a) || Qt(n)) return { done: !1, value: { reference: a, container: t, property: r, index: i } };
            }
            e.arrayIndex = 0;
          }
        }
...
function Lh(t, e) {
  ...
  for (const i of Object.values(r.properties))
    i.defaultValue !== void 0 && n[i.name] === void 0 && (n[i.name] = Sf(i.defaultValue));
}
function Sf(t) {
  return Array.isArray(t) ? [...t.map(Sf)] : t;
}
const Je = { $type: "AbstractElement", cardinality: "cardinality" };
function xh(t) {
  return J.isInstance(t, Je.$type);
}
const Fa = { $type: "AbstractParserRule" };
function Bi(t) {
  return J.isInstance(t, Fa.$type);
}
const ga = { $type: "AbstractRule" },
  ot = { $type: "AbstractType" },
  vr = {
    $type: "Action",
...
const Ga = { $type: "Alternatives", cardinality: "cardinality", elements: "elements" };
function wf(t) {
  return J.isInstance(t, Ga.$type);
}
const Ac = { $type: "ArrayLiteral", elements: "elements" },
  $c = { $type: "ArrayType", elementType: "elementType" },
  Er = {
    $type: "Assignment",
    cardinality: "cardinality",
    feature: "feature",
...
const po = { $type: "BooleanLiteral", true: "true" };
function Dh(t) {
  return J.isInstance(t, po.$type);
}
const Ar = {
  $type: "CharacterRange",
  cardinality: "cardinality",
...
function Mh(t) {
  return J.isInstance(t, Ar.$type);
}
const Fr = { $type: "Condition" },
  ja = { $type: "Conjunction", left: "left", right: "right" };
function Fh(t) {
  return J.isInstance(t, ja.$type);
}
const $r = {
  $type: "CrossReference",
  cardinality: "cardinality",
...
function As(t) {
  return J.isInstance(t, $r.$type);
}
const za = { $type: "Disjunction", left: "left", right: "right" };
function Gh(t) {
  return J.isInstance(t, za.$type);
}
const mo = { $type: "EndOfFile", cardinality: "cardinality" };
function jh(t) {
  return J.isInstance(t, mo.$type);
}
const sr = {
    $type: "Grammar",
    imports: "imports",
  ...
  Cc = { $type: "GrammarImport", path: "path" },
  Br = {
    $type: "Group",
    cardinality: "cardinality",
    elements: "elements",
...
const go = { $type: "InferredType", name: "name" };
function kf(t) {
  return J.isInstance(t, go.$type);
}
const Lt = {
  $type: "InfixRule",
  call: "call",
...
function es(t) {
  return J.isInstance(t, Lt.$type);
}
const Ds = { $type: "InfixRuleOperatorList", associativity: "associativity", operators: "operators" },
  Sc = { $type: "InfixRuleOperators", precedences: "precedences" },
  Ei = { $type: "Interface", attributes: "attributes", name: "name", superTypes: "superTypes" };
function zh(t) {
  return J.isInstance(t, Ei.$type);
}
const Ai = { $type: "Keyword", cardinality: "cardinality", predicate: "predicate", value: "value" };
function _r(t) {
  return J.isInstance(t, Ai.$type);
}
const ya = { $type: "NamedArgument", calledByName: "calledByName", parameter: "parameter", value: "value" },
  Wr = {
    $type: "NegatedToken",
    cardinality: "cardinality",
    lookahead: "lookahead",
...
const yo = { $type: "Negation", value: "value" };
function qh(t) {
  return J.isInstance(t, yo.$type);
}
const wc = { $type: "NumberLiteral", value: "value" },
  Ta = { $type: "Parameter", name: "name" },
  To = { $type: "ParameterReference", parameter: "parameter" };
function Bh(t) {
  return J.isInstance(t, To.$type);
}
const pt = {
  $type: "ParserRule",
  dataType: "dataType",
...
const Ms = { $type: "ReferenceType", isMulti: "isMulti", referenceType: "referenceType" },
  Vr = {
    $type: "RegexToken",
    cardinality: "cardinality",
    lookahead: "lookahead",
...
const Ro = { $type: "ReturnType", name: "name" };
function Vh(t) {
  return J.isInstance(t, Ro.$type);
}
const Kr = {
  $type: "RuleCall",
  arguments: "arguments",
...
const $i = { $type: "SimpleType", primitiveType: "primitiveType", stringType: "stringType", typeRef: "typeRef" };
function Kh(t) {
  return J.isInstance(t, $i.$type);
}
const kc = { $type: "StringLiteral", value: "value" },
  Hr = {
...
function Yh(t) {
  return J.isInstance(t, Yr.$type);
}
const Ua = { $type: "Type", name: "name", type: "type" };
function Jh(t) {
  return J.isInstance(t, Ua.$type);
}
const Zn = {
    $type: "TypeAttribute",
  ...
  Qn = { $type: "TypeDefinition" },
  bc = { $type: "UnionType", types: "types" },
  qa = { $type: "UnorderedGroup", cardinality: "cardinality", elements: "elements" };
function bf(t) {
  return J.isInstance(t, qa.$type);
}
const Jr = {
  $type: "UntilToken",
  cardinality: "cardinality",
...
function Zh(t) {
  return J.isInstance(t, Jr.$type);
}
const ei = { $type: "ValueLiteral" },
  Ci = { $type: "Wildcard", cardinality: "cardinality", lookahead: "lookahead", parenthesized: "parenthesized" };
function Qh(t) {
  return J.isInstance(t, Ci.$type);
}
class _f extends Ef {
  constructor() {
    (super(...arguments),
      (this.types = {
        AbstractElement: { name: Je.$type, properties: { cardinality: { name: Je.cardinality } }, superTypes: [] },
        AbstractParserRule: { name: Fa.$type, properties: {}, superTypes: [ga.$type, ot.$type] },
        AbstractRule: { name: ga.$type, properties: {}, superTypes: [] },
        AbstractType: { name: ot.$type, properties: {}, superTypes: [] },
        Action: {
          name: vr.$type,
          properties: {
            cardinality: { name: vr.cardinality },
            feature: { name: vr.feature },
            inferredType: { name: vr.inferredType },
            operator: { name: vr.operator },
            type: { name: vr.type, referenceType: ot.$type },
          },
          superTypes: [Je.$type],
        },
        Alternatives: {
        ...
        ArrayLiteral: {
          name: Ac.$type,
          properties: { elements: { name: Ac.elements, defaultValue: [] } },
          superTypes: [ei.$type],
        },
        ArrayType: { name: $c.$type, properties: { elementType: { name: $c.elementType } }, superTypes: [Qn.$type] },
        Assignment: {
          name: Er.$type,
          properties: {
            cardinality: { name: Er.cardinality },
            feature: { name: Er.feature },
            operator: { name: Er.operator },
            predicate: { name: Er.predicate },
            terminal: { name: Er.terminal },
          },
          superTypes: [Je.$type],
        },
        BooleanLiteral: {
          name: po.$type,
          properties: { true: { name: po.true, defaultValue: !1 } },
          superTypes: [Fr.$type, ei.$type],
        },
        CharacterRange: {
          name: Ar.$type,
          properties: {
            cardinality: { name: Ar.cardinality },
            left: { name: Ar.left },
            lookahead: { name: Ar.lookahead },
            parenthesized: { name: Ar.parenthesized, defaultValue: !1 },
            right: { name: Ar.right },
          },
          superTypes: [rt.$type],
        },
        Condition: { name: Fr.$type, properties: {}, superTypes: [] },
        Conjunction: {
          name: ja.$type,
          properties: { left: { name: ja.left }, right: { name: ja.right } },
          superTypes: [Fr.$type],
        },
        CrossReference: {
          name: $r.$type,
          properties: {
            cardinality: { name: $r.cardinality },
            deprecatedSyntax: { name: $r.deprecatedSyntax, defaultValue: !1 },
            isMulti: { name: $r.isMulti, defaultValue: !1 },
            terminal: { name: $r.terminal },
            type: { name: $r.type, referenceType: ot.$type },
          },
          superTypes: [Je.$type],
        },
        Disjunction: {
          name: za.$type,
          properties: { left: { name: za.left }, right: { name: za.right } },
          superTypes: [Fr.$type],
        },
        EndOfFile: { name: mo.$type, properties: { cardinality: { name: mo.cardinality } }, superTypes: [Je.$type] },
        Grammar: {
          name: sr.$type,
          properties: {
            imports: { name: sr.imports, defaultValue: [] },
            interfaces: { name: sr.interfaces, defaultValue: [] },
            isDeclared: { name: sr.isDeclared, defaultValue: !1 },
            name: { name: sr.name },
            rules: { name: sr.rules, defaultValue: [] },
            types: { name: sr.types, defaultValue: [] },
          },
          superTypes: [],
        },
        GrammarImport: { name: Cc.$type, properties: { path: { name: Cc.path } }, superTypes: [] },
        Group: {
          name: Br.$type,
          properties: {
            cardinality: { name: Br.cardinality },
            elements: { name: Br.elements, defaultValue: [] },
            guardCondition: { name: Br.guardCondition },
            predicate: { name: Br.predicate },
          },
          superTypes: [Je.$type],
        },
        InferredType: { name: go.$type, properties: { name: { name: go.name } }, superTypes: [ot.$type] },
        InfixRule: {
          name: Lt.$type,
          properties: {
            call: { name: Lt.call },
            dataType: { name: Lt.dataType },
            inferredType: { name: Lt.inferredType },
            name: { name: Lt.name },
            operators: { name: Lt.operators },
            parameters: { name: Lt.parameters, defaultValue: [] },
            returnType: { name: Lt.returnType, referenceType: ot.$type },
          },
          superTypes: [Fa.$type],
        },
        InfixRuleOperatorList: {
          name: Ds.$type,
          properties: {
            associativity: { name: Ds.associativity },
            operators: { name: Ds.operators, defaultValue: [] },
          },
          superTypes: [],
        },
        InfixRuleOperators: {
          name: Sc.$type,
          properties: { precedences: { name: Sc.precedences, defaultValue: [] } },
          superTypes: [],
        },
        Interface: {
          name: Ei.$type,
          properties: {
            attributes: { name: Ei.attributes, defaultValue: [] },
            name: { name: Ei.name },
            superTypes: { name: Ei.superTypes, defaultValue: [], referenceType: ot.$type },
          },
          superTypes: [ot.$type],
        },
        Keyword: {
          name: Ai.$type,
          properties: {
            cardinality: { name: Ai.cardinality },
            predicate: { name: Ai.predicate },
            value: { name: Ai.value },
          },
          superTypes: [Je.$type],
        },
        NamedArgument: {
          name: ya.$type,
          properties: {
            calledByName: { name: ya.calledByName, defaultValue: !1 },
            parameter: { name: ya.parameter, referenceType: Ta.$type },
            value: { name: ya.value },
          },
          superTypes: [],
        },
        NegatedToken: {
          ...
          properties: {
            ...
            lookahead: { name: Wr.lookahead },
            parenthesized: { name: Wr.parenthesized, defaultValue: !1 },
            terminal: { name: Wr.terminal },
          },
          superTypes: [rt.$type],
        },
        Negation: { name: yo.$type, properties: { value: { name: yo.value } }, superTypes: [Fr.$type] },
        NumberLiteral: { name: wc.$type, properties: { value: { name: wc.value } }, superTypes: [ei.$type] },
        Parameter: { name: Ta.$type, properties: { name: { name: Ta.name } }, superTypes: [] },
        ParameterReference: {
          name: To.$type,
          properties: { parameter: { name: To.parameter, referenceType: Ta.$type } },
          superTypes: [Fr.$type],
        },
        ParserRule: {
          name: pt.$type,
          properties: {
            dataType: { name: pt.dataType },
            definition: { name: pt.definition },
            entry: { name: pt.entry, defaultValue: !1 },
            fragment: { name: pt.fragment, defaultValue: !1 },
            inferredType: { name: pt.inferredType },
            name: { name: pt.name },
            parameters: { name: pt.parameters, defaultValue: [] },
            returnType: { name: pt.returnType, referenceType: ot.$type },
          },
          superTypes: [Fa.$type],
        },
        ReferenceType: {
          name: Ms.$type,
          properties: { isMulti: { name: Ms.isMulti, defaultValue: !1 }, referenceType: { name: Ms.referenceType } },
          superTypes: [Qn.$type],
        },
        RegexToken: {
          name: Vr.$type,
        ...
        ReturnType: { name: Ro.$type, properties: { name: { name: Ro.name } }, superTypes: [] },
        RuleCall: {
          name: Kr.$type,
          properties: {
            arguments: { name: Kr.arguments, defaultValue: [] },
            cardinality: { name: Kr.cardinality },
            predicate: { name: Kr.predicate },
            rule: { name: Kr.rule, referenceType: ga.$type },
          },
          superTypes: [Je.$type],
        },
        SimpleType: {
          name: $i.$type,
          properties: {
            primitiveType: { name: $i.primitiveType },
            stringType: { name: $i.stringType },
            typeRef: { name: $i.typeRef, referenceType: ot.$type },
          },
          superTypes: [Qn.$type],
        },
        StringLiteral: { name: kc.$type, properties: { value: { name: kc.value } }, superTypes: [ei.$type] },
        TerminalAlternatives: {
          name: Hr.$type,
          properties: {
            cardinality: { name: Hr.cardinality },
            elements: { name: Hr.elements, defaultValue: [] },
            lookahead: { name: Hr.lookahead },
            parenthesized: { name: Hr.parenthesized, defaultValue: !1 },
          },
          superTypes: [rt.$type],
        },
        TerminalElement: {
        ...
        TerminalGroup: {
          name: Xr.$type,
          properties: {
            cardinality: { name: Xr.cardinality },
            elements: { name: Xr.elements, defaultValue: [] },
            lookahead: { name: Xr.lookahead },
            parenthesized: { name: Xr.parenthesized, defaultValue: !1 },
          },
          superTypes: [rt.$type],
        },
        TerminalRule: {
          name: Zt.$type,
          properties: {
            definition: { name: Zt.definition },
            fragment: { name: Zt.fragment, defaultValue: !1 },
            hidden: { name: Zt.hidden, defaultValue: !1 },
            name: { name: Zt.name },
            type: { name: Zt.type },
          },
          superTypes: [ga.$type],
        ...
        TerminalRuleCall: {
          name: Yr.$type,
          properties: {
            cardinality: { name: Yr.cardinality },
            lookahead: { name: Yr.lookahead },
            parenthesized: { name: Yr.parenthesized, defaultValue: !1 },
            rule: { name: Yr.rule, referenceType: Zt.$type },
          },
          superTypes: [rt.$type],
        },
        Type: {
          name: Ua.$type,
          properties: { name: { name: Ua.name }, type: { name: Ua.type } },
          superTypes: [ot.$type],
        },
        TypeAttribute: {
          name: Zn.$type,
          properties: {
            defaultValue: { name: Zn.defaultValue },
            isOptional: { name: Zn.isOptional, defaultValue: !1 },
            name: { name: Zn.name },
            type: { name: Zn.type },
          },
          superTypes: [],
        },
        TypeDefinition: { name: Qn.$type, properties: {}, superTypes: [] },
        UnionType: {
          name: bc.$type,
          properties: { types: { name: bc.types, defaultValue: [] } },
          superTypes: [Qn.$type],
        },
        UnorderedGroup: {
          name: qa.$type,
          properties: { cardinality: { name: qa.cardinality }, elements: { name: qa.elements, defaultValue: [] } },
          superTypes: [Je.$type],
        },
        UntilToken: {
          name: Jr.$type,
          properties: {
            cardinality: { name: Jr.cardinality },
            lookahead: { name: Jr.lookahead },
            parenthesized: { name: Jr.parenthesized, defaultValue: !1 },
            terminal: { name: Jr.terminal },
          },
          superTypes: [rt.$type],
        },
        ValueLiteral: { name: ei.$type, properties: {}, superTypes: [] },
        Wildcard: {
          name: Ci.$type,
          properties: {
            cardinality: { name: Ci.cardinality },
            lookahead: { name: Ci.lookahead },
            parenthesized: { name: Ci.parenthesized, defaultValue: !1 },
          },
          superTypes: [rt.$type],
        },
      }));
...
const J = new _f();
function vo(t) {
  return new Yl(t, (e) => (Ii(e) ? e.content : []), { includeRoot: !0 });
}
function ep(t, e) {
...
function tp(t, e) {
  ...
  return r && n ? Mt.Inside : r ? Mt.OverlapBack : n ? Mt.OverlapFront : Mt.Outside;
}
function rp(t, e) {
  return tp(t, e) > Mt.After;
}
const np = /^[\w\p{L}]$/u;
function ip(t, e) {
  if (t) {
    const r = ap(t, !0);
    if (r && _c(r, e)) return r;
    if ($f(t)) {
...
function _c(t, e) {
  return Af(t) && e.includes(t.tokenType.name);
}
function ap(t, e = !0) {
  for (; t.container; ) {
    const r = t.container;
...
function Wi(t, e = "Error: Got unexpected value.") {
  throw new Error(e);
}
function U(t) {
...
const rs = [];
for (let t = U("0"); t <= U("9"); t++) rs.push(t);
const ns = [U("_")].concat(rs);
for (let t = U("a"); t <= U("z"); t++) ns.push(t);
for (let t = U("A"); t <= U("Z"); t++) ns.push(t);
const Ic = [
    U(" "),
    U("\f"),
...
class If {
      ...
      case "{":
        ...
        switch (this.popChar()) {
          ...
          case ",":
            let a;
            (this.isDigit()
              ? ((a = this.integerIncludingZero()), (r = { atLeast: i, atMost: a }))
  ...
  atom() {
    ...
    if ((e === void 0 && this.isPatternCharacter() && (e = this.patternCharacter()), Gr(e)))
...
`),
  ...
  characterClassEscape() {
    ...
    if (Gr(e)) return { type: "Set", value: e, complement: r };
  }
  controlEscapeAtom() {
    let e;
    switch (this.popChar()) {
...
`);
    ...
    if (Gr(e)) return { type: "Character", value: e };
  }
...
`:
  ...
  positiveInteger() {
    let e = this.popChar();
    if (lp.test(e) === !1) throw Error("Expecting a positive integer");
    for (; Ra.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  integerIncludingZero() {
    let e = this.popChar();
    if (Ra.test(e) === !1) throw Error("Expecting an integer");
    for (; Ra.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  patternCharacter() {
...
`:
  ...
  isDigit() {
    return Ra.test(this.peekChar(0));
  }
  isClassAtom(e = 0) {
...
`:
  ...
  parseHexDigits(e) {
    ...
    for (let i = 0; i < e; i++) {
      ...
      if (op.test(a) === !1) throw Error("Expecting a HexDecimal digits");
      r += a;
    }
...
function gp(t) {
  return t.rules.find((e) => Bt(e) && e.entry);
}
function yp(t) {
  return t.rules.filter((e) => Wt(e) && e.hidden);
}
function Of(t, e) {
  const r = new Set(),
    n = gp(t);
  if (!n) return new Set(t.rules);
  const i = [n].concat(yp(t));
  for (const s of i) Lf(s, r, e);
  const a = new Set();
  for (const s of t.rules) (r.has(s.name) || (Wt(s) && s.hidden)) && a.add(s);
  return a;
}
function Lf(t, e, r) {
  (e.add(t.name),
...
function Tp(t) {
  ...
  if (t.type.ref) {
    const e = Df(t.type.ref);
    return e == null ? void 0 : e.terminal;
  }
}
function Rp(t) {
  return t.hidden && !Pf(ec(t));
}
function vp(t, e) {
  return !t || !e ? [] : Ql(t, e, t.astNode, !0);
}
function xf(t, e, r) {
  if (!t || !e) return;
  const n = Ql(t, e, t.astNode, !0);
  if (n.length !== 0) return (r !== void 0 ? (r = Math.max(0, Math.min(r, n.length - 1))) : (r = 0), n[r]);
}
function Ql(t, e, r, n) {
  if (!n) {
    const i = vs(t.grammarSource, br);
    if (i && i.feature === e) return [t];
  }
  return Ii(t) && t.astNode === r ? t.content.flatMap((i) => Ql(i, e, r, !1)) : [];
}
function Ep(t, e, r) {
  if (!t) return;
  const n = Ap(t, e, t == null ? void 0 : t.astNode);
  if (n.length !== 0) return (r !== void 0 ? (r = Math.max(0, Math.min(r, n.length - 1))) : (r = 0), n[r]);
}
function Ap(t, e, r) {
  if (t.astNode !== r) return [];
  if (_r(t.grammarSource) && t.grammarSource.value === e) return [t];
  const n = vo(t).iterator();
  let i;
  const a = [];
  do
    if (((i = n.next()), !i.done)) {
...
function Df(t) {
  ...
  return (
    kf(e) &&
      (Es(e.$container) ? (e = e.$container.$container) : Bi(e.$container) ? (e = e.$container) : Wi(e.$container)),
    Mf(t, e, new Map())
  );
}
function Mf(t, e, r) {
  ...
  function n(a, s) {
    let o;
    return (vs(a, br) || (o = Mf(s, s, r)), r.set(t, o), o);
  }
  if (r.has(t)) return r.get(t);
  r.set(t, void 0);
  for (const a of qi(e)) {
    if (br(a) && a.feature.toLowerCase() === "name") return (r.set(t, a), a);
    if (Nr(a) && Bt(a.rule.ref)) return n(a, a.rule.ref);
    if (Kh(a) && (i = a.typeRef) != null && i.ref) return n(a, a.typeRef.ref);
  }
}
function Ff(t) {
  return Gf(t, new Set());
...
function Gf(t, e) {
  ...
  for (const r of qi(t))
    if (Nr(r)) {
      if (!r.rule.ref || (Bt(r.rule.ref) && !Gf(r.rule.ref, e)) || es(r.rule.ref)) return !1;
    } else {
      if (br(r)) return !1;
      if (Es(r)) return !1;
    }
...
function Pi(t) {
  if (Bi(t)) return Bt(t) && Ff(t) ? t.name : (jf(t) ?? t.name);
  if (zh(t) || Jh(t) || Vh(t)) return t.name;
  if (Es(t)) {
    const e = Cp(t);
    if (e) return e;
  } else if (kf(t)) return t.name;
  throw new Error("Cannot get name of Unknown Type");
}
function Cp(t) {
  var e;
  if (t.inferredType) return t.inferredType.name;
  if ((e = t.type) != null && e.ref) return Pi(t.type.ref);
}
function Sp(t) {
  var e;
  return Wt(t) ? (((e = t.type) == null ? void 0 : e.name) ?? "string") : (jf(t) ?? t.name);
}
function ec(t) {
  const e = { s: !1, i: !1, u: !1 },
    r = On(t.definition, e),
...
function On(t, e) {
  ...
  if (Yh(t)) {
    ...
    return Ut(On(n.definition), { cardinality: t.cardinality, lookahead: t.lookahead, parenthesized: t.parenthesized });
  } else {
    if (Uh(t)) return _p(t);
    if (Zh(t)) return bp(t);
    if (Wh(t)) {
      const n = t.regex.lastIndexOf("/"),
        i = t.regex.substring(1, n),
        a = t.regex.substring(n + 1);
      return (
        e && ((e.i = a.includes("i")), (e.s = a.includes("s")), (e.u = a.includes("u"))),
        Ut(i, { cardinality: t.cardinality, lookahead: t.lookahead, parenthesized: t.parenthesized, wrap: !1 })
      );
    } else {
      if (Qh(t)) return Ut(tc, { cardinality: t.cardinality, lookahead: t.lookahead, parenthesized: t.parenthesized });
      throw new Error(
...
function wp(t) {
  return Ut(t.elements.map((e) => On(e)).join("|"), {
...
function Np(t) {
  return t.right
    ? Ut(`[${js(t.left)}-${js(t.right)}]`, {
        cardinality: t.cardinality,
        lookahead: t.lookahead,
        parenthesized: t.parenthesized,
        wrap: !1,
      })
    : Ut(js(t.left), { cardinality: t.cardinality, lookahead: t.lookahead, parenthesized: t.parenthesized, wrap: !1 });
}
function js(t) {
  return Cs(t.value);
}
function Ut(t, e) {
  return (
    (e.parenthesized || e.lookahead || e.wrap !== !1) && (t = `(${e.lookahead ?? (e.parenthesized ? "" : "?:")}${t})`),
...
function Ip(t) {
  const e = [],
    r = t.Grammar;
  for (const n of r.rules) Wt(n) && Rp(n) && dp(ec(n)) && e.push(n.name);
  return { multilineCommentRules: e, nameRegexp: np };
}
function zf(t) {
...
function Ba(t) {
  ...
  if (t instanceof qe) {
    ...
    if (t instanceof Ve) return { type: "Alternative", definition: e(t.definition) };
    if (t instanceof Me) return { type: "Option", idx: t.idx, definition: e(t.definition) };
    if (t instanceof et) return { type: "RepetitionMandatory", idx: t.idx, definition: e(t.definition) };
    if (t instanceof tt)
      return {
        type: "RepetitionMandatoryWithSeparator",
        idx: t.idx,
        separator: Ba(new se({ terminalType: t.separator })),
    ...
    if (t instanceof Te) return { type: "Repetition", idx: t.idx, definition: e(t.definition) };
    if (t instanceof He) return { type: "Alternation", idx: t.idx, definition: e(t.definition) };
    if (t instanceof se) {
      const r = { type: "Terminal", name: t.terminalType.name, label: Pp(t.terminalType), idx: t.idx };
      ...
      if (t instanceof Ln) return { type: "Rule", name: t.name, orgText: t.orgText, definition: e(t.definition) };
...
function is(t, e = []) {
  return t instanceof Me || t instanceof Te || t instanceof Ke
    ? !0
    : t instanceof He
      ? t.definition.some((n) => is(n, e))
      : t instanceof qe && e.includes(t)
        ? !1
        : t instanceof Tt
          ? (t instanceof qe && e.push(t), t.definition.every((n) => is(n, e)))
          : !1;
}
function Dp(t) {
...
function mt(t) {
  if (t instanceof qe) return "SUBRULE";
  if (t instanceof Me) return "OPTION";
  if (t instanceof He) return "OR";
  if (t instanceof et) return "AT_LEAST_ONE";
  if (t instanceof tt) return "AT_LEAST_ONE_SEP";
  if (t instanceof Ke) return "MANY_SEP";
  if (t instanceof Te) return "MANY";
  if (t instanceof se) return "CONSUME";
  throw Error("non exhaustive match");
}
class Ss {
  walk(e, r = []) {
    e.definition.forEach((n, i) => {
      ...
      if (n instanceof qe) this.walkProdRef(n, a, r);
      else if (n instanceof se) this.walkTerminal(n, a, r);
      else if (n instanceof Ve) this.walkFlat(n, a, r);
      else if (n instanceof Me) this.walkOption(n, a, r);
      else if (n instanceof et) this.walkAtLeastOne(n, a, r);
      else if (n instanceof tt) this.walkAtLeastOneSep(n, a, r);
      else if (n instanceof Ke) this.walkManySep(n, a, r);
      else if (n instanceof Te) this.walkMany(n, a, r);
      else if (n instanceof He) this.walkOr(n, a, r);
  ...
  walkAtLeastOne(e, r, n) {
    const i = [new Me({ definition: e.definition })].concat(r, n);
    this.walk(e, i);
  }
  ...
  walkOr(e, r, n) {
    ...
    e.definition.forEach((a) => {
      const s = new Ve({ definition: [a] });
      this.walk(s, i);
    });
  }
}
function Pc(t, e, r) {
  return [new Me({ definition: [new se({ terminalType: t.separator })].concat(t.definition) })].concat(e, r);
}
function Vi(t) {
  if (t instanceof qe) return Vi(t.referencedRule);
  if (t instanceof se) return Gp(t);
  if (xp(t)) return Mp(t);
  if (Dp(t)) return Fp(t);
  throw Error("non exhaustive match");
}
function Mp(t) {
  ...
  let n = 0,
    ...
    a,
    s = !0;
  for (; i && s; ) ((a = r[n]), (s = is(a)), (e = e.concat(Vi(a))), (n = n + 1), (i = r.length > n));
  return [...new Set(e)];
}
function Fp(t) {
  const e = t.definition.map((r) => Vi(r));
...
class jp extends Ss {
  ...
  walkTerminal(e, r, n) {}
  walkProdRef(e, r, n) {
    const i = Up(e.referencedRule, e.idx) + this.topProd.name,
      a = r.concat(n),
      s = new Ve({ definition: a }),
      o = Vi(s);
    this.follows[i] = o;
  }
}
...
function ws(t) {
  const e = t.toString();
  if (Wa.hasOwnProperty(e)) return Wa[e];
  {
    const r = qp.pattern(e);
    return ((Wa[e] = r), r);
  }
}
function Bp() {
...
const Bf = "Complement Sets are not supported for first char optimization",
  as = `Unable to use "first char" lexer optimizations:
`;
function Wp(t, e = !1) {
  try {
    const r = ws(t);
    return Ao(r.value, {}, r.flags.ignoreCase);
  } catch (r) {
    if (r.message === Bf) e && (`${as}${t.toString()}`, void 0);
    else {
      let n = "";
      (e &&
        (n = `
...
function Ao(t, e, r) {
  switch (t.type) {
    case "Disjunction":
      for (let i = 0; i < t.value.length; i++) Ao(t.value[i], e, r);
      break;
    case "Alternative":
      const n = t.value;
      for (let i = 0; i < n.length; i++) {
        ...
        switch (s.type) {
          case "Character":
            ...
            break;
          case "Set":
            if (s.complement === !0) throw Error(Bf);
            s.value.forEach((l) => {
              if (typeof l == "number") va(l, e, r);
              else {
                const c = l;
                if (r === !0) for (let u = c.from; u <= c.to; u++) va(u, e, r);
                else {
                  for (let u = c.from; u <= c.to && u < wi; u++) va(u, e, r);
                  if (c.to >= wi) {
                    const u = c.from >= wi ? c.from : wi,
                      d = c.to,
                      m = er(u),
                      h = er(d);
                    for (let E = m; E <= h; E++) e[E] = E;
                  }
                }
              }
            });
        ...
        if ((s.type === "Group" && $o(s) === !1) || (s.type !== "Group" && o === !1)) break;
      }
      break;
    default:
      throw Error("non exhaustive match!");
...
function Vp(t, e) {
  const r = String.fromCharCode(t),
    n = r.toUpperCase();
  if (n !== r) {
    const i = er(n.charCodeAt(0));
    e[i] = i;
  } else {
    const i = r.toLowerCase();
    if (i !== r) {
      const a = er(i.charCodeAt(0));
      e[a] = a;
    }
  }
}
function Oc(t, e) {
  return t.value.find((r) => {
    if (typeof r == "number") return e.includes(r);
    {
      const n = r;
...
function $o(t) {
  ...
  return e && e.atLeast === 0 ? !0 : t.value ? (Array.isArray(t.value) ? t.value.every($o) : $o(t.value)) : !1;
}
class Kp extends $s {
  constructor(e) {
  ...
  visitSet(e) {
    e.complement
      ? Oc(e, this.targetCharCodes) === void 0 && (this.found = !0)
      : Oc(e, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
}
function rc(t, e) {
...
`,
    ...
    ((i = !1),
      (a = n.map((w) => {
        ...
        if (S instanceof RegExp) {
          const P = S.source;
          return P.length === 1 && P !== "^" && P !== "$" && P !== "." && !S.ignoreCase
            ? P
            : P.length === 2 &&
                P[0] === "\\" &&
                !["d", "D", "s", "S", "t", "r", "n", "t", "0", "c", "b", "B", "f", "v", "w", "W"].includes(P[1])
              ? P[1]
              : Lc(S);
        } else {
          if (typeof S == "function") return ((i = !0), { exec: S });
          if (typeof S == "object") return ((i = !0), S);
          if (typeof S == "string") {
  ...
  r("misc mapping", () => {
    ((s = n.map((w) => w.tokenTypeIdx)),
      ...
      (l = n.map((w) => {
        const S = w.LONGER_ALT;
        if (S) return Array.isArray(S) ? S.map((W) => n.indexOf(W)) : [n.indexOf(S)];
      })),
      (c = n.map((w) => w.PUSH_MODE)),
      (u = n.map((w) => Object.hasOwn(w, "POP_MODE"))));
  });
  let d;
  r("Line Terminator Handling", () => {
    const w = Kf(e.lineTerminatorCharacters);
    ((d = n.map((S) => !1)),
      e.positionTracking !== "onlyOffset" &&
        (d = n.map((S) => (Object.hasOwn(S, "LINE_BREAKS") ? !!S.LINE_BREAKS : Vf(S, w) === !1 && rc(w, S.PATTERN)))));
  });
  let m, h, E, b;
  r("Misc Mapping #2", () => {
    ((m = n.map(Wf)),
      ...
      (E = n.reduce((w, S) => {
        const P = S.GROUP;
        return (typeof P == "string" && P !== We.SKIPPED && (w[P] = []), w);
      }, {})),
      (b = a.map((w, S) => ({
        pattern: a[S],
        longerAlt: l[S],
        canLineTerminator: d[S],
        isCustom: m[S],
        short: h[S],
        group: o[S],
        push: c[S],
      ...
      r("First Char Optimization", () => {
        C = n.reduce((w, S, P) => {
          if (typeof S.PATTERN == "string") {
            const W = S.PATTERN.charCodeAt(0),
              B = er(W);
            zs(w, B, b[P]);
          } else if (Array.isArray(S.START_CHARS_HINT)) {
            let W;
            S.START_CHARS_HINT.forEach((B) => {
              const H = typeof B == "string" ? B.charCodeAt(0) : B,
                ne = er(H);
              W !== ne && ((W = ne), zs(w, ne, b[P]));
            });
          } else if (S.PATTERN instanceof RegExp)
            if (S.PATTERN.unicode) ((I = !1), e.ensureOptimizations && (`${as}${S.PATTERN.toString()}`, void 0));
            else {
              const W = Wp(S.PATTERN, e.ensureOptimizations);
              (W.length === 0 && (I = !1),
                W.forEach((B) => {
                  zs(w, B, b[P]);
                }));
            }
          else (e.ensureOptimizations && (`${as}${S.name}`, void 0), (I = !1));
          return w;
        }, []);
      }),
    { emptyGroups: E, patternIdxToConfig: b, charCodeToPatternIdxToConfig: C, hasCustom: i, canBeOptimized: I }
  );
}
function Xp(t, e) {
  let r = [];
...
function Yp(t) {
  let e = [];
  const r = t.filter((n) => n[Ir] instanceof RegExp);
  return (
    (e = e.concat(em(r))),
    (e = e.concat(nm(r))),
    (e = e.concat(im(r))),
...
function Jp(t) {
  const e = t.filter((i) => !Object.hasOwn(i, Ir)),
    r = e.map((i) => ({
...
function am(t) {
  ...
  let r = t.map((a) =>
    t.reduce(
      (s, o) => (
        a.PATTERN.source === o.PATTERN.source && !e.includes(o) && o.PATTERN !== We.NA && (e.push(o), s.push(o)),
        s
      ),
      []
    )
...
function sm(t) {
  return t
    .filter((n) => {
      if (!Object.hasOwn(n, "GROUP")) return !1;
      const i = n.GROUP;
...
function om(t, e) {
  return t
    .filter((i) => i.PUSH_MODE !== void 0 && !e.includes(i.PUSH_MODE))
    .map((i) => ({
  ...
  const e = [],
    r = t.reduce((n, i, a) => {
      ...
      return (
        s === We.NA ||
          (typeof s == "string"
            ? n.push({ str: s, idx: a, tokenType: i })
            : s instanceof RegExp && um(s) && n.push({ str: s.source, idx: a, tokenType: i })),
        n
      );
    }, []);
  return (
    t.forEach((n, i) => {
      r.forEach(({ str: a, idx: s, tokenType: o }) => {
        if (i < s && cm(a, n.PATTERN)) {
          const l = `Token: ->${o.name}<- can never be matched.
Because it appears AFTER the Token Type ->${n.name}<-in the lexer's definition.
See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNREACHABLE`;
          e.push({ message: l, type: Re.UNREACHABLE_PATTERN, tokenTypes: [n, o] });
        }
      });
    }),
    e
...
function cm(t, e) {
  if (e instanceof RegExp) {
    ...
    if (typeof e == "function") return e(t, 0, [], {});
    if (Object.hasOwn(e, "exec")) return e.exec(t, 0, [], {});
...
`,
    ...
    Object.hasOwn(t, Ea) &&
      Object.hasOwn(t, Si) &&
      !Object.hasOwn(t.modes, t.defaultMode) &&
      n.push({
        message: `A MultiMode Lexer cannot be initialized with a ${Si}: <${t.defaultMode}>which does not exist
`,
        type: Re.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST,
      }),
    Object.hasOwn(t, Ea) &&
      Object.keys(t.modes).forEach((i) => {
        const a = t.modes[i];
        a.forEach((s, o) => {
          s === void 0
            ? n.push({
...
`,
            ...
            : Object.hasOwn(s, "LONGER_ALT") &&
              (Array.isArray(s.LONGER_ALT) ? s.LONGER_ALT : [s.LONGER_ALT]).forEach((c) => {
                c !== void 0 &&
                  !a.includes(c) &&
                  n.push({
  ...
  return (
    e &&
      s.forEach((l) => {
        const c = Vf(l, o);
        if (c !== !1) {
          const d = { message: ym(l, c), type: c.issue, tokenType: l };
          n.push(d);
        } else Object.hasOwn(l, "LINE_BREAKS") ? l.LINE_BREAKS === !0 && (i = !0) : rc(o, l.PATTERN) && (i = !0);
      }),
    e &&
      !i &&
      n.push({
...
function Wf(t) {
  const e = t.PATTERN;
  if (e instanceof RegExp) return !1;
...
function Vf(t, e) {
  if (Object.hasOwn(t, "LINE_BREAKS")) return !1;
  if (t.PATTERN instanceof RegExp) {
    try {
      rc(e, t.PATTERN);
    } catch (r) {
      return { issue: Re.IDENTIFY_TERMINATOR, errMsg: r.message };
    }
    return !1;
  } else {
    if (typeof t.PATTERN == "string") return !1;
    if (Wf(t)) return { issue: Re.CUSTOM_LINE_BREAK };
    throw Error("non exhaustive match");
  }
}
function ym(t, e) {
...
function Tm() {
  if (Va.length === 0) {
    Va = new Array(65536);
    for (let t = 0; t < 65536; t++) Va[t] = t > 255 ? 255 + ~~(t / 255) : t;
  }
}
function Ki(t, e) {
...
function vm(t) {
  t.forEach((e) => {
    (Yf(e) || ((Hf[xc] = e), (e.tokenTypeIdx = xc++)),
      Dc(e) && !Array.isArray(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]),
      Dc(e) || (e.CATEGORIES = []),
      $m(e) || (e.categoryMatches = []),
      Cm(e) || (e.categoryMatchesMap = {}));
  });
}
function Em(t) {
  t.forEach((e) => {
    ((e.categoryMatches = []),
      Object.keys(e.categoryMatchesMap).forEach((r) => {
        e.categoryMatches.push(Hf[r].tokenTypeIdx);
      }));
  });
}
function Am(t) {
    ...
    if (
      ...
      (this.TRACE_INIT = (i, a) => {
        if (this.traceInitPerf === !0) {
          ...
          const { time: o, value: l } = zf(a),
            c = o > 10 ? console.warn : console.log;
          return (
            this.traceInitIndent < this.traceInitMaxIdent && c(`${s}<-- <${i}> time: ${o}ms`),
            this.traceInitIndent--,
            l
          );
        } else return a();
...
a boolean 2nd argument is no longer supported`);
    this.config = Object.assign({}, ki, r);
    ...
    (n === !0
      ...
      this.TRACE_INIT("Lexer Constructor", () => {
        ...
        (this.TRACE_INIT("Lexer Config handling", () => {
          if (this.config.lineTerminatorsPattern === ki.lineTerminatorsPattern) this.config.lineTerminatorsPattern = gm;
          else if (this.config.lineTerminatorCharacters === ki.lineTerminatorCharacters)
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          ((this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking)),
            ...
            Array.isArray(e)
              ? (i = { modes: { defaultMode: [...e] }, defaultMode: Si })
              : ((a = !1), (i = Object.assign({}, e))));
        }),
          this.config.skipValidations === !1 &&
            (this.TRACE_INIT("performRuntimeChecks", () => {
              this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                dm(i, this.trackStartLines, this.config.lineTerminatorCharacters)
              );
            }),
            this.TRACE_INIT("performWarningRuntimeChecks", () => {
              this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                hm(i, this.trackStartLines, this.config.lineTerminatorCharacters)
              );
            })),
          (i.modes = i.modes ? i.modes : {}),
          Object.entries(i.modes).forEach(([o, l]) => {
              ...
              if (
                ...
                this.config.skipValidations === !1 &&
                  this.TRACE_INIT("validatePatterns", () => {
                    this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Xp(l, s));
                  }),
                ...
                (this.TRACE_INIT("analyzeTokenTypes", () => {
                  ...
                  (this.patternIdxToConfig[o] = c.patternIdxToConfig),
                  (this.charCodeToPatternIdxToConfig[o] = c.charCodeToPatternIdxToConfig),
                  (this.emptyGroups = Object.assign({}, this.emptyGroups, c.emptyGroups)),
                  (this.hasCustom = c.hasCustom || this.hasCustom),
                  (this.canModeBeOptimized[o] = c.canBeOptimized));
              }
            });
          }),
          (this.defaultMode = i.defaultMode),
          this.lexerDefinitionErrors.length > 0 && !this.config.deferDefinitionErrorsHandling)
        ) {
...
` + l
        ...
        (this.lexerDefinitionWarning.forEach((o) => {
          ...
          this.TRACE_INIT("Choosing sub-methods implementations", () => {
            if (
              (a && (this.handleModes = () => {}),
              this.trackStartLines === !1 && (this.computeNewColumn = (o) => o),
              this.trackEndLines === !1 && (this.updateTokenEndLineColumnLocation = () => {}),
            ...
            this.hasCustom
              ...
              : ((this.addToken = this.addTokenUsingMemberAccess), (this.handlePayload = this.handlePayloadNoCustom));
          }),
...
` + i
  ...
  tokenizeInternal(e, r) {
    let n, i, a, s, o, l, c, u, d, m, h, E, b, I, C;
    const w = e,
      S = w.length;
    let P = 0,
      W = 0;
    const B = this.hasCustom ? 0 : Math.floor(e.length / 10),
      H = new Array(B),
      ne = [];
    let oe = this.trackStartLines ? 1 : void 0,
      le = this.trackStartLines ? 1 : void 0;
    const _ = pm(this.emptyGroups),
      R = this.trackStartLines,
      g = this.config.lineTerminatorsPattern;
    let $ = 0,
      y = [],
      T = [];
    const A = [],
    ...
    let D = !1;
    const x = (z) => {
      if (A.length === 1 && z.tokenType.PUSH_MODE === void 0) {
        ...
        A.pop();
        const Q = A.at(-1);
        ((y = this.patternIdxToConfig[Q]), (T = this.charCodeToPatternIdxToConfig[Q]), ($ = y.length));
        const Ne = this.canModeBeOptimized[Q] && this.config.safeMode === !1;
        T && Ne ? (D = !0) : (D = !1);
      }
    };
    function j(z) {
      (A.push(z),
        (T = this.charCodeToPatternIdxToConfig[z]),
        (y = this.patternIdxToConfig[z]),
        ($ = y.length),
        ($ = y.length));
    ...
    for (; P < S; ) {
      ...
      for (n = 0; n < Ne; n++) {
        ...
        if (
          (ce !== !1
            ...
            : F.isCustom === !0
              ? ((C = ge.exec(w, P, H, _)),
                C !== null ? ((l = C[0]), (d = l.length), C.payload !== void 0 && (c = C.payload)) : (l = null))
              : ((ge.lastIndex = P), (d = this.matchLength(ge, e, P))),
          d !== -1)
        ) {
          if (((o = F.longerAlt), o !== void 0)) {
            ...
            for (a = 0; a < ke; a++) {
              ...
              if (
                ...
                Ie.isCustom === !0
                  ? ((C = Ce.exec(w, P, H, _)),
                    C !== null ? ((s = C[0]), C.payload !== void 0 && (u = C.payload)) : (s = null))
                  : ((Ce.lastIndex = P), (s = this.match(Ce, e, P))),
                s && s.length > l.length)
              ) {
      ...
      if (d !== -1) {
        if (
          ((m = F.group),
          m !== void 0 &&
            ((l = l !== null ? l : e.substring(P, P + d)),
            (h = F.tokenTypeIdx),
            (E = this.createTokenInstance(l, P, h, F.tokenType, oe, le, d)),
            this.handlePayload(E, c),
            m === !1 ? (W = this.addToken(H, W, E)) : _[m].push(E)),
          R === !0 && F.canLineTerminator === !0)
        ) {
          let ge = 0,
            ce,
            ke;
          ...
          do
            ((l = l !== null ? l : e.substring(P, P + d)),
              (ce = g.test(l)),
              ce === !0 && ((ke = g.lastIndex - 1), ge++));
          while (ce === !0);
          ge !== 0
            ? ((oe = oe + ge), (le = d - ke), this.updateTokenEndLineColumnLocation(E, m, ke, ge, oe, le, d))
            : (le = this.computeNewColumn(le, d));
        } else le = this.computeNewColumn(le, d);
        ((P = P + d), this.handleModes(F, x, j, E));
      } else {
        const ge = P,
          ce = oe,
          ke = le;
        ...
        for (; Ie === !1 && P < S; )
          for (P++, i = 0; i < $; i++) {
            ...
            if (
              (Xe !== !1
                ? w.charCodeAt(P) === Xe && (Ie = !0)
                : Ce.isCustom === !0
                  ? (Ie = Y.exec(w, P, H, _) !== null)
                  : ((Y.lastIndex = P), (Ie = Y.exec(e) !== null)),
              Ie === !0)
            )
              break;
          }
        if (
          ((b = P - ge),
          (le = this.computeNewColumn(le, b)),
          (I = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(w, ge, b, ce, ke, A.at(-1))),
          ne.push({ offset: ge, line: ce, column: ke, length: b, message: I }),
          te === !1)
        )
          break;
      }
    }
    return (this.hasCustom || (H.length = W), { tokens: H, groups: _, errors: ne });
  }
  handleModes(e, r, n, i) {
    if (e.pop === !0) {
      const a = e.push;
  ...
  updateTokenEndLineColumnLocation(e, r, n, i, a, s, o) {
    let l, c;
    r !== void 0 &&
      ((l = n === o - 1), (c = l ? -1 : 0), (i === 1 && l === !0) || ((e.endLine = a + c), (e.endColumn = s - 1 + -c)));
  }
  ...
  createStartOnlyToken(e, r, n, i, a, s) {
    return { image: e, startOffset: r, startLine: a, startColumn: s, tokenTypeIdx: n, tokenType: i };
  }
...
function km(t) {
  const e = t.pattern,
    r = {};
  if (((r.name = t.name), e !== void 0 && (r.PATTERN = e), Object.hasOwn(t, wm)))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return (
    Object.hasOwn(t, Mc) && (r.CATEGORIES = t[Mc]),
    Hi([r]),
    Object.hasOwn(t, Fc) && (r.LABEL = t[Fc]),
    Object.hasOwn(t, Gc) && (r.GROUP = t[Gc]),
    Object.hasOwn(t, zc) && (r.POP_MODE = t[zc]),
    Object.hasOwn(t, jc) && (r.PUSH_MODE = t[jc]),
    Object.hasOwn(t, Uc) && (r.LONGER_ALT = t[Uc]),
    Object.hasOwn(t, qc) && (r.LINE_BREAKS = t[qc]),
    Object.hasOwn(t, Bc) && (r.START_CHARS_HINT = t[Bc]),
    r
  );
}
const tr = Zf({ name: "EOF", pattern: We.NA });
Hi([tr]);
function nc(t, e, r, n, i, a, s, o) {
  return {
    image: e,
    startOffset: r,
    endOffset: n,
...
const nn = {
  buildMismatchTokenMessage({ expected: t, actual: e, previous: r, ruleName: n }) {
    return `Expecting ${Jf(t) ? `--> ${sn(t)} <--` : `token of type --> ${t.name} <--`} but found --> '${e.image}' <--`;
  },
...
${t
  .reduce((m, h) => m.concat(h), [])
  .map((m) => `[${m.map((h) => sn(h)).join(", ")}]`)
  .map((m, h) => `  ${h + 1}. ${m}`).join(`
`)}`;
      return a + d + o;
    }
...
but found: '` +
  ...
  <${t.map((c) => `[${c.map((u) => sn(u)).join(",")}]`).join(" ,")}>`;
      return i + l + s;
    }
  },
};
...
inside top level rule: ->` +
  ...
  wr = {
    buildDuplicateFoundError(t, e) {
      function r(u) {
        return u instanceof se ? u.terminalType.name : u instanceof qe ? u.nonTerminalName : "";
      }
      const n = t.name,
        i = e[0],
        a = i.idx,
...
and Non-Terminal names start with a lower case letter.`;
    ...
    buildAlternationPrefixAmbiguityError(t) {
      const e = t.prefixPath.map((i) => sn(i)).join(", "),
...
`;
        ...
        const i = t.prefixPath.map((a) => sn(a)).join(", ");
 ...
 has ${t.alternation.definition.length + 1} alternatives.`;
    ...
    buildLeftRecursionError(t) {
      const e = t.topLevelRule.name,
        r = t.leftRecursionPath.map((a) => a.name),
        n = `${e} --> ${r.concat([e]).join(" --> ")}`;
...
see: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
    ...
    buildDuplicateRuleNameError(t) {
      let e;
      return (
        t.topLevelRule instanceof Ln ? (e = t.topLevelRule.name) : (e = t.topLevelRule),
...
class Pm extends Im {
  ...
  walkTerminal(e, r, n) {
    if (
      ...
      const i = r.concat(n),
        a = new Ve({ definition: i });
      ((this.possibleTokTypes = Vi(a)), (this.found = !0));
    }
  }
}
class ks extends Ss {
  ...
  walkMany(e, r, n) {
    if (e.idx === this.occurrence) {
      ...
      ((this.result.isEndOfRule = i === void 0),
        i instanceof se && ((this.result.token = i.terminalType), (this.result.occurrence = i.idx)));
...
function So(t, e, r = []) {
  ...
  for (; r.length < e && i < t.length; ) {
    const o = t[i];
    if (o instanceof Ve) return s(o.definition);
    if (o instanceof qe) return s(o.definition);
    if (o instanceof Me) n = s(o.definition);
    else if (o instanceof et) {
      const l = o.definition.concat([new Te({ definition: o.definition })]);
      return s(l);
    } else if (o instanceof tt) {
      const l = [
        new Ve({ definition: o.definition }),
        new Te({ definition: [new se({ terminalType: o.separator })].concat(o.definition) }),
      ];
      return s(l);
      ...
      if (o instanceof He)
        return (
          o.definition.forEach((l) => {
            l.definition.length !== 0 && (n = s(l.definition));
          }),
          n
        );
      if (o instanceof se) r.push(o.terminalType);
      else throw Error("non exhaustive match");
    }
    i++;
  }
  return (n.push({ partialPath: r, suffixDef: t.slice(i) }), n);
}
function xm(t, e, r, n) {
  ...
  const l = e.length,
    ...
    u = [],
    d = [];
  for (d.push({ idx: -1, def: t, ruleStack: [], occurrenceStack: [] }); d.length !== 0; ) {
    const m = d.pop();
    if (m === s) {
    ...
    const C = h[0];
    if (C === i) {
      const w = { idx: E, def: h.slice(1), ruleStack: b.slice(0, -1), occurrenceStack: I.slice(0, -1) };
      d.push(w);
    } else if (C instanceof se)
      if (E < l - 1) {
        const w = E + 1,
          S = e[w];
        if (r(S, C.terminalType)) {
          const P = { idx: w, def: h.slice(1), ruleStack: b, occurrenceStack: I };
          d.push(P);
        }
      } else if (E === l - 1)
        (u.push({ nextTokenType: C.terminalType, nextTokenOccurrence: C.idx, ruleStack: b, occurrenceStack: I }),
          (o = !0));
      else throw Error("non exhaustive match");
    else if (C instanceof qe) {
      const w = [...b];
      w.push(C.nonTerminalName);
      const S = [...I];
      S.push(C.idx);
      const P = { idx: E, def: C.definition.concat(a, h.slice(1)), ruleStack: w, occurrenceStack: S };
      d.push(P);
    } else if (C instanceof Me) {
      const w = { idx: E, def: h.slice(1), ruleStack: b, occurrenceStack: I };
      (d.push(w), d.push(s));
      const S = { idx: E, def: C.definition.concat(h.slice(1)), ruleStack: b, occurrenceStack: I };
      d.push(S);
    } else if (C instanceof et) {
      const w = new Te({ definition: C.definition, idx: C.idx }),
        S = C.definition.concat([w], h.slice(1)),
        P = { idx: E, def: S, ruleStack: b, occurrenceStack: I };
      d.push(P);
    } else if (C instanceof tt) {
      const w = new se({ terminalType: C.separator }),
        S = new Te({ definition: [w].concat(C.definition), idx: C.idx }),
        P = C.definition.concat([S], h.slice(1)),
        W = { idx: E, def: P, ruleStack: b, occurrenceStack: I };
      d.push(W);
    } else if (C instanceof Ke) {
      const w = { idx: E, def: h.slice(1), ruleStack: b, occurrenceStack: I };
      (d.push(w), d.push(s));
      const S = new se({ terminalType: C.separator }),
        P = new Te({ definition: [S].concat(C.definition), idx: C.idx }),
        W = C.definition.concat([P], h.slice(1)),
        B = { idx: E, def: W, ruleStack: b, occurrenceStack: I };
      d.push(B);
    } else if (C instanceof Te) {
      const w = { idx: E, def: h.slice(1), ruleStack: b, occurrenceStack: I };
      (d.push(w), d.push(s));
      const S = new Te({ definition: C.definition, idx: C.idx }),
        P = C.definition.concat([S], h.slice(1)),
        W = { idx: E, def: P, ruleStack: b, occurrenceStack: I };
      d.push(W);
    } else if (C instanceof He)
      for (let w = C.definition.length - 1; w >= 0; w--) {
        const S = C.definition[w],
          P = { idx: E, def: S.definition.concat(h.slice(1)), ruleStack: b, occurrenceStack: I };
        (d.push(P), d.push(s));
      }
    else if (C instanceof Ve)
      d.push({ idx: E, def: C.definition.concat(h.slice(1)), ruleStack: b, occurrenceStack: I });
    else if (C instanceof Ln) d.push(Dm(C, E, b, I));
    else throw Error("non exhaustive match");
  }
  return u;
}
...
function ic(t) {
  if (t instanceof Me || t === "Option") return he.OPTION;
  if (t instanceof Te || t === "Repetition") return he.REPETITION;
  if (t instanceof et || t === "RepetitionMandatory") return he.REPETITION_MANDATORY;
  if (t instanceof tt || t === "RepetitionMandatoryWithSeparator") return he.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (t instanceof Ke || t === "RepetitionWithSeparator") return he.REPETITION_WITH_SEPARATOR;
  if (t instanceof He || t === "Alternation") return he.ALTERNATION;
  throw Error("non exhaustive match");
}
function Kc(t) {
  const { occurrence: e, rule: r, prodType: n, maxLookahead: i } = t,
    a = ic(n);
  return a === he.ALTERNATION ? bs(e, r, i) : _s(e, r, a, i);
}
function Mm(t, e, r, n, i, a) {
  const s = bs(t, e, r),
    o = rd(s) ? ss : Ki;
  return a(s, n, o, i);
}
function Fm(t, e, r, n, i, a) {
  const s = _s(t, e, i, r),
    o = rd(s) ? ss : Ki;
  return a(s[0], o, n);
}
function Gm(t, e, r, n) {
  const i = t.length,
    a = t.every((s) => s.every((o) => o.length === 1));
  if (e)
    return function (s) {
  ...
  if (a && !n) {
    const o = t
      ...
      .reduce(
        (l, c, u) => (
          c.forEach((d) => {
            (d.tokenTypeIdx in l || (l[d.tokenTypeIdx] = u),
              d.categoryMatches.forEach((m) => {
                Object.hasOwn(l, m) || (l[m] = u);
              }));
          }),
          l
        ),
      ...
      for (let s = 0; s < i; s++) {
        ...
        e: for (let c = 0; c < l; c++) {
          const u = o[c],
            d = u.length;
          for (let m = 0; m < d; m++) {
            const h = this.LA_FAST(m + 1);
            if (r(h, u[m]) === !1) continue e;
          }
          return s;
        }
      }
...
class zm extends Ss {
  ...
  walkAtLeastOne(e, r, n) {
    this.checkIsTarget(e, he.REPETITION_MANDATORY, r, n) || super.walkOption(e, r, n);
  }
  walkAtLeastOneSep(e, r, n) {
    this.checkIsTarget(e, he.REPETITION_MANDATORY_WITH_SEPARATOR, r, n) || super.walkOption(e, r, n);
  }
  walkMany(e, r, n) {
    this.checkIsTarget(e, he.REPETITION, r, n) || super.walkOption(e, r, n);
  }
  walkManySep(e, r, n) {
    this.checkIsTarget(e, he.REPETITION_WITH_SEPARATOR, r, n) || super.walkOption(e, r, n);
  }
}
class ed extends xn {
  constructor(e, r, n) {
...
function td(t, e) {
  const r = t.map((s) => So([s], 1)),
    n = Hc(r.length),
    i = r.map((s) => {
      const o = {};
      return (
        s.forEach((l) => {
          Us(l.partialPath).forEach((u) => {
            o[u] = !0;
          });
        }),
        o
  ...
  for (let s = 1; s <= e; s++) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      for (let u = 0; u < c.length; u++) {
        const d = c[u].partialPath,
          m = c[u].suffixDef,
          h = Us(d);
        if (Um(i, h, l) || m.length === 0 || d.length === e) {
          const b = n[l];
          if (wo(b, d) === !1) {
            b.push(d);
...
function bs(t, e, r, n) {
  const i = new ed(t, he.ALTERNATION, n);
  return (e.accept(i), td(i.result, r));
}
function _s(t, e, r, n) {
  const i = new ed(t, r);
  e.accept(i);
  const a = i.result,
    o = new zm(e, t, r).startWalking(),
    l = new Ve({ definition: a }),
    c = new Ve({ definition: o });
  return td([l, c], n);
}
function wo(t, e) {
  e: for (let r = 0; r < t.length; r++) {
    ...
    if (n.length === e.length) {
      for (let i = 0; i < n.length; i++) {
        const a = e[i],
          s = n[i];
        if ((a === s || s.categoryMatchesMap[a.tokenTypeIdx] !== void 0) === !1) continue e;
      }
      return !0;
    }
  }
...
function Bm(t) {
  return t.lookaheadStrategy
    .validate({ rules: t.rules, tokenTypes: t.tokenTypes, grammarName: t.grammarName })
    .map((r) => Object.assign({ type: Be.CUSTOM_LOOKAHEAD_VALIDATION }, r));
}
function Wm(t, e, r, n) {
  const i = t.flatMap((l) => Vm(l, r)),
    a = ig(t, e, r),
    s = t.flatMap((l) => eg(l, r)),
    o = t.flatMap((l) => Xm(l, t, n, r));
...
function Vm(t, e) {
  ...
  const n = r.allProductions,
    i = Object.groupBy(n, Km),
    a = Object.fromEntries(Object.entries(i).filter(([o, l]) => l.length > 1));
  return Object.values(a).map((o) => {
    const l = o[0],
      c = e.buildDuplicateFoundError(t, o),
      u = mt(l),
      d = { message: c, type: Be.DUPLICATE_PRODUCTIONS, ruleName: t.name, dslName: u, occurrence: l.idx },
      m = nd(l);
    return (m && (d.parameter = m), d);
  });
}
function Km(t) {
  return `${mt(t)}_#_${t.idx}_#_${nd(t)}`;
}
function nd(t) {
  return t instanceof se ? t.terminalType.name : t instanceof qe ? t.nonTerminalName : "";
}
class Hm extends xn {
  constructor() {
...
function Xm(t, e, r, n) {
  ...
  if (e.reduce((s, o) => (o.name === t.name ? s + 1 : s), 0) > 1) {
    const s = n.buildDuplicateRuleNameError({ topLevelRule: t, grammarName: r });
    i.push({ message: s, type: Be.DUPLICATE_RULE_NAME, ruleName: t.name });
  }
  return i;
}
function Ym(t, e, r) {
  ...
  return (
    e.includes(t) ||
      ...
      n.push({ message: i, type: Be.INVALID_RULE_OVERRIDE, ruleName: t })),
    n
  );
}
function id(t, e, r, n = []) {
...
function Ka(t) {
  ...
  const r = t[0];
  if (r instanceof qe) e.push(r.referencedRule);
  else if (
    r instanceof Ve ||
    r instanceof Me ||
    r instanceof et ||
    ...
    e = e.concat(Ka(r.definition));
  else if (r instanceof He) e = r.definition.map((a) => Ka(a.definition)).flat();
  else if (!(r instanceof se)) throw Error("non exhaustive match");
  const n = is(r),
    i = t.length > 1;
  if (n && i) {
    const a = t.slice(1);
    return e.concat(Ka(a));
  } else return e;
}
class ac extends xn {
  constructor() {
      ...
      a.definition
        ...
        .flatMap((o, l) =>
          xm([o], [], Ki, 1).length === 0
            ? [
                {
                  message: e.buildEmptyAlternationError({ topLevelRule: t, alternation: a, emptyChoiceIdx: l }),
...
function Zm(t, e, r) {
  ...
  return (
    (i = i.filter((s) => s.ignoreAmbiguities !== !0)),
    i.flatMap((s) => {
      const o = s.idx,
        l = s.maxLookahead || e,
        c = bs(o, t, l, s),
...
function eg(t, e) {
  ...
  return (
    t.accept(r),
    r.alternations.flatMap((a) =>
      a.definition.length > 255
        ? [
            {
              message: e.buildTooManyAlternativesError({ topLevelRule: t, alternation: a }),
...
function tg(t, e, r) {
  ...
  return (
    t.forEach((i) => {
      const a = new Qm();
      (i.accept(a),
        a.allProductions.forEach((o) => {
          const l = ic(o),
            c = o.maxLookahead || e,
            u = o.idx;
          if (_s(u, i, l, c)[0].flat().length === 0) {
            const h = r.buildEmptyRepetitionError({ topLevelRule: i, repetition: o });
            n.push({ message: h, type: Be.NO_NON_EMPTY_LOOKAHEAD, ruleName: i.name });
          }
        }));
    }),
    n
      ...
      (o, l, c) => (
        e.definition[c].ignoreAmbiguities === !0 ||
          l.forEach((u) => {
            const d = [c];
            (t.forEach((m, h) => {
              c !== h && wo(m, u) && e.definition[h].ignoreAmbiguities !== !0 && d.push(h);
            }),
              d.length > 1 && !wo(i, u) && (i.push(u), o.push({ alts: d, path: u })));
          }),
        o
      ),
      []
...
function ng(t, e, r, n) {
  ...
  return i.flatMap((s) => {
    if (e.definition[s.idx].ignoreAmbiguities === !0) return [];
    const l = s.idx,
      c = s.path;
    return i
      .filter((m) => e.definition[m.idx].ignoreAmbiguities !== !0 && m.idx < l && qm(m.path, c))
      .map((m) => {
        const h = [m.idx + 1, l + 1],
          E = e.idx === 0 ? "" : e.idx;
        return {
  ...
  return (
    t.forEach((a) => {
      ...
      if (i.includes(s)) {
        ...
        n.push({ message: o, type: Be.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: s });
      }
    }),
    n
  );
...
function ag(t) {
  const e = Object.assign({ errMsgProvider: bm }, t),
    r = {};
  return (
    t.rules.forEach((n) => {
      r[n.name] = n;
    }),
    _m(r, e.errMsgProvider)
  );
}
function sg(t) {
  var e;
  const r = (e = t.errMsgProvider) !== null && e !== void 0 ? e : wr;
  return Wm(t.rules, t.tokenTypes, r, t.grammarName);
}
const ad = "MismatchedTokenException",
  sd = "NoViableAltException",
  od = "EarlyExitException",
  ld = "NotAllInputParsedException",
  cd = [ad, sd, od, ld];
Object.freeze(cd);
function os(t) {
  return cd.includes(t.name);
}
...
class ud extends Ns {
  constructor(e, r, n) {
    (super(e, r), (this.previousToken = n), (this.name = ad));
  }
}
class og extends Ns {
  constructor(e, r, n) {
    (super(e, r), (this.previousToken = n), (this.name = sd));
  }
}
class lg extends Ns {
  constructor(e, r) {
    (super(e, r), (this.name = ld));
  }
}
class cg extends Ns {
  constructor(e, r, n) {
    (super(e, r), (this.previousToken = n), (this.name = od));
  }
}
const qs = {},
  fd = "InRuleRecoveryException";
class ug extends Error {
  constructor(e) {
    (super(e), (this.name = fd));
  }
}
class fg {
  initRecoverable(e) {
    ((this.firstAfterRepMap = {}),
      (this.resyncFollows = {}),
      (this.recoveryEnabled = Object.hasOwn(e, "recoveryEnabled") ? e.recoveryEnabled : qt.recoveryEnabled),
      this.recoveryEnabled && (this.attemptInRepetitionRecovery = dg));
  }
  getTokenToInsert(e) {
    const r = nc(e, "", NaN, NaN, NaN, NaN, NaN, NaN);
  ...
  tryInRepetitionRecovery(e, r, n, i) {
    ...
    const d = () => {
      const m = this.LA(0),
        ...
        E = new ud(h, c, this.LA(0));
      ((E.resyncedTokens = o.slice(0, -1)), this.SAVE_ERROR(E));
    };
    for (; !l; )
  ...
  getNextPossibleTokenTypes(e) {
    const r = e.ruleStack[0],
      i = this.getGAstProductions()[r];
    return new Pm(i, e).startWalking();
  }
  ...
  canRecoverWithSingleTokenInsertion(e, r) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || r.length === 0) return !1;
  ...
  findReSyncTokenType() {
    ...
    let r = this.LA_FAST(1),
      n = 2;
    for (;;) {
      const i = e.find((a) => Qf(r, a));
      if (i !== void 0) return i;
      ((r = this.LA(n)), n++);
    }
  }
  getCurrFollowKey() {
    if (this.RULE_STACK_IDX === 0) return qs;
  ...
  flattenFollowSet() {
    return this.buildFullFollowKeyStack()
      .map((r) => this.getFollowSetFromFollowKey(r))
      .flat();
  }
  getFollowSetFromFollowKey(e) {
    if (e === qs) return [tr];
    const r = e.ruleName + e.idxInCallingRule + qf + e.inRule;
    return this.resyncFollows[r];
  }
  addToResyncTokens(e, r) {
    return (this.tokenMatcher(e, tr) || r.push(e), r);
  }
  reSyncTo(e) {
    const r = [];
  ...
  getCurrentGrammarPath(e, r) {
    const n = this.getHumanReadableRuleStack(),
      i = this.RULE_OCCURRENCE_STACK.slice(0, this.RULE_OCCURRENCE_STACK_IDX + 1);
    return { ruleStack: n, occurrenceStack: i, lastTok: e, lastTokOccurrence: r };
  }
  getHumanReadableRuleStack() {
    const e = this.RULE_STACK_IDX + 1,
      r = new Array(e);
    for (let n = 0; n < e; n++) r[n] = this.shortRuleNameToFullName(this.RULE_STACK[n]);
    return r;
  }
}
function dg(t, e, r, n, i, a, s) {
  const o = this.getKeyForAutomaticLookahead(n, i);
  let l = this.firstAfterRepMap[o];
  if (l === void 0) {
    const m = this.getCurrRuleFullName(),
      h = this.getGAstProductions()[m];
    ((l = new a(h, i).startWalking()), (this.firstAfterRepMap[o] = l));
  }
  let c = l.token,
    u = l.occurrence;
  const d = l.isEndOfRule;
  (this.RULE_STACK_IDX === 0 && d && c === void 0 && ((c = tr), (u = 1)),
    !(c === void 0 || u === void 0) &&
      this.shouldInRepetitionRecoveryBeTried(c, u, s) &&
...
class sc {
  constructor(e) {
    var r;
    this.maxLookahead = (r = e == null ? void 0 : e.maxLookahead) !== null && r !== void 0 ? r : qt.maxLookahead;
  }
  validate(e) {
  ...
  validateNoLeftRecursion(e) {
    return e.flatMap((r) => id(r, r, wr));
  }
  validateEmptyOrAlternatives(e) {
    return e.flatMap((r) => Jm(r, wr));
  }
  validateAmbiguousAlternationAlternatives(e, r) {
    return e.flatMap((n) => Zm(n, r, wr));
  }
  validateSomeNonEmptyLookaheadPath(e, r) {
    return tg(e, r, wr);
  }
  buildLookaheadForAlternation(e) {
    return Mm(e.prodOccurrence, e.rule, e.maxLookahead, e.hasPredicates, e.dynamicTokensEnabled, Gm);
  }
  buildLookaheadForOptional(e) {
    return Fm(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, ic(e.prodType), jm);
  }
}
class pg {
  initLooksAhead(e) {
    ((this.dynamicTokensEnabled = Object.hasOwn(e, "dynamicTokensEnabled")
      ...
      : qt.dynamicTokensEnabled),
      (this.maxLookahead = Object.hasOwn(e, "maxLookahead") ? e.maxLookahead : qt.maxLookahead),
      (this.lookaheadStrategy = Object.hasOwn(e, "lookaheadStrategy")
        ? e.lookaheadStrategy
        : new sc({ maxLookahead: this.maxLookahead })),
    ...
    e.forEach((r) => {
      this.TRACE_INIT(`${r.name} Rule Lookahead`, () => {
        const {
          ...
          repetition: i,
          option: a,
          repetitionMandatory: s,
          repetitionMandatoryWithSeparator: o,
        ...
        (n.forEach((c) => {
          ...
          this.TRACE_INIT(`${mt(c)}${u}`, () => {
            const d = this.lookaheadStrategy.buildLookaheadForAlternation({
              ...
              m = Bs(this.fullRuleNameToShort[r.name], dd, c.idx);
            this.setLaFuncCache(m, d);
          });
        }),
          i.forEach((c) => {
            this.computeLookaheadFunc(r, c.idx, ko, "Repetition", c.maxLookahead, mt(c));
          }),
          a.forEach((c) => {
            this.computeLookaheadFunc(r, c.idx, hd, "Option", c.maxLookahead, mt(c));
          }),
          s.forEach((c) => {
            this.computeLookaheadFunc(r, c.idx, bo, "RepetitionMandatory", c.maxLookahead, mt(c));
          }),
          o.forEach((c) => {
            this.computeLookaheadFunc(r, c.idx, Ha, "RepetitionMandatoryWithSeparator", c.maxLookahead, mt(c));
          }),
          l.forEach((c) => {
            this.computeLookaheadFunc(r, c.idx, _o, "RepetitionWithSeparator", c.maxLookahead, mt(c));
          }));
      });
    });
  }
  computeLookaheadFunc(e, r, n, i, a, s) {
    this.TRACE_INIT(`${s}${r === 0 ? "" : r}`, () => {
      const o = this.lookaheadStrategy.buildLookaheadForOptional({
        ...
        l = Bs(this.fullRuleNameToShort[e.name], n, r);
      this.setLaFuncCache(l, o);
    });
  }
  getKeyForAutomaticLookahead(e, r) {
    return Bs(this.currRuleShortName, e, r);
  }
...
const Aa = new mg();
function gg(t) {
  (Aa.reset(), t.accept(Aa));
  const e = Aa.dslMethods;
  return (Aa.reset(), e);
}
function Xc(t, e) {
...
const Rg = "name";
function pd(t, e) {
  Object.defineProperty(t, Rg, { enumerable: !1, configurable: !0, writable: !1, value: e });
}
function vg(t, e) {
...
function Eg(t, e) {
  const r = function () {};
  pd(r, t + "BaseSemantics");
  const n = {
    visit: function (i, a) {
      if ((Array.isArray(i) && (i = i[0]), i !== void 0)) return this[i.name](i.children, a);
    },
...
function Ag(t, e, r) {
  const n = function () {};
  pd(n, t + "BaseSemanticsWithDefaults");
...
class Sg {
  ...
  cstPostTerminal(e, r) {
    ...
    (yg(n, r, e), this.setNodeLocationFromToken(n.location, r));
  }
  cstPostNonTerminal(e, r) {
    const n = this.CST_STACK[this.CST_STACK.length - 1];
    (Tg(n, r, e), this.setNodeLocationFromNode(n.location, e.location));
  }
  getBaseCstVisitorConstructor() {
    if (this.baseCstVisitorConstructor === void 0) {
      const e = Eg(this.className, Object.keys(this.gastProductionsCache));
  ...
  getBaseCstVisitorConstructorWithDefaults() {
    if (this.baseCstVisitorWithDefaultsConstructor === void 0) {
      const e = Ag(this.className, Object.keys(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
class wg {
  ...
  SKIP_TOKEN() {
    return this.currIdx <= this.tokVectorLength - 2 ? (this.consumeToken(), this.LA_FAST(1)) : kn;
  }
  LA_FAST(e) {
  ...
  LA(e) {
    const r = this.currIdx + e;
    return r < 0 || this.tokVectorLength <= r ? kn : this.tokVector[r];
  }
  consumeToken() {
    this.currIdx++;
  }
...
class kg {
  ...
  RULE(e, r, n = cs) {
    if (this.definedRulesNames.includes(e)) {
      const s = {
        message: wr.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }),
  ...
  OVERRIDE_RULE(e, r, n = cs) {
    const i = Ym(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return Lp(Object.values(this.gastProductionsCache));
  }
}
class bg {
  initRecognizerEngine(e, r) {
    if (
      ...
      Object.hasOwn(r, "serializedGrammar"))
    )
    ...
    if (Array.isArray(e)) this.tokensMap = e.reduce((a, s) => ((a[s.name] = s), a), {});
    else if (Object.hasOwn(e, "modes") && Object.values(e.modes).flat().every(Sm)) {
      const a = Object.values(e.modes).flat(),
        s = [...new Set(a)];
      this.tokensMap = s.reduce((o, l) => ((o[l.name] = l), o), {});
    } else if (typeof e == "object" && e !== null) this.tokensMap = Object.assign({}, e);
    else
      throw new Error(
    ...
    this.tokensMap.EOF = tr;
    const i = (Object.hasOwn(e, "modes") ? Object.values(e.modes).flat() : Object.values(e)).every((a) => {
      var s;
      return ((s = a.categoryMatches) === null || s === void 0 ? void 0 : s.length) == 0;
    });
    ((this.tokenMatcher = i ? ss : Ki), Hi(Object.values(this.tokensMap)));
  }
  defineRule(e, r, n) {
    if (this.selfAnalysisDone)
      throw Error(`Grammar rule <${e}> may not be defined after the 'performSelfAnalysis' method has been called'
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const i = Object.hasOwn(n, "resyncEnabled") ? n.resyncEnabled : cs.resyncEnabled,
      a = Object.hasOwn(n, "recoveryValueFunc") ? n.recoveryValueFunc : cs.recoveryValueFunc,
      s = this.ruleShortNameIdx << (hg + nr);
  ...
  optionInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(hd, r);
  ...
  atLeastOneInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(bo, e);
  ...
  atLeastOneInternalLogic(e, r, n) {
    ...
    if (i.call(this) === !0) {
      ...
      for (; i.call(this) === !0 && s === !0; ) s = this.doSingleRepetition(a);
    } else throw this.raiseEarlyExitException(e, he.REPETITION_MANDATORY, r.ERR_MSG);
    this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, r], i, bo, e, Lm);
  }
  atLeastOneSepFirstInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(Ha, e);
  ...
  atLeastOneSepFirstInternalLogic(e, r, n) {
    ...
    if (this.getLaFuncFromCache(n).call(this) === !0) {
      ...
      for (; this.tokenMatcher(this.LA_FAST(1), a) === !0; ) (this.CONSUME(a), i.call(this));
      this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal, [e, a, o, i, Vc], o, Ha, e, Vc);
    } else throw this.raiseEarlyExitException(e, he.REPETITION_MANDATORY_WITH_SEPARATOR, r.ERR_MSG);
  }
  manyInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(ko, e);
  ...
  manyInternalLogic(e, r, n) {
    ...
    let s = !0;
    for (; i.call(this) === !0 && s === !0; ) s = this.doSingleRepetition(a);
    this.attemptInRepetitionRecovery(this.manyInternal, [e, r], i, ko, e, Om, s);
  }
  manySepFirstInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(_o, e);
  ...
  manySepFirstInternalLogic(e, r, n) {
    ...
    if (this.getLaFuncFromCache(n).call(this) === !0) {
      ...
      const o = () => this.tokenMatcher(this.LA_FAST(1), a);
      for (; this.tokenMatcher(this.LA_FAST(1), a) === !0; ) (this.CONSUME(a), i.call(this));
      this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal, [e, a, o, i, Wc], o, _o, e, Wc);
    }
  }
  repetitionSepSecondInternal(e, r, n, i, a) {
    for (; n(); ) (this.CONSUME(r), i.call(this));
    this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal, [e, r, n, i, a], n, Ha, e, a);
  }
  ...
  orInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(dd, r),
      i = Array.isArray(e) ? e : e.DEF,
      s = this.getLaFuncFromCache(n).call(this, i);
    if (s !== void 0) return i[s].ALT.call(this);
    this.raiseNoAltException(r, e.ERR_MSG);
  }
  ruleFinallyStateUpdate() {
    (this.RULE_STACK_IDX--,
      this.RULE_OCCURRENCE_STACK_IDX--,
      this.RULE_STACK_IDX >= 0 && (this.currRuleShortName = this.RULE_STACK[this.RULE_STACK_IDX]),
      this.cstFinallyStateUpdate());
  }
  subruleInternal(e, r, n) {
    ...
    try {
      ...
      return (
        (this.subruleIdx = r),
        (i = e.coreRule.apply(this, a)),
        this.cstPostNonTerminal(i, n !== void 0 && n.LABEL !== void 0 ? n.LABEL : e.ruleName),
        i
      );
    } catch (a) {
  ...
  saveRecogState() {
    const e = this.errors,
      r = this.RULE_STACK.slice(0, this.RULE_STACK_IDX + 1);
  ...
  reloadRecogState(e) {
    ...
    for (let n = 0; n < r.length; n++) this.RULE_STACK[n] = r[n];
    ((this.RULE_STACK_IDX = r.length - 1),
      this.RULE_STACK_IDX >= 0 && (this.currRuleShortName = this.RULE_STACK[this.RULE_STACK_IDX]));
  }
  ...
  isAtEndOfInput() {
    return this.tokenMatcher(this.LA(1), tr);
  }
  reset() {
  ...
  onBeforeParse(e) {
    for (let r = 0; r < this.maxLookahead + 1; r++) this.tokVector.push(kn);
  }
  onAfterParse(e) {
    if (this.isAtEndOfInput() === !1) {
      ...
      this.SAVE_ERROR(new lg(n, r));
    }
    for (; this.tokVector.at(-1) === kn; ) this.tokVector.pop();
  }
}
class _g {
  initErrorHandler(e) {
  ...
  raiseEarlyExitException(e, r, n) {
    const i = this.getCurrRuleFullName(),
      ...
      o = _s(e, a, r, this.maxLookahead)[0],
      l = [];
    ...
    throw this.SAVE_ERROR(new cg(c, this.LA(1), this.LA(0)));
  }
  raiseNoAltException(e, r) {
    const n = this.getCurrRuleFullName(),
      i = this.getGAstProductions()[n],
      a = bs(e, i, this.maxLookahead),
      s = [];
    for (let c = 1; c <= this.maxLookahead; c++) s.push(this.LA(c));
    const o = this.LA(0),
    ...
    throw this.SAVE_ERROR(new og(l, this.LA(1), o));
  }
}
const Is = { description: "This Object indicates the Parser is during Recording Phase" };
Object.freeze(Is);
const Jc = !0,
  Zc = Math.pow(2, nr) - 1,
  md = Zf({ name: "RECORDING_PHASE_TOKEN", pattern: We.NA });
Hi([md]);
const gd = nc(
  md,
...
class Ig {
  ...
  topLevelRuleRecord(e, r) {
    try {
      const n = new Ln({ definition: [], name: e });
  ...
  optionInternalRecord(e, r) {
    return ri.call(this, Me, e, r);
  }
  atLeastOneInternalRecord(e, r) {
    ri.call(this, et, r, e);
  }
  atLeastOneSepFirstInternalRecord(e, r) {
    ri.call(this, tt, r, e, Jc);
  }
  manyInternalRecord(e, r) {
    ri.call(this, Te, r, e);
  }
  manySepFirstInternalRecord(e, r) {
    ri.call(this, Ke, r, e, Jc);
  }
  orInternalRecord(e, r) {
    return Pg.call(this, e, r);
  }
  subruleInternalRecord(e, r, n) {
    if ((ls(r), !e || !Object.hasOwn(e, "ruleName"))) {
      const o =
        new Error(`<SUBRULE${Qc(r)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw ((o.KNOWN_RECORDER_ERROR = !0), o);
    }
    const i = this.recordingProdStack.at(-1),
      a = e.ruleName,
      s = new qe({ idx: r, nonTerminalName: a, label: n == null ? void 0 : n.LABEL, referencedRule: void 0 });
    return (i.definition.push(s), this.outputCst ? Ng : Is);
  }
  consumeInternalRecord(e, r, n) {
    if ((ls(r), !Yf(e))) {
      const s =
        new Error(`<CONSUME${Qc(r)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw ((s.KNOWN_RECORDER_ERROR = !0), s);
    }
    const i = this.recordingProdStack.at(-1),
      a = new se({ idx: r, terminalType: e, label: n == null ? void 0 : n.LABEL });
    return (i.definition.push(a), gd);
  }
}
function ri(t, e, r, n = !1) {
  ls(r);
  const i = this.recordingProdStack.at(-1),
    a = typeof e == "function" ? e : e.DEF,
    s = new t({ definition: [], idx: r });
  return (
    n && (s.separator = e.SEP),
    Object.hasOwn(e, "MAX_LOOKAHEAD") && (s.maxLookahead = e.MAX_LOOKAHEAD),
...
function Pg(t, e) {
  ls(e);
  const r = this.recordingProdStack.at(-1),
    n = Array.isArray(t) === !1,
    i = n === !1 ? t : t.DEF,
    a = new He({ definition: [], idx: e, ignoreAmbiguities: n && t.IGNORE_AMBIGUITIES === !0 });
  ...
  return (
    ...
    r.definition.push(a),
    i.forEach((o) => {
      const l = new Ve({ definition: [] });
      (a.definition.push(l),
        Object.hasOwn(o, "IGNORE_AMBIGUITIES")
          ? (l.ignoreAmbiguities = o.IGNORE_AMBIGUITIES)
          : Object.hasOwn(o, "GATE") && (l.ignoreAmbiguities = !0),
...
function ls(t) {
  if (t < 0 || t > Zc) {
	...
	Idx value must be a none negative value smaller than ${Zc + 1}`);
...
class Og {
  initPerformanceTracer(e) {
    ...
    } else ((this.traceInitMaxIdent = 0), (this.traceInitPerf = qt.traceInitPerf));
    this.traceInitIndent = -1;
  }
  TRACE_INIT(e, r) {
    if (this.traceInitPerf === !0) {
      ...
      this.traceInitIndent < this.traceInitMaxIdent;
      const { time: i, value: a } = zf(r),
        s = i > 10 ? console.warn : console.log;
      return (
        this.traceInitIndent < this.traceInitMaxIdent && s(`${n}<-- <${e}> time: ${i}ms`),
        this.traceInitIndent--,
        a
      );
    } else return r();
...
const kn = nc(tr, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(kn);
const qt = Object.freeze({
  ...
  cs = Object.freeze({ recoveryValueFunc: () => {}, resyncEnabled: !0 });
var Be;
(function (t) {
    ...
    this.TRACE_INIT("performSelfAnalysis", () => {
        ...
        this.TRACE_INIT("Grammar Recording", () => {
          try {
            (this.enableRecording(),
              this.definedRulesNames.forEach((i) => {
      ...
      if (
        (this.TRACE_INIT("Grammar Resolving", () => {
          ((n = ag({ rules: Object.values(this.gastProductionsCache) })),
        ...
        this.definitionErrors.length === 0 &&
          (this.recoveryEnabled &&
            this.TRACE_INIT("computeAllProdsFollows", () => {
              const i = zp(Object.values(this.gastProductionsCache));
          ...
          this.TRACE_INIT("ComputeLookaheadFunctions", () => {
            ...
            ((a = (i = this.lookaheadStrategy).initialize) === null ||
              a === void 0 ||
              a.call(i, { rules: Object.values(this.gastProductionsCache) }),
              this.preComputeLookaheadFunctions(Object.values(this.gastProductionsCache)));
          })),
        !Xi.DEFER_DEFINITION_ERRORS_HANDLING && this.definitionErrors.length !== 0)
      )
        throw (
          (e = this.definitionErrors.map((i) => i.message)),
...
`)}`)
  ...
  constructor(e, r) {
    ...
    if (
      ...
      Object.hasOwn(r, "ignoredIssues"))
    )
      throw new Error(`The <ignoredIssues> IParserConfig property has been deprecated.
	Please use the <IGNORE_AMBIGUITIES> flag on the relevant DSL method instead.
	See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#IGNORING_AMBIGUITIES
	For further details.`);
    this.skipValidations = Object.hasOwn(r, "skipValidations") ? r.skipValidations : qt.skipValidations;
  }
}
Xi.DEFER_DEFINITION_ERRORS_HANDLING = !1;
Lg(Xi, [fg, pg, Sg, wg, bg, kg, _g, Ig, Og]);
class xg extends Xi {
  constructor(e, r = qt) {
...
function qg(t, e, r) {
  const n = _e(t, e, r, { type: Td });
  ir(t, n);
  const i = Dn(t, e, n, r, Lr(t, e, r));
  return $d(t, e, r, i);
}
function Bg(t, e, r) {
  const n = _e(t, e, r, { type: Td });
  ir(t, n);
  const i = Dn(t, e, n, r, Lr(t, e, r)),
    a = uc(t, e, r.separator, r);
  return $d(t, e, r, i, a);
}
function Wg(t, e, r) {
  const n = _e(t, e, r, { type: yd });
  ir(t, n);
  const i = Dn(t, e, n, r, Lr(t, e, r));
  return Ad(t, e, r, i);
}
...
function Kg(t, e, r) {
  const n = _e(t, e, r, { type: rr });
  ir(t, n);
  const i = Gt(r.definition, (s) => Ed(t, e, s));
  return Dn(t, e, n, r, ...i);
}
function Hg(t, e, r) {
  const n = _e(t, e, r, { type: rr });
...
function Lr(t, e, r) {
  const n = bh(
    Gt(r.definition, (i) => Ed(t, e, i)),
    (i) => i !== void 0
  );
  return n.length === 1 ? n[0] : n.length === 0 ? void 0 : Jg(t, n);
}
function Ad(t, e, r, n, i) {
  const a = n.left,
    ...
    o = _e(t, e, r, { type: jg });
  ir(t, o);
  const l = _e(t, e, r, { type: Rd });
  return (
    (a.loopback = o),
    (l.loopback = o),
    (t.decisionMap[bn(e, i ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", r.idx)] = o),
    Se(s, o),
    i === void 0 ? (Se(o, a), Se(o, l)) : (Se(o, l), Se(o, i.left), Se(i.right, a)),
    { left: a, right: l }
  );
}
function $d(t, e, r, n, i) {
  ...
  return (
    ...
    Se(o, l),
    Se(s, c),
    i !== void 0 ? (Se(c, l), Se(c, i.left), Se(i.right, a)) : Se(c, o),
    (t.decisionMap[bn(e, i ? "RepetitionWithSeparator" : "Repetition", r.idx)] = o),
    { left: o, right: l }
  );
}
function Xg(t, e, r, n) {
  const i = n.left,
    a = n.right;
  return (Se(i, a), (t.decisionMap[bn(e, "Option", r.idx)] = i), n);
}
function ir(t, e) {
  return (t.decisionStates.push(e), (e.decision = t.decisionStates.length - 1), e.decision);
}
function Dn(t, e, r, n, ...i) {
  const a = _e(t, e, n, { type: Mg, start: r });
  r.end = a;
  for (const o of i) o !== void 0 ? (Se(r, o.left), Se(o.right, a)) : Se(r, a);
  const s = { left: r, right: a };
  return ((t.decisionMap[bn(e, Yg(n), n.idx)] = r), s);
}
function Yg(t) {
  if (t instanceof He) return "Alternation";
  if (t instanceof Me) return "Option";
  if (t instanceof Te) return "Repetition";
  if (t instanceof Ke) return "RepetitionWithSeparator";
  if (t instanceof et) return "RepetitionMandatory";
  if (t instanceof tt) return "RepetitionMandatoryWithSeparator";
...
function Jg(t, e) {
  ...
  for (let a = 0; a < r - 1; a++) {
    ...
    const l = o instanceof cc,
      c = o,
      u = e[a + 1].left;
    s.left.type === rr &&
    s.right.type === rr &&
    o !== void 0 &&
    ((l && c.followState === s.right) || o.target === s.right)
      ? (l ? (c.followState = u) : (o.target = u), ey(t, s.right))
      : Se(s.right, u);
  }
  const n = e[0],
    i = e[r - 1];
...
function uc(t, e, r, n) {
  const i = _e(t, e, n, { type: rr }),
    a = _e(t, e, n, { type: rr });
  return (fc(i, new lc(a, r)), { left: i, right: a });
}
function Zg(t, e, r) {
  const n = r.referencedRule,
    i = t.ruleToStartState.get(n),
    a = _e(t, e, r, { type: rr }),
    s = _e(t, e, r, { type: rr }),
    o = new cc(i, n, s);
  return (fc(a, o), { left: a, right: s });
}
function Qg(t, e, r) {
  const n = t.ruleToStartState.get(e);
  Se(n, r.left);
  const i = t.ruleToStopState.get(e);
  return (Se(r.right, i), { left: n, right: i });
}
function Se(t, e) {
  const r = new vd(e);
  fc(t, r);
...
class Io {
  ...
  get alts() {
    return Gt(this.configs, (e) => e.alt);
  }
  get key() {
    let e = "";
...
function ty(t, e) {
  ...
  return (n) => {
    const i = n.toString();
    let a = r[i];
    return (a !== void 0 || ((a = { atnStartState: t, decision: e, states: {} }), (r[i] = a)), a);
  };
}
class Sd {
  constructor() {
...
class ry extends sc {
  constructor(e) {
    var r;
    (super(), (this.logging = (r = e == null ? void 0 : e.logging) !== null && r !== void 0 ? r : (n) => {}));
  }
  initialize(e) {
    ((this.atn = zg(e.rules)), (this.dfas = ny(this.atn)));
  }
  ...
  buildLookaheadForAlternation(e) {
    const { prodOccurrence: r, rule: n, hasPredicates: i, dynamicTokensEnabled: a } = e,
      s = this.dfas,
      o = this.logging,
      l = bn(n, "Alternation", r),
      u = this.atn.decisionMap[l].decision,
      d = Gt(Kc({ maxLookahead: 1, occurrence: r, prodType: "Alternation", rule: n }), (m) => Gt(m, (h) => h[0]));
    if (ru(d, !1) && !a) {
      const m = Rc(
        d,
        (h, E, b) => (
      ...
      return i
        ? function (h) {
            ...
            if (h !== void 0 && I !== void 0) {
              const C = (E = h[I]) === null || E === void 0 ? void 0 : E.GATE;
              if (C !== void 0 && C.call(this) === !1) return;
            }
            return I;
          }
        : function () {
            const h = this.LA_FAST(1);
            return m[h.tokenTypeIdx];
          };
    } else
      return i
        ? function (m) {
            const h = new Sd(),
              E = m === void 0 ? 0 : m.length;
            for (let I = 0; I < E; I++) {
              const C = m == null ? void 0 : m[I].GATE;
              h.set(I, C === void 0 || C.call(this));
            }
            const b = Ws.call(this, s, u, h, o);
            return typeof b == "number" ? b : void 0;
          }
        : function () {
            const m = Ws.call(this, s, u, tu, o);
            return typeof m == "number" ? m : void 0;
          };
  }
  buildLookaheadForOptional(e) {
    const { prodOccurrence: r, rule: n, prodType: i, dynamicTokensEnabled: a } = e,
      s = this.dfas,
      o = this.logging,
      l = bn(n, i, r),
      u = this.atn.decisionMap[l].decision,
      d = Gt(Kc({ maxLookahead: 1, occurrence: r, prodType: i, rule: n }), (m) => Gt(m, (h) => h[0]));
    if (ru(d) && d[0][0] && !a) {
      const m = d[0],
        h = $h(m);
      if (h.length === 1 && _h(h[0].categoryMatches)) {
        const b = h[0].tokenTypeIdx;
        return function () {
...
function ny(t) {
  const e = t.decisionStates.length,
    r = Array(e);
  for (let n = 0; n < e; n++) r[n] = ty(t.decisionStates[n], n);
  return r;
}
function Ws(t, e, r, n) {
  const i = t[e](r);
  let a = i.start;
  if (a === void 0) {
    const o = py(i.atnStartState);
    ((a = kd(i, wd(o))), (i.start = a));
  }
  return iy.apply(this, [i, a, r, n]);
}
function iy(t, e, r, n) {
  let i = e,
    a = 1;
  ...
  for (;;) {
    let l = uy(i, o);
    if ((l === void 0 && (l = ay.apply(this, [t, i, o, a, r, n])), l === us)) return cy(s, i, o);
    if (l.isAcceptState === !0) return l.prediction;
    ((i = l), s.push(o), (o = this.LA(a++)));
  }
}
function ay(t, e, r, n, i, a) {
  const s = fy(e.configs, r, i);
  if (s.size === 0) return (nu(t, e, r, us), us);
  let o = wd(s);
  const l = hy(s, i);
  if (l !== void 0) ((o.isAcceptState = !0), (o.prediction = l), (o.configs.uniqueAlt = l));
  else if (Ty(s)) {
    const c = Ch(s.alts);
    ((o.isAcceptState = !0), (o.prediction = c), (o.configs.uniqueAlt = c), sy.apply(this, [t, n, s.alts, a]));
  }
  return ((o = nu(t, e, r, o)), o);
}
function sy(t, e, r, n) {
  const i = [];
  for (let c = 1; c <= e; c++) i.push(this.LA(c).tokenType);
  const a = t.atnStartState,
    s = a.rule,
    o = a.production,
    l = oy({ topLevelRule: s, ambiguityIndices: r, production: o, prefixPath: i });
  n(l);
}
function oy(t) {
  const e = Gt(t.prefixPath, (i) => sn(i)).join(", "),
    r = t.production.idx === 0 ? "" : t.production.idx;
  let n = `Ambiguous Alternatives Detected: <${t.ambiguityIndices.join(", ")}> in <${ly(t.production)}${r}> inside <${t.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
  return (
    (n =
...
function cy(t, e, r) {
  const n = Nh(e.configs.elements, (a) => a.state.transitions),
    i = Ih(
      n.filter((a) => a instanceof lc).map((a) => a.tokenType),
      (a) => a.tokenTypeIdx
    );
...
function fy(t, e, r) {
  ...
  for (const s of t.elements) {
    ...
    for (let l = 0; l < o; l++) {
      const c = s.state.transitions[l],
        u = dy(c, e);
      u !== void 0 && n.add({ state: u, alt: s.alt, stack: s.stack });
    }
  }
  let a;
  if ((i.length === 0 && n.size === 1 && (a = n), a === void 0)) {
    a = new Io();
    for (const s of n.elements) fs(s, a);
  }
  if (i.length > 0 && !gy(a)) for (const s of i) a.add(s);
  return a;
}
function dy(t, e) {
  if (t instanceof lc && Qf(e, t.tokenType)) return t.target;
}
function hy(t, e) {
  let r;
...
function nu(t, e, r, n) {
  return ((n = kd(t, n)), (e.edges[r.tokenTypeIdx] = n), n);
}
function kd(t, e) {
  if (e === us) return e;
...
function py(t) {
  ...
  for (let n = 0; n < r; n++) {
    const a = { state: t.transitions[n].target, alt: n, stack: [] };
    fs(a, e);
  }
  return e;
}
function fs(t, e) {
  ...
  if (r.type === Yi) {
    if (t.stack.length > 0) {
      const i = [...t.stack],
        s = { state: i.pop(), alt: t.alt, stack: i };
      fs(s, e);
    } else e.add(t);
    return;
  }
  ...
  for (let i = 0; i < n; i++) {
    const a = r.transitions[i],
      s = my(t, a);
    s !== void 0 && fs(s, e);
  }
}
function my(t, e) {
  if (e instanceof vd) return { state: e.target, alt: t.alt, stack: t.stack };
  if (e instanceof cc) {
...
function gy(t) {
  for (const e of t.elements) if (e.state.type === Yi) return !0;
  return !1;
}
function yy(t) {
  for (const e of t.elements) if (e.state.type !== Yi) return !1;
  return !0;
}
function Ty(t) {
  if (yy(t)) return !0;
  const e = Ry(t.elements);
  return vy(e) && !Ey(e);
}
function Ry(t) {
  const e = new Map();
...
(function (t) {
  function e(n, i) {
    return (
      n === Number.MAX_VALUE && (n = Oi.MAX_VALUE),
      i === Number.MAX_VALUE && (i = Oi.MAX_VALUE),
      { line: n, character: i }
    );
  }
  t.create = e;
...
(function (t) {
  function e(n, i, a, s) {
    ...
    if (Z.is(n) && Z.is(i)) return { start: n, end: i };
...
(function (t) {
  ...
  function r(n) {
    let i = n;
    return v.objectLiteral(i) && K.is(i.range) && (v.string(i.uri) || v.undefined(i.uri));
  }
  t.is = r;
})(Li || (Li = {}));
var Lo;
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.objectLiteral(i) &&
      K.is(i.targetRange) &&
      v.string(i.targetUri) &&
      K.is(i.targetSelectionRange) &&
      (K.is(i.originSelectionRange) || v.undefined(i.originSelectionRange))
    );
  }
  t.is = r;
})(Lo || (Lo = {}));
...
(function (t) {
  function e(n, i, a, s) {
    return { red: n, green: i, blue: a, alpha: s };
  }
  t.create = e;
  function r(n) {
    const i = n;
    return (
      v.objectLiteral(i) &&
      v.numberRange(i.red, 0, 1) &&
      v.numberRange(i.green, 0, 1) &&
      v.numberRange(i.blue, 0, 1) &&
      v.numberRange(i.alpha, 0, 1)
    );
  }
  t.is = r;
})(hs || (hs = {}));
...
(function (t) {
  ...
  function r(n) {
    const i = n;
    return v.objectLiteral(i) && K.is(i.range) && hs.is(i.color);
  }
  t.is = r;
})(xo || (xo = {}));
var Do;
(function (t) {
  function e(n, i, a) {
    return { label: n, textEdit: i, additionalTextEdits: a };
  }
  t.create = e;
  function r(n) {
    const i = n;
    return (
      v.objectLiteral(i) &&
      v.string(i.label) &&
      (v.undefined(i.textEdit) || yt.is(i)) &&
      (v.undefined(i.additionalTextEdits) || v.typedArray(i.additionalTextEdits, yt.is))
    );
  }
  t.is = r;
})(Do || (Do = {}));
...
(function (t) {
  function e(n, i, a, s, o, l) {
    const c = { startLine: n, endLine: i };
    return (
      v.defined(a) && (c.startCharacter = a),
      v.defined(s) && (c.endCharacter = s),
      v.defined(o) && (c.kind = o),
      v.defined(l) && (c.collapsedText = l),
      c
    );
  }
  t.create = e;
  function r(n) {
    ...
    return (
      v.objectLiteral(i) &&
      v.uinteger(i.startLine) &&
      v.uinteger(i.startLine) &&
      (v.undefined(i.startCharacter) || v.uinteger(i.startCharacter)) &&
      (v.undefined(i.endCharacter) || v.uinteger(i.endCharacter)) &&
      (v.undefined(i.kind) || v.string(i.kind))
    );
  }
  t.is = r;
})(Fo || (Fo = {}));
...
(function (t) {
  ...
  function r(n) {
    let i = n;
    return v.defined(i) && Li.is(i.location) && v.string(i.message);
  }
  t.is = r;
})(ps || (ps = {}));
var Go;
...
(function (t) {
  function e(n, i, a, s, o, l) {
    ...
    return (
      v.defined(a) && (c.severity = a),
      v.defined(s) && (c.code = s),
      v.defined(o) && (c.source = o),
      v.defined(l) && (c.relatedInformation = l),
      c
    );
  }
  t.create = e;
  function r(n) {
    ...
    return (
      ...
      K.is(a.range) &&
      v.string(a.message) &&
      (v.number(a.severity) || v.undefined(a.severity)) &&
      (v.integer(a.code) || v.string(a.code) || v.undefined(a.code)) &&
      (v.undefined(a.codeDescription) ||
        v.string((i = a.codeDescription) === null || i === void 0 ? void 0 : i.href)) &&
      (v.string(a.source) || v.undefined(a.source)) &&
      (v.undefined(a.relatedInformation) || v.typedArray(a.relatedInformation, ps.is))
    );
  }
  t.is = r;
})(xi || (xi = {}));
...
(function (t) {
  ...
  function i(a) {
    const s = a;
    return v.objectLiteral(s) && v.string(s.newText) && K.is(s.range);
  }
  t.is = i;
})(yt || (yt = {}));
var kr;
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.objectLiteral(i) &&
      v.string(i.label) &&
      (v.boolean(i.needsConfirmation) || i.needsConfirmation === void 0) &&
      (v.string(i.description) || i.description === void 0)
    );
  }
  t.is = r;
})(kr || (kr = {}));
...
(function (t) {
  ...
  function i(a) {
    const s = a;
    return yt.is(s) && (kr.is(s.annotationId) || De.is(s.annotationId));
  }
  t.is = i;
})(Ft || (Ft = {}));
var Di;
...
(function (t) {
  function e(n, i, a) {
    let s = { kind: "create", uri: n };
    return (
      i !== void 0 && (i.overwrite !== void 0 || i.ignoreIfExists !== void 0) && (s.options = i),
  ...
  function r(n) {
    ...
    return (
      ...
      v.string(i.uri) &&
      (i.options === void 0 ||
        ((i.options.overwrite === void 0 || v.boolean(i.options.overwrite)) &&
          (i.options.ignoreIfExists === void 0 || v.boolean(i.options.ignoreIfExists)))) &&
      (i.annotationId === void 0 || De.is(i.annotationId))
    );
  }
  t.is = r;
})(_n || (_n = {}));
...
(function (t) {
  function e(n, i, a, s) {
    let o = { kind: "rename", oldUri: n, newUri: i };
    return (
      a !== void 0 && (a.overwrite !== void 0 || a.ignoreIfExists !== void 0) && (o.options = a),
...
(function (t) {
  function e(n, i, a) {
    let s = { kind: "delete", uri: n };
    return (
      i !== void 0 && (i.recursive !== void 0 || i.ignoreIfNotExists !== void 0) && (s.options = i),
      a !== void 0 && (s.annotationId = a),
      s
    );
  }
  ...
  function r(n) {
    ...
    return (
      ...
      v.string(i.uri) &&
      (i.options === void 0 ||
        ((i.options.recursive === void 0 || v.boolean(i.options.recursive)) &&
          (i.options.ignoreIfNotExists === void 0 || v.boolean(i.options.ignoreIfNotExists)))) &&
      (i.annotationId === void 0 || De.is(i.annotationId))
    );
  }
  t.is = r;
  ...
  function e(r) {
    ...
    return (
      ...
      (n.documentChanges === void 0 ||
        n.documentChanges.every((i) => (v.string(i.kind) ? _n.is(i) || Nn.is(i) || In.is(i) : Di.is(i))))
    );
  }
  t.is = e;
})(ms || (ms = {}));
...
class Ay {
    ...
    ((this._textEditChanges = Object.create(null)),
      e !== void 0
        ? ((this._workspaceEdit = e),
          e.documentChanges
            ? ((this._changeAnnotations = new iu(e.changeAnnotations)),
              (e.changeAnnotations = this._changeAnnotations.all()),
              e.documentChanges.forEach((r) => {
                if (Di.is(r)) {
                  const n = new $a(r.edits, this._changeAnnotations);
                  this._textEditChanges[r.textDocument.uri] = n;
                }
              }))
            : e.changes &&
              Object.keys(e.changes).forEach((r) => {
                const n = new $a(e.changes[r]);
  ...
  getTextEditChange(e) {
    if (Mi.is(e)) {
      ...
      if (!n) {
        const i = [],
          a = { textDocument: r, edits: i };
        (this._workspaceEdit.documentChanges.push(a),
          (n = new $a(i, this._changeAnnotations)),
      ...
      if (!r) {
        let n = [];
        ((this._workspaceEdit.changes[e] = n), (r = new $a(n)), (this._textEditChanges[e] = r));
      }
      return r;
    }
  }
  initDocumentChanges() {
    this._workspaceEdit.documentChanges === void 0 &&
      ...
      ((this._changeAnnotations = new iu()),
  ...
  createFile(e, r, n) {
    ...
    if (
      (i === void 0
        ? (a = _n.create(e, n))
        : ((s = De.is(i) ? i : this._changeAnnotations.manage(i)), (a = _n.create(e, n, s))),
      this._workspaceEdit.documentChanges.push(a),
      s !== void 0)
    )
      return s;
  ...
  renameFile(e, r, n, i) {
    ...
    if (
      (a === void 0
        ? (s = Nn.create(e, r, i))
        : ((o = De.is(a) ? a : this._changeAnnotations.manage(a)), (s = Nn.create(e, r, i, o))),
  ...
  deleteFile(e, r, n) {
    ...
    if (
      (i === void 0
        ? (a = In.create(e, n))
        : ((s = De.is(i) ? i : this._changeAnnotations.manage(i)), (a = In.create(e, n, s))),
      this._workspaceEdit.documentChanges.push(a),
      s !== void 0)
    )
      return s;
...
(function (t) {
  function e(r) {
    const n = r;
    return v.objectLiteral(r) && gs.is(n.kind) && v.string(n.value);
  }
  t.is = e;
})(Pn || (Pn = {}));
var Wo;
...
(function (t) {
  ...
  function r(n) {
    const i = n;
    return i && v.string(i.newText) && K.is(i.insert) && K.is(i.replace);
  }
  t.is = r;
})(Ho || (Ho = {}));
var Xo;
...
(function (t) {
  function e(r) {
    ...
    return (
      !!n &&
      v.objectLiteral(n) &&
      (Pn.is(n.contents) || Fi.is(n.contents) || v.typedArray(n.contents, Fi.is)) &&
      (r.range === void 0 || K.is(r.range))
    );
  }
  t.is = e;
})(Qo || (Qo = {}));
...
(function (t) {
  function e(r, n, i, a, s) {
    let o = { name: r, kind: n, location: { uri: a, range: i } };
...
(function (t) {
  function e(r, n, i, a) {
    return a !== void 0
      ? { name: r, kind: n, location: { uri: i, range: a } }
...
(function (t) {
  function e(n, i, a, s, o, l) {
    let c = { name: n, detail: i, kind: a, range: s, selectionRange: o };
  ...
  function r(n) {
    ...
    return (
      ...
      v.number(i.kind) &&
      K.is(i.range) &&
      K.is(i.selectionRange) &&
      (i.detail === void 0 || v.string(i.detail)) &&
      (i.deprecated === void 0 || v.boolean(i.deprecated)) &&
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.defined(i) &&
      v.typedArray(i.diagnostics, xi.is) &&
      (i.only === void 0 || v.typedArray(i.only, v.string)) &&
      (i.triggerKind === void 0 || i.triggerKind === Gi.Invoked || i.triggerKind === Gi.Automatic)
    );
  }
  t.is = r;
})(ul || (ul = {}));
...
(function (t) {
  function e(n, i, a) {
    let s = { title: n },
      o = !0;
    return (
      typeof i == "string" ? ((o = !1), (s.kind = i)) : Pr.is(i) ? (s.command = i) : (s.edit = i),
      o && a !== void 0 && (s.kind = a),
      s
    );
  }
  ...
  function r(n) {
    ...
    return (
      i &&
      v.string(i.title) &&
      (i.diagnostics === void 0 || v.typedArray(i.diagnostics, xi.is)) &&
      (i.kind === void 0 || v.string(i.kind)) &&
      (i.edit !== void 0 || i.command !== void 0) &&
      (i.command === void 0 || Pr.is(i.command)) &&
      (i.isPreferred === void 0 || v.boolean(i.isPreferred)) &&
      (i.edit === void 0 || ms.is(i.edit))
    );
  }
  t.is = r;
})(fl || (fl = {}));
...
(function (t) {
  ...
  function r(n) {
    let i = n;
    return v.defined(i) && K.is(i.range) && (v.undefined(i.command) || Pr.is(i.command));
  }
  t.is = r;
})(dl || (dl = {}));
var hl;
...
(function (t) {
  ...
  function r(n) {
    let i = n;
    return v.defined(i) && K.is(i.range) && (v.undefined(i.target) || v.string(i.target));
  }
  t.is = r;
})(pl || (pl = {}));
var ml;
(function (t) {
  ...
  function r(n) {
    let i = n;
    return v.objectLiteral(i) && K.is(i.range) && (i.parent === void 0 || t.is(i.parent));
  }
  t.is = r;
})(ml || (ml = {}));
var gl;
...
(function (t) {
  ...
  function r(n) {
    const i = n;
    return i != null && K.is(i.range) && v.string(i.text);
  }
  t.is = r;
})(Rl || (Rl = {}));
var vl;
(function (t) {
  ...
  function r(n) {
    ...
    return (
      i != null &&
      K.is(i.range) &&
      v.boolean(i.caseSensitiveLookup) &&
      (v.string(i.variableName) || i.variableName === void 0)
    );
  }
  t.is = r;
})(vl || (vl = {}));
...
(function (t) {
  ...
  function r(n) {
    const i = n;
    return i != null && K.is(i.range) && (v.string(i.expression) || i.expression === void 0);
  }
  t.is = r;
})(El || (El = {}));
var Al;
(function (t) {
  ...
  function r(n) {
    const i = n;
    return v.defined(i) && K.is(n.stoppedLocation);
  }
  t.is = r;
})(Al || (Al = {}));
var ys;
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      v.objectLiteral(i) &&
      (i.tooltip === void 0 || v.string(i.tooltip) || Pn.is(i.tooltip)) &&
      (i.location === void 0 || Li.is(i.location)) &&
      (i.command === void 0 || Pr.is(i.command))
    );
  }
  t.is = r;
...
(function (t) {
  ...
  function r(n) {
    ...
    return (
      (v.objectLiteral(i) &&
        Z.is(i.position) &&
        (v.string(i.label) || v.typedArray(i.label, Ts.is)) &&
        (i.kind === void 0 || ys.is(i.kind)) &&
        i.textEdits === void 0) ||
      (v.typedArray(i.textEdits, yt.is) &&
        (i.tooltip === void 0 || v.string(i.tooltip) || Pn.is(i.tooltip)) &&
        (i.paddingLeft === void 0 || v.boolean(i.paddingLeft)) &&
        (i.paddingRight === void 0 || v.boolean(i.paddingRight)))
    );
  }
  t.is = r;
})($l || ($l = {}));
...
(function (t) {
  function e(r) {
    const n = r;
    return v.objectLiteral(n) && ds.is(n.uri) && v.string(n.name);
  }
  t.is = e;
})(Nl || (Nl = {}));
const $y = [
...
(function (t) {
  ...
  function r(a) {
    ...
    return !!(
      v.defined(s) &&
      v.string(s.uri) &&
      (v.undefined(s.languageId) || v.string(s.languageId)) &&
      v.uinteger(s.lineCount) &&
      v.func(s.getText) &&
      v.func(s.positionAt) &&
      v.func(s.offsetAt)
    );
  ...
  function n(a, s) {
    ...
    for (let u = l.length - 1; u >= 0; u--) {
      let d = l[u],
        m = a.offsetAt(d.range.start),
        h = a.offsetAt(d.range.end);
      if (h <= c) o = o.substring(0, m) + d.newText + o.substring(h, o.length);
  ...
  function i(a, s) {
    ...
    let u = 0,
      d = 0,
      m = 0;
    for (; u < l.length && d < c.length; ) s(l[u], c[d]) <= 0 ? (a[m++] = l[u++]) : (a[m++] = c[d++]);
    for (; u < l.length; ) a[m++] = l[u++];
    for (; d < c.length; ) a[m++] = c[d++];
    return a;
  }
})(Il || (Il = {}));
let Cy = class {
...
` &&
  ...
  offsetAt(e) {
    ...
    let n = r[e.line],
      i = e.line + 1 < r.length ? r[e.line + 1] : this._content.length;
...
(function (t) {
  ...
  t.number = s;
  function o(h, E, b) {
    return e.call(h) === "[object Number]" && E <= h && h <= b;
  }
  t.numberRange = o;
  function l(h) {
  ...
  t.objectLiteral = d;
  function m(h, E) {
    return Array.isArray(h) && h.every(E);
  }
  t.typedArray = m;
})(v || (v = {}));
...
class wy {
  ...
  buildLeafNode(e, r) {
    const n = new Pl(e.startOffset, e.image.length, Eo(e), e.tokenType, !r);
  ...
  addHiddenNodes(e) {
    const r = [];
    for (const a of e) {
      const s = new Pl(a.startOffset, a.image.length, Eo(a), a.tokenType, !0);
...
class dc extends bd {
  constructor() {
    (super(...arguments), (this.content = new hc(this)));
  }
  get offset() {
    var e;
  ...
  get range() {
    ...
    } else return { start: Z.create(0, 0), end: Z.create(0, 0) };
  }
...
class hc extends Array {
  constructor(e) {
    (super(), (this.parent = e), Object.setPrototypeOf(this, hc.prototype));
  }
  push(...e) {
...
const Ol = Symbol("Datatype");
function Vs(t) {
  return t.$type === Ol;
}
const au = "​",
  Nd = (t) => (t.endsWith(au) ? t : t + au);
class Id {
  constructor(e) {
    var i;
    ...
    (i = e.shared.profilers.LangiumProfiler) != null && i.isActive("parsing")
      ? (this.wrapper = new Iy(
          r,
          { ...e.parser.ParserConfig, skipValidations: n, errorMessageProvider: e.parser.ParserErrorMessageProvider },
          e.shared.profilers.LangiumProfiler.createTask("parsing", e.LanguageMetaData.languageId)
        ))
      : (this.wrapper = new Od(r, {
...
class ky extends Id {
  ...
  rule(e, r) {
    ...
    let i;
    es(e) && ((i = e.name), this.registerPrecedenceMap(e));
    const a = this.wrapper.DEFINE_RULE(Nd(e.name), this.startImplementation(n, i, r).bind(this));
    return (this.allRules.set(e.name, a), Bt(e) && e.entry && (this.mainRule = a), a);
  }
  registerPrecedenceMap(e) {
    ...
    for (let i = 0; i < e.operators.precedences.length; i++) {
      ...
      for (const s of a.operators) n.set(s.value, { precedence: i, rightAssoc: a.associativity === "right" });
    }
    this.operatorPrecedence.set(r, n);
  }
  computeRuleType(e) {
    return es(e) ? Pi(e) : e.fragment ? void 0 : Ff(e) ? Ol : Pi(e);
  }
  parse(e, r = {}) {
    ...
    return (
      ...
      ho(a, { deep: !0 }),
      { value: a, lexerErrors: n.errors, lexerReport: n.report, parserErrors: this.wrapper.errors }
    );
  }
  doParse(e) {
  ...
  startImplementation(e, r, n) {
    return (i) => {
      ...
      if (a) {
        const s = { $type: e };
        (this.stack.push(s), e === Ol ? (s.value = "") : r !== void 0 && (s.$infixName = r));
      }
  ...
  consume(e, r, n) {
    ...
    if (!this.isRecording() && this.isValidToken(i)) {
      ...
      const s = this.nodeBuilder.buildLeafNode(i, n),
        { assignment: o, crossRef: l } = this.getAssignment(n),
        c = this.current;
      if (o) {
        const u = _r(n) ? i.image : this.converter.convert(i.image, s);
        this.assign(o.operator, o.feature, u, s, l);
      } else if (Vs(c)) {
        let u = i.image;
        (_r(n) || (u = this.converter.convert(u, s).toString()), (c.value += u));
      }
    }
  }
  isValidToken(e) {
  ...
  subrule(e, r, n, i, a) {
    ...
    try {
      ...
      this.isRecording() ||
        ...
        o !== void 0 && s && s.length > 0 && this.performSubruleAssignment(o, i, s));
    }
  }
  performSubruleAssignment(e, r, n) {
    const { assignment: i, crossRef: a } = this.getAssignment(r);
    if (i) this.assign(i.operator, i.feature, e, n, a);
    else if (!i) {
      const s = this.current;
      if (Vs(s)) s.value += e.toString();
  ...
  constructInfix(e, r) {
    ...
    const i = e.operators;
    if (!Array.isArray(i) || n.length < 2) return n[0];
    let a = 0,
      s = -1;
    for (let b = 0; b < i.length; b++) {
      const I = i[b],
        C = r.get(I) ?? { precedence: 1 / 0, rightAssoc: !1 };
      C.precedence > s ? ((s = C.precedence), (a = b)) : C.precedence === s && (C.rightAssoc || (a = b));
    }
    const o = i.slice(0, a),
      l = i.slice(a + 1),
      c = n.slice(0, a + 1),
      u = n.slice(a + 1),
      d = { $infixName: e.$infixName, $type: e.$type, $cstNode: e.$cstNode, parts: c, operators: o },
      m = { $infixName: e.$infixName, $type: e.$type, $cstNode: e.$cstNode, parts: u, operators: l },
      h = this.constructInfix(d, r),
      E = this.constructInfix(m, r);
    return { $type: e.$type, $cstNode: e.$cstNode, left: h, operator: i[a], right: E };
  }
  getAssignment(e) {
    if (!this.assignmentMap.has(e)) {
      ...
      this.assignmentMap.set(e, {
        assignment: r,
        crossRef: r && As(r.terminal) ? (r.terminal.isMulti ? "multi" : "single") : void 0,
      });
    }
  ...
  assign(e, r, n, i, a) {
    ...
    let o;
    switch (
      (a === "single" && typeof n == "string"
        ? (o = this.linker.buildReference(s, r, i, n))
        : a === "multi" && typeof n == "string"
          ? (o = this.linker.buildMultiReference(s, r, i, n))
          : (o = n),
      e)
    ) {
      case "=": {
...
class by {
  buildMismatchTokenMessage(e) {
    return nn.buildMismatchTokenMessage(e);
  }
  buildNotAllInputParsedMessage(e) {
    return nn.buildNotAllInputParsedMessage(e);
  }
  buildNoViableAltMessage(e) {
    return nn.buildNoViableAltMessage(e);
  }
  buildEarlyExitMessage(e) {
    return nn.buildEarlyExitMessage(e);
  }
}
class Pd extends by {
...
class _y extends Id {
  ...
  rule(e, r) {
    const n = this.wrapper.DEFINE_RULE(Nd(e.name), this.startImplementation(r).bind(this));
...
const Ny = { recoveryEnabled: !0, nodeLocationTracking: "full", skipValidations: !0, errorMessageProvider: new Pd() };
class Od extends xg {
  constructor(e, r) {
    ...
    super(e, {
      ...Ny,
      lookaheadStrategy: n
        ? new sc({ maxLookahead: r.maxLookahead })
        : new ry({ logging: r.skipValidations ? () => {} : void 0 }),
      ...r,
    });
  }
  get IS_RECORDING() {
...
function Ld(t, e, r) {
  return (Py({ parser: e, tokens: r, ruleNames: new Map() }, t), e);
}
function Py(t, e) {
  const r = Of(e, !1),
    n = de(e.rules)
      ...
      .filter((a) => r.has(a));
  for (const a of n) {
    const s = { ...t, consume: 1, optional: 1, subrule: 1, many: 1, or: 1 };
    t.parser.rule(a, Or(s, a.definition));
  }
  const i = de(e.rules)
    .filter(es)
    .filter((a) => r.has(a));
  for (const a of i) t.parser.rule(a, Oy(t, a));
}
function Oy(t, e) {
  const r = e.call.rule.ref;
  if (!r) throw new Error("Could not resolve reference to infix operator rule: " + e.call.rule.$refText);
  if (Wt(r)) throw new Error("Cannot use terminal rule in infix expression");
  const n = e.operators.precedences.flatMap((h) => h.operators),
    i = { $type: "Group", elements: [] },
    a = { $container: i, $type: "Assignment", feature: "parts", operator: "+=", terminal: e.call },
    s = { $container: i, $type: "Group", elements: [], cardinality: "*" };
  i.elements.push(a, s);
  const l = {
      $container: s,
      $type: "Assignment",
    ...
    c = { ...a, $container: s };
  s.elements.push(l, c);
  const d = n.map((h) => t.tokens[h.value]).map((h, E) => ({ ALT: () => t.parser.consume(E, h, l) }));
  let m;
  return (h) => {
    (m ?? (m = pc(t, r)),
      t.parser.subrule(0, m, !1, a, h),
      t.parser.many(0, {
        DEF: () => {
          (t.parser.alternatives(0, d), t.parser.subrule(1, m, !1, c, h));
        },
      }));
  };
}
function Or(t, e, r = !1) {
  let n;
  if (_r(e)) n = jy(t, e);
  else if (Es(e)) n = Ly(t, e);
  else if (br(e)) n = Or(t, e.terminal);
  else if (As(e)) n = xd(t, e);
  else if (Nr(e)) n = xy(t, e);
  else if (wf(e)) n = My(t, e);
  else if (bf(e)) n = Fy(t, e);
  else if (Zl(e)) n = Gy(t, e);
  else if (jh(e)) {
    const i = t.consume++;
    n = () => t.parser.consume(i, tr, e);
  } else throw new Nf(e.$cstNode, `Unexpected element type: ${e.$type}`);
  return Dd(t, r ? void 0 : Rs(e), n, e.cardinality);
}
function Ly(t, e) {
  const r = Pi(e);
...
function xy(t, e) {
  ...
  if (Bi(r)) {
    const n = t.subrule++,
      i = Bt(r) && r.fragment,
      a = e.arguments.length > 0 ? Dy(r, e.arguments) : () => ({});
    let s;
    return (o) => {
      (s ?? (s = pc(t, r)), t.parser.subrule(n, s, i, e, a(o)));
    };
  } else if (Wt(r)) {
    const n = t.consume++,
      i = Ll(t, r.name);
  ...
  else throw new Nf(e.$cstNode, `Undefined rule: ${e.rule.$refText}`);
}
function Dy(t, e) {
  if (e.some((n) => n.calledByName)) {
    ...
    return (i) => {
      const a = {};
      for (const { parameterName: s, predicate: o } of n) s && (a[s] = o(i));
      return a;
    };
  } else {
...
function My(t, e) {
  if (e.elements.length === 1) return Or(t, e.elements[0]);
  {
    const r = [];
    for (const i of e.elements) {
      const a = { ALT: Or(t, i, !0) },
        s = Rs(i);
        ...
        r.map((l, c) => {
          ...
          u.ALT = () => {
            if ((l.ALT(o), !d.isRecording())) {
              ...
              const E = d.unorderedGroups.get(h);
              typeof (E == null ? void 0 : E[c]) > "u" && (E[c] = !0);
            }
          };
          const m = l.GATE;
          return (
            m
              ? (u.GATE = () => m(o))
              : (u.GATE = () => {
                  const h = d.unorderedGroups.get(i(n, d));
                  return !(h != null && h[c]);
                }),
            u
          );
...
function Gy(t, e) {
  const r = e.elements.map((n) => Or(t, n));
  return (n) => r.forEach((i) => i(n));
}
function Rs(t) {
  if (Zl(t)) return t.guardCondition;
}
function xd(t, e, r = e.terminal) {
  if (r)
    if (Nr(r) && Bt(r.rule.ref)) {
      const n = r.rule.ref,
        i = t.subrule++;
      let a;
      return (s) => {
        (a ?? (a = pc(t, n)), t.parser.subrule(i, a, !1, e, s));
      };
    } else if (Nr(r) && Wt(r.rule.ref)) {
      const n = t.consume++,
        i = Ll(t, r.rule.ref.name);
      return () => t.parser.consume(n, i, e);
    } else if (_r(r)) {
      const n = t.consume++,
        i = Ll(t, r.value);
    ...
    const n = Df(e.type.ref),
      i = n == null ? void 0 : n.terminal;
    if (!i) throw new Error("Could not find name assignment for type: " + Pi(e.type.ref));
    return xd(t, e, i);
  }
}
function jy(t, e) {
...
function Dd(t, e, r, n) {
  ...
  if (n === "*") {
    const a = t.many++;
    return (s) => t.parser.many(a, { DEF: () => r(s), GATE: i ? () => i(s) : void 0 });
  } else if (n === "+") {
    const a = t.many++;
    if (i) {
      const s = t.or++;
      return (o) =>
        t.parser.alternatives(s, [
          { ALT: () => t.parser.atLeastOne(a, { DEF: () => r(o) }), GATE: () => i(o) },
          { ALT: eu(), GATE: () => !i(o) },
        ]);
    } else return (s) => t.parser.atLeastOne(a, { DEF: () => r(s) });
  } else if (n === "?") {
    const a = t.optional++;
    return (s) => t.parser.optional(a, { DEF: () => r(s), GATE: i ? () => i(s) : void 0 });
  } else Wi();
}
function pc(t, e) {
  const r = zy(t, e),
...
function zy(t, e) {
  ...
  if (t.ruleNames.has(e)) return t.ruleNames.get(e);
  {
    let r = e,
      ...
      i = e.$type;
    for (; !Bt(n); )
      ((Zl(n) || wf(n) || bf(n)) && (i = n.elements.indexOf(r).toString() + ":" + i), (r = n), (n = n.$container));
...
class Md {
  ...
  buildTokens(e, r) {
    const n = de(Of(e, !1)),
      ...
      a = this.buildKeywordTokens(n, i, r);
    return (a.push(...i), a);
  }
  flushLexingReport(e) {
  ...
  buildTerminalToken(e) {
    const r = ec(e),
      ...
      i = { name: e.name, PATTERN: n };
    return (typeof n == "function" && (i.LINE_BREAKS = !0), e.hidden && (i.GROUP = Pf(r) ? We.SKIPPED : "hidden"), i);
  }
  ...
  buildKeywordTokens(e, r, n) {
    return e
      .filter(Bi)
      .flatMap((i) => qi(i).filter(_r))
      .distinct((i) => i.value)
      .toArray()
      .sort((i, a) => a.value.length - i.value.length)
      .map((i) => this.buildKeywordToken(i, r, !!(n != null && n.caseInsensitive)));
  }
  buildKeywordToken(e, r, n) {
    const i = this.buildKeywordPattern(e, n),
      a = { name: e.value, PATTERN: i, LONGER_ALT: this.findLongerAlt(e, r) };
    return (typeof i == "function" && (a.LINE_BREAKS = !0), a);
  }
  buildKeywordPattern(e, r) {
    return r ? new RegExp(Cs(e.value), "i") : e.value;
  }
  findLongerAlt(e, r) {
    return r.reduce((n, i) => {
      const a = i == null ? void 0 : i.PATTERN;
      return (a != null && a.source && pp("^" + a.source + "$", e.value) && n.push(i), n);
    }, []);
  }
}
class Fd {
  ...
  runConverter(e, r, n) {
    ...
    switch (e.name.toUpperCase()) {
      case "INT":
        return Dt.convertInt(r);
      case "STRING":
        return Dt.convertString(r);
      case "ID":
        return Dt.convertID(r);
    }
    switch ((i = Sp(e)) == null ? void 0 : i.toLowerCase()) {
      case "number":
        return Dt.convertNumber(r);
      case "boolean":
        return Dt.convertBoolean(r);
      case "bigint":
        return Dt.convertBigint(r);
      case "date":
        return Dt.convertDate(r);
      default:
        return r;
    }
  }
...
function xr() {
  if (su) return Ca;
  ((su = 1), Object.defineProperty(Ca, "__esModule", { value: !0 }));
  let t;
  function e() {
    if (t === void 0) throw new Error("No runtime abstraction layer installed");
    return t;
  }
  return (
    (function (r) {
...
function Ji() {
  ...
  ((ou = 1),
    ...
    (Pe.stringArray = Pe.array = Pe.func = Pe.error = Pe.number = Pe.string = Pe.boolean = void 0));
  function t(o) {
    return o === !0 || o === !1;
  }
  Pe.boolean = t;
...
function Mn() {
  if (lu) return lr;
  ((lu = 1), Object.defineProperty(lr, "__esModule", { value: !0 }), (lr.Emitter = lr.Event = void 0));
  const t = xr();
  var e;
  (function (i) {
    const a = { dispose() {} };
  ...
  class r {
    add(a, s = null, o) {
      (this._callbacks || ((this._callbacks = []), (this._contexts = [])),
        ...
        Array.isArray(o) && o.push({ dispose: () => this.remove(a, s) }));
    }
    remove(a, s = null) {
      ...
      if (o) throw new Error("When adding a listener with a context, you should remove it with the same context");
    }
    invoke(...a) {
      if (!this._callbacks) return [];
      const s = [],
        o = this._callbacks.slice(0),
        l = this._contexts.slice(0);
        ...
        this._event ||
          (this._event = (a, s, o) => {
            (this._callbacks || (this._callbacks = new r()),
              ...
              this._callbacks.add(a, s));
            const l = {
              dispose: () => {
                this._callbacks &&
                  (this._callbacks.remove(a, s),
                  (l.dispose = n._noop),
                  this._options &&
  ...
  return ((lr.Emitter = n), (n._noop = function () {}), lr);
}
var cu;
function Ps() {
  if (cu) return or;
  ((cu = 1),
    ...
    (or.CancellationTokenSource = or.CancellationToken = void 0));
  const t = xr(),
    e = Ji(),
    r = Mn();
  var n;
  (function (o) {
    ((o.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: r.Event.None })),
      (o.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: r.Event.None })));
    function l(c) {
      const u = c;
      return (
        u &&
        (u === o.None || u === o.Cancelled || (e.boolean(u.isCancellationRequested) && !!u.onCancellationRequested))
      );
    }
    o.is = l;
  })(n || (or.CancellationToken = n = {}));
  ...
  return ((or.CancellationTokenSource = s), or);
}
var pe = Ps();
function Wy() {
...
let Xa = 0,
  Vy = 10;
function Ky() {
  return ((Xa = performance.now()), new pe.CancellationTokenSource());
}
const an = Symbol("OperationCancelled");
function Os(t) {
  return t === an;
}
async function Ue(t) {
  if (t === pe.CancellationToken.None) return;
  const e = performance.now();
  if ((e - Xa >= Vy && ((Xa = e), await Wy(), (Xa = performance.now())), t.isCancellationRequested)) throw an;
}
class mc {
  constructor() {
...
class ji {
  ...
  update(e, r) {
    for (const n of e)
      if (ji.isIncremental(n)) {
        ...
        const u = uu(n.text, !1, a);
        if (l - o === u.length) for (let m = 0, h = u.length; m < h; m++) c[m + o + 1] = u[m];
        else
          u.length < 1e4
            ? c.splice(o + 1, l - o, ...u)
            : (this._lineOffsets = c = c.slice(0, o + 1).concat(u, c.slice(l + 1)));
        const d = n.text.length - (s - a);
        if (d !== 0) for (let m = o + 1 + u.length, h = c.length; m < h; m++) c[m] = c[m] + d;
      } else if (ji.isFull(n)) ((this._content = n.text), (this._lineOffsets = void 0));
      else throw new Error("Unknown change event received");
    this._version = r;
  }
  getLineOffsets() {
    return (this._lineOffsets === void 0 && (this._lineOffsets = uu(this._content, !0)), this._lineOffsets);
  }
  positionAt(e) {
    e = Math.max(Math.min(e, this._content.length), 0);
  ...
  offsetAt(e) {
    ...
    const i = e.line + 1 < r.length ? r[e.line + 1] : this._content.length,
      a = Math.min(n + e.character, i);
    return this.ensureBeforeEOL(a, n);
  }
  ensureBeforeEOL(e, r) {
    for (; e > r && Gd(this._content.charCodeAt(e - 1)); ) e--;
    return e;
  }
  get lineCount() {
    return this.getLineOffsets().length;
...
(function (t) {
  function e(i, a, s, o) {
    return new ji(i, a, s, o);
  }
  t.create = e;
  function r(i, a, s) {
    if (i instanceof ji) return (i.update(a, s), i);
  ...
  function n(i, a) {
    const s = i.getText(),
      o = Dl(a.map(Hy), (u, d) => {
        const m = u.range.start.line - d.range.start.line;
        return m === 0 ? u.range.start.character - d.range.start.character : m;
      });
    let l = 0;
    const c = [];
...
function Dl(t, e) {
  ...
  let a = 0,
    s = 0,
    o = 0;
  for (; a < n.length && s < i.length; ) e(n[a], i[s]) <= 0 ? (t[o++] = n[a++]) : (t[o++] = i[s++]);
  for (; a < n.length; ) t[o++] = n[a++];
  for (; s < i.length; ) t[o++] = i[s++];
  return t;
}
function uu(t, e, r = 0) {
  const n = e ? [r] : [];
  for (let i = 0; i < t.length; i++) {
    ...
    Gd(a) && (a === 13 && i + 1 < t.length && t.charCodeAt(i + 1) === 10 && i++, n.push(r + i + 1));
  }
  return n;
}
function Gd(t) {
...
(() => {
  var t = {
      975: (_) => {
        ...
        function g(y, T) {
          for (var A, L = "", D = 0, x = -1, j = 0, F = 0; F <= y.length; ++F) {
            if (F < y.length) A = y.charCodeAt(F);
            else {
              if (A === 47) break;
              A = 47;
            }
                ...
                if (x !== F - 1 && j === 2) {
                  if (
                    ...
                    if (L.length > 2) {
                      ...
                      if (te !== L.length - 1) {
                        (te === -1 ? ((L = ""), (D = 0)) : (D = (L = L.slice(0, te)).length - 1 - L.lastIndexOf("/")),
                          (x = F),
                          (j = 0));
                        continue;
                      }
        ...
        var $ = {
          resolve: function () {
            for (var y, T = "", A = !1, L = arguments.length - 1; L >= -1 && !A; L--) {
              var D;
              (L >= 0 ? (D = arguments[L]) : (y === void 0 && (y = process.cwd()), (D = y)),
                R(D),
                D.length !== 0 && ((T = D + "/" + T), (A = D.charCodeAt(0) === 47)));
            }
            return ((T = g(T, !A)), A ? (T.length > 0 ? "/" + T : "/") : T.length > 0 ? T : ".");
          },
          normalize: function (y) {
            if ((R(y), y.length === 0)) return ".";
            var T = y.charCodeAt(0) === 47,
              A = y.charCodeAt(y.length - 1) === 47;
            return ((y = g(y, !T)).length !== 0 || T || (y = "."), y.length > 0 && A && (y += "/"), T ? "/" + y : y);
          },
          ...
          join: function () {
            ...
            for (var y, T = 0; T < arguments.length; ++T) {
              var A = arguments[T];
              (R(A), A.length > 0 && (y === void 0 ? (y = A) : (y += "/" + A)));
            }
            return y === void 0 ? "." : $.normalize(y);
          },
          relative: function (y, T) {
            if ((R(y), R(T), y === T || (y = $.resolve(y)) === (T = $.resolve(T)))) return "";
            for (var A = 1; A < y.length && y.charCodeAt(A) === 47; ++A);
            for (var L = y.length, D = L - A, x = 1; x < T.length && T.charCodeAt(x) === 47; ++x);
            for (var j = T.length - x, F = D < j ? D : j, te = -1, z = 0; z <= F; ++z) {
              if (z === F) {
                if (j > F) {
                  if (T.charCodeAt(x + z) === 47) return T.slice(x + z + 1);
                  if (z === 0) return T.slice(x + z);
                } else D > F && (y.charCodeAt(A + z) === 47 ? (te = z) : z === 0 && (te = 0));
                break;
              }
              var Q = y.charCodeAt(A + z);
              if (Q !== T.charCodeAt(x + z)) break;
              Q === 47 && (te = z);
            }
            var Ne = "";
            for (z = A + te + 1; z <= L; ++z)
              (z !== L && y.charCodeAt(z) !== 47) || (Ne.length === 0 ? (Ne += "..") : (Ne += "/.."));
            return Ne.length > 0 ? Ne + T.slice(x + te) : ((x += te), T.charCodeAt(x) === 47 && ++x, T.slice(x));
          },
          ...
          dirname: function (y) {
            if ((R(y), y.length === 0)) return ".";
            for (var T = y.charCodeAt(0), A = T === 47, L = -1, D = !0, x = y.length - 1; x >= 1; --x)
              if ((T = y.charCodeAt(x)) === 47) {
                if (!D) {
                  L = x;
                  break;
                }
              } else D = !1;
            return L === -1 ? (A ? "/" : ".") : A && L === 1 ? "//" : y.slice(0, L);
          },
            ...
            if (T !== void 0 && T.length > 0 && T.length <= y.length) {
              ...
              for (A = y.length - 1; A >= 0; --A) {
                ...
                if (te === 47) {
                  ...
                  (F === -1 && ((x = !1), (F = A + 1)),
                    j >= 0 && (te === T.charCodeAt(j) ? --j == -1 && (D = A) : ((j = -1), (D = F))));
              }
              return (L === D ? (D = F) : D === -1 && (D = y.length), y.slice(L, D));
            }
            for (A = y.length - 1; A >= 0; --A)
              if (y.charCodeAt(A) === 47) {
                if (!x) {
                  L = A + 1;
                  break;
                }
          ...
          extname: function (y) {
            R(y);
            for (var T = -1, A = 0, L = -1, D = !0, x = 0, j = y.length - 1; j >= 0; --j) {
              var F = y.charCodeAt(j);
              if (F !== 47)
                (L === -1 && ((D = !1), (L = j + 1)),
                  F === 46 ? (T === -1 ? (T = j) : x !== 1 && (x = 1)) : T !== -1 && (x = -1));
              else if (!D) {
                A = j + 1;
                break;
              }
            }
            return T === -1 || L === -1 || x === 0 || (x === 1 && T === L - 1 && T === A + 1) ? "" : y.slice(T, L);
          },
          format: function (y) {
            if (y === null || typeof y != "object")
              throw new TypeError('The "pathObject" argument must be of type Object. Received type ' + typeof y);
            return (function (T, A) {
              var L = A.dir || A.root,
                D = A.base || (A.name || "") + (A.ext || "");
              return L ? (L === A.root ? L + D : L + "/" + D) : D;
            })(0, y);
          },
          parse: function (y) {
            R(y);
            ...
            var A,
              ...
              D = L === 47;
            D ? ((T.root = "/"), (A = 1)) : (A = 0);
            for (var x = -1, j = 0, F = -1, te = !0, z = y.length - 1, Q = 0; z >= A; --z)
              if ((L = y.charCodeAt(z)) !== 47)
                (F === -1 && ((te = !1), (F = z + 1)),
                  L === 46 ? (x === -1 ? (x = z) : Q !== 1 && (Q = 1)) : x !== -1 && (Q = -1));
              else if (!te) {
                j = z + 1;
                break;
              }
            return (
              x === -1 || F === -1 || Q === 0 || (Q === 1 && x === F - 1 && x === j + 1)
                ? F !== -1 && (T.base = T.name = j === 0 && D ? y.slice(1, F) : y.slice(j, F))
                : (j === 0 && D
                    ? ((T.name = y.slice(1, x)), (T.base = y.slice(1, F)))
                    : ((T.name = y.slice(j, x)), (T.base = y.slice(j, F))),
                  (T.ext = y.slice(x, F))),
              j > 0 ? (T.dir = y.slice(0, j - 1)) : D && (T.dir = "/"),
              T
            );
          },
          sep: "/",
  ...
  function r(_) {
    ...
    var g = (e[_] = { exports: {} });
    return (t[_](g, g.exports, r), g.exports);
  }
  ((r.d = (_, R) => {
    for (var g in R) r.o(R, g) && !r.o(_, g) && Object.defineProperty(_, g, { enumerable: !0, get: R[g] });
  }),
    (r.o = (_, R) => Object.prototype.hasOwnProperty.call(_, R)),
    (r.r = (_) => {
      (typeof Symbol < "u" && Symbol.toStringTag && Object.defineProperty(_, Symbol.toStringTag, { value: "Module" }),
        Object.defineProperty(_, "__esModule", { value: !0 }));
    }));
  var n = {};
  let i;
  (r.r(n),
    r.d(n, { URI: () => m, Utils: () => le }),
  ...
  function l(_, R) {
    if (!_.scheme && R)
      throw new Error(
        `[UriError]: Scheme is missing: {scheme: "", authority: "${_.authority}", path: "${_.path}", query: "${_.query}", fragment: "${_.fragment}"}`
      );
  ...
  class m {
    constructor(R, g, $, y, T, A = !1) {
      ...
      Jt(this, "fragment");
      typeof R == "object"
        ? ((this.scheme = R.scheme || c),
          (this.authority = R.authority || c),
          (this.path = R.path || c),
          (this.query = R.query || c),
          (this.fragment = R.fragment || c))
        : ((this.scheme = (function (L, D) {
            return L || D ? L : "file";
          })(R, A)),
          (this.authority = g || c),
          (this.path = (function (L, D) {
            switch (L) {
              case "https":
              case "http":
              case "file":
    ...
    static isUri(R) {
      return (
        ...
        (!!R &&
          ...
          typeof R.fragment == "string" &&
          typeof R.path == "string" &&
          typeof R.query == "string" &&
          typeof R.scheme == "string" &&
          typeof R.fsPath == "string" &&
          typeof R.with == "function" &&
    ...
    with(R) {
      if (!R) return this;
      let { scheme: g, authority: $, path: y, query: T, fragment: A } = R;
      return (
        g === void 0 ? (g = this.scheme) : g === null && (g = c),
        $ === void 0 ? ($ = this.authority) : $ === null && ($ = c),
        y === void 0 ? (y = this.path) : y === null && (y = c),
        T === void 0 ? (T = this.query) : T === null && (T = c),
        A === void 0 ? (A = this.fragment) : A === null && (A = c),
        g === this.scheme && $ === this.authority && y === this.path && T === this.query && A === this.fragment
          ? this
          : new E(g, $, y, T, A)
      );
    }
    static parse(R, g = !1) {
      const $ = d.exec(R);
      return $ ? new E($[2] || c, B($[4] || c), B($[5] || c), B($[7] || c), B($[9] || c), g) : new E(c, c, c, c, c);
    }
    static file(R) {
      let g = c;
      if ((i && (R = R.replace(/\\/g, u)), R[0] === u && R[1] === u)) {
        const $ = R.indexOf(u, 2);
        $ === -1 ? ((g = R.substring(2)), (R = u)) : ((g = R.substring(2, $)), (R = R.substring($) || u));
      }
      return new E("file", g, R, c, c);
    }
    static from(R) {
      const g = new E(R.scheme, R.authority, R.path, R.query, R.fragment);
      return (l(g, !0), g);
    }
    toString(R = !1) {
      return S(this, R);
    ...
    static revive(R) {
      if (R) {
        ...
        {
          const g = new E(R);
          return ((g._formatted = R.external), (g._fsPath = R._sep === h ? R.fsPath : null), g);
        }
      }
      return R;
    }
  ...
  class E extends m {
    constructor() {
      super(...arguments);
      Jt(this, "_formatted", null);
      Jt(this, "_fsPath", null);
    }
    get fsPath() {
      return (this._fsPath || (this._fsPath = w(this)), this._fsPath);
    }
    toString(g = !1) {
      return g ? S(this, !0) : (this._formatted || (this._formatted = S(this, !1)), this._formatted);
    }
    toJSON() {
      const g = { $mid: 1 };
      return (
        this._fsPath && ((g.fsPath = this._fsPath), (g._sep = h)),
  ...
  function I(_, R, g) {
    ...
    for (let T = 0; T < _.length; T++) {
      ...
      if (
        ...
        (y !== -1 && (($ += encodeURIComponent(_.substring(y, T))), (y = -1)), $ !== void 0 && ($ += _.charAt(T)));
      else {
        $ === void 0 && ($ = _.substr(0, T));
        const L = b[A];
        L !== void 0
          ? (y !== -1 && (($ += encodeURIComponent(_.substring(y, T))), (y = -1)), ($ += L))
          : y === -1 && (y = T);
      }
    }
    return (y !== -1 && ($ += encodeURIComponent(_.substring(y))), $ !== void 0 ? $ : _);
  }
  function C(_) {
    let R;
    for (let g = 0; g < _.length; g++) {
      const $ = _.charCodeAt(g);
      $ === 35 || $ === 63 ? (R === void 0 && (R = _.substr(0, g)), (R += b[$])) : R !== void 0 && (R += _[g]);
    }
    return R !== void 0 ? R : _;
  }
  function w(_, R) {
    ...
    return (
      (g =
        _.authority && _.path.length > 1 && _.scheme === "file"
          ? `//${_.authority}${_.path}`
          : _.path.charCodeAt(0) === 47 &&
              ((_.path.charCodeAt(1) >= 65 && _.path.charCodeAt(1) <= 90) ||
                (_.path.charCodeAt(1) >= 97 && _.path.charCodeAt(1) <= 122)) &&
              _.path.charCodeAt(2) === 58
            ? _.path[1].toLowerCase() + _.path.substr(2)
            : _.path),
      i && (g = g.replace(/\//g, "\\")),
      g
    );
  ...
  function S(_, R) {
    const g = R ? C : I;
    let $ = "",
      { scheme: y, authority: T, path: A, query: L, fragment: D } = _;
    if ((y && (($ += y), ($ += ":")), (T || y === "file") && (($ += u), ($ += u)), T)) {
      let x = T.indexOf("@");
      if (x !== -1) {
        const j = T.substr(0, x);
        ((T = T.substr(x + 1)),
          (x = j.lastIndexOf(":")),
          x === -1
            ? ($ += g(j, !1, !1))
            : (($ += g(j.substr(0, x), !1, !1)), ($ += ":"), ($ += g(j.substr(x + 1), !1, !0))),
          ($ += "@"));
      }
      ((T = T.toLowerCase()),
        (x = T.lastIndexOf(":")),
        x === -1 ? ($ += g(T, !1, !0)) : (($ += g(T.substr(0, x), !1, !0)), ($ += T.substr(x))));
    }
    if (A) {
      if (A.length >= 3 && A.charCodeAt(0) === 47 && A.charCodeAt(2) === 58) {
        const x = A.charCodeAt(1);
        x >= 65 && x <= 90 && (A = `/${String.fromCharCode(x + 32)}:${A.substr(3)}`);
      } else if (A.length >= 2 && A.charCodeAt(1) === 58) {
        const x = A.charCodeAt(0);
        x >= 65 && x <= 90 && (A = `${String.fromCharCode(x + 32)}:${A.substr(2)}`);
      }
      $ += g(A, !0, !1);
    }
    return (L && (($ += "?"), ($ += g(L, !1, !1))), D && (($ += "#"), ($ += R ? D : I(D, !1, !1))), $);
  }
  function P(_) {
    try {
  ...
  function B(_) {
    return _.match(W) ? _.replace(W, (R) => P(R)) : _;
  }
  var H = r(975);
  const ne = H.posix || H,
    oe = "/";
  var le;
  ((function (_) {
    ((_.joinPath = function (R, ...g) {
      return R.with({ path: ne.join(R.path, ...g) });
    }),
      (_.resolvePath = function (R, ...g) {
        let $ = R.path,
          y = !1;
        $[0] !== oe && (($ = oe + $), (y = !0));
        let T = ne.resolve($, ...g);
        return (y && T[0] === oe && !R.authority && (T = T.substring(1)), R.with({ path: T }));
      }),
      (_.dirname = function (R) {
        if (R.path.length === 0 || R.path === oe) return R;
        let g = ne.dirname(R.path);
        return (g.length === 1 && g.charCodeAt(0) === 46 && (g = ""), R.with({ path: g }));
      }),
      (_.basename = function (R) {
        return ne.basename(R.path);
      }),
      (_.extname = function (R) {
        return ne.extname(R.path);
      }));
  })(le || (le = {})),
    (zd = n));
})();
const { URI: ft, Utils: ni } = zd;
var Qe;
(function (t) {
  ((t.basename = ni.basename),
    (t.dirname = ni.dirname),
    (t.extname = ni.extname),
    (t.joinPath = ni.joinPath),
    (t.resolvePath = ni.resolvePath));
  ...
  t.equals = r;
  function n(s, o) {
    const l = typeof s == "string" ? ft.parse(s).path : s.path,
      c = typeof o == "string" ? ft.parse(o).path : o.path,
      u = l.split("/").filter((b) => b.length > 0),
      d = c.split("/").filter((b) => b.length > 0);
    if (e) {
      const b = /^[A-Z]:$/;
      if (
        (u[0] && b.test(u[0]) && (u[0] = u[0].toLowerCase()),
        d[0] && b.test(d[0]) && (d[0] = d[0].toLowerCase()),
        u[0] !== d[0])
      )
        return c.substring(1);
    }
    let m = 0;
    for (; m < u.length && u[m] === d[m]; m++);
    const h = "../".repeat(u.length - m),
      E = d.slice(m).join("/");
    return h + E;
  }
  t.relative = n;
  ...
  t.normalize = i;
  function a(s, o) {
    let l = typeof s == "string" ? s : s.path,
      c = typeof o == "string" ? o : o.path;
    return (
...
class Xy {
  ...
  findNode(e) {
    const r = this.normalizeUri(e),
      n = this.getNode(r, !1);
    if (n) return { name: n.name, uri: Qe.joinPath(ft.parse(r), n.name).toString(), element: n.element };
  }
  findChildren(e) {
    const r = this.normalizeUri(e),
      n = this.getNode(r, !1);
    return n
      ? Array.from(n.children.values()).map((i) => ({
          name: i.name,
  ...
  getNode(e, r) {
    ...
    for (const a of n) {
      ...
      if (!s)
        if (r) ((s = { name: a, children: new Map(), parent: i }), i.children.set(a, s));
        else return;
      i = s;
    }
    return i;
...
class Yy {
  ...
  async fromUri(e, r = pe.CancellationToken.None) {
    const n = await this.fileSystemProvider.readFile(e);
    return this.createAsync(e, n, r);
  }
  fromTextDocument(e, r, n) {
    return ((r = r ?? ft.parse(e.uri)), pe.CancellationToken.is(n) ? this.createAsync(r, e, n) : this.create(r, e, n));
  }
  fromString(e, r, n) {
    return pe.CancellationToken.is(n) ? this.createAsync(r, e, n) : this.create(r, e, n);
  }
  fromModel(e, r) {
  ...
  createLangiumDocument(e, r, n, i) {
    let a;
    if (n) a = { parseResult: e, uri: r, state: V.Parsed, references: [], textDocument: n };
    else {
  ...
  async update(e, r) {
    var s, o;
    const n = (s = e.parseResult.value.$cstNode) == null ? void 0 : s.root.fullText,
      i = (o = this.textDocuments) == null ? void 0 : o.get(e.uri.toString()),
      a = i ? i.getText() : await this.fileSystemProvider.readFile(e.uri);
    ...
    return (
      n !== a && ((e.parseResult = await this.parseAsync(e.uri, a, r)), (e.parseResult.value.$document = e)),
      (e.state = V.Parsed),
      e
    );
  }
  ...
  createTextDocumentGetter(e, r) {
    ...
    let i;
    return () => i ?? (i = xl.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, r ?? ""));
  }
}
class Jy {
  constructor(e) {
    ((this.documentTrie = new Xy()),
      (this.services = e),
  ...
  createDocument(e, r, n) {
    if (n) return this.langiumDocumentFactory.fromString(r, e, n).then((i) => (this.addDocument(i), i));
    {
  ...
  invalidateDocument(e) {
    ...
    return (n && this.documentBuilder().resetToState(n, V.Changed), n);
  }
  deleteDocument(e) {
    const r = e.toString(),
      n = this.documentTrie.find(r);
    return (n && ((n.state = V.Changed), this.documentTrie.delete(r)), n);
  }
  deleteDocuments(e) {
    const r = e.toString(),
      n = this.documentTrie.findAll(r);
    for (const i of n) i.state = V.Changed;
    return (this.documentTrie.delete(r), n);
  }
}
const jr = Symbol("RefResolving");
class Zy {
  constructor(e) {
  ...
  async link(e, r = pe.CancellationToken.None) {
    ...
    } else for (const i of zt(e.parseResult.value)) (await Ue(r), Qa(i).forEach((a) => this.doLink(a, e)));
  }
  doLink(e, r) {
    const n = e.reference;
    if ("_ref" in n && n._ref === void 0) {
      ...
      try {
        ...
        n._ref = { info: e, message: `An error occurred while resolving reference to '${n.$refText}': ${a}` };
      }
      r.references.push(n);
  ...
  getCandidates(e) {
    const n = this.scopeProvider
      ...
      .distinct((i) => `${i.documentUri}#${i.path}`)
      .toArray();
  ...
  buildReference(e, r, n, i) {
    const a = this,
      s = {
        ...
        _ref: void 0,
        get ref() {
          if (Fe(this._ref)) return this._ref;
          if (Ph(this._nodeDescription)) {
            ...
            this._ref = jr;
            const o = Ma(e).$document,
              l = a.getLinkedNode({ reference: s, container: e, property: r });
            if (l.error && o && o.state < V.ComputedScopes) return (this._ref = void 0);
            ((this._ref = l.node ?? l.error), (this._nodeDescription = l.descr), o == null || o.references.push(this));
          } else this._ref === jr && a.throwCyclicReferenceError(e, r, i);
      ...
      s = {
        ...
        get items() {
          ...
          if (this._items === void 0) {
            this._items = jr;
            const o = Ma(e).$document,
              l = a.getCandidates({ reference: s, container: e, property: r }),
              c = [];
            if (Jn(l)) this._linkingError = l;
            else
              for (const u of l) {
          ...
          } else this._items === jr && a.throwCyclicReferenceError(e, r, i);
  ...
  createLinkingError(e, r) {
    const n = Ma(e.container).$document;
    n && n.state < V.ComputedScopes;
...
class tT {
  constructor(e) {
    ((this.nameProvider = e.references.NameProvider),
      ...
      (this.hasMultiReference = zt(e.Grammar).some((r) => As(r) && r.isMulti)));
  }
  findDeclarations(e) {
    if (e) {
      const r = $p(e),
      ...
      if (r && n) {
        const i = n[r.feature];
        if (ut(i) || Qt(i)) return vc(i);
        if (Array.isArray(i)) {
          for (const a of i)
            if ((ut(a) || Qt(a)) && a.$refNode && a.$refNode.offset <= e.offset && a.$refNode.end >= e.end)
              return vc(a);
        }
      }
      if (n) {
        const i = this.nameProvider.getNameNode(n);
        if (i && (i === e || ep(e, i))) return this.getSelfNodes(n);
      }
    }
    return [];
  }
  getSelfNodes(e) {
    if (this.hasMultiReference) {
      ...
      if (n) {
        for (const i of Qa(n))
          if (Qt(i.reference) && i.reference.items.some((a) => a.ref === e)) return i.reference.items.map((a) => a.ref);
      }
      return [e];
    } else return [e];
  }
  ...
  findReferences(e, r) {
    ...
    return (r.documentUri && (i = i.filter((a) => Qe.equals(a.sourceUri, r.documentUri))), n.push(...i), de(n));
  }
  getSelfReferences(e) {
    ...
    for (const i of r) {
      ...
      if (a) {
        const s = jt(i),
          o = this.nodeLocator.getAstNodePath(i);
        n.push({ sourceUri: s.uri, sourcePath: o, targetUri: s.uri, targetPath: o, segment: ts(a), local: !0 });
      }
    }
    return n;
  }
...
class zi {
  ...
  get size() {
    return fo.sum(de(this.map.values()).map((e) => e.length));
  }
  clear() {
    this.map.clear();
  }
  delete(e, r) {
    if (r === void 0) return this.map.delete(e);
    {
      ...
      if (n) {
        const i = n.indexOf(r);
        if (i >= 0) return (n.length === 1 ? this.map.delete(e) : n.splice(i, 1), !0);
      }
      return !1;
    }
  }
...
class rT {
  ...
  async collectExportedSymbols(e, r = pe.CancellationToken.None) {
    return this.collectExportedSymbolsForNode(e.parseResult.value, e, void 0, r);
  }
  async collectExportedSymbolsForNode(e, r, n = Jl, i = pe.CancellationToken.None) {
    const a = [];
    this.addExportedSymbol(e, a, r);
    for (const s of n(e)) (await Ue(i), this.addExportedSymbol(s, a, r));
    return a;
  }
  ...
  async collectLocalSymbols(e, r = pe.CancellationToken.None) {
    const n = e.parseResult.value,
      i = new zi();
    for (const a of qi(n)) (await Ue(r), this.addLocalSymbol(a, e, i));
    return i;
  }
...
class du {
  constructor(e, r, n) {
    ((this.elements = e),
      (this.outerScope = r),
      (this.caseInsensitive = (n == null ? void 0 : n.caseInsensitive) ?? !1),
      (this.concatOuterScope = (n == null ? void 0 : n.concatOuterScope) ?? !0));
  }
  getAllElements() {
  ...
  getElement(e) {
    const r = this.caseInsensitive ? e.toLowerCase() : e,
      n = this.caseInsensitive
        ? this.elements.find((i) => i.name.toLowerCase() === r)
        : this.elements.find((i) => i.name === e);
    if (n) return n;
...
class nT {
  ...
  getElements(e) {
    ...
    return (this.concatOuterScope || n.length === 0) && this.outerScope
      ? de(n).concat(this.outerScope.getElements(e))
      : de(n);
  }
  getAllElements() {
...
class aT extends Ud {
  constructor(e) {
    (super(), (this.cache = new Map()), (this.converter = e ?? ((r) => r)));
  }
  has(e, r) {
    ...
    (super(),
      r
        ? (this.toDispose.push(
          ...
          this.toDispose.push(
            e.workspace.DocumentBuilder.onUpdate((n, i) => {
...
class oT {
  constructor(e) {
    ((this.reflection = e.shared.AstReflection),
      ...
      (this.globalScopeCache = new sT(e.shared)));
  }
  getScope(e) {
    const r = [],
      n = this.reflection.getReferenceType(e),
      i = jt(e.container).localSymbols;
    if (i) {
      let s = e.container;
      do (i.has(s) && r.push(i.getStream(s).filter((o) => this.reflection.isSubtype(o.type, n))), (s = s.$container));
      while (s);
    }
    let a = this.getGlobalScope(n, e);
    for (let s = r.length - 1; s >= 0; s--) a = this.createScope(r[s], a);
    return a;
  }
  createScope(e, r, n) {
    return new du(de(e), r, n);
  }
  createScopeForNodes(e, r, n) {
    const i = de(e)
      .map((a) => {
        const s = this.nameProvider.getName(a);
        if (s) return this.descriptions.createDescription(a, s);
      })
      .nonNullable();
    return new du(i, r, n);
  }
  getGlobalScope(e, r) {
    return this.globalScopeCache.get(e, () => new nT(this.indexManager.allElements(e)));
  }
}
function lT(t) {
...
class cT {
  ...
  serialize(e, r) {
    const n = r ?? {},
      i = r == null ? void 0 : r.replacer,
      a = (o, l) => this.replacer(o, l, n),
      s = i ? (o, l) => i(o, l, a) : a;
    try {
      return ((this.currentDocument = jt(e)), JSON.stringify(e, s, r == null ? void 0 : r.space));
    } finally {
    ...
    if (!this.ignoreProperties.has(e))
      if (ut(r)) {
        ...
        if (d) {
          const h = jt(d);
          let E = "";
          this.currentDocument && this.currentDocument !== h && (o ? (E = o(h.uri, d)) : (E = h.uri.toString()));
          const b = this.astNodeLocator.getAstNodePath(d);
          return { $ref: `${E}#${b}`, $refText: m };
        } else
          return { $error: ((l = r.error) == null ? void 0 : l.message) ?? "Could not resolve reference", $refText: m };
      } else if (Qt(r)) {
        ...
        for (const h of r.items) {
          const E = h.ref,
            b = jt(h.ref);
          let I = "";
          this.currentDocument && this.currentDocument !== b && (o ? (I = o(b.uri, E)) : (I = b.uri.toString()));
          const C = this.astNodeLocator.getAstNodePath(E);
          m.push(`${I}#${C}`);
        }
        return { $refs: m, $refText: d };
      } else if (Fe(r)) {
        let d;
        if (
          (a &&
            ...
            (!e || r.$document) &&
              d != null &&
              d.$textRegion &&
              (d.$textRegion.documentURI = (c = this.currentDocument) == null ? void 0 : c.uri.toString())),
          i && !e && (d ?? (d = { ...r }), (d.$sourceText = (u = r.$cstNode) == null ? void 0 : u.text)),
          s)
        ) {
          d ?? (d = { ...r });
          const m = this.commentProvider.getComment(r);
          m && (d.$comment = m.replace(/\r/g, ""));
        }
        return d ?? r;
      } else return r;
  }
  addAstNodeRegionWithAssignmentsTo(e) {
    const r = (n) => ({ offset: n.offset, end: n.end, length: n.length, range: n.range });
    if (e.$cstNode) {
  ...
  linkNode(e, r, n, i, a, s) {
    for (const [l, c] of Object.entries(e))
      if (Array.isArray(c))
        for (let u = 0; u < c.length; u++) {
          const d = c[u];
          hu(d) ? (c[u] = this.reviveReference(e, l, r, d, n)) : Fe(d) && this.linkNode(d, r, n, e, l, u);
        }
      else hu(c) ? (e[l] = this.reviveReference(e, l, r, c, n)) : Fe(c) && this.linkNode(c, r, n, e, l);
    const o = e;
  ...
  reviveReference(e, r, n, i, a) {
    ...
    if (i.$ref) {
      ...
      if (Fe(c)) return (s || (s = this.nameProvider.getName(c)), { $refText: s ?? "", ref: c });
      o = c;
    } else if (i.$refs) {
      const c = [];
      ...
      if (c.length === 0) ((l = { $refText: s ?? "", items: c }), o ?? (o = "Could not resolve multi-reference"));
      else return { $refText: s ?? "", items: c };
    }
    if (o)
      return (
        l ?? (l = { $refText: s ?? "", ref: void 0 }),
        (l.error = { info: { container: e, property: r, reference: l }, message: o }),
        l
      );
  }
  getRefNode(e, r, n) {
    try {
      ...
      if (i < 0) {
        const l = n ? n(r) : ft.parse(r),
          c = this.langiumDocuments.getDocument(l);
        return c ? c.parseResult.value : "Could not find document for URI: " + r;
      }
      const a = n ? n(r.substring(0, i)) : ft.parse(r.substring(0, i)),
        s = this.langiumDocuments.getDocument(a);
      if (!s) return "Could not find document for URI: " + r;
      if (i === r.length - 1) return s.parseResult.value;
...
class uT {
  ...
  register(e) {
    ...
    for (const n of r.fileExtensions) (this.fileExtensionMap.has(n), this.fileExtensionMap.set(n, e));
    if (r.fileNames) for (const n of r.fileNames) (this.fileNameMap.has(n), this.fileNameMap.set(n, e));
  ...
  getServices(e) {
    ...
    const n = Qe.extname(e),
      i = Qe.basename(e),
      a = this.fileNameMap.get(i) ?? this.fileExtensionMap.get(n);
    if (!a)
      throw r
...
class fT {
  constructor(e) {
    ((this.entries = new zi()),
      (this.knownCategories = new Set(Ml.defaults)),
      (this.entriesBefore = []),
      (this.entriesAfter = []),
      (this.reflection = e.shared.AstReflection));
  }
  register(e, r = this, n = "fast") {
    ...
    for (const [i, a] of Object.entries(e)) {
      ...
      if (Array.isArray(s))
        for (const o of s) {
          const l = { check: this.wrapValidationException(o, r), category: n };
          this.addEntry(i, l);
        }
      else if (typeof s == "function") {
        const o = { check: this.wrapValidationException(s, r), category: n };
        this.addEntry(i, o);
      } else Wi();
    }
  }
...
const dT = Object.freeze({ validateNode: !0, validateChildren: !0 });
class hT {
  constructor(e) {
  ...
  async validateDocument(e, r = {}, n = pe.CancellationToken.None) {
    const i = e.parseResult,
      a = [];
    if (
      (await Ue(n),
      (!r.categories || r.categories.includes("built-in")) &&
        (this.processLexingErrors(i, a, r),
        (r.stopAfterLexingErrors &&
          a.some((s) => {
            var o;
            return ((o = s.data) == null ? void 0 : o.code) === ct.LexingError;
          })) ||
          (this.processParsingErrors(i, a, r),
          r.stopAfterParsingErrors &&
            a.some((s) => {
              var o;
              return ((o = s.data) == null ? void 0 : o.code) === ct.ParsingError;
            })) ||
          (this.processLinkingErrors(e, a, r),
          r.stopAfterLinkingErrors &&
            a.some((s) => {
              var o;
              return ((o = s.data) == null ? void 0 : o.code) === ct.LinkingError;
            }))))
    )
      return a;
    try {
  ...
  processLexingErrors(e, r, n) {
    ...
    for (const s of i) {
      const o = s.severity ?? "error",
        l = {
          severity: Ks(o),
          range: {
            start: { line: s.line - 1, character: s.column - 1 },
            end: { line: s.line - 1, character: s.column + s.length - 1 },
          },
          message: s.message,
          data: mT(o),
  ...
  async validateAst(e, r, n = pe.CancellationToken.None) {
    const i = [],
      a = (s, o, l) => {
        i.push(this.toDiagnostic(s, o, l));
      };
    return (
      await this.validateAstBefore(e, r, a, n),
      await this.validateAstNodes(e, r, a, n),
      await this.validateAstAfter(e, r, a, n),
      i
    );
  }
  async validateAstBefore(e, r, n, i = pe.CancellationToken.None) {
    const a = this.validationRegistry.checksBefore;
    for (const s of a) (await Ue(i), await s(e, n, r.categories ?? [], i));
  }
  async validateAstNodes(e, r, n, i = pe.CancellationToken.None) {
    var a;
    if ((a = this.profiler) != null && a.isActive("validating")) {
      ...
      try {
        ...
        for (const l of o) {
          ...
          if (c.validateNode)
            try {
              const u = this.validationRegistry.getChecks(l.$type, r.categories);
              for (const d of u) await d(l, n, i);
            } finally {
      ...
      for (const o of s) {
        ...
        if (l.validateNode) {
          ...
          for (const u of c) await u(o, n, i);
        }
  ...
  async validateAstAfter(e, r, n, i = pe.CancellationToken.None) {
...
function pT(t) {
  ...
  return (
    typeof t.property == "string"
      ? (e = xf(t.node.$cstNode, t.property, t.index))
      : typeof t.keyword == "string" && (e = Ep(t.node.$cstNode, t.keyword, t.index)),
    e ?? (e = t.node.$cstNode),
...
function mT(t) {
  switch (t) {
    case "error":
      return bi(ct.LexingError);
    case "warning":
      return bi(ct.LexingWarning);
    case "info":
      return bi(ct.LexingInfo);
    case "hint":
      return bi(ct.LexingHint);
    default:
      throw new Error("Invalid diagnostic severity: " + t);
  }
}
...
class gT {
  ...
  createDescription(e, r, n) {
    ...
    if (!r) throw new Error(`Node at path ${a} has no name.`);
    let s;
    const o = () => s ?? (s = ts(this.nameProvider.getNameNode(e) ?? e.$cstNode));
    return {
      node: e,
      name: r,
      get nameSegment() {
...
class yT {
  ...
  async createDescriptions(e, r = pe.CancellationToken.None) {
    const n = [],
  ...
  createInfoDescriptions(e) {
    ...
    let n = [];
    ut(r) && r.$nodeDescription
      ? (n = [r.$nodeDescription])
      : Qt(r) && (n = r.items.map((l) => l.$nodeDescription).filter((l) => l !== void 0));
    const i = jt(e.container).uri,
      a = this.nodeLocator.getAstNodePath(e.container),
      s = [],
      o = ts(r.$refNode);
    for (const l of n)
      s.push({
...
class TT {
  ...
  getAstNode(e, r) {
    return r.split(this.segmentSeparator).reduce((i, a) => {
      ...
      if (s > 0) {
        const o = a.substring(0, s),
          l = parseInt(a.substring(s + 1)),
          c = i[o];
...
class vT {
  constructor(e) {
    ((this._ready = new mc()),
      (this.onConfigurationSectionUpdateEmitter = new RT.Emitter()),
      (this.settings = {}),
  ...
  async initialized(e) {
    if (this.workspaceConfig) {
      ...
      if (e.fetchConfiguration) {
        const r = this.serviceRegistry.all.map((i) => ({ section: this.toSectionName(i.LanguageMetaData.languageId) })),
...
function qd() {
  ...
  (function (R) {
    ((R.ParseError = -32700),
      (R.InvalidRequest = -32600),
      (R.MethodNotFound = -32601),
      (R.InvalidParams = -32602),
      (R.InternalError = -32603),
      (R.jsonrpcReservedErrorRangeStart = -32099),
      (R.serverErrorStart = -32099),
      (R.MessageWriteError = -32099),
      (R.MessageReadError = -32098),
      (R.PendingResponseRejected = -32097),
      (R.ConnectionInactive = -32096),
      (R.ServerNotInitialized = -32002),
      (R.UnknownErrorCode = -32001),
      (R.jsonrpcReservedErrorRangeEnd = -32e3),
      (R.serverErrorEnd = -32e3));
  })(e || (G.ErrorCodes = e = {}));
  class r extends Error {
    constructor(g, $, y) {
      (super($),
        (this.code = t.number(g) ? g : e.UnknownErrorCode),
        (this.data = y),
        Object.setPrototypeOf(this, r.prototype));
    }
    toJson() {
      const g = { code: this.code, message: this.message };
  ...
  ((G.ParameterStructures = n),
    (n.auto = new n("auto")),
    (n.byPosition = new n("byPosition")),
    (n.byName = new n("byName")));
  class i {
    constructor(g, $) {
  ...
  G.NotificationType1 = w;
  class S extends i {
    constructor(g) {
      super(g, 2);
    }
  }
  G.NotificationType2 = S;
  class P extends i {
    constructor(g) {
      super(g, 3);
    }
  ...
  G.NotificationType8 = oe;
  class le extends i {
    constructor(g) {
      super(g, 9);
    }
  }
  G.NotificationType9 = le;
  var _;
  return (
    (function (R) {
      function g(T) {
        const A = T;
        return A && t.string(A.method) && (t.string(A.id) || t.number(A.id));
      }
      R.isRequest = g;
      function $(T) {
        const A = T;
        return A && t.string(A.method) && T.id === void 0;
      }
      R.isNotification = $;
      function y(T) {
        const A = T;
        return A && (A.result !== void 0 || !!A.error) && (t.string(A.id) || t.number(A.id) || A.id === null);
      }
      R.isResponse = y;
    })(_ || (G.Message = _ = {})),
    G
...
function Bd() {
  ...
  mu = 1;
  var t;
  (Object.defineProperty(wt, "__esModule", { value: !0 }), (wt.LRUCache = wt.LinkedMap = wt.Touch = void 0));
  var e;
  (function (i) {
  ...
  class r {
    ...
    get(a, s = e.None) {
      ...
      if (o) return (s !== e.None && this.touch(o, s), o.value);
    }
    set(a, s, o = e.None) {
      let l = this._map.get(a);
      if (l) ((l.value = s), o !== e.None && this.touch(l, o));
      else {
    ...
    remove(a) {
      ...
      if (s) return (this._map.delete(a), this.removeItem(s), this._size--, s.value);
    }
    shift() {
    ...
    trimOld(a) {
      ...
      let s = this._head,
        o = this.size;
      for (; s && o > a; ) (this._map.delete(s.key), (s = s.next), o--);
    ...
    touch(a, s) {
      ...
      if (!(s !== e.First && s !== e.Last)) {
        if (s === e.First) {
          ...
          const o = a.next,
            l = a.previous;
          (a === this._tail ? ((l.next = void 0), (this._tail = l)) : ((o.previous = l), (l.next = o)),
            (a.previous = void 0),
            (a.next = this._head),
          ...
          const o = a.next,
            l = a.previous;
          (a === this._head ? ((o.previous = void 0), (this._head = o)) : ((o.previous = l), (l.next = o)),
            (a.next = void 0),
    ...
    fromJSON(a) {
      this.clear();
      for (const [s, o] of a) this.set(s, o);
    }
  }
  wt.LinkedMap = r;
  class n extends r {
  ...
  return ((wt.LRUCache = n), wt);
}
var ii = {},
  gu;
function ET() {
  if (gu) return ii;
  ((gu = 1), Object.defineProperty(ii, "__esModule", { value: !0 }), (ii.Disposable = void 0));
  var t;
  return (
    (function (e) {
      function r(n) {
...
function AT() {
  ...
  ((yu = 1),
    ...
    (fr.SharedArrayReceiverStrategy = fr.SharedArraySenderStrategy = void 0));
  const t = Ps();
  var e;
  (function (s) {
  ...
  class r {
    ...
    enableCancellation(o) {
      if (o.id === null) return;
      const l = new SharedArrayBuffer(4),
        c = new Int32Array(l, 0, 1);
  ...
  fr.SharedArraySenderStrategy = r;
  class n {
    constructor(o) {
  ...
  return ((fr.SharedArrayReceiverStrategy = a), fr);
}
var kt = {},
  ai = {},
  Tu;
function Wd() {
  if (Tu) return ai;
  ((Tu = 1), Object.defineProperty(ai, "__esModule", { value: !0 }), (ai.Semaphore = void 0));
  const t = xr();
  class e {
    constructor(n = 1) {
...
function $T() {
  ...
  ((Ru = 1),
    ...
    (kt.ReadableStreamMessageReader = kt.AbstractMessageReader = kt.MessageReader = void 0));
  const t = xr(),
    e = Ji(),
    r = Mn(),
    n = Wd();
  ...
  class a {
    ...
    asError(c) {
      return c instanceof Error
        ? c
        : new Error(`Reader received error. Reason: ${e.string(c.message) ? c.message : "unknown"}`);
    }
  }
  ...
  (function (l) {
    function c(u) {
      ...
      let E;
      const b = new Map();
      if (u === void 0 || typeof u == "string") d = u ?? "utf-8";
      else {
        if (
          ((d = u.charset ?? "utf-8"),
          u.contentDecoder !== void 0 && ((m = u.contentDecoder), h.set(m.name, m)),
          u.contentDecoders !== void 0)
        )
          for (const I of u.contentDecoders) h.set(I.name, I);
        if (
          (u.contentTypeDecoder !== void 0 && ((E = u.contentTypeDecoder), b.set(E.name, E)),
          u.contentTypeDecoders !== void 0)
        )
          for (const I of u.contentTypeDecoders) b.set(I.name, I);
      }
      return (
        E === void 0 && ((E = (0, t.default)().applicationJson.decoder), b.set(E.name, E)),
        { charset: d, contentDecoder: m, contentDecoders: h, contentTypeDecoder: E, contentTypeDecoders: b }
      );
    }
    l.fromOptions = c;
  })(s || (s = {}));
  class o extends a {
    constructor(c, u) {
      (super(),
        (this.readable = c),
        (this.options = s.fromOptions(u)),
        (this.buffer = (0, t.default)().messageBuffer.create(this.options.charset)),
        (this._partialMessageTimeout = 1e4),
        (this.nextMessageLength = -1),
        (this.messageToken = 0),
        (this.readSemaphore = new n.Semaphore(1)));
    }
...
${JSON.stringify(Object.fromEntries(d))}`)
          ...
          (this.clearPartialMessageTimer(),
            ...
            this.readSemaphore
              .lock(async () => {
                const d = this.options.contentDecoder !== void 0 ? await this.options.contentDecoder.decode(u) : u,
                  m = await this.options.contentTypeDecoder.decode(d, this.options);
                this.callback(m);
              })
              .catch((d) => {
                this.fireError(d);
        ...
        !(this._partialMessageTimeout <= 0) &&
          (this.partialMessageTimer = (0, t.default)().timer.setTimeout(
            (c, u) => {
              ((this.partialMessageTimer = void 0),
                c === this.messageToken &&
                  (this.firePartialMessage({ messageToken: c, waitingTime: u }), this.setPartialMessageTimer()));
            },
...
function CT() {
  ...
  ((vu = 1),
    ...
    (bt.WriteableStreamMessageWriter = bt.AbstractMessageWriter = bt.MessageWriter = void 0));
  const t = xr(),
    e = Ji(),
    r = Wd(),
    n = Mn(),
...
`;
  ...
  (function (u) {
    function d(m) {
      let h = m;
      return h && e.func(h.dispose) && e.func(h.onClose) && e.func(h.onError) && e.func(h.write);
    }
    u.is = d;
  })(s || (bt.MessageWriter = s = {}));
  class o {
    constructor() {
    ...
    fireError(d, m, h) {
      this.errorEmitter.fire([this.asError(d), m, h]);
    }
    get onClose() {
      return this.closeEmitter.event;
    }
    ...
    asError(d) {
      return d instanceof Error
        ? d
        : new Error(`Writer received error. Reason: ${e.string(d.message) ? d.message : "unknown"}`);
    }
  }
  bt.AbstractMessageWriter = o;
  var l;
  (function (u) {
    function d(m) {
      return m === void 0 || typeof m == "string"
        ? { charset: m ?? "utf-8", contentTypeEncoder: (0, t.default)().applicationJson.encoder }
        : {
            charset: m.charset ?? "utf-8",
            contentEncoder: m.contentEncoder,
            contentTypeEncoder: m.contentTypeEncoder ?? (0, t.default)().applicationJson.encoder,
          };
    }
    u.fromOptions = d;
  })(l || (l = {}));
  class c extends o {
    constructor(d, m) {
      (super(),
        (this.writable = d),
        (this.options = l.fromOptions(m)),
        (this.errorCount = 0),
        (this.writeSemaphore = new r.Semaphore(1)),
        this.writable.onError((h) => this.fireError(h)),
        this.writable.onClose(() => this.fireClose()));
    }
    async write(d) {
      return this.writeSemaphore.lock(async () =>
        this.options.contentTypeEncoder
          .encode(d, this.options)
          .then((h) => (this.options.contentEncoder !== void 0 ? this.options.contentEncoder.encode(h) : h))
          .then(
            (h) => {
              const E = [];
              return (E.push(i, h.byteLength.toString(), a), E.push(a), this.doWrite(d, E, h));
            },
            (h) => {
              throw (this.fireError(h), h);
            }
          )
      );
    }
    async doWrite(d, m, h) {
      try {
        return (await this.writable.write(m.join(""), "ascii"), this.writable.write(h));
      } catch (E) {
        return (this.handleError(E, d), Promise.reject(E));
      }
    }
    handleError(d, m) {
      (this.errorCount++, this.fireError(d, m, this.errorCount));
    }
    end() {
      this.writable.end();
    }
  }
  return ((bt.WriteableStreamMessageWriter = c), bt);
}
var si = {},
  Eu;
function ST() {
  if (Eu) return si;
  ((Eu = 1), Object.defineProperty(si, "__esModule", { value: !0 }), (si.AbstractMessageBuffer = void 0));
  const t = 13,
    e = 10,
    r = `\r
`;
  class n {
    ...
    tryReadHeaders(a = !1) {
      ...
      if (s !== 4) return;
      const u = this._read(c + l),
        d = new Map(),
        m = this.toString(u, "ascii").split(r);
      if (m.length < 2) return d;
      for (let h = 0; h < m.length - 2; h++) {
        const E = m[h],
          b = E.indexOf(":");
        if (b === -1)
          throw new Error(`Message header must separate key and value using ':'
${E}`);
        const I = E.substr(0, b),
          C = E.substr(b + 1).trim();
        d.set(a ? I.toLowerCase() : I, C);
      }
      return d;
    }
    tryReadBody(a) {
      if (!(this._totalLength < a)) return this._read(a);
    }
    get numberOfBytes() {
    ...
    _read(a) {
      ...
      if (a > this._totalLength) throw new Error("Cannot read so many bytes!");
      ...
      for (; a > 0; ) {
        ...
        if (c.byteLength > a) {
          ...
          (s.set(c, o),
            (o += c.byteLength),
            this._chunks.shift(),
            (this._totalLength -= c.byteLength),
            (a -= c.byteLength));
      }
      return s;
    }
  }
  return ((si.AbstractMessageBuffer = n), si);
}
var Xs = {},
  Au;
function wT() {
  return (
    Au ||
      ...
      (function (t) {
        ...
        (function (g) {
          ((g[(g.Off = 0)] = "Off"),
            (g[(g.Messages = 1)] = "Messages"),
            (g[(g.Compact = 2)] = "Compact"),
            (g[(g.Verbose = 3)] = "Verbose"));
        })(m || (t.Trace = m = {}));
        var h;
        ((function (g) {
        ...
        (function (g) {
          ((g[(g.Closed = 1)] = "Closed"),
            (g[(g.Disposed = 2)] = "Disposed"),
            (g[(g.AlreadyListening = 3)] = "AlreadyListening"));
        })(C || (t.ConnectionErrors = C = {}));
        class w extends Error {
          constructor($, y) {
            (super(y), (this.code = $), Object.setPrototypeOf(this, w.prototype));
          }
        }
        t.ConnectionError = w;
        var S;
        ...
        (function (g) {
          function $(y) {
            ...
            return (
              ...
              (T.dispose === void 0 || r.func(T.dispose))
            );
          }
          g.is = $;
        ...
        var ne;
        (function (g) {
          g.Message = Object.freeze({ receiver: B.Message, sender: H.Message });
          function $(y) {
            const T = y;
            return T && B.is(T.receiver) && H.is(T.sender);
          }
          g.is = $;
        ...
        (function (g) {
          ...
          g.is = $;
        })(oe || (t.MessageStrategy = oe = {}));
        var le;
        (function (g) {
          function $(y) {
            const T = y;
            return T && (ne.is(T.cancellationStrategy) || S.is(T.connectionStrategy) || oe.is(T.messageStrategy));
          }
          g.is = $;
        })(le || (t.ConnectionOptions = le = {}));
        var _;
        (function (g) {
          ((g[(g.New = 1)] = "New"),
            (g[(g.Listening = 2)] = "Listening"),
            (g[(g.Closed = 3)] = "Closed"),
            (g[(g.Disposed = 4)] = "Disposed"));
        })(_ || (_ = {}));
        function R(g, $, y, T) {
          const A = y !== void 0 ? y : t.NullLogger;
          let L = 0,
            D = 0,
            x = 0;
          const j = "2.0";
          ...
          let ge,
            ...
            ye,
            it = _.New;
          const Dr = new a.Emitter(),
            jn = new a.Emitter(),
            zn = new a.Emitter(),
            Un = new a.Emitter(),
            qn = new a.Emitter(),
            at = T && T.cancellationStrategy ? T.cancellationStrategy : ne.Message;
          function Bn(p) {
            if (p === null) throw new Error("Can't send requests with id null since the response can't be correlated.");
            return "req-" + p.toString();
          }
          function Zi(p) {
            return p === null ? "res-unknown-" + (++x).toString() : "res-" + p.toString();
          }
          function Qi() {
            return "not-" + (++D).toString();
          }
          function ea(p, k) {
            n.Message.isRequest(k) ? p.set(Bn(k.id), k) : n.Message.isResponse(k) ? p.set(Zi(k.id), k) : p.set(Qi(), k);
          }
          function ta(p) {}
          function Wn() {
            return it === _.Listening;
          }
          function Vn() {
            return it === _.Closed;
          }
          function $t() {
            return it === _.Disposed;
          }
          function Kn() {
            (it === _.New || it === _.Listening) && ((it = _.Closed), jn.fire(void 0));
          }
          function ra(p) {
            Dr.fire([p, void 0, void 0]);
          }
          function na(p) {
            Dr.fire(p);
          }
          (g.onClose(Kn), g.onError(ra), $.onClose(Kn), $.onError(na));
          function Hn() {
            ge ||
              ce.size === 0 ||
              (ge = (0, e.default)().timer.setImmediate(() => {
                ((ge = void 0), ia());
              }));
          }
          function Xn(p) {
            n.Message.isRequest(p)
              ? sa(p)
              : n.Message.isNotification(p)
                ? la(p)
                : n.Message.isResponse(p)
                  ? oa(p)
                  : ca(p);
          }
          function ia() {
            ...
            const p = ce.shift();
            try {
              const k = T == null ? void 0 : T.messageStrategy;
              oe.is(k) ? k.handleMessage(p, Xn) : Xn(p);
            } finally {
              Hn();
            }
          }
          const aa = (p) => {
            try {
              if (n.Message.isNotification(p) && p.method === o.type.method) {
                const k = p.params.id,
                  O = Bn(k),
                  M = ce.get(O);
                if (n.Message.isRequest(M)) {
                  const re = T == null ? void 0 : T.connectionStrategy,
                    ie = re && re.cancelUndispatched ? re.cancelUndispatched(M, ta) : void 0;
                  if (ie && (ie.error !== void 0 || ie.result !== void 0)) {
                    (ce.delete(O),
                      Ce.delete(k),
                      (ie.id = M.id),
                      ar(ie, p.method, Date.now()),
                      $.write(ie).catch(() => A.error("Sending response for canceled message failed.")));
                    return;
                  }
                }
                const ae = Ce.get(k);
          ...
          function sa(p) {
            if ($t()) return;
            function k(X, ue, ee) {
              const be = { jsonrpc: j, id: p.id };
              (X instanceof n.ResponseError ? (be.error = X.toJson()) : (be.result = X === void 0 ? null : X),
                ar(be, ue, ee),
                $.write(be).catch(() => A.error("Sending response failed.")));
            }
            function O(X, ue, ee) {
              const be = { jsonrpc: j, id: p.id, error: X.toJson() };
              (ar(be, ue, ee), $.write(be).catch(() => A.error("Sending response failed.")));
            }
            function M(X, ue, ee) {
              X === void 0 && (X = null);
              const be = { jsonrpc: j, id: p.id, result: X };
              (ar(be, ue, ee), $.write(be).catch(() => A.error("Sending response failed.")));
            }
            da(p);
            const ae = te.get(p.method);
            let re, ie;
            ae && ((re = ae.type), (ie = ae.handler));
            const Ae = Date.now();
            if (ie || F) {
              const X = p.id ?? String(Date.now()),
                ue = P.is(at.receiver)
                  ? at.receiver.createCancellationTokenSource(X)
                  : at.receiver.createCancellationTokenSource(p);
              (p.id !== null && Ie.has(p.id) && ue.cancel(), p.id !== null && Ce.set(X, ue));
              try {
                let ee;
                if (ie)
                  if (p.params === void 0) {
                    if (re !== void 0 && re.numberOfParams !== 0) {
                      O(
                        new n.ResponseError(
                          ...
                          `Request ${p.method} defines ${re.numberOfParams} params but received none.`
                        ),
                        p.method,
                        Ae
                      );
                    ...
                    ee = ie(ue.token);
                  } else if (Array.isArray(p.params)) {
                    if (re !== void 0 && re.parameterStructures === n.ParameterStructures.byName) {
                      O(
                        new n.ResponseError(
                          n.ErrorCodes.InvalidParams,
                          `Request ${p.method} defines parameters by name but received parameters by position`
                        ),
                        p.method,
                        Ae
                      );
                    ...
                    ee = ie(...p.params, ue.token);
                  } else {
                    if (re !== void 0 && re.parameterStructures === n.ParameterStructures.byPosition) {
                      O(
                        new n.ResponseError(
                          n.ErrorCodes.InvalidParams,
                          `Request ${p.method} defines parameters by position but received parameters by name`
                        ),
                        p.method,
                        Ae
                      );
                ...
                else F && (ee = F(p.method, p.params, ue.token));
                const be = ee;
                ee
                  ? be.then
                    ? be.then(
                        (Ge) => {
                          (Ce.delete(X), k(Ge, p.method, Ae));
                        },
                        (Ge) => {
                          (Ce.delete(X),
                            Ge instanceof n.ResponseError
                              ? O(Ge, p.method, Ae)
                              : Ge && r.string(Ge.message)
                                ? O(
                                    new n.ResponseError(
                                      n.ErrorCodes.InternalError,
                                      `Request ${p.method} failed with message: ${Ge.message}`
                                    ),
                                    p.method,
                                    Ae
                                  )
                                : O(
                                    new n.ResponseError(
                                      n.ErrorCodes.InternalError,
                                      `Request ${p.method} failed unexpectedly without providing any details.`
                                    ),
                                    p.method,
                                    Ae
                                  ));
                    ...
                    : (Ce.delete(X), k(ee, p.method, Ae))
                  : (Ce.delete(X), M(ee, p.method, Ae));
              } catch (ee) {
                (Ce.delete(X),
                  ee instanceof n.ResponseError
                    ? k(ee, p.method, Ae)
                    : ee && r.string(ee.message)
                      ? O(
                          new n.ResponseError(
                            n.ErrorCodes.InternalError,
                            `Request ${p.method} failed with message: ${ee.message}`
                          ),
                          p.method,
                          Ae
                        )
            ...
            } else O(new n.ResponseError(n.ErrorCodes.MethodNotFound, `Unhandled method ${p.method}`), p.method, Ae);
          }
          function oa(p) {
            if (!$t())
              if (p.id === null)
...
${JSON.stringify(p.error, void 0, 4)}`)
                ...
                if ((ha(p, O), O !== void 0)) {
                  ...
                  try {
                    ...
                    } else if (p.result !== void 0) O.resolve(p.result);
                    else throw new Error("Should never happen.");
                  } catch (M) {
                    M.message
                      ? A.error(`Response handler '${O.method}' failed with message: ${M.message}`)
                      : A.error(`Response handler '${O.method}' failed unexpectedly.`);
                  }
                }
              }
          }
          function la(p) {
            if ($t()) return;
            let k, O;
            if (p.method === o.type.method) {
              const M = p.params.id;
              (Ie.delete(M), Mr(p));
              return;
            } else {
              const M = Q.get(p.method);
              M && ((O = M.handler), (k = M.type));
            }
            if (O || z)
              try {
                if ((Mr(p), O))
                  if (p.params === void 0)
                    (k !== void 0 &&
                      k.numberOfParams !== 0 &&
                      k.parameterStructures !== n.ParameterStructures.byName &&
                      A.error(`Notification ${p.method} defines ${k.numberOfParams} params but received none.`),
                      O());
                  else if (Array.isArray(p.params)) {
                    const M = p.params;
                    p.method === c.type.method && M.length === 2 && l.is(M[0])
                      ? O({ token: M[0], value: M[1] })
                      : (k !== void 0 &&
                          (k.parameterStructures === n.ParameterStructures.byName &&
                            A.error(
                              `Notification ${p.method} defines parameters by name but received parameters by position`
                            ),
                          k.numberOfParams !== p.params.length &&
                            A.error(
                              `Notification ${p.method} defines ${k.numberOfParams} params but received ${M.length} arguments`
                            )),
                        O(...M));
                  } else
                    (k !== void 0 &&
                      k.parameterStructures === n.ParameterStructures.byPosition &&
                      A.error(
                        `Notification ${p.method} defines parameters by position but received parameters by name`
                      ),
                      O(p.params));
                else z && z(p.method, p.params);
              } catch (M) {
                M.message
                  ? A.error(`Notification handler '${p.method}' failed with message: ${M.message}`)
                  : A.error(`Notification handler '${p.method}' failed unexpectedly.`);
              }
            else zn.fire(p);
          }
          function ca(p) {
...
${JSON.stringify(p, null, 4)}`);
            const k = p;
            if (r.string(k.id) || r.number(k.id)) {
              const O = k.id,
                M = ke.get(O);
          ...
          function ua(p) {
            if (!(Y === m.Off || !ye))
              if (Xe === E.Text) {
                let k;
                ((Y === m.Verbose || Y === m.Compact) &&
                  p.params &&
                  (k = `Params: ${st(p.params)}

`),
                  ye.log(`Sending request '${p.method} - (${p.id})'.`, k));
              } else Ct("send-request", p);
          }
          function fa(p) {
            if (!(Y === m.Off || !ye))
              if (Xe === E.Text) {
...
`)),
                  ye.log(`Sending notification '${p.method}'.`, k));
              } else Ct("send-notification", p);
          }
          function ar(p, k, O) {
            if (!(Y === m.Off || !ye))
              if (Xe === E.Text) {
                let M;
                ((Y === m.Verbose || Y === m.Compact) &&
                  (p.error && p.error.data
                    ? (M = `Error data: ${st(p.error.data)}

`)
                    : p.result
                      ? (M = `Result: ${st(p.result)}
...
`)),
                  ye.log(`Sending response '${k} - (${p.id})'. Processing request took ${Date.now() - O}ms`, M));
              } else Ct("send-response", p);
          }
          function da(p) {
            if (!(Y === m.Off || !ye))
              if (Xe === E.Text) {
...
`),
                  ye.log(`Received request '${p.method} - (${p.id})'.`, k));
              } else Ct("receive-request", p);
          }
          function Mr(p) {
            if (!(Y === m.Off || !ye || p.method === I.type.method))
              if (Xe === E.Text) {
                let k;
                ((Y === m.Verbose || Y === m.Compact) &&
                  (p.params
...
`)),
                  ye.log(`Received notification '${p.method}'.`, k));
              } else Ct("receive-notification", p);
          }
          function ha(p, k) {
            if (!(Y === m.Off || !ye))
              if (Xe === E.Text) {
                ...
                if (
                  ((Y === m.Verbose || Y === m.Compact) &&
                    (p.error && p.error.data
                      ? (O = `Error data: ${st(p.error.data)}

`)
                      : p.result
                        ? (O = `Result: ${st(p.result)}

`)
                        : p.error === void 0 &&
                          (O = `No result returned.

`)),
                  k)
                ) {
                  const M = p.error ? ` Request failed: ${p.error.message} (${p.error.code}).` : "";
                  ye.log(`Received response '${k.method} - (${p.id})' in ${Date.now() - k.timerStart}ms.${M}`, O);
                } else ye.log(`Received response ${p.id} without active response promise.`, O);
              } else Ct("receive-response", p);
          }
          function Ct(p, k) {
            if (!ye || Y === m.Off) return;
            const O = { isLSPMessage: !0, type: p, message: k, timestamp: Date.now() };
            ye.log(O);
          }
          function Xt() {
            if (Vn()) throw new w(C.Closed, "Connection is closed.");
            if ($t()) throw new w(C.Disposed, "Connection is disposed.");
          }
          function pa() {
            if (Wn()) throw new w(C.AlreadyListening, "Connection is already listening");
          }
          function ma() {
            if (!Wn()) throw new Error("Call listen() first.");
          }
          function Yt(p) {
          ...
          function ve(p, k) {
            switch (p) {
              case n.ParameterStructures.auto:
                return f(k) ? Yn(k) : [Yt(k)];
              case n.ParameterStructures.byName:
                if (!f(k)) throw new Error("Received parameters by name but param is not an object literal.");
                return Yn(k);
              case n.ParameterStructures.byPosition:
                return [Yt(k)];
              default:
                throw new Error(`Unknown parameter structure ${p.toString()}`);
            }
          }
          function Ee(p, k) {
            let O;
            const M = p.numberOfParams;
            switch (M) {
              case 0:
                O = void 0;
                break;
              case 1:
                O = ve(p.parameterStructures, k[0]);
                break;
              default:
                O = [];
                for (let ae = 0; ae < k.length && ae < M; ae++) O.push(Yt(k[ae]));
                if (k.length < M) for (let ae = k.length; ae < M; ae++) O.push(null);
                break;
            }
            return O;
          }
          const q = {
            sendNotification: (p, ...k) => {
              Xt();
              let O, M;
              if (r.string(p)) {
                O = p;
                const re = k[0];
                let ie = 0,
                  Ae = n.ParameterStructures.auto;
                n.ParameterStructures.is(re) && ((ie = 1), (Ae = re));
                let X = k.length;
                const ue = X - ie;
                switch (ue) {
                  case 0:
                  ...
                  default:
                    if (Ae === n.ParameterStructures.byName)
                      throw new Error(`Received ${ue} parameters for 'by Name' notification parameter structure.`);
                    M = k.slice(ie, X).map((ee) => Yt(ee));
                    break;
                }
              } else {
                const re = k;
                ((O = p.method), (M = Ee(p, re)));
              }
              const ae = { jsonrpc: j, method: O, params: M };
              return (
                fa(ae),
                $.write(ae).catch((re) => {
                  throw (A.error("Sending notification failed."), re);
                })
              );
            },
            onNotification: (p, k) => {
              ...
              return (
                r.func(p)
                  ...
                  : k &&
                    (r.string(p)
                      ? ((O = p), Q.set(p, { type: void 0, handler: k }))
                      : ((O = p.method), Q.set(p.method, { type: p, handler: k }))),
                {
                  dispose: () => {
            ...
            onProgress: (p, k, O) => {
              if (Ne.has(k)) throw new Error(`Progress handler for token ${k} already registered`);
              return (
                Ne.set(k, O),
                {
                  dispose: () => {
            ...
            sendProgress: (p, k, O) => q.sendNotification(c.type, { token: k, value: O }),
            onUnhandledProgress: Un.event,
            sendRequest: (p, ...k) => {
              (Xt(), ma());
              let O, M, ae;
              if (r.string(p)) {
                ...
                const X = k[0],
                  ue = k[k.length - 1];
                let ee = 0,
                  be = n.ParameterStructures.auto;
                n.ParameterStructures.is(X) && ((ee = 1), (be = X));
                let Ge = k.length;
                s.CancellationToken.is(ue) && ((Ge = Ge - 1), (ae = ue));
                const dt = Ge - ee;
                switch (dt) {
                  case 0:
                    M = void 0;
                  ...
                  default:
                    ...
                    M = k.slice(ee, Ge).map((Rh) => Yt(Rh));
                    break;
                }
              } else {
                const X = k;
                ((O = p.method), (M = Ee(p, X)));
                const ue = p.numberOfParams;
                ae = s.CancellationToken.is(X[ue]) ? X[ue] : void 0;
              }
              const re = L++;
              let ie;
              ae &&
                (ie = ae.onCancellationRequested(() => {
                  const X = at.sender.sendCancellation(q, re);
                  return X === void 0
                    ? (A.log(`Received no promise from cancellation strategy when cancelling id ${re}`),
                      Promise.resolve())
                    : X.catch(() => {
                        A.log(`Sending cancellation messages for id ${re} failed`);
                      });
                }));
              const Ae = { jsonrpc: j, id: re, method: O, params: M };
              return (
                ua(Ae),
                typeof at.sender.enableCancellation == "function" && at.sender.enableCancellation(Ae),
                new Promise(async (X, ue) => {
                  const ee = (dt) => {
                      (X(dt), at.sender.cleanup(re), ie == null || ie.dispose());
                    },
                    be = (dt) => {
                      (ue(dt), at.sender.cleanup(re), ie == null || ie.dispose());
                    },
                    Ge = { method: O, timerStart: Date.now(), resolve: ee, reject: be };
                  try {
                    (await $.write(Ae), ke.set(re, Ge));
                  } catch (dt) {
                    throw (
                      A.error("Sending request failed."),
                      Ge.reject(
                        new n.ResponseError(n.ErrorCodes.MessageWriteError, dt.message ? dt.message : "Unknown reason")
                      ),
                      dt
                    );
                  }
            ...
            onRequest: (p, k) => {
              ...
              return (
                d.is(p)
                  ? ((O = void 0), (F = p))
                  : r.string(p)
                    ? ((O = null), k !== void 0 && ((O = p), te.set(p, { handler: k, type: void 0 })))
                    : k !== void 0 && ((O = p.method), te.set(p.method, { type: p, handler: k })),
                {
                  dispose: () => {
            ...
            hasPendingResponse: () => ke.size > 0,
            trace: async (p, k, O) => {
              let M = !1,
                ae = E.Text;
              (O !== void 0 &&
                (r.boolean(O) ? (M = O) : ((M = O.sendNotification || !1), (ae = O.traceFormat || E.Text))),
                (Y = p),
                (Xe = ae),
                Y === m.Off ? (ye = void 0) : (ye = k),
                M && !Vn() && !$t() && (await q.sendNotification(b.type, { value: m.toString(p) })));
            },
            onError: Dr.event,
            onClose: jn.event,
            ...
            dispose: () => {
              if ($t()) return;
              ((it = _.Disposed), qn.fire(void 0));
              const p = new n.ResponseError(
                n.ErrorCodes.PendingResponseRejected,
                "Pending response rejected since connection got disposed"
              );
              for (const k of ke.values()) k.reject(p);
              ((ke = new Map()),
                (Ce = new Map()),
                (Ie = new Set()),
                (ce = new i.LinkedMap()),
                r.func($.dispose) && $.dispose(),
                r.func(g.dispose) && g.dispose());
            },
            listen: () => {
              (Xt(), pa(), (it = _.Listening), g.listen(aa));
            },
            inspect: () => {
          ...
          return (
            q.onNotification(I.type, (p) => {
              if (Y === m.Off || !ye) return;
              const k = Y === m.Verbose || Y === m.Compact;
              ye.log(p.message, k ? p.verbose : void 0);
            }),
            q.onNotification(c.type, (p) => {
              const k = Ne.get(p.token);
              k ? k(p.value) : Un.fire(p);
            }),
            q
          );
        }
...
function kT() {
  if (Cu) return Sa;
  ((Cu = 1), Object.defineProperty(Sa, "__esModule", { value: !0 }));
  const t = Fl();
  ...
  class r {
    constructor(l) {
      ((this.socket = l),
        ...
        (this._messageListener = (c) => {
          c.data.arrayBuffer().then(
            (d) => {
    ...
    onClose(l) {
      return (
        ...
        t.Disposable.create(() => this.socket.removeEventListener("close", l))
      );
    }
    onError(l) {
      return (
        this.socket.addEventListener("error", l),
        t.Disposable.create(() => this.socket.removeEventListener("error", l))
      );
    }
    onEnd(l) {
      return (
        this.socket.addEventListener("end", l),
        t.Disposable.create(() => this.socket.removeEventListener("end", l))
      );
    }
    onData(l) {
  ...
  const i = new TextEncoder(),
    a = Object.freeze({
      messageBuffer: Object.freeze({ create: (o) => new e(o) }),
      applicationJson: Object.freeze({
        encoder: Object.freeze({
          ...
          encode: (o, l) => {
            if (l.charset !== "utf-8")
              throw new Error(
                `In a Browser environments only utf-8 text encoding is supported. But got encoding: ${l.charset}`
              );
      ...
      stream: Object.freeze({ asReadableStream: (o) => new r(o), asWritableStream: (o) => new n(o) }),
      console,
      timer: Object.freeze({
        setTimeout(o, l, ...c) {
    ...
    Su ||
      ...
      (function (t) {
        var e =
            ...
            (Object.create
              ? function (l, c, u, d) {
                  ...
                  ((!m || ("get" in m ? !c.__esModule : m.writable || m.configurable)) &&
                    (m = {
                      enumerable: !0,
                      get: function () {
                        return c[u];
        ...
        class a extends i.AbstractMessageReader {
          constructor(c) {
            (super(),
              (this._onData = new i.Emitter()),
              (this._messageListener = (u) => {
                this._onData.fire(u.data);
              }),
              c.addEventListener("error", (u) => this.fireError(u)),
              (c.onmessage = this._messageListener));
          }
          listen(c) {
        ...
        function o(l, c, u, d) {
          return (
            u === void 0 && (u = i.NullLogger),
            i.ConnectionStrategy.is(d) && (d = { connectionStrategy: d }),
            (0, i.createMessageConnection)(l, c, u, d)
          );
        }
...
function me() {
  ...
  ((bu = 1),
    ...
    (je.ProtocolNotificationType =
      je.ProtocolNotificationType0 =
      je.ProtocolRequestType =
      je.ProtocolRequestType0 =
      je.RegistrationType =
      je.MessageDirection =
        void 0));
  const t = Fn();
...
function bT() {
  if (Nu) return oi;
  ((Nu = 1), Object.defineProperty(oi, "__esModule", { value: !0 }), (oi.ImplementationRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/implementation"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (oi.ImplementationRequest = e = {})),
    oi
  );
}
var li = {},
...
function _T() {
  if (Iu) return li;
  ((Iu = 1), Object.defineProperty(li, "__esModule", { value: !0 }), (li.TypeDefinitionRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/typeDefinition"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (li.TypeDefinitionRequest = e = {})),
    li
  );
}
var hr = {},
...
function NT() {
  ...
  (function (n) {
    ((n.method = "workspace/workspaceFolders"),
      (n.messageDirection = t.MessageDirection.serverToClient),
      (n.type = new t.ProtocolRequestType0(n.method)));
  })(e || (hr.WorkspaceFoldersRequest = e = {}));
  var r;
  return (
    (function (n) {
      ((n.method = "workspace/didChangeWorkspaceFolders"),
        (n.messageDirection = t.MessageDirection.clientToServer),
        (n.type = new t.ProtocolNotificationType(n.method)));
    })(r || (hr.DidChangeWorkspaceFoldersNotification = r = {})),
    hr
  );
}
var ci = {},
...
function IT() {
  if (Ou) return ci;
  ((Ou = 1), Object.defineProperty(ci, "__esModule", { value: !0 }), (ci.ConfigurationRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "workspace/configuration"),
        (r.messageDirection = t.MessageDirection.serverToClient),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (ci.ConfigurationRequest = e = {})),
    ci
  );
}
var pr = {},
...
function PT() {
  ...
  ((Lu = 1),
    ...
    (pr.ColorPresentationRequest = pr.DocumentColorRequest = void 0));
  const t = me();
  var e;
  (function (n) {
    ((n.method = "textDocument/documentColor"),
      (n.messageDirection = t.MessageDirection.clientToServer),
      (n.type = new t.ProtocolRequestType(n.method)));
  })(e || (pr.DocumentColorRequest = e = {}));
  var r;
  return (
    (function (n) {
      ((n.method = "textDocument/colorPresentation"),
        (n.messageDirection = t.MessageDirection.clientToServer),
        (n.type = new t.ProtocolRequestType(n.method)));
    })(r || (pr.ColorPresentationRequest = r = {})),
    pr
  );
}
var mr = {},
...
function OT() {
  ...
  ((xu = 1),
    ...
    (mr.FoldingRangeRefreshRequest = mr.FoldingRangeRequest = void 0));
  const t = me();
  var e;
  (function (n) {
  ...
  return (
    (function (n) {
      ((n.method = "workspace/foldingRange/refresh"),
        (n.messageDirection = t.MessageDirection.serverToClient),
        (n.type = new t.ProtocolRequestType0(n.method)));
    })(r || (mr.FoldingRangeRefreshRequest = r = {})),
    mr
  );
}
var ui = {},
...
function LT() {
  if (Du) return ui;
  ((Du = 1), Object.defineProperty(ui, "__esModule", { value: !0 }), (ui.DeclarationRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/declaration"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (ui.DeclarationRequest = e = {})),
    ui
  );
}
var fi = {},
...
function xT() {
  if (Mu) return fi;
  ((Mu = 1), Object.defineProperty(fi, "__esModule", { value: !0 }), (fi.SelectionRangeRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/selectionRange"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (fi.SelectionRangeRequest = e = {})),
    fi
  );
}
var _t = {},
...
function DT() {
  ...
  ((Fu = 1),
    ...
    (_t.WorkDoneProgressCancelNotification = _t.WorkDoneProgressCreateRequest = _t.WorkDoneProgress = void 0));
  const t = Fn(),
    e = me();
  var r;
  (function (a) {
...
function MT() {
  ...
  ((Gu = 1),
    ...
    (Nt.CallHierarchyOutgoingCallsRequest =
      Nt.CallHierarchyIncomingCallsRequest =
      Nt.CallHierarchyPrepareRequest =
        void 0));
  const t = me();
  var e;
  (function (i) {
    ((i.method = "textDocument/prepareCallHierarchy"),
      (i.messageDirection = t.MessageDirection.clientToServer),
      (i.type = new t.ProtocolRequestType(i.method)));
  ...
  return (
    (function (i) {
      ((i.method = "callHierarchy/outgoingCalls"),
        (i.messageDirection = t.MessageDirection.clientToServer),
        (i.type = new t.ProtocolRequestType(i.method)));
    })(n || (Nt.CallHierarchyOutgoingCallsRequest = n = {})),
    Nt
  );
}
var ze = {},
...
function FT() {
  ...
  ((ju = 1),
    ...
    (ze.SemanticTokensRefreshRequest =
      ze.SemanticTokensRangeRequest =
      ze.SemanticTokensDeltaRequest =
      ze.SemanticTokensRequest =
      ze.SemanticTokensRegistrationType =
      ze.TokenFormat =
        void 0));
  const t = me();
  var e;
  ...
  var n;
  (function (o) {
    ((o.method = "textDocument/semanticTokens/full"),
      (o.messageDirection = t.MessageDirection.clientToServer),
      (o.type = new t.ProtocolRequestType(o.method)),
      (o.registrationMethod = r.method));
  })(n || (ze.SemanticTokensRequest = n = {}));
  var i;
  (function (o) {
    ((o.method = "textDocument/semanticTokens/full/delta"),
      (o.messageDirection = t.MessageDirection.clientToServer),
      (o.type = new t.ProtocolRequestType(o.method)),
      (o.registrationMethod = r.method));
  ...
  var a;
  (function (o) {
    ((o.method = "textDocument/semanticTokens/range"),
      (o.messageDirection = t.MessageDirection.clientToServer),
      (o.type = new t.ProtocolRequestType(o.method)),
      (o.registrationMethod = r.method));
  ...
  return (
    (function (o) {
      ((o.method = "workspace/semanticTokens/refresh"),
        (o.messageDirection = t.MessageDirection.serverToClient),
        (o.type = new t.ProtocolRequestType0(o.method)));
    })(s || (ze.SemanticTokensRefreshRequest = s = {})),
    ze
  );
}
var di = {},
...
function GT() {
  if (zu) return di;
  ((zu = 1), Object.defineProperty(di, "__esModule", { value: !0 }), (di.ShowDocumentRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "window/showDocument"),
        (r.messageDirection = t.MessageDirection.serverToClient),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (di.ShowDocumentRequest = e = {})),
    di
  );
}
var hi = {},
...
function jT() {
  if (Uu) return hi;
  ((Uu = 1), Object.defineProperty(hi, "__esModule", { value: !0 }), (hi.LinkedEditingRangeRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/linkedEditingRange"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (hi.LinkedEditingRangeRequest = e = {})),
    hi
  );
}
var Oe = {},
...
function zT() {
  ...
  ((qu = 1),
    ...
    (Oe.WillDeleteFilesRequest =
      Oe.DidDeleteFilesNotification =
      Oe.DidRenameFilesNotification =
      Oe.WillRenameFilesRequest =
      Oe.DidCreateFilesNotification =
      Oe.WillCreateFilesRequest =
      Oe.FileOperationPatternKind =
        void 0));
  const t = me();
  var e;
  (function (l) {
  ...
  var r;
  (function (l) {
    ((l.method = "workspace/willCreateFiles"),
      (l.messageDirection = t.MessageDirection.clientToServer),
      (l.type = new t.ProtocolRequestType(l.method)));
  })(r || (Oe.WillCreateFilesRequest = r = {}));
  var n;
  (function (l) {
    ((l.method = "workspace/didCreateFiles"),
      (l.messageDirection = t.MessageDirection.clientToServer),
      (l.type = new t.ProtocolNotificationType(l.method)));
  })(n || (Oe.DidCreateFilesNotification = n = {}));
  var i;
  (function (l) {
    ((l.method = "workspace/willRenameFiles"),
      (l.messageDirection = t.MessageDirection.clientToServer),
      (l.type = new t.ProtocolRequestType(l.method)));
  })(i || (Oe.WillRenameFilesRequest = i = {}));
  var a;
  (function (l) {
    ((l.method = "workspace/didRenameFiles"),
      (l.messageDirection = t.MessageDirection.clientToServer),
      (l.type = new t.ProtocolNotificationType(l.method)));
  })(a || (Oe.DidRenameFilesNotification = a = {}));
  var s;
  (function (l) {
    ((l.method = "workspace/didDeleteFiles"),
      (l.messageDirection = t.MessageDirection.clientToServer),
      (l.type = new t.ProtocolNotificationType(l.method)));
  ...
  return (
    (function (l) {
      ((l.method = "workspace/willDeleteFiles"),
        (l.messageDirection = t.MessageDirection.clientToServer),
        (l.type = new t.ProtocolRequestType(l.method)));
    })(o || (Oe.WillDeleteFilesRequest = o = {})),
    Oe
  );
}
var It = {},
...
function UT() {
  ...
  ((Bu = 1),
    ...
    (It.MonikerRequest = It.MonikerKind = It.UniquenessLevel = void 0));
  const t = me();
  var e;
  (function (i) {
    ((i.document = "document"),
...
function qT() {
  ...
  ((Wu = 1),
    ...
    (Pt.TypeHierarchySubtypesRequest = Pt.TypeHierarchySupertypesRequest = Pt.TypeHierarchyPrepareRequest = void 0));
  const t = me();
  var e;
  (function (i) {
    ((i.method = "textDocument/prepareTypeHierarchy"),
      (i.messageDirection = t.MessageDirection.clientToServer),
      (i.type = new t.ProtocolRequestType(i.method)));
  })(e || (Pt.TypeHierarchyPrepareRequest = e = {}));
  var r;
  (function (i) {
    ((i.method = "typeHierarchy/supertypes"),
      (i.messageDirection = t.MessageDirection.clientToServer),
      (i.type = new t.ProtocolRequestType(i.method)));
  })(r || (Pt.TypeHierarchySupertypesRequest = r = {}));
  var n;
  return (
    (function (i) {
      ((i.method = "typeHierarchy/subtypes"),
        (i.messageDirection = t.MessageDirection.clientToServer),
        (i.type = new t.ProtocolRequestType(i.method)));
    })(n || (Pt.TypeHierarchySubtypesRequest = n = {})),
    Pt
  );
}
var gr = {},
...
function BT() {
  ...
  ((Vu = 1),
    ...
    (gr.InlineValueRefreshRequest = gr.InlineValueRequest = void 0));
  const t = me();
  var e;
  (function (n) {
  ...
  return (
    (function (n) {
      ((n.method = "workspace/inlineValue/refresh"),
        (n.messageDirection = t.MessageDirection.serverToClient),
        (n.type = new t.ProtocolRequestType0(n.method)));
    })(r || (gr.InlineValueRefreshRequest = r = {})),
    gr
  );
}
var Ot = {},
...
function WT() {
  ...
  ((Ku = 1),
    ...
    (Ot.InlayHintRefreshRequest = Ot.InlayHintResolveRequest = Ot.InlayHintRequest = void 0));
  const t = me();
  var e;
  (function (i) {
    ((i.method = "textDocument/inlayHint"),
      (i.messageDirection = t.MessageDirection.clientToServer),
      (i.type = new t.ProtocolRequestType(i.method)));
  })(e || (Ot.InlayHintRequest = e = {}));
  var r;
  (function (i) {
    ((i.method = "inlayHint/resolve"),
      (i.messageDirection = t.MessageDirection.clientToServer),
      (i.type = new t.ProtocolRequestType(i.method)));
  })(r || (Ot.InlayHintResolveRequest = r = {}));
  var n;
  return (
    (function (i) {
      ((i.method = "workspace/inlayHint/refresh"),
        (i.messageDirection = t.MessageDirection.serverToClient),
        (i.type = new t.ProtocolRequestType0(i.method)));
    })(n || (Ot.InlayHintRefreshRequest = n = {})),
    Ot
  );
}
var Ye = {},
...
function VT() {
  ...
  ((Hu = 1),
    ...
    (Ye.DiagnosticRefreshRequest =
      Ye.WorkspaceDiagnosticRequest =
      Ye.DocumentDiagnosticRequest =
      Ye.DocumentDiagnosticReportKind =
      Ye.DiagnosticServerCancellationData =
        void 0));
  const t = Fn(),
    e = yc(),
    r = me();
  ...
  var a;
  (function (l) {
    ((l.method = "textDocument/diagnostic"),
      (l.messageDirection = r.MessageDirection.clientToServer),
      (l.type = new r.ProtocolRequestType(l.method)),
      (l.partialResult = new t.ProgressType()));
  })(a || (Ye.DocumentDiagnosticRequest = a = {}));
  var s;
  (function (l) {
    ((l.method = "workspace/diagnostic"),
      (l.messageDirection = r.MessageDirection.clientToServer),
      (l.type = new r.ProtocolRequestType(l.method)),
      (l.partialResult = new t.ProgressType()));
  ...
  return (
    (function (l) {
      ((l.method = "workspace/diagnostic/refresh"),
        (l.messageDirection = r.MessageDirection.serverToClient),
        (l.type = new r.ProtocolRequestType0(l.method)));
    })(o || (Ye.DiagnosticRefreshRequest = o = {})),
    Ye
  );
}
var fe = {},
...
function KT() {
  ...
  ((Xu = 1),
    ...
    (fe.DidCloseNotebookDocumentNotification =
      fe.DidSaveNotebookDocumentNotification =
      fe.DidChangeNotebookDocumentNotification =
      fe.NotebookCellArrayChange =
      fe.DidOpenNotebookDocumentNotification =
  ...
  (function (h) {
    ...
    h.is = E;
  })(n || (fe.NotebookCellKind = n = {}));
  var i;
  (function (h) {
    function E(C, w) {
      const S = { executionOrder: C };
      return ((w === !0 || w === !1) && (S.success = w), S);
    }
    h.create = E;
    function b(C) {
      const w = C;
      return e.objectLiteral(w) && t.uinteger.is(w.executionOrder) && (w.success === void 0 || e.boolean(w.success));
    }
    h.is = b;
    function I(C, w) {
      return C === w
        ? !0
        : C == null || w === null || w === void 0
          ? !1
          : C.executionOrder === w.executionOrder && C.success === w.success;
    }
    h.equals = I;
  })(i || (fe.ExecutionSummary = i = {}));
  var a;
  (function (h) {
    function E(w, S) {
      return { kind: w, document: S };
    }
    h.create = E;
    function b(w) {
      const S = w;
      return (
        e.objectLiteral(S) &&
        n.is(S.kind) &&
        t.DocumentUri.is(S.document) &&
        (S.metadata === void 0 || e.objectLiteral(S.metadata))
      );
    }
    h.is = b;
    function I(w, S) {
      const P = new Set();
      return (
        w.document !== S.document && P.add("document"),
        w.kind !== S.kind && P.add("kind"),
        w.executionSummary !== S.executionSummary && P.add("executionSummary"),
        (w.metadata !== void 0 || S.metadata !== void 0) && !C(w.metadata, S.metadata) && P.add("metadata"),
        (w.executionSummary !== void 0 || S.executionSummary !== void 0) &&
          !i.equals(w.executionSummary, S.executionSummary) &&
          P.add("executionSummary"),
        P
      );
    }
    h.diff = I;
    function C(w, S) {
      if (w === S) return !0;
      if (w == null || S === null || S === void 0 || typeof w != typeof S || typeof w != "object") return !1;
      const P = Array.isArray(w),
        W = Array.isArray(S);
      if (P !== W) return !1;
      if (P && W) {
        if (w.length !== S.length) return !1;
        for (let B = 0; B < w.length; B++) if (!C(w[B], S[B])) return !1;
      }
      if (e.objectLiteral(w) && e.objectLiteral(S)) {
        const B = Object.keys(w),
          H = Object.keys(S);
        if (B.length !== H.length || (B.sort(), H.sort(), !C(B, H))) return !1;
        for (let ne = 0; ne < B.length; ne++) {
          const oe = B[ne];
          if (!C(w[oe], S[oe])) return !1;
        }
      }
      return !0;
    }
  ...
  (function (h) {
    function E(I, C, w, S) {
      return { uri: I, notebookType: C, version: w, cells: S };
    }
    h.create = E;
    function b(I) {
      const C = I;
      return e.objectLiteral(C) && e.string(C.uri) && t.integer.is(C.version) && e.typedArray(C.cells, a.is);
    }
    h.is = b;
  })(s || (fe.NotebookDocument = s = {}));
  var o;
  (function (h) {
    ((h.method = "notebookDocument/sync"),
      (h.messageDirection = r.MessageDirection.clientToServer),
      (h.type = new r.RegistrationType(h.method)));
  })(o || (fe.NotebookDocumentSyncRegistrationType = o = {}));
  var l;
  (function (h) {
    ((h.method = "notebookDocument/didOpen"),
      (h.messageDirection = r.MessageDirection.clientToServer),
      (h.type = new r.ProtocolNotificationType(h.method)),
      (h.registrationMethod = o.method));
  })(l || (fe.DidOpenNotebookDocumentNotification = l = {}));
  var c;
  (function (h) {
    function E(I) {
      const C = I;
      return (
        e.objectLiteral(C) &&
        t.uinteger.is(C.start) &&
        t.uinteger.is(C.deleteCount) &&
        (C.cells === void 0 || e.typedArray(C.cells, a.is))
      );
    }
    h.is = E;
    function b(I, C, w) {
      const S = { start: I, deleteCount: C };
      return (w !== void 0 && (S.cells = w), S);
    }
    h.create = b;
  })(c || (fe.NotebookCellArrayChange = c = {}));
  var u;
  (function (h) {
    ((h.method = "notebookDocument/didChange"),
      ...
      (h.type = new r.ProtocolNotificationType(h.method)),
      (h.registrationMethod = o.method));
  })(u || (fe.DidChangeNotebookDocumentNotification = u = {}));
  var d;
  (function (h) {
    ((h.method = "notebookDocument/didSave"),
      (h.messageDirection = r.MessageDirection.clientToServer),
      (h.type = new r.ProtocolNotificationType(h.method)),
      (h.registrationMethod = o.method));
  })(d || (fe.DidSaveNotebookDocumentNotification = d = {}));
  var m;
  return (
    (function (h) {
      ((h.method = "notebookDocument/didClose"),
        (h.messageDirection = r.MessageDirection.clientToServer),
        (h.type = new r.ProtocolNotificationType(h.method)),
        (h.registrationMethod = o.method));
    })(m || (fe.DidCloseNotebookDocumentNotification = m = {})),
    fe
  );
}
var pi = {},
...
function HT() {
  if (Yu) return pi;
  ((Yu = 1), Object.defineProperty(pi, "__esModule", { value: !0 }), (pi.InlineCompletionRequest = void 0));
  const t = me();
  var e;
  return (
    (function (r) {
      ((r.method = "textDocument/inlineCompletion"),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(e || (pi.InlineCompletionRequest = e = {})),
    pi
  );
}
var Ju;
    ...
    Ju ||
      ...
      (function (t) {
        ...
        (function (f) {
          ...
          f.is = ve;
        })(le || (t.NotebookDocumentFilter = le = {}));
        var _;
        (function (f) {
          function ve(Ee) {
            const q = Ee;
            return (
              n.objectLiteral(q) &&
              (n.string(q.notebook) || le.is(q.notebook)) &&
              (q.language === void 0 || n.string(q.language))
            );
          }
          f.is = ve;
        ...
        (function (f) {
          function ve(Ee) {
            if (!Array.isArray(Ee)) return !1;
            for (let q of Ee) if (!n.string(q) && !oe.is(q) && !_.is(q)) return !1;
            return !0;
          }
          f.is = ve;
        ...
        var g;
        (function (f) {
          ((f.method = "client/registerCapability"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(g || (t.RegistrationRequest = g = {}));
        var $;
        (function (f) {
          ((f.method = "client/unregisterCapability"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolRequestType(f.method)));
        })($ || (t.UnregistrationRequest = $ = {}));
        var y;
        ...
        (function (f) {
          ((f.Abort = "abort"),
            ...
            (f.TextOnlyTransactional = "textOnlyTransactional"),
            (f.Undo = "undo"));
        })(T || (t.FailureHandlingKind = T = {}));
        var A;
        (function (f) {
          ((f.UTF8 = "utf-8"), (f.UTF16 = "utf-16"), (f.UTF32 = "utf-32"));
        })(A || (t.PositionEncodingKind = A = {}));
        var L;
        (function (f) {
          function ve(Ee) {
            const q = Ee;
        ...
        (function (f) {
          function ve(Ee) {
            const q = Ee;
            return q && (q.documentSelector === null || R.is(q.documentSelector));
          }
          f.is = ve;
        ...
        (function (f) {
          function ve(q) {
            const p = q;
            return n.objectLiteral(p) && (p.workDoneProgress === void 0 || n.boolean(p.workDoneProgress));
          }
          f.is = ve;
          function Ee(q) {
            const p = q;
            return p && n.boolean(p.workDoneProgress);
          }
        ...
        (function (f) {
          ((f.method = "initialize"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        ...
        var te;
        (function (f) {
          ((f.method = "initialized"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(te || (t.InitializedNotification = te = {}));
        var z;
        (function (f) {
          ((f.method = "shutdown"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType0(f.method)));
        })(z || (t.ShutdownRequest = z = {}));
        var Q;
        (function (f) {
          ((f.method = "exit"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType0(f.method)));
        })(Q || (t.ExitNotification = Q = {}));
        var Ne;
        (function (f) {
          ((f.method = "workspace/didChangeConfiguration"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(Ne || (t.DidChangeConfigurationNotification = Ne = {}));
        var ge;
        (function (f) {
        ...
        var ce;
        (function (f) {
          ((f.method = "window/showMessage"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(ce || (t.ShowMessageNotification = ce = {}));
        var ke;
        (function (f) {
          ((f.method = "window/showMessageRequest"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ke || (t.ShowMessageRequest = ke = {}));
        var Ie;
        (function (f) {
          ((f.method = "window/logMessage"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(Ie || (t.LogMessageNotification = Ie = {}));
        var Ce;
        (function (f) {
          ((f.method = "telemetry/event"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolNotificationType(f.method)));
        ...
        (function (f) {
          function ve(q) {
            ...
            return (
              ...
              p.range !== void 0 &&
              (p.rangeLength === void 0 || typeof p.rangeLength == "number")
            );
          }
          f.isIncremental = ve;
          function Ee(q) {
            let p = q;
            return p != null && typeof p.text == "string" && p.range === void 0 && p.rangeLength === void 0;
          }
          f.isFull = Ee;
        })(ye || (t.TextDocumentContentChangeEvent = ye = {}));
        var it;
        (function (f) {
          ((f.method = "textDocument/didChange"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(it || (t.DidChangeTextDocumentNotification = it = {}));
        var Dr;
        (function (f) {
          ((f.method = "textDocument/didClose"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(Dr || (t.DidCloseTextDocumentNotification = Dr = {}));
        var jn;
        (function (f) {
          ((f.method = "textDocument/didSave"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        ...
        var Un;
        (function (f) {
          ((f.method = "textDocument/willSave"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(Un || (t.WillSaveTextDocumentNotification = Un = {}));
        var qn;
        (function (f) {
          ((f.method = "textDocument/willSaveWaitUntil"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(qn || (t.WillSaveTextDocumentWaitUntilRequest = qn = {}));
        var at;
        (function (f) {
          ((f.method = "workspace/didChangeWatchedFiles"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolNotificationType(f.method)));
        ...
        })(Bn || (t.FileChangeType = Bn = {}));
        var Zi;
        (function (f) {
          function ve(Ee) {
            const q = Ee;
            return (
              n.objectLiteral(q) && (r.URI.is(q.baseUri) || r.WorkspaceFolder.is(q.baseUri)) && n.string(q.pattern)
            );
          }
          f.is = ve;
        })(Zi || (t.RelativePattern = Zi = {}));
        var Qi;
        (function (f) {
        ...
        (function (f) {
          ((f.method = "textDocument/publishDiagnostics"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolNotificationType(f.method)));
        })(ea || (t.PublishDiagnosticsNotification = ea = {}));
        var ta;
        (function (f) {
          ((f.Invoked = 1), (f.TriggerCharacter = 2), (f.TriggerForIncompleteCompletions = 3));
        })(ta || (t.CompletionTriggerKind = ta = {}));
        var Wn;
        (function (f) {
          ((f.method = "textDocument/completion"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Wn || (t.CompletionRequest = Wn = {}));
        var Vn;
        (function (f) {
          ((f.method = "completionItem/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Vn || (t.CompletionResolveRequest = Vn = {}));
        var $t;
        (function (f) {
          ((f.method = "textDocument/hover"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })($t || (t.HoverRequest = $t = {}));
        var Kn;
        ...
        })(Kn || (t.SignatureHelpTriggerKind = Kn = {}));
        var ra;
        (function (f) {
          ((f.method = "textDocument/signatureHelp"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ra || (t.SignatureHelpRequest = ra = {}));
        var na;
        (function (f) {
          ((f.method = "textDocument/definition"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(na || (t.DefinitionRequest = na = {}));
        var Hn;
        (function (f) {
          ((f.method = "textDocument/references"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Hn || (t.ReferencesRequest = Hn = {}));
        var Xn;
        (function (f) {
          ((f.method = "textDocument/documentHighlight"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Xn || (t.DocumentHighlightRequest = Xn = {}));
        var ia;
        (function (f) {
          ((f.method = "textDocument/documentSymbol"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ia || (t.DocumentSymbolRequest = ia = {}));
        var aa;
        (function (f) {
          ((f.method = "textDocument/codeAction"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(aa || (t.CodeActionRequest = aa = {}));
        var sa;
        (function (f) {
          ((f.method = "codeAction/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(sa || (t.CodeActionResolveRequest = sa = {}));
        var oa;
        (function (f) {
          ((f.method = "workspace/symbol"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(oa || (t.WorkspaceSymbolRequest = oa = {}));
        var la;
        (function (f) {
          ((f.method = "workspaceSymbol/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(la || (t.WorkspaceSymbolResolveRequest = la = {}));
        var ca;
        (function (f) {
          ((f.method = "textDocument/codeLens"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ca || (t.CodeLensRequest = ca = {}));
        var st;
        (function (f) {
          ((f.method = "codeLens/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(st || (t.CodeLensResolveRequest = st = {}));
        var ua;
        (function (f) {
          ((f.method = "workspace/codeLens/refresh"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolRequestType0(f.method)));
        })(ua || (t.CodeLensRefreshRequest = ua = {}));
        var fa;
        (function (f) {
          ((f.method = "textDocument/documentLink"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(fa || (t.DocumentLinkRequest = fa = {}));
        var ar;
        (function (f) {
          ((f.method = "documentLink/resolve"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ar || (t.DocumentLinkResolveRequest = ar = {}));
        var da;
        (function (f) {
          ((f.method = "textDocument/formatting"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(da || (t.DocumentFormattingRequest = da = {}));
        var Mr;
        (function (f) {
          ((f.method = "textDocument/rangeFormatting"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Mr || (t.DocumentRangeFormattingRequest = Mr = {}));
        var ha;
        (function (f) {
          ((f.method = "textDocument/rangesFormatting"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ha || (t.DocumentRangesFormattingRequest = ha = {}));
        var Ct;
        (function (f) {
          ((f.method = "textDocument/onTypeFormatting"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        ...
        (function (f) {
          f.Identifier = 1;
        })(Xt || (t.PrepareSupportDefaultBehavior = Xt = {}));
        var pa;
        (function (f) {
          ((f.method = "textDocument/rename"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(pa || (t.RenameRequest = pa = {}));
        var ma;
        (function (f) {
          ((f.method = "textDocument/prepareRename"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(ma || (t.PrepareRenameRequest = ma = {}));
        var Yt;
        (function (f) {
          ((f.method = "workspace/executeCommand"),
            (f.messageDirection = e.MessageDirection.clientToServer),
            (f.type = new e.ProtocolRequestType(f.method)));
        })(Yt || (t.ExecuteCommandRequest = Yt = {}));
        var Yn;
        (function (f) {
          ((f.method = "workspace/applyEdit"),
            (f.messageDirection = e.MessageDirection.serverToClient),
            (f.type = new e.ProtocolRequestType("workspace/applyEdit")));
        })(Yn || (t.ApplyWorkspaceEditRequest = Yn = {}));
      })(Js)),
    Js
  );
}
...
function YT() {
  if (Zu) return mi;
  ((Zu = 1), Object.defineProperty(mi, "__esModule", { value: !0 }), (mi.createProtocolConnection = void 0));
  const t = Fn();
  function e(r, n, i, a) {
    return (t.ConnectionStrategy.is(a) && (a = { connectionStrategy: a }), (0, t.createMessageConnection)(r, n, i, a));
  }
  return ((mi.createProtocolConnection = e), mi);
}
var Qu;
function JT() {
  return (
    Qu ||
      ...
      (function (t) {
        ...
        var i;
        (function (a) {
          ((a.lspReservedErrorRangeStart = -32899),
            (a.RequestFailed = -32803),
            (a.ServerCancelled = -32802),
            (a.ContentModified = -32801),
            (a.RequestCancelled = -32800),
            (a.lspReservedErrorRangeEnd = -32800));
        })(i || (t.LSPErrorCodes = i = {}));
      })(dr)),
    dr
  );
...
class QT {
  constructor(e) {
    ((this.updateBuildOptions = { validation: { categories: ["built-in", "fast"] } }),
      ...
      (this.buildPhaseListeners = new zi()),
      (this.documentPhaseListeners = new zi()),
      (this.buildState = new Map()),
      (this.documentBuildWaiters = new Map()),
      (this.currentState = V.Changed),
  ...
  async build(e, r = {}, n = pe.CancellationToken.None) {
    var i;
    for (const a of e) {
      const s = a.uri.toString();
      if (a.state === V.Validated) {
        if (typeof r.validation == "boolean" && r.validation) this.resetToState(a, V.IndexedReferences);
        else if (typeof r.validation == "object") {
          const o = this.findMissingValidationCategories(a, r);
          o.length > 0 &&
            (this.buildState.set(s, {
              completed: !1,
              options: { validation: { categories: o } },
              result: (i = this.buildState.get(s)) == null ? void 0 : i.result,
            }),
            (a.state = V.IndexedReferences));
        }
      } else this.buildState.delete(s);
    }
    ((this.currentState = V.Changed),
  ...
  async update(e, r, n = pe.CancellationToken.None) {
    this.currentState = V.Changed;
    const i = [];
    for (const l of r) {
      const c = this.langiumDocuments.deleteDocuments(l);
      for (const u of c) (i.push(u.uri), this.cleanUpDeleted(u));
    }
    ...
    (this.langiumDocuments.all
      .filter((l) => !s.has(l.uri.toString()) && this.shouldRelink(l, s))
      .forEach((l) => this.resetToState(l, V.ComputedScopes)),
      await this.emitUpdate(a, i),
      await Ue(n));
    const o = this.sortDocuments(
      this.langiumDocuments.all
        .filter((l) => {
          var c;
          return (
  ...
  findMissingValidationCategories(e, r) {
    ...
    const n = this.buildState.get(e.uri.toString()),
      i = this.serviceRegistry.getServices(e.uri).validation.ValidationRegistry.getAllValidationCategories(e),
      a =
        (o = n == null ? void 0 : n.result) != null && o.validationChecks
          ? new Set((l = n == null ? void 0 : n.result) == null ? void 0 : l.validationChecks)
          : n != null && n.completed
            ? i
            : new Set(),
      s =
        r === void 0 || r.validation === !0 ? i : typeof r.validation == "object" ? (r.validation.categories ?? i) : [];
    return de(s)
      .filter((c) => !a.has(c))
      .toArray();
  }
  async findChangedUris(e) {
    var n;
    if (this.langiumDocuments.getDocument(e) ?? ((n = this.textDocuments) == null ? void 0 : n.get(e))) return [e];
    try {
  ...
  cleanUpDeleted(e) {
    (this.buildState.delete(e.uri.toString()), this.indexManager.remove(e.uri), (e.state = V.Changed));
  }
  async buildDocuments(e, r, n) {
    (this.prepareBuild(e, r),
      await this.runCancelable(e, V.Parsed, n, (s) => this.langiumDocumentFactory.update(s, n)),
      await this.runCancelable(e, V.IndexedContent, n, (s) => this.indexManager.updateContent(s, n)),
      await this.runCancelable(e, V.ComputedScopes, n, async (s) => {
    ...
    (await this.runCancelable(i, V.Linked, n, (s) =>
      this.serviceRegistry.getServices(s.uri).references.Linker.link(s, n)
    ),
      await this.runCancelable(i, V.IndexedReferences, n, (s) => this.indexManager.updateReferences(s, n)));
    const a = e.filter((s) => (this.shouldValidate(s) ? !0 : (this.markAsCompleted(s), !1)));
    await this.runCancelable(a, V.Validated, n, async (s) => {
  ...
  prepareBuild(e, r) {
    for (const n of e) {
      ...
      (!a || a.completed) &&
        this.buildState.set(i, { completed: !1, options: r, result: a == null ? void 0 : a.result });
    }
  }
  async runCancelable(e, r, n, i) {
    for (const s of e) s.state < r && (await Ue(n), await i(s), (s.state = r), await this.notifyDocumentPhase(s, r, n));
  ...
  waitUntil(e, r, n) {
    ...
    return (
      r && "path" in r ? (i = r) : (n = r),
      n ?? (n = pe.CancellationToken.None),
      i ? this.awaitDocumentState(e, i, n) : this.awaitBuilderState(e, n)
    );
  }
  awaitDocumentState(e, r, n) {
    const i = this.langiumDocuments.getDocument(r);
    if (i) {
      if (i.state >= e) return Promise.resolve(r);
      if (n.isCancellationRequested) return Promise.reject(an);
      if (this.currentState >= e && e > i.state)
        return Promise.reject(
          new wa.ResponseError(
            wa.LSPErrorCodes.RequestFailed,
            `Document state of ${r.toString()} is ${V[i.state]}, requiring ${V[e]}, but workspace state is already ${V[this.currentState]}. Returning undefined.`
          )
        );
    } else
      return Promise.reject(
        new wa.ResponseError(wa.LSPErrorCodes.ServerCancelled, `No document found for URI: ${r.toString()}`)
      );
  ...
  async notifyBuildPhase(e, r, n) {
    ...
    for (const s of a) (await Ue(n), await s(e, n));
  }
  shouldLink(e) {
  ...
  async validate(e, r) {
    const n = this.serviceRegistry.getServices(e.uri).validation.DocumentValidator,
      i = this.getBuildOptions(e),
      a = typeof i.validation == "object" ? { ...i.validation } : {};
    ...
    o &&
      ...
      o.result.validationChecks
        ? (o.result.validationChecks = de(o.result.validationChecks).concat(a.categories).distinct().toArray())
        : (o.result.validationChecks = [...a.categories]));
  }
  getBuildOptions(e) {
    var r;
...
class eR {
  ...
  getFileDescriptions(e, r) {
    return r
      ? this.symbolByTypeIndex.get(e, r, () =>
          (this.symbolIndex.get(e) ?? []).filter((a) => this.astReflection.isSubtype(a.type, r))
        )
  ...
  async updateContent(e, r = pe.CancellationToken.None) {
    const i = await this.serviceRegistry.getServices(e.uri).references.ScopeComputation.collectExportedSymbols(e, r),
      a = e.uri.toString();
    (this.symbolIndex.set(a, i), this.symbolByTypeIndex.clear(a));
  }
  async updateReferences(e, r = pe.CancellationToken.None) {
    const i = await this.serviceRegistry
      .getServices(e.uri)
...
class tR {
  ...
  async initializeWorkspace(e, r = pe.CancellationToken.None) {
  ...
  async performStartup(e) {
    ...
    const a = de(i)
      .distinct((s) => s.toString())
      .filter((s) => !this.langiumDocuments.hasDocument(s));
  ...
  async traverseFolder(e, r) {
    try {
      ...
      await Promise.all(
        n.map(async (i) => {
          this.shouldIncludeEntry(i) &&
            (i.isDirectory ? await this.traverseFolder(i.uri, r) : i.isFile && r.push(i.uri));
        })
      );
    } catch {}
  }
...
class rR {
  buildUnexpectedCharactersMessage(e, r, n, i, a) {
    return Co.buildUnexpectedCharactersMessage(e, r, n, i, a);
  }
  buildUnableToPopLexerModeMessage(e) {
    return Co.buildUnableToPopLexerModeMessage(e);
  }
}
const nR = { mode: "full" };
class iR {
  constructor(e) {
    ...
    const n = tf(r) ? Object.values(r) : r,
      i = e.LanguageMetaData.mode === "production";
  ...
  toTokenTypeDictionary(e) {
    if (tf(e)) return e;
    const r = Vd(e) ? Object.values(e.modes).flat() : e,
      n = {};
...
function sR(t, e, r) {
  ...
  const a = Kd(t),
    s = Tc(n),
    o = cR({ lines: a, position: i, options: s });
  return pR({ index: 0, tokens: o, position: i });
}
function oR(t, e) {
  const r = Tc(e),
    n = Kd(t);
...
function Kd(t) {
  let e = "";
  return (typeof t == "string" ? (e = t) : (e = t.text), e.split(cp));
}
const rf = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy,
  lR = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu;
function cR(t) {
  var i, a, s;
  const e = [];
  ...
  for (let o = 0; o < t.lines.length; o++) {
    const l = o === 0,
      c = o === t.lines.length - 1;
    let u = t.lines[o],
      d = 0;
    if (l && t.options.start) {
      const h = (i = t.options.start) == null ? void 0 : i.exec(u);
      h && (d = h.index + h[0].length);
    } else {
      const h = (a = t.options.line) == null ? void 0 : a.exec(u);
      h && (d = h.index + h[0].length);
    }
    if (c) {
      const h = (s = t.options.end) == null ? void 0 : s.exec(u);
      h && (u = u.substring(0, h.index));
    }
    if (((u = u.substring(0, hR(u))), Gl(u, d) >= u.length)) {
      if (e.length > 0) {
        const h = Z.create(r, n);
        e.push({ type: "break", content: "", range: K.create(h, h) });
      }
    } else {
      rf.lastIndex = d;
      const h = rf.exec(u);
      if (h) {
        const E = h[0],
          b = h[1],
          I = Z.create(r, n + d),
          C = Z.create(r, n + d + E.length);
        (e.push({ type: "tag", content: b, range: K.create(I, C) }), (d += E.length), (d = Gl(u, d)));
      }
      if (d < u.length) {
        const E = u.substring(d),
          b = Array.from(E.matchAll(lR));
        e.push(...uR(b, E, r, n + d));
      }
    }
    (r++, (n = 0));
...
function uR(t, e, r, n) {
  const i = [];
  if (t.length === 0) {
    const a = Z.create(r, n),
      s = Z.create(r, n + e.length);
    i.push({ type: "text", content: e, range: K.create(a, s) });
  } else {
    let a = 0;
    for (const o of t) {
      const l = o.index,
        c = e.substring(a, l);
      c.length > 0 &&
        i.push({ type: "text", content: e.substring(a, l), range: K.create(Z.create(r, a + n), Z.create(r, l + n)) });
      let u = c.length + 1;
      const d = o[1];
      if (
        (i.push({
          type: "inline-tag",
          content: d,
          range: K.create(Z.create(r, a + u + n), Z.create(r, a + u + d.length + n)),
        }),
        (u += d.length),
        o.length === 4)
      ) {
        ...
        i.push({
          type: "text",
          content: m,
          range: K.create(Z.create(r, a + u + n), Z.create(r, a + u + m.length + n)),
        });
      } else i.push({ type: "text", content: "", range: K.create(Z.create(r, a + u + n), Z.create(r, a + u + n)) });
      a = l + o[0].length;
    }
    const s = e.substring(a);
    s.length > 0 &&
      i.push({ type: "text", content: s, range: K.create(Z.create(r, a + n), Z.create(r, a + n + s.length)) });
  }
  return i;
}
const fR = /\S/,
  dR = /\s*$/;
function Gl(t, e) {
  const r = t.substring(e).match(fR);
...
function pR(t) {
  ...
  if (t.tokens.length === 0) return new nf([], K.create(e, e));
  const r = [];
  for (; t.index < t.tokens.length; ) {
    const o = mR(t, r[r.length - 1]);
    o && r.push(o);
  }
  const n = ((a = r[0]) == null ? void 0 : a.range.start) ?? e,
    i = ((s = r[r.length - 1]) == null ? void 0 : s.range.end) ?? e;
  return new nf(r, K.create(n, i));
}
function mR(t, e) {
  const r = t.tokens[t.index];
  if (r.type === "tag") return Xd(t, !1);
  if (r.type === "text" || r.type === "inline-tag") return Hd(t);
  (gR(r, e), t.index++);
}
function gR(t, e) {
  if (e) {
    const r = new Jd("", t.range);
...
function Hd(t) {
  ...
  let n = e;
  const i = [];
  for (; e && e.type !== "break" && e.type !== "tag"; ) (i.push(yR(t)), (n = e), (e = t.tokens[t.index]));
  return new jl(i, K.create(r.range.start, n.range.end));
}
function yR(t) {
  return t.tokens[t.index].type === "inline-tag" ? Xd(t, !0) : Yd(t);
}
function Xd(t, e) {
  const r = t.tokens[t.index++],
  ...
  if ((i == null ? void 0 : i.type) === "text")
    if (e) {
      const a = Yd(t);
      return new Qs(n, new jl([a], a.range), e, K.create(r.range.start, a.range.end));
    } else {
      const a = Hd(t);
      return new Qs(n, a, e, K.create(r.range.start, a.range.end));
    }
  else {
    const a = r.range;
    return new Qs(n, new jl([], a), e, a);
  }
}
function Yd(t) {
  const e = t.tokens[t.index++];
  return new Jd(e.content, e.range);
}
function Tc(t) {
  if (!t) return Tc({ start: "/**", end: "*/", line: "*" });
  const { start: e, end: r, line: n } = t;
  return { start: Zs(e, !0), end: Zs(r, !1), line: Zs(n, !0) };
}
function Zs(t, e) {
  if (typeof t == "string" || typeof t == "object") {
    const r = typeof t == "string" ? Cs(t) : t.source;
...
function TR(t, e, r) {
  ...
  if (t === "linkplain" || t === "linkcode" || t === "link") {
    ...
    return (
      (t === "linkcode" || (t === "link" && r.link === "code")) && (a = `\`${a}\``),
      ((n = r.renderLink) == null ? void 0 : n.call(r, e, a)) ?? RR(e, a)
    );
  }
}
function RR(t, e) {
...
class vR {
  ...
  documentationLinkRenderer(e, r, n) {
    ...
    if (i && i.nameSegment) {
      const a = i.nameSegment.range.start.line + 1,
        s = i.nameSegment.range.start.character + 1,
        o = i.documentUri.with({ fragment: `L${a},${s}` });
      return `[${n}](${o.toString()})`;
    } else return;
  }
  documentationTagRenderer(e, r) {}
  findNameInLocalSymbols(e, r) {
    const i = jt(e).localSymbols;
    if (!i) return;
    let a = e;
    do {
...
class ER {
  ...
  getComment(e) {
    ...
    return lT(e)
      ? e.$comment
      : (r = ip(e.$cstNode, this.grammarConfig().multilineCommentRules)) == null
        ? void 0
        : r.text;
  }
}
...
class $R {
  constructor() {
    ((this.previousTokenSource = new pe.CancellationTokenSource()),
      (this.writeQueue = []),
      (this.readQueue = []),
      (this.done = !0));
  }
  ...
  enqueue(e, r, n = pe.CancellationToken.None) {
    const i = new mc(),
      a = { action: r, deferred: i, cancellationToken: n };
  ...
  async performNextOperation() {
    ...
    ((this.done = !1),
      await Promise.all(
        e.map(async ({ action: r, deferred: n, cancellationToken: i }) => {
          try {
            const a = await Promise.resolve().then(() => r(i));
            n.resolve(a);
          } catch (a) {
            Os(a) ? n.resolve(void 0) : n.reject(a);
          }
        })
      ),
      (this.done = !0),
...
class CR {
  constructor(e) {
    ((this.grammarElementIdMap = new fu()),
      (this.tokenTypeIdMap = new fu()),
  ...
  createDehyrationContext(e) {
    const r = new Map(),
      n = new Map();
    for (const i of zt(e)) r.set(i, {});
    if (e.$cstNode) for (const i of vo(e.$cstNode)) n.set(i, {});
    ...
    for (const [i, a] of Object.entries(e))
      if (!i.startsWith("$"))
        if (Array.isArray(a)) {
          ...
          Fe(a)
            ? (n[i] = this.dehydrateAstNode(a, r))
            : ut(a)
              ? (n[i] = this.dehydrateReference(a, r))
              : a !== void 0 && (n[i] = a);
    return n;
  }
  ...
  dehydrateCstNode(e, r) {
    ...
    return (
      $f(e) ? (n.fullText = e.fullText) : (n.grammarSource = this.getGrammarElementId(e.grammarSource)),
      (n.hidden = e.hidden),
      (n.astNode = r.astNodes.get(e.astNode)),
      Ii(e)
        ? (n.content = e.content.map((i) => this.dehydrateCstNode(i, r)))
        : Af(e) &&
  ...
  createHydrationContext(e) {
    const r = new Map(),
      n = new Map();
    for (const a of zt(e)) r.set(a, {});
    let i;
    if (e.$cstNode)
      for (const a of vo(e.$cstNode)) {
        let s;
        ("fullText" in a
          ? ((s = new _d(a.fullText)), (i = s))
          : "content" in a
            ? (s = new dc())
            : "tokenType" in a && (s = this.hydrateCstLeafNode(a)),
          s && (n.set(a, s), (s.root = i)));
      }
    return { astNodes: r, cstNodes: n };
  }
  hydrateAstNode(e, r) {
    ...
    for (const [i, a] of Object.entries(e))
      if (!i.startsWith("$"))
        if (Array.isArray(a)) {
          ...
          for (const o of a)
            Fe(o)
              ? s.push(this.setParent(this.hydrateAstNode(o, r), n))
              : ut(o)
                ? s.push(this.hydrateReference(o, n, i, r))
                : s.push(o);
        } else
          Fe(a)
            ? (n[i] = this.setParent(this.hydrateAstNode(a, r), n))
            : ut(a)
              ? (n[i] = this.hydrateReference(a, n, i, r))
              : a !== void 0 && (n[i] = a);
    return n;
  }
  setParent(e, r) {
  ...
  hydrateCstNode(e, r, n = 0) {
    ...
    if (
      (typeof e.grammarSource == "number" && (i.grammarSource = this.getGrammarElement(e.grammarSource)),
      (i.astNode = r.astNodes.get(e.astNode)),
      Ii(i))
    )
  ...
  hydrateCstLeafNode(e) {
    const r = this.getTokenType(e.tokenType),
      ...
      l = e.endColumn,
      c = e.hidden;
    return new Pl(n, i, { start: { line: a, character: s }, end: { line: o, character: l } }, r, c);
  }
  getTokenType(e) {
  ...
  createGrammarElementIdMap() {
    let e = 0;
    for (const r of zt(this.grammar)) xh(r) && this.grammarElementIdMap.set(r, e++);
  }
}
function vt(t) {
  return {
    documentation: { CommentProvider: (e) => new ER(e), DocumentationProvider: (e) => new vR(e) },
    parser: {
      AsyncParser: (e) => new AR(e),
      GrammarConfig: (e) => Ip(e),
      LangiumParser: (e) => qy(e),
      CompletionParser: (e) => Uy(e),
      ValueConverter: () => new Fd(),
      TokenBuilder: () => new Md(),
      Lexer: (e) => new iR(e),
      ParserErrorMessageProvider: () => new Pd(),
      LexerErrorMessageProvider: () => new rR(),
    },
    workspace: {
      AstNodeLocator: () => new TT(),
      AstNodeDescriptionProvider: (e) => new gT(e),
      ReferenceDescriptionProvider: (e) => new yT(e),
    },
    references: {
      Linker: (e) => new Zy(e),
      NameProvider: () => new eT(),
      ScopeProvider: (e) => new oT(e),
      ScopeComputation: (e) => new rT(e),
      References: (e) => new tT(e),
    },
    serializer: { Hydrator: (e) => new CR(e), JsonSerializer: (e) => new cT(e) },
    validation: { DocumentValidator: (e) => new hT(e), ValidationRegistry: (e) => new fT(e) },
    shared: () => t.shared,
  };
}
function Et(t) {
  return {
    ServiceRegistry: (e) => new uT(e),
    workspace: {
      LangiumDocuments: (e) => new Jy(e),
      LangiumDocumentFactory: (e) => new Yy(e),
      DocumentBuilder: (e) => new QT(e),
      IndexManager: (e) => new eR(e),
      WorkspaceManager: (e) => new tR(e),
      FileSystemProvider: (e) => t.fileSystemProvider(e),
      WorkspaceLock: () => new $R(),
      ConfigurationProvider: (e) => new vT(e),
    },
    profilers: {},
  };
}
var sf;
(function (t) {
  t.merge = (e, r) => Ui(Ui({}, e), r);
})(sf || (sf = {}));
function we(t, e, r, n, i, a, s, o, l) {
  const c = [t, e, r, n, i, a, s, o, l].reduce(Ui, {});
  return Zd(c);
}
const SR = Symbol("isProxy");
function Zd(t, e) {
  const r = new Proxy(
    {},
    {
      ...
      get: (n, i) => (i === SR ? !0 : lf(n, i, t, e || r)),
      getOwnPropertyDescriptor: (n, i) => (lf(n, i, t, e || r), Object.getOwnPropertyDescriptor(n, i)),
      has: (n, i) => i in t,
...
function lf(t, e, r, n) {
  if (e in t) {
    ...
    t[e] = of;
    try {
      t[e] = typeof i == "function" ? i(n) : Zd(i, n);
    } catch (a) {
  ...
  if (e) {
    for (const [r, n] of Object.entries(e))
      if (n != null)
        if (typeof n == "object") {
          const i = t[r];
          typeof i == "object" && i !== null ? (t[r] = Ui(i, n)) : (t[r] = Ui({}, n));
        } else t[r] = n;
  }
  return t;
}
...
const At = { fileSystemProvider: () => new wR() },
  kR = {
    Grammar: () => {},
    LanguageMetaData: () => ({ caseInsensitive: !1, fileExtensions: [".langium"], languageId: "langium" }),
  },
  bR = { AstReflection: () => new _f() };
function _R() {
  const t = we(Et(At), bR),
    e = we(vt({ shared: t }), kR);
...
function Vt(t) {
  ...
  return (
    e.shared.workspace.LangiumDocumentFactory.fromModel(r, ft.parse(`memory:/${r.name ?? "grammar"}.langium`)),
    r
  );
}
var NR = Object.defineProperty,
  N = (t, e) => NR(t, "name", { value: e, configurable: !0 }),
  zl;
((t) => {
  t.Terminals = {
...
var ka = { $type: "Accelerator", name: "name", x: "x", y: "y" },
  ba = { $type: "Anchor", evolution: "evolution", name: "name", visibility: "visibility" },
  gi = { $type: "Annotation", number: "number", text: "text", x: "x", y: "y" },
  eo = { $type: "Annotations", x: "x", y: "y" },
  xt = {
    $type: "Architecture",
    accDescr: "accDescr",
    accTitle: "accTitle",
...
function IR(t) {
  return nt.isInstance(t, xt.$type);
}
N(IR, "isArchitecture");
var _a = { $type: "Axis", label: "label", name: "name" },
  Ya = { $type: "Branch", name: "name", order: "order" };
function PR(t) {
  return nt.isInstance(t, Ya.$type);
}
N(PR, "isBranch");
var cf = { $type: "Checkout", branch: "branch" },
  Na = { $type: "CherryPicking", id: "id", parent: "parent", tags: "tags" },
  to = { $type: "ClassDefStatement", className: "className", styleText: "styleText" },
  Zr = { $type: "Commit", id: "id", message: "message", tags: "tags", type: "type" };
function OR(t) {
...
var yr = {
  ...
  Ia = { $type: "Curve", entries: "entries", label: "label", name: "name" },
  Pa = { $type: "Deaccelerator", name: "name", x: "x", y: "y" },
  uf = { $type: "Decorator", strategy: "strategy" },
  zr = {
    $type: "Direction",
    accDescr: "accDescr",
    accTitle: "accTitle",
  ...
  ro = { $type: "Entry", axis: "axis", value: "value" },
  ff = { $type: "Evolution", stages: "stages" },
  Oa = { $type: "EvolutionStage", boundary: "boundary", name: "name", secondName: "secondName" },
  no = { $type: "Evolve", component: "component", target: "target" },
  Cr = { $type: "GitGraph", accDescr: "accDescr", accTitle: "accTitle", statements: "statements", title: "title" };
function LR(t) {
  return nt.isInstance(t, Cr.$type);
}
N(LR, "isGitGraph");
var yi = { $type: "Group", icon: "icon", id: "id", in: "in", title: "title" },
  _i = { $type: "Info", accDescr: "accDescr", accTitle: "accTitle", title: "title" };
function xR(t) {
  return nt.isInstance(t, _i.$type);
}
N(xR, "isInfo");
var Ti = { $type: "Item", classSelector: "classSelector", name: "name" },
  io = { $type: "Junction", id: "id", in: "in" },
  Ri = { $type: "Label", negX: "negX", negY: "negY", offsetX: "offsetX", offsetY: "offsetY" },
  La = { $type: "Leaf", classSelector: "classSelector", name: "name", value: "value" },
  Tr = {
    $type: "Link",
    arrow: "arrow",
    from: "from",
  ...
  Qr = { $type: "Merge", branch: "branch", id: "id", tags: "tags", type: "type" };
function DR(t) {
  return nt.isInstance(t, Qr.$type);
}
N(DR, "isMerge");
var xa = { $type: "Note", evolution: "evolution", text: "text", visibility: "visibility" },
  ao = { $type: "Option", name: "name", value: "value" },
  en = { $type: "Packet", accDescr: "accDescr", accTitle: "accTitle", blocks: "blocks", title: "title" };
function MR(t) {
  return nt.isInstance(t, en.$type);
}
N(MR, "isPacket");
var tn = { $type: "PacketBlock", bits: "bits", end: "end", label: "label", start: "start" };
function FR(t) {
  return nt.isInstance(t, tn.$type);
}
N(FR, "isPacketBlock");
var Sr = {
  $type: "Pie",
...
function GR(t) {
  return nt.isInstance(t, Sr.$type);
}
N(GR, "isPie");
var Ja = { $type: "PieSection", label: "label", value: "value" };
function jR(t) {
  return nt.isInstance(t, Ja.$type);
}
N(jR, "isPieSection");
var so = { $type: "Pipeline", components: "components", parent: "parent" },
  Da = { $type: "PipelineComponent", evolution: "evolution", label: "label", name: "name" },
  Rr = {
    $type: "Radar",
    accDescr: "accDescr",
    accTitle: "accTitle",
  ...
  oo = { $type: "Section", classSelector: "classSelector", name: "name" },
  Ur = { $type: "Service", icon: "icon", iconText: "iconText", id: "id", in: "in", title: "title" },
  lo = { $type: "Size", height: "height", width: "width" },
  qr = { $type: "Statement" },
  rn = { $type: "Treemap", accDescr: "accDescr", accTitle: "accTitle", title: "title", TreemapRows: "TreemapRows" };
function zR(t) {
  return nt.isInstance(t, rn.$type);
}
N(zR, "isTreemap");
var co = { $type: "TreemapRow", indent: "indent", item: "item" },
  uo = { $type: "TreeNode", indent: "indent", name: "name" },
  vi = { $type: "TreeView", accDescr: "accDescr", accTitle: "accTitle", nodes: "nodes", title: "title" },
  Le = {
    $type: "Wardley",
    accDescr: "accDescr",
...
var on,
      ...
      constructor() {
        (super(...arguments),
          (this.types = {
            Accelerator: {
              name: ka.$type,
              properties: { name: { name: ka.name }, x: { name: ka.x }, y: { name: ka.y } },
              superTypes: [],
            },
            Anchor: {
              name: ba.$type,
              properties: {
                evolution: { name: ba.evolution },
                name: { name: ba.name },
                visibility: { name: ba.visibility },
              },
              superTypes: [],
            },
            Annotation: {
            ...
            Annotations: { name: eo.$type, properties: { x: { name: eo.x }, y: { name: eo.y } }, superTypes: [] },
            Architecture: {
              name: xt.$type,
              properties: {
                accDescr: { name: xt.accDescr },
                accTitle: { name: xt.accTitle },
                edges: { name: xt.edges, defaultValue: [] },
                groups: { name: xt.groups, defaultValue: [] },
                junctions: { name: xt.junctions, defaultValue: [] },
                services: { name: xt.services, defaultValue: [] },
                title: { name: xt.title },
              },
              superTypes: [],
            },
            Axis: {
              name: _a.$type,
              properties: { label: { name: _a.label }, name: { name: _a.name } },
              superTypes: [],
            },
            Branch: {
              name: Ya.$type,
              properties: { name: { name: Ya.name }, order: { name: Ya.order } },
              superTypes: [qr.$type],
            },
            Checkout: { name: cf.$type, properties: { branch: { name: cf.branch } }, superTypes: [qr.$type] },
            CherryPicking: {
              name: Na.$type,
              properties: {
                id: { name: Na.id },
                parent: { name: Na.parent },
                tags: { name: Na.tags, defaultValue: [] },
              },
              superTypes: [qr.$type],
            },
            ClassDefStatement: {
              name: to.$type,
              properties: { className: { name: to.className }, styleText: { name: to.styleText } },
              superTypes: [],
            },
            Commit: {
              name: Zr.$type,
              properties: {
                id: { name: Zr.id },
                message: { name: Zr.message },
                tags: { name: Zr.tags, defaultValue: [] },
                type: { name: Zr.type },
              },
              superTypes: [qr.$type],
            },
            Component: {
              name: yr.$type,
              properties: {
                decorator: { name: yr.decorator },
                evolution: { name: yr.evolution },
                inertia: { name: yr.inertia, defaultValue: !1 },
                label: { name: yr.label },
                name: { name: yr.name },
                visibility: { name: yr.visibility },
              },
              superTypes: [],
            },
            Curve: {
              name: Ia.$type,
              properties: {
                entries: { name: Ia.entries, defaultValue: [] },
                label: { name: Ia.label },
                name: { name: Ia.name },
              },
              superTypes: [],
            ...
            Deaccelerator: {
              name: Pa.$type,
              properties: { name: { name: Pa.name }, x: { name: Pa.x }, y: { name: Pa.y } },
              superTypes: [],
            },
            Decorator: { name: uf.$type, properties: { strategy: { name: uf.strategy } }, superTypes: [] },
            Direction: {
              name: zr.$type,
              properties: {
                accDescr: { name: zr.accDescr },
                accTitle: { name: zr.accTitle },
                dir: { name: zr.dir },
                statements: { name: zr.statements, defaultValue: [] },
                title: { name: zr.title },
              },
              superTypes: [Cr.$type],
            },
            Edge: {
              name: ht.$type,
              properties: {
                lhsDir: { name: ht.lhsDir },
                lhsGroup: { name: ht.lhsGroup, defaultValue: !1 },
                lhsId: { name: ht.lhsId },
                lhsInto: { name: ht.lhsInto, defaultValue: !1 },
                rhsDir: { name: ht.rhsDir },
                rhsGroup: { name: ht.rhsGroup, defaultValue: !1 },
                rhsId: { name: ht.rhsId },
                rhsInto: { name: ht.rhsInto, defaultValue: !1 },
                title: { name: ht.title },
              },
              superTypes: [],
            },
            Entry: {
              name: ro.$type,
              properties: { axis: { name: ro.axis, referenceType: _a.$type }, value: { name: ro.value } },
              superTypes: [],
            },
            Evolution: {
              name: ff.$type,
              properties: { stages: { name: ff.stages, defaultValue: [] } },
              superTypes: [],
            },
            EvolutionStage: {
              name: Oa.$type,
              properties: {
                boundary: { name: Oa.boundary },
                name: { name: Oa.name },
                secondName: { name: Oa.secondName },
              },
              superTypes: [],
            },
            Evolve: {
              name: no.$type,
              properties: { component: { name: no.component }, target: { name: no.target } },
              superTypes: [],
            },
            GitGraph: {
              name: Cr.$type,
              properties: {
                accDescr: { name: Cr.accDescr },
                accTitle: { name: Cr.accTitle },
                statements: { name: Cr.statements, defaultValue: [] },
                title: { name: Cr.title },
              },
              superTypes: [],
            },
            ...
            Info: {
              name: _i.$type,
              properties: {
                accDescr: { name: _i.accDescr },
                accTitle: { name: _i.accTitle },
                title: { name: _i.title },
              },
              superTypes: [],
            },
            Item: {
              name: Ti.$type,
              properties: { classSelector: { name: Ti.classSelector }, name: { name: Ti.name } },
              superTypes: [],
            },
            Junction: { name: io.$type, properties: { id: { name: io.id }, in: { name: io.in } }, superTypes: [] },
            Label: {
              name: Ri.$type,
              properties: {
                negX: { name: Ri.negX, defaultValue: !1 },
                negY: { name: Ri.negY, defaultValue: !1 },
                offsetX: { name: Ri.offsetX },
                offsetY: { name: Ri.offsetY },
              },
              superTypes: [],
            },
            Leaf: {
              name: La.$type,
              properties: {
                classSelector: { name: La.classSelector },
                name: { name: La.name },
                value: { name: La.value },
              },
              superTypes: [Ti.$type],
            ...
            Link: {
              ...
              properties: {
                arrow: { name: Tr.arrow },
                from: { name: Tr.from },
                fromPort: { name: Tr.fromPort },
                linkLabel: { name: Tr.linkLabel },
                to: { name: Tr.to },
                toPort: { name: Tr.toPort },
              },
              superTypes: [],
            },
            Merge: {
              name: Qr.$type,
              properties: {
                branch: { name: Qr.branch },
                id: { name: Qr.id },
                tags: { name: Qr.tags, defaultValue: [] },
                type: { name: Qr.type },
              },
              superTypes: [qr.$type],
            },
            Note: {
              name: xa.$type,
              properties: {
                evolution: { name: xa.evolution },
                text: { name: xa.text },
                visibility: { name: xa.visibility },
              },
              superTypes: [],
            },
            Option: {
              name: ao.$type,
              properties: { name: { name: ao.name }, value: { name: ao.value, defaultValue: !1 } },
              superTypes: [],
            },
            Packet: {
              name: en.$type,
              properties: {
                accDescr: { name: en.accDescr },
                accTitle: { name: en.accTitle },
                blocks: { name: en.blocks, defaultValue: [] },
                title: { name: en.title },
              },
              superTypes: [],
            },
            ...
            Pie: {
              name: Sr.$type,
              properties: {
                accDescr: { name: Sr.accDescr },
                accTitle: { name: Sr.accTitle },
                sections: { name: Sr.sections, defaultValue: [] },
                showData: { name: Sr.showData, defaultValue: !1 },
                title: { name: Sr.title },
              },
              superTypes: [],
            },
            PieSection: {
              name: Ja.$type,
              properties: { label: { name: Ja.label }, value: { name: Ja.value } },
              superTypes: [],
            },
            Pipeline: {
              name: so.$type,
              properties: { components: { name: so.components, defaultValue: [] }, parent: { name: so.parent } },
              superTypes: [],
            },
            PipelineComponent: {
              name: Da.$type,
              properties: { evolution: { name: Da.evolution }, label: { name: Da.label }, name: { name: Da.name } },
              superTypes: [],
            },
            Radar: {
              name: Rr.$type,
              properties: {
                ...
                axes: { name: Rr.axes, defaultValue: [] },
                curves: { name: Rr.curves, defaultValue: [] },
                options: { name: Rr.options, defaultValue: [] },
                title: { name: Rr.title },
              },
              superTypes: [],
            },
            Section: {
              name: oo.$type,
              properties: { classSelector: { name: oo.classSelector }, name: { name: oo.name } },
              superTypes: [Ti.$type],
            },
            Service: {
              name: Ur.$type,
            ...
            Size: {
              name: lo.$type,
              properties: { height: { name: lo.height }, width: { name: lo.width } },
              superTypes: [],
            },
            Statement: { name: qr.$type, properties: {}, superTypes: [] },
            TreeNode: {
              name: uo.$type,
              properties: { indent: { name: uo.indent }, name: { name: uo.name } },
              superTypes: [],
            },
            TreeView: {
              name: vi.$type,
              properties: {
                accDescr: { name: vi.accDescr },
                accTitle: { name: vi.accTitle },
                nodes: { name: vi.nodes, defaultValue: [] },
                title: { name: vi.title },
              },
              superTypes: [],
            },
            Treemap: {
              ...
              properties: {
                ...
                title: { name: rn.title },
                TreemapRows: { name: rn.TreemapRows, defaultValue: [] },
              },
              superTypes: [],
            },
            TreemapRow: {
              name: co.$type,
              properties: { indent: { name: co.indent }, item: { name: co.item } },
              superTypes: [],
            },
            Wardley: {
              name: Le.$type,
              properties: {
                accDescr: { name: Le.accDescr },
                accelerators: { name: Le.accelerators, defaultValue: [] },
                accTitle: { name: Le.accTitle },
                anchors: { name: Le.anchors, defaultValue: [] },
                annotation: { name: Le.annotation, defaultValue: [] },
                annotations: { name: Le.annotations, defaultValue: [] },
                components: { name: Le.components, defaultValue: [] },
                deaccelerators: { name: Le.deaccelerators, defaultValue: [] },
                evolution: { name: Le.evolution },
                evolves: { name: Le.evolves, defaultValue: [] },
                links: { name: Le.links, defaultValue: [] },
                notes: { name: Le.notes, defaultValue: [] },
                pipelines: { name: Le.pipelines, defaultValue: [] },
                size: { name: Le.size },
                title: { name: Le.title },
              },
              superTypes: [],
  ...
  ZR = { languageId: "architecture", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  QR = { languageId: "gitGraph", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  ev = { languageId: "info", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  tv = { languageId: "packet", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  rv = { languageId: "pie", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  nv = { languageId: "radar", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  iv = { languageId: "treemap", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  av = { languageId: "treeView", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  sv = { languageId: "wardley", fileExtensions: [".mmd", ".mermaid"], caseInsensitive: !1, mode: "production" },
  Kt = { AstReflection: N(() => new Qd(), "AstReflection") },
  ov = { Grammar: N(() => qR(), "Grammar"), LanguageMetaData: N(() => ZR, "LanguageMetaData"), parser: {} },
  lv = { Grammar: N(() => BR(), "Grammar"), LanguageMetaData: N(() => QR, "LanguageMetaData"), parser: {} },
  cv = { Grammar: N(() => WR(), "Grammar"), LanguageMetaData: N(() => ev, "LanguageMetaData"), parser: {} },
  uv = { Grammar: N(() => VR(), "Grammar"), LanguageMetaData: N(() => tv, "LanguageMetaData"), parser: {} },
  fv = { Grammar: N(() => KR(), "Grammar"), LanguageMetaData: N(() => rv, "LanguageMetaData"), parser: {} },
  dv = { Grammar: N(() => HR(), "Grammar"), LanguageMetaData: N(() => nv, "LanguageMetaData"), parser: {} },
  hv = { Grammar: N(() => XR(), "Grammar"), LanguageMetaData: N(() => iv, "LanguageMetaData"), parser: {} },
  pv = { Grammar: N(() => YR(), "Grammar"), LanguageMetaData: N(() => av, "LanguageMetaData"), parser: {} },
  mv = { Grammar: N(() => JR(), "Grammar"), LanguageMetaData: N(() => sv, "LanguageMetaData"), parser: {} },
  gv = /accDescr(?:[\t ]*:([^\n\r]*)|\s*{([^}]*)})/,
  yv = /accTitle[\t ]*:([^\n\r]*)/,
  Tv = /title([\t ][^\n\r]*|)/,
  Rv = { ACC_DESCR: gv, ACC_TITLE: yv, TITLE: Tv },
  ln,
  Gn =
    ((ln = class extends Fd {
      runConverter(e, r, n) {
...
`
    ...
    N(ln, "AbstractMermaidValueConverter"),
    ln),
  cn,
  Ls =
    ((cn = class extends Gn {
  ...
  Ht =
    ...
    N(un, "AbstractMermaidTokenBuilder"),
    un),
  fn;
((fn = class extends Ht {}), N(fn, "CommonTokenBuilder"));
var dn,
  vv =
    ((dn = class extends Ht {
      constructor() {
    ...
    N(dn, "TreemapTokenBuilder"),
    dn),
  Ev = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/,
  hn,
  Av =
    ((hn = class extends Gn {
      runCustomConverter(e, r, n) {
        ...
        if (e.name === "ClassDef") {
          ...
          const i = Ev.exec(r);
          if (i) return { $type: "ClassDefStatement", className: i[1], styleText: i[2] || void 0 };
        }
      }
    }),
    N(hn, "TreemapValueConverter"),
    hn);
function eh(t) {
    ...
    ((pn = class {
      checkSingleRoot(e, r) {
        ...
        for (const i of e.TreemapRows)
          i.item &&
            (n === void 0 && i.indent === void 0
              ? (n = 0)
              : i.indent === void 0
                ? r("error", "Multiple root nodes are not allowed in a treemap.", { node: i, property: "item" })
                : n !== void 0 &&
                  n >= parseInt(i.indent, 10) &&
                  r("error", "Multiple root nodes are not allowed in a treemap.", { node: i, property: "item" }));
      }
    }),
    N(pn, "TreemapValidator"),
    pn),
  th = {
    parser: { TokenBuilder: N(() => new vv(), "TokenBuilder"), ValueConverter: N(() => new Av(), "ValueConverter") },
    validation: { TreemapValidator: N(() => new $v(), "TreemapValidator") },
  };
function rh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), hv, th);
  return (e.ServiceRegistry.register(r), eh(r), { shared: e, Treemap: r });
}
N(rh, "createTreemapServices");
var mn,
  Cv =
    ((mn = class extends Gn {
      runCustomConverter(e, r, n) {
    ...
    N(mn, "WardleyValueConverter"),
    mn),
  nh = { parser: { ValueConverter: N(() => new Cv(), "ValueConverter") } };
function ih(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), mv, nh);
  return (e.ServiceRegistry.register(r), { shared: e, Wardley: r });
}
N(ih, "createWardleyServices");
var gn,
  Sv =
    ((gn = class extends Ht {
      constructor() {
    ...
    N(gn, "GitGraphTokenBuilder"),
    gn),
  ah = {
    parser: { TokenBuilder: N(() => new Sv(), "TokenBuilder"), ValueConverter: N(() => new Ls(), "ValueConverter") },
  };
function sh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), lv, ah);
  return (e.ServiceRegistry.register(r), { shared: e, GitGraph: r });
}
N(sh, "createGitGraphServices");
var yn,
  wv =
    ((yn = class extends Ht {
      constructor() {
    ...
    N(yn, "InfoTokenBuilder"),
    yn),
  oh = {
    parser: { TokenBuilder: N(() => new wv(), "TokenBuilder"), ValueConverter: N(() => new Ls(), "ValueConverter") },
  };
function lh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), cv, oh);
  return (e.ServiceRegistry.register(r), { shared: e, Info: r });
}
N(lh, "createInfoServices");
var Tn,
  kv =
    ((Tn = class extends Ht {
      constructor() {
    ...
    N(Tn, "PacketTokenBuilder"),
    Tn),
  ch = {
    parser: { TokenBuilder: N(() => new kv(), "TokenBuilder"), ValueConverter: N(() => new Ls(), "ValueConverter") },
  };
function uh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), uv, ch);
  return (e.ServiceRegistry.register(r), { shared: e, Packet: r });
}
N(uh, "createPacketServices");
var Rn,
  bv =
    ((Rn = class extends Ht {
      constructor() {
  ...
  _v =
    ...
    N(vn, "PieValueConverter"),
    vn),
  fh = {
    parser: { TokenBuilder: N(() => new bv(), "TokenBuilder"), ValueConverter: N(() => new _v(), "ValueConverter") },
  };
function dh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), fv, fh);
  return (e.ServiceRegistry.register(r), { shared: e, Pie: r });
}
N(dh, "createPieServices");
var En,
  Nv =
    ((En = class extends Gn {
      runCustomConverter(e, r, n) {
  ...
  Iv =
    ...
    N(An, "TreeViewTokenBuilder"),
    An),
  hh = {
    parser: { TokenBuilder: N(() => new Iv(), "TokenBuilder"), ValueConverter: N(() => new Nv(), "ValueConverter") },
  };
function ph(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), pv, hh);
  return (e.ServiceRegistry.register(r), { shared: e, TreeView: r });
}
N(ph, "createTreeViewServices");
var $n,
  Pv =
    (($n = class extends Ht {
      constructor() {
        ...
        if (e.name === "ARCH_TITLE") {
          ...
          return (
            ((i.startsWith('"') && i.endsWith('"')) || (i.startsWith("'") && i.endsWith("'"))) &&
              ((i = i.slice(1, -1)), (i = i.replace(/\\"/g, '"').replace(/\\'/g, "'"))),
            i.trim()
          );
        }
      }
    }),
    N(Cn, "ArchitectureValueConverter"),
    Cn),
  mh = {
    parser: { TokenBuilder: N(() => new Pv(), "TokenBuilder"), ValueConverter: N(() => new Ov(), "ValueConverter") },
  };
function gh(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), ov, mh);
  return (e.ServiceRegistry.register(r), { shared: e, Architecture: r });
}
N(gh, "createArchitectureServices");
var Sn,
  Lv =
    ((Sn = class extends Ht {
      constructor() {
    ...
    N(Sn, "RadarTokenBuilder"),
    Sn),
  yh = {
    parser: { TokenBuilder: N(() => new Lv(), "TokenBuilder"), ValueConverter: N(() => new Ls(), "ValueConverter") },
  };
function Th(t = At) {
  const e = we(Et(t), Kt),
    r = we(vt({ shared: e }), dv, yh);
  return (e.ServiceRegistry.register(r), { shared: e, Radar: r });
}
N(Th, "createRadarServices");
var lt = {},
  xv = {
    info: N(async () => {
      const { createInfoServices: t } = await St(
          async () => {
            const { createInfoServices: r } = await Promise.resolve().then(() => Fv);
    ...
    packet: N(async () => {
      const { createPacketServices: t } = await St(
          async () => {
            const { createPacketServices: r } = await Promise.resolve().then(() => Gv);
    ...
    pie: N(async () => {
      const { createPieServices: t } = await St(
          async () => {
            const { createPieServices: r } = await Promise.resolve().then(() => jv);
    ...
    treeView: N(async () => {
      const { createTreeViewServices: t } = await St(
          async () => {
            const { createTreeViewServices: r } = await Promise.resolve().then(() => zv);
    ...
    architecture: N(async () => {
      const { createArchitectureServices: t } = await St(
          async () => {
            const { createArchitectureServices: r } = await Promise.resolve().then(() => Uv);
    ...
    gitGraph: N(async () => {
      const { createGitGraphServices: t } = await St(
          async () => {
            const { createGitGraphServices: r } = await Promise.resolve().then(() => qv);
    ...
    radar: N(async () => {
      const { createRadarServices: t } = await St(
          async () => {
            const { createRadarServices: r } = await Promise.resolve().then(() => Bv);
    ...
    treemap: N(async () => {
      const { createTreemapServices: t } = await St(
          async () => {
            const { createTreemapServices: r } = await Promise.resolve().then(() => Wv);
    ...
    wardley: N(async () => {
      const { createWardleyServices: t } = await St(
          async () => {
            const { createWardleyServices: r } = await Promise.resolve().then(() => Vv);
...
async function Dv(t, e) {
  ...
  if (i.lexerErrors.length > 0 || i.parserErrors.length > 0) throw new Mv(i);
  return i.value;
}
N(Dv, "parse");
var wn,
    ...
    ((wn = class extends Error {
      constructor(e) {
        const r = e.lexerErrors.map((i) => {
            const a = i.line !== void 0 && !isNaN(i.line) ? i.line : "?",
              s = i.column !== void 0 && !isNaN(i.column) ? i.column : "?";
            return `Lexer error on line ${a}, column ${s}: ${i.message}`;
          }).join(`
`),
          n = e.parserErrors.map((i) => {
            const a = i.token.startLine !== void 0 && !isNaN(i.token.startLine) ? i.token.startLine : "?",
              s = i.token.startColumn !== void 0 && !isNaN(i.token.startColumn) ? i.token.startColumn : "?";
...
`);
    ...
    N(wn, "MermaidParseError"),
    wn);
const Fv = Object.freeze(
    Object.defineProperty({ __proto__: null, InfoModule: oh, createInfoServices: lh }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  Gv = Object.freeze(
    Object.defineProperty({ __proto__: null, PacketModule: ch, createPacketServices: uh }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  jv = Object.freeze(
    Object.defineProperty({ __proto__: null, PieModule: fh, createPieServices: dh }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  zv = Object.freeze(
    Object.defineProperty({ __proto__: null, TreeViewModule: hh, createTreeViewServices: ph }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  Uv = Object.freeze(
    Object.defineProperty(
      { __proto__: null, ArchitectureModule: mh, createArchitectureServices: gh },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  qv = Object.freeze(
    Object.defineProperty({ __proto__: null, GitGraphModule: ah, createGitGraphServices: sh }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  Bv = Object.freeze(
    Object.defineProperty({ __proto__: null, RadarModule: yh, createRadarServices: Th }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  Wv = Object.freeze(
    Object.defineProperty({ __proto__: null, TreemapModule: th, createTreemapServices: rh }, Symbol.toStringTag, {
      value: "Module",
    })
  ),
  Vv = Object.freeze(
    Object.defineProperty({ __proto__: null, WardleyModule: nh, createWardleyServices: ih }, Symbol.toStringTag, {
      value: "Module",
    })
  );
export { Dv as p };
