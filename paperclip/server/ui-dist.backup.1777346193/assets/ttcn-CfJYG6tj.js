...
const i = {
  ...
  types: o(
    "anytype bitstring boolean char charstring default float hexstring integer objid octetstring universal verdicttype timer"
  ),
...
var y = i.keywords || {},
  ...
  z = i.otherConsts || {},
  L = i.types || {},
  M = i.visibilityModifiers || {},
  S = i.templateMatch || {},
  W = i.indentStatements !== !1,
  d = /[+\-*&@=<>!\/]/,
  l;
function T(e, t) {
  var n = e.next();
  ...
  if (d.test(n))
    return n == "@" && (e.match("try") || e.match("catch") || e.match("lazy"))
      ? "keyword"
  ...
  return y.propertyIsEnumerable(r)
    ...
    : v.propertyIsEnumerable(r)
      ...
      : x.propertyIsEnumerable(r) ||
        ...
        ? "def"
        : C.propertyIsEnumerable(r) || I.propertyIsEnumerable(r) || z.propertyIsEnumerable(r)
          ? "string"
          : L.propertyIsEnumerable(r)
            ? "typeName.standard"
...
function a(e, t, n) {
  ...
  return (
    ...
    (e.context = new b(r, t, n, null, e.context))
  );
}
function u(e) {
...
const P = {
  ...
  token: function (e, t) {
    ...
    if ((n.align == null && (n.align = !0), (l == ";" || l == ":" || l == ",") && n.type == "statement")) u(t);
