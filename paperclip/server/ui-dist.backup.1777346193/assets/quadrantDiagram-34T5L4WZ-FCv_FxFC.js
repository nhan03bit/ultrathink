...
var Vt = (function () {
  var t = o(function (j, r, l, g) {
    ...
    vt = {
      ...
      performAction: o(function (r, l, g, f, _, e, pt) {
        var s = e.length - 1;
        switch (_) {
          case 23:
            this.$ = e[s];
      ...
      table: [
        { 18: n, 26: 1, 27: 2, 28: u, 55: c, 56: h, 57: p },
        { 1: [3] },
        { 18: n, 26: 8, 27: 2, 28: u, 55: c, 56: h, 57: p },
        { 18: n, 26: 9, 27: 2, 28: u, 55: c, 56: h, 57: p },
        t(y, [2, 33], { 29: 10 }),
        t(S, [2, 61]),
        t(S, [2, 62]),
        t(S, [2, 63]),
        ...
        t(a, [2, 46]),
        { 18: [1, 50] },
        { 4: d, 5: T, 10: q, 12: m, 13: b, 14: x, 43: 51, 58: 31, 60: W, 61: U, 63: k, 64: F, 65: P, 66: v, 67: C },
        { 4: d, 5: T, 10: q, 12: m, 13: b, 14: x, 43: 52, 58: 31, 60: W, 61: U, 63: k, 64: F, 65: P, 66: v, 67: C },
        { 4: d, 5: T, 10: q, 12: m, 13: b, 14: x, 43: 53, 58: 31, 60: W, 61: U, 63: k, 64: F, 65: P, 66: v, 67: C },
        { 4: d, 5: T, 10: q, 12: m, 13: b, 14: x, 43: 54, 58: 31, 60: W, 61: U, 63: k, 64: F, 65: P, 66: v, 67: C },
        { 4: d, 5: T, 10: q, 12: m, 13: b, 14: x, 43: 55, 58: 31, 60: W, 61: U, 63: k, 64: F, 65: P, 66: v, 67: C },
        { 4: d, 5: T, 10: q, 12: m, 13: b, 14: x, 43: 56, 58: 31, 60: W, 61: U, 63: k, 64: F, 65: P, 66: v, 67: C },
        {
          4: d,
          5: T,
          8: H,
        ...
        t(a, [2, 43]),
        t(a, [2, 44]),
        { 3: 64, 4: Rt, 5: Nt, 6: Wt, 7: Ut, 8: Qt, 9: Ot, 10: Ht, 11: Xt, 12: Mt, 13: Yt, 14: jt, 15: Gt, 21: 63 },
        t(a, [2, 53], {
          59: 59,
          58: 60,
          4: d,
        ...
        { 46: [1, 85] },
        { 45: [1, 86] },
        { 4: J, 5: $, 6: tt, 8: et, 11: it, 13: at, 16: 89, 17: nt, 18: st, 19: rt, 20: ot, 22: 88, 23: 87 },
        t(I, [2, 24]),
        t(a, [2, 51], {
          59: 59,
          58: 60,
        ...
        { 46: [1, 101] },
        t(a, [2, 29], { 10: Pt }),
        t(Kt, [2, 27], { 16: 103, 4: J, 5: $, 6: tt, 8: et, 11: it, 13: at, 17: nt, 18: st, 19: rt, 20: ot }),
        t(R, [2, 25]),
        t(R, [2, 13]),
        t(R, [2, 14]),
        t(R, [2, 15]),
        ...
        { 4: J, 5: $, 6: tt, 8: et, 11: it, 13: at, 16: 89, 17: nt, 18: st, 19: rt, 20: ot, 22: 105 },
        t(R, [2, 26]),
        t(a, [2, 50], { 10: Pt }),
        t(Kt, [2, 28], { 16: 103, 4: J, 5: $, 6: tt, 8: et, 11: it, 13: at, 17: nt, 18: st, 19: rt, 20: ot }),
      ],
      ...
      parse: o(function (r) {
        var l = this,
          ...
          qe = 2,
          Jt = 1,
          me = e.slice.call(arguments, 1),
          E = Object.create(this.lexer),
          K = { yy: {} };
        for (var Ct in this.yy) Object.prototype.hasOwnProperty.call(this.yy, Ct) && (K.yy[Ct] = this.yy[Ct]);
        (E.setInput(r, K.yy), (K.yy.lexer = E), (K.yy.parser = this), typeof E.yylloc > "u" && (E.yylloc = {}));
        var Lt = E.yylloc;
        e.push(Lt);
        var be = E.options && E.options.ranges;
        typeof K.yy.parseError == "function"
        ...
        function $t() {
          ...
          return (
            (B = f.pop() || E.lex() || Jt),
            typeof B != "number" && (B instanceof Array && ((f = B), (B = f.pop())), (B = l.symbols_[B] || B)),
            B
          );
        }
        o($t, "lex");
        for (var w, Z, N, Et, lt = {}, bt, M, te, St; ; ) {
          if (
            ...
            this.defaultActions[Z]
              ? (N = this.defaultActions[Z])
              : ((w === null || typeof w > "u") && (w = $t()), (N = pt[Z] && pt[Z][w])),
            typeof N > "u" || !N.length || !N[0])
          ) {
            var Dt = "";
            St = [];
            for (bt in pt[Z]) this.terminals_[bt] && bt > qe && St.push("'" + this.terminals_[bt] + "'");
            (E.showPosition
              ? (Dt =
                  "Parse error on line " +
                  (mt + 1) +
...
Expecting ` +
              ...
              : (Dt =
                  ...
                  (mt + 1) +
                  ": Unexpected " +
                  (w == Jt ? "end of input" : "'" + (this.terminals_[w] || w) + "'")),
              this.parseError(Dt, {
                text: E.match,
          ...
          switch (N[0]) {
            ...
            case 2:
              if (
                ...
                be && (lt._$.range = [e[e.length - (M || 1)].range[0], e[e.length - 1].range[1]]),
                (Et = this.performAction.apply(lt, [s, Zt, mt, K.yy, N[1], _, e].concat(me))),
                typeof Et < "u")
              )
                return Et;
              (M && ((g = g.slice(0, -1 * M * 2)), (_ = _.slice(0, -1 * M)), (e = e.slice(0, -1 * M))),
                g.push(this.productions_[N[1]][0]),
                _.push(lt.$),
                e.push(lt._$),
                (te = pt[g[g.length - 2]][g[g.length - 1]]),
                g.push(te));
              break;
            case 3:
              return !0;
        ...
        unput: o(function (r) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: g
                ? (g.length === f.length ? this.yylloc.first_column : 0) + f[f.length - g.length].length - g[0].length
                : this.yylloc.first_column - l,
            }),
            this.options.ranges && (this.yylloc.range = [_[0], _[0] + this.yyleng - l]),
...
` +
        ...
        next: o(function () {
          ...
          for (var _ = this._currentRules(), e = 0; e < _.length; e++)
            if (((g = this._input.match(this.rules[_[e]])), g && (!l || g[0].length > l[0].length))) {
              if (((l = g), (f = e), this.options.backtrack_lexer)) {
                if (((r = this.test_match(g, _[e])), r !== !1)) return r;
                if (this._backtrack) {
                  l = !1;
                  continue;
                } else return !1;
          ...
          return l
            ? ((r = this.test_match(l, _[f])), r !== !1 ? r : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: o(function (l, g, f, _) {
          switch (f) {
            case 0:
              break;
            case 1:
    ...
    ((ht = class {
      ...
      getDefaultConfig() {
        ...
        return {
          ...
          quadrantInternalBorderStrokeWidth:
            ((Y = D.quadrantChart) == null ? void 0 : Y.quadrantInternalBorderStrokeWidth) || 1,
          quadrantExternalBorderStrokeWidth:
            ((G = D.quadrantChart) == null ? void 0 : G.quadrantExternalBorderStrokeWidth) || 2,
        };
      }
      ...
      calculateSpace(n, u, c, h) {
        const p = this.config.xAxisLabelPadding * 2 + this.config.xAxisLabelFontSize,
          y = { top: n === "top" && u ? p : 0, bottom: n === "bottom" && u ? p : 0 },
          S = this.config.yAxisLabelPadding * 2 + this.config.yAxisLabelFontSize,
          a = {
          ...
          d = { top: h ? A : 0 },
          T = this.config.quadrantPadding + a.left,
          q = this.config.quadrantPadding + y.top + d.top,
          m = this.config.chartWidth - this.config.quadrantPadding * 2 - a.left - a.right,
          b = this.config.chartHeight - this.config.quadrantPadding * 2 - y.top - y.bottom - d.top,
          x = m / 2,
          O = b / 2;
        return {
          xAxisSpace: y,
            ...
            x.push({
              ...
              y:
                n === "top"
                  ...
                  : this.config.xAxisLabelPadding + T + a + this.config.quadrantPadding,
            ...
            x.push({
              ...
              x:
                this.config.yAxisPosition === "left"
                  ...
                  : this.config.yAxisLabelPadding + A + q + this.config.quadrantPadding,
              y: T + a - (b ? S / 2 : 0),
      ...
      getQuadrants(n) {
        const { quadrantSpace: u } = n,
          { quadrantHalfHeight: c, quadrantLeft: h, quadrantHalfWidth: p, quadrantTop: y } = u,
          S = [
            {
              text: {
        ...
        for (const a of S)
          ((a.text.x = a.x + a.width / 2),
            this.data.points.length === 0
              ? ((a.text.y = a.y + a.height / 2), (a.text.horizontalPos = "middle"))
              : ((a.text.y = a.y + this.config.quadrantTextTopPadding), (a.text.horizontalPos = "top")));
        return S;
      }
      getQuadrantPoints(n) {
        const { quadrantSpace: u } = n,
          { quadrantHeight: c, quadrantLeft: h, quadrantTop: p, quadrantWidth: y } = u,
          S = ee()
            .domain([0, 1])
            .range([h, y + h]),
          a = ee()
      ...
      getBorders(n) {
        const u = this.config.quadrantExternalBorderStrokeWidth / 2,
          { quadrantSpace: c } = n,
          {
      ...
      build() {
        const n = this.config.showXAxis && !!(this.data.xAxisLeftText || this.data.xAxisRightText),
          u = this.config.showYAxis && !!(this.data.yAxisTopText || this.data.yAxisBottomText),
          c = this.config.showTitle && !!this.data.titleText,
          h = this.data.points.length > 0 ? "bottom" : this.config.xAxisPosition,
          p = this.calculateSpace(h, n, u, c);
        return {
...
function kt(t) {
  ...
  for (const u of t) {
    ...
    if (c === "radius") {
      if (ae(h)) throw new _t(c, h, "number");
      n.radius = parseInt(h);
    } else if (c === "color") {
      if (It(h)) throw new _t(c, h, "hex code");
      n.color = h;
    } else if (c === "stroke-color") {
      if (It(h)) throw new _t(c, h, "hex code");
      n.strokeColor = h;
    } else if (c === "stroke-width") {
      if (ne(h)) throw new _t(c, h, "number of pixels (eg. 10px)");
      n.strokeWidth = h;
    } else throw new Error(`style named ${c} is not supported.`);
  }
  return n;
}
o(kt, "parseStyles");
function xe(t, n, u, c, h) {
  const p = kt(h);
  z.addPoints([{ x: u, y: c, text: Q(t.text), className: n, ...p }]);
}
o(xe, "addPoint");
function fe(t, n) {
  z.addClass(t, kt(n));
...
function ye() {
  const t = wt(),
    { themeVariables: n, quadrantChart: u } = t;
  return (
    u && z.setConfig(u),
    z.setThemeConfig({
...
` + t
    ...
    let A;
    a === "sandbox" && (A = zt("#i" + n));
    const T = (a === "sandbox" ? zt(A.nodes()[0].contentDocument.body) : zt("body")).select(`[id="${n}"]`),
      q = T.append("g").attr("class", "main"),
      m = ((xt = S.quadrantChart) == null ? void 0 : xt.chartWidth) ?? 500,
      b = ((ft = S.quadrantChart) == null ? void 0 : ft.chartHeight) ?? 500;
    (ve(T, b, m, ((gt = S.quadrantChart) == null ? void 0 : gt.useMaxWidth) ?? !0),
      T.attr("viewBox", "0 0 " + m + " " + b),
      c.db.setHeight(b),
      c.db.setWidth(m));
    const x = c.db.getQuadrantData(),
      O = q.append("g").attr("class", "quadrants"),
      Y = q.append("g").attr("class", "border"),
      G = q.append("g").attr("class", "data-points"),
      yt = q.append("g").attr("class", "labels"),
      Tt = q.append("g").attr("class", "title");
    (x.title &&
      Tt.append("text")
        .attr("x", 0)
        .attr("y", 0)
        .attr("fill", x.title.fill)
        .attr("font-size", x.title.fontSize)
        .attr("dominant-baseline", h(x.title.horizontalPos))
        .attr("text-anchor", p(x.title.verticalPos))
        .attr("transform", y(x.title))
        .text(x.title.text),
      x.borderLines &&
        Y.selectAll("line")
          .data(x.borderLines)
          ...
          .attr("x2", (i) => i.x2)
          .attr("y2", (i) => i.y2)
          .style("stroke", (i) => i.strokeFill)
          .style("stroke-width", (i) => i.strokeWidth));
    const dt = O.selectAll("g.quadrant").data(x.quadrants).enter().append("g").attr("class", "quadrant");
    (dt
      .append("rect")
      .attr("x", (i) => i.x)
      .attr("y", (i) => i.y)
      .attr("width", (i) => i.width)
      .attr("height", (i) => i.height)
      .attr("fill", (i) => i.fill),
      dt
        .append("text")
        .attr("x", 0)
        .attr("y", 0)
        .attr("fill", (i) => i.text.fill)
        .attr("font-size", (i) => i.text.fontSize)
        .attr("dominant-baseline", (i) => h(i.text.horizontalPos))
        .attr("text-anchor", (i) => p(i.text.verticalPos))
        .attr("transform", (i) => y(i.text))
        .text((i) => i.text.text),
      yt
        .selectAll("g.label")
        .data(x.axisLabels)
        ...
        .text((i) => i.text)
        .attr("fill", (i) => i.fill)
        .attr("font-size", (i) => i.fontSize)
        .attr("dominant-baseline", (i) => h(i.horizontalPos))
        .attr("text-anchor", (i) => p(i.verticalPos))
        .attr("transform", (i) => y(i)));
    ...
    (ut
      ...
      .attr("r", (i) => i.radius)
      .attr("fill", (i) => i.fill)
      .attr("stroke", (i) => i.strokeColor)
      .attr("stroke-width", (i) => i.strokeWidth),
      ut
        .append("text")
        .attr("x", 0)
        .attr("y", 0)
  ...
  Re = { draw: Be },
  He = { parser: De, db: we, renderer: Re, styles: o(() => "", "styles") };
