import { L as p, a as u, p as n, s as l, t as e } from "./index-DsVzfBkh.js";
import { html as m } from "./index-CRYcSL6M.js";
import { javascriptLanguage as b } from "./index-CX-969Xh.js";
import { L as S, a as r } from "./index-Bwdi7UEW.js";
import "./index-B05OvgYd.js";
const c = S.deserialize({
    version: 14,
    states:
  ...
  P = b.parser.configure({ top: "SingleExpression" }),
  o = c.configure({
    props: [
      l({
        Text: e.content,
        ...
        VueAttributeName: e.keyword,
        Identifier: e.variableName,
        "AttributeValue ScriptAttributeValue": e.attributeValue,
        Entity: e.character,
        "{{ }}": e.brace,
        "@ :": e.punctuation,
      }),
  ...
  s = { parser: P },
  Q = o.configure({ wrap: n((O, t) => (O.name == "InterpolationContent" ? s : null)) }),
  g = o.configure({ wrap: n((O, t) => (O.name == "AttributeScript" ? s : null)), top: "Attribute" }),
  y = { parser: Q },
  R = { parser: g },
  a = m();
function i(O) {
  return O.configure({ dialect: "selfClosing", wrap: n(X) }, "vue");
}
const T = i(a.language);
function X(O, t) {
  switch (O.name) {
    case "Attribute":
      return /^(@|:|v-)/.test(t.read(O.from, O.from + 2)) ? R : null;
    case "Text":
      return y;
  }
  return null;
...
function k(O = {}) {
  ...
  return new u(t.language == a.language ? T : i(t.language), [
    t.support,
    t.language.data.of({ closeBrackets: { brackets: ["{", '"'] } }),
  ]);
}
export { k as vue, T as vueLanguage };
