...
const U = {
  name: "scheme",
  startState: function () {
    return { indentStack: null, indentation: 0, mode: !1, sExprComment: !1, sExprQuote: !1 };
  },
  token: function (e, n) {
    if ((n.indentStack == null && e.sol() && (n.indentation = e.indentation()), e.eatSpace())) return null;
    var i = null;
    switch (n.mode) {
      case "string":
        (y(e, { token: '"', state: n }), (i = g));
        break;
      case "symbol":
        (y(e, { token: "|", state: n }), (i = x));
        break;
      case "comment":
        ...
        break;
      case "s-expr-comment":
        if (((n.mode = !1), e.peek() == "(" || e.peek() == "[")) n.sExprComment = 0;
        else {
          (e.eatWhile(/[^\s\(\)\[\]]/), (i = a));
          break;
        }
      default:
        var r = e.next();
        if (r == '"') ((n.mode = "string"), (i = g));
        else if (r == "'")
          e.peek() == "(" || e.peek() == "["
            ? (typeof n.sExprQuote != "number" && (n.sExprQuote = 0), (i = c))
            : (e.eatWhile(/[\w_\-!$%&*+\.\/:<=>?@\^~]/), (i = c));
        else if (r == "|") ((n.mode = "symbol"), (i = x));
        else if (r == "#")
          if (e.eat("|")) ((n.mode = "comment"), (i = a));
          else if (e.eat(/[tf]/i)) i = c;
          else if (e.eat(";")) ((n.mode = "s-expr-comment"), (i = a));
          else {
            var l = null,
              o = !1,
              m = !0;
            (e.eat(/[ei]/i) ? (o = !0) : e.backUp(1),
              e.match(/^#b/i)
                ? (l = B)
                : e.match(/^#o/i)
                  ? (l = $)
                  : e.match(/^#x/i)
                    ...
                    : e.match(/^#d/i)
                      ...
                      : e.match(/^[-+0-9.]/, !1)
                        ? ((m = !1), (l = u))
                        : o || e.eat("#"),
              l != null && (m && !o && e.match(/^#[ei]/i), l(e) && (i = b)));
          }
        else if (/^[-+0-9.]/.test(r) && u(e, !0)) i = b;
        else if (r == ";") (e.skipToEnd(), (i = a));
        else if (r == "(" || r == "[") {
          for (var d = "", f = e.column(), h; (h = e.eat(/[^\s\(\[\;\)\]]/)) != null; ) d += h;
          (d.length > 0 && q.propertyIsEnumerable(d)
            ? s(n, f + S, r)
            : (e.eatSpace(), e.eol() || e.peek() == ";" ? s(n, f + 1, r) : s(n, f + e.current().length, r)),
            e.backUp(e.current().length - 1),
            typeof n.sExprComment == "number" && n.sExprComment++,
            typeof n.sExprQuote == "number" && n.sExprQuote++,
            (i = v));
        } else
          r == ")" || r == "]"
            ? ((i = v),
              n.indentStack != null &&
                n.indentStack.type == (r == ")" ? "(" : "[") &&
                (N(n),
                typeof n.sExprComment == "number" && --n.sExprComment == 0 && ((i = a), (n.sExprComment = !1)),
                typeof n.sExprQuote == "number" && --n.sExprQuote == 0 && ((i = c), (n.sExprQuote = !1))))
            : (e.eatWhile(/[\w_\-!$%&*+\.\/:<=>?@\^~]/),
              k && k.propertyIsEnumerable(e.current()) ? (i = E) : (i = "variable"));
    }
