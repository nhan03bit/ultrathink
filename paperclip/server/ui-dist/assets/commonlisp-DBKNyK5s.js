...
function o(e, n) {
  ...
  if (t == "#") {
    ...
    return r == "."
      ? null
      : ((l = "symbol"),
        r == "nil" || r == "t" || r.charAt(0) == ":"
          ? "atom"
          : n.lastType == "open" && (u.test(r) || c.test(r))
            ? "keyword"
            : r.charAt(0) == "&"
...
const s = {
  ...
  token: function (e, n) {
    ...
    return (
      l != "ws" &&
        (n.ctx.indentTo == null
          ? l == "symbol" && c.test(e.current())
            ? (n.ctx.indentTo = n.ctx.start + e.indentUnit)
            : (n.ctx.indentTo = "next")
          : n.ctx.indentTo == "next" && (n.ctx.indentTo = e.column()),
        (n.lastType = l)),
      l == "open"
        ? (n.ctx = { prev: n.ctx, start: e.column(), indentTo: null })
        : l == "close" && (n.ctx = n.ctx.prev || n.ctx),
      t
    );
  },
  indent: function (e) {
