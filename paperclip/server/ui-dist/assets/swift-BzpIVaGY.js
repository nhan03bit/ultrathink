...
var l = c([
  ...
  d = c(["true", "false", "nil", "self", "super", "_"]),
  v = c([
    "Array",
    "Bool",
    "Character",
  ...
  s = /^\-?0b[01][01_]*/,
  k = /^\-?0o[0-7][0-7_]*/,
  x = /^\-?0x[\dA-Fa-f][\dA-Fa-f_]*(?:(?:\.[\dA-Fa-f][\dA-Fa-f_]*)?[Pp]\-?\d[\d_]*)?/,
  y = /^\-?\d[\d_]*(?:\.\d[\d_]*)?(?:[Ee]\-?\d[\d_]*)?/,
...
function f(n, e, t) {
  ...
  if (n.match(g)) {
    var u = n.current();
    return v.hasOwnProperty(u)
      ? "type"
      : d.hasOwnProperty(u)
        ? "atom"
        : l.hasOwnProperty(u)
          ? (p.hasOwnProperty(u) && (e.prev = "define"), "keyword")
          : t == "define"
            ? "def"
            : "variable";
  }
...
const C = {
  ...
  token: function (n, e) {
    var t = e.prev;
    e.prev = null;
    var i = e.tokenize[e.tokenize.length - 1] || f,
      r = i(n, e, t);
