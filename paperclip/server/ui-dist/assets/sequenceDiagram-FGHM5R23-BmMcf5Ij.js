...
import { a as Er, b as re, g as dt, d as ur, e as ae, f as se } from "./chunk-YZCP3GAM-BAiBeFVJ.js";
import { I as fr } from "./chunk-QZHKN3VN-BzqBfdtF.js";
import "./index-Cwp91QXi.js";
var jt = (function () {
  var e = g(function (ut, N, v, k) {
      for (v = v || {}, k = ut.length; k--; v[ut[k]] = N);
      return v;
    }, "o"),
    t = [1, 2],
    a = [1, 3],
    ...
    Gt = {
      ...
      performAction: g(function (N, v, k, y, z, o, wt) {
        var T = o.length - 1;
        switch (z) {
          case 3:
          ...
          case 16:
            ...
            break;
          case 17:
            (o[T - 1].unshift({ type: "boxStart", boxData: y.parseBoxData(o[T - 2]) }),
              o[T - 1].push({ type: "boxEnd", boxText: o[T - 2] }),
              (this.$ = o[T - 1]));
            break;
          case 19:
            this.$ = {
              type: "sequenceIndex",
              sequenceIndex: Number(o[T - 2]),
              sequenceIndexStep: Number(o[T - 1]),
              sequenceVisible: !0,
          ...
          case 35:
            (o[T - 1].unshift({
              type: "loopStart",
              loopText: y.parseMessage(o[T - 2]),
              signalType: y.LINETYPE.LOOP_START,
            }),
              o[T - 1].push({ type: "loopEnd", loopText: o[T - 2], signalType: y.LINETYPE.LOOP_END }),
              (this.$ = o[T - 1]));
            break;
          case 36:
            (o[T - 1].unshift({
              type: "rectStart",
              color: y.parseMessage(o[T - 2]),
              signalType: y.LINETYPE.RECT_START,
            }),
              o[T - 1].push({ type: "rectEnd", color: y.parseMessage(o[T - 2]), signalType: y.LINETYPE.RECT_END }),
              (this.$ = o[T - 1]));
            break;
          case 37:
            (o[T - 1].unshift({
              type: "optStart",
              optText: y.parseMessage(o[T - 2]),
              signalType: y.LINETYPE.OPT_START,
            }),
              o[T - 1].push({ type: "optEnd", optText: y.parseMessage(o[T - 2]), signalType: y.LINETYPE.OPT_END }),
              (this.$ = o[T - 1]));
            break;
          case 38:
            (o[T - 1].unshift({
              type: "altStart",
              altText: y.parseMessage(o[T - 2]),
              signalType: y.LINETYPE.ALT_START,
            }),
              o[T - 1].push({ type: "altEnd", signalType: y.LINETYPE.ALT_END }),
              (this.$ = o[T - 1]));
            break;
          case 39:
            (o[T - 1].unshift({
              type: "parStart",
              parText: y.parseMessage(o[T - 2]),
              signalType: y.LINETYPE.PAR_START,
            }),
              o[T - 1].push({ type: "parEnd", signalType: y.LINETYPE.PAR_END }),
              (this.$ = o[T - 1]));
            break;
          case 40:
            (o[T - 1].unshift({
          ...
          case 41:
            (o[T - 1].unshift({
              type: "criticalStart",
              criticalText: y.parseMessage(o[T - 2]),
              signalType: y.LINETYPE.CRITICAL_START,
            }),
              o[T - 1].push({ type: "criticalEnd", signalType: y.LINETYPE.CRITICAL_END }),
              (this.$ = o[T - 1]));
            break;
          case 42:
            (o[T - 1].unshift({
              type: "breakStart",
              breakText: y.parseMessage(o[T - 2]),
              signalType: y.LINETYPE.BREAK_START,
            }),
              o[T - 1].push({ type: "breakEnd", optText: y.parseMessage(o[T - 2]), signalType: y.LINETYPE.BREAK_END }),
              (this.$ = o[T - 1]));
            break;
          case 44:
            this.$ = o[T - 3].concat([
              { type: "option", optionText: y.parseMessage(o[T - 1]), signalType: y.LINETYPE.CRITICAL_OPTION },
              o[T],
            ]);
            break;
          case 46:
            this.$ = o[T - 3].concat([
              { type: "and", parText: y.parseMessage(o[T - 1]), signalType: y.LINETYPE.PAR_AND },
              o[T],
            ]);
            break;
          case 48:
            this.$ = o[T - 3].concat([
              { type: "else", altText: y.parseMessage(o[T - 1]), signalType: y.LINETYPE.ALT_ELSE },
              o[T],
            ]);
            break;
          case 49:
            ((o[T - 3].draw = "participant"),
              (o[T - 3].type = "addParticipant"),
              (o[T - 3].description = y.parseMessage(o[T - 1])),
              (this.$ = o[T - 3]));
            break;
          case 50:
          ...
          case 58:
            ...
            break;
          case 59:
            ((o[T - 2] = [].concat(o[T - 1], o[T - 1]).slice(0, 2)),
              (o[T - 2][0] = o[T - 2][0].actor),
              (o[T - 2][1] = o[T - 2][1].actor),
              (this.$ = [
                o[T - 1],
                { type: "addNote", placement: y.PLACEMENT.OVER, actor: o[T - 2].slice(0, 2), text: o[T] },
              ]));
            break;
          case 60:
          ...
          case 75:
            this.$ = [
              o[T - 3],
              o[T - 1],
              { type: "addMessage", from: o[T - 3].actor, to: o[T - 1].actor, signalType: o[T - 2], msg: o[T] },
            ];
            break;
          case 76:
            this.$ = { type: "addParticipant", actor: o[T - 1], config: o[T] };
            break;
          case 77:
            this.$ = o[T - 1].trim();
            break;
      ...
      table: [
        ...
        { 5: [1, 132], 52: [1, 131] },
        { 5: [1, 134], 52: [1, 133] },
        e(Ut, Ae, { 74: 135, 75: [1, 136] }),
        { 5: [1, 138], 52: [1, 137] },
        { 5: [1, 140], 52: [1, 139] },
        { 5: [1, 141] },
        { 23: 145, 70: [1, 142], 71: [1, 143], 72: [1, 144], 73: W },
        {
          69: 146,
          78: A,
          79: D,
        ...
        { 58: 153, 104: ct },
        { 58: 154, 104: ct },
        { 4: [1, 157], 5: [1, 159], 12: 156, 13: 158, 17: [1, 155], 51: U, 53: G, 54: X },
        { 5: [1, 160] },
        e(C, [2, 20]),
        e(C, [2, 21]),
        e(C, [2, 23]),
      ...
      parseError: g(function (N, v) {
        if (v.recoverable) this.trace(N);
        else {
          var k = new Error(N);
          throw ((k.hash = v), k);
        }
      ...
      parse: g(function (N) {
        var v = this,
          ...
          Qe = 2,
          me = 1,
          $e = o.slice.call(arguments, 1),
          J = Object.create(this.lexer),
          gt = { yy: {} };
        for (var Xt in this.yy) Object.prototype.hasOwnProperty.call(this.yy, Xt) && (gt.yy[Xt] = this.yy[Xt]);
        ...
        function tr(ot) {
          ((k.length = k.length - 2 * ot), (z.length = z.length - ot), (o.length = o.length - ot));
        }
        g(tr, "popStack");
        function Pe() {
          var ot;
          return (
            (ot = y.pop() || J.lex() || me),
            typeof ot != "number" && (ot instanceof Array && ((y = ot), (ot = y.pop())), (ot = v.symbols_[ot] || ot)),
            ot
          );
        }
        g(Pe, "lex");
        for (var at, xt, lt, Zt, Ot = {}, Ct, Tt, ke, Mt; ; ) {
          if (
            ((xt = k[k.length - 1]),
            this.defaultActions[xt]
              ? (lt = this.defaultActions[xt])
              : ((at === null || typeof at > "u") && (at = Pe()), (lt = wt[xt] && wt[xt][at])),
            typeof lt > "u" || !lt.length || !lt[0])
          ) {
            var Qt = "";
            Mt = [];
            for (Ct in wt[xt]) this.terminals_[Ct] && Ct > Qe && Mt.push("'" + this.terminals_[Ct] + "'");
            (J.showPosition
              ? (Qt =
                  "Parse error on line " +
                  (vt + 1) +
...
Expecting ` +
              ...
              : (Qt =
                  ...
                  (vt + 1) +
                  ": Unexpected " +
                  (at == me ? "end of input" : "'" + (this.terminals_[at] || at) + "'")),
              this.parseError(Qt, {
                text: J.match,
          ...
          if (lt[0] instanceof Array && lt.length > 1)
            throw new Error("Parse Error: multiple actions possible at state: " + xt + ", token: " + at);
          switch (lt[0]) {
            case 1:
              (k.push(at),
                z.push(J.yytext),
            ...
            case 2:
              if (
                ...
                je && (Ot._$.range = [o[o.length - (Tt || 1)].range[0], o[o.length - 1].range[1]]),
                (Zt = this.performAction.apply(Ot, [T, Ne, vt, gt.yy, lt[1], z, o].concat($e))),
                typeof Zt < "u")
              )
                return Zt;
              (Tt && ((k = k.slice(0, -1 * Tt * 2)), (z = z.slice(0, -1 * Tt)), (o = o.slice(0, -1 * Tt))),
                k.push(this.productions_[lt[1]][0]),
                z.push(Ot.$),
                o.push(Ot._$),
                (ke = wt[k[k.length - 2]][k[k.length - 1]]),
                k.push(ke));
              break;
            case 3:
              return !0;
    ...
    Ze = (function () {
      var ut = {
        EOF: 1,
        parseError: g(function (v, k) {
          if (this.yy.parser) this.yy.parser.parseError(v, k);
          else throw new Error(v);
        }, "parseError"),
        setInput: g(function (N, v) {
          return (
            (this.yy = v || this.yy || {}),
            (this._input = N),
        ...
        input: g(function () {
          ...
          var v = N.match(/(?:\r\n?|\n).*/g);
          return (
            v ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++,
        ...
        unput: g(function (N) {
          ...
          ((this._input = N + this._input),
            (this.yytext = this.yytext.substr(0, this.yytext.length - v)),
            (this.offset -= v));
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [z[0], z[0] + this.yyleng - v]),
...
` +
        ...
        test_match: g(function (N, v) {
          ...
          if (
            (this.options.backtrack_lexer &&
              ...
              this.options.ranges && (z.yylloc.range = this.yylloc.range.slice(0))),
            (y = N[0].match(/(?:\r\n?|\n).*/g)),
            ...
            (this.matched += N[0]),
            (k = this.performAction.call(this, this.yy, this, v, this.conditionStack[this.conditionStack.length - 1])),
            this.done && this._input && (this.done = !1),
            k)
          )
            return k;
          if (this._backtrack) {
            for (var o in z) this[o] = z[o];
            return !1;
          }
          return !1;
        }, "test_match"),
        next: g(function () {
          ...
          for (var z = this._currentRules(), o = 0; o < z.length; o++)
            if (((k = this._input.match(this.rules[z[o]])), k && (!v || k[0].length > v[0].length))) {
              if (((v = k), (y = o), this.options.backtrack_lexer)) {
                if (((N = this.test_match(k, z[o])), N !== !1)) return N;
                if (this._backtrack) {
                  v = !1;
                  continue;
                } else return !1;
          ...
          return v
            ? ((N = this.test_match(v, z[y])), N !== !1 ? N : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: g(function (v, k, y, z) {
          switch (y) {
            case 0:
              return 5;
            case 1:
...
var _r = jt,
  ...
  Yt = { ACTOR: "actor", CONTROL: "control", DATABASE: "database", ENTITY: "entity" },
  bt,
  yr =
    ((bt = class {
      constructor() {
        ((this.state = new fr(() => ({
          ...
          (this.setAccTitle = De),
          (this.setAccDescription = sr),
          (this.setDiagramTitle = ir),
          (this.getAccTitle = nr),
          (this.getAccDescription = or),
          (this.getDiagramTitle = cr),
      ...
      addBox(t) {
        (this.state.records.boxes.push({ name: t.text, wrap: t.wrap ?? this.autoWrap(), fill: t.color, actorKeys: [] }),
...
` +
        ...
        ((i = (c == null ? void 0 : c.type) ?? i),
          c != null &&
            c.alias &&
            (!r || r.text === a) &&
            (r = { text: c.alias, wrap: r == null ? void 0 : r.wrap, type: i }));
      ...
      autoWrap() {
        ...
        return this.state.records.wrapEnabled !== void 0
          ...
          : (((t = j().sequence) == null ? void 0 : t.wrap) ?? !1);
      }
      clear() {
        (this.state.reset(), dr());
      }
      parseMessage(t) {
        const a = t.trim(),
          ...
          n = { text: i, wrap: r };
        return (st.debug(`parseMessage: ${JSON.stringify(n)}`), n);
      }
      parseBoxData(t) {
        ...
        if (window != null && window.CSS) window.CSS.supports("color", r) || ((r = "transparent"), (i = t.trim()));
          ...
          ((c.color = r), c.color !== r && ((r = "transparent"), (i = t.trim())));
        }
        const { wrap: n, cleanedText: s } = this.extractWrap(i);
        return { text: s ? Vt(s, j()) : void 0, color: r, wrap: n };
      }
      addNote(t, a, r) {
        const i = { actor: t, placement: a, message: r.text, wrap: r.wrap ?? this.autoWrap() },
          n = [].concat(t, t);
      ...
      addLinks(t, a) {
        ...
        try {
          ...
          st.error("error while parsing actor link text", i);
        }
      }
      addALink(t, a) {
        const r = this.getActor(t);
        try {
          ...
          const c = n.slice(0, s - 1).trim(),
            E = n.slice(s + 1).trim();
          ((i[c] = E), this.insertLinks(r, i));
        } catch (i) {
          st.error("error while parsing actor link text", i);
        }
      }
      ...
      addProperties(t, a) {
        ...
        try {
          ...
          st.error("error while parsing actor properties text", i);
        }
      }
      ...
      addDetails(t, a) {
        ...
        try {
          ...
          st.error("error while parsing actor details text", n);
        }
      }
...
`;
  ...
  Lr = g(function (e, t, a, r, i) {
    ...
    var l = "";
    c.class !== void 0 && (l = " " + c.class);
    let x = c.width > a ? c.width : a;
    const u = d.append("rect");
    if (
      (u.attr("class", "actorPopupMenuPanel" + l),
      u.attr("x", c.x),
      u.attr("y", c.height),
      u.attr("fill", c.fill),
      u.attr("stroke", c.stroke),
      u.attr("width", x),
      u.attr("height", c.height),
      u.attr("rx", c.rx),
      u.attr("ry", c.ry),
      n != null)
    ) {
      ...
      for (let _ in n) {
        var p = d.append("a"),
          f = Me.sanitizeUrl(n[_]);
        (p.attr("xlink:href", f),
          p.attr("target", "_blank"),
          Gr(r)(_, p, c.x + 10, c.height + O, x, 20, { class: "actor" }, r),
          (O += 30));
      }
    }
    return (u.attr("height", O), { height: c.height + O, width: x });
  }, "drawPopup"),
  Ht = g(function (e) {
    return (
  ...
  Kt = g(async function (e, t, a = null) {
    let r = e.append("foreignObject");
    const i = await Ve(t.text, Wt()),
      s = r
        .append("xhtml:div")
    ...
    if ((r.attr("height", Math.round(s.height)).attr("width", Math.round(s.width)), t.class === "noteText")) {
      ...
      let { startx: c, stopx: E, starty: d } = a;
      if (c > E) {
        const l = c;
        ((c = E), (E = l));
      }
      (r.attr("x", Math.round(c + Math.abs(c - E) / 2 - s.width / 2)),
        t.class === "loopText" ? r.attr("y", Math.round(d)) : r.attr("y", Math.round(d - s.height)));
    }
    return [r];
  }, "drawKatex"),
  At = g(function (e, t) {
    ...
    if (t.valign !== void 0 && t.textMargin !== void 0 && t.textMargin > 0)
      switch (t.valign) {
        case "top":
        case "start":
          d = g(() => Math.round(t.y + t.textMargin), "yfunc");
          break;
        case "middle":
        case "center":
          d = g(() => Math.round(t.y + (a + r + t.textMargin) / 2), "yfunc");
          break;
        case "bottom":
        case "end":
          d = g(() => Math.round(t.y + (a + r + 2 * t.textMargin) - t.textMargin), "yfunc");
          break;
      }
    ...
    for (let [l, x] of i.entries()) {
      t.textMargin !== void 0 && t.textMargin === 0 && n !== void 0 && (E = l * n);
      ...
      (u.attr("x", t.x),
        ...
        t.dy !== void 0 ? u.attr("dy", t.dy) : E !== 0 && u.attr("dy", E));
      const O = x || Tr;
      if (t.tspan) {
  ...
  br = g(function (e, t, a, r, i) {
    var m, w;
    const n = r ? t.stopy : t.starty,
      s = t.x + t.width / 2,
      c = n + t.height,
      { look: E, theme: d, themeVariables: l } = a,
      { bkgColorArray: x, borderColorArray: u } = l,
      O = e.append("g").lower();
    var p = O;
    r ||
      (B++,
      Object.keys(t.links || {}).length &&
        !a.forceMenus &&
        p.attr("onclick", Ht(`actor${B}_popup`)).attr("cursor", "pointer"),
      p
        .append("line")
        .attr("id", "actor" + B)
        .attr("x1", s)
      ...
      (p = O.append("g")),
      (t.actorCnt = B),
      t.links != null && p.attr("id", "root-" + B),
      E === "neo" && p.attr("data-look", "neo"));
    const f = dt();
    var _ = "actor";
    ((m = t.properties) != null && m.class ? (_ = t.properties.class) : (f.fill = "#eaeaea"),
      r ? (_ += ` ${_t}`) : (_ += ` ${ft}`),
      (f.x = t.x),
      (f.y = n),
      (f.width = t.width),
    ...
    const I = Nt(p, f),
      L = i.get(t.name) ?? 0;
    if (
      (pt.has(d) && (I.style("stroke", u[L % u.length]), I.style("fill", x[L % u.length])),
      E === "neo" && I.attr("filter", "url(#drop-shadow)"),
      (t.rectData = f),
    ...
    (r || (p.attr("data-et", "participant"), p.attr("data-type", "participant"), p.attr("data-id", t.name)),
      Et(a, $(t.description))(t.description, p, f.x, f.y, f.width, f.height, { class: `actor ${Ft}` }, a));
    let b = t.height;
    if (I.node) {
  ...
  Ar = g(function (e, t, a, r, i) {
    ...
    const f = dt();
    var _ = "actor";
    ((Y = t.properties) != null && Y.class ? (_ = t.properties.class) : (f.fill = "#eaeaea"),
      r ? (_ += ` ${_t}`) : (_ += ` ${ft}`),
      (f.x = t.x),
      (f.y = n),
      (f.width = t.width),
      ...
      (f.name = t.name));
    const I = 6,
      L = { ...f, x: f.x + -I, y: f.y + +I, class: "actor" },
      b = Nt(p, f),
      m = Nt(p, L);
    ...
    if (
      (pt.has(d) &&
        ...
        b.style("fill", x[w % u.length]),
        m.style("stroke", u[w % u.length]),
        m.style("fill", x[w % u.length])),
      (M = t.properties) != null && M.icon)
    ) {
      const V = t.properties.icon.trim();
      V.charAt(0) === "@" ? ae(p, f.x + f.width - 20, f.y + 10, V.substr(1)) : se(p, f.x + f.width - 20, f.y + 10, V);
    }
    Et(a, $(t.description))(t.description, p, f.x - I, f.y + I, f.width, f.height, { class: `actor ${Ft}` }, a);
    let S = t.height;
    if (b.node) {
      const V = b.node().getBBox();
      ((t.height = V.height), (S = V.height));
    }
    return (r || (p.attr("data-et", "participant"), p.attr("data-type", "collections"), p.attr("data-id", t.name)), S);
  }, "drawActorTypeCollections"),
  Sr = g(function (e, t, a, r, i) {
    var V, U;
    const n = r ? t.stopy : t.starty,
      s = t.x + t.width / 2,
      c = n + t.height,
    ...
    const f = dt();
    let _ = "actor";
    ((V = t.properties) != null && V.class ? (_ = t.properties.class) : (f.fill = "#eaeaea"),
      r ? (_ += ` ${_t}`) : (_ += ` ${ft}`),
      p.attr("class", _),
      (f.x = t.x),
      (f.y = n),
    ...
    Z
  `;
    (b.append("path").attr("d", w),
      m.append("path").attr(
        "d",
        `M ${f.x},${f.y + I}
      a ${L},${I} 0 0 0 0,${f.height}`
      ),
      b.attr("transform", `translate(${L}, ${-(f.height / 2)})`),
      m.attr("transform", `translate(${f.width - L}, ${-f.height / 2})`),
      (t.rectData = f),
      E === "neo" && b.attr("filter", "url(#drop-shadow)"));
    const S = i.get(t.name) ?? 0;
    if (
      (pt.has(d) &&
        (b.style("stroke", u[S % u.length]),
        b.style("fill", x[S % u.length]),
        m.style("stroke", u[S % u.length]),
        m.style("fill", x[S % u.length])),
      (U = t.properties) != null && U.icon)
    ) {
      const G = t.properties.icon.trim(),
        X = f.x + f.width - 20,
        Q = f.y + 10;
      G.charAt(0) === "@" ? ae(p, X, Q, G.substr(1)) : se(p, X, Q, G);
    }
    Et(a, $(t.description))(t.description, p, f.x, f.y, f.width, f.height, { class: `actor ${Ft}` }, a);
    let Y = t.height;
    const M = b.select("path:last-child");
    if (M.node()) {
      const G = M.node().getBBox();
      ((t.height = G.height), (Y = G.height));
    }
    return (r || (p.attr("data-et", "participant"), p.attr("data-type", "queue"), p.attr("data-id", t.name)), Y);
  }, "drawActorTypeQueue"),
  wr = g(function (e, t, a, r, i, n) {
    var V;
    const s = r ? t.stopy : t.starty,
      c = t.x + t.width / 2,
      E = s + 75,
      { look: d, theme: l, themeVariables: x } = a,
      { bkgColorArray: u, borderColorArray: O, actorBorder: p, actorBkg: f } = x,
      _ = e.append("g").lower();
    r ||
      (B++,
      _.append("line")
    ...
    (I.append("defs")
      ...
      I.append("circle")
        ...
        .attr("cy", w)
        .attr("r", S)
        .attr("filter", `${d === "neo" ? "url(#drop-shadow)" : ""}`),
      I.append("line")
        .attr("marker-end", "url(#" + i + "-filled-head-control)")
        .attr("transform", `translate(${m}, ${w - S})`));
    const Y = n.get(t.name) ?? 0;
    pt.has(l)
      ? (I.style("stroke", O[Y % O.length]), I.style("fill", u[Y % O.length]))
      : (I.style("stroke", p), I.style("fill", f));
    const M = I.node().getBBox();
    return (
      (t.height = M.height + 2 * (((V = a == null ? void 0 : a.sequence) == null ? void 0 : V.labelBoxHeight) ?? 0)),
      Et(a, $(t.description))(
        t.description,
        I,
        b.x,
  ...
  Nr = g(function (e, t, a, r, i) {
    ...
    const I = t.x + t.width / 2,
      L = n + (r ? 10 : 25),
      b = 22;
    (p.append("circle").attr("cx", I).attr("cy", L).attr("r", b).attr("width", t.width).attr("height", t.height),
      p
        .append("line")
        .attr("x1", I - b)
        .attr("x2", I + b)
        ...
        .attr("y2", L + b)
        .attr("stroke-width", 2),
      E === "neo" && p.attr("filter", "url(#drop-shadow)"));
    const m = i.get(t.name) ?? 0;
    pt.has(d) && (p.style("stroke", u[m % u.length]), p.style("fill", x[m % u.length]));
    const w = p.node().getBBox();
    return (
      (t.height = w.height + (((S = a == null ? void 0 : a.sequence) == null ? void 0 : S.labelBoxHeight) ?? 0)),
      r ||
        (B++,
        O.append("line")
          .attr("id", "actor" + B)
      ...
      r
        ? p.attr("transform", `translate(0, ${b})`)
        : (p.attr("transform", `translate(0, ${b / 2 - 5})`),
          p.attr("data-et", "participant"),
          p.attr("data-type", "entity"),
          p.attr("data-id", t.name)),
      t.height
    );
  }, "drawActorTypeEntity"),
  mr = g(function (e, t, a, r, i) {
    var U;
    const n = r ? t.stopy : t.starty,
      s = t.x + t.width / 2,
      c = n + t.height + 2 * a.boxTextMargin,
      { theme: E, themeVariables: d, look: l } = a,
      { bkgColorArray: x, borderColorArray: u, actorBorder: O } = d,
      p = e.append("g").lower();
    let f = p;
    r ||
      (B++,
      Object.keys(t.links || {}).length &&
        !a.forceMenus &&
        f.attr("onclick", Ht(`actor${B}_popup`)).attr("cursor", "pointer"),
      f
        .append("line")
        .attr("id", "actor" + B)
        .attr("x1", s)
      ...
      (f = p.append("g")),
      (t.actorCnt = B),
      t.links != null && f.attr("id", "root-" + B),
      l === "neo" && f.attr("data-look", "neo"));
    const _ = dt();
    let I = "actor";
    ((U = t.properties) != null && U.class ? (I = t.properties.class) : (_.fill = "#eaeaea"),
      r ? (I += ` ${_t}`) : (I += ` ${ft}`),
      (_.x = t.x),
      (_.y = n),
      (_.width = t.width),
  ...
  l 0,-${b - 2 * w}
`;
    (S.append("path").attr("d", Y), l === "neo" && S.attr("filter", "url(#drop-shadow)"));
    const M = i.get(t.name) ?? 0;
    (pt.has(E) ? (S.style("stroke", u[M % u.length]), S.style("fill", x[M % u.length])) : S.style("stroke", O),
      S.attr("transform", `translate(${L}, ${w})`),
      (t.rectData = _),
      Et(a, $(t.description))(t.description, f, _.x, _.y + 35, _.width, _.height, { class: `actor ${Ft}` }, a));
    const V = S.select("path:last-child");
    if (V.node()) {
      const G = V.node().getBBox();
      t.height = G.height + (a.sequence.labelBoxHeight ?? 0);
    }
    return (
      r || (f.attr("data-et", "participant"), f.attr("data-type", "database"), f.attr("data-id", t.name)),
      t.height
    );
  }, "drawActorTypeDatabase"),
  Pr = g(function (e, t, a, r, i) {
    const n = r ? t.stopy : t.starty,
      s = t.x + t.width / 2,
      c = n + 80,
      E = 22,
      d = e.append("g").lower(),
      { look: l, theme: x, themeVariables: u } = a,
      { bkgColorArray: O, borderColorArray: p, actorBorder: f } = u;
    r ||
      (B++,
      d
        .append("line")
    ...
    ((L.x = t.x),
      ...
      (L.class = "actor"),
      _.append("line")
        .attr("id", "actor-man-torso" + B)
        .attr("x1", t.x + t.width / 2 - E * 2.5)
        .attr("y1", n + 12)
        .attr("x2", t.x + t.width / 2 - 15)
        .attr("y2", n + 12),
      _.append("line")
        .attr("id", "actor-man-arms" + B)
        .attr("x1", t.x + t.width / 2 - E * 2.5)
        .attr("y1", n + 2)
        .attr("x2", t.x + t.width / 2 - E * 2.5)
        .attr("y2", n + 22),
      _.append("circle")
        .attr("cx", t.x + t.width / 2)
        .attr("cy", n + 12)
        .attr("r", E),
      l === "neo" && _.attr("filter", "url(#drop-shadow)"));
    ...
    return (
      ...
      Et(a, $(t.description))(t.description, _, L.x, L.y + 15, L.width, L.height, { class: `actor ${yt}` }, a),
      _.attr("transform", `translate(0,${E / 2 + 10})`),
      r || (_.attr("data-et", "participant"), _.attr("data-type", "boundary"), _.attr("data-id", t.name)),
      t.height
    );
  }, "drawActorTypeBoundary"),
  kr = g(function (e, t, a, r, i) {
    const n = r ? t.stopy : t.starty,
      s = t.x + t.width / 2,
      c = n + 80,
      { look: E, theme: d, themeVariables: l } = a,
      { bkgColorArray: x, borderColorArray: u, actorBorder: O } = l,
      p = e.append("g").lower();
    r ||
      (B++,
      p
    ...
    (r ? (_ += ` ${_t}`) : (_ += ` ${ft}`),
      f.attr("class", _),
      f.attr("name", t.name),
      r || f.attr("data-et", "participant").attr("data-type", "actor").attr("data-id", t.name));
    const I = E === "neo" ? 0.5 : 1,
      L = E === "neo" ? n + (1 - I) * 30 : n;
    (f
      .append("line")
    ...
    const S = i.get(t.name) ?? 0;
    return (
      pt.has(d) ? (f.style("stroke", u[S % u.length]), f.style("fill", x[S % u.length])) : f.style("stroke", O),
      Et(a, $(t.description))(
        t.description,
        f,
        w.x,
  ...
  Dr = g(async function (e, t, a, r, i, n, s) {
    const c = s ?? new Map([...n.db.getActors().values()].map((E, d) => [E.name, d]));
    switch (t.type) {
      case "actor":
        return await kr(e, t, a, r, c);
      case "participant":
        return await br(e, t, a, r, c);
      case "boundary":
        return await Pr(e, t, a, r, c);
      case "control":
        return await wr(e, t, a, r, i, c);
      case "entity":
        return await Nr(e, t, a, r, c);
      case "database":
        return await mr(e, t, a, r, c);
      case "collections":
        return await Ar(e, t, a, r, c);
      case "queue":
        return await Sr(e, t, a, r, c);
    }
  }, "drawActor"),
  vr = g(function (e, t, a) {
    const i = e.append("g");
  ...
  Mr = g(function (e, t, a, r, i, n, s) {
    const { theme: c, themeVariables: E } = r,
      { bkgColorArray: d, borderColorArray: l, mainBkg: x } = E,
      u = dt(),
      O = t.anchored,
      p = t.actor;
    ((u.x = t.startx),
      ...
      (u.height = a - t.starty));
    const f = Nt(O, u),
      I = (s ?? new Map([...n.db.getActors().values()].map((L, b) => [L.name, b]))).get(p) ?? 0;
    pt.has(c) && (f.style("stroke", l[I % l.length]), f.style("fill", d[I % l.length] ?? x));
  }, "drawActivation"),
  Br = g(async function (e, t, a, r, i) {
    const {
        boxMargin: n,
        boxTextMargin: s,
        labelBoxHeight: c,
    ...
    ((p.text = a),
      ...
      (p.valign = "middle"),
      (p.tspan = !1),
      (p.width = Math.max(E ?? 0, 50)),
      (p.height = c + (r.look === "neo" ? 15 : 0) || 20),
      (p.textMargin = s),
      (p.class = "labelText"),
      Ye(u, p),
      (p = Fe()),
      (p.text = t.title),
      (p.x = t.startx + E / 2 + (t.stopx - t.startx) / 2),
      (p.y = t.starty + n + s),
      (p.anchor = "middle"),
      (p.valign = "middle"),
      (p.textMargin = s),
      ...
      (p.fontWeight = x),
      (p.wrap = !0));
    let f = $(p.text) ? await Kt(u, p, t) : At(u, p);
    if (t.sectionTitles !== void 0) {
      for (const [_, I] of Object.entries(t.sectionTitles))
        if (I.message) {
          ((p.text = I.message),
            (p.x = t.startx + (t.stopx - t.startx) / 2),
            (p.y = t.sections[_].y + n + s),
            (p.class = "loopText"),
            (p.anchor = "middle"),
            (p.valign = "middle"),
            (p.tspan = !1),
            ...
            (p.fontWeight = x),
            (p.wrap = t.wrap),
            $(p.text) ? ((t.starty = t.sections[_].y), await Kt(u, p, t)) : At(u, p));
          let L = Math.round(f.map((b) => (b._groups || b)[0][0].getBBox().height).reduce((b, m) => b + m));
  ...
  Et = (function () {
    ...
    g(e, "byText");
    function t(n, s, c, E, d, l, x, u) {
      const { actorFontSize: O, actorFontFamily: p, actorFontWeight: f } = u,
        [_, I] = Be(O),
    ...
    g(t, "byTspan");
    function a(n, s, c, E, d, l, x, u) {
      const O = s.append("switch"),
        f = O.append("foreignObject")
          .attr("x", c)
          .attr("y", E)
          .attr("width", d)
          .attr("height", l)
    ...
    g(a, "byFo");
    async function r(n, s, c, E, d, l, x, u) {
      const O = await mt(n, Wt()),
        p = s.append("switch"),
        _ = p
          .append("foreignObject")
          .attr("x", c + d / 2 - O.width / 2)
          .attr("y", E + l / 2 - O.height / 2)
          .attr("width", O.width)
    ...
    g(r, "byKatex");
    function i(n, s) {
      for (const c in s) s.hasOwnProperty(c) && n.attr(c, s[c]);
    }
    return (
      g(i, "_setTextAttrs"),
      function (n, s = !1) {
  ...
  Gr = (function () {
    function e(i, n, s, c, E, d, l) {
      const x = n.append("text").attr("x", s).attr("y", c).style("text-anchor", "start").text(i);
      r(x, l);
    }
    g(e, "byText");
    function t(i, n, s, c, E, d, l, x) {
      const { actorFontSize: u, actorFontFamily: O, actorFontWeight: p } = x,
        f = i.split(P.lineBreakRegex);
      for (let _ = 0; _ < f.length; _++) {
        const I = _ * u - (u * (f.length - 1)) / 2,
          L = n
            .append("text")
            .attr("x", s)
            .attr("y", c)
            ...
            .style("font-weight", p)
            .style("font-family", O);
        (L.append("tspan").attr("x", s).attr("dy", I).text(f[_]),
          L.attr("y", c + d / 2)
            .attr("dominant-baseline", "central")
            .attr("alignment-baseline", "central"),
          r(L, l));
  ...
  R = {
    ...
    models: {
      ...
      addActor: g(function (e) {
        this.actors.push(e);
      }, "addActor"),
      addLoop: g(function (e) {
        this.loops.push(e);
      }, "addLoop"),
      addMessage: g(function (e) {
        this.messages.push(e);
      }, "addMessage"),
      addNote: g(function (e) {
        this.notes.push(e);
      }, "addNote"),
      lastActor: g(function () {
        return this.actors[this.actors.length - 1];
      }, "lastActor"),
      lastLoop: g(function () {
        return this.loops[this.loops.length - 1];
      }, "lastLoop"),
      lastMessage: g(function () {
    ...
    updateVal: g(function (e, t, a, r) {
      e[t] === void 0 ? (e[t] = a) : (e[t] = r(a, e[t]));
    }, "updateVal"),
    updateBounds: g(function (e, t, a, r) {
      const i = this;
      let n = 0;
      function s(c) {
        return g(function (d) {
          n++;
          const l = i.sequenceItems.length - n + 1;
          (i.updateVal(d, "starty", t - l * h.boxMargin, Math.min),
            i.updateVal(d, "stopy", r + l * h.boxMargin, Math.max),
            i.updateVal(R.data, "startx", e - l * h.boxMargin, Math.min),
            i.updateVal(R.data, "stopx", a + l * h.boxMargin, Math.max),
            c !== "activation" &&
              (i.updateVal(d, "startx", e - l * h.boxMargin, Math.min),
              i.updateVal(d, "stopx", a + l * h.boxMargin, Math.max),
              i.updateVal(R.data, "starty", t - l * h.boxMargin, Math.min),
              i.updateVal(R.data, "stopy", r + l * h.boxMargin, Math.max)));
        }, "updateItemBounds");
      }
      (g(s, "updateFn"), this.sequenceItems.forEach(s()), this.activations.forEach(s("activation")));
    }, "updateBounds"),
    insert: g(function (e, t, a, r) {
      ...
      (this.updateVal(R.data, "startx", i, Math.min),
        ...
        this.updateVal(R.data, "stopy", c, Math.max),
        this.updateBounds(i, s, n, c));
    }, "insert"),
    newActivation: g(function (e, t, a) {
      const r = a.get(e.from),
        i = qt(e.from).length || 0,
        n = r.x + r.width / 2 + ((i - 1) * h.activationWidth) / 2;
      this.activations.push({
        ...
        stopy: void 0,
        actor: e.from,
        anchored: H.anchorElement(t),
      });
    }, "newActivation"),
    endActivation: g(function (e) {
    ...
    createLoop: g(function (e = { message: void 0, wrap: !1, width: void 0 }, t) {
      return {
        startx: void 0,
  ...
  $r = g(async function (e, t, a) {
    ...
    ((s.x = t.startx),
      ...
      (s.text = t.message),
      (s.class = "noteText"),
      (s.fontFamily = h.noteFontFamily),
      (s.fontSize = h.noteFontSize),
      (s.fontWeight = h.noteFontWeight),
      (s.anchor = h.noteAlign),
      (s.textMargin = h.noteMargin),
      (s.valign = "center"));
    const c = $(s.text) ? await Kt(i, s) : At(i, s),
      E = Math.round(c.map((d) => (d._groups || d)[0][0].getBBox().height).reduce((d, l) => d + l));
    (n.attr("height", E + 2 * h.noteMargin),
      (t.height += E + 2 * h.noteMargin),
      R.bumpVerticalPos(E + 2 * h.noteMargin),
      (t.stopy = t.starty + E + 2 * h.noteMargin),
      (t.stopx = t.startx + r.width),
      R.insert(t.startx, t.starty, t.stopx, t.stopy),
      R.models.addNote(t));
  }, "drawNote"),
  ve = g(function (e, t, a, r, i, n, s) {
    const c = r.db.getActors(),
      E = c.get(t.from),
      d = c.get(t.to),
      l = a.sequenceVisible;
    let x = E.x + E.width / 2,
    ...
    const O = x <= u,
      ...
      L = g((S) => {
        f.append("circle").attr("cx", S).attr("cy", s).attr("r", 5).attr("width", 10).attr("height", 10);
      }, "drawCircle"),
      { CENTRAL_CONNECTION: b, CENTRAL_CONNECTION_REVERSE: m, CENTRAL_CONNECTION_DUAL: w } = r.db.LINETYPE;
    if (l)
  ...
  Lt = g((e) => ({ fontFamily: e.noteFontFamily, fontSize: e.noteFontSize, fontWeight: e.noteFontWeight }), "noteFont"),
  te = g(
...
async function He(e, t) {
  ...
  const { startx: a, stopx: r, message: i } = t,
    ...
    s = $(i),
    c = s ? await mt(i, j()) : Z.calculateTextDimensions(i, Rt(h));
  if (!s) {
    const x = c.height / n;
  ...
  if (a === r) {
    ...
    const x = P.getMax(l / 2, h.width / 2);
    R.insert(a - x, R.getVerticalPos() - 10 + d, r + x, R.getVerticalPos() + 30 + d);
  } else ((d += h.boxMargin), (E = R.getVerticalPos() + d), R.insert(a, E - 10, r, E));
  return (
    R.bumpVerticalPos(d),
    (t.height += d),
...
g(He, "boundMessage");
var jr = g(async function (e, t, a, r, i, n) {
    const { startx: s, stopx: c, starty: E, message: d, type: l, sequenceIndex: x, sequenceVisible: u } = t,
      O = Z.calculateTextDimensions(d, Rt(h)),
      p = re();
    ((p.x = s),
      (p.y = E + 10),
      (p.width = c - s),
      ...
      (p.dy = "1em"),
      (p.text = d),
      (p.fontFamily = h.messageFontFamily),
      (p.fontSize = h.messageFontSize),
      (p.fontWeight = h.messageFontWeight),
      (p.anchor = h.messageAlign),
      (p.valign = "center"),
      (p.textMargin = h.wrapPadding),
      (p.tspan = !1),
      $(p.text) ? await Kt(e, p, { startx: s, stopx: c, starty: a }) : At(e, p));
    const f = O.width;
    let _;
    if (s === c) {
      const L = u || h.showSequenceNumbers,
        b = Je(i, r),
        m = na(i, r),
        w = s + (L && (b || m) ? 10 : 0);
      (h.rightAngles
        ? (_ = e.append("path").attr("d", `M  ${w},${a} H ${s + P.getMax(h.width / 2, f / 2)} V ${a + 25} H ${s}`))
        : (_ = e
            .append("path")
            .attr(
              "d",
      ...
      ((_ = e.append("line")),
        ...
        _.attr("y2", a),
        $t(i, r) && ve(e, i, t, r, s, c, a));
    (l === r.db.LINETYPE.DOTTED ||
    l === r.db.LINETYPE.DOTTED_CROSS ||
    l === r.db.LINETYPE.DOTTED_POINT ||
    l === r.db.LINETYPE.DOTTED_OPEN ||
    l === r.db.LINETYPE.BIDIRECTIONAL_DOTTED ||
    l === r.db.LINETYPE.SOLID_TOP_DOTTED ||
    l === r.db.LINETYPE.SOLID_BOTTOM_DOTTED ||
    l === r.db.LINETYPE.STICK_TOP_DOTTED ||
    l === r.db.LINETYPE.STICK_BOTTOM_DOTTED ||
    ...
    let I = "";
    if (
      (h.arrowMarkerAbsolute && (I = pr(!0)),
      _.attr("stroke-width", 2),
      _.attr("stroke", "none"),
      _.style("fill", "none"),
      (l === r.db.LINETYPE.SOLID_TOP || l === r.db.LINETYPE.SOLID_TOP_DOTTED) &&
        _.attr("marker-end", "url(" + I + "#" + n + "-solidTopArrowHead)"),
      (l === r.db.LINETYPE.SOLID_BOTTOM || l === r.db.LINETYPE.SOLID_BOTTOM_DOTTED) &&
        _.attr("marker-end", "url(" + I + "#" + n + "-solidBottomArrowHead)"),
      (l === r.db.LINETYPE.STICK_TOP || l === r.db.LINETYPE.STICK_TOP_DOTTED) &&
        _.attr("marker-end", "url(" + I + "#" + n + "-stickTopArrowHead)"),
      (l === r.db.LINETYPE.STICK_BOTTOM || l === r.db.LINETYPE.STICK_BOTTOM_DOTTED) &&
        _.attr("marker-end", "url(" + I + "#" + n + "-stickBottomArrowHead)"),
      (l === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE || l === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) &&
      ...
      (l === r.db.LINETYPE.SOLID || l === r.db.LINETYPE.DOTTED) &&
        _.attr("marker-end", "url(" + I + "#" + n + "-arrowhead)"),
      (l === r.db.LINETYPE.BIDIRECTIONAL_SOLID || l === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) &&
        (_.attr("marker-start", "url(" + I + "#" + n + "-arrowhead)"),
        _.attr("marker-end", "url(" + I + "#" + n + "-arrowhead)")),
      (l === r.db.LINETYPE.SOLID_POINT || l === r.db.LINETYPE.DOTTED_POINT) &&
        _.attr("marker-end", "url(" + I + "#" + n + "-filled-head)"),
      (l === r.db.LINETYPE.SOLID_CROSS || l === r.db.LINETYPE.DOTTED_CROSS) &&
        _.attr("marker-end", "url(" + I + "#" + n + "-crosshead)"),
      u || h.showSequenceNumbers)
    ) {
      const L = l === r.db.LINETYPE.BIDIRECTIONAL_SOLID || l === r.db.LINETYPE.BIDIRECTIONAL_DOTTED,
        b =
          l === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE ||
          l === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED ||
          l === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE ||
          l === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED ||
          l === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE ||
          l === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED ||
          l === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE ||
          l === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED,
        m = 6,
        w = $t(i, r);
      let S = s,
      ...
      (V
        ? (M = t.fromBounds + 1)
        : b
          ? (M = U ? t.toBounds - 1 : t.fromBounds + 1)
          : (M = U ? t.fromBounds + 1 : t.toBounds - 1),
        e
          .append("line")
          .attr("x1", M)
          .attr("y1", a)
  ...
  ta = g(function (e, t, a, r, i, n, s) {
    ...
    for (const x of r) {
      const u = t.get(x),
        O = u.box;
      (d && d != O && (s || R.models.addBox(d), (E += h.boxMargin + d.margin)),
        O && O != d && (s || ((O.x = c + E), (O.y = i)), (E += O.margin)),
        (u.width = P.getMax(u.width || h.width, h.width)),
        (u.height = P.getMax(u.height || h.height, h.height)),
        (u.margin = u.margin || h.actorMargin),
        (l = P.getMax(l, u.height)),
        a.get(u.name) && (E += u.width / 2),
        (u.x = c + E),
        (u.starty = R.getVerticalPos()),
        R.insert(u.x, i, u.x + u.width, u.height),
        (c += u.width + E),
        u.box && (u.box.width = c + O.margin - u.box.x),
        (E = u.margin),
        (d = u.box),
        R.models.addActor(u));
    }
    (d && !s && R.models.addBox(d), R.bumpVerticalPos(l));
  }, "addActorRenderingData"),
  ee = g(async function (e, t, a, r, i, n, s) {
    if (r) {
      let c = 0;
      ...
      for (const E of a) {
        ...
        const l = await H.drawActor(e, d, h, !0, i, n, s);
        c = P.getMax(c, l);
      }
      R.bumpVerticalPos(c + h.boxMargin);
    } else
      for (const c of a) {
        const E = t.get(c);
        await H.drawActor(e, E, h, !1, i, n, s);
      }
  }, "drawActors"),
  qe = g(function (e, t, a, r) {
    let i = 0,
      n = 0;
    for (const s of a) {
      const c = t.get(s),
        E = ra(c),
        d = H.drawPopup(e, c, E, h, h.forceMenus, r);
      (d.height > i && (i = d.height), d.width + c.x > n && (n = d.width + c.x));
    }
    return { maxHeight: i, maxWidth: n };
  }, "drawActorsPopup"),
  ze = g(function (e) {
    (ar(h, e),
      e.fontFamily && (h.actorFontFamily = h.noteFontFamily = h.messageFontFamily = e.fontFamily),
      e.fontSize && (h.actorFontSize = h.noteFontSize = h.messageFontSize = e.fontSize),
      e.fontWeight && (h.actorFontWeight = h.noteFontWeight = h.messageFontWeight = e.fontWeight));
  }, "setConf"),
  qt = g(function (e) {
  ...
  Ce = g(function (e, t) {
    const a = t.get(e),
      ...
      i = r.reduce(
        function (s, c) {
          return P.getMin(s, c.startx);
        },
        a.x + a.width / 2 - 1
      ),
      n = r.reduce(
        function (s, c) {
          return P.getMax(s, c.stopx);
        },
        a.x + a.width / 2 + 1
      );
    return [i, n];
...
function ht(e, t, a, r, i) {
  ...
  if (t.id && t.message && e[t.id]) {
    const s = e[t.id].width,
      c = Rt(h);
    ((t.message = Z.wrapLabel(`[${t.message}]`, s - 2 * h.wrapPadding, c)), (t.width = s), (t.wrap = !0));
    const E = Z.calculateTextDimensions(t.message, c),
      d = P.getMax(E.height, h.labelBoxHeight);
    ((n = r + d), st.debug(`${d} - ${t.message}`));
  }
...
function Ue(e, t, a, r, i, n, s) {
  function c(l, x) {
    l.x < i.get(e.from).x
      ? (R.insert(t.stopx - x, t.starty, t.startx, t.stopy + l.height / 2 + h.noteMargin), (t.stopx = t.stopx + x))
      : (R.insert(t.startx, t.starty, t.stopx + x, t.stopy + l.height / 2 + h.noteMargin), (t.stopx = t.stopx - x));
  }
  g(c, "receiverAdjustment");
  function E(l, x) {
    l.x < i.get(e.to).x
      ? (R.insert(t.startx - x, t.starty, t.stopx, t.stopy + l.height / 2 + h.noteMargin), (t.startx = t.startx + x))
      : (R.insert(t.stopx, t.starty, t.startx + x, t.stopy + l.height / 2 + h.noteMargin), (t.startx = t.startx - x));
  }
  g(E, "senderAdjustment");
  const d = [Yt.ACTOR, Yt.CONTROL, Yt.ENTITY, Yt.DATABASE];
  if (n.get(e.to) == r) {
    const l = i.get(e.to),
      x = d.includes(l.type) ? It / 2 + 3 : l.width / 2 + 3;
    (c(l, x), (l.starty = a - l.height / 2), R.bumpVerticalPos(l.height / 2));
  } else if (s.get(e.from) == r) {
    const l = i.get(e.from);
    if (h.mirrorActors) {
      const x = d.includes(l.type) ? It / 2 : l.width / 2;
      E(l, x);
    }
    ((l.stopy = a - l.height / 2), R.bumpVerticalPos(l.height / 2));
  } else if (s.get(e.to) == r) {
    const l = i.get(e.to);
    if (h.mirrorActors) {
      const x = d.includes(l.type) ? It / 2 + 3 : l.width / 2 + 3;
      c(l, x);
    }
    ((l.stopy = a - l.height / 2), R.bumpVerticalPos(l.height / 2));
  }
...
var ea = g(async function (e, t, a, r) {
  const { securityLevel: i, sequence: n, look: s } = j();
  h = n;
  let c;
  i === "sandbox" && (c = Bt("#i" + t));
  const E = i === "sandbox" ? Bt(c.nodes()[0].contentDocument.body) : Bt("body"),
    d = i === "sandbox" ? c.nodes()[0].contentDocument : document;
  (R.init(), st.debug(r.db));
  const l = i === "sandbox" ? E.select(`[id="${t}"]`) : Bt(`[id="${t}"]`),
    x = r.db.getActors(),
    u = r.db.getCreatedActors(),
    O = r.db.getDestroyedActors(),
    p = r.db.getBoxes();
  let f = r.db.getActorKeys();
  const _ = r.db.getMessages(),
    I = r.db.getDiagramTitle(),
    L = r.db.hasAtLeastOneBox(),
    b = r.db.hasAtLeastOneBoxWithTitle(),
    m = await Ge(x, _, r);
  if (
    ((h.height = await Xe(x, m, p)),
    H.insertComputerIcon(l, t),
    H.insertDatabaseIcon(l, t),
    H.insertClockIcon(l, t),
    L && (R.bumpVerticalPos(h.boxMargin), b && R.bumpVerticalPos(p[0].textMaxHeight)),
    h.hideUnusedParticipants === !0)
  ) {
    const A = new Set();
    (_.forEach((D) => {
      (A.add(D.from), A.add(D.to));
    }),
      (f = f.filter((D) => A.has(D))));
  }
  const w = new Map(
    f.map((A, D) => {
      var et;
      return [((et = x.get(A)) == null ? void 0 : et.name) ?? A, D];
    })
  );
  ta(l, x, u, f, 0, _, !1);
  const S = await ca(_, x, m, r);
  (H.insertArrowHead(l, t),
    H.insertArrowCrossHead(l, t),
    H.insertArrowFilledHead(l, t),
    H.insertSequenceNumber(l, t),
    H.insertSolidTopArrowHead(l, t),
    H.insertSolidBottomArrowHead(l, t),
    H.insertStickTopArrowHead(l, t),
    H.insertStickBottomArrowHead(l, t),
    s === "neo" && H.insertDropShadow(l, h));
  function Y(A, D) {
    const et = R.endActivation(A);
    (et.starty + 18 > D && ((et.starty = D - 6), (D += 12)),
      H.drawActivation(l, et, D, h, qt(A.from).length, r, w),
      R.insert(et.startx, D - 10, et.stopx, D));
  }
  g(Y, "activeEnd");
  let M = 1,
    V = 1;
  ...
  for (const A of _) {
    ...
    switch (A.type) {
      case r.db.LINETYPE.NOTE:
        (R.resetVerticalPos(), (et = A.noteModel), await $r(l, et, A.id));
        break;
      case r.db.LINETYPE.ACTIVE_START:
        R.newActivation(A, l, x);
        break;
      ...
      case r.db.LINETYPE.ACTIVE_END:
        Y(A, R.getVerticalPos());
        break;
      case r.db.LINETYPE.LOOP_START:
        ht(S, A, h.boxMargin, h.boxMargin + h.boxTextMargin, (K) => R.newLoop(K));
        break;
      case r.db.LINETYPE.LOOP_END:
        ((D = R.endLoop()),
          await H.drawLoop(l, D, "loop", h, A),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      case r.db.LINETYPE.RECT_START:
        ht(S, A, h.boxMargin, h.boxMargin, (K) => R.newLoop(void 0, K.message));
        break;
      ...
      case r.db.LINETYPE.ALT_ELSE:
        ht(S, A, h.boxMargin + h.boxTextMargin, h.boxMargin, (K) => R.addSectionToLoop(K));
        break;
      case r.db.LINETYPE.ALT_END:
        ((D = R.endLoop()),
          await H.drawLoop(l, D, "alt", h, A),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      case r.db.LINETYPE.PAR_START:
      case r.db.LINETYPE.PAR_OVER_START:
        (ht(S, A, h.boxMargin, h.boxMargin + h.boxTextMargin, (K) => R.newLoop(K)), R.saveVerticalPos());
        break;
      ...
      case r.db.LINETYPE.AUTONUMBER:
        ((M = A.message.start || M),
          (V = A.message.step || V),
          A.message.visible ? r.db.enableSequenceNumbers() : r.db.disableSequenceNumbers());
        break;
      ...
      case r.db.LINETYPE.CRITICAL_END:
        ((D = R.endLoop()),
          await H.drawLoop(l, D, "critical", h, A),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      ...
      case r.db.LINETYPE.BREAK_END:
        ((D = R.endLoop()),
          await H.drawLoop(l, D, "break", h, A),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      default:
        try {
          ((rt = A.msgModel),
            (rt.starty = R.getVerticalPos()),
            (rt.sequenceIndex = M),
            (rt.sequenceVisible = r.db.showSequenceNumbers()),
            (rt.id = A.id),
            (rt.from = A.from),
            (rt.to = A.to));
          const K = await He(l, rt);
          (Ue(A, rt, K, X, x, u, O), U.push({ messageModel: rt, lineStartY: K, msg: A }), R.models.addMessage(rt));
        } catch (K) {
          st.error("error while drawing message", K);
        }
    }
    ([
    ...
    ].includes(A.type) && (M = M + V),
      X++);
  }
  (st.debug("createdActors", u), st.debug("destroyedActors", O), await ee(l, x, f, !1, t, r, w));
  for (const A of U) await jr(l, A.messageModel, A.lineStartY, r, A.msg, t);
  (h.mirrorActors && (await ee(l, x, f, !0, t, r, w)), G.forEach((A) => H.drawBackgroundRect(l, A)), We(l, x, f, h));
  for (const A of R.models.boxes) {
    ((A.height = R.getVerticalPos() - A.y), R.insert(A.x, A.y, A.x + A.width, A.height));
    const D = h.boxMargin * 2;
    ((A.startx = A.x - D),
      (A.starty = A.y - D * 0.25),
      (A.stopx = A.startx + A.width + 2 * D),
      (A.stopy = A.starty + A.height + D * 0.75),
      (A.stroke = "rgb(0,0,0, 0.5)"),
      H.drawBox(l, A, h));
  }
  L && R.bumpVerticalPos(h.boxMargin);
  const Q = qe(l, x, f, d),
    { bounds: q } = R.getBounds();
  (q.startx === void 0 && (q.startx = 0),
    q.starty === void 0 && (q.starty = 0),
    q.stopx === void 0 && (q.stopx = 0),
    q.stopy === void 0 && (q.stopy = 0));
  let it = q.stopy - q.starty;
  it < Q.maxHeight && (it = Q.maxHeight);
  let tt = it + 2 * h.diagramMarginY;
  h.mirrorActors && (tt = tt - h.boxMargin + h.bottomMarginAdj);
  let nt = q.stopx - q.startx;
  nt < Q.maxWidth && (nt = Q.maxWidth);
  const W = nt + 2 * h.diagramMarginX;
  (I &&
    l
      .append("text")
      .text(I)
      .attr("x", (q.stopx - q.startx) / 2 - 2 * h.diagramMarginX)
      .attr("y", -25),
    rr(l, tt, W, h.useMaxWidth));
  const C = I ? 40 : 0,
    Pt = x.size && s === "neo" ? 30 : 0;
  (l.attr("viewBox", q.startx - h.diagramMarginX + " -" + (h.diagramMarginY + C) + " " + W + " " + (tt + C + Pt)),
    st.debug("models:", R.models));
}, "draw");
  ...
  for (const i of t)
    if (e.get(i.to) && e.get(i.from)) {
      ...
      const s = i.placement !== void 0,
        c = !s,
        E = s ? Lt(h) : Rt(h),
        d = i.wrap ? Z.wrapLabel(i.message, h.width - 2 * h.wrapPadding, E) : i.message,
        x = ($(d) ? await mt(i.message, j()) : Z.calculateTextDimensions(d, E)).width + 2 * h.wrapPadding;
      c && i.from === n.nextActor
        ? (r[i.to] = P.getMax(r[i.to] || 0, x))
        : c && i.from === n.prevActor
          ? (r[i.from] = P.getMax(r[i.from] || 0, x))
          : c && i.from === i.to
            ? ((r[i.from] = P.getMax(r[i.from] || 0, x / 2)), (r[i.to] = P.getMax(r[i.to] || 0, x / 2)))
            : i.placement === a.db.PLACEMENT.RIGHTOF
              ? (r[i.from] = P.getMax(r[i.from] || 0, x))
              : i.placement === a.db.PLACEMENT.LEFTOF
                ? (r[n.prevActor] = P.getMax(r[n.prevActor] || 0, x))
                : i.placement === a.db.PLACEMENT.OVER &&
                  (n.prevActor && (r[n.prevActor] = P.getMax(r[n.prevActor] || 0, x / 2)),
                  n.nextActor && (r[i.from] = P.getMax(r[i.from] || 0, x / 2)));
    }
  return (st.debug("maxMessageWidthPerActor:", r), r);
}
...
var ra = g(function (e) {
  ...
  for (const r in e.links) {
    const n = Z.calculateTextDimensions(r, a).width + 2 * h.wrapPadding + 2 * h.boxMargin;
    t < n && (t = n);
  }
  return t;
...
async function Xe(e, t, a) {
  ...
  for (const n of e.keys()) {
    const s = e.get(n);
    s.wrap && (s.description = Z.wrapLabel(s.description, h.width - 2 * h.wrapPadding, te(h)));
    const c = $(s.description) ? await mt(s.description, j()) : Z.calculateTextDimensions(s.description, te(h));
    ((s.width = s.wrap ? h.width : P.getMax(h.width, c.width + 2 * h.wrapPadding)),
      (s.height = s.wrap ? P.getMax(c.height, h.height) : h.height),
      (r = P.getMax(r, s.height)));
  }
  for (const n in t) {
    const s = e.get(n);
    if (!s) continue;
    const c = e.get(s.nextActor);
    if (!c) {
      const x = t[n] + h.actorMargin - s.width / 2;
      s.margin = P.getMax(x, h.actorMargin);
      continue;
    }
    const d = t[n] + h.actorMargin - s.width / 2 - c.width / 2;
  ...
  return (
    a.forEach((n) => {
      const s = Rt(h);
      let c = n.actorKeys.reduce((x, u) => (x += e.get(u).width + (e.get(u).margin || 0)), 0);
      const E = h.boxMargin * 8;
      ((c += E), (c -= 2 * h.boxTextMargin), n.wrap && (n.name = Z.wrapLabel(n.name, c - 2 * h.wrapPadding, s)));
      const d = Z.calculateTextDimensions(n.name, s);
      i = P.getMax(d.height, i);
      const l = P.getMax(c, d.width + 2 * h.wrapPadding);
      if (((n.margin = h.boxTextMargin), c < l)) {
        const x = (l - c) / 2;
        n.margin += x;
      }
    }),
...
var aa = g(async function (e, t, a) {
    const r = t.get(e.from),
      ...
      c = e.wrap && e.message;
    let E = $(e.message)
      ? await mt(e.message, j())
      : Z.calculateTextDimensions(c ? Z.wrapLabel(e.message, h.width, Lt(h)) : e.message, Lt(h));
    const d = {
      width: c ? h.width : P.getMax(h.width, E.width + 2 * h.noteMargin),
      height: 0,
      startx: r.x,
      stopx: 0,
      starty: 0,
    ...
    return (
      e.placement === a.db.PLACEMENT.RIGHTOF
        ? ((d.width = c ? P.getMax(h.width, E.width) : P.getMax(r.width / 2 + i.width / 2, E.width + 2 * h.noteMargin)),
          (d.startx = n + (r.width + h.actorMargin) / 2))
        : e.placement === a.db.PLACEMENT.LEFTOF
          ? ((d.width = c
              ? P.getMax(h.width, E.width + 2 * h.noteMargin)
              : P.getMax(r.width / 2 + i.width / 2, E.width + 2 * h.noteMargin)),
            (d.startx = n - d.width + (r.width - h.actorMargin) / 2))
          : e.to === e.from
            ? ((E = Z.calculateTextDimensions(
                c ? Z.wrapLabel(e.message, P.getMax(h.width, r.width), Lt(h)) : e.message,
                Lt(h)
              )),
              (d.width = c ? P.getMax(h.width, r.width) : P.getMax(r.width, h.width, E.width + 2 * h.noteMargin)),
              (d.startx = n + (r.width - d.width) / 2))
            : ((d.width = Math.abs(n + r.width / 2 - (s + i.width / 2)) + h.actorMargin),
              (d.startx = n < s ? n + r.width / 2 - h.actorMargin / 2 : s + i.width / 2 - h.actorMargin / 2)),
      c && (d.message = Z.wrapLabel(e.message, d.width - 2 * h.wrapPadding, Lt(h))),
      st.debug(`NM:[${d.startx},${d.stopx},${d.starty},${d.stopy}:${d.width},${d.height}=${e.message}]`),
      d
    );
  }, "buildNoteModel"),
  sa = 4,
  ...
  ia = g(function (e, t, a) {
    ...
    let c = 0;
    return (
      (e.centralConnection === r || e.centralConnection === i) && (c += sa),
      (e.centralConnection === r || e.centralConnection === i) && (e.type === n || e.type === s) && (c += a ? 0 : -6),
      c
    );
  ...
  Je = g(function (e, t) {
    const {
      ...
      STICK_ARROW_TOP_REVERSE_DOTTED: c,
      STICK_ARROW_BOTTOM_REVERSE: E,
      STICK_ARROW_BOTTOM_REVERSE_DOTTED: d,
    } = t.db.LINETYPE;
    return [a, r, i, n, s, c, E, d].includes(e.type);
  }, "isReverseArrowType"),
  na = g(function (e, t) {
  ...
  oa = g(function (e, t, a) {
    ...
    let d = E ? n : i,
      l = E ? s : c;
    (r === "neo" &&
      (e.type !== a.db.LINETYPE.SOLID_OPEN && (l += E ? -3 : 3),
      (e.type === a.db.LINETYPE.BIDIRECTIONAL_SOLID || e.type === a.db.LINETYPE.BIDIRECTIONAL_DOTTED) &&
        (d += E ? 3 : -3)),
      (d += ia(e, a, E)));
    const x = Math.abs(s - c) > 2,
      u = g((_) => (E ? -_ : _), "adjustValue");
    e.from === e.to
      ? (l = d)
      : (e.activate && !x && (l += u(h.activationWidth / 2 - 1)),
        [
          a.db.LINETYPE.SOLID_OPEN,
          a.db.LINETYPE.DOTTED_OPEN,
          a.db.LINETYPE.STICK_TOP,
    ...
    const O = [i, n, s, c],
      p = Math.abs(d - l);
    e.wrap && e.message && (e.message = Z.wrapLabel(e.message, P.getMax(p + 2 * h.wrapPadding, h.width), Rt(h)));
    const f = Z.calculateTextDimensions(e.message, Rt(h));
    return {
      width: P.getMax(e.wrap ? 0 : f.width + 2 * h.wrapPadding, p + 2 * h.wrapPadding, h.width),
      height: 0,
      startx: d,
      stopx: l,
      starty: 0,
  ...
  ca = g(async function (e, t, a, r) {
    ...
    for (const d of e) {
      switch (d.type) {
        ...
        case r.db.LINETYPE.CRITICAL_START:
        case r.db.LINETYPE.BREAK_START:
          n.push({ id: d.id, msg: d.message, from: Number.MAX_SAFE_INTEGER, to: Number.MIN_SAFE_INTEGER, width: 0 });
          break;
        case r.db.LINETYPE.ALT_ELSE:
        case r.db.LINETYPE.PAR_AND:
        case r.db.LINETYPE.CRITICAL_OPTION:
        ...
        case r.db.LINETYPE.ACTIVE_START:
          {
            const x = t.get(d.from ? d.from : d.to.actor),
              u = qt(d.from ? d.from : d.to.actor).length,
              O = x.x + x.width / 2 + ((u - 1) * h.activationWidth) / 2,
              p = { startx: O, stopx: O + h.activationWidth, actor: d.from, enabled: !0 };
      ...
      d.placement !== void 0
        ? ((c = await aa(d, t, r)),
          ...
          n.forEach((x) => {
            ((s = x),
              (s.from = P.getMin(s.from, c.startx)),
              (s.to = P.getMax(s.to, c.startx + c.width)),
              (s.width = P.getMax(s.width, Math.abs(s.from - s.to)) - h.labelBoxWidth));
          }))
        : ((E = oa(d, t, r)),
          (d.msgModel = E),
          E.startx &&
            ...
            n.forEach((x) => {
              if (((s = x), E.startx === E.stopx)) {
                const u = t.get(d.from),
                  O = t.get(d.to);
                ((s.from = P.getMin(u.x - E.width / 2, u.x - u.width / 2, s.from)),
                  (s.to = P.getMax(O.x + E.width / 2, O.x + u.width / 2, s.to)),
                  (s.width = P.getMax(s.width, Math.abs(s.to - s.from)) - h.labelBoxWidth));
              } else
                ((s.from = P.getMin(E.startx, s.from)),
                  (s.to = P.getMax(E.stopx, s.to)),
                  (s.width = P.getMax(s.width, E.width) - h.labelBoxWidth));
            }));
    }
    return ((R.activations = []), st.debug("Loop type widths:", i), i);
  }, "calculateLoopBounds"),
  la = { bounds: R, drawActors: ee, drawActorsPopup: qe, setConf: ze, draw: ea },
  Ea = {
    parser: _r,
    get db() {
      return new yr();
