function f(e) {
  for (var t = {}, n = e.split(","), r = 0; r < n.length; ++r) {
    var i = n[r].toUpperCase(),
      l = n[r].charAt(0).toUpperCase() + n[r].slice(1);
    ((t[n[r]] = !0), (t[i] = !0), (t[l] = !0));
  }
  return t;
}
...
var k = f("null"),
  ...
  v = f("architecture,entity,begin,case,port,else,elsif,end,for,function,if"),
  d = /[&|~><!\)\(*#%@+\/=?\:;}{,\.\^\-\[\]]/,
  o;
function c(e, t) {
  var n = e.next();
  ...
  e.eatWhile(/[\w\$_]/);
  var i = e.current();
  return y.propertyIsEnumerable(i.toLowerCase())
    ? (v.propertyIsEnumerable(i) && (o = "newstatement"), "keyword")
...
const w = {
  ...
  startState: function (e) {
    return { tokenize: null, context: new h(-e, 0, "top", !1), indented: 0, startOfLine: !0 };
  },
  token: function (e, t) {
    var n = t.context;
    if (
    ...
    if ((n.align == null && (n.align = !0), (o == ";" || o == ":") && n.type == "statement")) u(t);
      ...
      o == n.type
        ? u(t)
        : (n.type == "}" || n.type == "top" || (n.type == "statement" && o == "newstatement")) &&
  ...
  indent: function (e, t, n) {
    ...
    return i.type == "statement"
      ? i.indented + (r == "{" ? 0 : n.unit)
      : i.align
        ? i.column + (l ? 0 : 1)
        : i.indented + (l ? 0 : n.unit);
  },
