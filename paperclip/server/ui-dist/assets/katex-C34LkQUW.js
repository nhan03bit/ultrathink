class S extends Error {
  constructor(e, t) {
    ...
    if (u && u.start <= u.end) {
      ...
      ((n = u.start),
        (l = u.end),
        n === h.length ? (a += " at end of input: ") : (a += " at position " + (n + 1) + ": "));
      var c = h.slice(n, l).replace(/[^]/g, "$&̲"),
        v;
      n > 15 ? (v = "…" + h.slice(n - 15, n)) : (v = h.slice(0, n));
      var g;
      (l + 15 < h.length ? (g = h.slice(l, l + 15) + "…") : (g = h.slice(l)), (a += v + c + g));
    }
    (super(a),
      (this.name = "ParseError"),
      Object.setPrototypeOf(this, S.prototype),
      (this.position = n),
      n != null && l != null && (this.length = l - n),
      (this.rawMessage = e));
  }
}
var I1 = /([A-Z])/g,
  Tt = (r) => r.replace(I1, "-$1").toLowerCase(),
  N1 = { "&": "&amp;", ">": "&gt;", "<": "&lt;", '"': "&quot;", "'": "&#x27;" },
  O1 = /[&><"']/g,
  n0 = (r) => String(r).replace(O1, (e) => N1[e]),
  De = (r) =>
    r.type === "ordgroup" || r.type === "color"
      ...
      : r.type === "font"
        ? De(r.body)
        : r,
  H1 = new Set(["mathord", "textord", "atom"]),
  C0 = (r) => H1.has(De(r).type),
  F1 = (r) => {
...
class Bt {
  ...
  useStrictBehavior(e, t, a) {
    ...
    return !n || n === "ignore" ? !1 : n === !0 || n === "error" ? !0 : (typeof console < "u", !1);
  }
  isTrusted(e) {
...
class O0 {
  ...
  sup() {
    return w0[P1[this.id]];
  }
  sub() {
    return w0[G1[this.id]];
  }
  fracNum() {
    return w0[U1[this.id]];
  }
  fracDen() {
    return w0[V1[this.id]];
  }
  cramp() {
    return w0[X1[this.id]];
  }
  text() {
    return w0[Y1[this.id]];
  }
  isTight() {
    return this.size >= 2;
  }
...
var Dt = 0,
  ...
  P1 = [he, g0, he, g0, ee, u0, ee, u0],
  G1 = [g0, g0, g0, g0, u0, u0, u0, u0],
  U1 = [_0, B0, he, g0, ee, u0, ee, u0],
  V1 = [B0, B0, g0, g0, u0, u0, u0, u0],
  X1 = [qe, qe, B0, B0, g0, g0, u0, u0],
  Y1 = [Dt, qe, _0, B0, _0, B0, _0, B0],
  N = { DISPLAY: w0[Dt], TEXT: w0[_0], SCRIPT: w0[he], SCRIPTSCRIPT: w0[ee] },
  ft = [
    {
      name: "latin",
      blocks: [
...
function W1(r) {
  for (var e = 0; e < ft.length; e++)
    for (var t = ft[e], a = 0; a < t.blocks.length; a++) {
      var n = t.blocks[a];
...
var Ce = [];
ft.forEach((r) => r.blocks.forEach((e) => Ce.push(...e)));
function Cr(r) {
  for (var e = 0; e < Ce.length; e += 2) if (r >= Ce[e] && r <= Ce[e + 1]) return !0;
  return !1;
}
var r0 = (r) => r + " " + r,
  Q0 = 80,
...
219 661 l218 661zM702 ` +
  ...
  ta = function (e, t) {
    switch (e) {
      case "⎜":
        return r0("M291 0 H417 V" + t + " H291z");
      case "∣":
        return r0("M145 0 H188 V" + t + " H145z");
      case "∥":
        return r0("M145 0 H188 V" + t + " H145z") + r0("M367 0 H410 V" + t + " H367z");
      case "⎟":
        return r0("M457 0 H583 V" + t + " H457z");
      case "⎢":
        return r0("M319 0 H403 V" + t + " H319z");
      case "⎥":
        return r0("M263 0 H347 V" + t + " H263z");
      case "⎪":
        return r0("M384 0 H504 V" + t + " H384z");
      case "⏐":
        return r0("M312 0 H355 V" + t + " H312z");
      case "‖":
        return r0("M257 0 H300 V" + t + " H257z") + r0("M478 0 H521 V" + t + " H478z");
      default:
        return "";
    }
  },
...
-68.7 15.7-86 37-10 12-15 25.3-15 40 0 22.7 9.8 40.7 29.5 54 19.7 13.3 43.5 21
 71.5 23h399859zM103 281v-40h399897v40z`,
    leftlinesegment: r0("M40 281 V428 H0 V94 H40 V241 H400000 v40z"),
    leftbracketunder: r0("M0 0 h120 V290 H399995 v120 H0z"),
    leftbracketover: r0("M0 440 h120 V150 H399995 v-120 H0z"),
    leftmapsto: r0("M40 281 V448H0V74H40V241H400000v40z"),
    leftToFrom: `M0 147h400000v40H0zm0 214c68 40 115.7 95.7 143 167h22c15.3 0 23
-.3 23-1 0-1.3-5.3-13.7-16-37-18-35.3-41.3-69-70-101l-7-8h399905v-40H95l7-8
c28.7-32 52-65.7 70-101 10.7-23.3 16-35.7 16-37 0-.7-7.7-1-23-1h-22C115.7 265.3
 68 321 0 361zm0-174v-40h399900v40zm100 154v40h399900v-40z`,
    longequal: r0("M0 50 h400000 v40H0z m0 194h40000v40H0z"),
...
-13.3 8.7-20 26-20 38 0 71 11.2 99 33.5 0 0 7 5.6 21 16.7 14 11.2 21 33.5 21
 66.8s-14 61.2-42 83.5c-28 22.3-61 33.5-99 33.5L0 241z M0 281v-40h399859v40z`,
    rightlinesegment: r0("M399960 241 V94 h40 V428 h-40 V281 H0 v-40z"),
    rightbracketunder: r0("M399995 0 h-120 V290 H0 v120 H400000z"),
    rightbracketover: r0("M399995 440 h-120 V150 H0 v-120 H399995z"),
...
var vt = {
  ...
  aa = { ex: !0, em: !0, mu: !0 },
  qr = function (e) {
    return (typeof e != "string" && (e = e.unit), e in vt || e in aa || e === "ex");
  },
  Z = function (e, t) {
    var a;
    if (e.unit in vt) a = vt[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
  ...
  Rr = function (e) {
    ...
    for (var l = 0; l < this.children.length; l++) t.appendChild(this.children[l].toNode());
    return t;
  },
  na = /[\s"'>/=\x00-\x1f]/,
  Ir = function (e) {
    var t = "<" + e;
    this.classes.length && (t += ' class="' + n0(F0(this.classes)) + '"');
    var a = "";
    for (var n of Object.keys(this.style)) a += Tt(n) + ":" + this.style[n] + ";";
    a && (t += ' style="' + n0(a) + '"');
    for (var l of Object.keys(this.attributes)) {
      if (na.test(l)) throw new S("Invalid attribute name '" + l + "'");
      t += " " + l + '="' + n0(this.attributes[l]) + '"';
    }
    t += ">";
...
class ia {
  ...
  toMarkup() {
    var e = '<img src="' + n0(this.src) + '"' + (' alt="' + n0(this.alt) + '"'),
      t = "";
    for (var a of Object.keys(this.style)) t += Tt(a) + ":" + this.style[a] + ";";
    return (t && (e += ' style="' + n0(t) + '"'), (e += "'/>"), e);
  }
}
var la = { î: "ı̂", ï: "ı̈", í: "ı́", ì: "ı̀" };
class f0 {
  constructor(e, t, a, n, l, u, h, c) {
    ((this.text = e),
      ...
      (this.style = c || {}),
      (this.maxFontSize = 0));
    var v = W1(this.text.charCodeAt(0));
    (v && this.classes.push(v + "_fallback"), /[îïíì]/.test(this.text) && (this.text = la[this.text]));
  }
  hasClass(e) {
    return this.classes.includes(e);
  }
  toNode() {
    var e = document.createTextNode(this.text),
      t = null;
    (this.italic > 0 && ((t = document.createElement("span")), (t.style.marginRight = M(this.italic))),
      this.classes.length > 0 && ((t = t || document.createElement("span")), (t.className = F0(this.classes))));
  ...
  toMarkup() {
    var e = !1,
      t = "<span";
    this.classes.length && ((e = !0), (t += ' class="'), (t += n0(F0(this.classes))), (t += '"'));
    var a = "";
    this.italic > 0 && (a += "margin-right:" + M(this.italic) + ";");
    for (var n of Object.keys(this.style)) a += Tt(n) + ":" + this.style[n] + ";";
    a && ((e = !0), (t += ' style="' + n0(a) + '"'));
    var l = n0(this.text);
...
class D0 {
  ...
  toMarkup() {
    ...
    for (var t of Object.keys(this.attributes)) e += " " + t + '="' + n0(this.attributes[t]) + '"';
    e += ">";
...
class L0 {
  ...
  toMarkup() {
    return this.alternate ? '<path d="' + n0(this.alternate) + '"/>' : '<path d="' + n0(Qt[this.pathName]) + '"/>';
  }
}
class pt {
  constructor(e) {
...
var oa = (r) => r instanceof ne || r instanceof Oe || r instanceof ae,
  k0 = {
    "AMS-Regular": {
      32: [0, 0, 0, 0, 0.25],
...
function Ct(r, e, t) {
  ...
  var a = r.charCodeAt(0),
    n = k0[e][a];
  if (
    (!n && r[0] in _t && ((a = _t[r[0]].charCodeAt(0)), (n = k0[e][a])),
    !n && t === "text" && Cr(a) && (n = k0[e][77]),
    n)
  )
...
function ma(r) {
  var e;
  if ((r >= 5 ? (e = 0) : r >= 3 ? (e = 1) : (e = 2), !Je[e])) {
    var t = (Je[e] = { cssEmPerMu: xe.quad[e] / 18 });
    for (var a in xe) xe.hasOwnProperty(a) && (t[a] = xe[a][e]);
  }
  return Je[e];
}
var ca = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  da = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
  J = { math: {}, text: {} };
function i(r, e, t, a, n, l) {
  ((J[r][n] = { font: e, group: t, replace: a }), l && a && (J[r][a] = J[r][n]));
}
var s = "math",
  w = "text",
  o = "main",
...
i(s, o, f, "⋈", "\\bowtie", !0);
i(s, o, f, "⌣", "\\smile", !0);
i(s, o, f, "⊑", "\\sqsubseteq", !0);
i(s, o, f, "⊒", "\\sqsupseteq", !0);
i(s, o, f, "≐", "\\doteq", !0);
i(s, o, f, "⌢", "\\frown", !0);
i(s, o, f, "∋", "\\ni", !0);
i(s, o, f, "∝", "\\propto", !0);
...
i(s, o, p, "‡", "\\ddag");
i(w, o, p, "‡", "\\ddag");
i(w, o, p, "‡", "\\textdaggerdbl");
i(s, o, o0, "⎱", "\\rmoustache", !0);
i(s, o, v0, "⎰", "\\lmoustache", !0);
i(s, o, o0, "⟯", "\\rgroup", !0);
i(s, o, v0, "⟮", "\\lgroup", !0);
i(s, o, D, "∓", "\\mp", !0);
i(s, o, D, "⊖", "\\ominus", !0);
...
i(s, o, D, "⨿", "\\amalg");
i(s, o, D, "&", "\\And");
i(s, o, f, "⟵", "\\longleftarrow", !0);
i(s, o, f, "⇐", "\\Leftarrow", !0);
i(s, o, f, "⟸", "\\Longleftarrow", !0);
i(s, o, f, "⟶", "\\longrightarrow", !0);
i(s, o, f, "⇒", "\\Rightarrow", !0);
i(s, o, f, "⟹", "\\Longrightarrow", !0);
i(s, o, f, "↔", "\\leftrightarrow", !0);
i(s, o, f, "⟷", "\\longleftrightarrow", !0);
i(s, o, f, "⇔", "\\Leftrightarrow", !0);
i(s, o, f, "⟺", "\\Longleftrightarrow", !0);
i(s, o, f, "↦", "\\mapsto", !0);
i(s, o, f, "⟼", "\\longmapsto", !0);
i(s, o, f, "↗", "\\nearrow", !0);
i(s, o, f, "↩", "\\hookleftarrow", !0);
i(s, o, f, "↪", "\\hookrightarrow", !0);
i(s, o, f, "↘", "\\searrow", !0);
i(s, o, f, "↼", "\\leftharpoonup", !0);
i(s, o, f, "⇀", "\\rightharpoonup", !0);
i(s, o, f, "↙", "\\swarrow", !0);
i(s, o, f, "↽", "\\leftharpoondown", !0);
i(s, o, f, "⇁", "\\rightharpoondown", !0);
i(s, o, f, "↖", "\\nwarrow", !0);
i(s, o, f, "⇌", "\\rightleftharpoons", !0);
i(s, d, f, "≮", "\\nless", !0);
i(s, d, f, "", "\\@nleqslant");
i(s, d, f, "", "\\@nleqq");
i(s, d, f, "⪇", "\\lneq", !0);
...
i(s, d, p, "®", "\\circledR");
i(w, d, p, "®", "\\circledR");
i(s, d, p, "∡", "\\measuredangle", !0);
i(s, d, p, "∄", "\\nexists");
i(s, d, p, "℧", "\\mho");
i(s, d, p, "Ⅎ", "\\Finv", !0);
i(s, d, p, "⅁", "\\Game", !0);
i(s, d, p, "‵", "\\backprime");
i(s, d, p, "▲", "\\blacktriangle");
i(s, d, p, "▼", "\\blacktriangledown");
i(s, d, p, "■", "\\blacksquare");
i(s, d, p, "⧫", "\\blacklozenge");
i(s, d, p, "★", "\\bigstar");
i(s, d, p, "∢", "\\sphericalangle", !0);
i(s, d, p, "∁", "\\complement", !0);
i(s, d, p, "ð", "\\eth", !0);
i(w, o, p, "ð", "ð");
i(s, d, p, "╱", "\\diagup");
i(s, d, p, "╲", "\\diagdown");
...
i(s, d, f, "≦", "\\leqq", !0);
i(s, d, f, "⩽", "\\leqslant", !0);
i(s, d, f, "⪕", "\\eqslantless", !0);
i(s, d, f, "≲", "\\lesssim", !0);
i(s, d, f, "⪅", "\\lessapprox", !0);
i(s, d, f, "≊", "\\approxeq", !0);
i(s, d, D, "⋖", "\\lessdot");
i(s, d, f, "⋘", "\\lll", !0);
i(s, d, f, "≶", "\\lessgtr", !0);
i(s, d, f, "⋚", "\\lesseqgtr", !0);
i(s, d, f, "⪋", "\\lesseqqgtr", !0);
i(s, d, f, "≑", "\\doteqdot");
i(s, d, f, "≓", "\\risingdotseq", !0);
i(s, d, f, "≒", "\\fallingdotseq", !0);
i(s, d, f, "∽", "\\backsim", !0);
i(s, d, f, "⋍", "\\backsimeq", !0);
i(s, d, f, "⫅", "\\subseteqq", !0);
i(s, d, f, "⋐", "\\Subset", !0);
i(s, d, f, "⊏", "\\sqsubset", !0);
i(s, d, f, "≼", "\\preccurlyeq", !0);
i(s, d, f, "⋞", "\\curlyeqprec", !0);
i(s, d, f, "≾", "\\precsim", !0);
i(s, d, f, "⪷", "\\precapprox", !0);
...
i(s, d, f, "⋑", "\\Supset", !0);
i(s, d, f, "⊐", "\\sqsupset", !0);
i(s, d, f, "≽", "\\succcurlyeq", !0);
i(s, d, f, "⋟", "\\curlyeqsucc", !0);
i(s, d, f, "≿", "\\succsim", !0);
i(s, d, f, "⪸", "\\succapprox", !0);
...
i(s, d, D, "⋒", "\\Cap", !0);
i(s, d, D, "⋓", "\\Cup", !0);
i(s, d, D, "⩞", "\\doublebarwedge", !0);
i(s, d, D, "⊟", "\\boxminus", !0);
i(s, d, D, "⊞", "\\boxplus", !0);
i(s, d, D, "⋇", "\\divideontimes", !0);
i(s, d, D, "⋉", "\\ltimes", !0);
i(s, d, D, "⋊", "\\rtimes", !0);
i(s, d, D, "⋋", "\\leftthreetimes", !0);
i(s, d, D, "⋌", "\\rightthreetimes", !0);
i(s, d, D, "⋏", "\\curlywedge", !0);
i(s, d, D, "⋎", "\\curlyvee", !0);
i(s, d, D, "⊝", "\\circleddash", !0);
i(s, d, D, "⊛", "\\circledast", !0);
i(s, d, D, "⋅", "\\centerdot");
i(s, d, D, "⊺", "\\intercal", !0);
i(s, d, D, "⋒", "\\doublecap");
i(s, d, D, "⋓", "\\doublecup");
i(s, d, D, "⊠", "\\boxtimes", !0);
i(s, d, f, "⇢", "\\dashrightarrow", !0);
i(s, d, f, "⇠", "\\dashleftarrow", !0);
i(s, d, f, "⇇", "\\leftleftarrows", !0);
i(s, d, f, "⇆", "\\leftrightarrows", !0);
i(s, d, f, "⇚", "\\Lleftarrow", !0);
i(s, d, f, "↞", "\\twoheadleftarrow", !0);
i(s, d, f, "↢", "\\leftarrowtail", !0);
i(s, d, f, "↫", "\\looparrowleft", !0);
i(s, d, f, "⇋", "\\leftrightharpoons", !0);
i(s, d, f, "↶", "\\curvearrowleft", !0);
i(s, d, f, "↺", "\\circlearrowleft", !0);
i(s, d, f, "↰", "\\Lsh", !0);
i(s, d, f, "⇈", "\\upuparrows", !0);
i(s, d, f, "↿", "\\upharpoonleft", !0);
i(s, d, f, "⇃", "\\downharpoonleft", !0);
i(s, o, f, "⊶", "\\origof", !0);
i(s, o, f, "⊷", "\\imageof", !0);
i(s, d, f, "⊸", "\\multimap", !0);
i(s, d, f, "↭", "\\leftrightsquigarrow", !0);
i(s, d, f, "⇉", "\\rightrightarrows", !0);
i(s, d, f, "⇄", "\\rightleftarrows", !0);
i(s, d, f, "↠", "\\twoheadrightarrow", !0);
i(s, d, f, "↣", "\\rightarrowtail", !0);
i(s, d, f, "↬", "\\looparrowright", !0);
i(s, d, f, "↷", "\\curvearrowright", !0);
i(s, d, f, "↻", "\\circlearrowright", !0);
i(s, d, f, "↱", "\\Rsh", !0);
i(s, d, f, "⇊", "\\downdownarrows", !0);
i(s, d, f, "↾", "\\upharpoonright", !0);
i(s, d, f, "⇂", "\\downharpoonright", !0);
i(s, d, f, "⇝", "\\rightsquigarrow", !0);
i(s, d, f, "⇝", "\\leadsto");
i(s, d, f, "⇛", "\\Rrightarrow", !0);
i(s, d, f, "↾", "\\restriction");
i(s, o, p, "‘", "`");
i(s, o, p, "$", "\\$");
i(w, o, p, "$", "\\$");
...
i(s, o, E, "ψ", "\\psi", !0);
i(s, o, E, "ω", "\\omega", !0);
i(s, o, E, "ε", "\\varepsilon", !0);
i(s, o, E, "ϑ", "\\vartheta", !0);
i(s, o, E, "ϖ", "\\varpi", !0);
i(s, o, E, "ϱ", "\\varrho", !0);
i(s, o, E, "ς", "\\varsigma", !0);
i(s, o, E, "φ", "\\varphi", !0);
i(s, o, D, "∗", "*", !0);
i(s, o, D, "+", "+");
i(s, o, D, "−", "-", !0);
...
i(s, o, v0, "{", "\\{");
i(w, o, p, "{", "\\{");
i(w, o, p, "{", "\\textbraceleft");
i(s, o, o0, "}", "\\}");
i(w, o, p, "}", "\\}");
i(w, o, p, "}", "\\textbraceright");
i(s, o, v0, "{", "\\lbrace");
i(s, o, o0, "}", "\\rbrace");
i(s, o, v0, "[", "\\lbrack", !0);
i(w, o, p, "[", "\\lbrack", !0);
...
i(s, o, p, "∥", "\\Vert");
i(w, o, p, "∥", "\\textbardbl");
i(w, o, p, "~", "\\textasciitilde");
i(w, o, p, "\\", "\\textbackslash");
i(w, o, p, "^", "\\textasciicircum");
i(s, o, f, "↑", "\\uparrow", !0);
i(s, o, f, "⇑", "\\Uparrow", !0);
i(s, o, f, "↓", "\\downarrow", !0);
i(s, o, f, "⇓", "\\Downarrow", !0);
i(s, o, f, "↕", "\\updownarrow", !0);
i(s, o, f, "⇕", "\\Updownarrow", !0);
i(s, o, e0, "∐", "\\coprod");
i(s, o, e0, "⋁", "\\bigvee");
i(s, o, e0, "⋀", "\\bigwedge");
...
i(w, o, p, "—", "\\textemdash");
i(w, o, p, "‘", "`", !0);
i(w, o, p, "‘", "\\textquoteleft");
i(w, o, p, "’", "'", !0);
i(w, o, p, "’", "\\textquoteright");
i(w, o, p, "“", "``", !0);
i(w, o, p, "“", "\\textquotedblleft");
i(w, o, p, "”", "''", !0);
i(w, o, p, "”", "\\textquotedblright");
i(s, o, p, "°", "\\degree", !0);
i(w, o, p, "°", "\\degree");
i(w, o, p, "°", "\\textdegree", !0);
i(s, o, p, "£", "\\pounds");
i(s, o, p, "£", "\\mathsterling", !0);
i(w, o, p, "£", "\\pounds");
i(w, o, p, "£", "\\textsterling", !0);
i(s, d, p, "✠", "\\maltese");
i(w, d, p, "✠", "\\maltese");
var er = '0123456789/@."';
for (var Qe = 0; Qe < er.length; Qe++) {
  var tr = er.charAt(Qe);
  i(s, o, p, tr, tr);
}
var rr = '0123456789!@*()-=+";:?/.,';
for (var _e = 0; _e < rr.length; _e++) {
  var ar = rr.charAt(_e);
  i(w, o, p, ar, ar);
}
var Ee = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
for (var et = 0; et < Ee.length; et++) {
  var we = Ee.charAt(et);
  (i(s, o, E, we, we), i(w, o, p, we, we));
}
i(s, d, p, "C", "ℂ");
i(w, d, p, "C", "ℂ");
i(s, d, p, "H", "ℍ");
...
i(w, o, E, "h", "ℎ");
var R = "";
for (var l0 = 0; l0 < Ee.length; l0++) {
  var K = Ee.charAt(l0);
  ((R = String.fromCharCode(55349, 56320 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56372 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56424 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56580 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56684 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56736 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56788 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56840 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    (R = String.fromCharCode(55349, 56944 + l0)),
    i(s, o, E, K, R),
    i(w, o, p, K, R),
    l0 < 26 &&
      ((R = String.fromCharCode(55349, 56632 + l0)),
      i(s, o, E, K, R),
      i(w, o, p, K, R),
      (R = String.fromCharCode(55349, 56476 + l0)),
      i(s, o, E, K, R),
      i(w, o, p, K, R)));
}
R = "𝕜";
...
for (var X0 = 0; X0 < 10; X0++) {
  var H0 = X0.toString();
  ((R = String.fromCharCode(55349, 57294 + X0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R),
    (R = String.fromCharCode(55349, 57314 + X0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R),
    (R = String.fromCharCode(55349, 57324 + X0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R),
    (R = String.fromCharCode(55349, 57334 + X0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R));
}
var gt = "ÐÞþ";
...
var Se = [
  ...
  fa = (r, e) => {
    ...
    if (119808 <= n && n < 120484) {
      ...
      return [Se[u][2], Se[u][l]];
    } else if (120782 <= n && n <= 120831) {
      var h = Math.floor((n - 120782) / 10);
      return [nr[h][2], nr[h][l]];
    } else {
      if (n === 120485 || n === 120486) return [Se[0][2], Se[0][l]];
  ...
  He = function (e, t, a) {
    ...
    return { value: e, metrics: Ct(e, t, a) };
  },
  s0 = function (e, t, a, n, l) {
    var u = He(e, t, a),
      h = u.metrics;
    e = u.value;
    var c;
    if (h) {
      var v = h.italic;
      ((a === "text" || (n && n.font === "mathit")) && (v = 0),
        (c = new f0(e, h.height, h.depth, v, h.skew, h.width, l)));
    } else (typeof console < "u", (c = new f0(e, 0, 0, 0, 0, 0, l)));
    if (n) {
  ...
  qt = function (e, t, a, n) {
    return (
      n === void 0 && (n = []),
      a.font === "boldsymbol" && He(e, "Main-Bold", t).metrics
        ? s0(e, "Main-Bold", t, a, n.concat(["mathbf"]))
        : e === "\\" || J[t][e].font === "main"
          ? s0(e, "Main-Regular", t, a, n)
          : s0(e, "AMS-Regular", t, a, n.concat(["amsrm"]))
    );
  },
  va = function (e, t, a, n, l) {
    return l !== "textord" && He(e, "Math-BoldItalic", t).metrics
  ...
  Fe = function (e, t, a) {
    var n = e.mode,
      ...
      v = "",
      g = "";
    if ((l.charCodeAt(0) === 55349 && ([v, g] = fa(l, n)), v.length > 0)) return s0(l, v, n, t, u.concat(g));
    if (c) {
      var b, y;
      if (c === "boldsymbol") {
        var x = va(l, n, t, u, a);
        ...
        h
          ? ((b = bt[c].fontName), (y = [c]))
          : ((b = ze(c, t.fontWeight, t.fontShape)), (y = [c, t.fontWeight, t.fontShape]));
      if (He(l, b, n).metrics) return s0(l, b, n, t, u.concat(y));
      if (Nr.hasOwnProperty(l) && b.slice(0, 10) === "Typewriter") {
        for (var A = [], T = 0; T < l.length; T++) A.push(s0(l[T], b, n, t, u.concat(y)));
        return E0(A);
      }
    }
    if (a === "mathord") return s0(l, "Math-Italic", n, t, u.concat(["mathnormal"]));
    if (a === "textord") {
      var C = J[n][l] && J[n][l].font;
      if (C === "ams") {
        var q = ze("amsrm", t.fontWeight, t.fontShape);
        return s0(l, q, n, t, u.concat("amsrm", t.fontWeight, t.fontShape));
      } else if (C === "main" || !C) {
        var I = ze("textrm", t.fontWeight, t.fontShape);
        return s0(l, I, n, t, u.concat(t.fontWeight, t.fontShape));
      } else {
        var O = ze(C, t.fontWeight, t.fontShape);
        return s0(l, O, n, t, u.concat(O, t.fontWeight, t.fontShape));
      }
    } else throw new Error("unexpected type: " + a + " in makeOrd");
  },
  pa = (r, e) => {
    if (
      F0(r.classes) !== F0(e.classes) ||
      r.skew !== e.skew ||
  ...
  re = function (e, t) {
    return e instanceof ae ? k([], [e], t) : e;
  },
  ba = function (e) {
    if (e.positionType === "individualShift") {
      for (var t = e.children, a = [t[0]], n = -t[0].shift - t[0].elem.depth, l = n, u = 1; u < t.length; u++) {
        var h = -t[u].shift - l - t[u].elem.depth,
          c = h - (t[u - 1].elem.height + t[u - 1].elem.depth);
        ((l = l + h), a.push({ type: "kern", size: c }), a.push(t[u]));
      }
    ...
    if (e.positionType === "top") {
      ...
      if (e.positionType === "shift") v = -x.elem.depth - e.positionData;
      else if (e.positionType === "firstBaseline") v = -x.elem.depth;
      else throw new Error("Invalid positionType " + e.positionType + ".");
    }
    return { children: e.children, depth: v };
  },
  G = function (e, t) {
    ...
    for (var g = [], b = n, y = n, x = n, A = 0; A < a.length; A++) {
      ...
      if (T.type === "kern") x += T.size;
        ...
        var C = T.elem,
          ...
          I = T.wrapperStyle || {},
          O = k(q, [v, C], void 0, I);
        ((O.style.top = M(-l - x - C.depth)),
          T.marginLeft && (O.style.marginLeft = T.marginLeft),
          T.marginRight && (O.style.marginRight = T.marginRight),
          g.push(O),
          (x += C.height + C.depth));
      }
    ...
    if (b < 0) {
      var L = k([], []),
        P = k(["vlist"], [L]);
      P.style.height = M(-b);
      var W = k(["vlist-s"], [new f0("​")]);
      V = [k(["vlist-r"], [F, W]), k(["vlist-r"], [P])];
    } else V = [k(["vlist-r"], [F])];
    var X = k(["vlist-t"], V);
    return (V.length === 2 && X.classes.push("vlist-t2"), (X.height = y), (X.depth = -b), X);
  },
  Hr = (r, e) => {
    var t = k(["mspace"], [], e),
      a = Z(r, e);
  ...
  A0 = { number: 5, unit: "mu" },
  ya = {
    mord: { mop: j, mbin: Y0, mrel: A0, minner: j },
    mop: { mord: j, mop: j, mrel: A0, minner: j },
    mbin: { mord: Y0, mop: Y0, mopen: Y0, minner: Y0 },
    mrel: { mord: A0, mop: A0, mopen: A0, minner: A0 },
    mopen: {},
    mclose: { mop: j, mbin: Y0, mrel: A0, minner: j },
    mpunct: { mord: j, mop: j, mrel: A0, mopen: j, mclose: j, mpunct: j, minner: j },
    minner: { mord: j, mop: j, mbin: Y0, mrel: A0, mopen: j, mpunct: j, minner: j },
  },
  xa = {
    mord: { mop: j },
    mop: { mord: j, mop: j },
...
function B(r) {
  for (
    var { type: e, names: t, props: a, handler: n, htmlBuilder: l, mathmlBuilder: u } = r,
      h = {
        type: e,
        numArgs: a.numArgs,
        argTypes: a.argTypes,
...
var Ne = function (e) {
  ...
  wa = new Set(["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]),
  ka = new Set(["rightmost", "mrel", "mclose", "mpunct"]),
  Sa = { display: N.DISPLAY, text: N.TEXT, script: N.SCRIPT, scriptscript: N.SCRIPTSCRIPT },
  za = {
    mord: "mord",
    mop: "mop",
    mbin: "mbin",
  ...
  a0 = function (e, t, a, n) {
    ...
    if (e.length === 1) {
      var g = e[0];
      g.type === "sizing" ? (v = t.havingSize(g.size)) : g.type === "styling" && (v = t.havingStyle(Sa[g.style]));
    }
    var b = k([n[0] || "leftmost"], [], t),
      y = k([n[1] || "rightmost"], [], t),
      x = a === "root";
    return (
      yt(
        ...
        (A, T) => {
          var C = T.classes[0],
            q = A.classes[0];
          C === "mbin" && ka.has(q) ? (T.classes[0] = "mord") : q === "mbin" && wa.has(C) && (A.classes[0] = "mord");
        },
        { node: b },
        y,
        x
  ...
  yt = function (e, t, a, n, l) {
    n && e.push(n);
    for (var u = 0; u < e.length; u++) {
      var h = e[u],
        c = Gr(h);
      if (c) {
        yt(c.children, t, a, null, l);
        continue;
      }
      ...
      (v ? (a.node = h) : l && h.hasClass("newline") && (a.node = k(["leftmost"])),
        (a.insertAfter = ((b) => (y) => {
          (e.splice(b + 1, 0, y), u++);
        })(u)));
    }
  ...
  Gr = function (e) {
    return e instanceof ae || e instanceof Oe || (e instanceof ne && e.hasClass("enclosing")) ? e : null;
  },
  xt = function (e, t) {
    var a = Gr(e);
    if (a) {
      var n = a.children;
      if (n.length) {
        if (t === "right") return xt(n[n.length - 1], "right");
        if (t === "left") return xt(n[0], "left");
      }
    }
    return e;
  },
...
function Me(r, e) {
  var t = k(["base"], r, e),
    a = k(["strut"]);
  return (
    (a.style.height = M(t.height + t.depth)),
    t.depth && (a.style.verticalAlign = M(-t.depth)),
...
function kt(r, e) {
  ...
  for (var l = [], u = [], h = 0; h < a.length; h++)
    if ((u.push(a[h]), a[h].hasClass("mbin") || a[h].hasClass("mrel") || a[h].hasClass("allowbreak"))) {
      ...
      c || (l.push(Me(u, e)), (u = []));
    } else a[h].hasClass("newline") && (u.pop(), u.length > 0 && (l.push(Me(u, e)), (u = [])), l.push(a[h]));
  u.length > 0 && l.push(Me(u, e));
  var v;
  t ? ((v = Me(a0(t, e, !0), e)), (v.classes = ["tag"]), l.push(v)) : n && l.push(n);
  var g = k(["katex-html"], l);
  if ((g.setAttribute("aria-hidden", "true"), v)) {
    var b = v.children[0];
  ...
  toMarkup() {
    ...
    for (var t in this.attributes)
      Object.prototype.hasOwnProperty.call(this.attributes, t) &&
        ((e += " " + t + '="'), (e += n0(this.attributes[t])), (e += '"'));
    (this.classes.length > 0 && (e += ' class ="' + n0(F0(this.classes)) + '"'), (e += ">"));
    for (var a = 0; a < this.children.length; a++) e += this.children[a].toMarkup();
...
var Ma = new Set(["\\imath", "\\jmath"]),
  Aa = new Set(["mrow", "mtable"]),
  b0 = function (e, t, a) {
    return (
      J[t][e] &&
        J[t][e].replace &&
        ...
        !(
          Nr.hasOwnProperty(e) &&
          a &&
          ((a.fontFamily && a.fontFamily.slice(4, 6) === "tt") || (a.font && a.font.slice(4, 6) === "tt"))
        ) &&
        (e = J[t][e].replace),
      new _(e)
    );
  ...
  It = function (e, t) {
    ...
    var l = e.text;
    if (Ma.has(l)) return null;
    if (J[n][l]) {
      var u = J[n][l].replace;
      u && (l = u);
    }
    var h = bt[a].fontName;
    return Ct(l, h, n) ? bt[a].variant : null;
  };
function rt(r) {
  if (!r) return !1;
...
var p0 = function (e, t, a) {
    if (e.length === 1) {
      var n = Y(e[0], t);
      return (
        a && n instanceof z && n.type === "mo" && (n.setAttribute("lspace", "0em"), n.setAttribute("rspace", "0em")),
        [n]
      );
    }
    for (var l = [], u, h = 0; h < e.length; h++) {
      ...
      if (c instanceof z && u instanceof z) {
        if (
          c.type === "mtext" &&
          u.type === "mtext" &&
          c.getAttribute("mathvariant") === u.getAttribute("mathvariant")
        ) {
          ...
          u.children.push(...c.children);
          continue;
        } else if (rt(c) && u.type === "mn") {
          u.children.push(...c.children);
          continue;
        } else if (c.type === "mn" && rt(u)) ((c.children = [...u.children, ...c.children]), l.pop());
        else if ((c.type === "msup" || c.type === "msub") && c.children.length >= 1 && (u.type === "mn" || rt(u))) {
          var v = c.children[0];
          v instanceof z && v.type === "mn" && ((v.children = [...u.children, ...v.children]), l.pop());
...
function ir(r, e, t, a, n) {
  ...
  var h = new z("annotation", [new _(e)]);
  h.setAttribute("encoding", "application/x-tex");
  var c = new z("semantics", [u, h]),
    v = new z("math", [c]);
...
var Ta = [
  ...
  lr = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
  sr = function (e, t) {
...
class T0 {
  constructor(e) {
    ((this.style = e.style),
      ...
      (this.sizeMultiplier = lr[this.size - 1]),
  ...
  extend(e) {
    ...
    return (Object.assign(t, e), new T0(t));
  }
  havingStyle(e) {
    return this.style === e ? this : this.extend({ style: e, size: sr(this.textSize, e) });
  }
  havingCrampedStyle() {
  ...
  havingSize(e) {
    return this.size === e && this.textSize === e
      ? this
      : this.extend({ style: this.style.text(), size: e, textSize: e, sizeMultiplier: lr[e - 1] });
  }
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = sr(T0.BASESIZE, e);
    return this.size === t && this.textSize === T0.BASESIZE && this.style === e
      ? this
...
var Xr = function (e) {
  ...
  Ba = function (e, t, a) {
    var n = Xr(a),
      l;
    if (a.output === "mathml") return ir(e, t, n, a.displayMode, !0);
    if (a.output === "html") {
      var u = kt(e, n);
      l = k(["katex"], [u]);
    } else {
      var h = ir(e, t, n, a.displayMode, !1),
        c = kt(e, n);
      l = k(["katex"], [h, c]);
    }
    return Yr(l, a);
  ...
  Le = function (e) {
    var t = new z("mo", [new _(Ca[e.replace(/^\\/, "")])]);
  ...
  Ea = new Set(["widehat", "widecheck", "widetilde", "utilde"]),
  Pe = function (e, t) {
    function a() {
      var h = 4e5,
        c = e.label.slice(1);
      if (Ea.has(c)) {
        var v = e,
          g = v.base.type === "ordgroup" ? v.base.body.length : 1,
          b,
          y,
          x;
        if (g > 5)
          c === "widehat" || c === "widecheck"
            ? ((b = 420), (h = 2364), (x = 0.42), (y = c + "4"))
            : ((b = 312), (h = 2340), (x = 0.34), (y = "tilde4"));
        else {
          var A = [1, 1, 2, 2, 3, 3][g];
          c === "widehat" || c === "widecheck"
            ? ((h = [0, 1062, 2364, 2364, 2364][A]),
              (b = [0, 239, 300, 360, 420][A]),
              (x = [0, 0.24, 0.3, 0.3, 0.36, 0.42][A]),
              (y = c + A))
            : ((h = [0, 600, 1033, 2339, 2340][A]),
              (b = [0, 260, 286, 306, 312][A]),
              (x = [0, 0.26, 0.286, 0.3, 0.306, 0.34][A]),
              (y = "tilde" + A));
        }
        var T = new L0(y),
          C = new D0([T], { width: "100%", height: M(x), viewBox: "0 0 " + h + " " + b, preserveAspectRatio: "none" });
        return { span: P0([], [C], t), minWidth: 0, height: x };
      } else {
        var q = [],
          I = qa[c],
          [O, F, V] = I,
        ...
        if (P === 1) {
          var h0 = I[3];
          ((W = ["hide-tail"]), (X = [h0]));
        } else if (P === 2) ((W = ["halfarrow-left", "halfarrow-right"]), (X = ["xMinYMin", "xMaxYMin"]));
        else if (P === 3)
          ((W = ["brace-left", "brace-center", "brace-right"]), (X = ["xMinYMin", "xMidYMin", "xMaxYMin"]));
        else
          throw new Error(
        ...
        for (var i0 = 0; i0 < P; i0++) {
          var t0 = new L0(O[i0]),
            V0 = new D0([t0], {
              ...
              height: M(L),
              viewBox: "0 0 " + h + " " + V,
              preserveAspectRatio: X[i0] + " slice",
            }),
            m0 = P0([W[i0]], [V0], t);
          if (P === 1) return { span: m0, minWidth: F, height: L };
          ((m0.style.height = M(L)), q.push(m0));
        }
        return { span: k(["stretchy"], q, t), minWidth: F, height: L };
      }
    }
  ...
  Ra = function (e, t, a, n, l) {
    ...
    if (/fbox|color|angl/.test(t)) {
      ...
      var v = [];
      (/^[bx]cancel$/.test(t) &&
        v.push(new pt({ x1: "0", y1: "0", x2: "100%", y2: "100%", "stroke-width": "0.046em" })),
        /^x?cancel$/.test(t) &&
          v.push(new pt({ x1: "0", y1: "100%", x2: "100%", y2: "0", "stroke-width": "0.046em" })));
      var g = new D0(v, { width: "100%", height: M(h) });
      u = P0([], [g], l);
    }
...
var Wr = (r) => {
    if (r instanceof f0) return r;
    if (oa(r) && r.children.length === 1) return Wr(r.children[0]);
  },
  Nt = (r, e) => {
    var t, a, n;
    r && r.type === "supsub"
      ? ((a = H(r.base, "accent")), (t = a.base), (r.base = t), (n = ua(U(r, e))), (r.base = a))
      : ((a = H(r, "accent")), (t = a.base));
    var l = U(t, e.havingCrampedStyle()),
      u = a.isShifty && C0(t),
      h = 0;
    if (u) {
      var c, v;
      h = (c = (v = Wr(l)) == null ? void 0 : v.skew) != null ? c : 0;
    }
    var g = a.label === "\\c",
      b = g ? l.height + l.depth : Math.min(l.height, e.fontMetrics().xHeight),
      y;
    if (a.isStretchy)
      ((y = Pe(a, e)),
        (y = G({
          ...
          children: [
            { type: "elem", elem: l },
            {
              ...
              wrapperStyle: h > 0 ? { width: "calc(100% - " + M(2 * h) + ")", marginLeft: M(2 * h) } : void 0,
            },
          ],
        })));
    else {
      var x, A;
      (a.label === "\\vec"
        ? ((x = Lr("vec", e)), (A = Fr.vec[1]))
        : ((x = Fe({ mode: a.mode, text: a.label }, e, "textord")),
          (x = sa(x)),
          (x.italic = 0),
          (A = x.width),
          g && (b += x.depth)),
    ...
    var q = k(["mord", "accent"], [y], e);
    return n ? ((n.children[0] = q), (n.height = Math.max(q.height, n.height)), (n.classes[0] = "mord"), n) : q;
  },
  $r = (r, e) => {
    var t = r.isStretchy ? Le(r.label) : new z("mo", [b0(r.label, r.mode)]),
      a = new z("mover", [Y(r.base, e), t]);
...
B({
  ...
  htmlBuilder: (r, e) => {
    ...
    return k(["mord", "accentunder"], [l], e);
  },
  mathmlBuilder: (r, e) => {
    var t = Le(r.label),
      a = new z("munder", [Y(r.base, e), t]);
...
B({
  ...
  htmlBuilder(r, e) {
    var t = e.style,
      ...
      n = re(U(r.body, a, e), e),
      l = r.label.slice(0, 2) === "\\x" ? "x" : "cd";
    n.classes.push(l + "-arrow-pad");
    var u;
    r.below && ((a = e.havingStyle(t.sub())), (u = re(U(r.below, a, e), e)), u.classes.push(l + "-arrow-pad"));
    var h = Pe(r, e),
      c = -e.fontMetrics().axisHeight + 0.5 * h.height,
      v = -e.fontMetrics().axisHeight - 0.5 * h.height - 0.111;
    (n.depth > 0.25 || r.label === "\\xleftequilibrium") && (v -= n.depth);
    var g;
    if (u) {
      ...
      g = G({
        ...
        children: [
          { type: "elem", elem: n, shift: v },
          { type: "elem", elem: h, shift: c },
          { type: "elem", elem: u, shift: b },
        ],
      });
    } else
      g = G({
    ...
    return (g.children[0].children[0].children[1].classes.push("svg-align"), k(["mrel", "x-arrow"], [g], e));
  },
  mathmlBuilder(r, e) {
    var t = Le(r.label);
    ...
    if (r.body) {
      var n = Ae(Y(r.body, e));
      if (r.below) {
        var l = Ae(Y(r.below, e));
        a = new z("munderover", [t, l, n]);
      } else a = new z("mover", [t, n]);
    } else if (r.below) {
      var u = Ae(Y(r.below, e));
      a = new z("munder", [t, u]);
    } else ((a = Ae()), (a = new z("mover", [t, a])));
    return a;
  },
});
function jr(r, e) {
    ...
    r.mclass === "minner"
      ...
      : r.mclass === "mord"
        ? r.isCharacterBox
          ? ((t = a[0]), (t.type = "mi"))
          : (t = new z("mi", a))
        : (r.isCharacterBox ? ((t = a[0]), (t.type = "mo")) : (t = new z("mo", a)),
          r.mclass === "mbin"
...
B({
  ...
  handler(r, e) {
    var { parser: t, funcName: a } = r,
      n = e[0];
    return { type: "mclass", mode: t.mode, mclass: "m" + a.slice(5), body: Q(n), isCharacterBox: C0(n) };
  },
  htmlBuilder: jr,
  mathmlBuilder: Zr,
});
...
B({
  ...
  handler(r, e) {
    var { parser: t } = r;
    return { type: "mclass", mode: t.mode, mclass: Ve(e[0]), body: Q(e[1]), isCharacterBox: C0(e[1]) };
  },
});
B({
  type: "mclass",
  ...
  handler(r, e) {
    ...
    return { type: "mclass", mode: t.mode, mclass: u, body: [c], isCharacterBox: C0(c) };
  },
  htmlBuilder: jr,
  mathmlBuilder: Zr,
});
B({
  ...
  handler(r, e) {
    var { parser: t } = r;
    return { type: "pmb", mode: t.mode, mclass: Ve(e[0]), body: Q(e[0]) };
  },
  htmlBuilder(r, e) {
    var t = a0(r.body, e, !0),
      a = k([r.mclass], t, e);
...
var Na = {
  ...
  ur = () => ({ type: "styling", body: [], mode: "math", style: "display" }),
  or = (r) => r.type === "textord" && r.text === "@",
  Oa = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function Ha(r, e, t) {
  var a = Na[r];
  switch (a) {
    case "\\\\cdrightarrow":
    ...
    case "\\downarrow": {
      var n = t.callFunction("\\\\cdleft", [e[0]], []),
        l = { type: "atom", text: a, mode: "math", family: "rel" },
        u = t.callFunction("\\Big", [l], []),
        h = t.callFunction("\\\\cdright", [e[1]], []),
        c = { type: "ordgroup", mode: "math", body: [n, u, h] };
      return t.callFunction("\\\\cdparent", [c], []);
    }
    case "\\\\cdlongequal":
      return t.callFunction("\\\\cdlongequal", [], []);
    case "\\Vert": {
      var v = { type: "textord", text: "\\Vert", mode: "math" };
...
function Fa(r) {
  ...
  for (r.gullet.beginGroup(), r.gullet.macros.set("\\cr", "\\\\\\relax"), r.gullet.beginGroup(); ; ) {
    ...
    if (t === "&" || t === "\\\\") r.consume();
      ...
      break;
    } else throw new S("Expected \\\\ or \\cr or \\end", r.nextToken);
  }
  for (var a = [], n = [a], l = 0; l < e.length; l++) {
    for (var u = e[l], h = ur(), c = 0; c < u.length; c++)
      if (!or(u[c])) h.body.push(u[c]);
      else {
        (a.push(h), (c += 1));
        var v = Ge(u[c]).text,
          g = new Array(2);
        if (
          ...
          if ("<>AV".includes(v))
            for (var b = 0; b < 2; b++) {
              for (var y = !0, x = c + 1; x < u.length; x++) {
                if (Oa(u[x], v)) {
                  ((y = !1), (c = x));
                  break;
                }
                if (or(u[x])) throw new S("Missing a " + v + " character to complete a CD arrow.", u[x]);
                g[b].body.push(u[x]);
              }
              if (y) throw new S("Missing a " + v + " character to complete a CD arrow.", u[c]);
            }
          else throw new S('Expected one of "<>AV=|." after @', u[c]);
        var A = Ha(v, g, r),
          T = { type: "styling", body: [A], mode: "math", style: "display" };
        (a.push(T), (h = ur()));
      }
...
B({
  ...
  htmlBuilder(r, e) {
    var t = e.havingStyle(e.style.sup()),
      a = re(U(r.label, t, e), e);
    return (
      a.classes.push("cd-label-" + r.side),
      (a.style.bottom = M(0.8 - a.depth)),
      (a.height = 0),
      (a.depth = 0),
      a
    );
...
B({
  ...
  htmlBuilder(r, e) {
    var t = re(U(r.fragment, e), e);
    return (t.classes.push("cd-vert-arrow"), t);
  },
  mathmlBuilder(r, e) {
    return new z("mrow", [Y(r.fragment, e)]);
  },
});
B({
  type: "textord",
  ...
  props: { numArgs: 1, allowedInText: !0 },
  handler(r, e) {
    for (var { parser: t } = r, a = H(e[0], "ordgroup"), n = a.body, l = "", u = 0; u < n.length; u++) {
      var h = H(n[u], "textord");
      l += h.text;
    }
    var c = parseInt(l),
      v;
    if (isNaN(c)) throw new S("\\@char has non-numeric argument " + l);
    if (c < 0 || c >= 1114111) throw new S("\\@char with invalid code point " + l);
    return (
      c <= 65535
        ? (v = String.fromCharCode(c))
        : ((c -= 65536), (v = String.fromCharCode((c >> 10) + 55296, (c & 1023) + 56320))),
      { type: "textord", mode: t.mode, text: v }
    );
  },
});
var Kr = (r, e) => {
  ...
  Jr = (r, e) => {
    var t = p0(r.body, e.withColor(r.color)),
      a = new z("mstyle", t);
...
B({
  ...
  handler(r, e) {
    ...
    return { type: "color", mode: t.mode, color: n, body: l };
  },
  htmlBuilder: Kr,
  mathmlBuilder: Jr,
});
B({
  ...
  handler(r, e, t) {
    ...
    return { type: "cr", mode: a.mode, newLine: l, size: n && H(n, "size").value };
  },
  htmlBuilder(r, e) {
    var t = k(["mspace"], [], e);
    return (r.newLine && (t.classes.push("newline"), r.size && (t.style.marginTop = M(Z(r.size, e)))), t);
  },
  mathmlBuilder(r, e) {
    var t = new z("mspace");
    return (
      r.newLine && (t.setAttribute("linebreak", "newline"), r.size && t.setAttribute("height", M(Z(r.size, e)))),
      t
    );
  },
});
var St = {
  ...
  Qr = (r) => {
    var e = r.text;
    if (/^(?:[\\{}$&#^_]|EOF)$/.test(e)) throw new S("Expected a control sequence", r);
    return e;
  },
  La = (r) => {
  ...
  _r = (r, e, t, a) => {
    ...
    (n == null && ((t.noexpand = !0), (n = { tokens: [t], numArgs: 0, unexpandable: !r.gullet.isExpandable(t.text) })),
...
B({
  ...
  handler(r) {
    ...
    var a = e.fetch();
    if (St[a.text])
      return ((t === "\\global" || t === "\\\\globallong") && (a.text = St[a.text]), H(e.parseFunction(), "internal"));
...
B({
  ...
  handler(r) {
    var { parser: e, funcName: t } = r,
      a = e.gullet.popToken(),
      n = a.text;
    if (/^(?:[\\{}$&#^_]|EOF)$/.test(n)) throw new S("Expected a control sequence", a);
    for (var l = 0, u, h = [[]]; e.gullet.future().text !== "{"; )
      if (((a = e.gullet.popToken()), a.text === "#")) {
        ...
        if (parseInt(a.text) !== l + 1) throw new S('Argument number "' + a.text + '" out of order');
        (l++, h.push([]));
      } else {
        if (a.text === "EOF") throw new S("Expected a macro definition");
        h[l].push(a.text);
      }
    ...
    return (
      ...
      e.gullet.macros.set(n, { tokens: c, numArgs: l, delimiters: h }, t === St[t]),
...
B({
  ...
  handler(r) {
    var { parser: e, funcName: t } = r,
      a = Qr(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var n = La(e);
    return (_r(e, a, n, t === "\\\\globallet"), { type: "internal", mode: e.mode });
  },
});
B({
  type: "internal",
  ...
  handler(r) {
    var { parser: e, funcName: t } = r,
      ...
      l = e.gullet.popToken();
    return (
      _r(e, a, l, t === "\\\\globalfuture"),
      e.gullet.pushToken(l),
...
var ue = function (e, t, a) {
    var n = J.math[e] && J.math[e].replace,
      l = Ct(n || e, t, a);
    if (!l) throw new Error("Unsupported symbol " + e + " and font size " + t + ".");
    return l;
  },
  Ot = function (e, t, a, n) {
    var l = a.havingBaseStyle(t),
      u = k(n.concat(l.sizingClasses(a)), [e], a),
      h = l.sizeMultiplier / a.sizeMultiplier;
    return ((u.height *= h), (u.depth *= h), (u.maxFontSize = l.sizeMultiplier), u);
  },
  e1 = function (e, t, a) {
    var n = t.havingBaseStyle(a),
      l = (1 - t.sizeMultiplier / n.sizeMultiplier) * t.fontMetrics().axisHeight;
    (e.classes.push("delimcenter"), (e.style.top = M(l)), (e.height -= l), (e.depth += l));
  },
  Pa = function (e, t, a, n, l, u) {
    var h = s0(e, "Main-Regular", l, n),
      c = Ot(h, t, n, u);
    return (e1(c, n, t), c);
  },
  Ga = function (e, t, a, n) {
    return s0(e, "Size" + t + "-Regular", a, n);
  },
  t1 = function (e, t, a, n, l, u) {
    var h = Ga(e, t, l, n),
      c = Ot(k(["delimsizing", "size" + t], [h], n), N.TEXT, n, u);
    return (a && e1(c, n, N.TEXT), c);
  },
  at = function (e, t, a) {
    var n;
    t === "Size1-Regular" ? (n = "delim-size1") : (n = "delim-size4");
    var l = k(["delimsizinginner", n], [k([], [s0(e, t, a)])]);
  ...
  nt = function (e, t, a) {
    var n = k0["Size4-Regular"][e.charCodeAt(0)]
      ...
      l = new L0("inner", ta(e, Math.round(1e3 * t))),
      u = new D0([l], {
        width: M(n),
        height: M(t),
        style: "width:" + M(n),
      ...
      h = P0([], [u], a);
    return ((h.height = t), (h.style.height = M(t)), (h.style.width = M(n)), { type: "elem", elem: h });
  },
  zt = 0.008,
  Te = { type: "kern", size: -1 * zt },
  Ua = new Set(["|", "\\lvert", "\\rvert", "\\vert"]),
  Va = new Set(["\\|", "\\lVert", "\\rVert", "\\Vert"]),
  r1 = function (e, t, a, n, l, u) {
      ...
      : e === "\\Uparrow"
        ...
        : e === "\\downarrow"
          ...
          : e === "\\Downarrow"
            ? (h = v = "‖")
            : e === "\\updownarrow"
              ? ((h = "\\uparrow"), (v = "⏐"), (g = "\\downarrow"))
              : e === "\\Updownarrow"
                ? ((h = "\\Uparrow"), (v = "‖"), (g = "\\Downarrow"))
                : Ua.has(e)
                  ? ((v = "∣"), (b = "vert"), (y = 333))
                  : Va.has(e)
                    ? ((v = "∥"), (b = "doublevert"), (y = 556))
                    : e === "[" || e === "\\lbrack"
                      ? ((h = "⎡"), (v = "⎢"), (g = "⎣"), (x = "Size4-Regular"), (b = "lbrack"), (y = 667))
                      : e === "]" || e === "\\rbrack"
                        ? ((h = "⎤"), (v = "⎥"), (g = "⎦"), (x = "Size4-Regular"), (b = "rbrack"), (y = 667))
                        : e === "\\lfloor" || e === "⌊"
                          ? ((v = h = "⎢"), (g = "⎣"), (x = "Size4-Regular"), (b = "lfloor"), (y = 667))
                          : e === "\\lceil" || e === "⌈"
                            ? ((h = "⎡"), (v = g = "⎢"), (x = "Size4-Regular"), (b = "lceil"), (y = 667))
                            : e === "\\rfloor" || e === "⌋"
                              ? ((v = h = "⎥"), (g = "⎦"), (x = "Size4-Regular"), (b = "rfloor"), (y = 667))
                              : e === "\\rceil" || e === "⌉"
                                ? ((h = "⎤"), (v = g = "⎥"), (x = "Size4-Regular"), (b = "rceil"), (y = 667))
                                : e === "(" || e === "\\lparen"
                                  ? ((h = "⎛"), (v = "⎜"), (g = "⎝"), (x = "Size4-Regular"), (b = "lparen"), (y = 875))
                                  : e === ")" || e === "\\rparen"
                                    ? ((h = "⎞"),
                                      (v = "⎟"),
                                      (g = "⎠"),
                                      ...
                                      (y = 875))
                                    : e === "\\{" || e === "\\lbrace"
                                      ? ((h = "⎧"), (c = "⎨"), (g = "⎩"), (v = "⎪"), (x = "Size4-Regular"))
                                      : e === "\\}" || e === "\\rbrace"
                                        ? ((h = "⎫"), (c = "⎬"), (g = "⎭"), (v = "⎪"), (x = "Size4-Regular"))
                                        : e === "\\lgroup" || e === "⟮"
                                          ? ((h = "⎧"), (g = "⎩"), (v = "⎪"), (x = "Size4-Regular"))
                                          : e === "\\rgroup" || e === "⟯"
                                            ? ((h = "⎫"), (g = "⎭"), (v = "⎪"), (x = "Size4-Regular"))
                                            : e === "\\lmoustache" || e === "⎰"
                                              ? ((h = "⎧"), (g = "⎭"), (v = "⎪"), (x = "Size4-Regular"))
    ...
    var P = T + O + F,
      W = Math.max(0, Math.ceil((t - P) / (V * q))),
      X = P + W * V * q,
      h0 = n.fontMetrics().axisHeight;
    a && (h0 *= n.sizeMultiplier);
    var i0 = X / 2 - h0,
      t0 = [];
    if (b.length > 0) {
      var V0 = X - T - O,
        m0 = Math.round(X * 1e3),
        y0 = ra(b, Math.round(V0 * 1e3)),
        R0 = new L0(b, y0),
        j0 = M(y / 1e3),
        Z0 = M(m0 / 1e3),
        Ze = new D0([R0], { width: j0, height: Z0, viewBox: "0 0 " + y + " " + m0 }),
        I0 = P0([], [Ze], n);
      ((I0.height = m0 / 1e3), (I0.style.width = j0), (I0.style.height = Z0), t0.push({ type: "elem", elem: I0 }));
    } else {
      if ((t0.push(at(g, x, l)), t0.push(Te), c === null)) {
        var N0 = X - T - O + 2 * zt;
        t0.push(nt(v, N0, n));
      } else {
        var se = (X - T - O - F) / 2 + 2 * zt;
        (t0.push(nt(v, se, n)), t0.push(Te), t0.push(at(c, x, l)), t0.push(Te), t0.push(nt(v, se, n)));
      }
      (t0.push(Te), t0.push(at(h, x, l)));
    }
    var x0 = n.havingBaseStyle(N.TEXT),
      fe = G({ positionType: "bottom", positionData: i0, children: t0 });
    return Ot(k(["delimsizing", "mult"], [fe], x0), N.TEXT, n, u);
  },
  it = 80,
  lt = 0.08,
  st = function (e, t, a, n, l) {
    var u = ea(e, n, a),
      h = new L0(e, u),
      c = new D0([h], {
        width: "400em",
    ...
    return P0(["hide-tail"], [c], l);
  },
  Xa = function (e, t) {
    var a = t.havingBaseSizing(),
      n = s1("\\surd", e * a.sizeMultiplier, l1, a),
      l = a.sizeMultiplier,
      ...
      n.type === "small"
        ...
        : n.type === "large"
          ? ((g = (1e3 + it) * oe[n.size]),
            (v = (oe[n.size] + u) / l),
            (c = (oe[n.size] + u + lt) / l),
            (h = st("sqrtSize" + n.size, c, g, u, t)),
            (h.style.minWidth = "1.02em"),
            (b = 1 / l))
          : ((c = e + u + lt),
            (v = e + u),
            (g = Math.floor(1e3 * e + u) + it),
            (h = st("sqrtTall", c, g, u, t)),
            (h.style.minWidth = "0.742em"),
            (b = 1.056)),
      (h.height = v),
      (h.style.height = M(c)),
      { span: h, advanceWidth: b, ruleWidth: (t.fontMetrics().sqrtRuleThickness + u) * l }
    );
  },
  a1 = new Set([
    "(",
  ...
  n1 = new Set(["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"]),
  oe = [0, 1.2, 1.8, 2.4, 3],
  i1 = function (e, t, a, n, l) {
    if (
      ...
      return t1(e, t, !1, a, n, l);
    if (Ya.has(e)) return r1(e, oe[t], !1, a, n, l);
    throw new S("Illegal delimiter: '" + e + "'");
  },
  Wa = [
    { type: "small", style: N.SCRIPTSCRIPT },
    { type: "small", style: N.SCRIPT },
    { type: "small", style: N.TEXT },
    { type: "large", size: 1 },
    { type: "large", size: 2 },
    { type: "large", size: 3 },
    { type: "large", size: 4 },
  ...
  s1 = function (e, t, a, n) {
    for (var l = Math.min(2, 3 - n.style.size), u = l; u < a.length; u++) {
      var h = a[u];
      if (h.type === "stack") break;
      var c = ue(e, ja(h), "math"),
        v = c.height + c.depth;
      if (h.type === "small") {
  ...
  Mt = function (e, t, a, n, l, u) {
    e === "<" || e === "\\lt" || e === "⟨"
      ? (e = "\\langle")
      : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
    var h;
    n1.has(e) ? (h = Wa) : a1.has(e) ? (h = l1) : (h = $a);
    var c = s1(e, t, h, n);
    return c.type === "small"
      ? Pa(e, c.style, a, n, l, u)
      : c.type === "large"
        ? t1(e, c.size, a, n, l, u)
        : r1(e, t, a, n, l, u);
  },
  ut = function (e, t, a, n, l, u) {
    var h = n.fontMetrics().axisHeight * n.sizeMultiplier,
      c = 901,
      v = 5 / n.fontMetrics().ptPerEm,
      g = Math.max(t - h, a + h),
      b = Math.max((g / 500) * c, 2 * g - v);
    return Mt(e, b, !0, n, l, u);
  },
  hr = {
...
function Xe(r, e) {
  var t = Ue(r);
  if (t && Za.has(t.text)) return t;
  throw t
    ? new S("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", r)
    : new S("Invalid delimiter type '" + r.type + "'", r);
}
B({
  type: "delimsizing",
  names: [
  ...
  htmlBuilder: (r, e) => (r.delim === "." ? k([r.mclass]) : i1(r.delim, r.size, e, r.mode, [r.mclass])),
  mathmlBuilder: (r) => {
    var e = [];
...
B({
  ...
  handler: (r, e) => {
    ...
    if (t && typeof t != "string") throw new S("\\current@color set to non-string in \\right");
    return { type: "leftright-right", mode: r.parser.mode, delim: Xe(e[0], r).text, color: t };
  },
});
B({
  type: "leftright",
  ...
  handler: (r, e) => {
    ...
    var l = H(a.parseFunction(), "leftright-right");
    return { type: "leftright", mode: a.mode, body: n, left: t.text, right: l.delim, rightColor: l.color };
  },
  htmlBuilder: (r, e) => {
    mr(r);
    for (var t = a0(r.body, e, !0, ["mopen", "mclose"]), a = 0, n = 0, l = !1, u = 0; u < t.length; u++)
      t[u].isMiddle ? (l = !0) : ((a = Math.max(t[u].height, a)), (n = Math.max(t[u].depth, n)));
    ((a *= e.sizeMultiplier), (n *= e.sizeMultiplier));
    var h;
    if ((r.left === "." ? (h = me(e, ["mopen"])) : (h = ut(r.left, a, n, e, r.mode, ["mopen"])), t.unshift(h), l))
      for (var c = 1; c < t.length; c++) {
        var v = t[c],
          g = v.isMiddle;
        g && (t[c] = ut(g.delim, a, n, g.options, r.mode, []));
      }
    var b;
    if (r.right === ".") b = me(e, ["mclose"]);
    else {
      var y = r.rightColor ? e.withColor(r.rightColor) : e;
      b = ut(r.right, a, n, y, r.mode, ["mclose"]);
    }
    return (t.push(b), k(["minner"], t, e));
  },
  mathmlBuilder: (r, e) => {
    mr(r);
    var t = p0(r.body, e);
    if (r.left !== ".") {
      var a = new z("mo", [b0(r.left, r.mode)]);
      (a.setAttribute("fence", "true"), t.unshift(a));
    }
    if (r.right !== ".") {
      var n = new z("mo", [b0(r.right, r.mode)]);
...
B({
  ...
  handler: (r, e) => {
    var t = Xe(e[0], r);
    if (!r.parser.leftrightDepth) throw new S("\\middle without preceding \\left", t);
...
var Ye = (r, e) => {
    ...
    if (a === "sout")
      ((l = k(["stretchy", "sout"])),
        (l.height = e.fontMetrics().defaultRuleThickness / n),
        (u = -0.5 * e.fontMetrics().xHeight));
    else if (a === "phase") {
      var c = Z({ number: 0.6, unit: "pt" }, e),
        v = Z({ number: 0.35, unit: "ex" }, e),
        g = e.havingBaseSizing();
      n = n / g.sizeMultiplier;
      var b = t.height + t.depth + c + v;
      t.style.paddingLeft = M(b / 2 + c);
      var y = Math.floor(1e3 * b * n),
        x = Q1(y),
        A = new D0([new L0("phase", x)], {
          width: "400em",
          height: M(y / 1e3),
          viewBox: "0 0 400000 " + y,
          preserveAspectRatio: "xMinYMin slice",
        });
      ((l = P0(["hide-tail"], [A], e)), (l.style.height = M(b)), (u = t.depth + c + v));
    } else {
      /cancel/.test(a)
      ...
      var T = 0,
        ...
        q = 0;
      (/box/.test(a)
        ? ((q = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)),
          (T = e.fontMetrics().fboxsep + (a === "colorbox" ? 0 : q)),
          (C = T))
        : a === "angl"
          ? ((q = Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness)),
            (T = 4 * q),
            (C = Math.max(0, 0.25 - t.depth)))
          : ((T = h ? 0.2 : 0), (C = T)),
        (l = Ra(t, a, T, C, e)),
        /fbox|boxed|fcolorbox/.test(a)
          ? ((l.style.borderStyle = "solid"), (l.style.borderWidth = M(q)))
          : a === "angl" && q !== 0.049 && ((l.style.borderTopWidth = M(q)), (l.style.borderRightWidth = M(q))),
        (u = t.depth + C),
        r.backgroundColor &&
          ((l.style.backgroundColor = r.backgroundColor), r.borderColor && (l.style.borderColor = r.borderColor)));
    }
    var I;
    if (r.backgroundColor)
      ...
      I = G({
        ...
        children: [
          { type: "elem", elem: t, shift: 0 },
          { type: "elem", elem: l, shift: u, wrapperClasses: O },
        ],
      });
    }
    return (
      /cancel/.test(a) && ((I.height = t.height), (I.depth = t.depth)),
      /cancel/.test(a) && !h ? k(["mord", "cancel-lap"], [I], e) : k(["mord"], [I], e)
    );
  },
  We = (r, e) => {
    var t = 0,
      a = new z(r.label.includes("colorbox") ? "mpadded" : "menclose", [Y(r.body, e)]);
    switch (r.label) {
      case "\\cancel":
      ...
      case "\\colorbox":
        if (
          ...
          a.setAttribute("style", "border: " + M(n) + " solid " + r.borderColor);
        }
        break;
      case "\\xcancel":
...
B({
  ...
  handler(r, e, t) {
    var { parser: a, funcName: n } = r,
      l = H(e[0], "color-token").color,
      u = e[1];
    return { type: "enclose", mode: a.mode, label: n, backgroundColor: l, body: u };
  },
  htmlBuilder: Ye,
  mathmlBuilder: We,
});
B({
  ...
  handler(r, e, t) {
    var { parser: a, funcName: n } = r,
      ...
      h = e[2];
    return { type: "enclose", mode: a.mode, label: n, backgroundColor: u, borderColor: l, body: h };
  },
  htmlBuilder: Ye,
  mathmlBuilder: We,
});
...
class d0 {
  ...
  range(e, t) {
    return new d0(t, c0.range(this, e));
  }
}
function cr(r) {
  var e = [];
...
var $e = (r) => {
    ...
    if (!e.displayMode) throw new S("{" + r.envName + "} can be used only in display mode.");
  },
  Ka = new Set(["gather", "gather*"]);
function Ht(r) {
...
function U0(r, e, t) {
  ...
  if ((r.gullet.beginGroup(), v || r.gullet.macros.set("\\cr", "\\\\\\relax"), !u)) {
    var x = r.gullet.expandMacroAsText("\\arraystretch");
    if (x == null) u = 1;
    else if (((u = parseFloat(x)), !u || u < 0)) throw new S("Invalid \\arraystretch: " + x);
  }
  r.gullet.beginGroup();
  var A = [],
    T = [A],
  ...
  function F() {
    I &&
      (r.gullet.macros.get("\\df@tag")
        ...
        : I.push(!!c && r.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (O(), q.push(cr(r)); ; ) {
    var V = r.parseExpression(!1, v ? "\\end" : "\\\\");
    (r.gullet.endGroup(), r.gullet.beginGroup());
    var L = { type: "ordgroup", mode: r.mode, body: V };
    (t && (L = { type: "styling", mode: r.mode, style: t, body: [L] }), A.push(L));
    var P = r.fetch().text;
    if (P === "&") {
      if (b && A.length === b) {
        if (v || h) throw new S("Too many tab characters: &", r.nextToken);
      ...
      (F(),
        A.length === 1 &&
          L.type === "styling" &&
          L.body.length === 1 &&
          L.body[0].type === "ordgroup" &&
          L.body[0].body.length === 0 &&
          (T.length > 1 || !g) &&
          T.pop(),
        q.length < T.length + 1 && q.push([]));
      break;
    } else if (P === "\\\\") {
      r.consume();
      var W = void 0;
      (r.gullet.future().text !== " " && (W = r.parseSizeGroup(!0)),
        C.push(W ? W.value : null),
        F(),
        q.push(cr(r)),
        (A = []),
        T.push(A),
        O());
    } else throw new S("Expected & or \\\\ or \\cr or \\end", r.nextToken);
  }
  return (
    r.gullet.endGroup(),
    r.gullet.endGroup(),
...
var z0 = function (e, t) {
    ...
    var A = e.colSeparationType === "CD" ? Z({ number: 3, unit: "ex" }, t) : 12 * b,
      T = 3 * b,
      C = e.arraystretch * A,
      q = 0.7 * C,
      I = 0.3 * C,
      O = 0;
    function F(be) {
      for (var ye = 0; ye < be.length; ++ye) (ye > 0 && (O += 0.25), v.push({ pos: O, isDashed: be[ye] }));
    }
    for (F(u[0]), a = 0; a < e.body.length; ++a) {
      ...
      for (n = 0; n < V.length; ++n) {
        var X = U(V[n], t);
        (P < X.depth && (P = X.depth), L < X.height && (L = X.height), (W[n] = X));
      }
      var h0 = e.rowGaps[a],
        i0 = 0;
      (h0 && ((i0 = Z(h0, t)), i0 > 0 && ((i0 += I), P < i0 && (P = i0), (i0 = 0))),
        e.addJot && a < e.body.length - 1 && (P += T),
        (W.height = L),
        (W.depth = P),
        (O += L),
        (W.pos = O),
    ...
    var t0 = O / 2 + t.fontMetrics().axisHeight,
      V0 = e.cols || [],
      m0 = [],
      y0,
      R0,
    ...
    if (e.tags && e.tags.some((be) => be))
      for (a = 0; a < l; ++a) {
        var Z0 = c[a],
          ...
          I0 = e.tags[a],
          N0 = void 0;
        (I0 === !0 ? (N0 = k(["eqn-num"], [], t)) : I0 === !1 ? (N0 = k([], [], t)) : (N0 = k([], a0(I0, t, !0), t)),
          (N0.depth = Z0.depth),
          (N0.height = Z0.height),
          j0.push({ type: "elem", elem: N0, shift: Ze }));
      }
    for (n = 0, R0 = 0; n < h || R0 < V0.length; ++n, ++R0) {
      for (var se, x0 = V0[R0], fe = !0; ((Vt = x0) == null ? void 0 : Vt.type) === "separator"; ) {
        var Vt;
        if (
          (fe || ((y0 = k(["arraycolsep"], [])), (y0.style.width = M(t.fontMetrics().doubleRuleSep)), m0.push(y0)),
          x0.separator === "|" || x0.separator === ":")
        ) {
          var A1 = x0.separator === "|" ? "solid" : "dashed",
            K0 = k(["vertical-separator"], [], t);
          ((K0.style.height = M(O)),
            (K0.style.borderRightWidth = M(g)),
            (K0.style.borderRightStyle = A1),
            (K0.style.margin = "0 " + M(-g / 2)));
          var Xt = O - t0;
          (Xt && (K0.style.verticalAlign = M(-Xt)), m0.push(K0));
        } else throw new S("Invalid separator type: " + x0.separator);
        (R0++, (x0 = V0[R0]), (fe = !1));
      }
      if (!(n >= h)) {
        var J0 = void 0;
        if (n > 0 || e.hskipBeforeAndAfter) {
          var Yt, Wt;
          ((J0 = (Yt = (Wt = x0) == null ? void 0 : Wt.pregap) != null ? Yt : y),
            J0 !== 0 && ((y0 = k(["arraycolsep"], [])), (y0.style.width = M(J0)), m0.push(y0)));
        }
        var $t = [];
        for (a = 0; a < l; ++a) {
          var ve = c[a],
          ...
          if (pe) {
            var T1 = ve.pos - t0;
            ((pe.depth = ve.depth), (pe.height = ve.height), $t.push({ type: "elem", elem: pe, shift: T1 }));
          }
        }
        var B1 = G({ positionType: "individualShift", children: $t }),
          D1 = k(["col-align-" + (((se = x0) == null ? void 0 : se.align) || "c")], [B1]);
        if ((m0.push(D1), n < h - 1 || e.hskipBeforeAndAfter)) {
          var jt, Zt;
          ((J0 = (jt = (Zt = x0) == null ? void 0 : Zt.postgap) != null ? jt : y),
            J0 !== 0 && ((y0 = k(["arraycolsep"], [])), (y0.style.width = M(J0)), m0.push(y0)));
        }
      }
    }
    ...
    if (v.length > 0) {
      for (
        var C1 = te("hline", t, g), q1 = te("hdashline", t, g), Ke = [{ type: "elem", elem: ge, shift: 0 }];
        v.length > 0;
      ) {
        var Kt = v.pop(),
          Jt = Kt.pos - t0;
        Kt.isDashed ? Ke.push({ type: "elem", elem: q1, shift: Jt }) : Ke.push({ type: "elem", elem: C1, shift: Jt });
      }
      ge = G({ positionType: "individualShift", children: Ke });
    }
    if (j0.length === 0) return k(["mord"], [ge], t);
    var E1 = G({ positionType: "individualShift", children: j0 }),
      R1 = k(["tag"], [E1], t);
    return E0([ge, R1]);
  },
  Ja = { c: "center ", l: "left ", r: "right " },
  M0 = function (e, t) {
    for (
      var a = [], n = new z("mtd", [], ["mtr-glue"]), l = new z("mtd", [], ["mml-eqn-num"]), u = 0;
      u < e.body.length;
      u++
    ) {
      for (var h = e.body[u], c = [], v = 0; v < h.length; v++) c.push(new z("mtd", [Y(h[v], t)]));
      (e.tags && e.tags[u] && (c.unshift(n), c.push(n), e.leqno ? c.unshift(l) : c.push(l)), a.push(new z("mtr", c)));
    }
    var g = new z("mtable", a),
      b = e.arraystretch === 0.5 ? 0.1 : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
    ...
    if (e.cols && e.cols.length > 0) {
      var A = e.cols,
        ...
        q = 0,
        I = A.length;
      (A[0].type === "separator" && ((y += "top "), (q = 1)),
        A[A.length - 1].type === "separator" && ((y += "bottom "), (I -= 1)));
      for (var O = q; O < I; O++) {
        var F = A[O];
        F.type === "align"
          ? ((x += Ja[F.align]), C && (T += "none "), (C = !0))
          : F.type === "separator" && C && ((T += F.separator === "|" ? "solid " : "dashed "), (C = !1));
      }
      (g.setAttribute("columnalign", x.trim()), /[sd]/.test(T) && g.setAttribute("columnlines", T.trim()));
    }
    if (e.colSeparationType === "align") {
      for (var V = e.cols || [], L = "", P = 1; P < V.length; P++) L += P % 2 ? "0em " : "1em ";
    ...
    var W = "",
      X = e.hLinesBeforeRow;
    ((y += X[0].length > 0 ? "left " : ""), (y += X[X.length - 1].length > 0 ? "right " : ""));
    for (var h0 = 1; h0 < X.length - 1; h0++) W += X[h0].length === 0 ? "none " : X[h0][0] ? "dashed " : "solid ";
    return (
      /[sd]/.test(W) && g.setAttribute("rowlines", W.trim()),
      y !== "" && ((g = new z("menclose", [g])), g.setAttribute("notation", y.trim())),
      e.arraystretch && e.arraystretch < 1 && ((g = new z("mstyle", [g])), g.setAttribute("scriptlevel", "1")),
      g
    );
  },
  h1 = function (e, t) {
    e.envName.includes("ed") || $e(e);
    var a = [],
      ...
      h = 0,
      c = 0,
      v = { type: "ordgroup", mode: e.mode, body: [] };
    if (t[0] && t[0].type === "ordgroup") {
      for (var g = "", b = 0; b < t[0].body.length; b++) {
        var y = H(t[0].body[b], "textord");
        g += y.text;
      }
      ((h = Number(g)), (c = h * 2));
    }
    ...
    u.body.forEach(function (q) {
      for (var I = 1; I < q.length; I += 2) {
        var O = H(q[I], "styling"),
          F = H(O.body[0], "ordgroup");
        F.body.unshift(v);
      }
      if (x) c < q.length && (c = q.length);
      else {
        var V = q.length / 2;
        if (h < V) throw new S("Too many math in a row: " + ("expected " + h + ", but got " + V), q[0]);
      }
    });
    for (var A = 0; A < c; ++A) {
      var T = "r",
        C = 0;
      (A % 2 === 1 ? (T = "l") : A > 0 && x && (C = 1), (a[A] = { type: "align", align: T, pregap: C, postgap: 0 }));
    }
  ...
  handler(r, e) {
    var t = Ue(e[0]),
      ...
      n = a.map(function (u) {
        ...
        if (c === ":") return { type: "separator", separator: ":" };
        throw new S("Unknown column alignment: " + c, u);
      }),
      l = { cols: n, hskipBeforeAndAfter: !0, maxNumCols: n.length };
...
S0({
  ...
  handler(r) {
    ...
    var l = U0(r.parser, a, Ft(r.envName)),
      u = Math.max(0, ...l.body.map((h) => h.length));
    return (
      (l.cols = new Array(u).fill({ type: "align", align: t })),
      e ? { type: "leftright", mode: r.mode, body: [l], left: e[0], right: e[1], rightColor: void 0 } : l
    );
  },
  htmlBuilder: z0,
  mathmlBuilder: M0,
  ...
  handler(r, e) {
    var t = Ue(e[0]),
      ...
      n = a.map(function (h) {
        var c = Ge(h),
          v = c.text;
        if ("lc".includes(v)) return { type: "align", align: v };
        throw new S("Unknown column alignment: " + v, h);
      });
    if (n.length > 1) throw new S("{subarray} can contain only one column");
    var l = { cols: n, hskipBeforeAndAfter: !1, arraystretch: 0.5 },
      u = U0(r.parser, l, "script");
    if (u.body.length > 0 && u.body[0].length > 1) throw new S("{subarray} can contain only one column");
    return u;
  },
  htmlBuilder: z0,
  mathmlBuilder: M0,
...
S0({
  ...
  props: { numArgs: 0 },
  handler(r) {
    Ka.has(r.envName) && $e(r);
    var e = {
      cols: [{ type: "align", align: "c" }],
      addJot: !0,
      colSeparationType: "gather",
      autoTag: Ht(r.envName),
      emptySingleRow: !0,
...
B({
  ...
  handler(r, e) {
    var { parser: t, funcName: a } = r,
      n = e[0];
    if (n.type !== "ordgroup") throw new S("Invalid environment name", n);
    for (var l = "", u = 0; u < n.body.length; ++u) l += H(n.body[u], "textord").text;
    if (a === "\\begin") {
      if (!dr.hasOwnProperty(l)) throw new S("No such environment: " + l, n);
      var h = dr[l],
        { args: c, optArgs: v } = t.parseArguments("\\begin{" + l + "}", h),
        g = { mode: t.mode, envName: l, parser: t },
        b = h.handler(g, c, v);
      t.expect("\\end", !1);
      var y = t.nextToken,
        x = H(t.parseFunction(), "environment");
      if (x.name !== l) throw new S("Mismatch: \\begin{" + l + "} matched by \\end{" + x.name + "}", y);
      return b;
    }
    return { type: "environment", mode: t.mode, name: l, nameGroup: n };
  },
});
var m1 = (r, e) => {
    var t = r.font,
  ...
  fr = { "\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak", "\\bm": "\\boldsymbol" };
B({
  type: "font",
  names: [
    "\\mathrm",
  ...
  handler: (r, e) => {
    var { parser: t, funcName: a } = r,
      n = Ne(e[0]),
      l = a;
    return (l in fr && (l = fr[l]), { type: "font", mode: t.mode, font: l.slice(1), body: n });
  },
  htmlBuilder: m1,
  mathmlBuilder: c1,
});
...
B({
  ...
  handler: (r, e) => {
    var { parser: t, funcName: a, breakOnTokenText: n } = r,
      { mode: l } = t,
      u = t.parseExpression(!0, n),
      h = "math" + a.slice(1);
    return { type: "font", mode: l, font: h, body: { type: "ordgroup", mode: t.mode, body: u } };
  },
  htmlBuilder: m1,
  mathmlBuilder: c1,
});
var Qa = (r, e) => {
    ...
    var v = U(r.denom, l, e),
      ...
      y;
    r.hasBarLine
      ? (r.barSize ? ((b = Z(r.barSize, e)), (g = te("frac-line", e, b))) : (g = te("frac-line", e)),
        (b = g.height),
        (y = g.height))
      : ((g = null), (b = 0), (y = e.fontMetrics().defaultRuleThickness));
    var x, A, T;
    t.size === N.DISPLAY.size
      ? ((x = e.fontMetrics().num1), b > 0 ? (A = 3 * y) : (A = 7 * y), (T = e.fontMetrics().denom1))
      : (b > 0 ? ((x = e.fontMetrics().num2), (A = y)) : ((x = e.fontMetrics().num3), (A = 3 * y)),
        (T = e.fontMetrics().denom2));
    var C;
    if (g) {
      var I = e.fontMetrics().axisHeight;
      (x - u.depth - (I + 0.5 * b) < A && (x += A - (x - u.depth - (I + 0.5 * b))),
        I - 0.5 * b - (v.height - T) < A && (T += A - (I - 0.5 * b - (v.height - T))));
      var O = -(I - 0.5 * b);
      C = G({
        positionType: "individualShift",
        children: [
          { type: "elem", elem: v, shift: T },
          { type: "elem", elem: g, shift: O },
          { type: "elem", elem: u, shift: -x },
        ],
      });
    } else {
      var q = x - u.depth - (v.height - T);
      (q < A && ((x += 0.5 * (A - q)), (T += 0.5 * (A - q))),
        (C = G({
          positionType: "individualShift",
          children: [
            { type: "elem", elem: v, shift: T },
    ...
    ((l = e.havingStyle(t)),
      (C.height *= l.sizeMultiplier / e.sizeMultiplier),
      (C.depth *= l.sizeMultiplier / e.sizeMultiplier));
    var F;
    t.size === N.DISPLAY.size
      ? (F = e.fontMetrics().delim1)
      : t.size === N.SCRIPTSCRIPT.size
        ? (F = e.havingStyle(N.SCRIPT).fontMetrics().delim2)
        : (F = e.fontMetrics().delim2);
    var V, L;
    return (
      r.leftDelim == null ? (V = me(e, ["mopen"])) : (V = Mt(r.leftDelim, F, !0, e.havingStyle(t), r.mode, ["mopen"])),
      r.continued
        ? (L = k([]))
        : r.rightDelim == null
          ? (L = me(e, ["mclose"]))
          : (L = Mt(r.rightDelim, F, !0, e.havingStyle(t), r.mode, ["mclose"])),
      k(["mord"].concat(l.sizingClasses(e)), [V, k(["mfrac"], [C]), L], e)
    );
  },
  _a = (r, e) => {
    var t = new z("mfrac", [Y(r.numer, e), Y(r.denom, e)]);
    ...
    if (r.leftDelim != null || r.rightDelim != null) {
      ...
      if ((n.push(t), r.rightDelim != null)) {
        var u = new z("mo", [new _(r.rightDelim.replace("\\", ""))]);
...
B({
  ...
  handler: (r, e) => {
    ...
    var v = a === "\\cfrac",
      g = null;
    return (
      v || a.startsWith("\\d") ? (g = "display") : a.startsWith("\\t") && (g = "text"),
      d1(
        {
          type: "genfrac",
          mode: t.mode,
...
var vr = ["display", "text", "script", "scriptscript"],
  pr = function (e) {
    var t = null;
...
B({
  ...
  handler(r, e) {
    var { parser: t } = r,
      ...
      n = e[5],
      l = Ne(e[0]),
      u = l.type === "atom" && l.family === "open" ? pr(l.text) : null,
      h = Ne(e[1]),
      c = h.type === "atom" && h.family === "close" ? pr(h.text) : null,
      v = H(e[2], "size"),
      g,
      b = null;
    v.isBlank ? (g = !0) : ((b = v.value), (g = b.number > 0));
    var y = null,
      x = e[3];
    if (x.type === "ordgroup") {
      if (x.body.length > 0) {
        var A = H(x.body[0], "textord");
        y = vr[Number(A.text)];
      }
    } else ((x = H(x, "textord")), (y = vr[Number(x.text)]));
    return d1(
      {
        type: "genfrac",
        mode: t.mode,
...
B({
  ...
  handler(r, e) {
    ...
    return { type: "infix", mode: t.mode, replaceWith: "\\\\abovefrac", size: H(e[0], "size").value, token: n };
  },
});
B({
  type: "genfrac",
  ...
  handler: (r, e) => {
    var { parser: t, funcName: a } = r,
      n = e[0],
      l = H(e[1], "infix").size;
    if (!l) throw new Error("\\\\abovefrac expected size, but got " + String(l));
    var u = e[2],
      h = l.number > 0;
    return {
      type: "genfrac",
...
var f1 = (r, e) => {
    var t = e.style,
      ...
      n;
    r.type === "supsub"
      ? ((a = r.sup ? U(r.sup, e.havingStyle(t.sup()), e) : U(r.sub, e.havingStyle(t.sub()), e)),
        (n = H(r.base, "horizBrace")))
      : (n = H(r, "horizBrace"));
    var l = U(n.base, e.havingBaseStyle(N.DISPLAY)),
      u = Pe(n, e),
      h;
    if (
      (n.isOver
      ...
      var c = k(["minner", n.isOver ? "mover" : "munder"], [h], e);
      n.isOver
        ? (h = G({
            positionType: "firstBaseline",
            children: [
    ...
    return k(["minner", n.isOver ? "mover" : "munder"], [h], e);
  },
  e4 = (r, e) => {
    var t = Le(r.label);
    return new z(r.isOver ? "mover" : "munder", [Y(r.base, e), t]);
  };
B({
  type: "horizBrace",
...
B({
  ...
  handler: (r, e) => {
    ...
    for (var n = [], l = 0; l < a.length; l++) {
      var u = a[l];
      (u === "~" && (u = "\\textasciitilde"), n.push({ type: "textord", mode: "text", text: u }));
    }
...
B({
  ...
  handler: (r, e) => {
    ...
    switch (a) {
      case "\\htmlClass":
        ((c.class = l), (h = { command: "\\htmlClass", class: l }));
        break;
      case "\\htmlId":
        ((c.id = l), (h = { command: "\\htmlId", id: l }));
        break;
      case "\\htmlStyle":
        ((c.style = l), (h = { command: "\\htmlStyle", style: l }));
        break;
      case "\\htmlData": {
        for (var v = l.split(","), g = 0; g < v.length; g++) {
          var b = v[g],
            y = b.indexOf("=");
          if (y < 0) throw new S("\\htmlData key/value '" + b + "' missing equals sign");
          var x = b.slice(0, y),
            A = b.slice(y + 1);
          c["data-" + x.trim()] = A;
        }
    ...
    return t.settings.isTrusted(h)
      ? { type: "html", mode: t.mode, attributes: c, body: Q(u) }
  ...
  htmlBuilder: (r, e) => {
    ...
    var n = k(a, t, e);
    for (var l in r.attributes) l !== "class" && r.attributes.hasOwnProperty(l) && n.setAttribute(l, r.attributes[l]);
    return n;
  },
...
var ot = function (e) {
  ...
  if (!qr(a)) throw new S("Invalid unit: '" + a.unit + "' in \\includegraphics.");
  return a;
};
B({
  ...
  handler: (r, e, t) => {
    var { parser: a } = r,
      ...
      h = "";
    if (t[0])
      for (var c = H(t[0], "raw").string, v = c.split(","), g = 0; g < v.length; g++) {
        var b = v[g].split("=");
        if (b.length === 2) {
          var y = b[1].trim();
          switch (b[0].trim()) {
    ...
    return (
      ...
      a.settings.isTrusted({ command: "\\includegraphics", url: x })
        ? { type: "includegraphics", mode: a.mode, alt: h, width: n, height: l, totalheight: u, src: x }
  ...
  mathmlBuilder: (r, e) => {
    ...
    var a = Z(r.height, e),
      n = 0;
    if (
      (r.totalheight.number > 0 && ((n = Z(r.totalheight, e) - a), t.setAttribute("valign", M(-n))),
      t.setAttribute("height", M(a + n)),
      r.width.number > 0)
    ) {
      var l = Z(r.width, e);
    ...
    if (t.settings.strict) {
      ...
      l
        ? (u ||
          ...
          t.mode !== "math" &&
            t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " works only in math mode"))
        : u && t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " doesn't support mu units");
    }
    return { type: "kern", mode: t.mode, dimension: n.value };
  },
  htmlBuilder(r, e) {
    return Hr(r.dimension, e);
  },
  mathmlBuilder(r, e) {
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t;
    r.alignment === "clap"
      ? ((t = k([], [U(r.body, e)])), (t = k(["inner"], [t], e)))
      : (t = k(["inner"], [U(r.body, e)]));
    var a = k(["fix"], []),
      n = k([r.alignment], [t, a], e),
      l = k(["strut"]);
    return (
      (l.style.height = M(n.height + n.depth)),
      n.depth && (l.style.verticalAlign = M(-n.depth)),
  ...
  mathmlBuilder: (r, e) => {
    var t = new z("mpadded", [Y(r.body, e)]);
    if (r.alignment !== "rlap") {
...
B({
  ...
  handler(r, e) {
    ...
    a.switchMode("math");
    var l = t === "\\(" ? "\\)" : "$",
      u = a.parseExpression(!1, l);
    return (a.expect(l), a.switchMode(n), { type: "styling", mode: a.mode, style: "text", body: u });
  },
});
B({
  type: "text",
...
var v1 = (r, e, t, a, n, l, u) => {
    ...
    if (e) {
      ...
      v = { elem: g, kern: Math.max(a.fontMetrics().bigOpSpacing1, a.fontMetrics().bigOpSpacing3 - g.depth) };
    }
    if (t) {
      var b = U(t, a.havingStyle(n.sub()), a);
      c = { elem: b, kern: Math.max(a.fontMetrics().bigOpSpacing2, a.fontMetrics().bigOpSpacing4 - b.height) };
    }
    var y;
    if (v && c) {
      ...
      y = G({
        ...
        children: [
          ...
          { type: "elem", elem: c.elem, marginLeft: M(-l) },
          { type: "kern", size: c.kern },
          { type: "elem", elem: r },
          { type: "kern", size: v.kern },
          { type: "elem", elem: v.elem, marginLeft: M(l) },
          { type: "kern", size: a.fontMetrics().bigOpSpacing5 },
        ],
      });
    } else if (c) {
  ...
  le = (r, e) => {
    var t,
      ...
      n = !1,
      l;
    r.type === "supsub" ? ((t = r.sup), (a = r.sub), (l = H(r.base, "op")), (n = !0)) : (l = H(r, "op"));
    var u = e.style,
      h = !1;
    u.size === N.DISPLAY.size && l.symbol && !p1.has(l.name) && (h = !0);
    var c;
    if (l.symbol) {
      var v = h ? "Size2-Regular" : "Size1-Regular",
        g = "";
      if (
        ((l.name === "\\oiint" || l.name === "\\oiiint") &&
          ((g = l.name.slice(1)), (l.name = g === "oiint" ? "\\iint" : "\\iiint")),
        (c = s0(l.name, v, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"])),
        g.length > 0)
      ) {
        var b = c.italic,
          y = Lr(g + "Size" + (h ? "2" : "1"), e);
        ((c = G({
          ...
          children: [
            ...
            { type: "elem", elem: y, shift: h ? 0.08 : 0 },
          ],
        })),
          (l.name = "\\" + g),
      ...
      var x = a0(l.body, e, !0);
      x.length === 1 && x[0] instanceof f0 ? ((c = x[0]), (c.classes[0] = "mop")) : (c = k(["mop"], x, e));
    } else {
      for (var A = [], T = 1; T < l.name.length; T++) A.push(qt(l.name[T], l.mode, e));
      c = k(["mop"], A, e);
    }
    var C = 0,
      q = 0;
    return (
      (c instanceof f0 || l.name === "\\oiint" || l.name === "\\oiiint") &&
        !l.suppressBaseShift &&
        ((C = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight), (q = c.italic || 0)),
      n ? v1(c, t, a, e, u, q, C) : (C && ((c.style.position = "relative"), (c.style.top = M(C))), c)
    );
  },
  de = (r, e) => {
    var t;
    if (r.symbol) ((t = new z("mo", [b0(r.name, r.mode)])), p1.has(r.name) && t.setAttribute("largeop", "false"));
    else if (r.body) t = new z("mo", p0(r.body, e));
    else {
      t = new z("mi", [new _(r.name.slice(1))]);
      var a = new z("mo", [b0("⁡", "text")]);
      r.parentIsSupSub ? (t = new z("mrow", [t, a])) : (t = Ur([t, a]));
    }
    return t;
  },
  t4 = {
...
var r4 = { "∫": "\\int", "∬": "\\iint", "∭": "\\iiint", "∮": "\\oint", "∯": "\\oiint", "∰": "\\oiiint" };
B({
  type: "op",
  names: [
    "\\arcsin",
...
var g1 = (r, e) => {
    var t,
      ...
      l;
    r.type === "supsub"
      ? ((t = r.sup), (a = r.sub), (l = H(r.base, "operatorname")), (n = !0))
      : (l = H(r, "operatorname"));
    var u;
    if (l.body.length > 0) {
      for (
        var h = l.body.map((b) => {
            ...
            return typeof y == "string" ? { type: "textord", mode: b.mode, text: y } : b;
          }),
          c = a0(h, e.withFont("mathrm"), !0),
          v = 0;
        v < c.length;
        v++
      ) {
    ...
    return n ? v1(u, t, a, e, e.style, 0, 0) : u;
  },
  a4 = (r, e) => {
    for (var t = p0(r.body, e.withFont("mathrm")), a = !0, n = 0; n < t.length; n++) {
      var l = t[n];
      if (!(l instanceof Vr))
        if (l instanceof z)
          switch (l.type) {
            ...
            case "mo": {
              var u = l.children[0];
              l.children.length === 1 && u instanceof _
    ...
    var v = new z("mo", [b0("⁡", "text")]);
    return r.parentIsSupSub ? new z("mrow", [c, v]) : Ur([c, v]);
  };
B({
  type: "operatorname",
...
$0({
  type: "ordgroup",
  htmlBuilder(r, e) {
    return r.semisimple ? E0(a0(r.body, e, !1)) : k(["mord"], a0(r.body, e, !0), e);
  },
  mathmlBuilder(r, e) {
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    return k(["mord", "overline"], [l], e);
  },
  mathmlBuilder(r, e) {
    var t = new z("mo", [new _("‾")]);
    t.setAttribute("stretchy", "true");
    var a = new z("mover", [Y(r.body, e), t]);
    return (a.setAttribute("accent", "true"), a);
  },
});
B({
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t = k(["inner"], [U(r.body, e.withPhantom())]),
      a = k(["fix"], []);
...
B({
  ...
  htmlBuilder(r, e) {
    var t = U(r.body, e),
      a = Z(r.dy, e);
    return G({ positionType: "shift", positionData: -a, children: [{ type: "elem", elem: t }] });
  },
  mathmlBuilder(r, e) {
    var t = new z("mpadded", [Y(r.body, e)]),
...
B({
  ...
  handler(r, e, t) {
    var { parser: a } = r,
      ...
      l = H(e[0], "size"),
      u = H(e[1], "size");
    return { type: "rule", mode: a.mode, shift: n && H(n, "size").value, width: l.value, height: u.value };
  },
  htmlBuilder(r, e) {
    var t = k(["mord", "rule"], [], e),
      a = Z(r.width, e),
      n = Z(r.height, e),
      l = r.shift ? Z(r.shift, e) : 0;
    return (
      (t.style.borderRightWidth = M(a)),
      (t.style.borderTopWidth = M(n)),
      (t.style.bottom = M(l)),
      (t.width = a),
      (t.height = n + l),
      (t.depth = -l),
  ...
  mathmlBuilder(r, e) {
    var t = Z(r.width, e),
      ...
      l = (e.color && e.getColor()) || "black",
      u = new z("mspace");
    (u.setAttribute("mathbackground", l), u.setAttribute("width", M(t)), u.setAttribute("height", M(a)));
    var h = new z("mpadded", [u]);
    return (
      n >= 0 ? h.setAttribute("height", M(n)) : (h.setAttribute("height", M(n)), h.setAttribute("depth", M(-n))),
      h.setAttribute("voffset", M(n)),
      h
    );
  },
});
function b1(r, e, t) {
  for (var a = a0(r, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, l = 0; l < a.length; l++) {
    var u = a[l].classes.indexOf("sizing");
    (u < 0
      ? Array.prototype.push.apply(a[l].classes, e.sizingClasses(t))
      : a[l].classes[u + 1] === "reset-size" + e.size && (a[l].classes[u + 1] = "reset-size" + t.size),
      (a[l].height *= n),
      (a[l].depth *= n));
  }
  return E0(a);
...
B({
  ...
  handler: (r, e) => {
    var { breakOnTokenText: t, funcName: a, parser: n } = r,
      l = n.parseExpression(!1, t);
    return { type: "sizing", mode: n.mode, size: br.indexOf(a) + 1, body: l };
  },
  htmlBuilder: n4,
  mathmlBuilder: (r, e) => {
    var t = e.havingSize(r.size),
...
B({
  ...
  handler: (r, e, t) => {
    var { parser: a } = r,
      n = !1,
      l = !1,
      u = t[0] && H(t[0], "ordgroup");
    if (u)
      for (var h = "", c = 0; c < u.body.length; ++c) {
        var v = u.body[c];
        if (((h = Ge(v).text), h === "t")) n = !0;
        else if (h === "b") l = !0;
        else {
          ((n = !1), (l = !1));
          break;
    ...
    var g = e[0];
    return { type: "smash", mode: a.mode, body: g, smashHeight: n, smashDepth: l };
  },
  htmlBuilder: (r, e) => {
    var t = k([], [U(r.body, e)]);
    ...
    var n = G({ positionType: "firstBaseline", children: [{ type: "elem", elem: t }] });
    return k(["mord"], [n], e);
  },
  mathmlBuilder: (r, e) => {
    var t = new z("mpadded", [Y(r.body, e)]);
...
B({
  ...
  handler(r, e, t) {
    var { parser: a } = r,
      n = t[0],
      l = e[0];
    return { type: "sqrt", mode: a.mode, body: l, index: n };
  },
  htmlBuilder(r, e) {
    var t = U(r.body, e.havingCrampedStyle());
    (t.height === 0 && (t.height = e.fontMetrics().xHeight), (t = re(t, e)));
    var a = e.fontMetrics(),
      n = a.defaultRuleThickness,
      l = n;
    e.style.id < N.TEXT.id && (l = e.fontMetrics().xHeight);
    var u = n + l / 4,
      h = t.height + t.depth + u + n,
      { span: c, ruleWidth: v, advanceWidth: g } = Xa(h, e),
      b = c.height - v;
    b > t.height + t.depth + u && (u = (u + b - t.height - t.depth) / 2);
    var y = c.height - t.height - u - v;
    ...
    if (r.index) {
      var A = e.havingStyle(N.SCRIPTSCRIPT),
        T = U(r.index, A, e),
        C = 0.6 * (x.height - x.depth),
        q = G({ positionType: "shift", positionData: -C, children: [{ type: "elem", elem: T }] }),
        I = k(["root"], [q]);
      return k(["mord", "sqrt"], [I, x], e);
    } else return k(["mord", "sqrt"], [x], e);
  },
  mathmlBuilder(r, e) {
    var { body: t, index: a } = r;
    return a ? new z("mroot", [Y(t, e), Y(a, e)]) : new z("msqrt", [Y(t, e)]);
  },
});
var yr = { display: N.DISPLAY, text: N.TEXT, script: N.SCRIPT, scriptscript: N.SCRIPTSCRIPT };
B({
  type: "styling",
  ...
  handler(r, e) {
    var { breakOnTokenText: t, funcName: a, parser: n } = r,
      l = n.parseExpression(!0, t),
      u = a.slice(1, a.length - 5);
    return { type: "styling", mode: n.mode, style: u, body: l };
  },
  htmlBuilder(r, e) {
    var t = yr[r.style],
  ...
  mathmlBuilder(r, e) {
    var t = yr[r.style],
      ...
      n = p0(r.body, a),
      l = new z("mstyle", n),
      u = { display: ["0", "true"], text: ["0", "false"], script: ["1", "false"], scriptscript: ["2", "false"] },
      h = u[r.style];
...
var i4 = function (e, t) {
  ...
  if (a)
    if (a.type === "op") {
      ...
      if (a.type === "accent") return C0(a.base) ? Nt : null;
...
$0({
  ...
  htmlBuilder(r, e) {
    ...
    var T;
    e.style === N.DISPLAY ? (T = v.sup1) : e.style.cramped ? (T = v.sup3) : (T = v.sup2);
    var C = e.sizeMultiplier,
      q = M(0.5 / v.ptPerEm / C),
      I = null;
    if (c) {
      var O =
        r.base && r.base.type === "op" && r.base.name && (r.base.name === "\\oiint" || r.base.name === "\\oiiint");
      (u instanceof f0 || O) && (I = M(-u.italic));
    }
    var F;
    if (h && c) {
      ((g = Math.max(g, T, h.depth + 0.25 * v.xHeight)), (b = Math.max(b, v.sub2)));
      var V = v.defaultRuleThickness,
        L = 4 * V;
      if (g - h.depth - (c.height - b) < L) {
        b = L - (g - h.depth) + c.height;
        var P = 0.8 * v.xHeight - (g - h.depth);
        P > 0 && ((g += P), (b -= P));
      }
      var W = [
        { type: "elem", elem: c, shift: b, marginRight: q, marginLeft: I },
        { type: "elem", elem: h, shift: -g, marginRight: q },
      ];
      F = G({ positionType: "individualShift", children: W });
    } else if (c) {
      b = Math.max(b, v.sub1, c.height - 0.8 * v.xHeight);
      var X = [{ type: "elem", elem: c, marginLeft: I, marginRight: q }];
      F = G({ positionType: "shift", positionData: b, children: X });
    } else if (h)
      ((g = Math.max(g, T, h.depth + 0.25 * v.xHeight)),
        (F = G({ positionType: "shift", positionData: -g, children: [{ type: "elem", elem: h, marginRight: q }] })));
    else throw new Error("supsub must have either sup or sub.");
    var h0 = wt(u, "right") || "mord";
    return k([h0], [u, k(["msupsub"], [F])], e);
  },
  mathmlBuilder(r, e) {
    var t = !1,
      a,
    ...
    var u;
    if (t) u = a ? "mover" : "munder";
    else if (r.sub)
      if (r.sup) {
        var v = r.base;
        (v && v.type === "op" && v.limits && e.style === N.DISPLAY) ||
        (v && v.type === "operatorname" && v.alwaysHandleSupSub && (e.style === N.DISPLAY || v.limits))
          ? (u = "munderover")
          : (u = "msubsup");
      } else {
        var c = r.base;
        (c && c.type === "op" && c.limits && (e.style === N.DISPLAY || c.alwaysHandleSupSub)) ||
        (c && c.type === "operatorname" && c.alwaysHandleSupSub && (c.limits || e.style === N.DISPLAY))
          ? (u = "munder")
          : (u = "msub");
      }
    else {
      var h = r.base;
      (h && h.type === "op" && h.limits && (e.style === N.DISPLAY || h.alwaysHandleSupSub)) ||
      (h && h.type === "operatorname" && h.alwaysHandleSupSub && (h.limits || e.style === N.DISPLAY))
        ? (u = "mover")
        : (u = "msup");
    }
    return new z(u, l);
...
$0({
  ...
  mathmlBuilder(r, e) {
    var t = new z("mo", [b0(r.text, r.mode)]);
    if (r.family === "bin") {
      var a = It(r, e);
...
var y1 = { mi: "italic", mn: "normal", mtext: "normal" };
$0({
  type: "mathord",
  htmlBuilder(r, e) {
  ...
  mathmlBuilder(r, e) {
    var t = new z("mi", [b0(r.text, r.mode, e)]),
      a = It(r, e) || "italic";
      ...
      r.mode === "text"
        ...
        : /[0-9]/.test(r.text)
          ...
          : r.text === "\\prime"
            ? (n = new z("mo", [t]))
            : (n = new z("mi", [t])),
      a !== y1[n.type] && n.setAttribute("mathvariant", a),
      n
    );
  },
});
var ht = { "\\nobreak": "nobreak", "\\allowbreak": "allowbreak" },
  mt = { " ": {}, "\\ ": {}, "~": { className: "nobreak" }, "\\space": {}, "\\nobreakspace": { className: "nobreak" } };
$0({
  type: "spacing",
  htmlBuilder(r, e) {
    if (mt.hasOwnProperty(r.text)) {
      var t = mt[r.text].className || "";
      if (r.mode === "text") {
        var a = Fe(r, e, "textord");
        return (a.classes.push(t), a);
      } else return k(["mspace", t], [qt(r.text, r.mode, e)], e);
    } else {
      if (ht.hasOwnProperty(r.text)) return k(["mspace", ht[r.text]], [], e);
      throw new S('Unknown type of space "' + r.text + '"');
    }
  },
  mathmlBuilder(r, e) {
    var t;
    if (mt.hasOwnProperty(r.text)) t = new z("mtext", [new _(" ")]);
    else {
      if (ht.hasOwnProperty(r.text)) return new z("mspace");
      throw new S('Unknown type of space "' + r.text + '"');
    }
    return t;
  },
...
$0({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new z("mtable", [new z("mtr", [xr(), new z("mtd", [G0(r.body, e)]), xr(), new z("mtd", [G0(r.tag, e)])])]);
...
var wr = {
  ...
  kr = { "\\textbf": "textbf", "\\textmd": "textmd" },
  l4 = { "\\textit": "textit", "\\textup": "textup" },
  Sr = (r, e) => {
    var t = r.font;
    if (t) {
      if (wr[t]) return e.withTextFontFamily(wr[t]);
      if (kr[t]) return e.withTextFontWeight(kr[t]);
      if (t === "\\emph")
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    return k(["mord", "underline"], [l], e);
  },
  mathmlBuilder(r, e) {
    var t = new z("mo", [new _("‾")]);
    t.setAttribute("stretchy", "true");
    var a = new z("munder", [Y(r.body, e), t]);
    return (a.setAttribute("accentunder", "true"), a);
  },
});
B({
  ...
  htmlBuilder(r, e) {
    ...
    return G({ positionType: "shift", positionData: n, children: [{ type: "elem", elem: t }] });
  },
  mathmlBuilder(r, e) {
    var t = new z("mpadded", [Y(r.body, e)], ["vcenter"]);
    return new z("mrow", [t]);
  },
});
B({
  ...
  htmlBuilder(r, e) {
    for (var t = zr(r), a = [], n = e.havingStyle(e.style.text()), l = 0; l < t.length; l++) {
      var u = t[l];
      (u === "~" && (u = "\\textasciitilde"), a.push(s0(u, "Typewriter-Regular", r.mode, n, ["mord", "texttt"])));
    }
    return k(["mord", "text"].concat(n.sizingClasses(e)), Or(a), n);
  },
  mathmlBuilder(r, e) {
    var t = new _(zr(r)),
      a = new z("mtext", [t]);
...
var zr = (r) => r.body.replace(/ /g, r.star ? "␣" : " "),
  W0 = Pr,
  x1 = `[ \r
	]`,
  s4 = "\\\\[a-zA-Z@]+",
...
class Mr {
  ...
  lex() {
    ...
    if (t === e.length) return new d0("EOF", new c0(this, t, t));
    var a = this.tokenRegex.exec(e);
    if (a === null || a.index !== t)
      throw new S("Unexpected character: '" + e[t] + "'", new d0(e[t], new c0(this, t, t + 1)));
    var n = a[6] || a[3] || (a[2] ? "\\ " : " ");
...
`,
    ...
    return new d0(n, new c0(this, t, this.tokenRegex.lastIndex));
  }
}
class d4 {
  constructor(e, t) {
...
m("\\char", function (r) {
  ...
  if (e.text === "'") ((t = 8), (e = r.popToken()));
    ...
    if (((e = r.popToken()), e.text[0] === "\\")) a = e.text.charCodeAt(1);
      ...
      if (e.text === "EOF") throw new S("\\char` missing argument");
      a = e.text.charCodeAt(0);
    }
  else t = 10;
  if (t) {
    if (((a = Ar[e.text]), a == null || a >= t)) throw new S("Invalid base-" + t + " digit " + e.text);
    for (var n; (n = Ar[r.future().text]) != null && n < t; ) ((a *= t), (a += n), r.popToken());
  }
  return "\\@char{" + a + "}";
});
var Lt = (r, e, t, a) => {
  var n = r.consumeArg().tokens;
  if (n.length !== 1) throw new S("\\newcommand's first argument must be a macro name");
  var l = n[0].text,
    u = r.isDefined(l);
  if (u && !e) throw new S("\\newcommand{" + l + "} attempting to redefine " + (l + "; use \\renewcommand"));
  if (!u && !t) throw new S("\\renewcommand{" + l + "} when command " + l + " does not yet exist; use \\newcommand");
  var h = 0;
  if (((n = r.consumeArg().tokens), n.length === 1 && n[0].text === "[")) {
    for (var c = "", v = r.expandNextToken(); v.text !== "]" && v.text !== "EOF"; )
      ((c += v.text), (v = r.expandNextToken()));
    if (!c.match(/^\s*[0-9]+\s*$/)) throw new S("Invalid number of arguments: " + c);
    ((h = parseInt(c)), (n = r.consumeArg().tokens));
  }
  return ((u && a) || r.macros.set(l, { tokens: n, numArgs: h }), "");
};
m("\\newcommand", (r) => Lt(r, !1, !0, !1));
m("\\renewcommand", (r) => Lt(r, !0, !1, !1));
m("\\providecommand", (r) => Lt(r, !0, !0, !0));
m("\\message", (r) => {
...
m("\\dots", function (r) {
  ...
  return (
    t in Tr ? (e = Tr[t]) : (t.slice(0, 4) === "\\not" || (t in J.math && v4.has(J.math[t].group))) && (e = "\\dotsb"),
    e
  );
});
var Pt = {
...
m("\\tag@literal", (r) => {
  if (r.macros.get("\\df@tag")) throw new S("Multiple \\tag");
...
var w1 = M(k0["Main-Regular"][84][1] - 0.7 * k0["Main-Regular"][65][1]);
m(
  "\\LaTeX",
  "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + w1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}"
);
m(
  "\\KaTeX",
  "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + w1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}"
);
...
var S1 = { "^": !0, _: !0, "\\limits": !0, "\\nolimits": !0 };
class p4 {
  constructor(e, t, a) {
    ((this.settings = t),
      (this.expansionCount = 0),
      this.feed(e),
      (this.macros = new d4(f4, t.macros)),
      (this.mode = a),
      (this.stack = []));
  }
  feed(e) {
  ...
  scanArgument(e) {
    ...
    return (this.pushToken(new d0("EOF", a.loc)), this.pushTokens(n), new d0("", c0.range(t, a)));
  }
  consumeSpaces() {
    for (;;) {
      var e = this.future();
  ...
  consumeArg(e) {
    ...
    var n = this.future(),
      ...
      h = 0;
    do {
      if (((l = this.popToken()), t.push(l), l.text === "{")) ++u;
      else if (l.text === "}") {
        if ((--u, u === -1)) throw new S("Extra }", l);
      } else if (l.text === "EOF")
        throw new S("Unexpected end of input in a macro argument, expected '" + (e && a ? e[h] : "}") + "'", l);
      if (e && a)
  ...
  consumeArgs(e, t) {
    if (t) {
      ...
      for (var a = t[0], n = 0; n < a.length; n++) {
        var l = this.popToken();
        if (a[n] !== l.text) throw new S("Use of the macro doesn't match its definition", l);
      }
    }
  ...
  expandOnce(e) {
    ...
    if (n == null || (e && n.unexpandable)) {
      if (e && n == null && a[0] === "\\" && !this.isDefined(a)) throw new S("Undefined control sequence: " + a);
      return (this.pushToken(t), !1);
    }
    this.countExpansion(1);
    var l = n.tokens,
      u = this.consumeArgs(n.numArgs, n.delimiters);
    if (n.numArgs) {
      l = l.slice();
      for (var h = l.length - 1; h >= 0; --h) {
        var c = l[h];
        if (c.text === "#") {
          if (h === 0) throw new S("Incomplete placeholder at end of macro body", c);
          if (((c = l[--h]), c.text === "#")) l.splice(h + 1, 1);
          else if (/^[1-9]$/.test(c.text)) l.splice(h, 2, ...u[+c.text - 1]);
  ...
  _getExpansion(e) {
    ...
    if (typeof n == "string") {
      var l = 0;
      if (n.includes("#")) for (var u = n.replace(/##/g, ""); u.includes("#" + (l + 1)); ) ++l;
      for (var h = new Mr(n, this.settings), c = [], v = h.lex(); v.text !== "EOF"; ) (c.push(v), (v = h.lex()));
      c.reverse();
      var g = { tokens: c, numArgs: l };
      return g;
    }
    return n;
  }
  isDefined(e) {
    return (
      this.macros.has(e) ||
      W0.hasOwnProperty(e) ||
      J.math.hasOwnProperty(e) ||
      J.text.hasOwnProperty(e) ||
      S1.hasOwnProperty(e)
    );
  }
  isExpandable(e) {
...
class je {
  constructor(e, t) {
    ((this.mode = "math"),
      (this.gullet = new p4(e, t, this.mode)),
      (this.settings = t),
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (je.endOfExpression.has(n.text) || (t && n.text === t) || (e && W0[n.text] && W0[n.text].infix)) break;
  ...
  handleInfixNodes(e) {
    for (var t = -1, a, n = 0; n < e.length; n++) {
      var l = e[n];
      if (l.type === "infix") {
        if (t !== -1) throw new S("only one infix operator per group", l.token);
        ((t = n), (a = l.replaceWith));
      }
    }
    if (t !== -1 && a) {
      var u,
        ...
        c = e.slice(0, t),
        v = e.slice(t + 1);
      (c.length === 1 && c[0].type === "ordgroup" ? (u = c[0]) : (u = { type: "ordgroup", mode: this.mode, body: c }),
        v.length === 1 && v[0].type === "ordgroup" ? (h = v[0]) : (h = { type: "ordgroup", mode: this.mode, body: v }));
      var g;
      return (
        a === "\\\\abovefrac" ? (g = this.callFunction(a, [u, e[t], h], [])) : (g = this.callFunction(a, [u, h], [])),
        [g]
      );
    } else return e;
  }
  handleSupSubscript(e) {
    ...
    if (!n) throw new S("Expected group after '" + a + "'", t);
    return n;
  }
  formatUnsupportedCmd(e) {
    for (var t = [], a = 0; a < e.length; a++) t.push({ type: "textord", mode: "text", text: e[a] });
    var n = { type: "text", mode: this.mode, body: t },
      l = { type: "color", mode: this.mode, color: this.settings.errorColor, body: [n] };
    return l;
  }
  parseAtom(e) {
    ...
    for (var a, n; ; ) {
      ...
      if (l.text === "\\limits" || l.text === "\\nolimits") {
        ...
        } else if (t && t.type === "operatorname") t.alwaysHandleSupSub && (t.limits = l.text === "\\limits");
        else throw new S("Limit controls must follow a math operator", l);
        this.consume();
      } else if (l.text === "^") {
        if (a) throw new S("Double superscript", l);
        a = this.handleSupSubscript("superscript");
      } else if (l.text === "_") {
        if (n) throw new S("Double subscript", l);
        ...
        var v = Br.test(l.text),
          g = [];
        for (g.push(new d0(Be[l.text])), this.consume(); ; ) {
          var b = this.fetch().text;
          if (!Be[b] || Br.test(b) !== v) break;
          (g.unshift(new d0(Be[b])), this.consume());
        }
        var y = this.subparse(g);
        v ? (n = { type: "ordgroup", mode: "math", body: y }) : (a = { type: "ordgroup", mode: "math", body: y });
      } else break;
    }
  ...
  parseFunction(e, t) {
    ...
    if (this.mode === "text" && !l.allowedInText) throw new S("Can't use function '" + n + "' in text mode", a);
    if (this.mode === "math" && l.allowedInMath === !1) throw new S("Can't use function '" + n + "' in math mode", a);
    var { args: u, optArgs: h } = this.parseArguments(n, l);
    return this.callFunction(n, u, h, a, e);
  }
  callFunction(e, t, a, n, l) {
    var u = { funcName: e, parser: this, token: n, breakOnTokenText: l },
      h = W0[e];
    if (h && h.handler) return h.handler(u, t, a);
  ...
  parseArguments(e, t) {
    ...
    for (var n = [], l = [], u = 0; u < a; u++) {
      var h = t.argTypes && t.argTypes[u],
        c = u < t.numOptionalArgs;
      (("primitive" in t && t.primitive && h == null) || (t.type === "sqrt" && u === 1 && l[0] == null)) &&
        (h = "primitive");
  ...
  parseGroupOfType(e, t, a) {
    switch (t) {
      ...
      case "primitive": {
        if (a) throw new S("A primitive argument cannot be optional");
        var u = this.parseGroup(e);
        if (u == null) throw new S("Expected group as " + e, this.fetch());
        return u;
      }
      case "original":
      case null:
  ...
  parseStringGroup(e, t) {
    ...
    for (var n = "", l; (l = this.fetch()).text !== "EOF"; ) ((n += l.text), this.consume());
  ...
  parseRegexGroup(e, t) {
    ...
    if (l === "") throw new S("Invalid " + t + ": '" + a.text + "'", a);
    return a.range(n, l);
  }
  parseColorGroup(e) {
    ...
    if (!a) throw new S("Invalid color: '" + t.text + "'", t);
    var n = a[0];
  ...
  parseSizeGroup(e) {
    ...
    if (!n) throw new S("Invalid size: '" + t.text + "'", t);
    var l = { number: +(n[1] + n[2]), unit: n[3] };
    if (!qr(l)) throw new S("Invalid unit: '" + l.unit + "'", t);
    return { type: "size", mode: this.mode, value: l, isBlank: a };
  }
  parseUrlGroup(e) {
  ...
  parseArgumentGroup(e, t) {
    ...
    var u = { type: "ordgroup", mode: this.mode, loc: a.loc, body: l };
  ...
  parseGroup(e, t) {
    ...
    if (n === "{" || n === "\\begingroup") {
      ...
      ((l = this.parseFunction(t, e) || this.parseSymbol()), l == null && n[0] === "\\" && !S1.hasOwnProperty(n))
    ) {
      if (this.settings.throwOnError) throw new S("Undefined control sequence: " + n, a);
    ...
    for (var t = e.length - 1, a = 0; a < t; ++a) {
      ...
      if (n.type === "textord") {
        ...
        if (!(!u || u.type !== "textord")) {
          if (l === "-" && u.text === "-") {
            var h = e[a + 2];
            a + 1 < t && h && h.type === "textord" && h.text === "-"
              ? (e.splice(a, 3, { type: "textord", mode: "text", loc: c0.range(n, h), text: "---" }), (t -= 2))
              : (e.splice(a, 2, { type: "textord", mode: "text", loc: c0.range(n, u), text: "--" }), (t -= 1));
          }
          (l === "'" || l === "`") &&
            u.text === l &&
            (e.splice(a, 2, { type: "textord", mode: "text", loc: c0.range(n, u), text: l + l }), (t -= 1));
        }
      }
    }
  }
  parseSymbol() {
    ...
    if (J[this.mode][t]) {
      ...
      var h = J[this.mode][t].group,
        c = c0.range(e),
        v;
      if (ca.hasOwnProperty(h)) {
        var g = h;
        v = { type: "atom", mode: this.mode, family: g, loc: c, text: t };
      } else v = { type: h, mode: this.mode, loc: c, text: t };
      u = v;
      ...
      (this.settings.strict &&
        ...
        (u = { type: "textord", mode: "text", loc: c0.range(e), text: t }));
    else return null;
    if ((this.consume(), l))
      for (var b = 0; b < l[0].length; b++) {
        var y = l[0][b];
        if (!ct[y]) throw new S("Unknown accent ' " + y + "'", e);
        var x = ct[y][this.mode] || ct[y].text;
        if (!x) throw new S("Accent " + y + " unsupported in " + this.mode + " mode", e);
        u = { type: "accent", mode: this.mode, loc: c0.range(e), label: x, isStretchy: !1, isShifty: !0, base: u };
      }
    return u;
  }
}
je.endOfExpression = new Set(["}", "\\endgroup", "\\end", "\\right", "&"]);
var Gt = function (e, t) {
...
var g4 = function (e, t) {
  ...
  M1 = function (e, t, a) {
    if (a.throwOnError || !(e instanceof S)) throw e;
    var n = k(["katex-error"], [new f0(t)]);
  ...
  x4 = "0.16.45",
  w4 = { Span: ne, Anchor: Oe, SymbolNode: f0, SvgNode: D0, PathNode: L0, LineNode: pt },
  k4 = {
    version: x4,
    render: z1,
    renderToString: g4,
...
export {
  S as ParseError,
  dt as SETTINGS_SCHEMA,
  B as __defineFunction,
  m as __defineMacro,
  i as __defineSymbol,
  w4 as __domTree,
  b4 as __parse,
  Ut as __renderToDomTree,
  y4 as __renderToHTMLTree,
  ha as __setFontMetrics,
  k4 as default,
  z1 as render,
  g4 as renderToString,
  x4 as version,
};
