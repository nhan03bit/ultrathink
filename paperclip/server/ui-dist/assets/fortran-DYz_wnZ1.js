...
var l = r([
  ...
  c = /[+\-*&=<>\/\:]/,
  _ = /^\.(and|or|eq|lt|le|gt|ge|ne|not|eqv|neqv)\./i;
function u(t, n) {
  if (t.match(_)) return "operator";
  var e = t.next();
  if (e == "!") return (t.skipToEnd(), "comment");
  if (e == '"' || e == "'") return ((n.tokenize = m(e)), n.tokenize(t, n));
  if (/[\[\]\(\),]/.test(e)) return null;
  if (/\d/.test(e)) return (t.eatWhile(/[\w\.]/), "number");
  if (c.test(e)) return (t.eatWhile(c), "operator");
  t.eatWhile(/[\w\$_]/);
