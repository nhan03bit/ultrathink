...
var s =
  "body catch class do else enum for foreach foreach_reverse if in interface mixin out scope struct switch try union unittest version while with";
const l = {
  keywords: c(
    "abstract alias align asm assert auto break case cast cdouble cent cfloat const continue debug default delegate delete deprecated export extern final finally function goto immutable import inout invariant is lazy macro module new nothrow override package pragma private protected public pure ref return shared short static super synchronized template this throw typedef typeid typeof volatile __FILE__ __LINE__ __gshared __traits __vector __parameters " +
      s
  ),
  blockKeywords: c(s),
  builtin: c(
    "bool byte char creal dchar double float idouble ifloat int ireal long real short ubyte ucent uint ulong ushort wchar wstring void size_t sizediff_t"
  ),
...
var w = l.statementIndentUnit,
  v = l.keywords,
  x = l.builtin,
  d = l.blockKeywords,
  g = l.atoms,
  p = l.hooks,
  _ = l.multiLineStrings,
  h = /[+\-*&%=<>!?|\/]/,
  o;
function m(e, n) {
  var t = e.next();
  ...
  e.eatWhile(/[\w\$_\xa1-\uffff]/);
  var r = e.current();
  return v.propertyIsEnumerable(r)
    ? (d.propertyIsEnumerable(r) && (o = "newstatement"), "keyword")
    : x.propertyIsEnumerable(r)
      ? (d.propertyIsEnumerable(r) && (o = "newstatement"), "builtin")
...
function f(e, n, t) {
  var i = e.indented;
  return (
    e.context && e.context.type == "statement" && (i = e.context.indented),
    (e.context = new b(i, n, t, null, e.context))
  );
}
function a(e) {
...
const E = {
  ...
  startState: function (e) {
    return { tokenize: null, context: new b(-e, 0, "top", !1), indented: 0, startOfLine: !0 };
  },
  token: function (e, n) {
    var t = n.context;
    if (
    ...
    if ((t.align == null && (t.align = !0), (o == ";" || o == ":" || o == ",") && t.type == "statement")) a(n);
      ...
      o == t.type
        ? a(n)
        : (((t.type == "}" || t.type == "top") && o != ";") || (t.type == "statement" && o == "newstatement")) &&
          f(n, e.column(), "statement");
  ...
  indent: function (e, n, t) {
    ...
    var u = r == i.type;
    return i.type == "statement"
      ? i.indented + (r == "{" ? 0 : w || t.unit)
      : i.align
        ? i.column + (u ? 0 : 1)
        : i.indented + (u ? 0 : t.unit);
  },
