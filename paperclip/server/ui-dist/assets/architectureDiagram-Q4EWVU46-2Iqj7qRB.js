import {
  ...
  aK as sr,
  aL as hr,
} from "./mermaid.core-CRFIEA0t.js";
import { p as lr } from "./chunk-4BX2VUAB-CN25_Jv2.js";
import { p as fr } from "./wardley-RL74JXVD-DE4kNYCD.js";
import { c as Fe } from "./cytoscape.esm-CheSGy0x.js";
import { K as cr } from "./index-hX5IdXBW.js";
import "./min-Bc6fzmQn.js";
import "./_baseUniq-rMv7-Shc.js";
var he = { exports: {} },
  le = { exports: {} },
  fe = { exports: {} },
  gr = fe.exports,
        ...
        (function (P, L) {
          ...
          return (function (A) {
            ...
            function L(g) {
              ...
              var l = (P[g] = { i: g, l: !1, exports: {} });
              return (A[g].call(l.exports, l, l.exports, L), (l.l = !0), l.exports);
            }
            return (
              (L.m = A),
              (L.c = P),
              ...
              (L.d = function (g, l, a) {
                L.o(g, l) || Object.defineProperty(g, l, { configurable: !1, enumerable: !0, get: a });
              }),
              (L.n = function (g) {
                var l =
                  g && g.__esModule
            ...
            function (A, P, L) {
              function g() {}
              ((g.QUALITY = 1),
                (g.DEFAULT_CREATE_BENDS_AS_NEEDED = !1),
                (g.DEFAULT_INCREMENTAL = !1),
                (g.DEFAULT_ANIMATION_ON_LAYOUT = !0),
                (g.DEFAULT_ANIMATION_DURING_LAYOUT = !1),
                (g.DEFAULT_ANIMATION_PERIOD = 50),
                (g.DEFAULT_UNIFORM_LEAF_NODE_SIZES = !1),
                (g.DEFAULT_GRAPH_MARGIN = 15),
                (g.NODE_DIMENSIONS_INCLUDE_LABELS = !1),
                (g.SIMPLE_NODE_SIZE = 40),
                (g.SIMPLE_NODE_HALF_SIZE = g.SIMPLE_NODE_SIZE / 2),
                (g.EMPTY_COMPOUND_NODE_SIZE = 40),
                (g.MIN_EDGE_LENGTH = 1),
                (g.WORLD_BOUNDARY = 1e6),
                (g.INITIAL_WORLD_BOUNDARY = g.WORLD_BOUNDARY / 1e3),
                (g.WORLD_CENTER_X = 1200),
                (g.WORLD_CENTER_Y = 900),
                (A.exports = g));
            },
            function (A, P, L) {
              var g = L(2),
              ...
              ((e.prototype.getSource = function () {
                ...
                (e.prototype.getOtherEndInGraph = function (f, i) {
                  for (var u = this.getOtherEnd(f), t = i.getGraphManager().getRoot(); ; ) {
                    if (u.getOwner() == i) return u;
                    if (u.getOwner() == t) break;
                ...
                (e.prototype.updateLength = function () {
                  var f = new Array(4);
                  ((this.isOverlapingSourceAndTarget = l.getIntersection(
                    this.target.getRect(),
                    this.source.getRect(),
                    f
                  )),
            ...
            function (A, P, L) {
              ...
              function i(t, s, o, c) {
                (o == null && c == null && (c = s),
                  ...
                  (this.estimatedSize = l.MIN_VALUE),
                  (this.inclusionTreeDepth = l.MAX_VALUE),
                  (this.vGraphObject = c),
                  (this.edges = []),
                  (this.graphManager = t),
                  o != null && s != null ? (this.rect = new a(s.x, s.y, o.width, o.height)) : (this.rect = new a()));
              }
              i.prototype = Object.create(g.prototype);
              for (var u in g) i[u] = g[u];
              ((i.prototype.getEdges = function () {
                ...
                (i.prototype.getNeighborsList = function () {
                  var t = new Set(),
                    s = this;
                  return (
                    s.edges.forEach(function (o) {
                      if (o.source == s) t.add(o.target);
                      else {
                        if (o.target != s) throw "Incorrect incidency!";
                        t.add(o.source);
                      }
                    }),
                    t
                      ...
                      (this.labelWidth &&
                        ...
                        this.labelHeight &&
                          (this.labelPosVertical == "top"
                            ? ((this.rect.y -= this.labelHeight), this.setHeight(o + this.labelHeight))
                            : this.labelPosVertical == "center" && this.labelHeight > o
                              ? ((this.rect.y -= (this.labelHeight - o) / 2), this.setHeight(this.labelHeight))
                              : this.labelPosVertical == "bottom" && this.setHeight(o + this.labelHeight)));
                    }
                  }
                }),
            ...
            function (A, P, L) {
              ...
              ((l.MAX_ITERATIONS = 2500),
                (l.DEFAULT_EDGE_LENGTH = 50),
                (l.DEFAULT_SPRING_STRENGTH = 0.45),
                (l.DEFAULT_REPULSION_STRENGTH = 4500),
                (l.DEFAULT_GRAVITY_STRENGTH = 0.4),
                (l.DEFAULT_COMPOUND_GRAVITY_STRENGTH = 1),
                (l.DEFAULT_GRAVITY_RANGE_FACTOR = 3.8),
                (l.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = 1.5),
                (l.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION = !0),
                (l.DEFAULT_USE_SMART_REPULSION_RANGE_CALCULATION = !0),
                (l.DEFAULT_COOLING_FACTOR_INCREMENTAL = 0.3),
                (l.COOLING_ADAPTATION_FACTOR = 0.33),
                (l.ADAPTATION_LOWER_NODE_LIMIT = 1e3),
                (l.ADAPTATION_UPPER_NODE_LIMIT = 5e3),
                (l.MAX_NODE_DISPLACEMENT_INCREMENTAL = 100),
                (l.MAX_NODE_DISPLACEMENT = l.MAX_NODE_DISPLACEMENT_INCREMENTAL * 3),
                (l.MIN_REPULSION_DIST = l.DEFAULT_EDGE_LENGTH / 10),
                (l.CONVERGENCE_CHECK_PERIOD = 100),
                (l.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = 0.1),
                (l.MIN_EDGE_LENGTH = 1),
                (l.GRID_CALCULATION_CHECK_PERIOD = 10),
                (A.exports = l));
            },
            function (A, P, L) {
              function g(l, a) {
              ...
              ((s.prototype.getNodes = function () {
                ...
                (s.prototype.add = function (c, h, T) {
                  if (h == null && T == null) {
                    ...
                    if (this.getNodes().indexOf(d) > -1) throw "Node already in graph!";
                ...
                (s.prototype.remove = function (c) {
                  ...
                  if (c instanceof r) {
                    ...
                    for (var T = h.edges.slice(), d, v = T.length, N = 0; N < v; N++)
                      ((d = T[N]), d.isInterGraph ? this.graphManager.remove(d) : d.source.owner.remove(d));
                    var F = this.nodes.indexOf(h);
                    if (F == -1) throw "Node not in owner node list!";
                    this.nodes.splice(F, 1);
                  } else if (c instanceof f) {
                    var d = c;
                    if (d == null) throw "Edge is null!";
                    if (!(d.source != null && d.target != null)) throw "Source and/or target is null!";
                    if (
                      !(
                        d.source.owner != null &&
                        d.target.owner != null &&
                    ...
                    var C = d.source.edges.indexOf(d),
                      G = d.target.edges.indexOf(d);
                    ...
                    var F = d.source.owner.getEdges().indexOf(d);
                    if (F == -1) throw "Not in owner's edge list!";
                    d.source.owner.getEdges().splice(F, 1);
                  }
                }),
                (s.prototype.updateLeftTop = function () {
                  for (
                    var c = l.MAX_VALUE, h = l.MAX_VALUE, T, d, v, N = this.getNodes(), F = N.length, C = 0;
                    C < F;
                    C++
                  ) {
                    var G = N[C];
                ...
                (s.prototype.updateBounds = function (c) {
                  ...
                  (h == l.MAX_VALUE &&
                    ...
                    X[0].getParent().paddingLeft != null ? (Z = X[0].getParent().paddingLeft) : (Z = this.margin),
                    (this.left = n.x - Z),
                    (this.right = n.x + n.width + Z),
                    (this.top = n.y - Z),
                    (this.bottom = n.y + n.height + Z));
                }),
                ...
                (s.prototype.updateConnected = function () {
                  ...
                  for (
                    ...
                    for (var C = v.length, G = 0; G < C; G++) {
                      var Z = v[G];
                      if (((N = Z.getOtherEndInGraph(d, this)), N != null && !T.has(N))) {
            ...
            function (A, P, L) {
              var g,
                l = L(1);
              function a(e) {
                ((g = L(6)), (this.layout = e), (this.graphs = []), (this.edges = []));
              }
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.add = function (e, r, f, i, u) {
                  if (f == null && i == null && u == null) {
                    ...
                    if (t == s) return ((f.isInterGraph = !1), t.add(f, i, u));
                ...
                (a.prototype.remove = function (e) {
                  if (e instanceof g) {
                    ...
                    for (var i, u = f.length, t = 0; t < u; t++) ((i = f[t]), r.remove(i));
                    var s = [];
                    s = s.concat(r.getNodes());
                    var o;
                    u = s.length;
                    for (var t = 0; t < u; t++) ((o = s[t]), r.remove(o));
                ...
                (a.prototype.getAllEdges = function () {
                  if (this.allEdges == null) {
                    var e = [],
                      r = this.getGraphs();
                    r.length;
                    for (var f = 0; f < r.length; f++) e = e.concat(r[f].getEdges());
                ...
                (a.prototype.isOneAncestorOfOther = function (e, r) {
                  ...
                  var f = e.getOwner(),
                    i;
                  do {
                    if (((i = f.getParent()), i == null)) break;
                    if (i == r) return !0;
                    if (((f = i.getOwner()), f == null)) break;
                  } while (!0);
                  f = r.getOwner();
                  do {
                    if (((i = f.getParent()), i == null)) break;
                ...
                (a.prototype.calcLowestCommonAncestors = function () {
                  for (var e, r, f, i, u, t = this.getAllEdges(), s = t.length, o = 0; o < s; o++) {
                    if (
                      ((e = t[o]),
                      (r = e.source),
                      (f = e.target),
                    ...
                    for (i = r.getOwner(); e.lca == null; ) {
                      for (e.targetInLca = f, u = f.getOwner(); e.lca == null; ) {
                        if (u == i) {
                          e.lca = u;
                          break;
                        }
                        ...
                        ((e.targetInLca = u.getParent()), (u = e.targetInLca.getOwner()));
                      }
                ...
                (a.prototype.calcInclusionTreeDepths = function (e, r) {
                  ...
                  for (var f, i = e.getNodes(), u = i.length, t = 0; t < u; t++)
                    ((f = i[t]),
                      (f.inclusionTreeDepth = r),
                      f.child != null && this.calcInclusionTreeDepths(f.child, r + 1));
                }),
            ...
            function (A, P, L) {
              ...
              ((l.calcSeparationAmount = function (a, e, r, f) {
                ...
                var u = Math.abs((e.getCenterY() - a.getCenterY()) / (e.getCenterX() - a.getCenterX()));
                e.getCenterY() === a.getCenterY() && e.getCenterX() === a.getCenterX() && (u = 1);
                var t = u * r[0],
                  s = r[1] / u;
                (r[0] < s ? (s = r[0]) : (t = r[1]),
                  (r[0] = -1 * i[0] * (s / 2 + f)),
                ...
                (l.getIntersection2 = function (a, e, r) {
                  var f = a.getCenterX(),
                    ...
                    u = e.getCenterX(),
                    t = e.getCenterY();
                  if (a.intersects(e)) return ((r[0] = f), (r[1] = i), (r[2] = u), (r[3] = t), !0);
                  var s = a.getX(),
                    o = a.getY(),
                    c = a.getRight(),
                    h = a.getX(),
                    ...
                    m = !1;
                  if (f === u) {
                    if (i > t) return ((r[0] = f), (r[1] = o), (r[2] = u), (r[3] = X), !1);
                    if (i < t) return ((r[0] = f), (r[1] = T), (r[2] = u), (r[3] = C), !1);
                  } else if (i === t) {
                    if (f > u) return ((r[0] = s), (r[1] = i), (r[2] = G), (r[3] = t), !1);
                    if (f < u) return ((r[0] = c), (r[1] = i), (r[2] = F), (r[3] = t), !1);
                  } else {
                    ...
                    if (
                      (-p === y
                        ? f > u
                          ? ((r[0] = h), (r[1] = T), (n = !0))
                          : ((r[0] = c), (r[1] = o), (n = !0))
                        : p === y && (f > u ? ((r[0] = s), (r[1] = o), (n = !0)) : ((r[0] = d), (r[1] = T), (n = !0))),
                      -E === y
                        ? u > f
                          ? ((r[2] = Z), (r[3] = X), (m = !0))
                          : ((r[2] = G), (r[3] = C), (m = !0))
                        : E === y && (u > f ? ((r[2] = F), (r[3] = C), (m = !0)) : ((r[2] = K), (r[3] = X), (m = !0))),
                      n && m)
                    )
                      return !1;
                    if (
                      (f > u
                        ? i > t
                          ? ((I = this.getCardinalDirection(p, y, 4)), (w = this.getCardinalDirection(E, y, 2)))
                          : ((I = this.getCardinalDirection(-p, y, 3)), (w = this.getCardinalDirection(-E, y, 1)))
                        : i > t
                          ? ((I = this.getCardinalDirection(-p, y, 1)), (w = this.getCardinalDirection(-E, y, 3)))
                          : ((I = this.getCardinalDirection(p, y, 2)), (w = this.getCardinalDirection(E, y, 4))),
                      !n)
                    )
                      switch (I) {
                        case 1:
                          ((W = o), (S = f + -N / y), (r[0] = S), (r[1] = W));
                          break;
                        case 2:
                          ((S = d), (W = i + v * y), (r[0] = S), (r[1] = W));
                          break;
                        case 3:
                          ((W = T), (S = f + N / y), (r[0] = S), (r[1] = W));
                          break;
                        case 4:
                          ((S = h), (W = i + -v * y), (r[0] = S), (r[1] = W));
                          break;
                      }
                    if (!m)
                      switch (w) {
                        case 1:
                          ((q = C), (x = u + -rt / y), (r[2] = x), (r[3] = q));
                          break;
                        case 2:
                          ((x = K), (q = t + D * y), (r[2] = x), (r[3] = q));
                          break;
                        case 3:
                          ((q = X), (x = u + rt / y), (r[2] = x), (r[3] = q));
                          break;
                        case 4:
                          ((x = Z), (q = t + -D * y), (r[2] = x), (r[3] = q));
                          break;
                      }
                  }
                  return !1;
                ...
                (l.getIntersection = function (a, e, r, f) {
                  if (f == null) return this.getIntersection2(a, e, r);
                  var i = a.x,
                    u = a.y,
                    t = e.x,
                    s = e.y,
                  ...
                  return (
                    ...
                    (X = h * c - o * T),
                    (K = N * G - F * C),
                    K === 0 ? null : ((d = (C * X - G * Z) / K), (v = (F * Z - N * X) / K), new g(d, v))
                  );
                }),
                (l.angleOfVector = function (a, e, r, f) {
                  ...
                  return (
                    a !== r
                      ? ((i = Math.atan((f - e) / (r - a))), r < a ? (i += Math.PI) : f < e && (i += this.TWO_PI))
                      : f < e
                ...
                (l.doIntersect = function (a, e, r, f) {
                  var i = a.x,
                    ...
                    d = (t - i) * (T - c) - (h - o) * (s - u);
                  if (d === 0) return !1;
                  var v = ((T - c) * (h - i) + (o - h) * (T - u)) / d,
                    N = ((u - s) * (h - i) + (t - i) * (T - u)) / d;
                  return 0 < v && v < 1 && 0 < N && N < 1;
                }),
                (l.findCircleLineIntersections = function (a, e, r, f, i, u, t) {
                  var s = (r - a) * (r - a) + (f - e) * (f - e),
                    o = 2 * ((a - i) * (r - a) + (e - u) * (f - e)),
                    c = (a - i) * (a - i) + (e - u) * (e - u) - t * t,
                    h = o * o - 4 * s * c;
                  if (h >= 0) {
                    var T = (-o + Math.sqrt(o * o - 4 * s * c)) / (2 * s),
                      d = (-o - Math.sqrt(o * o - 4 * s * c)) / (2 * s),
                      v = null;
                    return T >= 0 && T <= 1 ? [T] : d >= 0 && d <= 1 ? [d] : v;
                  } else return null;
                }),
                (l.HALF_PI = 0.5 * Math.PI),
                (l.ONE_AND_HALF_PI = 1.5 * Math.PI),
                (l.TWO_PI = 2 * Math.PI),
                (l.THREE_PI = 3 * Math.PI),
                (A.exports = l));
            },
            function (A, P, L) {
              function g() {}
            ...
            function (A, P, L) {
              ...
              var a = function (u) {
                ...
                e = function (u, t, s, o) {
                  return (
                    u !== null ? (u.next = t) : (o.head = t),
                    s !== null ? (s.prev = t) : (o.tail = t),
                    (t.prev = u),
                    (t.next = s),
                    o.length++,
                    t
                ...
                r = function (u, t) {
                  var s = u.prev,
                    o = u.next;
                  return (
                    s !== null ? (s.next = o) : (t.head = o),
                    o !== null ? (o.prev = s) : (t.tail = s),
                    (u.prev = u.next = null),
                    t.length--,
                    u
                  );
                  ...
                  return (
                    g(i, [
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          if (t <= this.length()) {
                            for (var s = 1, o = this.head; s < t; ) ((o = o.next), s++);
                            return o.value;
                          }
                        },
                      },
                      {
                        ...
                        value: function (t, s) {
                          if (t <= this.length()) {
                            for (var o = 1, c = this.head; o < t; ) ((c = c.next), o++);
                            c.value = s;
                          }
                        },
                      },
            ...
            function (A, P, L) {
              function g(l, a, e) {
                ((this.x = null),
                  (this.y = null),
                  l == null && a == null && e == null
                    ? ((this.x = 0), (this.y = 0))
                    : typeof l == "number" && typeof a == "number" && e == null
                      ? ((this.x = l), (this.y = a))
                      : l.constructor.name == "Point" &&
                        a == null &&
                        e == null &&
                        ((e = l), (this.x = e.x), (this.y = e.y)));
              }
              ((g.prototype.getX = function () {
                return this.x;
              }),
                ...
                (g.prototype.setLocation = function (l, a, e) {
                  l.constructor.name == "Point" && a == null && e == null
                    ? ((e = l), this.setLocation(e.x, e.y))
                    : typeof l == "number" &&
                      typeof a == "number" &&
                      e == null &&
                      (parseInt(l) == l && parseInt(a) == a
                        ? this.move(l, a)
                        : ((this.x = Math.floor(l + 0.5)), (this.y = Math.floor(a + 0.5))));
                }),
              ...
              function g(l, a, e, r) {
                ((this.x = 0),
                  ...
                  l != null &&
                    ...
                    e != null &&
                    r != null &&
                    ((this.x = l), (this.y = a), (this.width = e), (this.height = r)));
              }
              ((g.prototype.getX = function () {
                return this.x;
              }),
            ...
            function (A, P, L) {
              ...
              function l() {}
              ((l.lastID = 0),
                (l.createID = function (a) {
                  return l.isPrimitive(a)
                    ? a
                    : (a.uniqueID != null || ((a.uniqueID = l.getString()), l.lastID++), a.uniqueID);
                }),
                (l.getString = function (a) {
                  return (a == null && (a = l.lastID), "Object#" + a);
                }),
                (l.isPrimitive = function (a) {
                  var e = typeof a > "u" ? "undefined" : g(a);
            ...
            function (A, P, L) {
              function g(o) {
                if (Array.isArray(o)) {
                  for (var c = 0, h = Array(o.length); c < o.length; c++) h[c] = o[c];
                  return h;
              ...
              function s(o) {
                (t.call(this),
                  (this.layoutQuality = l.QUALITY),
                  (this.createBendsAsNeeded = l.DEFAULT_CREATE_BENDS_AS_NEEDED),
                  (this.incremental = l.DEFAULT_INCREMENTAL),
                  (this.animationOnLayout = l.DEFAULT_ANIMATION_ON_LAYOUT),
                  (this.animationDuringLayout = l.DEFAULT_ANIMATION_DURING_LAYOUT),
                  (this.animationPeriod = l.DEFAULT_ANIMATION_PERIOD),
                  (this.uniformLeafNodeSizes = l.DEFAULT_UNIFORM_LEAF_NODE_SIZES),
                  (this.edgeToDummyNodes = new Map()),
                  (this.graphManager = new a(this)),
                  (this.isLayoutFinished = !1),
                  (this.isSubLayout = !1),
                  (this.isRemoteUse = !1),
                  o != null && (this.isRemoteUse = o));
              }
              ((s.RANDOM_SEED = 1),
                ...
                (s.prototype.runLayout = function () {
                  ...
                  var o;
                  return (
                    this.checkLayoutSuccess() ? (o = !1) : (o = this.layout()),
                    l.ANIMATE === "during"
                      ? !1
                      : (o && (this.isSubLayout || this.doPostLayout()),
                ...
                (s.prototype.update2 = function () {
                  if (
                    ...
                    for (var o = this.graphManager.getAllEdges(), c = 0; c < o.length; c++) o[c];
                  ...
                  for (C = C.concat(h); C.length > 0 && c; ) {
                    for (N.push(C[0]); N.length > 0 && c; ) {
                      ...
                      for (var Z = G.getEdges(), d = 0; d < Z.length; d++) {
                        var X = Z[d].getOtherEnd(G);
                        if (F.get(G) != X)
                          if (!v.has(X)) (N.push(X), F.set(X, G));
                          else {
                            c = !1;
                            break;
                          }
                ...
                (s.prototype.createDummyNodesForBendpoints = function (o) {
                  for (
                    var c = [], h = o.source, T = this.graphManager.calcLowestCommonAncestor(o.source, o.target), d = 0;
                    d < o.bendpoints.length;
                    d++
                  ) {
                  ...
                  var N = this.newEdge(null);
                  return (
                    this.graphManager.add(N, h, o.target),
                    this.edgeToDummyNodes.set(o, c),
                    o.isInterGraph() ? this.graphManager.remove(o) : T.remove(o),
                    c
                  );
                }),
                (s.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  ((o = o.concat(this.graphManager.getAllEdges())),
                    (o = [].concat(g(this.edgeToDummyNodes.keys())).concat(o)));
                    ...
                    if (h.bendpoints.length > 0) {
                      for (var T = this.edgeToDummyNodes.get(h), d = 0; d < T.length; d++) {
                        var v = T[d],
                          ...
                          F = h.bendpoints.get(d);
                        ((F.x = N.x), (F.y = N.y), v.getOwner().remove(v));
                      }
                ...
                (s.transform = function (o, c, h, T) {
                  if (h != null && T != null) {
                    ...
                    var F, C;
                    return (
                      o <= 50 ? ((F = (9 * c) / 500), (C = c / 10)) : ((F = (9 * c) / 50), (C = -8 * c)),
                      F * o + C
                    );
                  }
                }),
                (s.findCenterOfTree = function (o) {
                  ...
                  for (var N = 0; N < c.length; N++) {
                    var F = c[N],
                      C = F.getNeighborsList().size;
                    (T.set(F, F.getNeighborsList().size), C == 1 && h.push(F));
                  }
                  var G = [];
                  for (G = G.concat(h); !d; ) {
                    var Z = [];
            ...
            function (A, P, L) {
              ...
              ((l.prototype.getWorldOrgX = function () {
                ...
                (l.prototype.inverseTransformPoint = function (a) {
                  var e = new g(this.inverseTransformX(a.x), this.inverseTransformY(a.y));
                  return e;
                }),
                (A.exports = l));
            },
            function (A, P, L) {
              function g(t) {
                if (Array.isArray(t)) {
                  for (var s = 0, o = Array(t.length); s < t.length; s++) o[s] = t[s];
                  return o;
              ...
              ((i.prototype.initParameters = function () {
                ...
                (i.prototype.calcIdealEdgeLengths = function () {
                  for (var t, s, o, c, h, T, d, v = this.getGraphManager().getAllEdges(), N = 0; N < v.length; N++)
                    ((t = v[N]),
                      (s = t.idealLength),
                      t.isInterGraph &&
                        ((c = t.getSource()),
                        ...
                        (o = t.getLca().getInclusionTreeDepth()),
                        (t.idealLength +=
                          s *
                          a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR *
                          (c.getInclusionTreeDepth() + h.getInclusionTreeDepth() - 2 * o))));
                }),
                ...
                (i.prototype.moveNodes = function () {
                  for (var t = this.getAllNodes(), s, o = 0; o < t.length; o++) ((s = t[o]), s.move());
                }),
                (i.prototype.calcSpringForce = function (t, s) {
                  var o = t.getSource(),
                    ...
                    d,
                    v;
                  if (this.uniformLeafNodeSizes && o.getChild() == null && c.getChild() == null) t.updateLengthSimple();
                  else if ((t.updateLength(), t.isOverlapingSourceAndTarget)) return;
                  ((h = t.getLength()),
                    h != 0 &&
                      ((T = t.edgeElasticity * (h - s)),
                      (d = T * (t.lengthX / h)),
                      (v = T * (t.lengthY / h)),
                      (o.springForceX += d),
                      (o.springForceY += v),
                ...
                (i.prototype.calcRepulsionForce = function (t, s) {
                  var o = t.getRect(),
                    ...
                    Z;
                  if (o.intersects(c)) {
                    (r.calcSeparationAmount(o, c, h, a.DEFAULT_EDGE_LENGTH / 2), (G = 2 * h[0]), (Z = 2 * h[1]));
                    var X = (t.noOfChildren * s.noOfChildren) / (t.noOfChildren + s.noOfChildren);
                    ((t.repulsionForceX -= X * G),
                      (t.repulsionForceY -= X * Z),
                      (s.repulsionForceX += X * G),
                      (s.repulsionForceY += X * Z));
                  } else
                    (this.uniformLeafNodeSizes && t.getChild() == null && s.getChild() == null
                      ? ((d = c.getCenterX() - o.getCenterX()), (v = c.getCenterY() - o.getCenterY()))
                      : (r.getIntersection(o, c, T), (d = T[2] - T[0]), (v = T[3] - T[1])),
                      Math.abs(d) < a.MIN_REPULSION_DIST && (d = f.sign(d) * a.MIN_REPULSION_DIST),
                      Math.abs(v) < a.MIN_REPULSION_DIST && (v = f.sign(v) * a.MIN_REPULSION_DIST),
                      (N = d * d + v * v),
                      (F = Math.sqrt(N)),
                      (C = ((t.nodeRepulsion / 2 + s.nodeRepulsion / 2) * t.noOfChildren * s.noOfChildren) / N),
                      (G = (C * d) / F),
                      (Z = (C * v) / F),
                      (t.repulsionForceX -= G),
                      (t.repulsionForceY -= Z),
                ...
                (i.prototype.calcGravitationalForce = function (t) {
                  var s, o, c, h, T, d, v, N;
                  ((s = t.getOwner()),
                    (o = (s.getRight() + s.getLeft()) / 2),
                    (c = (s.getTop() + s.getBottom()) / 2),
                    (h = t.getCenterX() - o),
                    (T = t.getCenterY() - c),
                    (d = Math.abs(h) + t.getWidth() / 2),
                    (v = Math.abs(T) + t.getHeight() / 2),
                    t.getOwner() == this.graphManager.getRoot()
                      ? ((N = s.getEstimatedSize() * this.gravityRangeFactor),
                        (d > N || v > N) &&
                          ((t.gravitationForceX = -this.gravityConstant * h),
                          (t.gravitationForceY = -this.gravityConstant * T)))
                      : ((N = s.getEstimatedSize() * this.compoundGravityRangeFactor),
                        (d > N || v > N) &&
                ...
                (i.prototype.calcGrid = function (t) {
                  ...
                  ((s = parseInt(Math.ceil((t.getRight() - t.getLeft()) / this.repulsionRange))),
                    (o = parseInt(Math.ceil((t.getBottom() - t.getTop()) / this.repulsionRange))));
                  for (var c = new Array(s), h = 0; h < s; h++) c[h] = new Array(o);
                  for (var h = 0; h < s; h++) for (var T = 0; T < o; T++) c[h][T] = new Array();
                  return c;
                }),
                (i.prototype.addNodeToGrid = function (t, s, o) {
                  var c = 0,
                    ...
                    T = 0,
                    d = 0;
                  ((c = parseInt(Math.floor((t.getRect().x - s) / this.repulsionRange))),
                    (h = parseInt(Math.floor((t.getRect().width + t.getRect().x - s) / this.repulsionRange))),
                    (T = parseInt(Math.floor((t.getRect().y - o) / this.repulsionRange))),
                    (d = parseInt(Math.floor((t.getRect().height + t.getRect().y - o) / this.repulsionRange))));
                  for (var v = c; v <= h; v++)
                    for (var N = T; N <= d; N++) (this.grid[v][N].push(t), t.setGridCoordinates(c, h, T, d));
                }),
                  ...
                  if ((this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && o) || c) {
                    ...
                    for (var T, d = this.grid, v = t.startX - 1; v < t.finishX + 2; v++)
                      for (var N = t.startY - 1; N < t.finishY + 2; N++)
                        if (!(v < 0 || N < 0 || v >= d.length || N >= d[0].length)) {
                          for (var F = 0; F < d[v][N].length; F++)
                            if (
                              ((T = d[v][N][F]), !(t.getOwner() != T.getOwner() || t == T) && !s.has(T) && !h.has(T))
                            ) {
            ...
            function (A, P, L) {
              ...
              function a(r, f, i) {
                (g.call(this, r, f, i),
                  (this.idealLength = l.DEFAULT_EDGE_LENGTH),
                  (this.edgeElasticity = l.DEFAULT_SPRING_STRENGTH));
              }
            ...
            function (A, P, L) {
              ...
              function a(r, f, i, u) {
                (g.call(this, r, f, i, u),
                  (this.nodeRepulsion = l.DEFAULT_REPULSION_STRENGTH),
                  (this.springForceX = 0),
                  (this.springForceY = 0),
              ...
              a.prototype = Object.create(g.prototype);
              for (var e in g) a[e] = g[e];
              ((a.prototype.setGridCoordinates = function (r, f, i, u) {
                ((this.startX = r), (this.finishX = f), (this.startY = i), (this.finishY = u));
              }),
                (A.exports = a));
            },
            function (A, P, L) {
              function g(l, a) {
                ((this.width = 0),
                  (this.height = 0),
                  l !== null && a !== null && ((this.height = a), (this.width = l)));
              }
              ((g.prototype.getWidth = function () {
                return this.width;
              }),
            ...
            function (A, P, L) {
              ...
              ((l.prototype.add = function (a) {
                ...
                (l.prototype.addAllTo = function (a) {
                  for (var e = Object.keys(this.set), r = e.length, f = 0; f < r; f++) a.push(this.set[e[f]]);
                }),
                (l.prototype.size = function () {
                  return Object.keys(this.set).length;
                }),
            ...
            function (A, P, L) {
              function g() {}
              ((g.multMat = function (l, a) {
                for (var e = [], r = 0; r < l.length; r++) {
                  e[r] = [];
                  for (var f = 0; f < a[0].length; f++) {
                    e[r][f] = 0;
                    for (var i = 0; i < l[0].length; i++) e[r][f] += l[r][i] * a[i][f];
                  }
                }
                return e;
              }),
                (g.transpose = function (l) {
                  for (var a = [], e = 0; e < l[0].length; e++) {
                    a[e] = [];
                    for (var r = 0; r < l.length; r++) a[e][r] = l[r][e];
                  }
                  return a;
                }),
                (g.multCons = function (l, a) {
                  for (var e = [], r = 0; r < l.length; r++) e[r] = l[r] * a;
                  return e;
                }),
                (g.minusOp = function (l, a) {
                  for (var e = [], r = 0; r < l.length; r++) e[r] = l[r] - a[r];
                  return e;
                }),
                (g.dotProduct = function (l, a) {
                  for (var e = 0, r = 0; r < l.length; r++) e += l[r] * a[r];
                  return e;
                }),
                (g.mag = function (l) {
                ...
                (g.normalize = function (l) {
                  for (var a = [], e = this.mag(l), r = 0; r < l.length; r++) a[r] = l[r] / e;
                  return a;
                }),
                (g.multGamma = function (l) {
                  for (var a = [], e = 0, r = 0; r < l.length; r++) e += l[r];
                  e *= -1 / l.length;
                  for (var f = 0; f < l.length; f++) a[f] = e + l[f];
                  return a;
                }),
                (g.multL = function (l, a, e) {
                  for (var r = [], f = [], i = [], u = 0; u < a[0].length; u++) {
                    for (var t = 0, s = 0; s < a.length; s++) t += -0.5 * a[s][u] * l[s];
                    f[u] = t;
                  }
                  for (var o = 0; o < e.length; o++) {
                    for (var c = 0, h = 0; h < e.length; h++) c += e[o][h] * f[h];
                    i[o] = c;
                  }
                  for (var T = 0; T < a.length; T++) {
                    for (var d = 0, v = 0; v < a[0].length; v++) d += a[T][v] * i[v];
                    r[T] = d;
                  }
                  return r;
                }),
            ...
            function (A, P, L) {
              var g = (function () {
                ...
                return function (f, i, u) {
                  return (i && r(f.prototype, i), u && r(f, u), f);
                };
              })();
              function l(r, f) {
                      ...
                      },
                      {
                        ...
                        value: function (i, u, t) {
                          for (var s = this._get(i, u), o = u, c = t; ; ) {
                            for (; this.compareFunction(s, this._get(i, c)); ) c--;
                            for (; this.compareFunction(this._get(i, o), s); ) o++;
                            if (o < c) (this._swap(i, o, c), o++, c--);
                            else return c;
                          }
                        },
                      },
              ...
              ((g.svd = function (l) {
                ...
                for (
                  var e = (function (Tt) {
                    ...
                    u = Math.max(0, Math.min(this.n - 2, this.m)),
                    t = 0;
                  t < Math.max(i, u);
                  t++
                ) {
                  if (t < i) {
                    this.s[t] = 0;
                    for (var s = t; s < this.m; s++) this.s[t] = g.hypot(this.s[t], l[s][t]);
                    if (this.s[t] !== 0) {
                      l[t][t] < 0 && (this.s[t] = -this.s[t]);
                      for (var o = t; o < this.m; o++) l[o][t] /= this.s[t];
                      l[t][t] += 1;
                    }
                    this.s[t] = -this.s[t];
                  }
                  for (var c = t + 1; c < this.n; c++) {
                    if (
                      ...
                      for (var h = 0, T = t; T < this.m; T++) h += l[T][t] * l[T][c];
                      h = -h / l[t][t];
                      for (var d = t; d < this.m; d++) l[d][c] += h * l[d][t];
                    }
                    e[c] = l[t][c];
                  }
                  if (
                    ...
                    for (var v = t; v < this.m; v++) this.U[v][t] = l[v][t];
                  if (t < u) {
                    e[t] = 0;
                    for (var N = t + 1; N < this.n; N++) e[t] = g.hypot(e[t], e[N]);
                    if (e[t] !== 0) {
                      e[t + 1] < 0 && (e[t] = -e[t]);
                      for (var F = t + 1; F < this.n; F++) e[F] /= e[t];
                      e[t + 1] += 1;
                    }
                    if (
                      ((e[t] = -e[t]),
                      ...
                      for (var G = t + 1; G < this.n; G++) for (var Z = t + 1; Z < this.m; Z++) r[Z] += e[G] * l[Z][G];
                      for (var X = t + 1; X < this.n; X++)
                        for (var K = -e[X] / e[t + 1], D = t + 1; D < this.m; D++) l[D][X] += K * r[D];
                    }
                    for (var rt = t + 1; rt < this.n; rt++) this.V[rt][t] = e[rt];
                  }
                }
                var n = Math.min(this.n, this.m + 1);
                (i < this.n && (this.s[i] = l[i][i]),
                  ...
                  (e[n - 1] = 0));
                {
                  ...
                  for (var E = i - 1; E >= 0; E--)
                    if (this.s[E] !== 0) {
                      for (var y = E + 1; y < a; y++) {
                        for (var I = 0, w = E; w < this.m; w++) I += this.U[w][E] * this.U[w][y];
                        I = -I / this.U[E][E];
                        for (var S = E; S < this.m; S++) this.U[S][y] += I * this.U[S][E];
                      }
                      for (var W = E; W < this.m; W++) this.U[W][E] = -this.U[W][E];
                      this.U[E][E] = 1 + this.U[E][E];
                      for (var x = 0; x < E - 1; x++) this.U[x][E] = 0;
                    } else {
                      for (var q = 0; q < this.m; q++) this.U[q][E] = 0;
                      this.U[E][E] = 1;
                    }
                }
                for (var V = this.n - 1; V >= 0; V--) {
                  if (
                    ...
                    for (var Y = V + 1; Y < a; Y++) {
                      ...
                      et = -et / this.V[V + 1][V];
                      for (var O = V + 1; O < this.n; O++) this.V[O][Y] += et * this.V[O][V];
                    }
                    ...
                    case 4:
                      {
                        if (this.s[Q] <= 0) {
                          ...
                          for (var ot = 0; ot <= $; ot++) this.V[ot][Q] = -this.V[ot][Q];
                        }
                ...
                (g.hypot = function (l, a) {
                  ...
                  return (
                    Math.abs(l) > Math.abs(a)
                      ? ((e = a / l), (e = Math.abs(l) * Math.sqrt(1 + e * e)))
                      : a != 0
                        ? ((e = l / a), (e = Math.abs(a) * Math.sqrt(1 + e * e)))
                        : (e = 0),
                    e
                  );
                }),
              ...
              var a = (function () {
                function e(r, f) {
                  ...
                  for (var s = 0; s < this.iMax; s++) {
                    ...
                    for (var o = 0; o < this.jMax; o++) this.grid[s][o] = 0;
                  }
                ...
                return (
                  g(e, [
                      ...
                      value: function () {
                        ...
                        for (var u = 1; u < this.iMax; u++)
                          for (var t = 1; t < this.jMax; t++) {
                            var s = void 0;
                            this.sequence1[u - 1] === this.sequence2[t - 1]
                              ? (s = this.grid[u - 1][t - 1] + this.match_score)
                              : (s = this.grid[u - 1][t - 1] + this.mismatch_penalty);
                            var o = this.grid[u - 1][t] + this.gap_penalty,
                              c = this.grid[u][t - 1] + this.gap_penalty,
                              h = [s, o, c],
                              T = this.arrayAllMaxIndexes(h);
                            ((this.grid[u][t] = h[T[0]]),
                              (this.tracebackGrid[u][t] = [T.includes(0), T.includes(1), T.includes(2)]));
                          }
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (
                          ...
                          var i = f[0],
                            u = this.tracebackGrid[i.pos[0]][i.pos[1]];
                          (u[0] &&
                            f.push({
                    ...
                    },
                    {
                      key: "getAllIndexes",
                      value: function (f, i) {
                        for (var u = [], t = -1; (t = f.indexOf(i, t + 1)) !== -1; ) u.push(t);
                        return u;
                      },
                    },
                    {
            ...
            function (A, P, L) {
              ...
              ((g.FDLayout = L(18)),
                ...
                (g.LNode = L(3)),
                (g.Layout = L(15)),
                (g.LayoutConstants = L(0)),
                (g.NeedlemanWunsch = L(27)),
                (g.Matrix = L(24)),
                (g.SVD = L(26)),
                (A.exports = g));
            },
          ...
          return (() => {
            var P = {
                45: (a, e, r) => {
                  var f = {};
                  ((f.layoutBase = r(551)),
                    (f.CoSEConstants = r(806)),
                    (f.CoSEEdge = r(767)),
                    (f.CoSEGraph = r(880)),
                    (f.CoSEGraphManager = r(578)),
                    (f.CoSELayout = r(765)),
                    (f.CoSENode = r(991)),
                    (f.ConstraintHandler = r(902)),
                    (a.exports = f));
                },
                806: (a, e, r) => {
                  var f = r(551).FDLayoutConstants;
                  function i() {}
                  for (var u in f) i[u] = f[u];
                  ((i.DEFAULT_USE_MULTI_LEVEL_SCALING = !1),
                    (i.DEFAULT_RADIAL_SEPARATION = f.DEFAULT_EDGE_LENGTH),
                  ...
                  ((D.prototype.newGraphManager = function () {
                    ...
                    (D.prototype.classicLayout = function () {
                      if (
                        ...
                        if (o.TREE_REDUCTION_ON_INCREMENTAL) {
                          ...
                          var m = new Set(this.getAllNodes()),
                            p = this.nodesWithGravity.filter(function (I) {
                              return m.has(I);
                            });
                      ...
                      return (
                        ...
                        o.APPLY_LAYOUT && this.runSpringEmbedder(),
                        !0
                      );
                    }),
                    ...
                    (D.prototype.initConstraintVariables = function () {
                      ...
                      var y = function O(H) {
                        for (var $ = H.getChild().getNodes(), _, ht = 0, Q = 0; Q < $.length; Q++)
                          ((_ = $[Q]), _.getChild() == null ? n.fixedNodeSet.has(_.id) && (ht += 100) : (ht += O(_)));
                        return ht;
                      };
                        ...
                        if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                          ((this.shuffle = function (O) {
                            ...
                            this.constraints.relativePlacementConstraint.forEach(function (O) {
                              if (O.left) {
                                var H = w.has(O.left) ? w.get(O.left) : O.left,
                                  $ = w.has(O.right) ? w.get(O.right) : O.right;
                                (n.nodesInRelativeHorizontal.includes(H) ||
                                  ...
                                  n.nodesInRelativeHorizontal.includes($) ||
                                    (n.nodesInRelativeHorizontal.push($),
                                    n.nodeToRelativeConstraintMapHorizontal.set($, []),
                                    n.dummyToNodeForVerticalAlignment.has($)
                                      ? n.nodeToTempPositionMapHorizontal.set(
                                          $,
                                          n.idToNodeMap.get(n.dummyToNodeForVerticalAlignment.get($)[0]).getCenterX()
                                        )
                                      : n.nodeToTempPositionMapHorizontal.set($, n.idToNodeMap.get($).getCenterX())),
                                  n.nodeToRelativeConstraintMapHorizontal.get(H).push({ right: $, gap: O.gap }),
                                  n.nodeToRelativeConstraintMapHorizontal.get($).push({ left: H, gap: O.gap }));
                              } else {
                                var _ = S.has(O.top) ? S.get(O.top) : O.top,
                                  ht = S.has(O.bottom) ? S.get(O.bottom) : O.bottom;
                                (n.nodesInRelativeVertical.includes(_) ||
                                  ...
                                  n.nodesInRelativeVertical.includes(ht) ||
                                    ...
                                    n.dummyToNodeForHorizontalAlignment.has(ht)
                                      ? n.nodeToTempPositionMapVertical.set(
                                          ht,
                                          n.idToNodeMap.get(n.dummyToNodeForHorizontalAlignment.get(ht)[0]).getCenterY()
                                        )
                                      : n.nodeToTempPositionMapVertical.set(ht, n.idToNodeMap.get(ht).getCenterY())),
                                  n.nodeToRelativeConstraintMapVertical.get(_).push({ bottom: ht, gap: O.gap }),
                                  n.nodeToRelativeConstraintMapVertical.get(ht).push({ top: _, gap: O.gap }));
                              }
                            }));
                        else {
                          var q = new Map(),
                          ...
                          this.constraints.relativePlacementConstraint.forEach(function (O) {
                            if (O.left) {
                              var H = w.has(O.left) ? w.get(O.left) : O.left,
                                $ = w.has(O.right) ? w.get(O.right) : O.right;
                              (q.has(H) ? q.get(H).push($) : q.set(H, [$]),
                                q.has($) ? q.get($).push(H) : q.set($, [H]));
                            } else {
                              var _ = S.has(O.top) ? S.get(O.top) : O.top,
                                ht = S.has(O.bottom) ? S.get(O.bottom) : O.bottom;
                        ...
                        if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                            ...
                            this.nodesInRelativeHorizontal.forEach(function (z) {
                              if (!n.fixedNodesOnHorizontal.has(z)) {
                                ...
                                (n.dummyToNodeForVerticalAlignment.has(z)
                                  ? (O = n.idToNodeMap.get(n.dummyToNodeForVerticalAlignment.get(z)[0]).displacementX)
                                  : (O = n.idToNodeMap.get(z).displacementX),
                                  ...
                                  n.nodeToTempPositionMapHorizontal.set(
                                    z,
                                    n.nodeToTempPositionMapHorizontal.get(z) + O
                                  ),
                                  n.dummyToNodeForVerticalAlignment.has(z)
                            ...
                            this.nodesInRelativeVertical.forEach(function (z) {
                              if (!n.fixedNodesOnHorizontal.has(z)) {
                                ...
                                (n.dummyToNodeForHorizontalAlignment.has(z)
                                  ? (O = n.idToNodeMap.get(n.dummyToNodeForHorizontalAlignment.get(z)[0]).displacementY)
                                  : (O = n.idToNodeMap.get(z).displacementY),
                                  ...
                                  n.nodeToTempPositionMapVertical.set(z, n.nodeToTempPositionMapVertical.get(z) + O),
                                  n.dummyToNodeForHorizontalAlignment.has(z)
                          ...
                          for (var p = 0; p < this.componentsOnHorizontal.length; p++) {
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              for (var y = 0; y < x.length; y++)
                                this.dummyToNodeForVerticalAlignment.has(x[y])
                                  ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function (H) {
                              ...
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                ...
                                } else ((q += this.idToNodeMap.get(x[y]).displacementX), V++);
                          ...
                          for (var p = 0; p < this.componentsOnVertical.length; p++) {
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              for (var y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                                  ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function ($) {
                              ...
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                ...
                                } else ((q += this.idToNodeMap.get(x[y]).displacementY), V++);
                              for (var et = q / V, y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                                  ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function (Q) {
                      ...
                      for (p = 0; p < n.length; p++) {
                        ...
                        if (!m.has(E)) {
                          ...
                          if (y == I)
                            ...
                            var w = [];
                            if (
                              ((w = w.concat(y.getEdgeListToNode(I))),
                              (w = w.concat(I.getEdgeListToNode(y))),
                              !m.has(w[0]))
                            ) {
                              if (w.length > 1) {
                                var S;
                    ...
                    (D.prototype.positionNodesRadially = function (n) {
                      for (
                        ...
                        S % p == 0 && ((I = 0), (y = E), S != 0 && (y += o.DEFAULT_COMPONENT_SEPERATION), (E = 0));
                        var W = n[S],
                          x = F.findCenterOfTree(W);
                        ((m.x = I),
                          (m.y = y),
                          (w = D.radialLayout(W, x, m)),
                          w.y > E && (E = Math.floor(w.y)),
                          (I = Math.floor(w.x + o.DEFAULT_COMPONENT_SEPERATION)));
                      }
                    ...
                    (D.radialLayout = function (n, m, p) {
                      ...
                      var y = Z.calculateBounds(n),
                        I = new X();
                      (I.setDeviceOrgX(y.getMinX()),
                        I.setDeviceOrgY(y.getMinY()),
                        I.setWorldOrgX(p.x),
                        I.setWorldOrgY(p.y));
                    ...
                    (D.branchRadialLayout = function (n, m, p, E, y, I) {
                      ...
                      for (var ht = Math.abs(E - p) / Y, Q = O; et != Y; Q = ++Q % z) {
                        var It = V[Q].getOtherEnd(n);
                        if (It != m) {
                          var Nt = (p + et * ht) % 360,
                            vt = (Nt + ht) % 360;
                          (D.branchRadialLayout(It, n, Nt, vt, y + I, I), et++);
                        }
                      }
                    }),
                    ...
                    (D.prototype.groupZeroDegreeMembers = function () {
                      ...
                      for (var y = 0; y < p.length; y++) {
                        var I = p[y],
                          S = I.getParent().id;
                        (typeof m[S] > "u" && (m[S] = []), (m[S] = m[S].concat(I)));
                      }
                      Object.keys(m).forEach(function (W) {
                        if (m[W].length > 1) {
                          var x = "DummyCompound_" + W;
                          n.memberGroups[x] = m[W];
                          var q = m[W][0].getParent(),
                          ...
                          (E.labelWidth &&
                            ...
                            E.labelHeight &&
                              (E.labelPosVertical == "top"
                                ...
                                : E.labelPosVertical == "center" && E.labelHeight > I
                                  ? ((E.rect.y -= (E.labelHeight - I) / 2),
                                    E.setHeight(E.labelHeight),
                                    (E.labelMarginTop = (E.labelHeight - I) / 2))
                                  : E.labelPosVertical == "bottom" && E.setHeight(I + E.labelHeight)));
                        }
                      });
                    }),
                    ...
                    (D.prototype.repopulateZeroDegreeMembers = function () {
                      ...
                      Object.keys(m).forEach(function (p) {
                        var E = n.idToDummyNode[p],
                          ...
                          w = E.labelMarginLeft,
                          S = E.labelMarginTop;
                        n.adjustLocations(m[p], E.rect.x, E.rect.y, y, I, w, S);
                      });
                    }),
                    (D.prototype.getToBeTiled = function (n) {
                      ...
                      for (var E = p.getNodes(), y = 0; y < E.length; y++) {
                        var I = E[y];
                        if (this.getNodeDegree(I) > 0) return ((this.toBeTiled[m] = !1), !1);
                        if (I.getChild() == null) {
                          this.toBeTiled[I.id] = !1;
                          continue;
                        }
                        if (!this.getToBeTiled(I)) return ((this.toBeTiled[m] = !1), !1);
                      }
                      ...
                      for (var S = m, W = 0; W < n.rows.length; W++) {
                        ...
                        for (var q = 0, V = 0; V < x.length; V++) {
                          ...
                          ((Y.rect.x = m),
                            ...
                            Y.rect.height > q && (q = Y.rect.height));
                        }
                            ...
                            (y.labelWidth &&
                              (y.labelPosHorizontal == "left"
                                ? ((y.rect.x -= y.labelWidth),
                                  y.setWidth(I + y.labelWidth),
                                  (y.labelMarginLeft = y.labelWidth))
                                : y.labelPosHorizontal == "center" && y.labelWidth > I
                                  ? ((y.rect.x -= (y.labelWidth - I) / 2),
                                    y.setWidth(y.labelWidth),
                                    (y.labelMarginLeft = (y.labelWidth - I) / 2))
                                  : y.labelPosHorizontal == "right" && y.setWidth(I + y.labelWidth)),
                              y.labelHeight &&
                    ...
                    (D.prototype.calcIdealRowWidth = function (n, m) {
                      var p = o.TILING_PADDING_VERTICAL,
                        E = o.TILING_PADDING_HORIZONTAL,
                        y = n.length,
                        I = 0,
                        w = 0,
                        S = 0;
                      n.forEach(function (z) {
                        ((I += z.getWidth()), (w += z.getHeight()), z.getWidth() > S && (S = z.getWidth()));
                      });
                      var W = I / y,
                        x = w / y,
                        q = Math.pow(p - E, 2) + 4 * (W + E) * (x + p) * y,
                        V = (E - p + Math.sqrt(q)) / (2 * (W + E)),
                        Y;
                    ...
                    (D.prototype.tileNodesByFavoringDim = function (n, m, p) {
                      var E = o.TILING_PADDING_VERTICAL,
                        y = o.TILING_PADDING_HORIZONTAL,
                        I = o.TILING_COMPARE_BY,
                        w = {
                          rows: [],
                          rowWidth: [],
                          rowHeight: [],
                    ...
                    (D.prototype.insertNodeToRow = function (n, m, p, E) {
                      ...
                      var W = 0;
                      (S > n.rowHeight[p] && ((W = n.rowHeight[p]), (n.rowHeight[p] = S), (W = n.rowHeight[p] - W)),
                        (n.height += W),
                        n.rows[p].push(m));
                    }),
                    ...
                    (D.prototype.canAddHorizontal = function (n, m, p) {
                      ...
                      var S = 0;
                      n.rowHeight[I] < p && I > 0 && (S = p + n.verticalPadding - n.rowHeight[I]);
                      var W;
                      (n.width - w >= m + n.horizontalPadding
                        ? (W = (n.height + S) / (w + m + n.horizontalPadding))
                        : (W = (n.height + S) / n.width),
                        (S = p + n.verticalPadding));
                      var x;
                      return (
                        n.width < m ? (x = (n.height + S) / m) : (x = (n.height + S) / n.width),
                        x < 1 && (x = 1 / x),
                        W < 1 && (W = 1 / W),
                        W < x
                      );
                    ...
                    (D.prototype.shiftToLastRow = function (n) {
                      var m = this.getLongestRowIndex(n),
                        ...
                        E = n.rows[m],
                        y = E[E.length - 1],
                        I = y.width + n.horizontalPadding;
                      if (n.width - n.rowWidth[p] > I && m != p) {
                        (E.splice(-1, 1),
                          n.rows[p].push(y),
                          (n.rowWidth[m] = n.rowWidth[m] - I),
                          (n.rowWidth[p] = n.rowWidth[p] + I),
                          (n.width = n.rowWidth[instance.getLongestRowIndex(n)]));
                        for (var w = Number.MIN_VALUE, S = 0; S < E.length; S++) E[S].height > w && (w = E[S].height);
                          ...
                          if (
                            ...
                            if (o.PURE_INCREMENTAL) {
                              var w = p.getEdges()[0].getOtherEnd(p),
                                S = new N(p.getCenterX() - w.getCenterX(), p.getCenterY() - w.getCenterY());
                    ...
                    (D.prototype.findPlaceforPrunedNode = function (n) {
                      ...
                      if ((E == n[1].source ? (p = n[1].target) : (p = n[1].source), o.PURE_INCREMENTAL))
                        ...
                        for (var z = C.MAX_VALUE, O, H, $ = 0; $ < Y.length; $++)
                          Y[$] < z ? ((z = Y[$]), (O = 1), (H = $)) : Y[$] == z && O++;
                        if (O == 3 && z == 0)
                          Y[0] == 0 && Y[1] == 0 && Y[2] == 0
                            ? (m = 1)
                ...
                991: (a, e, r) => {
                  var f = r(551).FDLayoutNode,
                    i = r(551).IMath;
                  function u(s, o, c, h) {
                    f.call(this, s, o, c, h);
                  }
                  u.prototype = Object.create(f.prototype);
                  for (var t in f) u[t] = f[t];
                  ((u.prototype.calculateDisplacement = function () {
                    ...
                    (this.getChild() != null && this.fixedNodeWeight
                      ...
                      Math.abs(this.displacementX) > s.coolingFactor * s.maxNodeDisplacement &&
                        (this.displacementX = s.coolingFactor * s.maxNodeDisplacement * i.sign(this.displacementX)),
                      Math.abs(this.displacementY) > s.coolingFactor * s.maxNodeDisplacement &&
                        (this.displacementY = s.coolingFactor * s.maxNodeDisplacement * i.sign(this.displacementY)),
                      this.child &&
                    ...
                    (u.prototype.propogateDisplacementToChildren = function (s, o) {
                      for (var c = this.getChild().getNodes(), h, T = 0; T < c.length; T++)
                        ((h = c[T]),
                          h.getChild() == null
                            ? ((h.displacementX += s), (h.displacementY += o))
                            : h.propogateDisplacementToChildren(s, o));
                    }),
                ...
                902: (a, e, r) => {
                  ...
                  ((o.handleConstraints = function (c) {
                    ...
                    for (
                      var T = new Map(), d = new Map(), v = [], N = [], F = c.getAllNodes(), C = 0, G = 0;
                      G < F.length;
                      G++
                    ) {
                      var Z = F[G];
                      Z.getChild() == null &&
                        (d.set(Z.id, C++), v.push(Z.getCenterX()), N.push(Z.getCenterY()), T.set(Z.id, Z));
                    }
                        ...
                        (nt.forEach(function (lt, ot) {
                          (lt == 0
                            ? (ut.push(ot),
                              J ||
                                (B == "horizontal"
                                  ? tt.set(ot, d.has(ot) ? v[d.get(ot)] : k.get(ot))
                                  : tt.set(ot, d.has(ot) ? N[d.get(ot)] : k.get(ot))))
                            : tt.set(ot, Number.NEGATIVE_INFINITY),
                            J && j.set(ot, new Set([ot])));
                        }),
                          J &&
                            at.forEach(function (lt) {
                              ...
                              if (
                                ...
                                (ot.forEach(function (st) {
                                  B == "horizontal"
                                    ? (tt.set(st, d.has(st) ? v[d.get(st)] : k.get(st)), (Lt += tt.get(st)))
                                    : (tt.set(st, d.has(st) ? N[d.get(st)] : k.get(st)), (Lt += tt.get(st)));
                                }),
                                  (Lt = Lt / ot.length),
                                  lt.forEach(function (st) {
                                ...
                                (lt.forEach(function (st) {
                                  B == "horizontal"
                                    ? (ft += d.has(st) ? v[d.get(st)] : k.get(st))
                                    : (ft += d.has(st) ? N[d.get(st)] : k.get(st));
                                }),
                                  (ft = ft / lt.length),
                                  lt.forEach(function (st) {
                                    tt.set(st, ft);
                            ...
                            Lt.forEach(function (ft) {
                              if (tt.get(ft.id) < tt.get(ot) + ft.gap)
                                if (J && J.has(ft.id)) {
                                  ...
                                  if (
                                    (B == "horizontal"
                                      ? (st = d.has(ft.id) ? v[d.get(ft.id)] : k.get(ft.id))
                                      : (st = d.has(ft.id) ? N[d.get(ft.id)] : k.get(ft.id)),
                                    tt.set(ft.id, st),
                                    st < tt.get(ot) + ft.gap)
                                  ) {
                              ...
                              (nt.set(ft.id, nt.get(ft.id) - 1),
                                ...
                                J && j.set(ft.id, ct(j.get(ot), j.get(ft.id))));
                            });
                          };
                          ut.length != 0;
                        )
                              ...
                              try {
                                for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = !0) {
                                  var St = zt.value,
                                    kt = void 0;
                                  B == "horizontal"
                                    ? (kt = d.has(St) ? v[d.get(St)] : k.get(St))
                                    : (kt = d.has(St) ? N[d.get(St)] : k.get(St));
                                  var Kt = tt.get(St);
                                  (kt < Lt && (Lt = kt),
                                    kt > st && (st = kt),
                                    Kt < ft && (ft = Kt),
                      ...
                      rt = function (U) {
                        ...
                        if (
                          (U.forEach(function (j) {
                            j.left
                              ? v[d.get(j.left)] - v[d.get(j.right)] >= 0
                                ? B++
                                : J++
                              : N[d.get(j.top)] - N[d.get(j.bottom)] >= 0
                                ? k++
                                : at++;
                          }),
                          B > J && k > at)
                        )
                          for (var ct = 0; ct < d.size; ct++) ((v[ct] = -1 * v[ct]), (N[ct] = -1 * N[ct]));
                        else if (B > J) for (var nt = 0; nt < d.size; nt++) v[nt] = -1 * v[nt];
                        else if (k > at) for (var tt = 0; tt < d.size; tt++) N[tt] = -1 * N[tt];
                      },
                      n = function (U) {
                        var B = [],
                          J = new u(),
                    ...
                    if (
                      ...
                      if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 1)
                        (h.fixedNodeConstraint.forEach(function (b, U) {
                          ((E[U] = [b.position.x, b.position.y]), (y[U] = [v[d.get(b.nodeId)], N[d.get(b.nodeId)]]));
                        }),
                          (I = !0));
                            ...
                            for (
                              var U = h.alignmentConstraint.vertical,
                                B = function (tt) {
                                  ...
                                  var ut = new Set(
                                      [].concat(f(j)).filter(function (pt) {
                                        return S.has(pt);
                                      })
                                    ),
                                    wt = void 0;
                                  (ut.size > 0 ? (wt = v[d.get(ut.values().next().value)]) : (wt = K(j).x),
                                    U[tt].forEach(function (pt) {
                                      ((E[b] = [wt, N[d.get(pt)]]), (y[b] = [v[d.get(pt)], N[d.get(pt)]]), b++);
                                    }));
                                },
                                J = 0;
                              J < U.length;
                              ...
                              var k = h.alignmentConstraint.horizontal,
                                at = function (tt) {
                                  ...
                                  var ut = new Set(
                                    ...
                                    wt = void 0;
                                  (ut.size > 0 ? (wt = v[d.get(ut.values().next().value)]) : (wt = K(j).y),
                                    k[tt].forEach(function (pt) {
                                      ((E[b] = [v[d.get(pt)], wt]), (y[b] = [v[d.get(pt)], N[d.get(pt)]]), b++);
                                    }));
                                },
                                ct = 0;
                              ct < k.length;
                        ...
                        if (V < x.size / 2) (rt(h.relativePlacementConstraint), (I = !1), (w = !1));
                        else {
                          var z = new Map(),
                            O = new Map(),
                            H = [];
                          (q[Y].forEach(function (b) {
                            W.get(b).forEach(function (U) {
                              U.direction == "horizontal"
                                ...
                                : (O.has(b) ? O.get(b).push(U) : O.set(b, [U]),
                          ...
                          var $ = D(z, "horizontal"),
                            _ = D(O, "vertical");
                          (q[Y].forEach(function (b, U) {
                            ((y[U] = [v[d.get(b)], N[d.get(b)]]),
                              (E[U] = []),
                              $.has(b) ? (E[U][0] = $.get(b)) : (E[U][0] = v[d.get(b)]),
                              _.has(b) ? (E[U][1] = _.get(b)) : (E[U][1] = N[d.get(b)]));
                          }),
                            (I = !0));
                        }
                      }
                    ...
                    if (i.ENFORCE_CONSTRAINTS) {
                      if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 0) {
                        var Et = { x: 0, y: 0 };
                        (h.fixedNodeConstraint.forEach(function (b, U) {
                          var B = { x: v[d.get(b.nodeId)], y: N[d.get(b.nodeId)] },
                            J = b.position,
                            k = X(J, B);
                          ((Et.x += k.x), (Et.y += k.y));
                        }),
                          ...
                          h.fixedNodeConstraint.forEach(function (b) {
                            ((v[d.get(b.nodeId)] = b.position.x), (N[d.get(b.nodeId)] = b.position.y));
                          }));
                      }
                          ...
                          for (
                            var Dt = h.alignmentConstraint.vertical,
                              Rt = function (U) {
                                ...
                                var J = new Set(
                                    [].concat(f(B)).filter(function (at) {
                                      return S.has(at);
                                    })
                                  ),
                                  k = void 0;
                                (J.size > 0 ? (k = v[d.get(J.values().next().value)]) : (k = K(B).x),
                            ...
                            var Ut = h.alignmentConstraint.horizontal,
                              Pt = function (U) {
                                ...
                                var J = new Set(
                                  ...
                                  k = void 0;
                                (J.size > 0 ? (k = N[d.get(J.values().next().value)]) : (k = K(B).y),
                                  B.forEach(function (at) {
                                    S.has(at) || (N[d.get(at)] = k);
                                  }));
                              },
                              Ft = 0;
                            Ft < Ut.length;
                      ...
                      h.relativePlacementConstraint &&
                        (function () {
                                  ...
                                  j = function (yt) {
                                    (B.set("dummy" + yt, []),
                                      tt[yt].forEach(function (Mt) {
                                        (b.set(Mt, "dummy" + yt),
                                          B.get("dummy" + yt).push(Mt),
                                          S.has(Mt) && ct.add("dummy" + yt));
                                      }),
                                  ...
                                  pt = function (yt) {
                                    (J.set("dummy" + yt, []),
                                      wt[yt].forEach(function (Mt) {
                                        (U.set(Mt, "dummy" + yt),
                                          J.get("dummy" + yt).push(Mt),
                                          S.has(Mt) && nt.add("dummy" + yt));
                                      }),
                                      at.set("dummy" + yt, N[d.get(wt[yt][0])]));
                                  },
                                  xt = 0;
                                xt < wt.length;
                                xt++
                              ...
                              W.get(yt).forEach(function (Mt) {
                                ...
                                Mt.direction == "horizontal"
                                  ? ((Zt = b.get(yt) ? b.get(yt) : yt),
                                    b.get(Mt.id)
                                      ? (Bt = { id: b.get(Mt.id), gap: Mt.gap, direction: Mt.direction })
                                      : (Bt = Mt),
                                    lt.has(Zt) ? lt.get(Zt).push(Bt) : lt.set(Zt, [Bt]),
                                    lt.has(Bt.id) || lt.set(Bt.id, []))
                                  : ((Zt = U.get(yt) ? U.get(yt) : yt),
                                    U.get(Mt.id)
                                      ? (Bt = { id: U.get(Mt.id), gap: Mt.gap, direction: Mt.direction })
                                      : (Bt = Mt),
                          ...
                          var _t = D(lt, "horizontal", ct, k, Qt),
                            Jt = D(ot, "vertical", nt, at, jt),
                            oe = function (yt) {
                              B.get(yt)
                                ? B.get(yt).forEach(function (Mt) {
                          ...
                          var Be = function (yt) {
                              J.get(yt)
                                ? J.get(yt).forEach(function (Mt) {
                                    N[d.get(Mt)] = Jt.get(yt);
                                  })
                                : (N[d.get(yt)] = Jt.get(yt));
                            },
                            de = !0,
                            Ce = !1,
                            Ae = void 0;
                    ...
                    for (var Yt = 0; Yt < F.length; Yt++) {
                      var Vt = F[Yt];
                      Vt.getChild() == null && Vt.setCenter(v[d.get(Vt.id)], N[d.get(Vt.id)]);
                    }
                  }),
                    (a.exports = o));
                },
            ...
            function g(a) {
              ...
              var r = (L[a] = { exports: {} });
              return (P[a](r, r.exports, g), r.exports);
            }
            var l = g(45);
            return l;
          })();
            ...
            var P = {
                ...
                548: (a, e, r) => {
                  var f = (function () {
                      function t(s, o) {
                        ...
                        try {
                          for (
                            var v = s[Symbol.iterator](), N;
                            !(h = (N = v.next()).done) && (c.push(N.value), !(o && c.length === o));
                            h = !0
                          );
                        } catch (F) {
                          ((T = !0), (d = F));
                      ...
                      return function (s, o) {
                        ...
                        if (Symbol.iterator in Object(s)) return t(s, o);
                  ...
                  ((u.getTopMostNodes = function (t) {
                    for (var s = {}, o = 0; o < t.length; o++) s[t[o].id()] = !0;
                    ...
                    (u.connectComponents = function (t, s, o, c) {
                      var h = new i(),
                        ...
                        K = function () {
                          ...
                          var n = o[0],
                            m = t.collection();
                          (m.merge(n).merge(n.descendants().intersection(s)),
                            d.push(n),
                          ...
                          if (
                            ...
                            d.length == o.length && (C = !0),
                            !C || (C && G > 1))
                          ) {
                            ((N = d[0]),
                              (F = N.connectedEdges().length),
                      ...
                      do K();
                      while (!C);
                      return (c && Z.length > 0 && c.set("dummy" + (c.size + 1), Z), X);
                    }),
                      ...
                      if (!o.fixedNodeConstraint) {
                        ...
                        if (o.quality == "draft") {
                          ...
                          Object.keys(s).forEach(function (x) {
                            var q = s[x],
                              V = q.getRect().x,
                              Y = q.getRect().x + q.getRect().width,
                              et = q.getRect().y,
                              z = q.getRect().y + q.getRect().height;
                    ...
                    (u.calcBoundingBox = function (t, s, o, c) {
                      for (
                        ...
                        var D = Z[K];
                        ((N = s[c.get(D.id())] - D.width() / 2),
                          (F = s[c.get(D.id())] + D.width() / 2),
                          (C = o[c.get(D.id())] - D.height() / 2),
                          (G = o[c.get(D.id())] + D.height() / 2),
                          h > N && (h = N),
                          T < F && (T = F),
                          d > C && (d = C),
                          v < G && (v = G));
                    ...
                    (u.calcParentsWithoutChildren = function (t, s) {
                      var o = t.collection();
                      return (
                        s.nodes(":parent").forEach(function (c) {
                          var h = !1;
                ...
                816: (a, e, r) => {
                  var f = r(548),
                    ...
                    s = r(140).layoutBase.DimensionD,
                    o = r(140).layoutBase.LayoutConstants,
                    ...
                    T = function (v, N) {
                      var F = v.cy,
                        ...
                        D = void 0,
                        rt = {};
                      v.randomize && ((X = N.nodeIndexes), (K = N.xCoords), (D = N.yCoords));
                      var n = function (x) {
                        ...
                        p = f.calcParentsWithoutChildren(F, C),
                        E = function W(x, q, V, Y) {
                          for (var et = q.length, z = 0; z < et; z++) {
                            var O = q[z],
                              H = null;
                            O.intersection(p).length == 0 && (H = O.children());
                            var $ = void 0,
                              _ = O.layoutDimensions({ nodeDimensionsIncludeLabels: Y.nodeDimensionsIncludeLabels });
                              ...
                              if (Y.randomize)
                                if (!O.isParent())
                                  $ = x.add(
                                    new u(
                                      V.graphManager,
                                      new t(K[X.get(O.id())] - _.w / 2, D[X.get(O.id())] - _.h / 2),
                                      new s(parseFloat(_.w), parseFloat(_.h))
                                    )
                                  );
                                else {
                                  var ht = f.calcBoundingBox(O, K, D, X);
                                  O.intersection(p).length == 0
                                    ? ($ = x.add(
                                        new u(
                                          V.graphManager,
                                ...
                                $ = x.add(
                                  new u(
                                    V.graphManager,
                                    new t(O.position("x") - _.w / 2, O.position("y") - _.h / 2),
                                    new s(parseFloat(_.w), parseFloat(_.h))
                                  )
                                );
                            else $ = x.add(new u(this.graphManager));
                            if (
                              (($.id = O.data("id")),
                              ($.nodeRepulsion = m(Y.nodeRepulsion, O)),
                              ($.paddingLeft = parseInt(O.css("padding"))),
                              ...
                              Y.nodeDimensionsIncludeLabels &&
                                (($.labelWidth = O.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).w),
                                ($.labelHeight = O.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).h),
                                ($.labelPosVertical = O.css("text-valign")),
                                ($.labelPosHorizontal = O.css("text-halign"))),
                              (rt[O.data("id")] = $),
                              isNaN($.rect.x) && ($.rect.x = 0),
                              isNaN($.rect.y) && ($.rect.y = 0),
                              H != null && H.length > 0)
                            ) {
                              var Q = void 0;
                        ...
                        y = function (x, q, V) {
                          for (var Y = 0, et = 0, z = 0; z < V.length; z++) {
                            ...
                            if (H && $ && H !== $ && H.getEdgesBetween($).length == 0) {
                              ...
                              ((_.id = O.id()),
                                (_.idealLength = m(v.idealEdgeLength, O)),
                                (_.edgeElasticity = m(v.edgeElasticity, O)),
                                (Y += _.idealLength),
                                et++);
                            }
                          }
                        ...
                        I = function (x, q) {
                          (q.fixedNodeConstraint && (x.constraints.fixedNodeConstraint = q.fixedNodeConstraint),
                            q.alignmentConstraint && (x.constraints.alignmentConstraint = q.alignmentConstraint),
                            q.relativePlacementConstraint &&
                              (x.constraints.relativePlacementConstraint = q.relativePlacementConstraint));
                        };
                      (v.nestingFactor != null &&
                        ...
                        v.quality == "proof" ? (o.QUALITY = 2) : (o.QUALITY = 0),
                        (h.NODE_DIMENSIONS_INCLUDE_LABELS =
                          c.NODE_DIMENSIONS_INCLUDE_LABELS =
                          o.NODE_DIMENSIONS_INCLUDE_LABELS =
                            v.nodeDimensionsIncludeLabels),
                        (h.DEFAULT_INCREMENTAL = c.DEFAULT_INCREMENTAL = o.DEFAULT_INCREMENTAL = !v.randomize),
                        (h.ANIMATE = c.ANIMATE = o.ANIMATE = v.animate),
                        (h.TILE = v.tile),
                        ...
                        (h.DEFAULT_INCREMENTAL = c.DEFAULT_INCREMENTAL = o.DEFAULT_INCREMENTAL = !0),
                        (h.PURE_INCREMENTAL = !v.randomize),
                        (o.DEFAULT_UNIFORM_LEAF_NODE_SIZES = v.uniformNodeDimensions),
                        v.step == "transformed" &&
                      ...
                      var w = new i(),
                        S = w.newGraphManager();
                      return (E(S.addRoot(), f.getTopMostNodes(G), w, v), y(w, S, Z), I(w, v), w.runLayout(), rt);
                    };
                ...
                212: (a, e, r) => {
                  var f = (function () {
                    ...
                    return function (N, F, C) {
                      return (F && v(N.prototype, F), C && v(N, C), N);
                    };
                  })();
                  function i(v, N) {
                        ...
                        f(v, [
                          {
                            ...
                            value: function () {
                              ...
                              if (
                                ...
                                if (p) {
                                  var I = t.getTopMostNodes(C.eles.nodes());
                                  if (
                                    ((D = t.connectComponents(G, C.eles, I)),
                                    ...
                                    if (C.tile) {
                                      var S = new Map(),
                                        ...
                                        x = [],
                                        q = 0,
                                        V = { nodeIndexes: S, xCoords: W, yCoords: x },
                                        Y = [];
                                      if (
                                    ...
                                    D.forEach(function (vt, it) {
                                      ((C.eles = vt), K.push(h(C, X[it])), t.relocateComponent(rt[it], K[it], C));
                                    });
                                  } else
                                    D.forEach(function (vt, it) {
                                  ...
                                  if (D.length > 1) {
                                    var H = [],
                                      $ = Z.filter(function (vt) {
                                        return vt.css("display") == "none";
                                      });
                                    D.forEach(function (vt, it) {
                                      var gt = void 0;
                                      if (
                                        (C.quality == "draft" && (gt = X[it].nodeIndexes), vt.nodes().not($).length > 0)
                                      ) {
                                        var mt = {};
                                        ((mt.edges = []), (mt.nodes = []));
                                        var At = void 0;
                                        (vt
                                          ...
                                          .forEach(function (Ot) {
                                            if (C.quality == "draft")
                                              ...
                                              K[it][Ot.id()] &&
                                                mt.nodes.push({
                                                  x: K[it][Ot.id()].getLeft(),
                                                  y: K[it][Ot.id()].getTop(),
                                                  width: K[it][Ot.id()].getWidth(),
                                                  height: K[it][Ot.id()].getHeight(),
                                                });
                                          }),
                                            ...
                                            if (Et.css("display") != "none" && Dt.css("display") != "none")
                                              if (C.quality == "draft") {
                                                ...
                                                K[it][Et.id()] &&
                                                  K[it][Dt.id()] &&
                                                  mt.edges.push({
                                                    startX: K[it][Et.id()].getCenterX(),
                                                    startY: K[it][Et.id()].getCenterY(),
                                                    endX: K[it][Dt.id()].getCenterX(),
                                                    endY: K[it][Dt.id()].getCenterY(),
                                                  });
                                          }),
                                          mt.nodes.length > 0 && (H.push(mt), O.add(it)));
                                      }
                                    });
                                  ...
                                  C.quality == "default" || C.quality == "proof"
                                    ? (K.push(h(C, X[0])), t.relocateComponent(rt[0], K[0], C))
                              ...
                              if (C.quality == "default" || C.quality == "proof" || C.randomize) {
                                var It = t.calcParentsWithoutChildren(G, Z),
                                  Nt = Z.filter(function (vt) {
                                    return vt.css("display") == "none";
                                  });
                                ((C.eles = Z.not(Nt)),
                                  Z.nodes().not(":parent").not(Nt).layoutPositions(F, C, Q),
                                  It.length > 0 &&
                    ...
                    t = function (o) {
                      var c = o.cy,
                        ...
                        x = function (U, B, J) {
                          ...
                          if (J) {
                            for (var ot = 0; ot < m; ot++) D[ot][B] < K[ot] && (K[ot] = D[ot][B]);
                            for (var Lt = 0; Lt < m; Lt++) K[Lt] > ut && ((ut = K[Lt]), (wt = Lt));
                          }
                          return wt;
                        },
                        q = function (U) {
                          ...
                          if (U) {
                            ...
                            for (var k = 0; k < m; k++) K[k] = p;
                            for (var at = 0; at < S; at++) ((X[at] = B), (B = x(B, at, U)));
                          } else {
                            W();
                            for (var J = 0; J < S; J++) x(X[J], J, U);
                          }
                          for (var ct = 0; ct < m; ct++) for (var nt = 0; nt < S; nt++) D[ct][nt] *= D[ct][nt];
                          for (var tt = 0; tt < S; tt++) rt[tt] = [];
                          for (var j = 0; j < S; j++) for (var ut = 0; ut < S; ut++) rt[j][ut] = D[X[ut]][j];
                        },
                        V = function () {
                          for (
                            var U = u.svd(rt), B = U.S, J = U.U, k = U.V, at = B[0] * B[0] * B[0], ct = [], nt = 0;
                            nt < S;
                            nt++
                          ) {
                            ct[nt] = [];
                            for (var tt = 0; tt < S; tt++)
                              ((ct[nt][tt] = 0),
                                nt == tt && (ct[nt][tt] = B[nt] / (B[nt] * B[nt] + at / (B[nt] * B[nt]))));
                          }
                        ...
                        Y = function () {
                          ...
                          for (var tt = E, j = E, ut = void 0; ; ) {
                            for (var wt = 0; wt < m; wt++) at[wt] = J[wt];
                            if (
                              ((J = i.multGamma(i.multL(i.multGamma(at), D, n))),
                              (U = i.dotProduct(at, J)),
                              (J = i.normalize(J)),
                      ...
                      (f.connectComponents(c, h, f.getTopMostNodes(T), v),
                      ...
                      var O = !0,
                        ...
                        $ = void 0;
                      try {
                        for (var _ = v.keys()[Symbol.iterator](), ht; !(O = (ht = _.next()).done); O = !0) {
                          var Q = ht.value;
                          N.set(Q, et++);
                        }
                      } catch (b) {
                      ...
                      (d.forEach(function (b) {
                        ...
                        (U.nodes(":childless").forEach(function (k, at) {
                          ...
                          F.set(b.id(), U.nodes(":childless")[B].id()));
                      }),
                        T.forEach(function (b) {
                          var U = void 0;
                          (b.isParent() ? (U = N.get(F.get(b.id()))) : (U = N.get(b.id())),
                            b
                              .neighborhood()
                              .nodes()
                              .forEach(function (B) {
                                h.intersection(b.edgesWith(B)).length > 0 &&
                                  (B.isParent() ? C[U].push(F.get(B.id())) : C[U].push(B.id()));
                              }));
                        }));
                      var Nt = function (U) {
                          var B = N.get(U),
                          ...
                          v.get(U).forEach(function (k) {
                            (c.getElementById(k).isParent() ? (J = F.get(k)) : (J = k),
                              C[B].push(J),
                              C[N.get(J)].push(U));
                          });
                        },
                      ...
                      if (m > 2) {
                        ...
                        for (var Dt = 0; Dt < m; Dt++) D[Dt] = [];
                        for (var Rt = 0; Rt < S; Rt++) n[Rt] = [];
                        return (
                          o.quality == "draft" || o.step == "all"
                            ? (q(I), V(), Y(), (Et = { nodeIndexes: N, xCoords: G, yCoords: Z }))
                            : (N.forEach(function (b, U) {
                                (G.push(c.getElementById(U).position("x")), Z.push(c.getElementById(U).position("y")));
                              }),
                              (Et = { nodeIndexes: N, xCoords: G, yCoords: Z })),
                          Et
                        );
                      } else {
                        var Ht = N.keys(),
                        ...
                        if ((G.push(Pt.x), Z.push(Pt.y), m == 2)) {
                          var Yt = c.getElementById(Ht.next().value),
                            Vt = Yt.outerWidth();
                          (G.push(Pt.x + Ft / 2 + Vt / 2 + o.idealEdgeLength), Z.push(Pt.y));
                        }
                        return ((Et = { nodeIndexes: N, xCoords: G, yCoords: Z }), Et);
                      }
                    };
...
var xe = { L: "left", R: "right", T: "top", B: "bottom" },
  Ie = {
    L: dt((R) => `${R},${R / 2} 0,${R} 0,0`, "L"),
    R: dt((R) => `0,${R / 2} ${R},0 ${R},${R}`, "R"),
    T: dt((R) => `0,0 ${R},0 ${R / 2},${R}`, "T"),
    B: dt((R) => `${R / 2},0 ${R},${R} 0,${R}`, "B"),
  },
  se = {
    L: dt((R, M) => R - M + 2, "L"),
    R: dt((R, M) => R - 2, "R"),
  ...
  Lr = dt(function (R) {
    return R !== "LL" && R !== "RR" && R !== "TT" && R !== "BB";
  }, "isValidArchitectureDirectionPair"),
  ye = dt(function (R, M) {
    const A = `${R}${M}`;
    return Lr(A) ? A : void 0;
  }, "getArchitectureDirectionPair"),
  Cr = dt(function ([R, M], A) {
    const P = A[0],
      L = A[1];
    return Wt(P)
      ? qt(L)
  ...
  wr = dt(function (R, M) {
    return Te(R, M) ? "bend" : Wt(R) ? "horizontal" : "vertical";
  }, "getArchitectureDirectionAlignment"),
  Mr = dt(function (R) {
    return R.type === "service";
  }, "isArchitectureService"),
  Or = dt(function (R) {
    return R.type === "junction";
  }, "isArchitectureJunction"),
  be = dt((R) => R.data(), "edgeData"),
  ie = dt((R) => R.data(), "nodeData"),
  Dr = rr.architecture,
  ae,
  Pe =
    ((ae = class {
      ...
      addService({ id: M, icon: A, in: P, title: L, iconText: g }) {
        if (this.registeredIds[M] !== void 0)
          throw new Error(`The service id [${M}] is already in use by another ${this.registeredIds[M]}`);
        if (P !== void 0) {
          if (M === P) throw new Error(`The service [${M}] cannot be placed within itself`);
          ...
          if (this.registeredIds[P] === "node") throw new Error(`The service [${M}]'s parent is not a group`);
        }
        ((this.registeredIds[M] = "node"),
          (this.nodes[M] = { id: M, type: "service", icon: A, iconText: g, title: L, edges: [], in: P }));
      }
      getServices() {
        return Object.values(this.nodes).filter(Mr);
      }
      addJunction({ id: M, in: A }) {
        if (this.registeredIds[M] !== void 0)
          throw new Error(`The junction id [${M}] is already in use by another ${this.registeredIds[M]}`);
        if (A !== void 0) {
          if (M === A) throw new Error(`The junction [${M}] cannot be placed within itself`);
          ...
          if (this.registeredIds[A] === "node") throw new Error(`The junction [${M}]'s parent is not a group`);
        }
        ((this.registeredIds[M] = "node"), (this.nodes[M] = { id: M, type: "junction", edges: [], in: A }));
      }
      getJunctions() {
      ...
      getNode(M) {
        return this.nodes[M] ?? null;
      }
      addGroup({ id: M, icon: A, in: P, title: L }) {
        var g, l, a;
        if (((g = this.registeredIds) == null ? void 0 : g[M]) !== void 0)
          throw new Error(`The group id [${M}] is already in use by another ${this.registeredIds[M]}`);
        if (P !== void 0) {
          if (M === P) throw new Error(`The group [${M}] cannot be placed within itself`);
          ...
          if (((a = this.registeredIds) == null ? void 0 : a[P]) === "node")
            throw new Error(`The group [${M}]'s parent is not a group`);
        }
        ((this.registeredIds[M] = "group"), (this.groups[M] = { id: M, icon: A, title: L, in: P }));
      }
      getGroups() {
      ...
      addEdge({
        ...
        if (!Re(P))
          throw new Error(
            `Invalid direction given for left hand side of edge ${M}--${A}. Expected (L,R,T,B) got ${String(P)}`
          );
        if (!Re(L))
          throw new Error(
            `Invalid direction given for right hand side of edge ${M}--${A}. Expected (L,R,T,B) got ${String(L)}`
          );
        if (this.nodes[M] === void 0 && this.groups[M] === void 0)
          throw new Error(
        ...
        (this.edges.push(u),
          this.nodes[M] &&
            this.nodes[A] &&
            (this.nodes[M].edges.push(this.edges[this.edges.length - 1]),
        ...
        if (this.dataStructures === void 0) {
          const M = {},
            A = Object.entries(this.nodes).reduce(
              (e, [r, f]) => (
                (e[r] = f.edges.reduce((i, u) => {
                  var o, c;
                  const t = (o = this.getNode(u.lhsId)) == null ? void 0 : o.in,
                    s = (c = this.getNode(u.rhsId)) == null ? void 0 : c.in;
                  if (t && s && t !== s) {
                    const h = wr(u.lhsDir, u.rhsDir);
                    h !== "bend" && (M[t] ?? (M[t] = {}), (M[t][s] = h), M[s] ?? (M[s] = {}), (M[s][t] = h));
                  }
                  if (u.lhsId === r) {
                    const h = ye(u.lhsDir, u.rhsDir);
                    h && (i[h] = u.rhsId);
                  } else {
                    const h = ye(u.rhsDir, u.lhsDir);
                    h && (i[h] = u.lhsId);
                  }
                  return i;
                }, {})),
            ...
            P = Object.keys(A)[0],
            L = { [P]: 1 },
            g = Object.keys(A).reduce((e, r) => (r === P ? e : { ...e, [r]: 1 }), {}),
            l = dt((e) => {
              const r = { [e]: [0, 0] },
                f = [e];
              for (; f.length > 0; ) {
            ...
            a = [l(P)];
          for (; Object.keys(g).length > 0; ) a.push(l(Object.keys(g)[0]));
          this.dataStructures = { adjList: A, spatialMaps: a, groupAlignments: M };
        }
  ...
  xr = dt((R, M) => {
    (lr(R, M),
      R.groups.map((A) => M.addGroup(A)),
      R.services.map((A) => M.addService({ ...A, type: "service" })),
      R.junctions.map((A) => M.addJunction({ ...A, type: "junction" })),
      R.edges.map((A) => M.addEdge(A)));
  }, "populateDb"),
  Ge = {
    parser: { yy: void 0 },
    parse: dt(async (R) => {
      var P;
      const M = await fr("architecture", R);
      Se.debug(M);
...
`,
  ...
  Rr = Ir,
  re = dt((R) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${R}</g>`, "wrapIcon"),
  ne = {
  ...
  Sr = dt(async function (R, M, A, P) {
    const L = A.getConfigField("padding"),
      g = A.getConfigField("iconSize"),
      l = g / 2,
      a = g / 6,
      e = a / 2;
    await Promise.all(
      M.edges().map(async (r) => {
        ...
        let { x: d, y: v } = r[0].sourceEndpoint();
        const { x: N, y: F } = r[0].midpoint();
        let { x: C, y: G } = r[0].targetEndpoint();
        const Z = L + 4;
        if (
          (t && (Wt(i) ? (d += i === "L" ? -Z : Z) : (v += i === "T" ? -Z : Z + 18)),
          h && (Wt(o) ? (C += o === "L" ? -Z : Z) : (G += o === "T" ? -Z : Z + 18)),
          !t &&
            ((X = A.getNode(f)) == null ? void 0 : X.type) === "junction" &&
            (Wt(i) ? (d += i === "L" ? l : -l) : (v += i === "T" ? l : -l)),
          !h &&
            ((K = A.getNode(s)) == null ? void 0 : K.type) === "junction" &&
            (Wt(o) ? (C += o === "L" ? l : -l) : (G += o === "T" ? l : -l)),
          r[0]._private.rscratch)
        ) {
          const D = R.insert("g");
          if (
            (D.insert("path")
              .attr("d", `M ${d},${v} L ${N},${F} L${C},${G} `)
              .attr("class", "edge")
              .attr("id", `${P}-${or(f, s, { prefix: "L" })}`),
            u)
          ) {
            const rt = Wt(i) ? se[i](d, a) : d - e,
              n = qt(i) ? se[i](v, a) : v - e;
            D.insert("polygon")
              .attr("points", Ie[i](a))
              .attr("transform", `translate(${rt},${n})`)
              .attr("class", "arrow");
          }
          if (c) {
            const rt = Wt(o) ? se[o](C, a) : C - e,
              n = qt(o) ? se[o](G, a) : G - e;
            D.insert("polygon")
              .attr("points", Ie[o](a))
              .attr("transform", `translate(${rt},${n})`)
          ...
          if (T) {
            const rt = Te(i, o) ? "XY" : Wt(i) ? "X" : "Y";
            let n = 0;
            rt === "X" ? (n = Math.abs(d - C)) : rt === "Y" ? (n = Math.abs(v - G) / 1.5) : (n = Math.abs(d - C) / 2);
            const m = D.append("g");
            if (
              (await me(m, T, { useHtmlLabels: !1, width: n, classes: "architecture-service-label" }, Ee()),
              m
                .attr("dy", "1em")
              ...
              m.attr("transform", "translate(" + N + ", " + F + ")");
            else if (rt === "Y") m.attr("transform", "translate(" + N + ", " + F + ") rotate(-90)");
            else if (rt === "XY") {
              const p = ye(i, o);
              if (p && Nr(p)) {
                const E = m.node().getBoundingClientRect(),
                  [y, I] = Ar(p);
                m.attr("dominant-baseline", "auto").attr("transform", `rotate(${-1 * y * I * 45})`);
                const w = m.node().getBoundingClientRect();
                m.attr(
                  "transform",
                  `
  ...
  Fr = dt(async function (R, M, A, P) {
    const g = A.getConfigField("padding") * 0.75,
      l = A.getConfigField("fontSize"),
      e = A.getConfigField("iconSize") / 2;
    await Promise.all(
      M.nodes().map(async (r) => {
        const f = ie(r);
        if (f.type === "group") {
          const { h: i, w: u, x1: t, y1: s } = r.boundingBox(),
            o = R.append("rect");
          o.attr("id", `${P}-group-${f.id}`)
            .attr("x", t + e)
            .attr("y", s + e)
            .attr("width", u)
            .attr("height", i)
          ...
          if (f.icon) {
            const d = c.append("g");
            (d.html(`<g>${await pe(f.icon, { height: g, width: g, fallbackPrefix: ne.prefix })}</g>`),
              d.attr("transform", "translate(" + (h + e + 1) + ", " + (T + e + 1) + ")"),
              (h += g),
              (T += l / 2 - 1 - 2));
          }
          if (f.label) {
            const d = c.append("g");
            (await me(d, f.label, { useHtmlLabels: !1, width: u, classes: "architecture-service-label" }, Ee()),
              d
                .attr("dy", "1em")
                .attr("alignment-baseline", "middle")
                .attr("dominant-baseline", "start")
                .attr("text-anchor", "start"),
              d.attr("transform", "translate(" + (h + e + 4) + ", " + (T + e + 2) + ")"));
          }
  ...
  br = dt(async function (R, M, A, P) {
    ...
    for (const g of A) {
      ...
      if (g.title) {
        const i = l.append("g");
        (await me(i, g.title, { useHtmlLabels: !1, width: a * 1.5, classes: "architecture-service-label" }, L),
          i
            .attr("dy", "1em")
            .attr("alignment-baseline", "middle")
            .attr("dominant-baseline", "middle")
      ...
      const e = l.append("g");
      if (g.icon) e.html(`<g>${await pe(g.icon, { height: a, width: a, fallbackPrefix: ne.prefix })}</g>`);
      else if (g.iconText) {
        ...
        const t = e
            ...
            .append("div")
            .html(ar(g.iconText, L)),
          s = parseInt(window.getComputedStyle(t.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
        t.attr("style", `-webkit-line-clamp: ${Math.floor((a - 2) / s)};`);
      } else
        e.append("path")
          .attr("class", "node-bkg")
          .attr("id", `${P}-node-${g.id}`)
          .attr("d", `M0,${a} V5 Q0,0 5,0 H${a - 5} Q${a},0 ${a},5 V${a} Z`);
      l.attr("id", `${P}-service-${g.id}`).attr("class", "architecture-service");
      const { width: r, height: f } = l.node().getBBox();
      ((g.width = r), (g.height = f), R.setElementForId(g.id, l));
    }
    return 0;
  }, "drawServices"),
  Pr = dt(function (R, M, A, P) {
    A.forEach((L) => {
      const g = M.append("g"),
        l = R.getConfigField("iconSize");
      (g
        .append("g")
        .append("rect")
        .attr("id", `${P}-node-${L.id}`)
        ...
        .attr("width", l)
        .attr("height", l),
        g.attr("class", "architecture-junction"));
      const { width: e, height: r } = g._groups[0][0].getBBox();
      ((g.width = e), (g.height = r), R.setElementForId(L.id, g));
    });
  }, "drawJunctions");
sr([{ name: ne.prefix, icons: ne }]);
Fe.use(mr);
function Ue(R, M, A) {
  R.forEach((P) => {
    M.add({
...
function Xe(R, M) {
  M.nodes().map((A) => {
    ...
    ((P.x = A.position().x),
      (P.y = A.position().y),
      R.getElementById(P.id).attr("transform", "translate(" + (P.x || 0) + "," + (P.y || 0) + ")"));
  });
}
dt(Xe, "positionNodes");
function He(R, M) {
...
function We(R, M) {
  R.forEach((A) => {
    const { lhsId: P, rhsId: L, lhsInto: g, lhsGroup: l, rhsInto: a, lhsDir: e, rhsDir: r, rhsGroup: f, title: i } = A,
      u = Te(A.lhsDir, A.rhsDir) ? "segments" : "straight",
      t = {
        id: `${P}-${L}`,
        label: i,
        source: P,
    ...
    M.add({ group: "edges", data: t, classes: u });
  });
}
dt(We, "addEdges");
function Ve(R, M, A) {
  const P = dt(
      (a, e) =>
        Object.entries(a).reduce((r, [f, i]) => {
          var s;
          let u = 0;
          const t = Object.entries(i);
          if (t.length === 1) return ((r[f] = t[0][1]), r);
          for (let o = 0; o < t.length - 1; o++)
            for (let c = o + 1; c < t.length; c++) {
              const [h, T] = t[o],
                [d, v] = t[c];
              if (((s = A[h]) == null ? void 0 : s[d]) === e) (r[f] ?? (r[f] = []), (r[f] = [...r[f], ...T, ...v]));
              else if (h === "default" || d === "default") (r[f] ?? (r[f] = []), (r[f] = [...r[f], ...T, ...v]));
              else {
                const F = `${f}-${u++}`;
                r[F] = T;
                const C = `${f}-${u++}`;
    ...
    L = M.map((a) => {
      const e = {},
        r = {};
      return (
        Object.entries(a).forEach(([f, [i, u]]) => {
          var s, o, c;
          const t = ((s = R.getNode(f)) == null ? void 0 : s.in) ?? "default";
          (e[u] ?? (e[u] = {}),
            (o = e[u])[t] ?? (o[t] = []),
            e[u][t].push(f),
            r[i] ?? (r[i] = {}),
        ...
        {
          horiz: Object.values(P(e, "horizontal")).filter((f) => f.length > 1),
          vert: Object.values(P(r, "vertical")).filter((f) => f.length > 1),
        }
      );
    }),
    [g, l] = L.reduce(
  ...
  return { horizontal: g, vertical: l };
}
dt(Ve, "getAlignments");
function ze(R, M) {
  const A = [],
    P = dt((g) => `${g[0]},${g[1]}`, "posToStr"),
    L = dt((g) => g.split(",").map((l) => parseInt(l)), "strToPos");
  return (
    R.forEach((g) => {
      const l = Object.fromEntries(Object.entries(g).map(([f, i]) => [P(i), f])),
        a = [P([0, 0])],
        e = {},
        ...
        if (f) {
          ...
          if (i) {
            ...
            Object.entries(r).forEach(([t, s]) => {
              const o = P([u[0] + s[0], u[1] + s[1]]),
                c = l[o];
              c &&
                !e[o] &&
                (a.push(o), A.push({ [xe[t]]: c, [xe[Tr(t)]]: i, gap: 1.5 * M.getConfigField("iconSize") }));
            });
          }
        }
      }
...
function $e(R, M, A, P, L, { spatialMaps: g, groupAlignments: l }) {
  return new Promise((a) => {
    ...
    (e.remove(), He(A, r), Ue(R, r, L), Ye(M, r, L), We(P, r));
    const f = Ve(L, g, l),
      i = ze(g, L),
      u = r.layout({
        name: "fcose",
    ...
    (u.one("layoutstop", () => {
      ...
      function t(o, c, h, T) {
        ...
        const { x: N, y: F } = o,
          { x: C, y: G } = c;
        ((v = (T - F + ((N - h) * (F - G)) / (N - C)) / Math.sqrt(1 + Math.pow((F - G) / (N - C), 2))),
          (d = Math.sqrt(Math.pow(T - F, 2) + Math.pow(h - N, 2) - Math.pow(v, 2))));
        const Z = Math.sqrt(Math.pow(C - N, 2) + Math.pow(G - F, 2));
        d = d / Z;
        let X = (C - N) * (T - F) - (G - F) * (h - N);
        switch (!0) {
          case X >= 0:
            X = 1;
            break;
        ...
        return ((v = Math.abs(v) * X), (d = d * K), { distances: v, weights: d });
      }
      (dt(t, "getSegmentWeights"), r.startBatch());
      for (const o of Object.values(r.edges()))
        if ((s = o.data) != null && s.call(o)) {
          const { x: c, y: h } = o.source().position(),
            { x: T, y: d } = o.target().position();
          if (c !== T && h !== d) {
            const v = o.sourceEndpoint(),
              N = o.targetEndpoint(),
              { sourceDir: F } = be(o),
              [C, G] = qt(F) ? [v.x, N.y] : [N.x, v.y],
              { weights: Z, distances: X } = t(v, N, C, G);
            (o.style("segment-distances", X), o.style("segment-weights", Z));
          }
        }
      (r.endBatch(), u.run());
    }),
...
var Gr = dt(async (R, M, A, P) => {
    const L = P.db;
    L.setDiagramId(M);
    const g = L.getServices(),
      l = L.getJunctions(),
      a = L.getGroups(),
      e = L.getEdges(),
    ...
    const t = f.append("g");
    (t.attr("class", "architecture-groups"), await br(L, u, g, M), Pr(L, u, l, M));
    const s = await $e(g, l, a, e, L, r);
    (await Sr(i, s, L, M),
      await Fr(t, s, L, M),
      Xe(L, s),
      Ze(void 0, f, L.getConfigField("padding"), L.getConfigField("useMaxWidth")));
  }, "draw"),
  Ur = { draw: Gr },
  Br = {
    parser: Ge,
