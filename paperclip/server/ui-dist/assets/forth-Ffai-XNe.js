...
function R(i, n) {
  var E;
  for (E = i.length - 1; E >= 0; E--) if (i[E].name === n.toUpperCase()) return i[E];
}
const L = {
  name: "forth",
  startState: function () {
    return { state: "", base: 10, coreWordList: r, immediateWordList: O, wordList: [] };
  },
  token: function (i, n) {
    var E;
    if (i.eatSpace()) return null;
    if (n.state === "") {
      if (i.match(/^(\]|:NONAME)(\s|$)/i)) return ((n.state = " compilation"), "builtin");
      ...
      if (((E = i.match(/^(\'|\[\'\])\s+(\S+)(\s|$)+/)), E)) return "builtin";
    } else {
      if (i.match(/^(\;|\[)(\s)/)) return ((n.state = ""), i.backUp(1), "builtin");
      if (i.match(/^(\;|\[)($)/)) return ((n.state = ""), "builtin");
      if (i.match(/^(POSTPONE)\s+\S+(\s|$)+/)) return "builtin";
    }
    if (((E = i.match(/^(\S+)(\s+|$)/)), E))
      return R(n.wordList, E[1]) !== void 0
        ? "variable"
        : E[1] === "\\"
          ? (i.skipToEnd(), "comment")
          : R(n.coreWordList, E[1]) !== void 0
            ? "builtin"
            : R(n.immediateWordList, E[1]) !== void 0
              ? "keyword"
              : E[1] === "("
                ? (i.eatWhile(function (e) {
                    return e !== ")";
                  }),
                  i.eat(")"),
                  "comment")
