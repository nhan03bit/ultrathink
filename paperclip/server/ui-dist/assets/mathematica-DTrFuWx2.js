...
function i(e, a) {
  ...
  return (
    (n = e.next()),
    n === '"'
      ? ((a.tokenize = Z), a.tokenize(e, a))
      : n === "(" && e.eat("*")
        ? (a.commentLevel++, (a.tokenize = $), a.tokenize(e, a))
        : (e.backUp(1),
          e.match(z, !0, !1) || e.match(m, !0, !1)
            ? "number"
            : e.match(/(?:In|Out)\[[0-9]*\]/, !0, !1)
              ? "atom"
              : e.match(/([a-zA-Z\$][a-zA-Z0-9\$]*(?:`[a-zA-Z0-9\$]+)*::usage)/, !0, !1)
                ? "meta"
                : e.match(/([a-zA-Z\$][a-zA-Z0-9\$]*(?:`[a-zA-Z0-9\$]+)*::[a-zA-Z\$][a-zA-Z0-9\$]*):?/, !0, !1)
                  ? "string.special"
                  : e.match(
