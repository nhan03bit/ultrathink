import { L as r } from "./index-CW2e1zPo.js";
import { s as e, t as O, a as s, L as X, i as l, m as Y, c as $, h as S, f as o, j as t } from "./index-hX5IdXBW.js";
const Z = e({
    null: O.null,
  ...
  _ = X.define({
    ...
    parser: d.configure({
      props: [
        l.add({
          IfStatement: $({ except: /^\s*({|else\b)/ }),
          TryStatement: $({ except: /^\s*({|catch|finally)\b/ }),
          LabeledStatement: Y,
          SwitchBlock: (Q) => {
            let P = Q.textAfter,
              i = /^\s*\}/.test(P),
              a = /^\s*(case|default)\b/.test(P);
            return Q.baseIndent + (i ? 0 : a ? 1 : 2) * Q.unit;
          },
          Block: S({ closing: "}" }),
          BlockComment: () => null,
          Statement: $({ except: /^{/ }),
...
export { q as java, _ as javaLanguage };
