var o = /[+\-\/\\*~<>=@%|&?!.,:;^]/,
  p = /true|false|nil|self|super|thisContext/,
  l = function (e, n) {
    ...
    return (
      a === '"'
        ...
        : a === "'"
          ...
          : a === "#"
            ? e.peek() === "'"
              ? (e.next(), (i = f(e, new l(f, n))))
              : e.eatWhile(/[^\s.{}\[\]()]/)
                ? (i.name = "string.special")
                : (i.name = "meta")
            : a === "$"
              ? (e.next() === "<" && (e.eatWhile(/[^\s>]/), e.next()), (i.name = "string.special"))
              : a === "|" && t.expectVariable
                ? (i.context = new l(x, n))
                : /[\[\]{}()]/.test(a)
                  ? ((i.name = "bracket"),
                    (i.eos = /[\[{(]/.test(a)),
                    a === "[" ? t.indentation++ : a === "]" && (t.indentation = Math.max(0, t.indentation - 1)))
                  : o.test(a)
                    ? (e.eatWhile(o), (i.name = "operator"), (i.eos = a !== ";"))
                    : /\d/.test(a)
                      ? (e.eatWhile(/[\w\d]/), (i.name = "number"))
                      : /[\w_]/.test(a)
                        ? (e.eatWhile(/[\w\d_]/),
                          (i.name = t.expectVariable ? (p.test(e.current()) ? "keyword" : "variable") : null))
...
const d = {
  ...
  token: function (e, n) {
    if ((n.userIndent(e.indentation(), e.indentUnit), e.eatSpace())) return null;
