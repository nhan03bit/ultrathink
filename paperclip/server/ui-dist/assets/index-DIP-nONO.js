import {
  ...
  F as ue,
  G as Lt,
} from "./index-Cwp91QXi.js";
import { html as bt, htmlCompletionSource as wt } from "./index-c2fEEIhx.js";
import "./index-CUFCPqXX.js";
import "./index-CtdEV9UT.js";
import "./index-DOlG5Lgj.js";
class _ {
  ...
  constructor(e, r, n, s, i, o, a) {
    ((this.type = e),
      ...
      (this.children = o),
      (this.positions = a),
      (this.hashProp = [[v.contextHash, s]]));
  }
  addChild(e, r) {
    (e.prop(v.contextHash) != this.hash && (e = new H(e.type, e.children, e.positions, e.length, this.hashProp)),
  ...
  toTree(e, r = this.end) {
    ...
    return (
      ...
      new H(e.types[this.type], this.children, this.positions, r - this.from).balance({
...
class Ct {
  ...
  countIndent(e, r = 0, n = 0) {
    for (let s = r; s < e; s++) n += this.text.charCodeAt(s) == 9 ? 4 - (n % 4) : 1;
    return n;
  }
  findColumn(e) {
    let r = 0;
    for (let n = 0; r < this.text.length && n < e; r++) n += this.text.charCodeAt(r) == 9 ? 4 - (n % 4) : 1;
    return r;
  }
  scrub() {
    if (!this.baseIndent) return this.text;
    let e = "";
    for (let r = 0; r < this.basePos; r++) e += " ";
    return e + this.text.slice(this.basePos);
  }
}
function de(t, e, r) {
  if (r.pos == r.text.length || (t != e.block && r.indent >= e.stack[r.depth + 1].value + r.baseIndent)) return !0;
...
const He = {
  [u.Blockquote](t, e, r) {
    return r.next != 62
      ? !1
      : (r.markers.push(k(u.QuoteMark, e.lineStart + r.pos, e.lineStart + r.pos + 1)),
        r.moveBase(r.pos + (A(r.text.charCodeAt(r.pos + 1)) ? 2 : 1)),
        (t.end = e.lineStart + r.text.length),
        !0);
  },
  [u.ListItem](t, e, r) {
...
function O(t, e = 0) {
  for (; e < t.length && A(t.charCodeAt(e)); ) e++;
  return e;
}
function pe(t, e, r) {
  for (; e > r && A(t.charCodeAt(e - 1)); ) e--;
  return e;
}
function Pe(t) {
  ...
  if (t.next == 96) {
    for (let r = e; r < t.text.length; r++) if (t.text.charCodeAt(r) == 96) return -1;
  }
  return e;
}
function ve(t) {
...
function se(t, e, r) {
  ...
  return (r &&
    t.next == 45 &&
    Re(t) > -1 &&
    t.depth == e.stack.length &&
    e.parser.leafBlockParsers.indexOf(De.SetextHeading) > -1) ||
    n < 3
    ? -1
    : 1;
}
function Ne(t, e) {
  for (let r = t.stack.length - 1; r >= 0; r--) if (t.stack[r].type == e) return !0;
  return !1;
}
function ie(t, e, r) {
  return (t.next == 45 || t.next == 43 || t.next == 42) &&
    (t.pos == t.text.length - 1 || A(t.text.charCodeAt(t.pos + 1))) &&
    (!r || Ne(e, u.BulletList) || t.skipSpace(t.pos + 2) < t.text.length)
    ? 1
    : -1;
}
function oe(t, e, r) {
  ...
  for (; s >= 48 && s <= 57; ) {
    n++;
    if (n == t.text.length) return -1;
    s = t.text.charCodeAt(n);
  }
  return n == t.pos ||
    n > t.pos + 9 ||
    (s != 46 && s != 41) ||
    (n < t.text.length - 1 && !A(t.text.charCodeAt(n + 1))) ||
    (r && !Ne(e, u.OrderedList) && (t.skipSpace(n + 1) == t.text.length || n > t.pos + 1 || t.next != 49))
    ? -1
    : n + 1 - t.pos;
}
function ye(t) {
...
function Re(t) {
  ...
  for (; e < t.text.length && t.text.charCodeAt(e) == t.next; ) e++;
  let r = e;
  for (; e < t.text.length && A(t.text.charCodeAt(e)); ) e++;
...
function ze(t, e, r) {
  ...
  for (let s = 0, i = ee.length - (r ? 1 : 0); s < i; s++) if (ee[s][0].test(n)) return s;
  return -1;
}
function ce(t, e) {
  let r = t.countIndent(e, t.pos, t.indent),
    n = t.countIndent(t.skipSpace(e), e, r);
  return n >= r + 5 ? r + 1 : n;
}
function x(t, e, r) {
  let n = t.length - 1;
...
const $ = {
  ...
  IndentedCode(t, e) {
    ...
    if (e.indent < r) return !1;
    let n = e.findColumn(r),
      s = t.lineStart + n,
    ...
    for (x(o, s, i); t.nextLine() && e.depth >= t.stack.length; )
      if (e.pos == e.text.length) {
        ...
        {
          if (a.length) {
            for (let h of a) h.type == u.CodeText ? x(o, h.from, h.to) : o.push(h);
            a = [];
          }
          x(o, t.lineStart - 1, t.lineStart);
          for (let h of e.markers) o.push(h);
          i = t.lineStart + e.text.length;
    ...
    return (
      a.length && ((a = a.filter((l) => l.type != u.CodeText)), a.length && (e.markers = a.concat(e.markers))),
      t.addNode(t.buffer.writeElements(o, -s).finish(u.CodeBlock, i - s), s),
      !0
    );
  },
  FencedCode(t, e) {
    ...
    let n = t.lineStart + e.pos,
      ...
      i = r - e.pos,
      o = e.skipSpace(r),
      a = pe(e.text, e.text.length, o),
      l = [k(u.CodeMark, n, n + i)];
    o < a && l.push(k(u.CodeInfo, t.lineStart + o, t.lineStart + a));
    for (let h = !0, f = !0, p = !1; t.nextLine() && e.depth >= t.stack.length; h = !1) {
      let d = e.pos;
      if (e.indent - e.baseIndent < 4) for (; d < e.text.length && e.text.charCodeAt(d) == s; ) d++;
      if (d - e.pos >= i && e.skipSpace(d) == e.text.length) {
        for (let c of e.markers) l.push(c);
        (f && p && x(l, t.lineStart - 1, t.lineStart),
          l.push(k(u.CodeMark, t.lineStart + e.pos, t.lineStart + d)),
          t.nextLine());
        break;
      } else {
        ((p = !0), h || (x(l, t.lineStart - 1, t.lineStart), (f = !1)));
        for (let g of e.markers) l.push(g);
        let c = t.lineStart + e.basePos,
          L = t.lineStart + e.text.length;
        c < L && (x(l, c, L), (f = !1));
      }
    }
  ...
  Blockquote(t, e) {
    ...
    return r < 0
      ? !1
      : (t.startContext(u.Blockquote, e.pos),
        t.addNode(u.QuoteMark, t.lineStart + e.pos, t.lineStart + e.pos + 1),
        e.moveBase(e.pos + r),
        null);
  },
  HorizontalRule(t, e) {
    if (se(e, t, !1) < 0) return !1;
  ...
  BulletList(t, e) {
    ...
    let n = ce(e, e.pos + 1);
    return (
      t.startContext(u.ListItem, e.basePos, n - e.baseIndent),
      t.addNode(u.ListMark, t.lineStart + e.pos, t.lineStart + e.pos + r),
      e.moveBaseColumn(n),
      null
    );
  },
  ...
  ATXHeading(t, e) {
    ...
    let n = e.pos,
      s = t.lineStart + n,
      i = pe(e.text, e.text.length, n),
      o = i;
    for (; o > n && e.text.charCodeAt(o - 1) == e.next; ) o--;
    (o == i || o == n || !A(e.text.charCodeAt(o - 1))) && (o = e.text.length);
    let a = t.buffer
      .write(u.HeaderMark, 0, r)
      .writeElements(t.parser.parseInline(e.text.slice(n + r + 1, o), s + r + 1), -s);
  ...
  HTMLBlock(t, e) {
    ...
    for (; !s.test(e.text) && t.nextLine(); ) {
      ...
      for (let h of e.markers) i.push(h);
    }
    o && t.nextLine();
    let a = s == Oe ? u.CommentBlock : s == Te ? u.ProcessingInstructionBlock : u.HTMLBlock,
      l = t.prevLineEnd();
...
` +
  ...
  finish(e, r) {
    return (this.stage == 2 || this.stage == 3) && O(r.content, this.pos) == r.content.length
      ? this.complete(e, r, r.content.length)
      : !1;
  }
  complete(e, r, n) {
  ...
  advance(e) {
    for (;;) {
      if (this.stage == -1) return -1;
      if (this.stage == 0) {
        if (!this.nextStage(Ze(e, this.pos, this.start, !0))) return -1;
        ...
        if (!this.nextStage(qe(e, O(e, this.pos), this.start))) return -1;
        ...
        if (r > this.pos) {
          ...
          if (s) {
            let i = G(e, s.to - this.start);
            i > 0 && (this.nextStage(s), (n = i));
          }
        }
        return (n || (n = G(e, this.pos)), n > 0 && n < e.length ? n : -1);
      } else return G(e, this.pos);
    }
  }
}
function G(t, e) {
...
class xt {
  nextLine(e, r, n) {
    let s = r.depth < e.stack.length ? -1 : Re(r),
      i = r.next;
    if (s < 0) return !1;
    ...
    return (
      ...
      e.addLeafElement(
        n,
        k(i == 61 ? u.SetextHeading1 : u.SetextHeading2, n.start, e.prevLineEnd(), [
...
class It {
  constructor(e, r, n, s) {
    ((this.parser = e),
      ...
      (this.lineStart = this.absoluteLineStart = this.absoluteLineEnd = s[0].from),
      (this.block = _.create(u.Document, 0, this.lineStart, 0, 0)),
      (this.stack = [this.block]),
      (this.fragments = n.length ? new Pt(n, r) : null),
      this.readLine());
  }
  get parsedPos() {
  ...
  advance() {
    ...
    e: for (; this.nextLine() && e.pos != e.text.length; ) {
      if (e.indent < e.baseIndent + 4) {
        for (let n of this.parser.endLeafBlock) if (n(this, e, r)) break e;
      }
      for (let n of r.parsers) if (n.nextLine(this, e, r)) return null;
      r.content +=
        `
` + e.scrub();
      for (let n of e.markers) r.marks.push(n);
    }
  ...
  reuseFragment(e) {
    ...
    return r
      ? ((this.absoluteLineStart += r),
        (this.lineStart = Ge(this.absoluteLineStart, this.ranges)),
        this.moveRangeI(),
  ...
  scanLine(e) {
    let r = Et;
    if (((r.end = e), e >= this.to)) r.text = "";
    else if (((r.text = this.lineChunkAt(e)), (r.end += r.text.length), this.ranges.length > 1)) {
      let n = this.absoluteLineStart,
        s = this.rangeI;
      for (; this.ranges[s].to < r.end; ) {
        s++;
        let i = this.ranges[s].from,
          o = this.lineChunkAt(i);
        ((r.end = i + o.length),
          (r.text = r.text.slice(0, this.ranges[s - 1].to - n) + o),
          (n = r.end - r.text.length));
      }
    }
    return r;
  }
  readLine() {
    let { line: e } = this,
      { text: r, end: n } = this.scanLine(this.absoluteLineStart);
    for (this.absoluteLineEnd = n, e.reset(r); e.depth < this.stack.length; e.depth++) {
      let s = this.stack[e.depth],
        i = this.parser.skipContextMarkup[s.type];
      if (!i) throw new Error("Unhandled block context " + u[s.type]);
...
`);
  ...
  startContext(e, r, n = 0) {
    ((this.block = _.create(e, n, this.lineStart + r, this.block.hash, this.lineStart + this.line.text.length)),
  ...
  addNode(e, r, n) {
    (typeof e == "number" && (e = new H(this.parser.nodeSet.types[e], N, N, (n ?? this.prevLineEnd()) - r)),
      this.block.addChild(e, r - this.block.from));
  }
  addElement(e) {
...
function Fe(t, e, r, n, s) {
  ...
  for (let f = r.firstChild; f; f = f.nextSibling) {
    ...
    let p = f.from + n,
      d,
      c = s.get(f.tree);
    (c ? (d = c) : f.to + n > i ? ((d = Fe(t, e, f, n, s)), h(f.to + n, !1)) : (d = f.toTree()),
      o.push(d),
      a.push(p - l));
  }
...
class Z extends st {
  constructor(e, r, n, s, i, o, a, l, h) {
    ...
    for (let f of e.types) this.nodeTypes[f.name] = f.id;
  }
  createParse(e, r, n) {
    let s = new It(this, e, r, n);
    for (let i of this.wrappers) s = i(s, e, r, n);
    return s;
  }
  configure(e) {
    let r = te(e);
    if (!r) return this;
    let { nodeSet: n, skipContextMarkup: s } = this,
      i = this.blockParsers.slice(),
      o = this.leafBlockParsers.slice(),
      a = this.blockNames.slice(),
      l = this.inlineParsers.slice(),
      h = this.inlineNames.slice(),
      f = this.endLeafBlock.slice(),
      p = this.wrappers;
    if (R(r.defineNodes)) {
      s = Object.assign({}, s);
      let d = n.types.slice(),
      ...
      for (let L of r.defineNodes) {
        ...
        if (d.some((I) => I.name == g)) continue;
        w && (s[d.length] = (I, y, nt) => w(y, nt, I.value));
        let b = d.length,
          E = w
            ? ["Block", "BlockContext"]
            : B
              ? b >= u.ATXHeading1 && b <= u.SetextHeading2
                ? ["Block", "LeafBlock", "Heading"]
                : ["Block", "LeafBlock"]
              : void 0;
        (d.push(Q.define({ id: b, name: g, props: E && [[v.group, E]] })),
    ...
    if ((R(r.props) && (n = n.extend(...r.props)), R(r.remove)))
      for (let d of r.remove) {
        let c = this.blockNames.indexOf(d),
          L = this.inlineNames.indexOf(d);
        (c > -1 && (i[c] = o[c] = void 0), L > -1 && (l[L] = void 0));
      }
    if (R(r.parseBlock))
      for (let d of r.parseBlock) {
        let c = a.indexOf(d.name);
        if (c > -1) ((i[c] = d.parse), (o[c] = d.leaf));
        else {
  ...
  getNodeType(e) {
    ...
    if (r == null) throw new RangeError(`Unknown node type '${e}'`);
    return r;
  }
  parseInline(e, r) {
...
function U(t, e) {
  let r = t.indexOf(e);
  if (r < 0) throw new RangeError(`Position specified relative to unknown parser ${e}`);
  return r;
}
let Xe = [Q.none];
...
class $e {
  ...
  writeElements(e, r = 0) {
    for (let n of e) n.writeTo(this, r);
    return this;
  }
  finish(e, r) {
    return H.build({ buffer: this.content, nodeSet: this.nodeSet, reused: this.nodes, topID: e, length: r });
  }
}
class D {
  ...
  writeTo(e, r) {
    ...
    (e.writeElements(this.children, r),
      e.content.push(this.type, this.from + r, this.to + r, e.content.length + 4 - n));
  }
  toTree(e) {
...
const _e = { resolve: "Emphasis", mark: "EmphasisMark" },
  je = { resolve: "Emphasis", mark: "EmphasisMark" },
  M = {},
  j = {};
class C {
  constructor(e, r, n, s) {
...
const V = {
  Escape(t, e, r) {
    if (e != 92 || r == t.end - 1) return -1;
    let n = t.char(r + 1);
    for (let s = 0; s < me.length; s++) if (me.charCodeAt(s) == n) return t.append(k(u.Escape, r, r + 2));
    return -1;
  },
  Entity(t, e, r) {
    if (e != 38) return -1;
  ...
  InlineCode(t, e, r) {
    if (e != 96 || (r && t.char(r - 1) == 96)) return -1;
    let n = r + 1;
    for (; n < t.end && t.char(n) == 96; ) n++;
    let s = n - r,
      i = 0;
    for (; n < t.end; n++)
      if (t.char(n) == 96) {
        if ((i++, i == s && t.char(n + 1) != 96))
          return t.append(k(u.InlineCode, r, n + 1, [k(u.CodeMark, r, r + s), k(u.CodeMark, n + 1 - s, n + 1)]));
      } else i = 0;
    return -1;
  },
  HTMLTag(t, e, r) {
    if (e != 60 || r == t.end - 1) return -1;
    let n = t.slice(r + 1, t.end),
      s =
    ...
    let i = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(n);
    if (i) return t.append(k(u.Comment, r, r + 1 + i[0].length));
    let o = /^\?[^]*?\?>/.exec(n);
    if (o) return t.append(k(u.ProcessingInstruction, r, r + 1 + o[0].length));
    let a =
  ...
  HardBreak(t, e, r) {
    if (e == 92 && t.char(r + 1) == 10) return t.append(k(u.HardBreak, r, r + 2));
    if (e == 32) {
      let n = r + 1;
      for (; t.char(n) == 32; ) n++;
      if (t.char(n) == 10 && n >= r + 2) return t.append(k(u.HardBreak, r, n + 1));
    }
    return -1;
  },
  Link(t, e, r) {
    return e == 91 ? t.append(new C(M, r, r + 1, 1)) : -1;
  },
  Image(t, e, r) {
    return e == 33 && t.char(r + 1) == 91 ? t.append(new C(j, r, r + 2, 1)) : -1;
  },
  LinkEnd(t, e, r) {
    if (e != 93) return -1;
    for (let n = t.parts.length - 1; n >= 0; n--) {
      ...
      if (s instanceof C && (s.type == M || s.type == j)) {
        ...
        let i = t.takeContent(n),
          o = (t.parts[n] = Mt(t, i, s.type == M ? u.Link : u.Image, s.from, r + 1));
        if (s.type == M)
          for (let a = 0; a < n; a++) {
            let l = t.parts[a];
...
function Mt(t, e, r, n, s) {
  ...
  if ((e.unshift(k(u.LinkMark, n, n + (r == u.Image ? 2 : 1))), e.push(k(u.LinkMark, s - 1, s)), o == 40)) {
    let l = t.skipSpace(s + 1),
      h = qe(i, l - t.offset, t.offset),
      f;
    (h && ((l = t.skipSpace(h.to)), l != h.to && ((f = Qe(i, l - t.offset, t.offset)), f && (l = t.skipSpace(f.to)))),
      t.char(l) == 41 &&
        (e.push(k(u.LinkMark, s, s + 1)), (a = l + 1), h && e.push(h), f && e.push(f), e.push(k(u.LinkMark, l, a))));
  } else if (o == 91) {
...
function qe(t, e, r) {
  if (t.charCodeAt(e) == 60) {
    for (let s = e + 1; s < t.length; s++) {
      ...
      if (i == 62) return k(u.URL, e + r, s + 1 + r);
...
function Qe(t, e, r) {
  ...
  if (n != 39 && n != 34 && n != 40) return !1;
  let s = n == 40 ? 41 : n;
  for (let i = e + 1, o = !1; i < t.length; i++) {
    let a = t.charCodeAt(i);
    if (o) o = !1;
    else {
      if (a == s) return k(u.LinkTitle, e + r, i + 1 + r);
      a == 92 && (o = !0);
    }
  }
  return null;
...
function Ze(t, e, r, n) {
  for (let s = !1, i = e + 1, o = Math.min(t.length, i + 999); i < o; i++) {
    ...
    if (s) s = !1;
      ...
      if (a == 93) return n ? !1 : k(u.LinkLabel, e + r, i + 1 + r);
      if ((n && !A(a) && (n = !1), a == 91)) return !1;
      a == 92 && (s = !0);
    }
  }
  return null;
...
class ae {
  ...
  get hasOpenLink() {
    for (let e = this.parts.length - 1; e >= 0; e--) {
      let r = this.parts[e];
      if (r instanceof C && (r.type == M || r.type == j)) return !0;
    }
    return !1;
  }
  addElement(e) {
  ...
  resolveMarkers(e) {
    for (let n = e; n < this.parts.length; n++) {
      let s = this.parts[n];
      if (!(s instanceof C && s.type.resolve && s.side & 2)) continue;
      let i = s.type == _e || s.type == je,
        o = s.to - s.from,
        a,
        l = n - 1;
      for (; l >= e; l--) {
      ...
      for (let g = l + 1; g < n; g++) (this.parts[g] instanceof D && f.push(this.parts[g]), (this.parts[g] = null));
      s.type.mark && f.push(this.elt(s.type.mark, s.from, d));
      let c = this.elt(h, p, d, f);
      ((this.parts[l] = i && a.from != p ? new C(a.type, a.from, p, a.side) : null),
        (this.parts[n] = i && s.to != d ? new C(s.type, d, s.to, s.side) : null)
          ? this.parts.splice(n, 0, c)
          : (this.parts[n] = c));
    }
    let r = [];
    for (let n = e; n < this.parts.length; n++) {
  ...
  findOpeningDelimiter(e) {
    for (let r = this.parts.length - 1; r >= 0; r--) {
      let n = this.parts[r];
      if (n instanceof C && n.type == e && n.side & 1) return r;
    }
    return null;
  }
  takeContent(e) {
...
`;
    ...
    for (; n.to <= s; ) if (!n.parent()) return !1;
    for (;;) {
      if (n.from >= s) return this.fragment.from <= r;
      if (!n.childAfter(s)) return !1;
    }
  }
  matches(e) {
  ...
  takeNodes(e) {
    let r = this.cursor,
      ...
      s = this.fragmentEnd - (this.fragment.openEnd ? 1 : 0),
    ...
    for (;;) {
      if (r.to - n > s) {
        if (r.type.isAnonymous && r.firstChild()) continue;
        break;
      }
      let f = Ge(r.from - n, e.ranges);
      if (r.to - n <= e.ranges[e.rangeI].to) e.addNode(r.tree, f);
      else {
      ...
      if (
        (r.type.is("Block") &&
          (Ht.indexOf(r.type.id) < 0 ? ((o = r.to - n), (a = e.block.children.length)) : ((o = l), (a = h)),
          (l = r.to - n),
...
const vt = Ie({
  ...
  Nt = new Z(
    new Ee(Xe).extend(vt),
    Object.keys($).map((t) => $[t]),
    Object.keys($).map((t) => De[t]),
    Object.keys($),
    Bt,
    He,
    Object.keys(V).map((t) => V[t]),
    Object.keys(V),
    []
  );
function yt(t, e, r) {
  ...
  for (let s = t.firstChild, i = e; ; s = s.nextSibling) {
    let o = s ? s.from : r;
    if ((o > i && n.push({ from: i, to: o }), !s)) break;
    i = s.to;
  }
  return n;
}
  ...
  return {
    wrap: ot((s, i) => {
      ...
      if (e && (o == u.CodeBlock || o == u.FencedCode)) {
        ...
        let l = e(a);
        if (l) return { parser: l, overlay: (h) => h.type.id == u.CodeText, bracketed: o == u.FencedCode };
...
const Ot = { resolve: "Strikethrough", mark: "StrikethroughMark" },
  Tt = {
    defineNodes: [
      { name: "Strikethrough", style: { "Strikethrough/...": m.strikethrough } },
      { name: "StrikethroughMark", style: m.processingInstruction },
    ],
    parseInline: [
      {
        name: "Strikethrough",
        parse(t, e, r) {
          if (e != 126 || t.char(r + 1) != 126 || t.char(r + 2) == 126) return -1;
          let n = t.slice(r - 1, r),
            s = t.slice(r + 2, r + 3),
            i = /\s|^$/.test(n),
            o = /\s|^$/.test(s),
...
function T(t, e, r = 0, n, s = 0) {
  ...
  for (let p = r; p < e.length; p++) {
    ...
    (d == 124 && !h
      ? ((!o || a > -1) && i++,
        (o = !1),
        n && (a > -1 && f(), n.push(t.elt("TableDelimiter", p + s, p + s + 1))),
        (a = l = -1))
      : (h || (d != 32 && d != 9)) && (a < 0 && (a = p), (l = p + 1)),
      (h = !h && d == 92));
  }
  return (a > -1 && (i++, n && f()), i);
}
...
class ke {
  ...
  nextLine(e, r, n) {
    if (this.rows == null) {
      this.rows = !1;
      let s;
      if ((r.next == 45 || r.next == 58 || r.next == 124) && Ve.test((s = r.text.slice(r.pos)))) {
        let i = [];
        T(e, n.content, 0, i, n.start) == T(e, s, r.pos) &&
          (this.rows = [
      ...
      let s = [];
      (T(e, r.text, r.pos, s, e.lineStart),
        this.rows.push(e.elt("TableRow", e.lineStart + r.pos, e.lineStart + r.text.length, s)));
    }
    return !1;
  }
  finish(e, r) {
  ...
  parseBlock: [
    {
      ...
      endLeaf(t, e, r) {
        if (r.parsers.some((s) => s instanceof ke) || !ge(e.text, e.basePos)) return !1;
        let n = t.peekLine();
        return Ve.test(n) && T(t, e.text, e.basePos) == T(t, n, e.basePos);
      },
...
class Dt {
  ...
  finish(e, r) {
    return (
      e.addLeafElement(
        r,
        e.elt("Task", r.start, r.start + r.content.length, [
...
const Ft = {
  ...
  Le = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy,
  be = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy,
  Xt = /[\w-]+\.[\w-]+($|\/)/,
  we = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy,
  Se = /\/[a-zA-Z\d@.]+/gy;
function Ce(t, e, r, n) {
  let s = 0;
  for (let i = e; i < r; i++) t[i] == n && s++;
  return s;
}
function $t(t, e) {
  be.lastIndex = e;
  let r = be.exec(t);
  if (!r || Xt.exec(r[0])[0].indexOf("_") > -1) return -1;
  let n = e + r[0].length;
  for (;;) {
    let s = t[n - 1],
      i;
    if (/[?!.,:*_~]/.test(s) || (s == ")" && Ce(t, e, n, ")") > Ce(t, e, n, "("))) n--;
    else if (s == ";" && (i = /&(?:#\d+|#x[a-f\d]+|\w+);$/.exec(t.slice(e, n)))) n = e + i.index;
    else break;
  }
  return n;
}
    ...
    parseInline: [
      {
        ...
        parse(t, e, r) {
          let n = r - t.offset;
          if (n && /\w/.test(t.text[n - 1])) return -1;
          Le.lastIndex = n;
          let s = Le.exec(t.text),
            i = -1;
          if (!s) return -1;
          if (s[1] || s[2]) {
            ...
            s[3]
              ? (i = Ae(t.text, n))
              : ((i = Ae(t.text, n + s[0].length)),
                i > -1 &&
                  s[0] == "xmpp:" &&
                  ((Se.lastIndex = i), (s = Se.exec(t.text)), s && (i = s.index + s[0].length)));
...
function Ke(t, e, r) {
  return (n, s, i) => {
    if (s != t || n.char(i + 1) == t) return -1;
    let o = [n.elt(r, i, i + 1)];
    for (let a = i + 1; a < n.end; a++) {
      let l = n.char(a);
      if (l == t) return n.addElement(n.elt(e, i, a + 1, o.concat(n.elt(r, a, a + 1))));
      if ((l == 92 && o.push(n.elt("Escape", a, a++ + 2)), A(l))) break;
    }
    return -1;
  };
}
const jt = {
    ...
    parseInline: [{ name: "Superscript", parse: Ke(94, "Superscript", "SuperscriptMark") }],
  },
  qt = {
    defineNodes: [
    ...
    parseInline: [{ name: "Subscript", parse: Ke(126, "Subscript", "SubscriptMark") }],
  },
  Qt = {
    ...
    parseInline: [
      {
        ...
        parse(t, e, r) {
          let n;
          return e != 58 || !(n = /^[a-zA-Z_0-9]+:/.exec(t.slice(r + 1, t.end)))
            ? -1
            : t.addElement(t.elt("Emoji", r, r + 1 + n[0].length));
        },
      },
    ],
  },
  Je = pt({ commentTokens: { block: { open: "<!--", close: "-->" } } }),
  Ye = new v(),
  We = Nt.configure({
    props: [
      Me.add((t) =>
        !t.is("Block") || t.is("Document") || ne(t) != null || Zt(t)
          ? void 0
          : (e, r) => ({ from: r.doc.lineAt(e.from).to, to: e.to })
      ),
      Ye.add(ne),
      gt.add({ Document: () => null }),
      kt.add({ Document: Je }),
    ],
  });
function ne(t) {
...
function Gt(t, e) {
  ...
  for (;;) {
    let n = r.nextSibling,
      s;
    if (!n || ((s = ne(n.type)) != null && s <= e)) break;
    r = n;
  }
  return r.to;
}
const Vt = dt.of((t, e, r) => {
  for (let n = X(t).resolveInner(r, -1); n && !(n.from < e); n = n.parent) {
    let s = n.type.prop(Ye);
    if (s == null) continue;
    let i = Gt(n, s);
    if (i > r) return { from: r, to: i };
  }
  return null;
});
function le(t) {
  return new ft(Je, t, [], "markdown");
}
const Kt = le(We),
  Jt = We.configure([
    _t,
    ...
    jt,
    Qt,
    { props: [Me.add({ Table: (t, e) => ({ from: e.doc.lineAt(t.from).to, to: t.to }) })] },
  ]),
  q = le(Jt);
function Yt(t, e) {
  return (r) => {
    if (r && t) {
      ...
      if (
        ((r = /\S*/.exec(r)[0]),
        typeof t == "function" ? (n = t(r)) : (n = ue.matchLanguageName(t, r, !0)),
        n instanceof ue)
      )
        return n.support ? n.support.language.parser : Lt.getSkippingParser(n.load());
      if (n) return n.parser;
    }
...
class K {
  ...
  blank(e, r = !0) {
    ...
    if (e != null) {
      ...
      for (let s = this.to - this.from - n.length - this.spaceAfter.length; s > 0; s--) n += " ";
...
function et(t, e) {
  ...
  for (let s = r.length - 1; s >= 0; s--) {
    ...
    if (i.name == "Blockquote" && (o = /^ *>( ?)/.exec(a.text.slice(l))))
      ...
      i.name == "ListItem" &&
      i.parent.name == "OrderedList" &&
      (o = /^( *)\d+([.)])( *)/.exec(a.text.slice(l)))
    ) {
      let h = o[3],
        f = o[0].length;
      (h.length >= 4 && ((h = h.slice(0, h.length - 4)), (f -= 4)),
        n.push(new K(i.parent, l, l + f, o[1], h, o[2], i)));
    } else if (
      i.name == "ListItem" &&
      i.parent.name == "BulletList" &&
      (o = /^( *)([-+*])( {1,4}\[[ xX]\])?( +)/.exec(a.text.slice(l)))
    ) {
      let h = o[4],
        f = o[0].length;
      h.length > 4 && ((h = h.slice(0, h.length - 4)), (f -= 4));
...
function he(t, e) {
  ...
  if (!r || e.facet(ut) != "	") return t;
  let n = z(t, 4, r),
    s = "";
  for (let i = n; i > 0; ) i >= 4 ? ((s += "	"), (i -= 4)) : ((s += " "), i--);
  return s + t.slice(r);
}
const Wt =
    (t = {}) =>
    ({ state: e, dispatch: r }) => {
      let n = X(e),
        ...
        i = null,
        o = e.changeByRange((a) => {
          if (!a.empty || (!q.isActiveAt(e, a.from, -1) && !q.isActiveAt(e, a.from, 1))) return (i = { range: a });
          let l = a.from,
            h = s.lineAt(l),
            f = et(n.resolveInner(l, -1), s);
          for (; f.length && f[f.length - 1].from > l - h.from; ) f.pop();
          if (!f.length) return (i = { range: a });
          let p = f[f.length - 1];
          if (p.to - p.spaceAfter.length > l - h.from) return (i = { range: a });
          let d = l >= p.to - p.spaceAfter.length && !/\S/.test(h.text.slice(p.to));
          if (p.item && d) {
            let w = p.node.firstChild,
              S = p.node.getChild("ListItem", "ListItem");
            if (
              w.to >= l ||
              (S && S.to < l) ||
              (h.from > 0 && !/[^\s>]/.test(s.lineAt(h.from - 1).text)) ||
              t.nonTightLists === !1
            ) {
              let b = f.length > 1 ? f[f.length - 2] : null,
                E,
                I = "";
              b && b.item ? ((E = h.from + b.from), (I = b.marker(s, 1))) : (E = h.from + (b ? b.to : 0));
              let y = [{ from: E, to: l, insert: I }];
              return (
                p.node.name == "OrderedList" && J(p.item, s, y, -2),
                b && b.node.name == "OrderedList" && J(b.item, s, y),
                { range: P.cursor(E + I.length), changes: y }
              );
            } else {
              let b = Be(f, e, h);
              return { range: P.cursor(l + b.length + 1), changes: { from: h.from, insert: b + e.lineBreak } };
            }
          }
          if (p.node.name == "Blockquote" && d && h.from) {
            let w = s.lineAt(h.from - 1),
              S = />\s*$/.exec(w.text);
            if (S && S.index == p.from) {
              let b = e.changes([
          ...
          let L = p.item && p.item.from < h.from,
            g = "";
          ...
          let B = l;
          for (; B > h.from && /\s/.test(h.text.charAt(B - h.from - 1)); ) B--;
          return (
            (g = he(g, e)),
            tr(p.node, e.doc) && (g = Be(f, e, h) + e.lineBreak + g),
            c.push({ from: B, to: l, insert: e.lineBreak + g }),
            { range: P.cursor(B + g.length + 1), changes: c }
          );
        });
...
function tr(t, e) {
  ...
  let r = t.firstChild,
    n = t.getChild("ListItem", "ListItem");
  if (!n) return !1;
  let s = e.lineAt(r.to),
    i = e.lineAt(n.from),
    o = /^[\s>]*$/.test(s.text);
...
function rr(t, e) {
  let r = t.resolveInner(e, -1),
    n = e;
  xe(r) && ((n = r.from), (r = r.parent));
  for (let s; (s = r.childBefore(n)); )
    if (xe(s)) n = s.from;
    else if (s.name == "OrderedList" || s.name == "BulletList") ((r = s.lastChild), (n = r.to));
    else break;
  return r;
}
    ...
    let r = X(t),
      ...
      s = t.changeByRange((i) => {
        ...
        if (i.empty && q.isActiveAt(t, i.from)) {
          ...
          if (h.length) {
            let f = h[h.length - 1],
              p = f.to - f.spaceAfter.length + (f.spaceAfter ? 1 : 0);
            if (o - l.from > p && !/\S/.test(l.text.slice(p, o - l.from)))
              return { range: P.cursor(l.from + p), changes: { from: l.from + p, to: o } };
            if (o - l.from == p && (!f.item || l.from <= f.item.from || !/\S/.test(l.text.slice(0, f.to)))) {
              let d = l.from + f.from;
              if (f.item && f.node.from < f.item.from && /\S/.test(l.text.slice(f.from, f.to))) {
                let c = f.blank(z(l.text, 4, f.to) - z(l.text, 4, f.from));
                return (
                  d == l.from && (c = he(c, t)),
                  { range: P.cursor(d + c.length), changes: { from: d, to: l.from + f.to, insert: c } }
                );
              }
              if (d < o) return { range: P.cursor(d), changes: { from: d, to: o } };
            }
          }
        }
        return (n = { range: i });
...
function cr(t = {}) {
  let {
    ...
    addKeymap: n = !0,
    base: { parser: s } = Kt,
    completeHTMLTags: i = !0,
    pasteURLAsLink: o = !0,
    htmlTagLanguage: a = rt,
  } = t;
  if (!(s instanceof Z)) throw new RangeError("Base parser provided to `markdown` should be a Markdown parser");
  let l = t.extensions ? [t.extensions] : [],
    h = [a.support, Vt],
    f;
  (o && h.push(lr), r instanceof fe ? (h.push(r.support), (f = r.language)) : r && (f = r));
  let p = e || f ? Yt(e, f) : void 0;
  (l.push(Rt({ codeParser: p, htmlParser: a.language.parser })), n && h.push(at.high(lt.of(sr))));
  let d = le(s.configure(l));
  return (i && h.push(d.data.of({ autocomplete: ir })), new fe(d, h));
}
function ir(t) {
  let { state: e, pos: r } = t,
    n = /<[:\-\.\w\u00b7-\uffff]*$/.exec(e.sliceDoc(r - 25, r));
  if (!n) return null;
  ...
  return { from: r - n[0].length, to: r, options: or(), validFor: /^<[:\-\.\w\u00b7-\uffff]*$/ };
}
let Y = null;
function or() {
  if (Y) return Y;
  let t = wt(new ct(mt.create({ extensions: rt }), 0, !0));
  return (Y = t ? t.options : []);
}
const ar = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i,
  lr = ht.domEventHandlers({
    paste: (t, e) => {
      var r;
      ...
      if (
        !s ||
        !/^(https?:\/\/|mailto:|xmpp:|www\.)/.test(s) ||
        (/^www\./.test(s) && (s = "https://" + s), !q.isActiveAt(e.state, n.from, 1))
      )
        return !1;
      let i = X(e.state),
        o = !1;
