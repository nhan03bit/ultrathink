import { b as Ve, G as g, i as m, v as E } from "./graph-CanpU2vE.js";
import {
  i as z,
  c as C,
  k as Ye,
  ...
  m as I,
  r as B,
} from "./_baseUniq-WPYfBEmq.js";
import { f as O, b as me, a as He, c as Ue, m as w, d as P } from "./min-DVON4MDT.js";
import {
  a$ as M,
  by as Ze,
  bz as Je,
  ...
  En = ge(function (e, n) {
    ...
    for (i && S(n[0], n[1], i) && (t = 1); ++r < t; )
      for (var o = n[r], a = ye(o), u = -1, d = a.length; ++u < d; ) {
        var s = a[u],
          c = e[s];
        (c === void 0 || (Ke(c, Oe[s]) && !xn.call(e, s))) && (e[s] = o[s]);
      }
    return e;
  });
function F(e) {
...
function Fn(e, n) {
  if (e !== n) {
    var r = e !== void 0,
      ...
      d = n === n,
      s = z(n);
    if ((!u && !s && !o && e > n) || (o && a && d && !u && !s) || (t && a && d) || (!r && d) || !i) return 1;
    if ((!t && !o && !s && e < n) || (s && r && i && !t && !o) || (u && r && i) || (!a && i) || !d) return -1;
  }
  return 0;
}
function An(e, n, r) {
...
var A = bn(function (e, n) {
  ...
  Vn = Math.max;
function Yn(e, n, r, t) {
  for (var i = -1, o = Vn(Gn((n - e) / (r || 1)), 0), a = Array(o); o--; ) ((a[++i] = e), (e += r));
  return a;
}
function $n(e) {
  return function (n, r, t) {
    return (
      t && typeof t != "number" && S(n, r, t) && (r = t = void 0),
      (n = T(n)),
      r === void 0 ? ((r = n), (n = 0)) : (r = T(r)),
...
class zn {
  ...
  toString() {
    for (var n = [], r = this._sentinel, t = r._prev; t !== r; ) (n.push(JSON.stringify(t, Xn)), (t = t._prev));
    return "[" + n.join(", ") + "]";
  }
}
function ie(e) {
...
function Un(e, n) {
  ...
  var r = Jn(e, n || Hn),
    t = Zn(r.graph, r.buckets, r.zeroIdx);
  return O(
    w(t, function (i) {
...
function Zn(e, n, r) {
  for (var t = [], i = n[n.length - 1], o = n[0], a; e.nodeCount(); ) {
    for (; (a = o.dequeue()); ) Y(e, n, r, a);
    for (; (a = i.dequeue()); ) Y(e, n, r, a);
    if (e.nodeCount()) {
...
function Kn(e) {
  ...
  f(n, function (t) {
    var i = e.edge(t);
    (e.removeEdge(t), (i.forwardName = t.name), (i.reversed = !0), e.setEdge(t.w, t.v, i, J("rev")));
  });
  function r(t) {
    return function (i) {
  ...
  if (o !== t + 1) {
    ...
    for (l = 0, ++t; t < o; ++l, ++t)
      ((u.points = []),
        ...
        (c = N(e, "edge", s, "_d")),
        t === d && ((s.width = u.width), (s.height = u.height), (s.dummy = "edge-label"), (s.labelpos = u.labelpos)),
        e.setEdge(r, c, { weight: u.weight }, a),
        l === 0 && e.graph().dummyChains.push(c),
        (r = c));
...
function Ce(e) {
  var n = new g({ directed: !1 }),
    r = e.nodes()[0],
    t = e.nodeCount();
  n.setNode(r, {});
  for (var i, o; vr(n, e) < t; ) ((i = pr(n, e)), (o = n.hasNode(i.v) ? _(e, i) : -_(e, i)), wr(n, e, o));
  return n;
}
function vr(e, n) {
  function r(t) {
...
function pr(e, n) {
  return Z(n.edges(), function (r) {
    if (e.hasNode(r.v) !== e.hasNode(r.w)) return _(n, r);
  });
}
function wr(e, n, r) {
...
function x(e) {
  ...
  var n = Ce(e);
  (ee(n), Q(n, e));
  for (var r, t; (r = Se(n)); ) ((t = Fe(n, e, r)), Ae(n, e, r, t));
}
function Q(e, n) {
  var r = mr(e, e.nodes());
...
function Be(e, n, r, t, i, o, a) {
  ...
  (e.setParent(d, a),
    ...
    f(u, function (l) {
      Be(e, n, r, t, i, o, l);
      var h = e.node(l),
        v = h.borderTop ? h.borderTop : l,
        p = h.borderBottom ? h.borderBottom : l,
        b = h.borderTop ? t : 2 * t,
        L = v !== p ? 1 : i - o[a] + 1;
      (e.setEdge(d, v, { weight: b, minlen: L, nestingEdge: !0 }),
        e.setEdge(p, s, { weight: b, minlen: L, nestingEdge: !0 }));
    }),
...
function Rr(e, n, r) {
  var t = Tr(e),
    i = new g({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function (o) {
      return e.node(o);
    });
  return (
    f(e.nodes(), function (o) {
...
function Mr(e, n) {
  for (var r = 0, t = 1; t < n.length; ++t) r += Sr(e, n[t - 1], n[t]);
  return r;
}
function Sr(e, n, r) {
  for (
  ...
  return (
    f(
      i.forEach(function (s) {
        var c = s.pos + o;
        u[c] += s.weight;
        for (var l = 0; c > 0; ) (c % 2 && (l += u[c + 1]), (c = (c - 1) >> 1), (u[c] += s.weight));
        d += s.weight * l;
      })
    ),
    d
...
function ce(e, n, r) {
  for (var t; n.length && (t = F(n)).i <= r; ) (n.pop(), e.push(t.vs), r++);
  return r;
}
function Yr(e) {
  return function (n, r) {
...
function qr(e) {
  var n = Pe(e),
    r = le(e, k(1, n + 1), "inEdges"),
    t = le(e, k(n - 1, -1, -1), "outEdges"),
    i = Fr(e);
  he(e, i);
...
function zr(e) {
  ...
  f(e.graph().dummyChains, function (r) {
    for (
      var t = e.node(r), i = t.edgeObj, o = Xr(e, n, i.v, i.w), a = o.path, u = o.lca, d = 0, s = a[d], c = !0;
      r !== i.w;
    ) {
      if (((t = e.node(r)), c)) {
        for (; (s = a[d]) !== u && e.node(s).maxRank < t.rank; ) d++;
        s === u && (c = !1);
      }
      if (!c) {
        for (; d < a.length - 1 && e.node((s = a[d + 1])).minRank <= t.rank; ) d++;
        s = a[d];
      }
...
function Xr(e, n, r, t) {
  ...
  for (s = d, d = t; (d = e.parent(d)) !== s; ) o.push(d);
...
function Ur(e, n) {
  ...
  function t(i, o) {
    ...
    return (
      f(o, function (c, l) {
        var h = Jr(e, c),
          v = h ? e.node(h).order : d;
        (h || c === s) &&
          (f(o.slice(u, l + 1), function (p) {
...
function et(e, n, r, t, i) {
  ...
  return (
    d(s, a.predecessors.bind(a)),
    d(c, a.successors.bind(a)),
    f(t, function (l) {
      o[l] = o[r[l]];
    }),
    o
...
function ft(e, n) {
  (n("    makeSpaceForEdgeLabels", () => xt(e)),
    n("    removeSelfEdges", () => It(e)),
    n("    acyclic", () => Kn(e)),
    n("    nestingGraph.run", () => Lr(e)),
    n("    rank", () => kr(Le(e))),
    n("    injectEdgeLabelProxies", () => Et(e)),
    n("    removeEmptyRanks", () => tr(e)),
    n("    nestingGraph.cleanup", () => Cr(e)),
    n("    normalizeRanks", () => rr(e)),
    n("    assignRankMinMax", () => kt(e)),
    n("    removeEdgeLabelProxies", () => Ot(e)),
    n("    normalize.run", () => cr(e)),
    n("    parentDummyChains", () => zr(e)),
    n("    addBorderSegments", () => or(e)),
    n("    order", () => qr(e)),
    n("    insertSelfEdges", () => Rt(e)),
    n("    adjustCoordinateSystem", () => ur(e)),
    n("    position", () => dt(e)),
    n("    positionSelfEdges", () => Tt(e)),
    n("    removeBorderNodes", () => Ct(e)),
    n("    normalize.undo", () => hr(e)),
    n("    fixupEdgeLabelCoords", () => Pt(e)),
    n("    undoCoordinateSystem", () => dr(e)),
    n("    translateGraph", () => Nt(e)),
    n("    assignNodeIntersects", () => Lt(e)),
    n("    reversePoints", () => _t(e)),
    n("    acyclic.undo", () => er(e)));
}
function ct(e, n) {
  (f(e.nodes(), function (r) {
...
var lt = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"],
  ht = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" },
  vt = ["acyclicer", "ranker", "rankdir", "align"],
  pt = ["width", "height"],
  wt = { width: 0, height: 0 },
  bt = ["minlen", "weight", "width", "height", "labeloffset"],
  mt = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: "r" },
  gt = ["labelpos"];
function yt(e) {
  var n = new g({ multigraph: !0, compound: !0 }),
    r = W(e.graph());
  return (
    n.setGraph(X({}, ht, q(r, lt), A(r, vt))),
    f(e.nodes(), function (t) {
      var i = W(e.node(t));
    ...
    f(e.edges(), function (t) {
      var i = W(e.edge(t));
      n.setEdge(t, X({}, mt, q(i, bt), A(i, gt)));
    }),
    n
  );
}
...
function kt(e) {
  ...
  (f(e.nodes(), function (r) {
    var t = e.node(r);
    t.borderTop &&
      ((t.minRank = e.node(t.borderTop).rank), (t.maxRank = e.node(t.borderBottom).rank), (n = y(n, t.maxRank)));
  }),
    (e.graph().maxRank = n));
}
function Ot(e) {
  ...
  (f(e.nodes(), function (s) {
    ...
    f(e.edges(), function (s) {
      ...
      (f(c.points, function (l) {
        ...
        Object.prototype.hasOwnProperty.call(c, "x") && (c.x -= n),
        Object.prototype.hasOwnProperty.call(c, "y") && (c.y -= t));
    }),
    (o.width = r - n + a),
    (o.height = i - t + u));
}
function Lt(e) {
  f(e.edges(), function (n) {
    ...
    (r.points ? ((o = r.points[0]), (a = r.points[r.points.length - 1])) : ((r.points = []), (o = i), (a = t)),
      r.points.unshift(ae(t, o)),
      r.points.push(ae(i, a)));
  });
}
function Pt(e) {
  f(e.edges(), function (n) {
  ...
  (f(e.nodes(), function (n) {
    if (e.children(n).length) {
      var r = e.node(n),
        ...
        o = e.node(F(r.borderLeft)),
        a = e.node(F(r.borderRight));
