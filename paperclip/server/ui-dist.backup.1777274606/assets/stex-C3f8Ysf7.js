function k(b) {
  ...
  var r = {};
  ((r.importmodule = i("importmodule", "tag", ["string", "builtin"])),
  ...
  function l(t, n) {
    ...
    if (t.match(/^\\[a-zA-Z@\xc0-\u1fff\u2060-\uffff]+/)) {
      ...
      return ((e = r.hasOwnProperty(a) ? r[a] : r.DEFAULT), (e = new e()), h(n, e), f(n, d), e.style);
    }
    ...
    var u = t.next();
    if (u == "%") return (t.skipToEnd(), "comment");
    if (u == "}" || u == "]") {
      if (((e = g(n)), e)) (e.closeBracket(u), f(n, d));
      else return "error";
      return "bracket";
    } else
      return u == "{" || u == "["
        ? ((e = r.DEFAULT), (e = new e()), h(n, e), "bracket")
        : /\d/.test(u)
          ? (t.eatWhile(/[\w.%]/), "atom")
          : (t.eatWhile(/[\w\-_]/), (e = s(n)), e.name == "begin" && (e.argument = t.current()), e.styleIdentifier());
  }
  function o(t, n, e) {
    if (t.eatSpace()) return null;
    if (e && t.match(e)) return (f(n, l), "keyword");
  ...
  function d(t, n) {
    var e = t.peek(),
      a;
    return e == "{" || e == "["
      ? ((a = g(n)), a.openBracket(e), t.eat(e), f(n, l), "bracket")
      : /[ \t\r]/.test(e)
        ? (t.eat(e), null)
        : (f(n, l), p(n), l(t, n));
  }
...
const y = k(!1),
  S = k(!0);
export { y as stex, S as stexMath };
