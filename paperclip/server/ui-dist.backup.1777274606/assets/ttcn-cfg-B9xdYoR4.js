function I(e) {
  for (var n = {}, T = e.split(" "), E = 0; E < T.length; ++E) n[T[E]] = !0;
  return n;
}
const r = {
  keywords: I(
    "Yes No LogFile FileMask ConsoleMask AppendFile TimeStampFormat LogEventTypes SourceInfoFormat LogEntityName LogSourceInfo DiskFullAction LogFileNumber LogFileSize MatchingHints Detailed Compact SubCategories Stack Single None Seconds DateTime Time Stop Error Retry Delete TCPPort KillTimer NumHCs UnixSocketsEnabled LocalAddress"
  ),
  fileNCtrlMaskOptions: I(
...
var A = r.keywords,
  U = r.fileNCtrlMaskOptions,
  R = r.externalCommands,
  S = r.indentStatements !== !1,
  O = /[\|]/,
  t;
function u(e, n) {
  var T = e.next();
  ...
  e.eatWhile(/[\w\$_]/);
  var E = e.current();
  return A.propertyIsEnumerable(E)
    ? "keyword"
    : U.propertyIsEnumerable(E)
      ? "atom"
      : R.propertyIsEnumerable(E)
        ? "deleted"
        : "variable";
}
function P(e) {
  return function (n, T) {
    for (var E = !1, i, l = !1; (i = n.next()) != null; ) {
      if (i == e && !E) {
        var C = n.peek();
        (C && ((C = C.toLowerCase()), (C == "b" || C == "h" || C == "o") && n.next()), (l = !0));
        break;
      }
      E = !E && i == "\\";
    }
...
function N(e, n, T) {
  var E = e.indented;
  return (
    e.context && e.context.type == "statement" && (E = e.context.indented),
    (e.context = new _(E, n, T, null, e.context))
  );
}
function o(e) {
...
const L = {
  name: "ttcn",
  startState: function () {
    return { tokenize: null, context: new _(0, 0, "top", !1), indented: 0, startOfLine: !0 };
  },
  token: function (e, n) {
    var T = n.context;
    if (
    ...
    if ((T.align == null && (T.align = !0), (t == ";" || t == ":" || t == ",") && T.type == "statement")) o(n);
      ...
      t == T.type
        ? o(n)
        : S &&
          (((T.type == "}" || T.type == "top") && t != ";") || (T.type == "statement" && t == "newstatement")) &&
          N(n, e.column(), "statement");
