import { g as ze } from "./chunk-55IACEB6-coqV5UWO.js";
import { s as Ge } from "./chunk-QN33PNHL-DmZbeWJQ.js";
import {
  _ as m,
  b as Xe,
  a as Je,
...
var Ae = (function () {
  var e = m(function (P, i, r, l) {
    ...
    g = [1, 39],
    _ = [1, 40],
    y = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90],
    $ = [1, 61],
    X = [89, 90],
    Ce = [
    ...
    Se = {
      ...
      performAction: m(function (i, r, l, s, d, t, Ee) {
        var n = t.length - 1;
        switch (d) {
          case 4:
      ...
      table: [
        { 3: 1, 4: 2, 6: a, 9: u, 11: o, 13: f },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: a, 9: u, 11: o, 13: f },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(c, [2, 6]),
        { 3: 12, 4: 2, 6: a, 9: u, 11: o, 13: f },
        { 1: [2, 2] },
        {
          4: 17,
          5: p,
        ...
        e(y, [2, 19]),
        e(y, [2, 20]),
        { 30: 60, 33: 62, 75: $, 89: g, 90: _ },
        { 30: 63, 33: 62, 75: $, 89: g, 90: _ },
        { 30: 64, 33: 62, 75: $, 89: g, 90: _ },
        e(X, [2, 29]),
        e(X, [2, 30]),
        e(X, [2, 31]),
        e(X, [2, 32]),
        ...
        e(de, [2, 85]),
        e(de, [2, 86]),
        { 62: 69, 65: Ve, 66: ve, 67: xe, 68: Le, 69: De, 70: Oe, 71: we },
        { 62: 77, 65: Ve, 66: ve, 67: xe, 68: Le, 69: De, 70: Oe, 71: we },
        { 30: 78, 33: 62, 75: $, 89: g, 90: _ },
        {
          73: 79,
          75: ee,
          76: U,
        ...
        { 30: 94, 33: 62, 75: $, 76: U, 89: g, 90: _ },
        { 5: [1, 95] },
        { 30: 96, 33: 62, 75: $, 89: g, 90: _ },
        { 5: [1, 97] },
        { 30: 98, 33: 62, 75: $, 89: g, 90: _ },
        { 63: [1, 99] },
        e(Y, [2, 50]),
        e(Y, [2, 51]),
        e(Y, [2, 52]),
        ...
        { 5: he, 40: ue, 56: 163, 57: me, 59: fe },
        { 5: he, 40: ue, 56: 164, 57: me, 59: fe },
        e(y, [2, 23]),
        e(y, [2, 24]),
        e(y, [2, 25]),
        e(y, [2, 26]),
      ...
      parse: m(function (i) {
        var r = this,
          ...
          He = 2,
          $e = 1,
          Ke = t.slice.call(arguments, 1),
          S = Object.create(this.lexer),
          z = { yy: {} };
        for (var Ie in this.yy) Object.prototype.hasOwnProperty.call(this.yy, Ie) && (z.yy[Ie] = this.yy[Ie]);
        ...
        function Ue() {
          ...
          return (
            (T = s.pop() || S.lex() || $e),
            typeof T != "number" && (T instanceof Array && ((s = T), (T = s.pop())), (T = r.symbols_[T] || T)),
            T
          );
        }
        m(Ue, "lex");
        for (var b, G, q, Te, J = {}, ge, F, Ye, _e; ; ) {
          if (
            ...
            this.defaultActions[G]
              ? (q = this.defaultActions[G])
              : ((b === null || typeof b > "u") && (b = Ue()), (q = Ee[G] && Ee[G][b])),
            typeof q > "u" || !q.length || !q[0])
          ) {
            var ke = "";
            _e = [];
            for (ge in Ee[G]) this.terminals_[ge] && ge > He && _e.push("'" + this.terminals_[ge] + "'");
            (S.showPosition
              ? (ke =
                  "Parse error on line " +
                  (ye + 1) +
...
Expecting ` +
              ...
              : (ke =
                  ...
                  (ye + 1) +
                  ": Unexpected " +
                  (b == $e ? "end of input" : "'" + (this.terminals_[b] || b) + "'")),
              this.parseError(ke, {
                text: S.match,
          ...
          switch (q[0]) {
            ...
            case 2:
              if (
                ...
                We && (J._$.range = [t[t.length - (F || 1)].range[0], t[t.length - 1].range[1]]),
                (Te = this.performAction.apply(J, [n, Pe, ye, z.yy, q[1], d, t].concat(Ke))),
                typeof Te < "u")
              )
                return Te;
              (F && ((l = l.slice(0, -1 * F * 2)), (d = d.slice(0, -1 * F)), (t = t.slice(0, -1 * F))),
                l.push(this.productions_[q[1]][0]),
                d.push(J.$),
                t.push(J._$),
                (Ye = Ee[l[l.length - 2]][l[l.length - 1]]),
                l.push(Ye));
              break;
            case 3:
              return !0;
    ...
    Qe = (function () {
      var P = {
        EOF: 1,
        parseError: m(function (r, l) {
          if (this.yy.parser) this.yy.parser.parseError(r, l);
          else throw new Error(r);
        }, "parseError"),
        setInput: m(function (i, r) {
          return (
            (this.yy = r || this.yy || {}),
            (this._input = i),
        ...
        unput: m(function (i) {
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [d[0], d[0] + this.yyleng - r]),
...
` +
        ...
        test_match: m(function (i, r) {
          ...
          if (
            ...
            (this.matched += i[0]),
            (l = this.performAction.call(this, this.yy, this, r, this.conditionStack[this.conditionStack.length - 1])),
        ...
        next: m(function () {
          ...
          for (var d = this._currentRules(), t = 0; t < d.length; t++)
            if (((l = this._input.match(this.rules[d[t]])), l && (!r || l[0].length > r[0].length))) {
              if (((r = l), (s = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(l, d[t])), i !== !1)) return i;
                if (this._backtrack) {
                  r = !1;
                  continue;
                } else return !1;
          ...
          return r
            ? ((i = this.test_match(r, d[s])), i !== !1 ? i : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: m(function (r) {
          return ((r = this.conditionStack.length - 1 - Math.abs(r || 0)), r >= 0 ? this.conditionStack[r] : "INITIAL");
        }, "topState"),
        pushState: m(function (r) {
          this.begin(r);
        }, "pushState"),
        ...
        performAction: m(function (r, l, s, d) {
          switch (s) {
            case 0:
              return "title";
            case 1:
    ...
    ((Z = class {
      constructor() {
        ((this.relations = []),
          ...
          (this.setAccTitle = Xe),
          (this.getAccTitle = Je),
          (this.setAccDescription = Ze),
          (this.getAccDescription = et),
          (this.setDiagramTitle = tt),
          (this.getDiagramTitle = st),
          (this.getConfig = m(() => Ne().requirement, "getConfig")),
          this.clear(),
      ...
      addRequirement(a, u) {
        return (
          this.requirements.has(a) ||
            this.requirements.set(a, {
              name: a,
              type: u,
      ...
      addRelationship(a, u, o) {
        this.relations.push({ type: a, src: u, dst: o });
      }
      getRelationships() {
      ...
      setCssStyle(a, u) {
        for (const o of a) {
          ...
          if (!u || !f) return;
          for (const c of u) c.includes(",") ? f.cssStyles.push(...c.split(",")) : f.cssStyles.push(c);
        }
      }
      setClass(a, u) {
        var o;
      ...
      defineClass(a, u) {
        for (const o of a) {
          ...
          (f === void 0 && ((f = { id: o, styles: [], textStyles: [] }), this.classes.set(o, f)),
            u &&
      ...
      getData() {
        ...
        for (const h of this.requirements.values()) {
          const E = h;
          ((E.id = h.name),
            (E.cssStyles = h.cssStyles),
            (E.cssClasses = h.classes.join(" ")),
            (E.shape = "requirementBox"),
            (E.look = a.look),
            u.push(E));
        }
        ...
        for (const h of this.relations) {
          let E = 0;
          const I = h.type === this.Relationships.CONTAINS,
            k = {
              id: `${h.src}-${h.dst}-${E}`,
              start:
                ((f = this.requirements.get(h.src)) == null ? void 0 : f.name) ??
                ((c = this.elements.get(h.src)) == null ? void 0 : c.name),
              end:
                ((p = this.requirements.get(h.dst)) == null ? void 0 : p.name) ??
                ((R = this.elements.get(h.dst)) == null ? void 0 : R.name),
              label: `&lt;&lt;${h.type}&gt;&gt;`,
...
`,
  ...
  Be = {};
rt(Be, { draw: () => mt });
var mt = m(async function (e, a, u, o) {
    (qe.info("REF0:"), qe.info("Drawing requirement diagram (unified)", a));
    const { securityLevel: f, state: c, layout: p } = Ne(),
      R = o.db.getData(),
      h = ze(a, f);
    ((R.type = o.type),
      (R.layoutAlgorithm = nt(p)),
      (R.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) ?? 50),
      (R.rankSpacing = (c == null ? void 0 : c.rankSpacing) ?? 50),
      (R.markers = ["requirement_contains", "requirement_arrow"]),
      (R.diagramId = a),
      await at(R, h));
    const E = 8;
    (lt.insertTitle(
      ...
      Ge(h, E, "requirementDiagram", (c == null ? void 0 : c.useMaxWidth) ?? !0));
  }, "draw"),
  Rt = {
    parser: ct,
    get db() {
