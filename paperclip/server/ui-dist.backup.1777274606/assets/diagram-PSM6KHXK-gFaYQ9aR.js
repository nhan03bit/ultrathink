...
import { s as we } from "./chunk-QN33PNHL-DmZbeWJQ.js";
import { p as Ce } from "./chunk-4BX2VUAB-Cb4O8Gqh.js";
import { p as Te } from "./treemap-GDKQZRPO-qHAS-c0V.js";
import { b as O } from "./defaultLocale-DX6XiGOO.js";
import { o as U } from "./ordinal-Cboi1Yqb.js";
...
function Fe(t, a) {
  for (var l = this, n = [l], o, s, d = -1; (l = n.pop()); )
    if ((t.call(a, l, ++d, this), (o = l.children))) for (s = o.length - 1; s >= 0; --s) n.push(o[s]);
  return this;
}
function ke(t, a) {
  for (var l = this, n = [l], o = [], s, d, h, g = -1; (l = n.pop()); )
    if ((o.push(l), (s = l.children))) for (d = 0, h = s.length; d < h; ++d) n.push(s[d]);
...
function ze(t) {
  for (var a = this, l = Ve(a, t), n = [a]; a !== l; ) ((a = a.parent), n.push(a));
...
function* Ee() {
  ...
  do
    for (a = l.reverse(), l = []; (t = a.pop()); )
      if ((yield t, (n = t.children))) for (o = 0, s = n.length; o < s; ++o) l.push(n[o]);
  while (l.length);
}
function Q(t, a) {
...
function Ke(t, a, l, n, o, s) {
  for (var d = [], h = a.children, g, c, u = 0, b = 0, r = h.length, x, S, v = a.value, p, m, N, k, V, E, M; u < r; ) {
    ...
    (d.push((g = { value: p, dice: x < S, children: h.slice(u, b) })),
      g.dice ? je(g, l, n, o, v ? (n += (S * p) / v) : s) : Ye(g, l, n, v ? (l += (x * p) / v) : o, s),
      (v -= p),
      (u = b));
  }
  return d;
    ...
    ((R = class {
      constructor() {
        ((this.nodes = []),
          ...
          (this.setAccTitle = pe),
          (this.getAccTitle = fe),
          (this.setDiagramTitle = ge),
          (this.getDiagramTitle = me),
          (this.getAccDescription = ye),
          (this.setAccDescription = Se));
      }
      getNodes() {
        return this.nodes;
      }
      ...
      addClass(a, l) {
        ...
        (o &&
          o.forEach((s) => {
            (xe(s) && (n != null && n.textStyles ? n.textStyles.push(s) : (n.textStyles = [s])),
...
var Qe = w((t, a) => {
    ...
    for (const s of t.TreemapRows ?? []) {
      ...
      const h = s.indent ? parseInt(s.indent) : 0,
        ...
        u = c.length > 0 ? c.join(";") : void 0,
        b = { level: h, name: g, type: d.$type, value: d.value, classSelector: d.classSelector, cssCompiledStyles: u };
      l.push(b);
    }
    const n = le(l),
      o = w((s, d) => {
        for (const h of s) (a.addNode(h, d), h.children && h.children.length > 0 && o(h.children, d + 1));
      }, "addNodesRecursively");
    o(n, 0);
  }, "populate"),
  et = w((t) => (t.name ? String(t.name) : ""), "getItemName"),
  re = {
    parser: { yy: void 0 },
    parse: w(async (t) => {
      var a;
  ...
  at = w((t, a, l, n) => {
    ...
    const u = h ? 30 : 0,
      b = he(a),
      r = s.nodeWidth ? s.nodeWidth * B : 960,
    ...
    try {
      ...
      if (e === "$0,0") p = w((i) => "$" + O(",")(i), "valueFormat");
    ...
    const V = b.append("g").attr("transform", `translate(0, ${u})`).attr("class", "treemapContainer"),
      ...
      ee = Je()
        ...
        .round(!0)(E),
      se = ee.descendants().filter((e) => e.children && e.children.length > 0),
      W = V.selectAll(".treemapSection")
        .data(se)
        .enter()
        .append("g")
    ...
    const ie = ee.leaves(),
      j = V.selectAll(".treemapLeafGroup")
        .data(ie)
        .enter()
        .append("g")
        .attr(
      ...
      j
        ...
        .each(function (e) {
          ...
          const _ = 8,
            ...
            z = 6,
            H = 2;
          for (; L.getComputedTextLength() > D && y > _; ) (y--, i.style("font-size", `${y}px`));
          let I = Math.max(z, Math.min(F, Math.round(y * T))),
            K = y + H + I;
          for (; K > A && y > _ && (y--, (I = Math.max(z, Math.min(F, Math.round(y * T)))), !(I < z && y === _)); )
            (i.style("font-size", `${y}px`), (K = y + H + I));
          (i.style("font-size", `${y}px`),
            (L.getComputedTextLength() > D || y < _ || A < y) && i.style("display", "none"));
        }),
      s.showValues !== !1 &&
        j
          .append("text")
          ...
          .attr("style", (i) => {
            const f = "text-anchor: middle; dominant-baseline: hanging; font-size: 28px;fill:" + k(i.data.name) + ";",
              C = P({ cssCompiledStyles: i.data.cssCompiledStyles });
          ...
          .each(function (i) {
            ...
            const H = i.x1 - i.x0,
              ce = i.y1 - i.y0 - 4,
              de = H - 8;
            f.node().getComputedTextLength() > de || z + F > ce || F < y
              ? f.style("display", "none")
