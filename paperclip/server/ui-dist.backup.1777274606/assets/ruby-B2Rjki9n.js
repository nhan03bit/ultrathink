...
var v = [
  ...
  x = k(v),
  z = k(["def", "class", "case", "for", "while", "until", "module", "catch", "loop", "proc", "begin"]),
  b = k(["end", "until"]),
  h = { "[": "]", "{": "}", "(": ")" },
  _ = { "]": "[", "}": "{", ")": "(" },
  f;
...
function p(e, i) {
  ...
  if (n == "/") return g(e) ? c(d(n, "string.special", !0), e, i) : "operator";
  if (n == "%") {
    var l = "string",
      r = !0;
    e.eat("s")
...
function d(e, i, n, o) {
  return function (l, r) {
    var u = !1,
      t;
    for (
      r.context.type === "read-quoted-paused" && ((r.context = r.context.prev), l.eat("}"));
      (t = l.next()) != null;
    ) {
      if (t == e && (o || !u)) {
        r.tokenize.pop();
...
const E = {
  ...
  token: function (e, i) {
    ...
    var n = i.tokenize[i.tokenize.length - 1](e, i),
      o,
      l = f;
    if (n == "variable") {
      var r = e.current();
      ((n =
        i.lastTok == "."
          ? "property"
          : x.propertyIsEnumerable(e.current())
            ? "keyword"
            : /^[A-Z]/.test(r)
              ? "tag"
              : i.lastTok == "def" || i.lastTok == "class" || i.varList
                ? "def"
                : "variable"),
        n == "keyword" &&
          ((l = r),
          z.propertyIsEnumerable(r)
            ? (o = "indent")
            : b.propertyIsEnumerable(r)
              ? (o = "dedent")
              : (((r == "if" || r == "unless") && e.column() == e.indentation()) ||
                  (r == "do" && i.context.indented < i.indented)) &&
                (o = "indent")));
    }
    return (
      (f || (n && n != "comment")) && (i.lastTok = l),
      f == "|" && (i.varList = !i.varList),
      o == "indent" || /[\(\[\{]/.test(f)
        ? (i.context = { prev: i.context, type: f || n, indented: i.indented })
        : (o == "dedent" || /[\)\]\}]/.test(f)) && i.context.prev && (i.context = i.context.prev),
      e.eol() && (i.continuedLine = f == "\\" || n == "operator"),
      n
    );
  },
  indent: function (e, i, n) {
    ...
    var o = i && i.charAt(0),
      l = e.context,
      r = l.type == _[o] || (l.type == "keyword" && /^(?:end|until|else|elsif|when|rescue)\b/.test(i));
