import { g as de } from "./chunk-FMBD7UC4-BPzB7Csq.js";
import {
  _ as d,
  H as st,
  d as R,
...
import { c as ve } from "./clone-CiBR69il.js";
import { G as Ee } from "./graph-C_2AnXgs.js";
import { c as _e } from "./channel-CAxg-MJq.js";
import "./index-ChLuXRS1.js";
import "./_baseUniq-LizNW1gx.js";
var wt = (function () {
  var e = d(function (N, x, g, p) {
    ...
    y = [1, 23],
    b = [1, 24],
    L = [8, 10, 15, 16, 21, 28, 29, 30, 31, 39, 43, 46],
    E = [8, 10, 15, 16, 21, 27, 28, 29, 30, 31, 39, 43, 46],
    D = [1, 49],
    v = {
      ...
      performAction: d(function (x, g, p, w, S, c, _) {
        var f = c.length - 1;
        switch (S) {
          case 4:
          ...
          case 11:
            ...
            break;
          case 12:
            (w.getLogger().debug("Rule: statement: ", c[f]),
              typeof c[f].length == "number" ? (this.$ = c[f]) : (this.$ = [c[f]]));
            break;
          case 13:
          ...
          case 14:
            ...
            break;
          case 15:
            (w.getLogger().debug("Rule: LABEL link: ", c[f - 3], c[f - 1], c[f]),
              (this.$ = { edgeTypeStr: c[f], label: c[f - 1] }));
            break;
          case 18:
          ...
          case 23:
            ...
            break;
          case 24:
            (w.getLogger().debug("Rule: nodeStatement (abc88 node size) ", c[f - 1], c[f]),
              (this.$ = {
                id: c[f - 1].id,
                label: c[f - 1].label,
                type: w.typeStr2Type(c[f - 1].typeStr),
                directions: c[f - 1].directions,
                widthInColumns: parseInt(c[f], 10),
              }));
            break;
          case 25:
            (w.getLogger().debug("Rule: nodeStatement (node) ", c[f]),
              (this.$ = {
                id: c[f].id,
                label: c[f].label,
                type: w.typeStr2Type(c[f].typeStr),
                directions: c[f].directions,
                widthInColumns: 1,
              }));
            break;
          case 26:
            (w.getLogger().debug("APA123", this ? this : "na"),
              w.getLogger().debug("COLUMNS: ", c[f]),
              (this.$ = { type: "column-setting", columns: c[f] === "auto" ? -1 : parseInt(c[f]) }));
            break;
          case 27:
            (w.getLogger().debug("Rule: id-block statement : ", c[f - 2], c[f - 1]),
              w.generateId(),
              (this.$ = { ...c[f - 2], type: "composite", children: c[f - 1] }));
            break;
          case 28:
          ...
          case 29:
            ...
            break;
          case 30:
            (w.getLogger().debug("Rule: node (NODE_ID nodeShapeNLabel separator): ", c[f - 1], c[f]),
              (this.$ = { id: c[f - 1], label: c[f].label, typeStr: c[f].typeStr, directions: c[f].directions }));
            break;
          case 31:
          ...
          case 32:
            ...
            break;
          case 33:
            (w.getLogger().debug("Rule: nodeShapeNLabel: ", c[f - 2], c[f - 1], c[f]),
              (this.$ = { typeStr: c[f - 2] + c[f], label: c[f - 1] }));
            break;
          case 34:
            (w.getLogger().debug("Rule: BLOCK_ARROW nodeShapeNLabel: ", c[f - 3], c[f - 2], " #3:", c[f - 1], c[f]),
              (this.$ = { typeStr: c[f - 3] + c[f], label: c[f - 2], directions: c[f - 1] }));
            break;
          case 35:
          case 36:
      ...
      table: [
        ...
        { 44: [1, 30] },
        { 47: [1, 31] },
        e(E, [2, 29], { 32: 32, 35: [1, 33], 37: [1, 34] }),
        { 1: [2, 7] },
        e(u, [2, 13]),
        { 26: 35, 31: s },
        { 31: [2, 14] },
      ...
      parse: d(function (x) {
        ...
        function Tt() {
          ...
          return (
            (H = w.pop() || M.lex() || P),
            typeof H != "number" && (H instanceof Array && ((w = H), (H = w.pop())), (H = g.symbols_[H] || H)),
            H
          );
        }
        d(Tt, "lex");
        for (var Y, $, U, ft, tt = {}, it, q, Ct, nt; ; ) {
          if (
            ...
            this.defaultActions[$]
              ...
              : ((Y === null || typeof Y > "u") && (Y = Tt()), (U = _[$] && _[$][Y])),
...
Expecting ` +
              ...
              : (xt =
                  ...
                  (A + 1) +
                  ": Unexpected " +
                  (Y == P ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'")),
              this.parseError(xt, {
                text: M.match,
          ...
          switch (U[0]) {
            ...
            case 2:
              if (
                ...
                oe && (tt._$.range = [c[c.length - (q || 1)].range[0], c[c.length - 1].range[1]]),
                (ft = this.performAction.apply(tt, [f, O, A, Q.yy, U[1], S, c].concat(J))),
                typeof ft < "u")
              )
                return ft;
              (q && ((p = p.slice(0, -1 * q * 2)), (S = S.slice(0, -1 * q)), (c = c.slice(0, -1 * q))),
                p.push(this.productions_[U[1]][0]),
                S.push(tt.$),
                c.push(tt._$),
                (Ct = _[p[p.length - 2]][p[p.length - 1]]),
                p.push(Ct));
              break;
            case 3:
              return !0;
        ...
        unput: d(function (x) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: p
                ? (p.length === w.length ? this.yylloc.first_column : 0) + w[w.length - p.length].length - p[0].length
                : this.yylloc.first_column - g,
            }),
            this.options.ranges && (this.yylloc.range = [S[0], S[0] + this.yyleng - g]),
...
` +
        ...
        test_match: d(function (x, g) {
          ...
          if (
            ...
            (this.matched += x[0]),
            (p = this.performAction.call(this, this.yy, this, g, this.conditionStack[this.conditionStack.length - 1])),
        ...
        next: d(function () {
          ...
          return g
            ? ((x = this.test_match(g, S[w])), x !== !1 ? x : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        options: {},
        performAction: d(function (g, p, w, S) {
          switch (w) {
            case 0:
            ...
            case 7:
              return (
                ...
                g.getLogger().debug("COLUMNS (LEX)", p.yytext),
                28
              );
            case 8:
            ...
            case 14:
              return (
                ...
                g.getLogger().debug("SPACE NUM (LEX)", p.yytext),
                21
              );
            case 15:
            ...
            case 85:
              return (
                ...
                g.getLogger().debug("Lex (right): dir:", p.yytext),
                "DIR"
              );
            case 86:
            ...
            case 91:
              return (
                (p.yytext = "]>"),
                g.getLogger().debug("Lex (ARROW_DIR end):", p.yytext),
                this.popState(),
                this.popState(),
                "BLOCK_ARROW_END"
              );
...
var ke = wt,
  ...
  Ne = z(),
  ot = new Map(),
  Te = d((e) => me.sanitizeText(e, Ne), "sanitizeText"),
  Ce = d(function (e, t = "") {
    let a = ot.get(e);
    (a || ((a = { id: e, styles: [], textStyles: [] }), ot.set(e, a)),
      t != null &&
        t.split(Kt).forEach((i) => {
    ...
    for (const r of a) {
      if (
        (typeof s == "number" &&
          ...
          r.widthInColumns > s &&
          m.warn(`Block ${r.id} width ${r.widthInColumns} exceeds configured column width ${s}`),
        r.label && (r.label = Te(r.label)),
        r.type === "classDef")
      ) {
        Ce(r.id, r.css);
        continue;
  ...
  _t = [],
  at = { id: "root", type: "composite", children: [], columns: -1 },
  Oe = d(() => {
    (m.debug("Clear called"),
      ue(),
      (at = { id: "root", type: "composite", children: [], columns: -1 }),
      (V = new Map([["root", at]])),
      (_t = []),
...
var Ot = 0,
  Re = d(() => (Ot++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Ot), "generateId"),
  ze = d((e) => {
  ...
  Me = d(() => [...V.values()], "getBlocksFlat"),
  Fe = d(() => _t || [], "getBlocks"),
  We = d(() => Et, "getEdges"),
  Pe = d((e) => V.get(e), "getBlock"),
  Ye = d((e) => {
    V.set(e.id, e);
  }, "setBlock"),
  He = d(() => m, "getLogger"),
  ...
  Xe = {
    getConfig: d(() => st().block, "getConfig"),
    typeStr2Type: Ut,
    edgeTypeStr2Type: jt,
...
`,
  ...
  Pt,
  Yt,
  B = ((Yt = (Pt = z()) == null ? void 0 : Pt.block) == null ? void 0 : Yt.padding) ?? 8;
function Gt(e, t) {
...
var nr = d((e) => {
  ...
  for (const i of e.children) {
    ...
    (m.debug("getMaxChildSize abc95 child:", i.id, "width:", l, "height:", s, "x:", r, "y:", n, i.type),
...
function ht(e, t, a = 0, i = 0) {
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    for (const S of e.children) ht(S, t);
    const T = nr(e);
    ((l = T.width), (s = T.height), m.debug("setBlockSizes abc95 maxWidth of", e.id, ":s children is ", l, s));
    for (const S of e.children)
      S.size &&
        (m.debug(`abc95 Setting size of children of ${e.id} id=${S.id} ${l} ${s} ${JSON.stringify(S.size)}`),
        (S.size.width = l * (S.widthInColumns ?? 1) + B * ((S.widthInColumns ?? 1) - 1)),
        (S.size.height = s),
        (S.size.x = 0),
        (S.size.y = 0),
        m.debug(`abc95 updating size of ${e.id} children child:${S.id} maxWidth:${l} maxHeight:${s}`));
    for (const S of e.children) ht(S, t, l, s);
    const k = e.columns ?? -1;
    let N = 0;
    for (const S of e.children) N += S.widthInColumns ?? 1;
    ...
    let p = x * (l + B) + B,
      w = g * (s + B) + B;
    if (p < a) {
      (m.debug(`Detected to small sibling: abc95 ${e.id} siblingWidth ${a} siblingHeight ${i} width ${p}`),
        (p = a),
        (w = i));
      const S = (a - x * B - B) / x,
        c = (i - g * B - B) / g;
      (m.debug("Size indata abc88", e.id, "childWidth", S, "maxWidth", l),
        m.debug("Size indata abc88", e.id, "childHeight", c, "maxHeight", s),
        m.debug("Size indata abc88 xSize", x, "padding", B));
      for (const _ of e.children) _.size && ((_.size.width = S), (_.size.height = c), (_.size.x = 0), (_.size.y = 0));
    }
    if (
      (m.debug(
      ...
      if (S > 0) {
        ...
        for (const _ of e.children) _.size && (_.size.width = c);
      }
    }
    e.size = { width: p, height: w, x: 0, y: 0 };
  }
  m.debug(
...
function kt(e, t) {
  ...
  const a = e.columns ?? -1;
  if ((m.debug("layoutBlocks columns abc95", e.id, "=>", a, e), e.children && e.children.length > 0)) {
    const x =
        ((n = (r = e == null ? void 0 : e.children[0]) == null ? void 0 : r.size) == null ? void 0 : n.width) ?? 0,
      g = e.children.length * x + (e.children.length - 1) * B;
    m.debug("widthOfChildren 88", g, "posX");
    let p = 0;
    m.debug("abc91 block?.size?.x", e.id, (o = e == null ? void 0 : e.size) == null ? void 0 : o.x);
    let w =
        (u = e == null ? void 0 : e.size) != null && u.x
          ? ((h = e == null ? void 0 : e.size) == null ? void 0 : h.x) +
            (-((y = e == null ? void 0 : e.size) == null ? void 0 : y.width) / 2 || 0)
          : -B,
      S = 0;
    for (const c of e.children) {
      const _ = e;
      if (!c.size) continue;
      const { width: f, height: A } = c.size,
        { px: O, py: X } = Gt(a, p);
      if (
        (X != S &&
          ((S = X),
          (w =
            (b = e == null ? void 0 : e.size) != null && b.x
              ? ((L = e == null ? void 0 : e.size) == null ? void 0 : L.x) +
                (-((E = e == null ? void 0 : e.size) == null ? void 0 : E.width) / 2 || 0)
              : -B),
          m.debug("New row in layout for block", e.id, " and child ", c.id, S)),
        m.debug(
        ...
        ((c.size.x = w + B + J),
          ...
          (w = c.size.x + J),
          (c.size.y = _.size.y - _.size.height / 2 + X * (A + B) + A / 2 + B),
          m.debug(
...
function Zt(e) {
  ...
  const { minX: a, minY: i, maxX: l, maxY: s } = Dt(t),
    r = s - i,
    n = l - a;
...
d(Lt, "applyStyle");
function qt(e, t) {
  const a = R(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")),
...
var lr = d(async (e, t, a, i) => {
    ...
    if (Z(s.flowchart.htmlLabels)) {
      ...
      for (const o of n) {
        ...
        (u.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve"),
          ...
          u.setAttribute("x", "0"),
          a ? u.setAttribute("class", "title-row") : u.setAttribute("class", "row"),
          (u.textContent = o.trim()),
          r.appendChild(u));
      }
      return r;
    }
  ...
  j = lr,
  cr = d((e, t, a, i, l) => {
    (t.arrowTypeStart && Rt(e, "start", t.arrowTypeStart, a, i, l),
      t.arrowTypeEnd && Rt(e, "end", t.arrowTypeEnd, a, i, l));
  }, "addEdgeMarkers"),
  or = {
    arrow_cross: "cross",
    arrow_point: "point",
  ...
  hr = d(async (e, t) => {
    const a = z(),
      ...
      l =
        t.labelType === "markdown"
          ? Ht(e, t.label, { style: t.labelStyle, useHtmlLabels: i, addSvgBackground: !0 }, a)
    ...
    let o;
    if (t.startLabelLeft) {
      const u = await j(t.startLabelLeft, t.labelStyle),
        h = e.insert("g").attr("class", "edgeTerminals"),
        y = h.insert("g").attr("class", "inner");
      o = y.node().appendChild(u);
      const b = u.getBBox();
      (y.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")"),
        W[t.id] || (W[t.id] = {}),
        (W[t.id].startLeft = h),
        rt(o, t.startLabelLeft));
    }
    if (t.startLabelRight) {
      const u = await j(t.startLabelRight, t.labelStyle),
        h = e.insert("g").attr("class", "edgeTerminals"),
        y = h.insert("g").attr("class", "inner");
      ...
      (y.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")"),
        W[t.id] || (W[t.id] = {}),
        (W[t.id].startRight = h),
        rt(o, t.startLabelRight));
    }
    if (t.endLabelLeft) {
      const u = await j(t.endLabelLeft, t.labelStyle),
        h = e.insert("g").attr("class", "edgeTerminals"),
        y = h.insert("g").attr("class", "inner");
      o = y.node().appendChild(u);
      const b = u.getBBox();
    ...
    if (t.endLabelRight) {
      const u = await j(t.endLabelRight, t.labelStyle),
        h = e.insert("g").attr("class", "edgeTerminals"),
        y = h.insert("g").attr("class", "inner");
      o = y.node().appendChild(u);
      const b = u.getBBox();
...
var dr = d((e, t) => {
    ...
    if (e.label) {
      ...
      if (a) {
        ...
        (m.debug("Moving label " + e.label + " from (", r, ",", n, ") to (", o.x, ",", o.y, ") abc88"),
    ...
    if (e.startLabelRight) {
      ...
      let r = e.x,
        n = e.y;
      if (a) {
        const o = et.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, "start_right", a);
        ((r = o.x), (n = o.y));
      }
      s.attr("transform", `translate(${r}, ${n})`);
    }
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(l - t.y) * r > Math.abs(i - t.x) * o) {
      ...
      n = (h * y) / u;
      const b = { x: a.x < t.x ? a.x + n : a.x - h + n, y: a.y < t.y ? a.y + u - y : a.y - u + y };
      return (
        n === 0 && ((b.x = t.x), (b.y = t.y)),
        h === 0 && (b.x = t.x),
        u === 0 && (b.y = t.y),
        m.debug(`abc89 topp/bott calc, Q ${u}, q ${y}, R ${h}, r ${n}`, b),
        b
      );
    } else {
      ...
      let y = (u * n) / h,
        ...
        L = a.y < t.y ? a.y + y : a.y - y;
      return (
        m.debug(`sides calc abc89, Q ${u}, q ${y}, R ${h}, r ${n}`, { _x: b, _y: L }),
        n === 0 && ((b = t.x), (L = t.y)),
        h === 0 && (b = t.x),
        u === 0 && (L = t.y),
        { x: b, y: L }
      ...
      e.forEach((s) => {
        if (!gr(t, s) && !l) {
          ...
          (a.forEach((o) => {
            ...
            a.some((o) => o.x === r.x && o.y === r.y) || a.push(r),
            (l = !0));
        } else ((i = s), l || a.push(s));
      }),
      a
  ...
  pr = d(function (e, t, a, i, l, s, r) {
    ...
    (h != null &&
      ...
      u != null &&
      u.intersect &&
      ((n = n.slice(1, a.points.length - 1)), n.unshift(u.intersect(n[0])), n.push(h.intersect(n[n.length - 1]))),
      a.toCluster && (m.debug("to cluster abc88", i[a.toCluster]), (n = zt(a.points, i[a.toCluster].node)), (o = !0)),
      a.fromCluster &&
        (m.debug("from cluster abc88", i[a.fromCluster]),
        (n = zt(n.reverse(), i[a.fromCluster].node).reverse()),
        (o = !0)));
    const y = n.filter((x) => !Number.isNaN(x.y));
    let b = ye;
    a.curve && (l === "graph" || l === "flowchart") && (b = a.curve);
    const { x: L, y: E } = fe(a),
      D = xe().x(L).y(E).curve(b);
    let v;
    switch (a.thickness) {
      case "normal":
    ...
    const T = e
      ...
      .attr("d", D(y))
      .attr("id", a.id)
      .attr("class", " " + v + (a.classes ? " " + a.classes : ""))
      .attr("style", a.style);
    let k = "";
...
function re(e, t, a) {
  ...
  for (var o = i - e.width / 2 - r, u = l - e.height / 2 - n, h = 0; h < t.length; h++) {
    var y = t[h],
      ...
      L = wr(e, a, { x: o + y.x, y: u + y.y }, { x: o + b.x, y: u + b.y });
    L && s.push(L);
  }
  return s.length
    ? (s.length > 1 &&
...
var Lr = d((e, t) => {
    ...
    return (
      Math.abs(s) * r > Math.abs(l) * n
        ? (s < 0 && (n = -n), (o = s === 0 ? 0 : (n * l) / s), (u = n))
        : (l < 0 && (r = -r), (o = r), (u = l === 0 ? 0 : (r * s) / l)),
      { x: a + o, y: i + u }
    );
  }, "intersectRect"),
  Sr = Lr,
  C = { node: yr, circle: br, ellipse: $t, polygon: mr, rect: Sr },
  F = d(async (e, t, a, i) => {
    const l = z();
    let s;
    ...
    const n = e
      ...
      o = n.insert("g").attr("class", "label").attr("style", t.labelStyle);
    let u;
    ...
    t.labelType === "markdown"
      ...
      : (y = h.appendChild(await j(bt(yt(u), l), t.labelStyle, !1, i)));
    let b = y.getBBox();
    const L = t.padding / 2;
    if (Z(l.flowchart.htmlLabels)) {
      const E = y.children[0],
        D = R(y),
    ...
    return (
      r
        ? o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")")
        : o.attr("transform", "translate(0, " + -b.height / 2 + ")"),
      t.centerLabel && o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")"),
      o.insert("rect", ":first-child"),
      { shapeSvg: n, bbox: b, halfPadding: L, label: o }
    );
  }, "labelHelper"),
  I = d((e, t) => {
...
var vr = d(async (e, t) => {
  ...
  Er = vr,
  At = d((e) => (e ? " " + e : ""), "formatClass"),
  K = d((e, t) => `${t || "node default"}${At(e.classes)} ${At(e.class)}`, "getClassesFromNode"),
  Mt = d(async (e, t) => {
    const { shapeSvg: a, bbox: i } = await F(e, t, K(t, void 0), !0),
      l = i.width + t.padding,
  ...
  Tr = d(async (e, t) => {
    const { shapeSvg: a, bbox: i } = await F(e, t, K(t), !0),
      l = i.width + t.padding,
      s = i.height + t.padding,
      r = [
        { x: (-2 * s) / 6, y: 0 },
  ...
  Rr = d(async (e, t) => {
    ...
    return (
      ...
      (t.intersect = function (h) {
        ...
        if (
          s != 0 &&
          (Math.abs(b) < t.width / 2 || (Math.abs(b) == t.width / 2 && Math.abs(y.y - t.y) > t.height / 2 - r))
        ) {
          let L = r * r * (1 - (b * b) / (s * s));
  ...
  zr = d(async (e, t) => {
    const { shapeSvg: a, bbox: i, halfPadding: l } = await F(e, t, "node " + t.classes + " " + t.class, !0),
      ...
      o = t.positioned ? -r / 2 : -i.width / 2 - l,
      u = t.positioned ? -n / 2 : -i.height / 2 - l;
    if (
      (s
      ...
      (t.props.borders && (dt(s, t.props.borders, r, n), h.delete("borders")),
        h.forEach((y) => {
  ...
  Mr = d(async (e, t) => {
    ...
    if ((i.attr("width", l).attr("height", s), a.attr("class", "label edgeLabel"), t.props)) {
      ...
      (t.props.borders && (dt(i, t.props.borders, l, s), r.delete("borders")),
        r.forEach((n) => {
...
function dt(e, t, a, i) {
  ...
  (t.includes("t") ? (m.debug("add top border"), s(a)) : r(a),
    t.includes("r") ? (m.debug("add right border"), s(i)) : r(i),
    t.includes("b") ? (m.debug("add bottom border"), s(a)) : r(a),
    t.includes("l") ? (m.debug("add left border"), s(i)) : r(i),
...
var Fr = d(async (e, t) => {
    ...
    let b = u.getBBox();
    const L = r.node().appendChild(await j(y.join ? y.join("<br/>") : y, t.labelStyle, !0, !0));
    if (Z(z().flowchart.htmlLabels)) {
    ...
    return (
      R(L).attr(
        "transform",
        "translate( " + (h.width > b.width ? 0 : (b.width - h.width) / 2) + ", " + (b.height + E + 5) + ")"
      ),
      R(u).attr("transform", "translate( " + (h.width < b.width ? 0 : -(b.width - h.width) / 2) + ", 0)"),
      (h = r.node().getBBox()),
      r.attr("transform", "translate(" + -h.width / 2 + ", " + (-h.height / 2 - E + 3) + ")"),
      l
      ...
      s
        ...
        .attr("x1", -h.width / 2 - E)
        .attr("x2", h.width / 2 + E)
        .attr("y1", -h.height / 2 - E + b.height + E)
        .attr("y2", -h.height / 2 - E + b.height + E),
      I(t, l),
  ...
  Pr = d(async (e, t) => {
    const { shapeSvg: a, bbox: i, halfPadding: l } = await F(e, t, K(t, void 0), !0),
  ...
  Ur = d(async (e, t) => {
    ...
    let L = 0;
    const E = (S = t.classData.annotations) == null ? void 0 : S[0],
      D = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "",
      v = b.node().appendChild(await j(D, t.labelStyle, !0, !0));
    let T = v.getBBox();
    if (Z(z().flowchart.htmlLabels)) {
    ...
    t.classData.type !== void 0 &&
      t.classData.type !== "" &&
      (z().flowchart.htmlLabels ? (k += "&lt;" + t.classData.type + "&gt;") : (k += "<" + t.classData.type + ">"));
    ...
    (t.classData.members.forEach(async (c) => {
      ...
      const A = b.node().appendChild(await j(f, _.cssStyle ? _.cssStyle : t.labelStyle, !0, !0));
      let O = A.getBBox();
      if (Z(z().flowchart.htmlLabels)) {
    ...
    if (
      ...
      let c = (h - T.width) / 2;
      (R(v).attr("transform", "translate( " + ((-1 * h) / 2 + c) + ", " + (-1 * y) / 2 + ")"), (L = T.height + i));
    }
    let w = (h - x.width) / 2;
    return (
      R(N).attr("transform", "translate( " + ((-1 * h) / 2 + w) + ", " + ((-1 * y) / 2 + L) + ")"),
      (L += x.height + i),
      o
        .attr("class", "divider")
        .attr("x1", -h / 2 - a)
      ...
      (L += l),
      g.forEach((c) => {
        R(c).attr("transform", "translate( " + -h / 2 + ", " + ((-1 * y) / 2 + L + l / 2) + ")");
      ...
      (L += l),
      p.forEach((c) => {
        R(c).attr("transform", "translate( " + -h / 2 + ", " + ((-1 * y) / 2 + L) + ")");
        const _ = c == null ? void 0 : c.getBBox();
        L += ((_ == null ? void 0 : _.height) ?? 0) + i;
      }),
      n
  ...
  ae = d(async (e, t, a) => {
    ...
    if (t.link) {
      let s;
      (z().securityLevel === "sandbox" ? (s = "_top") : t.linkTarget && (s = t.linkTarget || "_blank"),
        (i = e.insert("svg:a").attr("xlink:href", t.link).attr("target", s)),
        (l = await Wt[t.shape](i, t, a)));
    } else ((l = await Wt[t.shape](e, t, a)), (i = l));
    return (
      t.tooltip && l.attr("title", t.tooltip),
      t.class && l.attr("class", "node default " + t.class),
      (ct[t.id] = i),
      t.haveCallback && ct[t.id].attr("class", ct[t.id].attr("class") + " clickable"),
      i
    );
  }, "insertNode"),
  jr = d((e) => {
    const t = ct[e.id];
    m.trace("Transforming node", e.diff, e, "translate(" + (e.x - e.width / 2 - 5) + ", " + e.width / 2 + ")");
    const a = 8,
      i = e.diff || 0;
    return (
      e.clusterNode
...
function Nt(e, t, a = !1) {
  ...
  const o = Se((i == null ? void 0 : i.styles) ?? []),
    u = i.label,
...
async function gt(e, t, a, i) {
  for (const l of t) (await i(e, l, a), l.children && (await gt(e, l.children, a, i)));
}
      ...
      if (n != null && n.size && o != null && o.size) {
        ...
        (pr(
          ...
          r.label &&
            ...
            dr({ ...r, x: y[1].x, y: y[1].y }, { originalPath: y })));
      }
    }
}
d(ce, "insertEdges");
var Vr = d(function (e, t) {
    return t.db.getClasses();
  }, "getClasses"),
  Gr = d(async function (e, t, a, i) {
    const { securityLevel: l, block: s } = st(),
      r = i.db;
    let n;
    l === "sandbox" && (n = R("#i" + t));
    const o = l === "sandbox" ? R(n.nodes()[0].contentDocument.body) : R("body"),
      u = l === "sandbox" ? o.select(`[id="${t}"]`) : R(`[id="${t}"]`);
    ir(u, ["point", "circle", "cross"], i.type, t);
    const y = r.getBlocks(),
      b = r.getBlocksFlat(),
      L = r.getEdges(),
      E = u.insert("g").attr("class", "block");
    await ne(E, y, r);
    const D = Zt(r);
    if ((await le(E, y, r), await ce(E, L, b, r, t), D)) {
      const v = D,
        T = Math.max(1, Math.round(0.125 * (v.width / v.height))),
        k = v.height + T + 10,
        N = v.width + 10,
        { useMaxWidth: x } = s;
      (ge(u, k, N, !!x),
        m.debug("Here Bounds", D, v),
        u.attr("viewBox", `${v.x - 5} ${v.y - 5} ${v.width + 10} ${v.height + 10}`));
    }
  }, "draw"),
  Zr = { draw: Gr, getClasses: Vr },
  aa = { parser: ke, db: Ue, renderer: Zr, styles: Ve };
export { aa as diagram };
