import { a as gt, g as lt, f as mt, d as xt } from "./chunk-TZMSLE5B-Bzs_t1H1.js";
import { g as kt } from "./chunk-FMBD7UC4-BPzB7Csq.js";
import {
  g as _t,
  s as vt,
  a as bt,
...
import { d as et } from "./arc-COk5UT4S.js";
import "./index-ChLuXRS1.js";
var U = (function () {
  var t = n(function (h, i, a, l) {
    ...
    g = {
      ...
      performAction: n(function (i, a, l, d, p, o, b) {
        var k = o.length - 1;
        switch (p) {
          case 1:
            return o[k - 1];
      ...
      table: [
        ...
        { 1: [3] },
        t(e, [2, 2], { 5: 3 }),
        { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: s, 12: c, 14: r, 16: f, 17: u, 18: y },
        t(e, [2, 7], { 1: [2, 1] }),
        t(e, [2, 3]),
        { 9: 15, 11: s, 12: c, 14: r, 16: f, 17: u, 18: y },
        t(e, [2, 5]),
        t(e, [2, 6]),
        t(e, [2, 8]),
        { 13: [1, 16] },
      ...
      parse: n(function (i) {
        ...
        function D() {
          ...
          return (
            (w = d.pop() || _.lex() || Q),
            typeof w != "number" && (w instanceof Array && ((d = w), (w = d.pop())), (w = a.symbols_[w] || w)),
            w
          );
        }
        n(D, "lex");
        for (var v, A, T, q, F = {}, N, M, tt, z; ; ) {
          if (
            ...
            this.defaultActions[A]
              ...
              : ((v === null || typeof v > "u") && (v = D()), (T = b[A] && b[A][v])),
            typeof T > "u" || !T.length || !T[0])
          ) {
            var H = "";
            z = [];
            for (N in b[A]) this.terminals_[N] && N > dt && z.push("'" + this.terminals_[N] + "'");
            (_.showPosition
              ? (H =
                  "Parse error on line " +
                  (C + 1) +
...
Expecting ` +
              ...
              : (H =
                  ...
                  (C + 1) +
                  ": Unexpected " +
                  (v == Q ? "end of input" : "'" + (this.terminals_[v] || v) + "'")),
              this.parseError(H, {
                text: _.match,
          ...
          switch (T[0]) {
            ...
            case 2:
              if (
                ...
                ft && (F._$.range = [o[o.length - (M || 1)].range[0], o[o.length - 1].range[1]]),
                (q = this.performAction.apply(F, [k, K, C, I.yy, T[1], p, o].concat(yt))),
                typeof q < "u")
              )
                return q;
              (M && ((l = l.slice(0, -1 * M * 2)), (p = p.slice(0, -1 * M)), (o = o.slice(0, -1 * M))),
        ...
        unput: n(function (i) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: l
                ? (l.length === d.length ? this.yylloc.first_column : 0) + d[d.length - l.length].length - l[0].length
...
` +
        ...
        next: n(function () {
          ...
          for (var p = this._currentRules(), o = 0; o < p.length; o++)
            if (((l = this._input.match(this.rules[p[o]])), l && (!a || l[0].length > a[0].length))) {
              if (((a = l), (d = o), this.options.backtrack_lexer)) {
                if (((i = this.test_match(l, p[o])), i !== !1)) return i;
                if (this._backtrack) {
                  a = !1;
                  continue;
                } else return !1;
          ...
          return a
            ? ((i = this.test_match(a, p[d])), i !== !1 ? i : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: n(function (a) {
          return ((a = this.conditionStack.length - 1 - Math.abs(a || 0)), a >= 0 ? this.conditionStack[a] : "INITIAL");
        }, "topState"),
        pushState: n(function (a) {
          this.begin(a);
        }, "pushState"),
        ...
        performAction: n(function (a, l, d, p) {
          switch (d) {
            case 0:
              break;
            case 1:
...
var Et = U,
  ...
  Vt = n(function (t, e) {
    ...
    const f = r.map((y) => y.trim()),
      u = { section: V, type: V, people: f, task: t, score: c };
    B.push(u);
  }, "addTask"),
  Rt = n(function (t) {
  ...
  rt = {
    getConfig: n(() => R().journey, "getConfig"),
    clear: Ct,
    setDiagramTitle: St,
    getDiagramTitle: Tt,
    setAccTitle: wt,
...
`,
  ...
  ot = n(function (t, e) {
    ...
    return (
      ...
      s.attr("r", e.r),
      s.class !== void 0 && s.attr("class", s.class),
      e.title !== void 0 && s.append("title").text(e.title),
      s
    );
  }, "drawCircle"),
  ct = n(function (t, e) {
  ...
  Ot = n(function (t, e, s) {
    ...
    (e.people.forEach((g) => {
      const m = e.actors[g].color,
        x = { cx: y, cy: e.y, r: 7, fill: m, stroke: "#000", title: g, pos: e.actors[g].position };
      (ot(r, x), (y += 10));
    }),
  ...
  ht = (function () {
    ...
    function e(r, f, u, y, g, m, x, h, i) {
      const { taskFontSize: a, taskFontFamily: l } = h,
        d = r.split(/<br\s*\/?>/gi);
      for (let p = 0; p < d.length; p++) {
        const o = p * a - (a * (d.length - 1)) / 2,
          b = f
            .append("text")
            .attr("x", u + g / 2)
            .attr("y", y)
    ...
    n(s, "byFo");
    function c(r, f) {
      for (const u in f) u in f && r.attr(u, f[u]);
    }
    return (
      n(c, "_setTextAttrs"),
      function (r) {
...
function ut(t) {
  ...
  Object.keys(E).forEach((r) => {
    const f = E[r].color,
      u = { cx: 20, cy: c, r: 7, fill: f, stroke: "#000", pos: E[r].position };
    j.drawCircle(t, u);
          ...
          if ((y.text(a), y.node().getBoundingClientRect().width > s)) {
            if ((h && m.push(h), (h = i), y.text(i), y.node().getBoundingClientRect().width > s)) {
              ...
              for (const p of i)
                ((d += p),
                  y.text(d + "-"),
                  y.node().getBoundingClientRect().width > s && (m.push(d.slice(0, -1) + "-"), (d = p)));
              h = d;
            }
          } else h = a;
        }),
...
var $ = R().journey,
  P = 0,
  Xt = n(function (t, e, s, c) {
    const r = R(),
      f = r.journey.titleColor,
      u = r.journey.titleFontSize,
      y = r.journey.titleFontFamily,
      g = r.securityLevel;
    let m;
    g === "sandbox" && (m = X("#i" + e));
    ...
    const i = c.db.getTasks(),
      a = c.db.getDiagramTitle(),
      l = c.db.getActors();
    for (const C in E) delete E[C];
    let d = 0;
    (l.forEach((C) => {
      ((E[C] = { color: $.actorColours[d % $.actorColours.length], position: d }), d++);
    }),
      ut(h),
      (P = $.leftMargin + W),
  ...
  S = {
    ...
    updateVal: n(function (t, e, s, c) {
      t[e] === void 0 ? (t[e] = s) : (t[e] = c(s, t[e]));
    }, "updateVal"),
    updateBounds: n(function (t, e, s, c) {
      const r = R().journey,
        f = this;
      let u = 0;
      function y(g) {
  ...
  Gt = n(function (t, e, s) {
    ...
    for (const [h, i] of e.entries()) {
      if (r !== i.section) {
        ...
        let l = 0;
        const d = i.section;
        for (let o = h; o < e.length && e[o].section == d; o++) l = l + 1;
        const p = {
