import { g as qt } from "./chunk-FMBD7UC4-BPzB7Csq.js";
import {
  _ as m,
  o as Ot,
  l as t1,
...
import { g as le } from "./chunk-55IACEB6-coqV5UWO.js";
import { s as ce } from "./chunk-QN33PNHL-DmZbeWJQ.js";
import { c as he } from "./channel-CAxg-MJq.js";
    ...
    ((P1 = class {
      constructor() {
        ((this.vertexCounter = 0),
          ...
          (this.funs = []),
          (this.setAccTitle = Qt),
          (this.setAccDescription = Jt),
          (this.setDiagramTitle = Zt),
          (this.getAccTitle = $t),
      ...
      lookUpDomId(i) {
        for (const a of this.vertices.values()) if (a.id === i) return a.domId;
        return i;
      }
...
` +
        ...
        if (k) {
          const d = r;
          ((d == null ? void 0 : d.animate) !== void 0 && (k.animate = d.animate),
            (d == null ? void 0 : d.animation) !== void 0 && (k.animation = d.animation),
            (d == null ? void 0 : d.curve) !== void 0 && (k.interpolate = d.curve));
          return;
        }
        let E,
        ...
        if (
          (b === void 0 &&
            ((b = { id: i, labelType: "text", domId: de + i + "-" + this.vertexCounter, styles: [], classes: [] }),
            this.vertices.set(i, b)),
          this.vertexCounter++,
          a !== void 0
            ? ((this.config = b1()),
              (E = this.sanitizeText(a.text.trim())),
              (b.labelType = a.type),
              E.startsWith('"') && E.endsWith('"') && (E = E.substring(1, E.length - 1)),
              (b.text = E))
          ...
          if (r.shape) {
            ...
            if (!ae(r.shape)) throw new Error(`No such shape: ${r.shape}.`);
            b.type = r == null ? void 0 : r.shape;
          }
          (r != null && r.label && (b.text = r == null ? void 0 : r.label),
            r != null &&
              r.icon &&
              ((b.icon = r == null ? void 0 : r.icon),
              !((L = r.label) != null && L.trim()) && b.text === i && (b.text = "")),
            r != null && r.form && (b.form = r == null ? void 0 : r.form),
            r != null && r.pos && (b.pos = r == null ? void 0 : r.pos),
            r != null &&
              r.img &&
              ((b.img = r == null ? void 0 : r.img),
              !((C = r.label) != null && C.trim()) && b.text === i && (b.text = "")),
      ...
      addSingleLink(i, a, n, u) {
        ...
        if (
          (A !== void 0 &&
            ((c.text = this.sanitizeText(A.text.trim())),
            c.text.startsWith('"') && c.text.endsWith('"') && (c.text = c.text.substring(1, c.text.length - 1)),
            (c.labelType = A.type)),
          n !== void 0 && ((c.type = n.type), (c.stroke = n.stroke), (c.length = n.length > 10 ? 10 : n.length)),
        ...
        if (this.edges.length < (this.config.maxEdges ?? 500)) (t1.info("Pushing edge..."), this.edges.push(c));
        else
...
You have to call mermaid.initialize.`);
      ...
      updateLink(i, a) {
        i.forEach((n) => {
          ...
          n === "default"
            ? (this.edges.defaultStyle = a)
            : ((this.edges[n].style = a),
              (((o = (u = this.edges[n]) == null ? void 0 : u.style) == null ? void 0 : o.length) ?? 0) > 0 &&
                !(
                  (c = (f = this.edges[n]) == null ? void 0 : f.style) != null &&
                  c.some((k) => (k == null ? void 0 : k.startsWith("fill")))
                ) &&
                ((r = (A = this.edges[n]) == null ? void 0 : A.style) == null || r.push("fill:none")));
        });
      }
      addClass(i, a) {
      ...
      setTooltip(i, a) {
        if (a !== void 0) {
          ...
          for (const n of i.split(",")) this.tooltips.set(this.version === "gen-1" ? this.lookUpDomId(n) : n, a);
        }
      }
      setClickFun(i, a, n) {
        const u = this.lookUpDomId(i);
        if (b1().securityLevel !== "loose" || a === void 0) return;
        let o = [];
        if (typeof n == "string") {
          o = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
      ...
      setupToolTips(i) {
        ...
        ((a._groups || a)[0][0] === null &&
          (a = S1("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)),
          S1(i)
            .select("svg")
            .selectAll("g.node")
            .on("mouseover", (o) => {
              ...
              (a.transition().duration(200).style("opacity", ".9"),
                a
                  .text(f.attr("title"))
                  .style("left", window.scrollX + A.left + (A.right - A.left) / 2 + "px")
                  .style("top", window.scrollY + A.bottom + "px"),
                a.html(a.html().replace(/&lt;br\/&gt;/g, "<br/>")),
                f.classed("hover", !0));
            })
            .on("mouseout", (o) => {
      ...
      addSubGraph(i, a, n) {
        ...
        const c = m((b) => {
            const L = { boolean: {}, number: {}, string: {} },
              C = [];
            let d;
            return {
              nodeList: b.filter(function (W) {
                const Z = typeof W;
        ...
        if (
          ((r = r ?? (k.inheritDir ? (this.getDirection() ?? b1().direction ?? void 0) : void 0)),
          this.version === "gen-1")
        )
          for (let b = 0; b < A.length; b++) A[b] = this.lookUpDomId(A[b]);
        ((u = u ?? "subGraph" + this.subCount),
          (o = o || ""),
          (o = this.sanitizeText(o)),
          (this.subCount = this.subCount + 1));
        const E = { id: u, nodes: A, title: o.trim(), classes: [], dir: r, labelType: n.type };
        return (
          t1.info("Adding", E.id, E.nodes, E.dir),
          (E.nodes = this.makeUniq(E, this.subGraphs).nodes),
          this.subGraphs.push(E),
          this.subGraphLookup.set(u, E),
          u
        );
      }
      getPosForId(i) {
        for (const [a, n] of this.subGraphs.entries()) if (n.id === i) return a;
        return -1;
      }
      indexNodes2(i, a) {
        const n = this.subGraphs[a].nodes;
        if (((this.secCount = this.secCount + 1), this.secCount > 2e3)) return { result: !1, count: 0 };
        if (((this.posCrossRef[this.secCount] = a), this.subGraphs[a].id === i)) return { result: !0, count: 0 };
        let u = 0,
          o = 1;
        for (; u < n.length; ) {
      ...
      destructLink(i, a) {
        ...
        let u;
        if (a) {
          if (((u = this.destructStartLink(a)), u.stroke !== n.stroke)) return { type: "INVALID", stroke: "INVALID" };
          if (u.type === "arrow_open") u.type = n.type;
          else {
            if (u.type !== n.type) return { type: "INVALID", stroke: "INVALID" };
      ...
      exists(i, a) {
        for (const n of i) if (n.nodes.includes(a)) return !0;
        return !1;
      }
      makeUniq(i, a) {
        const n = [];
      ...
      addNodeFromVertex(i, a, n, u, o, f) {
        ...
        if (r)
          ...
          A
            ? a.push({ ...E, isGroup: !0, shape: "rect" })
            : a.push({ ...E, isGroup: !1, shape: this.getTypeFromVertex(i) });
        }
      }
      getCompiledStyles(i) {
        let a = [];
        for (const n of i) {
          ...
          (u != null && u.styles && (a = [...a, ...(u.styles ?? [])].map((o) => o.trim())),
            u != null && u.textStyles && (a = [...a, ...(u.textStyles ?? [])].map((o) => o.trim())));
        }
        return a;
      }
      getData() {
        ...
        for (let r = u.length - 1; r >= 0; r--) {
          ...
          for (const E of k.nodes) o.set(E, k.id);
        }
        for (let r = u.length - 1; r >= 0; r--) {
          const k = u[r];
          a.push({
        ...
        return (
          A.forEach((r, k) => {
            var d;
            const { arrowTypeStart: E, arrowTypeEnd: b } = this.destructEdgeType(r.type),
              L = [...(A.defaultStyle ?? [])];
  ...
  ge = m(async function (s, i, a, n) {
    ...
    (it.insertTitle(k, "flowchartTitleText", (o == null ? void 0 : o.titleTopMargin) || 0, n.db.getDiagramTitle()),
    ...
    for (const C of r.nodes) {
      ...
      (J.setAttributeNS("http://www.w3.org/2000/svg", "class", C.cssClasses),
        J.setAttributeNS("http://www.w3.org/2000/svg", "rel", "noopener"),
        u === "sandbox"
          ? J.setAttributeNS("http://www.w3.org/2000/svg", "target", "_top")
          : C.linkTarget && J.setAttributeNS("http://www.w3.org/2000/svg", "target", C.linkTarget));
      const W = d.insert(function () {
          return J;
        }, ":first-child"),
        Z = d.select(".label-container");
      Z &&
        W.append(function () {
          return Z.node();
        });
  ...
  rt = (function () {
    var s = m(function (g1, h, p, g) {
      ...
      V1 = [1, 98],
      I1 = [1, 89],
      k1 = [8, 9, 10, 11, 40, 75, 77, 78],
      z = [8, 9, 10, 11, 40, 46, 75, 77, 78],
      q = [
        8, 9, 10, 11, 29, 40, 44, 46, 48, 50, 52, 54, 56, 58, 60, 63, 65, 67, 68, 70, 75, 77, 78, 89, 102, 105, 106,
        109, 111, 114, 115, 116,
      ],
      nt = [8, 9, 11, 44, 60, 75, 77, 78, 89, 102, 105, 106, 109, 111, 114, 115, 116],
      w1 = [44, 60, 89, 102, 105, 106, 109, 111, 114, 115, 116],
      ut = [1, 121],
      ot = [1, 122],
      K1 = [1, 124],
      Y1 = [1, 123],
      lt = [44, 60, 62, 74, 89, 102, 105, 106, 109, 111, 114, 115, 116],
      ct = [1, 133],
      ht = [1, 147],
      dt = [1, 148],
      pt = [1, 149],
      ...
      It = [10, 106],
      f1 = [31, 49, 51, 53, 55, 57, 62, 64, 66, 67, 69, 71, 116, 117, 118],
      r1 = [1, 247],
      a1 = [1, 245],
      n1 = [1, 249],
      u1 = [1, 243],
      ...
      J1 = {
        ...
        performAction: m(function (h, p, g, l, _, t, O1) {
          var e = t.length - 1;
          switch (_) {
            case 2:
              this.$ = [];
        ...
        table: [
          ...
          s(u, [2, 10]),
          s(u, [2, 11]),
          { 8: [1, 54], 9: [1, 55], 10: p1, 15: 53, 18: 56 },
          s(y, [2, 3]),
          s(y, [2, 4]),
          s(y, [2, 5]),
          s(y, [2, 6]),
          s(y, [2, 7]),
          s(y, [2, 8]),
          { 8: e1, 9: s1, 11: i1, 21: 58, 41: 59, 72: 63, 75: [1, 64], 77: [1, 66], 78: [1, 65] },
          { 8: e1, 9: s1, 11: i1, 21: 67 },
          { 8: e1, 9: s1, 11: i1, 21: 68 },
          { 8: e1, 9: s1, 11: i1, 21: 69 },
          { 8: e1, 9: s1, 11: i1, 21: 70 },
          { 8: e1, 9: s1, 11: i1, 21: 71 },
          { 8: e1, 9: s1, 10: [1, 72], 11: i1, 21: 73 },
          s(y, [2, 36]),
          { 35: [1, 74] },
          { 37: [1, 75] },
          s(y, [2, 39]),
          s(D1, [2, 50], { 18: 76, 39: 77, 10: p1, 40: at }),
          { 10: [1, 79] },
          { 10: [1, 80] },
          { 10: [1, 81] },
          { 10: [1, 82] },
          ...
          s(y, [2, 41]),
          s(y, [2, 42]),
          s(w1, [2, 76], { 73: 116, 62: [1, 118], 74: [1, 117] }),
          { 76: 119, 79: 120, 80: ut, 81: ot, 116: K1, 119: Y1 },
          { 75: [1, 125], 77: [1, 126] },
          s(lt, [2, 83]),
          s(y, [2, 28]),
          s(y, [2, 29]),
          ...
          s(y, [2, 38]),
          s(D1, [2, 48], { 44: Lt }),
          s(D1, [2, 49], { 18: 155, 10: p1, 40: Vt }),
          s(k1, [2, 44]),
          { 44: C, 47: 157, 60: d, 89: V, 102: I, 105: w, 106: R, 109: N, 111: G, 113: 41, 114: P, 115: O, 116: M },
          { 102: [1, 158], 103: 159, 105: [1, 160] },
          { 44: C, 47: 161, 60: d, 89: V, 102: I, 105: w, 106: R, 109: N, 111: G, 113: 41, 114: P, 115: O, 116: M },
          { 44: C, 47: 162, 60: d, 89: V, 102: I, 105: w, 106: R, 109: N, 111: G, 113: 41, 114: P, 115: O, 116: M },
          ...
          s(H, [2, 179]),
          s(H, [2, 180]),
          { 44: C, 47: 169, 60: d, 89: V, 102: I, 105: w, 106: R, 109: N, 111: G, 113: 41, 114: P, 115: O, 116: M },
          { 30: 170, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 178, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 180, 50: [1, 179], 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 181, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 182, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 183, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 109: [1, 184] },
          { 30: 185, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 186, 65: [1, 187], 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 188, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 189, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 30: 190, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          s(q, [2, 182]),
          s(u, [2, 20]),
          s(nt, [2, 25]),
          s(D1, [2, 46], { 39: 191, 18: 192, 10: p1, 40: at }),
          s(w1, [2, 73], { 10: [1, 193] }),
          { 10: [1, 194] },
          { 30: 195, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 77: [1, 196], 79: 197, 116: K1, 119: Y1 },
          s(R1, [2, 79]),
          s(R1, [2, 81]),
          s(R1, [2, 82]),
          s(R1, [2, 168]),
          s(R1, [2, 169]),
          { 76: 198, 79: 120, 80: ut, 81: ot, 116: K1, 119: Y1 },
          s(lt, [2, 84]),
          {
            8: e1,
            9: s1,
          ...
          { 31: [1, 217], 67: S, 82: 218, 116: D, 117: x, 118: T },
          s(f1, [2, 86]),
          s(f1, [2, 88]),
          s(f1, [2, 89]),
          s(f1, [2, 153]),
          ...
          s(f1, [2, 155]),
          s(f1, [2, 156]),
          { 49: [1, 219], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 30: 220, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 51: [1, 221], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 53: [1, 222], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 55: [1, 223], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 57: [1, 224], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 60: [1, 225] },
          { 64: [1, 226], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 66: [1, 227], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 30: 228, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          { 31: [1, 229], 67: S, 82: 218, 116: D, 117: x, 118: T },
          { 67: S, 69: [1, 230], 71: [1, 231], 82: 218, 116: D, 117: x, 118: T },
          { 67: S, 69: [1, 233], 71: [1, 232], 82: 218, 116: D, 117: x, 118: T },
          s(D1, [2, 45], { 18: 155, 10: p1, 40: Vt }),
          s(D1, [2, 47], { 44: Lt }),
          s(w1, [2, 75]),
          s(w1, [2, 74]),
          { 62: [1, 234], 67: S, 82: 218, 116: D, 117: x, 118: T },
          s(w1, [2, 77]),
          s(R1, [2, 80]),
          { 77: [1, 235], 79: 197, 116: K1, 119: Y1 },
          { 30: 236, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          s(Q1, o, { 5: 237 }),
          s(F, [2, 102]),
          s(y, [2, 35]),
          {
          ...
          { 10: p1, 18: 239 },
          { 10: r1, 60: a1, 84: n1, 92: 240, 105: u1, 107: 241, 108: 242, 109: o1, 110: l1, 111: c1, 112: h1 },
          {
            10: r1,
            60: a1,
            84: n1,
          ...
          { 105: [1, 255] },
          { 10: r1, 60: a1, 84: n1, 92: 256, 105: u1, 107: 241, 108: 242, 109: o1, 110: l1, 111: c1, 112: h1 },
          { 44: C, 47: 257, 60: d, 89: V, 102: I, 105: w, 106: R, 109: N, 111: G, 113: 41, 114: P, 115: O, 116: M },
          s(B, [2, 108]),
          { 80: [1, 258] },
          { 80: [1, 259], 98: [1, 260] },
          s(B, [2, 116]),
          ...
          s(f1, [2, 87]),
          s(z, [2, 57]),
          { 51: [1, 262], 67: S, 82: 218, 116: D, 117: x, 118: T },
          s(z, [2, 64]),
          s(z, [2, 59]),
          s(z, [2, 60]),
          s(z, [2, 61]),
          ...
          s(z, [2, 63]),
          s(z, [2, 65]),
          { 66: [1, 264], 67: S, 82: 218, 116: D, 117: x, 118: T },
          s(z, [2, 67]),
          s(z, [2, 68]),
          s(z, [2, 70]),
          s(z, [2, 69]),
          ...
          s(w1, [2, 78]),
          { 31: [1, 265], 67: S, 82: 218, 116: D, 117: x, 118: T },
          {
            6: 11,
            7: 12,
            8: f,
          ...
          s(B, [2, 121], { 106: N1 }),
          s(wt, [2, 130], { 108: 269, 10: r1, 60: a1, 84: n1, 105: u1, 109: o1, 110: l1, 111: c1, 112: h1 }),
          s($, [2, 132]),
          s($, [2, 134]),
          s($, [2, 135]),
          s($, [2, 136]),
          ...
          { 62: [1, 275] },
          { 66: [1, 276] },
          { 8: e1, 9: s1, 11: i1, 21: 277 },
          s(y, [2, 34]),
          s(k1, [2, 52]),
          { 10: r1, 60: a1, 84: n1, 105: u1, 107: 278, 108: 242, 109: o1, 110: l1, 111: c1, 112: h1 },
          s($, [2, 133]),
          {
            14: x1,
            44: T1,
          ...
          s(B, [2, 120]),
          s(z, [2, 58]),
          { 30: 282, 67: S, 80: j, 81: K, 82: 171, 116: D, 117: x, 118: T },
          s(z, [2, 66]),
          s(Q1, o, { 5: 283 }),
          s(wt, [2, 131], { 108: 269, 10: r1, 60: a1, 84: n1, 105: u1, 109: o1, 110: l1, 111: c1, 112: h1 }),
          s(B, [2, 126], {
            120: 167,
            10: [1, 284],
            14: x1,
          ...
          s(B, [2, 114]),
          { 31: [1, 286], 67: S, 82: 218, 116: D, 117: x, 118: T },
          {
            6: 11,
            7: 12,
            8: f,
          ...
          { 10: r1, 60: a1, 84: n1, 92: 288, 105: u1, 107: 241, 108: 242, 109: o1, 110: l1, 111: c1, 112: h1 },
          { 10: r1, 60: a1, 84: n1, 92: 289, 105: u1, 107: 241, 108: 242, 109: o1, 110: l1, 111: c1, 112: h1 },
          s(z, [2, 62]),
          s(y, [2, 33]),
          s(B, [2, 124], { 106: N1 }),
          s(B, [2, 125], { 106: N1 }),
        ...
        defaultActions: {},
        parseError: m(function (h, p) {
          if (p.recoverable) this.trace(h);
          else {
            var g = new Error(h);
            throw ((g.hash = p), g);
          }
        ...
        parse: m(function (h) {
          var p = this,
            ...
            U = Object.create(this.lexer),
            m1 = { yy: {} };
          for (var Z1 in this.yy) Object.prototype.hasOwnProperty.call(this.yy, Z1) && (m1.yy[Z1] = this.yy[Z1]);
          (U.setInput(h, m1.yy), (m1.yy.lexer = U), (m1.yy.parser = this), typeof U.yylloc > "u" && (U.yylloc = {}));
          var $1 = U.yylloc;
          t.push($1);
          var Kt = U.options && U.options.ranges;
          typeof m1.yy.parseError == "function"
            ? (this.parseError = m1.yy.parseError)
          ...
          function Gt() {
            ...
            return (
              (X = l.pop() || U.lex() || Nt),
              typeof X != "number" && (X instanceof Array && ((l = X), (X = l.pop())), (X = p.symbols_[X] || X)),
              X
            );
          }
          m(Gt, "lex");
          for (var Y, C1, Q, tt, G1 = {}, H1, d1, Pt, X1; ; ) {
            if (
              ((C1 = g[g.length - 1]),
              this.defaultActions[C1]
                ? (Q = this.defaultActions[C1])
                : ((Y === null || typeof Y > "u") && (Y = Gt()), (Q = O1[C1] && O1[C1][Y])),
              typeof Q > "u" || !Q.length || !Q[0])
            ) {
              var et = "";
              X1 = [];
              for (H1 in O1[C1]) this.terminals_[H1] && H1 > zt && X1.push("'" + this.terminals_[H1] + "'");
              (U.showPosition
                ? (et =
                    "Parse error on line " +
                    (v + 1) +
...
Expecting ` +
                ...
                : (et =
                    ...
                    (v + 1) +
                    ": Unexpected " +
                    (Y == Nt ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'")),
                this.parseError(et, {
                  text: U.match,
            ...
            switch (Q[0]) {
              ...
              case 2:
                if (
                  ...
                  Kt && (G1._$.range = [t[t.length - (d1 || 1)].range[0], t[t.length - 1].range[1]]),
                  (tt = this.performAction.apply(G1, [e, Rt, v, m1.yy, Q[1], _, t].concat(jt))),
                  typeof tt < "u")
                )
                  return tt;
                (d1 && ((g = g.slice(0, -1 * d1 * 2)), (_ = _.slice(0, -1 * d1)), (t = t.slice(0, -1 * d1))),
                  g.push(this.productions_[Q[1]][0]),
                  _.push(G1.$),
                  t.push(G1._$),
                  (Pt = O1[g[g.length - 2]][g[g.length - 1]]),
                  g.push(Pt));
                break;
              case 3:
                return !0;
      ...
      Wt = (function () {
        var g1 = {
          EOF: 1,
          parseError: m(function (p, g) {
            if (this.yy.parser) this.yy.parser.parseError(p, g);
            else throw new Error(p);
          }, "parseError"),
          setInput: m(function (h, p) {
            return (
              (this.yy = p || this.yy || {}),
              (this._input = h),
          ...
          unput: m(function (h) {
            ...
            return (
              ...
              this.options.ranges && (this.yylloc.range = [_[0], _[0] + this.yyleng - p]),
...
` +
          ...
          next: m(function () {
            ...
            return p
              ? ((h = this.test_match(p, _[l])), h !== !1 ? h : !1)
              : this._input === ""
                ? this.EOF
                : this.parseError(
                    "Lexical error on line " +
...
` +
          ...
          options: {},
          performAction: m(function (p, g, l, _) {
            switch (l) {
              case 0:
  ...
  Fe = {
    ...
    init: m((s) => {
      (s.flowchart || (s.flowchart = {}),
        s.layout && Ot({ layout: s.layout }),
        (s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute),
        Ot({ flowchart: { arrowMarkerAbsolute: s.arrowMarkerAbsolute } }));
    }, "init"),
  };
