import { ar as N, as as v, at as f, au as b, av as E } from "./mermaid.core-DrAPKfvO.js";
import { a as j, c as P, k as _, f as g, d, i as l, v as p, r as D } from "./_baseUniq-LizNW1gx.js";
var w = N(function (o) {
    return j(P(o, 1, v, !0));
  }),
  F = "\0",
...
class L {
  constructor(e = {}) {
    ((this._isDirected = Object.prototype.hasOwnProperty.call(e, "directed") ? e.directed : !0),
      ...
      (this._label = void 0),
      (this._defaultNodeLabelFn = f(void 0)),
      (this._defaultEdgeLabelFn = f(void 0)),
      (this._nodes = {}),
      this._isCompound && ((this._parent = {}), (this._children = {}), (this._children[a] = {})),
      (this._in = {}),
      (this._preds = {}),
      (this._out = {}),
      (this._sucs = {}),
  ...
  setNode(e, t) {
    return Object.prototype.hasOwnProperty.call(this._nodes, e)
      ...
      : ((this._nodes[e] = arguments.length > 1 ? t : this._defaultNodeLabelFn(e)),
        this._isCompound && ((this._parent[e] = a), (this._children[e] = {}), (this._children[a][e] = !0)),
        (this._in[e] = {}),
        (this._preds[e] = {}),
        (this._out[e] = {}),
        (this._sucs[e] = {}),
  ...
  setParent(e, t) {
    ...
    if (l(t)) t = a;
      ...
      for (var s = t; !l(s); s = this.parent(s))
        if (s === e) throw new Error("Setting " + t + " as parent of " + e + " would create a cycle");
      this.setNode(t);
    }
    return (
      this.setNode(e),
  ...
  neighbors(e) {
    ...
    if (t) return w(t, this.successors(e));
  }
  isLeaf(e) {
    var t;
  ...
  setEdge() {
    var e,
      ...
      r = !1,
      n = arguments[0];
    (typeof n == "object" && n !== null && "v" in n
      ? ((e = n.v), (t = n.w), (s = n.name), arguments.length === 2 && ((i = arguments[1]), (r = !0)))
      : ((e = n), (t = arguments[1]), (s = arguments[3]), arguments.length > 2 && ((i = arguments[2]), (r = !0))),
      (e = "" + e),
      (t = "" + t),
      l(s) || (s = "" + s));
