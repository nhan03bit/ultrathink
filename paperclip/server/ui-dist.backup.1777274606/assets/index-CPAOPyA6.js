import { P as L, N as $, k as E, D as j, l as y, T as S, I as G } from "./index-ChLuXRS1.js";
var N = {};
class v {
  ...
  storeNode(t, e, s, i = 4, h = !1) {
    if (t == 0 && (!this.stack.length || this.stack[this.stack.length - 1] < this.buffer.length + this.bufferBase)) {
      ...
      if (
        (n == 0 && r.parent && ((n = r.bufferBase - r.parent.bufferBase), (r = r.parent)),
        n > 0 && r.buffer[n - 4] == 0 && r.buffer[n - 1] > -1)
      ) {
        if (e == s) return;
        if (r.buffer[n - 2] >= e) {
          r.buffer[n - 2] = s;
