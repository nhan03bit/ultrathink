import { a as t, L as i, i as n, c as $, f as y, j as P, s as X, t as O } from "./index-ChLuXRS1.js";
import { defineCSSCompletionSource as m } from "./index-DMg7nhcl.js";
import { L as c, E as S } from "./index-CPAOPyA6.js";
const f = 110,
  l = 1,
  s = 2,
  r = [
...
const W = new S((T, Q) => {
    if (T.next == 40) {
      let a = T.peek(-1);
      (e(a) || p(a) || a == 95 || a == 45) && T.acceptToken(s, 1);
    }
  }),
  d = new S((T) => {
    if (r.indexOf(T.peek(-1)) > -1) {
      let { next: Q } = T;
      (e(Q) || Q == 95 || Q == 35 || Q == 46 || Q == 91 || Q == 58 || Q == 45) && T.acceptToken(f);
    }
  }),
  Z = new S((T) => {
    if (r.indexOf(T.peek(-1)) < 0) {
      let { next: Q } = T;
      if ((Q == 37 && (T.advance(), T.acceptToken(l)), e(Q))) {
        do T.advance();
        while (e(T.next));
        T.acceptToken(l);
      }
  ...
  w = X({
    "import charset namespace keyframes media supports when": O.definitionKeyword,
    ...
    IdName: O.labelName,
    "FeatureName PropertyName PropertyVariable": O.propertyName,
    ...
    "AtKeyword Interpolation": O.special(O.variableName),
  ...
  o = i.define({
    name: "less",
    parser: g.configure({ props: [n.add({ Declaration: $() }), y.add({ Block: P })] }),
    languageData: {
  ...
  u = m((T) => T.name == "VariableName" || T.name == "AtKeyword");
function k() {
  return new t(o, o.data.of({ autocomplete: u }));
}
export { k as less, u as lessCompletionSource, o as lessLanguage };
