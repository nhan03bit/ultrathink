...
var g = l(
  ...
  s = l("catch class do else finally for if switch try while"),
  E = l("true false null"),
  m = { "#": b },
  h = /[+\-*&%=<>!?|\/]/,
  o;
...
const z = {
  ...
  startState: function (e) {
    return { tokenize: null, context: new v(-e, 0, "top", !1), indented: 0, startOfLine: !0 };
  },
  token: function (e, n) {
    var t = n.context;
    if (
    ...
    if ((t.align == null && (t.align = !0), (o == ";" || o == ":") && t.type == "statement")) u(n);
      ...
      o == t.type
        ? u(n)
        : (t.type == "}" || t.type == "top" || (t.type == "statement" && o == "newstatement")) &&
          c(n, e.column(), "statement");
  ...
  indent: function (e, n, t) {
    ...
    return r.type == "statement"
      ? r.indented + (i == "{" ? 0 : t.unit)
      : r.align
        ? r.column + (a ? 0 : 1)
        : r.indented + (a ? 0 : t.unit);
  },
