...
import { s as he } from "./chunk-QN33PNHL-DmZbeWJQ.js";
import {
  _ as l,
  l as C,
  p as de,
...
const be = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto),
  ne = { randomUUID: be };
function Se(t, e, n) {
  var u;
  if (ne.randomUUID && !t) return ne.randomUUID();
  t = t || {};
...
var q = (function () {
  var t = l(function (v, s, i, a) {
    ...
    w = [1, 25],
    D = [6, 7, 11],
    J = [1, 6, 13, 15, 16, 19, 22],
    K = [1, 33],
    Q = [1, 34],
    A = [1, 6, 7, 11, 13, 15, 16, 19, 22],
    j = {
      ...
      performAction: l(function (s, i, a, o, g, r, U) {
        var d = r.length - 1;
        switch (g) {
          case 6:
          case 7:
          ...
          case 20:
            ...
            break;
          case 25:
            (o.getLogger().trace("node found ..", r[d - 2]),
              (this.$ = { id: r[d - 1], descr: r[d - 1], type: o.getType(r[d - 2], r[d]) }));
            break;
          case 26:
            this.$ = { id: r[d], descr: r[d], type: o.nodeType.DEFAULT };
            break;
          case 27:
            (o.getLogger().trace("node found ..", r[d - 3]),
              (this.$ = { id: r[d - 3], descr: r[d - 1], type: o.getType(r[d - 2], r[d]) }));
            break;
        }
      }, "anonymous"),
      table: [
        ...
        { 1: [2, 1] },
        { 4: 6, 6: [1, 7], 7: [1, 8], 8: e },
        { 6: n, 7: [1, 10], 9: 9, 12: 11, 13: c, 14: 14, 15: u, 16: h, 17: 17, 18: 18, 19: p, 22: y },
        t(_, [2, 3]),
        { 1: [2, 2] },
        t(_, [2, 4]),
        t(_, [2, 5]),
        { 1: [2, 6], 6: n, 12: 21, 13: c, 14: 14, 15: u, 16: h, 17: 17, 18: 18, 19: p, 22: y },
        { 6: n, 9: 22, 12: 11, 13: c, 14: 14, 15: u, 16: h, 17: 17, 18: 18, 19: p, 22: y },
        { 6: b, 7: m, 10: 23, 11: w },
        t(D, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: p, 22: y }),
        t(D, [2, 18]),
        t(D, [2, 19]),
        t(D, [2, 20]),
        t(D, [2, 21]),
        ...
        { 20: [1, 31] },
        { 6: b, 7: m, 10: 32, 11: w },
        { 1: [2, 7], 6: n, 12: 21, 13: c, 14: 14, 15: u, 16: h, 17: 17, 18: 18, 19: p, 22: y },
        t(J, [2, 14], { 7: K, 11: Q }),
        t(A, [2, 8]),
        t(A, [2, 9]),
        t(A, [2, 10]),
      ...
      parse: l(function (s) {
        var i = this,
          ...
          re = 2,
          ee = 1,
          ae = r.slice.call(arguments, 1),
          f = Object.create(this.lexer),
          T = { yy: {} };
        for (var H in this.yy) Object.prototype.hasOwnProperty.call(this.yy, H) && (T.yy[H] = this.yy[H]);
        ...
        function te() {
          ...
          return (
            (N = o.pop() || f.lex() || ee),
            typeof N != "number" && (N instanceof Array && ((o = N), (N = o.pop())), (N = i.symbols_[N] || N)),
            N
          );
        }
        l(te, "lex");
        for (var S, O, k, z, I = {}, V, L, ie, B; ; ) {
          if (
            ...
            this.defaultActions[O]
              ? (k = this.defaultActions[O])
              : ((S === null || typeof S > "u") && (S = te()), (k = U[O] && U[O][S])),
            typeof k > "u" || !k.length || !k[0])
          ) {
            var W = "";
            B = [];
            for (V in U[O]) this.terminals_[V] && V > re && B.push("'" + this.terminals_[V] + "'");
            (f.showPosition
              ? (W =
                  "Parse error on line " +
                  (M + 1) +
          ...
          switch (k[0]) {
            ...
            case 2:
              if (
                ...
                oe && (I._$.range = [r[r.length - (L || 1)].range[0], r[r.length - 1].range[1]]),
                (z = this.performAction.apply(I, [d, Z, M, T.yy, k[1], g, r].concat(ae))),
                typeof z < "u")
              )
                return z;
              (L && ((a = a.slice(0, -1 * L * 2)), (g = g.slice(0, -1 * L)), (r = r.slice(0, -1 * L))),
                a.push(this.productions_[k[1]][0]),
                g.push(I.$),
                r.push(I._$),
                (ie = U[a[a.length - 2]][a[a.length - 1]]),
                a.push(ie));
              break;
            case 3:
              return !0;
      ...
      var v = {
        ...
        unput: l(function (s) {
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [g[0], g[0] + this.yyleng - i]),
...
` +
        ...
        next: l(function () {
          ...
          for (var g = this._currentRules(), r = 0; r < g.length; r++)
            if (((a = this._input.match(this.rules[g[r]])), a && (!i || a[0].length > i[0].length))) {
              if (((i = a), (o = r), this.options.backtrack_lexer)) {
                if (((s = this.test_match(a, g[r])), s !== !1)) return s;
                if (this._backtrack) {
                  i = !1;
                  continue;
                } else return !1;
          ...
          return i
            ? ((s = this.test_match(i, g[o])), s !== !1 ? s : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: l(function (i) {
          return ((i = this.conditionStack.length - 1 - Math.abs(i || 0)), i >= 0 ? this.conditionStack[i] : "INITIAL");
        }, "topState"),
        pushState: l(function (i) {
          this.begin(i);
        }, "pushState"),
        ...
        performAction: l(function (i, a, o, g) {
          switch (o) {
            case 0:
...
q.parser = q;
var De = q,
  x = { DEFAULT: 0, NO_BORDER: 0, ROUNDED_RECT: 1, RECT: 2, CIRCLE: 3, CLOUD: 4, BANG: 5, HEXAGON: 6 },
  R,
  Ne =
    ((R = class {
      constructor() {
      ...
      getParent(e) {
        for (let n = this.nodes.length - 1; n >= 0; n--) if (this.nodes[n].level < e) return this.nodes[n];
        return null;
      }
      getMindmap() {
      ...
      addNode(e, n, c, u) {
        ...
        let h = !1;
        this.nodes.length === 0
          ? ((this.baseLevel = e), (e = 0), (h = !0))
          : this.baseLevel !== void 0 && ((e = e - this.baseLevel), (h = !1));
        const p = X();
      ...
      flattenNodes(e, n) {
        ...
        (e.isRoot === !0
          ? c.push("section-root", "section--1")
          : e.section !== void 0 && c.push(`section-${e.section}`),
          e.class && c.push(e.class));
        const u = c.join(" "),
          h = l((y) => {
            switch (y) {
              case x.CIRCLE:
        ...
        if ((n.push(p), e.children)) for (const y of e.children) this.flattenNodes(y, n);
      }
      generateEdges(e, n) {
        if (e.children)
      ...
      getData() {
        const e = this.getMindmap(),
          ...
          u = ue().layout !== void 0,
          h = n;
        if ((u || (h.layout = "cose-bilkent"), !e)) return { nodes: [], edges: [], config: h };
        (C.debug("getData: mindmapRoot", e, n), this.assignSections(e));
        const p = [],
          y = [];
        (this.flattenNodes(e, p),
          this.generateEdges(e, y),
          C.debug(`getData: processed ${p.length} nodes and ${y.length} edges`));
        const _ = new Map();
        for (const b of p) _.set(b.id, { shape: b.shape, width: b.width, height: b.height, padding: b.padding });
        return {
          nodes: p,
          edges: y,
          config: h,
...
` + t
    ...
    const u = c.db,
      h = u.getData(),
      p = le(e, h.config.securityLevel);
    ((h.type = c.type),
      (h.layoutAlgorithm = de(h.config.layout, { fallback: "cose-bilkent" })),
      (h.diagramId = e),
      u.getMindmap() &&
        (h.nodes.forEach((m) => {
          m.shape === "rounded"
            ...
            : m.shape === "circle"
              ? (m.padding = 10)
              : m.shape === "rect" && ((m.width = 0), (m.padding = 10));
        }),
        await ge(h, p),
        he(
          p,
