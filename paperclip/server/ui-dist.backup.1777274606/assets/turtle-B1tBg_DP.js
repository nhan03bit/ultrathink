...
p([]);
var d = p(["@prefix", "@base", "a"]),
  f = /[*+\-<>=&|]/;
function x(e, n) {
  var t = e.next();
  if (((r = null), t == "<" && !e.match(/^[\s\u00a0=]/, !1))) return (e.match(/^[^\s\u00a0>]*>?/), "atom");
...
const g = {
  ...
  token: function (e, n) {
    if (
      (e.sol() && (n.context && n.context.align == null && (n.context.align = !1), (n.indent = e.indentation())),
      e.eatSpace())
    )
      return null;
    var t = n.tokenize(e, n);
    if (
      (t != "comment" && n.context && n.context.align == null && n.context.type != "pattern" && (n.context.align = !0),
      r == "(")
    )
      l(n, ")", e.column());
      ...
      r == "." && n.context && n.context.type == "pattern"
        ? c(n)
        : /atom|string|variable/.test(t) &&
          n.context &&
          (/[\}\]]/.test(n.context.type)
            ? l(n, "pattern", e.column())
            : n.context.type == "pattern" &&
              !n.context.align &&
              ((n.context.align = !0), (n.context.col = e.column())));
    return t;
  },
