...
function h(e) {
  ...
  function K(i, a) {
    ...
    var u = i.current();
    return m(l, u)
      ? (m(b, u) && (p = "newstatement"), m(_, u) && (E = !0), "keyword")
      : m(s, u)
        ? "type"
        : m(d, u) || (U && U(u))
          ? (m(b, u) && (p = "newstatement"), "builtin")
          : m(w, u)
            ? "atom"
            : "variable";
  }
  ...
  return {
    ...
    token: function (i, a) {
      var c = a.context;
      if (
        (i.sol() && (c.align == null && (c.align = !1), (a.indented = i.indentation()), (a.startOfLine = !0)),
        i.eatSpace())
      )
        return ($(i, a), null);
      p = E = null;
      ...
      if (
        (o == "variable" &&
          (a.prevToken == "def" ||
            (e.typeFirstDefinitions && V(i, a, i.start) && P(a.context) && i.match(/^\s*\(/, !1))) &&
          (o = "def"),
        y.token)
      ) {
        var u = y.token(i, a, o);
      ...
      return (
        o == "def" && e.styleDefs === !1 && (o = "variable"),
        (a.startOfLine = !1),
        (a.prevToken = E ? "def" : o || p),
        $(i, a),
        o
      );
    },
    ...
    hooks: {
      ...
      token: function (e, n, t) {
        if (
          t == "variable" &&
          e.peek() == "(" &&
          (n.prevToken == ";" || n.prevToken == null || n.prevToken == "}") &&
          Y(e.current())
        )
          return "def";
      },
