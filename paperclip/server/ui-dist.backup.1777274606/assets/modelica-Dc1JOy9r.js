function r(n) {
  for (var e = {}, i = n.split(" "), l = 0; l < i.length; ++l) e[i[l]] = !0;
  return e;
}
var t = r(
  ...
  u = r("Real Boolean Integer String"),
  f = [].concat(Object.keys(t), Object.keys(a), Object.keys(u)),
  k = /[;=\(:\),{}.*<>+\-\/^\[\]]/,
  s = /(:=|<=|>=|==|<>|\.\+|\.\-|\.\*|\.\/|\.\^)/,
  o = /[0-9]/,
  c = /[_a-zA-Z]/;
...
function g(n, e) {
  return (
    n.eatWhile(o),
    n.eat(".") && n.eatWhile(o),
    (n.eat("e") || n.eat("E")) && (n.eat("-") || n.eat("+"), n.eatWhile(o)),
    (e.tokenize = null),
    (e.sol = !1),
    "number"
  );
...
const z = {
  ...
  indent: function (n, e, i) {
    ...
    return (
      /(algorithm)/.test(e) && l--,
      /(equation)/.test(e) && l--,
      /(initial algorithm)/.test(e) && l--,
      /(initial equation)/.test(e) && l--,
      /(end)/.test(e) && l--,
      l > 0 ? i.unit * l : 0
    );
  },
