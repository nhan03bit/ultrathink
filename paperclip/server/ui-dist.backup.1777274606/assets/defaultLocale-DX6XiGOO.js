...
function j(n, t) {
  ...
  var e = (n = t ? n.toExponential(t - 1) : n.toExponential()).indexOf("e"),
    i = n.slice(0, e);
...
function Q(n, t) {
  return function (e, i) {
    for (
      var o = e.length, a = [], c = 0, h = n[0], M = 0;
      o > 0 &&
      h > 0 &&
      (M + h + 1 > i && (h = Math.max(1, i - M)), a.push(e.substring((o -= h), o + h)), !((M += h + 1) > i));
    )
      h = n[(c = (c + 1) % n.length)];
...
function v(n, t) {
  ...
  var i = e[0],
    o = e[1],
    a = o - (N = Math.max(-8, Math.min(8, Math.floor(o / 3))) * 3) + 1,
    c = i.length;
  return a === c
    ? i
    : a > c
      ? i + new Array(a - c + 1).join("0")
      : a > 0
        ? i.slice(0, a) + "." + i.slice(a)
        : "0." + new Array(1 - a).join("0") + j(n, Math.max(0, t + a - 1))[0];
}
function X(n, t) {
  var e = j(n, t);
  if (!e) return n + "";
...
function nn(n) {
  var t = n.grouping === void 0 || n.thousands === void 0 ? R : Q(U.call(n.grouping, Number), n.thousands + ""),
    e = n.currency === void 0 ? "" : n.currency[0] + "",
    i = n.currency === void 0 ? "" : n.currency[1] + "",
    o = n.decimal === void 0 ? "." : n.decimal + "",
    a = n.numerals === void 0 ? R : V(U.call(n.numerals, String)),
    c = n.percent === void 0 ? "%" : n.percent + "",
    h = n.minus === void 0 ? "−" : n.minus + "",
    M = n.nan === void 0 ? "NaN" : n.nan + "";
  function T(f, g) {
    f = $(f);
    var b = f.fill,
      p = f.align,
      ...
      C = f.trim,
      d = f.type;
    (d === "n" ? ((F = !0), (d = "g")) : O[d] || (y === void 0 && (y = 12), (C = !0), (d = "g")),
      (S || (b === "0" && p === "=")) && ((S = !0), (b = "0"), (p = "=")));
    var q =
        (g && g.prefix !== void 0 ? g.prefix : "") +
        (w === "$" ? e : w === "#" && /[boxX]/.test(d) ? "0" + d.toLowerCase() : ""),
      B = (w === "$" ? i : /[%p]/.test(d) ? c : "") + (g && g.suffix !== void 0 ? g.suffix : ""),
      D = O[d],
      H = /[defgprs%]/.test(d);
    ...
    function G(r) {
      ...
      if (d === "c") ((u = D(r) + u), (r = ""));
        ...
        var P = r < 0 || 1 / r < 0;
        if (
          ((r = isNaN(r) ? M : D(Math.abs(r), y)),
          C && (r = _(r)),
          P && +r == 0 && m !== "+" && (P = !1),
          (l = (P ? (m === "(" ? m : h) : m === "-" || m === "(" ? "" : m) + l),
          (u = (d === "s" && !isNaN(r) && N !== void 0 ? Y[8 + N / 3] : "") + u + (P && m === "(" ? ")" : "")),
          H)
        ) {
      ...
      F && !S && (r = t(r, 1 / 0));
      var z = l.length + r.length + u.length,
        s = z < E ? new Array(E - z + 1).join(b) : "";
  ...
  function Z(f, g) {
    var b = Math.max(-8, Math.min(8, Math.floor(K(g) / 3))) * 3,
      p = Math.pow(10, -b),
      m = T(((f = $(f)), (f.type = "f"), f), { suffix: Y[8 + b / 3] });
    return function (w) {
      return m(p * w);
    };
  }
  return { format: T, formatPrefix: Z };
}
var A, tn, rn;
...
export { rn as a, tn as b, K as e, $ as f };
