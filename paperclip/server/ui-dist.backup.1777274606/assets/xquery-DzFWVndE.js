var d = (function () {
  ...
  for (
    var n = e("operator"),
      t = { type: "atom", style: "atom" },
      i = { type: "punctuation", style: null },
      o = { type: "axis_specifier", style: "qualifier" },
      l = { ",": i },
      p = [
        "after",
        "all",
...
function u(e, n) {
  var t = e.next(),
    ...
    o = _(e);
  if (t == "<") {
    if (e.match("!--", !0)) return x(e, n, N);
    if (e.match("![CDATA", !1)) return ((n.tokenize = E), "tag");
    if (e.match("?", !1)) return x(e, n, A);
    var l = e.eat("/");
    e.eatSpace();
    ...
    var f = e.current();
    return (
      (a = d.propertyIsEnumerable(f) && d[f]),
      i && !a && (a = { type: "function_call", style: "def" }),
      D(n)
        ? (c(n), "variable")
        : ((f == "element" || f == "attribute" || a.type == "axis_specifier") && s(n, { type: "xmlconstructor" }),
          a ? a.style : "variable")
    );
  }
}
  ...
  return function (t, i) {
    for (var o; (o = t.next()); )
      if (o == e) {
        (c(i), n && (i.tokenize = n));
        break;
      } else if (t.match("{", !1) && h(i)) return (s(i, { type: "codeblock" }), (i.tokenize = u), "string");
    return "string";
  };
}
function m(e, n, t, i) {
...
function T(e, n) {
  ...
  if (e.eat('"')) {
    for (; e.next() !== '"'; );
    e.eat(":");
  } else (e.eatWhile(t), e.match(":=", !1) || e.eat(":"));
  ...
  return t == "/" && e.eat(">")
    ...
    : t == ">"
      ...
      : t == "="
        ...
        : t == '"' || t == "'"
          ? m(e, n, t, y)
          : (h(n) || s(n, { type: "attribute", tokenize: y }),
            e.eat(/[a-zA-Z_:]/),
            e.eatWhile(/[-a-zA-Z0-9_:.]/),
            e.eatSpace(),
            (e.match(">", !1) || e.match("/", !1)) && (c(n), (n.tokenize = u)),
            "attribute");
}
function N(e, n) {
  for (var t; (t = e.next()); ) if (t == "-" && e.match("->", !0)) return ((n.tokenize = u), "comment");
}
function E(e, n) {
  for (var t; (t = e.next()); ) if (t == "]" && e.match("]", !0)) return ((n.tokenize = u), "comment");
}
function A(e, n) {
  for (var t; (t = e.next()); ) if (t == "?" && e.match(">", !0)) return ((n.tokenize = u), "processingInstruction");
}
function b(e) {
  return k(e, "tag");
}
