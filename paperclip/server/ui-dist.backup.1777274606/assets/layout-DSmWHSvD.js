import { G as g } from "./graph-C_2AnXgs.js";
import {
  b as Te,
  p as ce,
  q as le,
...
function U(e, n) {
  return e && e.length ? he(e, z(n), Fe) : void 0;
}
function rn(e, n) {
  var r = e.length;
...
function tn(e, n) {
  if (e !== n) {
    var r = e !== void 0,
      ...
      d = n === n,
      s = ee(n);
    if ((!u && !s && !i && e > n) || (i && o && d && !u && !s) || (t && o && d) || (!r && d) || !a) return 1;
    if ((!t && !i && !s && e < n) || (s && r && a && !t && !i) || (u && r && a) || (!o && a) || !d) return -1;
  }
  return 0;
}
function an(e, n, r) {
...
var M = He(function (e, n) {
  ...
  sn = Math.max;
function fn(e, n, r, t) {
  for (var a = -1, i = sn(dn((n - e) / (r || 1)), 0), o = Array(i); i--; ) ((o[++a] = e), (e += r));
  return o;
}
function cn(e) {
  return function (n, r, t) {
    return (
      t && typeof t != "number" && q(n, r, t) && (r = t = void 0),
      (n = V(n)),
      r === void 0 ? ((r = n), (n = 0)) : (r = V(r)),
      (t = t === void 0 ? (n < r ? 1 : -1) : V(t)),
      fn(n, r, t)
    );
  };
}
...
class pn {
  ...
  toString() {
    for (var n = [], r = this._sentinel, t = r._prev; t !== r; ) (n.push(JSON.stringify(t, wn)), (t = t._prev));
    return "[" + n.join(", ") + "]";
  }
}
function ne(e) {
...
function mn(e, n) {
  ...
  var r = yn(e, n || bn),
    t = gn(r.graph, r.buckets, r.zeroIdx);
  return O(
    w(t, function (a) {
...
function gn(e, n, r) {
  for (var t = [], a = n[n.length - 1], i = n[0], o; e.nodeCount(); ) {
    for (; (o = i.dequeue()); ) A(e, n, r, o);
    for (; (o = a.dequeue()); ) A(e, n, r, o);
    if (e.nodeCount()) {
...
function re(e, n) {
  var r = e.x,
    ...
    o = e.width / 2,
    u = e.height / 2;
  if (!a && !i) throw new Error("Not possible to find intersection inside of the rectangle");
  var d, s;
  return (
    Math.abs(i) * o > Math.abs(a) * u
      ? (i < 0 && (u = -u), (d = (u * a) / i), (s = u))
      : (a < 0 && (o = -o), (d = o), (s = (o * i) / a)),
    { x: r + d, y: t + s }
  );
...
function ae(e, n, r, t, a, i) {
  var o = { width: 0, height: 0, rank: i, borderType: n },
    u = a[n][i - 1],
    d = L(e, "border", o, r);
...
function J(e) {
  ...
  function r(t) {
    ...
    return ((i === Number.POSITIVE_INFINITY || i === void 0 || i === null) && (i = 0), (a.rank = i));
  }
  f(e.sources(), r);
}
function C(e, n) {
...
function ye(e) {
  var n = new g({ directed: !1 }),
    ...
    t = e.nodeCount();
  n.setNode(r, {});
  for (var a, i; Vn(n, e) < t; ) ((a = An(n, e)), (i = n.hasNode(a.v) ? C(e, a) : -C(e, a)), Bn(n, e, i));
  return n;
}
function Vn(e, n) {
  function r(t) {
...
function An(e, n) {
  return U(n.edges(), function (r) {
    if (e.hasNode(r.v) !== e.hasNode(r.w)) return C(n, r);
  });
}
function Bn(e, n, r) {
...
function k(e) {
  ...
  var n = ye(e);
  (Z(n), Q(n, e));
  for (var r, t; (r = Le(n)); ) ((t = Ne(n, e, r)), Pe(n, e, r, t));
}
function Q(e, n) {
  var r = Yn(e, e.nodes());
  ...
  (e.setParent(d, o),
    ...
    f(u, function (l) {
      ...
      var h = e.node(l),
        ...
        b = h.borderTop ? t : 2 * t,
        N = v !== p ? 1 : a - i[o] + 1;
      (e.setEdge(d, v, { weight: b, minlen: N, nestingEdge: !0 }),
        e.setEdge(p, s, { weight: b, minlen: N, nestingEdge: !0 }));
    }),
...
function er(e, n, r) {
  var t = nr(e),
    a = new g({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function (i) {
      return e.node(i);
    });
  return (
    f(e.nodes(), function (i) {
      var o = e.node(i),
        u = e.parent(i);
      (o.rank === n || (o.minRank <= n && n <= o.maxRank)) &&
        (a.setNode(i),
        a.setParent(i, u || t),
        f(e[r](i), function (d) {
          var s = d.v === i ? d.w : d.v,
        ...
        Object.prototype.hasOwnProperty.call(o, "minRank") &&
          a.setNode(i, { borderLeft: o.borderLeft[n], borderRight: o.borderRight[n] }));
    }),
    a
  );
}
...
function rr(e, n) {
  for (var r = 0, t = 1; t < n.length; ++t) r += tr(e, n[t - 1], n[t]);
  return r;
}
function tr(e, n, r) {
  for (
...
function or(e, n) {
  var r = {};
  (f(e, function (a, i) {
    var o = (r[a.v] = { indegree: 0, in: [], out: [], vs: [a.v], i });
...
function de(e, n, r) {
  for (var t; n.length && (t = T(n)).i <= r; ) (n.pop(), e.push(t.vs), r++);
  return r;
}
function fr(e) {
  return function (n, r) {
...
function hr(e) {
  var n = me(e),
    r = se(e, E(1, n + 1), "inEdges"),
    t = se(e, E(n - 1, -1, -1), "outEdges"),
    a = ar(e);
  fe(e, a);
...
function pr(e) {
  ...
  f(e.graph().dummyChains, function (r) {
    for (
      var t = e.node(r), a = t.edgeObj, i = wr(e, n, a.v, a.w), o = i.path, u = i.lca, d = 0, s = o[d], c = !0;
      r !== a.w;
    ) {
      if (((t = e.node(r)), c)) {
        for (; (s = o[d]) !== u && e.node(s).maxRank < t.rank; ) d++;
        s === u && (c = !1);
      }
      if (!c) {
        for (; d < o.length - 1 && e.node((s = o[d + 1])).minRank <= t.rank; ) d++;
        s = o[d];
      }
...
function wr(e, n, r, t) {
  var a = [],
    i = [],
    o = Math.min(n[r].low, n[t].low),
    u = Math.max(n[r].lim, n[t].lim),
    d,
    s;
  d = r;
  do ((d = e.parent(d)), a.push(d));
  while (d && (n[d].low > o || u > n[d].lim));
  for (s = d, d = t; (d = e.parent(d)) !== s; ) i.push(d);
  ...
  f(["u", "d"], function (o) {
    ((a = o === "u" ? n : x(n).reverse()),
      f(["l", "r"], function (u) {
        ...
        var d = (o === "u" ? e.predecessors : e.successors).bind(e),
          s = xr(e, a, r, d),
          c = Er(e, a, s.root, s.align, u === "r");
        (u === "r" &&
          (c = S(c, function (l) {
            return -l;
          })),
...
var jr = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"],
  Fr = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" },
  Vr = ["acyclicer", "ranker", "rankdir", "align"],
  Ar = ["width", "height"],
  Br = { width: 0, height: 0 },
  Gr = ["minlen", "weight", "width", "height", "labeloffset"],
  Yr = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: "r" },
  Dr = ["labelpos"];
function qr(e) {
  var n = new g({ multigraph: !0, compound: !0 }),
    r = D(e.graph());
  return (
    n.setGraph($({}, Fr, Y(r, jr), M(r, Vr))),
    f(e.nodes(), function (t) {
      var a = D(e.node(t));
...
function Wr(e) {
  f(e.edges(), function (n) {
    ...
    if (r.width && r.height) {
      var t = e.node(n.v),
        a = e.node(n.w),
        i = { rank: (a.rank - t.rank) / 2 + t.rank, e: n };
...
function Hr(e) {
  f(e.edges(), function (n) {
    var r = e.edge(n),
      ...
      i,
      o;
    (r.points ? ((i = r.points[0]), (o = r.points[r.points.length - 1])) : ((r.points = []), (i = a), (o = t)),
  ...
  (f(e.nodes(), function (n) {
    if (e.children(n).length) {
      var r = e.node(n),
        ...
        i = e.node(T(r.borderLeft)),
        o = e.node(T(r.borderRight));
...
function et(e) {
  ...
  f(n, function (r) {
    ...
    f(r, function (a, i) {
      var o = e.node(a);
      ((o.order = i + t),
        f(o.selfEdges, function (u) {
          L(
            e,
            "selfedge",
            { width: u.label.width, height: u.label.height, rank: o.rank, order: i + ++t, e: u.e, label: u.label },
            "_se"
          );
        }),
        delete o.selfEdges);
