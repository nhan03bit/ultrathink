...
var f = s(
  ...
  u = s("if elseif else and not or eq ne in ni for foreach while switch"),
  c = /[+\-*&%=<>!?^\/\|]/;
function i(r, n, t) {
...
function o(r, n) {
  ...
  if (/[\[\]{}\(\),;\.]/.test(e)) return (e == "(" && t ? (n.inParams = !0) : e == ")" && (n.inParams = !1), null);
  ...
  if (e == "$") return (r.eatWhile(/[$_a-z0-9A-Z\.{:]/), r.eatWhile(/}/), (n.beforeParams = !0), "builtin");
  if (c.test(e)) return (r.eatWhile(c), "comment");
  r.eatWhile(/[\w\$_{}\xa1-\uffff]/);
  var a = r.current().toLowerCase();
  return f && f.propertyIsEnumerable(a)
    ? "keyword"
    : u && u.propertyIsEnumerable(a)
      ? ((n.beforeParams = !0), "keyword")
      : null;
}
function p(r) {
  return function (n, t) {
