...
import { p as lr } from "./chunk-4BX2VUAB-Cb4O8Gqh.js";
import { p as fr } from "./treemap-GDKQZRPO-qHAS-c0V.js";
import { c as Fe } from "./cytoscape.esm-jbPEKk2Y.js";
import { K as cr } from "./index-ChLuXRS1.js";
import "./_baseUniq-LizNW1gx.js";
import "./_basePickBy-DfW1SwLa.js";
import "./clone-CiBR69il.js";
var he = { exports: {} },
  le = { exports: {} },
  fe = { exports: {} },
  gr = fe.exports,
        ...
        (function (P, N) {
          ...
          return (function (A) {
            ...
            return (
              ...
              (N.d = function (u, h, a) {
                N.o(u, h) || Object.defineProperty(u, h, { configurable: !1, enumerable: !0, get: a });
              }),
              (N.n = function (u) {
                var h =
                  u && u.__esModule
              ...
              ((r.prototype.getSource = function () {
                ...
                (r.prototype.getOtherEndInGraph = function (f, i) {
                  for (var g = this.getOtherEnd(f), t = i.getGraphManager().getRoot(); ; ) {
                    if (g.getOwner() == i) return g;
                    if (g.getOwner() == t) break;
            ...
            function (A, P, N) {
              ...
              ((i.prototype.getEdges = function () {
                ...
                (i.prototype.scatter = function () {
                  var t,
                    o,
                    s = -r.INITIAL_WORLD_BOUNDARY,
                    c = r.INITIAL_WORLD_BOUNDARY;
                  t = r.WORLD_CENTER_X + e.nextDouble() * (c - s) + s;
                  var l = -r.INITIAL_WORLD_BOUNDARY,
                    T = r.INITIAL_WORLD_BOUNDARY;
              ...
              ((o.prototype.getNodes = function () {
                ...
                (o.prototype.add = function (c, l, T) {
                  if (l == null && T == null) {
                    ...
                    if (!(l.owner == T.owner && l.owner == this)) throw "Both owners must be this graph!";
                    return l.owner != T.owner
                      ? null
                      : ((v.source = l),
                        (v.target = T),
                        (v.isInterGraph = !1),
                ...
                (o.prototype.updateLeftTop = function () {
                  for (
                    var c = h.MAX_VALUE, l = h.MAX_VALUE, T, d, v, L = this.getNodes(), S = L.length, C = 0;
                    C < S;
                    C++
                  ) {
                    var G = L[C];
                  ...
                  return c == h.MAX_VALUE
                    ? null
                    : (L[0].getParent().paddingLeft != null ? (v = L[0].getParent().paddingLeft) : (v = this.margin),
                      (this.left = l - v),
                      (this.top = c - v),
                      new g(this.left, this.top));
                }),
                (o.prototype.updateBounds = function (c) {
                  ...
                  (l == h.MAX_VALUE &&
                    ...
                    X[0].getParent().paddingLeft != null ? (K = X[0].getParent().paddingLeft) : (K = this.margin),
                    (this.left = n.x - K),
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.add = function (r, e, f, i, g) {
                  if (f == null && i == null && g == null) {
                    ...
                    if (t == o) return ((f.isInterGraph = !1), t.add(f, i, g));
                ...
                (a.prototype.remove = function (r) {
                  if (r instanceof u) {
                    ...
                    for (var i, g = f.length, t = 0; t < g; t++) ((i = f[t]), e.remove(i));
                    var o = [];
                    o = o.concat(e.getNodes());
                    var s;
                    g = o.length;
                    for (var t = 0; t < g; t++) ((s = o[t]), e.remove(s));
                    ...
                    if (((i = r), i == null)) throw "Edge is null!";
                ...
                (a.prototype.getAllEdges = function () {
                  if (this.allEdges == null) {
                    var r = [],
                      e = this.getGraphs();
                    e.length;
                    for (var f = 0; f < e.length; f++) r = r.concat(e[f].getEdges());
                ...
                (a.prototype.isOneAncestorOfOther = function (r, e) {
                  if (!(r != null && e != null)) throw "assert failed";
                  if (r == e) return !0;
                  var f = r.getOwner(),
                    i;
                  do {
                ...
                (a.prototype.calcInclusionTreeDepths = function (r, e) {
                  ...
                  for (var f, i = r.getNodes(), g = i.length, t = 0; t < g; t++)
                    ((f = i[t]),
                      (f.inclusionTreeDepth = e),
                      f.child != null && this.calcInclusionTreeDepths(f.child, e + 1));
                }),
                (a.prototype.includesInvalidEdge = function () {
                  ...
                  for (var i = 0; i < e.length; i++) this.remove(e[i]);
                  return !1;
                }),
                (A.exports = a));
            },
            function (A, P, N) {
              ...
              ((h.calcSeparationAmount = function (a, r, e, f) {
                if (!a.intersects(r)) throw "assert failed";
                var i = new Array(2);
                (this.decideDirectionsForOverlappingNodes(a, r, i),
                  (e[0] = Math.min(a.getRight(), r.getRight()) - Math.max(a.x, r.x)),
                  (e[1] = Math.min(a.getBottom(), r.getBottom()) - Math.max(a.y, r.y)),
                  a.getX() <= r.getX() && a.getRight() >= r.getRight()
                    ? (e[0] += Math.min(r.getX() - a.getX(), a.getRight() - r.getRight()))
                    : r.getX() <= a.getX() &&
                      r.getRight() >= a.getRight() &&
                      (e[0] += Math.min(a.getX() - r.getX(), r.getRight() - a.getRight())),
                  a.getY() <= r.getY() && a.getBottom() >= r.getBottom()
                    ? (e[1] += Math.min(r.getY() - a.getY(), a.getBottom() - r.getBottom()))
                    : r.getY() <= a.getY() &&
                      r.getBottom() >= a.getBottom() &&
                      (e[1] += Math.min(a.getY() - r.getY(), r.getBottom() - a.getBottom())));
                ...
                (h.decideDirectionsForOverlappingNodes = function (a, r, e) {
                  (a.getCenterX() < r.getCenterX() ? (e[0] = -1) : (e[0] = 1),
                    a.getCenterY() < r.getCenterY() ? (e[1] = -1) : (e[1] = 1));
                }),
                (h.getIntersection2 = function (a, r, e) {
                  var f = a.getCenterX(),
                    ...
                    g = r.getCenterX(),
                    t = r.getCenterY();
                  if (a.intersects(r)) return ((e[0] = f), (e[1] = i), (e[2] = g), (e[3] = t), !0);
                  var o = a.getX(),
                    s = a.getY(),
                    c = a.getRight(),
                    l = a.getX(),
                    ...
                    m = !1;
                  if (f === g) {
                    if (i > t) return ((e[0] = f), (e[1] = s), (e[2] = g), (e[3] = X), !1);
                    if (i < t) return ((e[0] = f), (e[1] = T), (e[2] = g), (e[3] = C), !1);
                  } else if (i === t) {
                    if (f > g) return ((e[0] = o), (e[1] = i), (e[2] = G), (e[3] = t), !1);
                    if (f < g) return ((e[0] = c), (e[1] = i), (e[2] = S), (e[3] = t), !1);
                  } else {
                    ...
                    if (
                      (-p === y
                        ? f > g
                          ? ((e[0] = l), (e[1] = T), (n = !0))
                          : ((e[0] = c), (e[1] = s), (n = !0))
                        : p === y && (f > g ? ((e[0] = o), (e[1] = s), (n = !0)) : ((e[0] = d), (e[1] = T), (n = !0))),
                      -E === y
                        ? g > f
                          ? ((e[2] = K), (e[3] = X), (m = !0))
                          : ((e[2] = G), (e[3] = C), (m = !0))
                        : E === y && (g > f ? ((e[2] = S), (e[3] = C), (m = !0)) : ((e[2] = Q), (e[3] = X), (m = !0))),
                      n && m)
                    )
                      return !1;
                    if (
                      (f > g
                        ? i > t
                          ? ((R = this.getCardinalDirection(p, y, 4)), (M = this.getCardinalDirection(E, y, 2)))
                          : ((R = this.getCardinalDirection(-p, y, 3)), (M = this.getCardinalDirection(-E, y, 1)))
                        : i > t
                          ? ((R = this.getCardinalDirection(-p, y, 1)), (M = this.getCardinalDirection(-E, y, 3)))
                          : ((R = this.getCardinalDirection(p, y, 2)), (M = this.getCardinalDirection(E, y, 4))),
                      !n)
                    )
                      switch (R) {
                        case 1:
                ...
                (h.getIntersection = function (a, r, e, f) {
                  if (f == null) return this.getIntersection2(a, r, e);
                  var i = a.x,
                    g = a.y,
                    t = r.x,
                    o = r.y,
                  ...
                  return (
                    ...
                    (X = l * c - s * T),
                    (Q = L * G - S * C),
                    Q === 0 ? null : ((d = (C * X - G * K) / Q), (v = (S * K - L * X) / Q), new u(d, v))
                  );
                }),
                (h.angleOfVector = function (a, r, e, f) {
                  ...
                  return (
                    a !== e
                      ? ((i = Math.atan((f - r) / (e - a))), e < a ? (i += Math.PI) : f < r && (i += this.TWO_PI))
                      : f < r
            ...
            function (A, P, N) {
              ...
              function h(i, g) {
                if (!(i instanceof g)) throw new TypeError("Cannot call a class as a function");
              }
              var a = function (g) {
            ...
            function (A, P, N) {
              function u(h, a, r) {
                ((this.x = null),
                  (this.y = null),
                  h == null && a == null && r == null
                    ? ((this.x = 0), (this.y = 0))
                    : typeof h == "number" && typeof a == "number" && r == null
                      ? ((this.x = h), (this.y = a))
                      : h.constructor.name == "Point" &&
                        a == null &&
                        r == null &&
                        ((r = h), (this.x = r.x), (this.y = r.y)));
              }
              ((u.prototype.getX = function () {
                return this.x;
              }),
                ...
                (u.prototype.setLocation = function (h, a, r) {
                  h.constructor.name == "Point" && a == null && r == null
                    ? ((r = h), this.setLocation(r.x, r.y))
                    : typeof h == "number" &&
                      typeof a == "number" &&
                      r == null &&
                      (parseInt(h) == h && parseInt(a) == a
                        ? this.move(h, a)
                        : ((this.x = Math.floor(h + 0.5)), (this.y = Math.floor(a + 0.5))));
                }),
              ...
              function u(h, a, r, e) {
                ((this.x = 0),
                  ...
                  h != null &&
                    ...
                    r != null &&
                    e != null &&
                    ((this.x = h), (this.y = a), (this.width = r), (this.height = e)));
              }
              ((u.prototype.getX = function () {
                return this.x;
              }),
            ...
            function (A, P, N) {
              ...
              function h() {}
              ((h.lastID = 0),
                (h.createID = function (a) {
                  return h.isPrimitive(a)
                    ? a
                    : (a.uniqueID != null || ((a.uniqueID = h.getString()), h.lastID++), a.uniqueID);
                }),
            ...
            function (A, P, N) {
              function u(s) {
                if (Array.isArray(s)) {
                  for (var c = 0, l = Array(s.length); c < s.length; c++) l[c] = s[c];
                  return l;
              ...
              ((o.RANDOM_SEED = 1),
                ...
                (o.prototype.update2 = function () {
                  if (
                    ...
                    for (var l = this.graphManager.getRoot().getNodes(), c = 0; c < l.length; c++) l[c];
                ...
                (o.prototype.update = function (s) {
                  if (s == null) this.update2();
                    ...
                    var c = s;
                    if (c.getChild() != null)
                      for (var l = c.getChild().getNodes(), T = 0; T < l.length; T++) update(l[T]);
                    ...
                    for (var c, l, T = s.getNodes(), d = 0; d < T.length; d++)
                      ((c = T[d]),
                        ...
                        l == null || l.getNodes().length == 0
                          ? c.scatter()
                          : (this.positionNodesRandomly(l), c.updateBounds()));
                }),
                ...
                (o.prototype.createDummyNodesForBendpoints = function (s) {
                  for (
                    var c = [], l = s.source, T = this.graphManager.calcLowestCommonAncestor(s.source, s.target), d = 0;
                    d < s.bendpoints.length;
                    d++
                  ) {
                  ...
                  var L = this.newEdge(null);
                  return (
                    this.graphManager.add(L, l, s.target),
                  ...
                  for (var c = 0; c < s.length; c++) {
                    ...
                    if (l.bendpoints.length > 0) {
                      for (var T = this.edgeToDummyNodes.get(l), d = 0; d < T.length; d++) {
                        var v = T[d],
                          L = new i(v.getCenterX(), v.getCenterY()),
                          S = l.bendpoints.get(d);
            ...
            function (A, P, N) {
              ...
              ((i.prototype.initParameters = function () {
                  ...
                  for (var t, o, s, c, l, T, d, v = this.getGraphManager().getAllEdges(), L = 0; L < v.length; L++)
                    ((t = v[L]),
                      ...
                      t.isInterGraph &&
                        ...
                        this.useSmartIdealEdgeLengthCalculation && (t.idealLength += T + d - 2 * r.SIMPLE_NODE_SIZE),
                        (s = t.getLca().getInclusionTreeDepth()),
                        (t.idealLength +=
                          o *
                          a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR *
                          (c.getInclusionTreeDepth() + l.getInclusionTreeDepth() - 2 * s))));
                }),
                ...
                (i.prototype.calcRepulsionForce = function (t, o) {
                  ...
                  if (s.intersects(c)) {
                    ...
                    ((t.repulsionForceX -= X * G),
                      (t.repulsionForceY -= X * K),
                      (o.repulsionForceX += X * G),
                      (o.repulsionForceY += X * K));
                  } else
                    (this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null
                      ? ((d = c.getCenterX() - s.getCenterX()), (v = c.getCenterY() - s.getCenterY()))
                      : (e.getIntersection(s, c, T), (d = T[2] - T[0]), (v = T[3] - T[1])),
                ...
                (i.prototype.calcGrid = function (t) {
                  ...
                  for (var c = new Array(o), l = 0; l < o; l++) c[l] = new Array(s);
                  for (var l = 0; l < o; l++) for (var T = 0; T < s; T++) c[l][T] = new Array();
                  return c;
                }),
                (i.prototype.addNodeToGrid = function (t, o, s) {
                  ...
                  ((c = parseInt(Math.floor((t.getRect().x - o) / this.repulsionRange))),
                    (l = parseInt(Math.floor((t.getRect().width + t.getRect().x - o) / this.repulsionRange))),
                  ...
                  for (var v = c; v <= l; v++)
                    for (var L = T; L <= d; L++) (this.grid[v][L].push(t), t.setGridCoordinates(c, l, T, d));
                }),
                      ...
                      for (var L = t.startY - 1; L < t.finishY + 2; L++)
                        if (!(v < 0 || L < 0 || v >= d.length || L >= d[0].length)) {
                          for (var S = 0; S < d[v][L].length; S++)
                            if (
                              ((T = d[v][L][S]), !(t.getOwner() != T.getOwner() || t == T) && !o.has(T) && !l.has(T))
                            ) {
            ...
            function (A, P, N) {
              function u(h, a) {
                ((this.width = 0),
                  (this.height = 0),
                  h !== null && a !== null && ((this.height = a), (this.width = h)));
              }
              ((u.prototype.getWidth = function () {
                return this.width;
              }),
            ...
            function (A, P, N) {
              ...
              ((h.prototype.add = function (a) {
                ...
                (h.prototype.addAllTo = function (a) {
                  for (var r = Object.keys(this.set), e = r.length, f = 0; f < e; f++) a.push(this.set[r[f]]);
                }),
                (h.prototype.size = function () {
                  return Object.keys(this.set).length;
                }),
              ...
              ((u.multMat = function (h, a) {
                for (var r = [], e = 0; e < h.length; e++) {
                  ...
                  for (var f = 0; f < a[0].length; f++) {
                    r[e][f] = 0;
                    for (var i = 0; i < h[0].length; i++) r[e][f] += h[e][i] * a[i][f];
                  }
                }
                return r;
              }),
                (u.transpose = function (h) {
                  for (var a = [], r = 0; r < h[0].length; r++) {
                    a[r] = [];
                    for (var e = 0; e < h.length; e++) a[r][e] = h[e][r];
                  }
                  return a;
                }),
                (u.multCons = function (h, a) {
                  for (var r = [], e = 0; e < h.length; e++) r[e] = h[e] * a;
                  return r;
                }),
                (u.minusOp = function (h, a) {
                  for (var r = [], e = 0; e < h.length; e++) r[e] = h[e] - a[e];
                  return r;
                }),
                (u.dotProduct = function (h, a) {
                  for (var r = 0, e = 0; e < h.length; e++) r += h[e] * a[e];
                  return r;
                }),
                (u.mag = function (h) {
                ...
                (u.normalize = function (h) {
                  for (var a = [], r = this.mag(h), e = 0; e < h.length; e++) a[e] = h[e] / r;
                  return a;
                }),
                (u.multGamma = function (h) {
                  for (var a = [], r = 0, e = 0; e < h.length; e++) r += h[e];
                  r *= -1 / h.length;
                  for (var f = 0; f < h.length; f++) a[f] = r + h[f];
                  return a;
                }),
                (u.multL = function (h, a, r) {
                  for (var e = [], f = [], i = [], g = 0; g < a[0].length; g++) {
                    for (var t = 0, o = 0; o < a.length; o++) t += -0.5 * a[o][g] * h[o];
                    f[g] = t;
                  }
                  for (var s = 0; s < r.length; s++) {
                    for (var c = 0, l = 0; l < r.length; l++) c += r[s][l] * f[l];
                    i[s] = c;
                  }
              ...
              ((u.svd = function (h) {
                ...
                for (
                  var r = (function (Tt) {
                    ...
                    g = Math.max(0, Math.min(this.n - 2, this.m)),
                    t = 0;
                  t < Math.max(i, g);
                  t++
                ) {
                  if (t < i) {
                    this.s[t] = 0;
                    for (var o = t; o < this.m; o++) this.s[t] = u.hypot(this.s[t], h[o][t]);
                    if (this.s[t] !== 0) {
                      h[t][t] < 0 && (this.s[t] = -this.s[t]);
                      for (var s = t; s < this.m; s++) h[s][t] /= this.s[t];
                      h[t][t] += 1;
                    }
                    this.s[t] = -this.s[t];
                  }
                  for (var c = t + 1; c < this.n; c++) {
                    if (
                      ...
                      for (var l = 0, T = t; T < this.m; T++) l += h[T][t] * h[T][c];
                      l = -l / h[t][t];
                      for (var d = t; d < this.m; d++) h[d][c] += l * h[d][t];
                    }
                    r[c] = h[t][c];
                  }
                  if (
                    ...
                    for (var v = t; v < this.m; v++) this.U[v][t] = h[v][t];
                  if (t < g) {
                    r[t] = 0;
                    for (var L = t + 1; L < this.n; L++) r[t] = u.hypot(r[t], r[L]);
                    if (r[t] !== 0) {
                      r[t + 1] < 0 && (r[t] = -r[t]);
                      for (var S = t + 1; S < this.n; S++) r[S] /= r[t];
                      r[t + 1] += 1;
                    }
                    if (
                      ((r[t] = -r[t]),
                      ...
                      for (var C = t + 1; C < this.m; C++) e[C] = 0;
                      for (var G = t + 1; G < this.n; G++) for (var K = t + 1; K < this.m; K++) e[K] += r[G] * h[K][G];
                      for (var X = t + 1; X < this.n; X++)
                        for (var Q = -r[X] / r[t + 1], O = t + 1; O < this.m; O++) h[O][X] += Q * e[O];
                    }
                    for (var rt = t + 1; rt < this.n; rt++) this.V[rt][t] = r[rt];
                  }
                }
                var n = Math.min(this.n, this.m + 1);
                (i < this.n && (this.s[i] = h[i][i]),
                  ...
                  (r[n - 1] = 0));
                {
                  ...
                  for (var E = i - 1; E >= 0; E--)
                    if (this.s[E] !== 0) {
                      for (var y = E + 1; y < a; y++) {
                        for (var R = 0, M = E; M < this.m; M++) R += this.U[M][E] * this.U[M][y];
                        R = -R / this.U[E][E];
                      ...
                      for (var k = 0; k < this.m; k++) this.U[k][E] = 0;
                      this.U[E][E] = 1;
                    }
                }
                for (var V = this.n - 1; V >= 0; V--) {
                  if (
                    ...
                    for (var Y = V + 1; Y < a; Y++) {
                      ...
                      et = -et / this.V[V + 1][V];
                      for (var w = V + 1; w < this.n; w++) this.V[w][Y] += et * this.V[w][V];
                    }
                    ...
                    case 3:
                      {
                        var Yt = Math.max(
                            Math.max(
                              Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(r[n - 2])),
                              Math.abs(this.s[q])
                            ),
                            Math.abs(r[q])
                          ),
                        ...
                        (function (Tt, Ct) {
                          ...
                          ((ct = Math.sqrt(Z * Z + at)), Z < 0 && (ct = -ct), (ct = at / (Z + ct)));
                        for (var nt = (B + Vt) * (B - Vt) + ct, tt = B * J, j = q; j < n - 1; j++) {
                          var ut = u.hypot(nt, tt),
                            Mt = nt / ut,
                            pt = tt / ut;
                          (j !== q && (r[j - 1] = ut),
                            (nt = Mt * this.s[j] + pt * r[j]),
                            (r[j] = Mt * r[j] - pt * this.s[j]),
                            (tt = pt * this.s[j + 1]),
                          ...
                          if (
                            ...
                            (pt = tt / ut),
                            (this.s[j] = ut),
                            (nt = Mt * r[j] + pt * this.s[j + 1]),
                            (this.s[j + 1] = -pt * r[j] + Mt * this.s[j + 1]),
                            (tt = pt * r[j + 1]),
                            (r[j + 1] = Mt * r[j + 1]),
                            j < this.m - 1)
                          )
                ...
                (u.hypot = function (h, a) {
                  ...
                  return (
                    Math.abs(h) > Math.abs(a)
                      ? ((r = a / h), (r = Math.abs(h) * Math.sqrt(1 + r * r)))
                      : a != 0
                        ? ((r = h / a), (r = Math.abs(a) * Math.sqrt(1 + r * r)))
                        : (r = 0),
                    r
                  );
                }),
                ...
                function r(e, f) {
                  for (var i = 0; i < f.length; i++) {
                    ...
                    ((g.enumerable = g.enumerable || !1),
                      ...
                      Object.defineProperty(e, g.key, g));
                  }
                }
              ...
              var a = (function () {
                function r(e, f) {
                  var i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1,
                    g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : -1,
                  ...
                  for (var c = 0; c < this.iMax; c++) {
                    ...
                    for (var l = 0; l < this.jMax; l++) this.tracebackGrid[c][l] = [null, null, null];
                  }
                ...
                return (
                  u(r, [
                      ...
                      value: function () {
                        ...
                        for (var g = 1; g < this.iMax; g++)
                          for (var t = 1; t < this.jMax; t++) {
                            var o = void 0;
                            this.sequence1[g - 1] === this.sequence2[t - 1]
                              ? (o = this.grid[g - 1][t - 1] + this.match_score)
                              : (o = this.grid[g - 1][t - 1] + this.mismatch_penalty);
                            var s = this.grid[g - 1][t] + this.gap_penalty,
                              c = this.grid[g][t - 1] + this.gap_penalty,
                              l = [o, s, c],
                              T = this.arrayAllMaxIndexes(l);
                            ((this.grid[g][t] = l[T[0]]),
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (
                          ...
                          var i = f[0],
                            g = this.tracebackGrid[i.pos[0]][i.pos[1]];
                          (g[0] &&
                            f.push({
                    ...
                    },
                    {
                      key: "getAllIndexes",
                      value: function (f, i) {
                        for (var g = [], t = -1; (t = f.indexOf(i, t + 1)) !== -1; ) g.push(t);
                        return g;
                      },
                    },
                    {
            ...
            function (A, P, N) {
              ...
              ((h.addListener = function (a, r) {
                this.listeners.push({ event: a, callback: r });
              }),
          ...
          return (() => {
            var P = {
                45: (a, r, e) => {
                  var f = {};
                  ((f.layoutBase = e(551)),
                    (f.CoSEConstants = e(806)),
                    (f.CoSEEdge = e(767)),
                    (f.CoSEGraph = e(880)),
                    (f.CoSEGraphManager = e(578)),
                    (f.CoSELayout = e(765)),
                    (f.CoSENode = e(991)),
                    (f.ConstraintHandler = e(902)),
                    (a.exports = f));
                },
                806: (a, r, e) => {
                ...
                765: (a, r, e) => {
                  var f = e(551).FDLayout,
                    ...
                    s = e(806),
                    c = e(902),
                    l = e(551).FDLayoutConstants,
                    T = e(551).LayoutConstants,
                    d = e(551).Point,
                    v = e(551).PointD,
                    L = e(551).DimensionD,
                    S = e(551).Layout,
                  ...
                  ((O.prototype.newGraphManager = function () {
                    ...
                    (O.prototype.initConstraintVariables = function () {
                      ...
                      if (this.constraints.relativePlacementConstraint) {
                        ...
                        if (
                          ...
                          this.fixedNodeSet.forEach(function (w) {
                        ...
                        if (s.RELAX_MOVEMENT_ON_CONSTRAINTS)
                            ...
                            this.constraints.relativePlacementConstraint.forEach(function (w) {
                              if (w.left) {
                                var H = M.has(w.left) ? M.get(w.left) : w.left,
                                  $ = M.has(w.right) ? M.get(w.right) : w.right;
                                (n.nodesInRelativeHorizontal.includes(H) ||
                                  ...
                                  n.nodeToRelativeConstraintMapHorizontal.get(H).push({ right: $, gap: w.gap }),
                                  n.nodeToRelativeConstraintMapHorizontal.get($).push({ left: H, gap: w.gap }));
                              } else {
                                var _ = F.has(w.top) ? F.get(w.top) : w.top,
                                  ht = F.has(w.bottom) ? F.get(w.bottom) : w.bottom;
                          ...
                          this.constraints.relativePlacementConstraint.forEach(function (w) {
                            if (w.left) {
                              var H = M.has(w.left) ? M.get(w.left) : w.left,
                                $ = M.has(w.right) ? M.get(w.right) : w.right;
                              (k.has(H) ? k.get(H).push($) : k.set(H, [$]),
                                k.has($) ? k.get($).push(H) : k.set($, [H]));
                            } else {
                              var _ = F.has(w.top) ? F.get(w.top) : w.top,
                                ht = F.has(w.bottom) ? F.get(w.bottom) : w.bottom;
                            ...
                            this.nodesInRelativeHorizontal.forEach(function (z) {
                              if (!n.fixedNodesOnHorizontal.has(z)) {
                                ...
                                (n.dummyToNodeForVerticalAlignment.has(z)
                                  ...
                                  n.nodeToTempPositionMapHorizontal.set(
                                    z,
                                    n.nodeToTempPositionMapHorizontal.get(z) + w
                                  ),
                                  n.dummyToNodeForVerticalAlignment.has(z)
                          ...
                          for (var p = 0; p < this.componentsOnHorizontal.length; p++) {
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              ...
                              for (var k = 0, V = 0, y = 0; y < x.length; y++)
                                ...
                                } else ((k += this.idToNodeMap.get(x[y]).displacementX), V++);
                          ...
                          for (var p = 0; p < this.componentsOnVertical.length; p++) {
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              ...
                              for (var k = 0, V = 0, y = 0; y < x.length; y++)
                                ...
                                } else ((k += this.idToNodeMap.get(x[y]).displacementY), V++);
                              for (var et = k / V, y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                    ...
                    (O.prototype.positionNodesRadially = function (n) {
                      for (
                        ...
                        var W = n[F],
                          x = S.findCenterOfTree(W);
                        ((m.x = R),
                          (m.y = y),
                          (M = O.radialLayout(W, x, m)),
                          M.y > E && (E = Math.floor(M.y)),
                    ...
                    (O.prototype.groupZeroDegreeMembers = function () {
                      ...
                      Object.keys(m).forEach(function (W) {
                        if (m[W].length > 1) {
                          ...
                          var k = m[W][0].getParent(),
                            V = new t(n.graphManager);
                          ((V.id = x),
                            (V.paddingLeft = k.paddingLeft || 0),
                            (V.paddingRight = k.paddingRight || 0),
                            (V.paddingBottom = k.paddingBottom || 0),
                            (V.paddingTop = k.paddingTop || 0),
                            (n.idToDummyNode[x] = V));
                      ...
                      for (var F = m, W = 0; W < n.rows.length; W++) {
                        ...
                        for (var k = 0, V = 0; V < x.length; V++) {
                          ...
                          ((Y.rect.x = m),
                            ...
                            Y.rect.height > k && (k = Y.rect.height));
                        }
                            ...
                            (y.labelWidth &&
                              ...
                              y.labelHeight &&
                                (y.labelPosVertical == "top"
                                  ...
                                  : y.labelPosVertical == "center" && y.labelHeight > M
                                    ? ((y.rect.y -= (y.labelHeight - M) / 2),
                                      y.setHeight(y.labelHeight),
                                      (y.labelMarginTop = (y.labelHeight - M) / 2))
                                    : y.labelPosVertical == "bottom" && y.setHeight(M + y.labelHeight)));
                          }
                        }));
                    }),
                    ...
                    (O.prototype.calcIdealRowWidth = function (n, m) {
                      ...
                      var W = R / y,
                        x = M / y,
                        k = Math.pow(p - E, 2) + 4 * (W + E) * (x + p) * y,
                        V = (E - p + Math.sqrt(k)) / (2 * (W + E)),
                        Y;
                    ...
                    (O.prototype.tileNodesByFavoringDim = function (n, m, p) {
                      ...
                      for (var V = 0; V < n.length; V++) {
                        var Y = n[V];
                        if (M.rows.length == 0) this.insertNodeToRow(M, Y, 0, m);
                        ...
                        } else this.insertNodeToRow(M, Y, M.rows.length, m);
                    ...
                    (O.prototype.insertNodeToRow = function (n, m, p, E) {
                      ...
                      (n.rows[p].length > 0 && (M += n.horizontalPadding),
                        (n.rowWidth[p] = M),
                        n.width < M && (n.width = M));
                      var F = m.rect.height;
                    ...
                    (O.prototype.canAddHorizontal = function (n, m, p) {
                      ...
                      var W;
                      (n.width - M >= m + n.horizontalPadding
                        ? (W = (n.height + F) / (M + m + n.horizontalPadding))
                        : (W = (n.height + F) / n.width),
                        (F = p + n.verticalPadding));
                      var x;
                      return (
                        n.width < m ? (x = (n.height + F) / m) : (x = (n.height + F) / n.width),
                        x < 1 && (x = 1 / x),
                        W < 1 && (W = 1 / W),
                        W < x
                      );
                    ...
                    (O.prototype.shiftToLastRow = function (n) {
                      ...
                      if (n.width - n.rowWidth[p] > R && m != p) {
                        ...
                        for (var M = Number.MIN_VALUE, F = 0; F < E.length; F++) E[F].height > M && (M = E[F].height);
                        ...
                        for (var R = 0; R < E.length; R++)
                          if (
                            ...
                            if (s.PURE_INCREMENTAL) {
                              var M = p.getEdges()[0].getOtherEnd(p),
                                F = new L(p.getCenterX() - M.getCenterX(), p.getCenterY() - M.getCenterY());
                    ...
                    (O.prototype.findPlaceforPrunedNode = function (n) {
                      ...
                      if ((E == n[1].source ? (p = n[1].target) : (p = n[1].source), s.PURE_INCREMENTAL))
                        ...
                        for (var z = C.MAX_VALUE, w, H, $ = 0; $ < Y.length; $++)
                          Y[$] < z ? ((z = Y[$]), (w = 1), (H = $)) : Y[$] == z && w++;
                        if (w == 3 && z == 0)
                          Y[0] == 0 && Y[1] == 0 && Y[2] == 0
                            ? (m = 1)
                        ...
                        m == 0
                          ? E.setCenter(
                              p.getCenterX(),
                              p.getCenterY() - p.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - E.getHeight() / 2
                            )
                          : m == 1
                            ? E.setCenter(
                                p.getCenterX() + p.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + E.getWidth() / 2,
                                p.getCenterY()
                              )
                            : m == 2
                              ? E.setCenter(
                ...
                991: (a, r, e) => {
                  var f = e(551).FDLayoutNode,
                    i = e(551).IMath;
                  function g(o, s, c, l) {
                    f.call(this, o, s, c, l);
                  }
                  g.prototype = Object.create(f.prototype);
                  for (var t in f) g[t] = f[t];
                  ((g.prototype.calculateDisplacement = function () {
                    ...
                    (g.prototype.propogateDisplacementToChildren = function (o, s) {
                      for (var c = this.getChild().getNodes(), l, T = 0; T < c.length; T++)
                        ((l = c[T]),
                          l.getChild() == null
                            ? ((l.displacementX += o), (l.displacementY += s))
                            : l.propogateDisplacementToChildren(o, s));
                    }),
                ...
                902: (a, r, e) => {
                  function f(c) {
                    if (Array.isArray(c)) {
                      for (var l = 0, T = Array(c.length); l < c.length; l++) T[l] = c[l];
                      return T;
                  ...
                  ((s.handleConstraints = function (c) {
                    var l = {};
                    ((l.fixedNodeConstraint = c.constraints.fixedNodeConstraint),
                      (l.alignmentConstraint = c.constraints.alignmentConstraint),
                      (l.relativePlacementConstraint = c.constraints.relativePlacementConstraint));
                    for (
                      var T = new Map(), d = new Map(), v = [], L = [], S = c.getAllNodes(), C = 0, G = 0;
                      G < S.length;
                      G++
                    ) {
                      var K = S[G];
                      K.getChild() == null &&
                        (d.set(K.id, C++), v.push(K.getCenterX()), L.push(K.getCenterY()), T.set(K.id, K));
                    }
                    l.relativePlacementConstraint &&
                      l.relativePlacementConstraint.forEach(function (b) {
                        !b.gap &&
                          b.gap != 0 &&
                          (b.left
                            ? (b.gap =
                        ...
                        (nt.forEach(function (lt, ot) {
                          (lt == 0
                            ? (ut.push(ot),
                              J ||
                                (B == "horizontal"
                                  ? tt.set(ot, d.has(ot) ? v[d.get(ot)] : Z.get(ot))
                                  : tt.set(ot, d.has(ot) ? L[d.get(ot)] : Z.get(ot))))
                            ...
                            at.forEach(function (lt) {
                              ...
                              if (
                                ...
                                (ot.forEach(function (st) {
                                  B == "horizontal"
                                    ? (tt.set(st, d.has(st) ? v[d.get(st)] : Z.get(st)), (Lt += tt.get(st)))
                                    : (tt.set(st, d.has(st) ? L[d.get(st)] : Z.get(st)), (Lt += tt.get(st)));
                                }),
                                  (Lt = Lt / ot.length),
                                  lt.forEach(function (st) {
                          ...
                          (U.forEach(function (j) {
                            j.left
                              ? v[d.get(j.left)] - v[d.get(j.right)] >= 0
                                ? B++
                                : J++
                              : L[d.get(j.top)] - L[d.get(j.bottom)] >= 0
                                ? Z++
                                : at++;
                          }),
                          B > J && Z > at)
                        )
                          for (var ct = 0; ct < d.size; ct++) ((v[ct] = -1 * v[ct]), (L[ct] = -1 * L[ct]));
                        else if (B > J) for (var nt = 0; nt < d.size; nt++) v[nt] = -1 * v[nt];
                        else if (Z > at) for (var tt = 0; tt < d.size; tt++) L[tt] = -1 * L[tt];
                      },
                      n = function (U) {
                        var B = [],
                          J = new g(),
                      ...
                      if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                        ...
                        (function () {
                              ...
                              var U = l.alignmentConstraint.vertical,
                                B = function (tt) {
                                  ...
                                  var ut = new Set(
                                    ...
                                    Mt = void 0;
                                  (ut.size > 0 ? (Mt = v[d.get(ut.values().next().value)]) : (Mt = Q(j).x),
                                    U[tt].forEach(function (pt) {
                          ...
                          if (l.alignmentConstraint.horizontal) {
                            for (
                              var Z = l.alignmentConstraint.horizontal,
                                at = function (tt) {
                                  var j = new Set();
                        ...
                        if (V < x.size / 2) (rt(l.relativePlacementConstraint), (R = !1), (M = !1));
                        else {
                          var z = new Map(),
                            w = new Map(),
                            H = [];
                          (k[Y].forEach(function (b) {
                            W.get(b).forEach(function (U) {
                              U.direction == "horizontal"
                                ...
                                : (w.has(b) ? w.get(b).push(U) : w.set(b, [U]),
                          ...
                          (k[Y].forEach(function (b, U) {
                            ((y[U] = [v[d.get(b)], L[d.get(b)]]),
                              (E[U] = []),
                              $.has(b) ? (E[U][0] = $.get(b)) : (E[U][0] = v[d.get(b)]),
                              _.has(b) ? (E[U][1] = _.get(b)) : (E[U][1] = L[d.get(b)]));
                          }),
                            (R = !0));
                        }
                      }
                    ...
                    if (i.ENFORCE_CONSTRAINTS) {
                      if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                        var Et = { x: 0, y: 0 };
                        (l.fixedNodeConstraint.forEach(function (b, U) {
                          var B = { x: v[d.get(b.nodeId)], y: L[d.get(b.nodeId)] },
                            J = b.position,
                            Z = X(J, B);
                          ((Et.x += Z.x), (Et.y += Z.y));
                        }),
                          (Et.x /= l.fixedNodeConstraint.length),
                          (Et.y /= l.fixedNodeConstraint.length),
                      ...
                      if (l.alignmentConstraint) {
                        if (l.alignmentConstraint.vertical)
                          for (
                            var Dt = l.alignmentConstraint.vertical,
                              Rt = function (U) {
                                var B = new Set();
                                ...
                                var J = new Set(
                                  ...
                                  Z = void 0;
                                (J.size > 0 ? (Z = v[d.get(J.values().next().value)]) : (Z = Q(B).x),
                            ...
                            var Ut = l.alignmentConstraint.horizontal,
                              Pt = function (U) {
                                ...
                                var J = new Set(
                                  ...
                                  Z = void 0;
                                (J.size > 0 ? (Z = L[d.get(J.values().next().value)]) : (Z = Q(B).y),
                                  B.forEach(function (at) {
                      ...
                      l.relativePlacementConstraint &&
                        (function () {
                          ...
                          if (
                            ...
                            if (l.alignmentConstraint.vertical)
                              for (
                                var tt = l.alignmentConstraint.vertical,
                                  j = function (yt) {
                                    (B.set("dummy" + yt, []),
                                      tt[yt].forEach(function (wt) {
                                        (b.set(wt, "dummy" + yt),
                                          B.get("dummy" + yt).push(wt),
                                          F.has(wt) && ct.add("dummy" + yt));
                                      }),
                            ...
                            if (l.alignmentConstraint.horizontal)
                              for (
                                var Mt = l.alignmentConstraint.horizontal,
                                  pt = function (yt) {
                                    (J.set("dummy" + yt, []),
                                      Mt[yt].forEach(function (wt) {
                                        (U.set(wt, "dummy" + yt),
                                          J.get("dummy" + yt).push(wt),
                                          F.has(wt) && nt.add("dummy" + yt));
                                      }),
                            ...
                            Lt = function (yt) {
                              W.get(yt).forEach(function (wt) {
                                ...
                                wt.direction == "horizontal"
                                  ? ((kt = b.get(yt) ? b.get(yt) : yt),
                                    b.get(wt.id)
                                      ? (Bt = { id: b.get(wt.id), gap: wt.gap, direction: wt.direction })
                                      : (Bt = wt),
                                    lt.has(kt) ? lt.get(kt).push(Bt) : lt.set(kt, [Bt]),
                                    lt.has(Bt.id) || lt.set(Bt.id, []))
                                  : ((kt = U.get(yt) ? U.get(yt) : yt),
                                    U.get(wt.id)
                                      ? (Bt = { id: U.get(wt.id), gap: wt.gap, direction: wt.direction })
                                      : (Bt = wt),
                                    ot.has(kt) ? ot.get(kt).push(Bt) : ot.set(kt, [Bt]),
                          ...
                          var _t = O(lt, "horizontal", ct, Z, Qt),
                            Jt = O(ot, "vertical", nt, at, jt),
                            oe = function (yt) {
                              B.get(yt)
                                ? B.get(yt).forEach(function (wt) {
            ...
            var P = {
                ...
                548: (a, r, e) => {
                  var f = (function () {
                      function t(o, s) {
                        ...
                        try {
                          for (
                            var v = o[Symbol.iterator](), L;
                            !(l = (L = v.next()).done) && (c.push(L.value), !(s && c.length === s));
                            l = !0
                          );
                        } catch (S) {
                          ((T = !0), (d = S));
                      ...
                      var l = new i(),
                        ...
                        Q = function () {
                          ...
                          if (
                            ...
                            d.length == s.length && (C = !0),
                            !C || (C && G > 1))
                          ) {
                            ((L = d[0]),
                              (S = L.connectedEdges().length),
                      ...
                      if (!s.fixedNodeConstraint) {
                        ...
                        if (s.quality == "draft") {
                          ...
                          Object.keys(o).forEach(function (x) {
                            var k = o[x],
                              V = k.getRect().x,
                              Y = k.getRect().x + k.getRect().width,
                              et = k.getRect().y,
                              z = k.getRect().y + k.getRect().height;
                ...
                816: (a, r, e) => {
                  var f = e(548),
                    i = e(140).CoSELayout,
                    g = e(140).CoSENode,
                    t = e(140).layoutBase.PointD,
                    o = e(140).layoutBase.DimensionD,
                    s = e(140).layoutBase.LayoutConstants,
                    c = e(140).layoutBase.FDLayoutConstants,
                    l = e(140).CoSEConstants,
                    T = function (v, L) {
                      var S = v.cy,
                        C = v.eles,
                        G = C.nodes(),
                      ...
                      var n = function (x) {
                        ...
                        p = f.calcParentsWithoutChildren(S, C),
                        E = function W(x, k, V, Y) {
                          for (var et = k.length, z = 0; z < et; z++) {
                            var w = k[z],
                              H = null;
                            w.intersection(p).length == 0 && (H = w.children());
                            var $ = void 0,
                              _ = w.layoutDimensions({ nodeDimensionsIncludeLabels: Y.nodeDimensionsIncludeLabels });
                              ...
                              if (Y.randomize)
                                if (!w.isParent())
                                  $ = x.add(
                                    new g(
                                      V.graphManager,
                                      new t(Q[X.get(w.id())] - _.w / 2, O[X.get(w.id())] - _.h / 2),
                                ...
                                $ = x.add(
                                  new g(
                                    V.graphManager,
                                    new t(w.position("x") - _.w / 2, w.position("y") - _.h / 2),
                                    new o(parseFloat(_.w), parseFloat(_.h))
                                  )
                                );
                            else $ = x.add(new g(this.graphManager));
                            if (
                              (($.id = w.data("id")),
                              ($.nodeRepulsion = m(Y.nodeRepulsion, w)),
                              ($.paddingLeft = parseInt(w.css("padding"))),
                              ...
                              Y.nodeDimensionsIncludeLabels &&
                                (($.labelWidth = w.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).w),
                                ($.labelHeight = w.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).h),
                                ($.labelPosVertical = w.css("text-valign")),
                                ($.labelPosHorizontal = w.css("text-halign"))),
                              (rt[w.data("id")] = $),
                        ...
                        y = function (x, k, V) {
                          ...
                          v.idealEdgeLength != null &&
                            (et > 0
                              ? (l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = Y / et)
                              : n(v.idealEdgeLength)
                                ? (l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = 50)
                                : (l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = v.idealEdgeLength),
                            (l.MIN_REPULSION_DIST = c.MIN_REPULSION_DIST = c.DEFAULT_EDGE_LENGTH / 10),
                            (l.DEFAULT_RADIAL_SEPARATION = c.DEFAULT_EDGE_LENGTH));
                        },
                        R = function (x, k) {
                          (k.fixedNodeConstraint && (x.constraints.fixedNodeConstraint = k.fixedNodeConstraint),
                            k.alignmentConstraint && (x.constraints.alignmentConstraint = k.alignmentConstraint),
                            k.relativePlacementConstraint &&
                              (x.constraints.relativePlacementConstraint = k.relativePlacementConstraint));
                        };
                      (v.nestingFactor != null &&
                        (l.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = c.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = v.nestingFactor),
                        v.gravity != null && (l.DEFAULT_GRAVITY_STRENGTH = c.DEFAULT_GRAVITY_STRENGTH = v.gravity),
                        v.numIter != null && (l.MAX_ITERATIONS = c.MAX_ITERATIONS = v.numIter),
                        v.gravityRange != null &&
                          (l.DEFAULT_GRAVITY_RANGE_FACTOR = c.DEFAULT_GRAVITY_RANGE_FACTOR = v.gravityRange),
                        v.gravityCompound != null &&
                          (l.DEFAULT_COMPOUND_GRAVITY_STRENGTH = c.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                            v.gravityCompound),
                        v.gravityRangeCompound != null &&
                          (l.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = c.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR =
                            v.gravityRangeCompound),
                        v.initialEnergyOnIncremental != null &&
                          (l.DEFAULT_COOLING_FACTOR_INCREMENTAL = c.DEFAULT_COOLING_FACTOR_INCREMENTAL =
                            v.initialEnergyOnIncremental),
                        v.tilingCompareBy != null && (l.TILING_COMPARE_BY = v.tilingCompareBy),
                        ...
                        (l.DEFAULT_INCREMENTAL = c.DEFAULT_INCREMENTAL = s.DEFAULT_INCREMENTAL = !v.randomize),
                        (l.ANIMATE = c.ANIMATE = s.ANIMATE = v.animate),
                        (l.TILE = v.tile),
                        ...
                        (l.DEFAULT_INCREMENTAL = c.DEFAULT_INCREMENTAL = s.DEFAULT_INCREMENTAL = !0),
                        (l.PURE_INCREMENTAL = !v.randomize),
                            ...
                            value: function () {
                              ...
                              if (
                                ...
                                if (p) {
                                  ...
                                  if (
                                    ...
                                    if (C.tile) {
                                      var F = new Map(),
                                        ...
                                        x = [],
                                        k = 0,
                                        V = { nodeIndexes: F, xCoords: W, yCoords: x },
                                        Y = [];
                                      if (
                                        (O.forEach(function (vt, it) {
                                          vt.edges().length == 0 &&
                                            (vt.nodes().forEach(function (gt, mt) {
                                              (M.merge(vt.nodes()[mt]),
                                                gt.isParent() ||
                                                  (V.nodeIndexes.set(vt.nodes()[mt].id(), k++),
                                  ...
                                  C.quality == "default" || C.quality == "proof"
                                    ? (Q.push(l(C, X[0])), t.relocateComponent(rt[0], Q[0], C))
                              ...
                              if (C.quality == "default" || C.quality == "proof" || C.randomize) {
                                var It = t.calcParentsWithoutChildren(G, K),
                                  Nt = K.filter(function (vt) {
                                    return vt.css("display") == "none";
                                  });
                                ((C.eles = K.not(Nt)),
                                  K.nodes().not(":parent").not(Nt).layoutPositions(S, C, q),
                                  It.length > 0 &&
                ...
                657: (a, r, e) => {
                  var f = e(548),
                    i = e(140).layoutBase.Matrix,
                    g = e(140).layoutBase.SVD,
                    t = function (s) {
                      var c = s.cy,
                        l = s.eles,
                        T = l.nodes(),
                        ...
                        x = function (U, B, J) {
                          for (
                            var Z = [], at = 0, ct = 0, nt = 0, tt = void 0, j = [], ut = 0, Mt = 1, pt = 0;
                            pt < m;
                            pt++
                          )
                            j[pt] = p;
                          ...
                          if (J) {
                            for (var ot = 0; ot < m; ot++) O[ot][B] < Q[ot] && (Q[ot] = O[ot][B]);
                            for (var Lt = 0; Lt < m; Lt++) Q[Lt] > ut && ((ut = Q[Lt]), (Mt = Lt));
                          }
                          return Mt;
                        },
                        k = function (U) {
                          ...
                          if (U) {
                            ...
                            for (var Z = 0; Z < m; Z++) Q[Z] = p;
                            for (var at = 0; at < F; at++) ((X[at] = B), (B = x(B, at, U)));
                          } else {
                            W();
                            for (var J = 0; J < F; J++) x(X[J], J, U);
                          }
                        ...
                        V = function () {
                          for (
                            var U = g.svd(rt), B = U.S, J = U.U, Z = U.V, at = B[0] * B[0] * B[0], ct = [], nt = 0;
                            nt < F;
                            nt++
                          ) {
                            ct[nt] = [];
                        ...
                        Y = function () {
                          ...
                          for (var tt = E, j = E, ut = void 0; ; ) {
                            for (var Mt = 0; Mt < m; Mt++) at[Mt] = J[Mt];
                            if (
                          ...
                          for (j = E; ; ) {
                            for (var xt = 0; xt < m; xt++) ct[xt] = Z[xt];
                            if (
                      ...
                      for (var It = 0; It < L.size; It++) C[It] = [];
                      (d.forEach(function (b) {
                        ...
                        T.forEach(function (b) {
                          var U = void 0;
                          (b.isParent() ? (U = L.get(S.get(b.id()))) : (U = L.get(b.id())),
                            b
                              .neighborhood()
                              .nodes()
                              .forEach(function (B) {
                                l.intersection(b.edgesWith(B)).length > 0 &&
                                  (B.isParent() ? C[U].push(S.get(B.id())) : C[U].push(B.id()));
                              }));
                        }));
                      var Nt = function (U) {
                          var B = L.get(U),
                          ...
                          v.get(U).forEach(function (Z) {
                            (c.getElementById(Z).isParent() ? (J = S.get(Z)) : (J = Z),
                              C[B].push(J),
                              C[L.get(J)].push(U));
                          });
                        },
                      ...
                      if (m > 2) {
                        ...
                        return (
                          s.quality == "draft" || s.step == "all"
                            ? (k(R), V(), Y(), (Et = { nodeIndexes: L, xCoords: G, yCoords: K }))
                            : (L.forEach(function (b, U) {
...
var xe = { L: "left", R: "right", T: "top", B: "bottom" },
  Ie = {
    L: dt((I) => `${I},${I / 2} 0,${I} 0,0`, "L"),
    R: dt((I) => `0,${I / 2} ${I},0 ${I},${I}`, "R"),
    T: dt((I) => `0,0 ${I},0 ${I / 2},${I}`, "T"),
    B: dt((I) => `${I / 2},0 ${I},${I} 0,${I}`, "B"),
  },
  se = {
    L: dt((I, D) => I - D + 2, "L"),
    R: dt((I, D) => I - 2, "R"),
  ...
  be = dt((I) => I.data(), "edgeData"),
  ie = dt((I) => I.data(), "nodeData"),
  Dr = rr.architecture,
  ae,
  Pe =
    ((ae = class {
      ...
      addService({ id: D, icon: A, in: P, title: N, iconText: u }) {
        if (this.registeredIds[D] !== void 0)
          throw new Error(`The service id [${D}] is already in use by another ${this.registeredIds[D]}`);
        if (P !== void 0) {
          if (D === P) throw new Error(`The service [${D}] cannot be placed within itself`);
          ...
          if (this.registeredIds[P] === "node") throw new Error(`The service [${D}]'s parent is not a group`);
        }
        ((this.registeredIds[D] = "node"),
          (this.nodes[D] = { id: D, type: "service", icon: A, iconText: u, title: N, edges: [], in: P }));
      }
      getServices() {
        return Object.values(this.nodes).filter(wr);
      }
      addJunction({ id: D, in: A }) {
        ((this.registeredIds[D] = "node"), (this.nodes[D] = { id: D, type: "junction", edges: [], in: A }));
      }
      getJunctions() {
      ...
      addGroup({ id: D, icon: A, in: P, title: N }) {
        ...
        if (((u = this.registeredIds) == null ? void 0 : u[D]) !== void 0)
          throw new Error(`The group id [${D}] is already in use by another ${this.registeredIds[D]}`);
        if (P !== void 0) {
          if (D === P) throw new Error(`The group [${D}] cannot be placed within itself`);
        ...
        ((this.registeredIds[D] = "group"), (this.groups[D] = { id: D, icon: A, title: N, in: P }));
      }
      getGroups() {
      ...
      addEdge({
        ...
        (this.edges.push(g),
          this.nodes[D] &&
            this.nodes[A] &&
            (this.nodes[D].edges.push(this.edges[this.edges.length - 1]),
        ...
        if (this.dataStructures === void 0) {
          const D = {},
            A = Object.entries(this.nodes).reduce(
              (r, [e, f]) => (
                (r[e] = f.edges.reduce((i, g) => {
                  var s, c;
                  const t = (s = this.getNode(g.lhsId)) == null ? void 0 : s.in,
                    o = (c = this.getNode(g.rhsId)) == null ? void 0 : c.in;
                  if (t && o && t !== o) {
                    const l = Mr(g.lhsDir, g.rhsDir);
                    l !== "bend" && (D[t] ?? (D[t] = {}), (D[t][o] = l), D[o] ?? (D[o] = {}), (D[o][t] = l));
                  }
                  if (g.lhsId === e) {
                    const l = ye(g.lhsDir, g.rhsDir);
                    l && (i[l] = g.rhsId);
                  } else {
                    const l = ye(g.rhsDir, g.lhsDir);
                    l && (i[l] = g.lhsId);
                  }
                  return i;
                }, {})),
            ...
            P = Object.keys(A)[0],
            N = { [P]: 1 },
            u = Object.keys(A).reduce((r, e) => (e === P ? r : { ...r, [e]: 1 }), {}),
            h = dt((r) => {
              const e = { [r]: [0, 0] },
                f = [r];
              for (; f.length > 0; ) {
            ...
            a = [h(P)];
          for (; Object.keys(u).length > 0; ) a.push(h(Object.keys(u)[0]));
          this.dataStructures = { adjList: A, spatialMaps: a, groupAlignments: D };
        }
  ...
  xr = dt((I, D) => {
    (lr(I, D),
      I.groups.map((A) => D.addGroup(A)),
      I.services.map((A) => D.addService({ ...A, type: "service" })),
      I.junctions.map((A) => D.addJunction({ ...A, type: "junction" })),
      I.edges.map((A) => D.addEdge(A)));
  }, "populateDb"),
  Ge = {
    parser: { yy: void 0 },
    parse: dt(async (I) => {
...
`,
  ...
  Rr = Ir,
  re = dt((I) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${I}</g>`, "wrapIcon"),
  ne = {
  ...
  Sr = dt(async function (I, D, A) {
    const P = A.getConfigField("padding"),
      N = A.getConfigField("iconSize"),
      u = N / 2,
      h = N / 6,
      a = h / 2;
    await Promise.all(
      D.edges().map(async (r) => {
        ...
        const G = P + 4;
        if (
          (g && (Wt(f) ? (T += f === "L" ? -G : G) : (d += f === "T" ? -G : G + 18)),
          c && (Wt(o) ? (S += o === "L" ? -G : G) : (C += o === "T" ? -G : G + 18)),
          !g &&
            ((K = A.getNode(e)) == null ? void 0 : K.type) === "junction" &&
            (Wt(f) ? (T += f === "L" ? u : -u) : (d += f === "T" ? u : -u)),
          !c &&
          ...
          if (
            (Q.insert("path")
              .attr("d", `M ${T},${d} L ${v},${L} L${S},${C} `)
              .attr("class", "edge")
              .attr("id", or(e, t, { prefix: "L" })),
            i)
          ) {
            const O = Wt(f) ? se[f](T, h) : T - a,
              rt = qt(f) ? se[f](d, h) : d - a;
            Q.insert("polygon")
              .attr("points", Ie[f](h))
          ...
          if (s) {
            const O = Wt(o) ? se[o](S, h) : S - a,
              rt = qt(o) ? se[o](C, h) : C - a;
            Q.insert("polygon")
              .attr("points", Ie[o](h))
              .attr("transform", `translate(${O},${rt})`)
              .attr("class", "arrow");
          ...
          if (l) {
            ...
            const n = Q.append("g");
            if (
              (await me(n, l, { useHtmlLabels: !1, width: rt, classes: "architecture-service-label" }, Ee()),
              n
                .attr("dy", "1em")
            ...
            else if (O === "Y") n.attr("transform", "translate(" + v + ", " + L + ") rotate(-90)");
            else if (O === "XY") {
              const m = ye(f, o);
              if (m && Nr(m)) {
  ...
  Fr = dt(async function (I, D, A) {
    const N = A.getConfigField("padding") * 0.75,
    ...
    await Promise.all(
      D.nodes().map(async (r) => {
        const e = ie(r);
        if (e.type === "group") {
          const { h: f, w: i, x1: g, y1: t } = r.boundingBox(),
            o = I.append("rect");
          o.attr("id", `group-${e.id}`)
            .attr("x", g + a)
            .attr("y", t + a)
            .attr("width", i)
            .attr("height", f)
          ...
          if (e.icon) {
            const T = s.append("g");
            (T.html(`<g>${await pe(e.icon, { height: N, width: N, fallbackPrefix: ne.prefix })}</g>`),
              T.attr("transform", "translate(" + (c + a + 1) + ", " + (l + a + 1) + ")"),
              (c += N),
              (l += u / 2 - 1 - 2));
          }
          if (e.label) {
            const T = s.append("g");
            (await me(T, e.label, { useHtmlLabels: !1, width: i, classes: "architecture-service-label" }, Ee()),
              T.attr("dy", "1em")
                .attr("alignment-baseline", "middle")
                .attr("dominant-baseline", "start")
                .attr("text-anchor", "start"),
              T.attr("transform", "translate(" + (c + a + 4) + ", " + (l + a + 2) + ")"));
          }
  ...
  br = dt(async function (I, D, A) {
    const P = Ee();
    for (const N of A) {
      const u = D.append("g"),
        h = I.getConfigField("iconSize");
      if (N.title) {
        const f = u.append("g");
        (await me(f, N.title, { useHtmlLabels: !1, width: h * 1.5, classes: "architecture-service-label" }, P),
          f
            .attr("dy", "1em")
            .attr("alignment-baseline", "middle")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle"),
          f.attr("transform", "translate(" + h / 2 + ", " + h + ")"));
      }
      const a = u.append("g");
      if (N.icon) a.html(`<g>${await pe(N.icon, { height: h, width: h, fallbackPrefix: ne.prefix })}</g>`);
      else if (N.iconText) {
        a.html(`<g>${await pe("blank", { height: h, width: h, fallbackPrefix: ne.prefix })}</g>`);
        const g = a
            .append("g")
            ...
            .append("div")
            .html(ar(N.iconText, P)),
          t = parseInt(window.getComputedStyle(g.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
        g.attr("style", `-webkit-line-clamp: ${Math.floor((h - 2) / t)};`);
      } else
        a.append("path")
          .attr("class", "node-bkg")
          .attr("id", "node-" + N.id)
          .attr("d", `M0 ${h} v${-h} q0,-5 5,-5 h${h} q5,0 5,5 v${h} H0 Z`);
  ...
  Pr = dt(function (I, D, A) {
    A.forEach((P) => {
      const N = D.append("g"),
        u = I.getConfigField("iconSize");
      (N.append("g")
        .append("rect")
        .attr("id", "node-" + P.id)
        .attr("fill-opacity", "0")
...
function We(I, D) {
  I.forEach((A) => {
    const { lhsId: P, rhsId: N, lhsInto: u, lhsGroup: h, rhsInto: a, lhsDir: r, rhsDir: e, rhsGroup: f, title: i } = A,
      g = Te(A.lhsDir, A.rhsDir) ? "segments" : "straight",
      t = {
        id: `${P}-${N}`,
        label: i,
        source: P,
    ...
    D.add({ group: "edges", data: t, classes: g });
  });
}
dt(We, "addEdges");
function Ve(I, D, A) {
  const P = dt(
      (a, r) =>
        Object.entries(a).reduce((e, [f, i]) => {
          var o;
          let g = 0;
          const t = Object.entries(i);
          if (t.length === 1) return ((e[f] = t[0][1]), e);
          for (let s = 0; s < t.length - 1; s++)
            for (let c = s + 1; c < t.length; c++) {
              const [l, T] = t[s],
                [d, v] = t[c];
              if (((o = A[l]) == null ? void 0 : o[d]) === r) (e[f] ?? (e[f] = []), (e[f] = [...e[f], ...T, ...v]));
              else if (l === "default" || d === "default") (e[f] ?? (e[f] = []), (e[f] = [...e[f], ...T, ...v]));
              else {
                const S = `${f}-${g++}`;
                e[S] = T;
                const C = `${f}-${g++}`;
    ...
    N = D.map((a) => {
      const r = {},
        e = {};
      return (
        Object.entries(a).forEach(([f, [i, g]]) => {
          var o, s, c;
        ...
        {
          horiz: Object.values(P(r, "horizontal")).filter((f) => f.length > 1),
          vert: Object.values(P(e, "vertical")).filter((f) => f.length > 1),
        }
      );
    }),
    [u, h] = N.reduce(
...
function ze(I, D) {
  const A = [],
    ...
    N = dt((u) => u.split(",").map((h) => parseInt(h)), "strToPos");
  return (
    I.forEach((u) => {
      const h = Object.fromEntries(Object.entries(u).map(([f, i]) => [P(i), f])),
        a = [P([0, 0])],
        r = {},
        e = { L: [-1, 0], R: [1, 0], T: [0, 1], B: [0, -1] };
      for (; a.length > 0; ) {
        const f = a.shift();
        if (f) {
          r[f] = 1;
          ...
          if (i) {
            ...
            Object.entries(e).forEach(([t, o]) => {
              ...
              c &&
                !r[s] &&
                (a.push(s), A.push({ [xe[t]]: c, [xe[Tr(t)]]: i, gap: 1.5 * D.getConfigField("iconSize") }));
            });
          }
        }
      }
...
function $e(I, D, A, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const r = nr("body").append("div").attr("id", "cy").attr("style", "display:none"),
      e = Fe({
        ...
        style: [
          ...
          { selector: ".node-group", style: { padding: `${N.getConfigField("padding")}px` } },
        ],
    ...
    (g.one("layoutstop", () => {
      ...
      function t(s, c, l, T) {
        ...
        const { x: L, y: S } = s,
          { x: C, y: G } = c;
        ((v = (T - S + ((L - l) * (S - G)) / (L - C)) / Math.sqrt(1 + Math.pow((S - G) / (L - C), 2))),
          (d = Math.sqrt(Math.pow(T - S, 2) + Math.pow(l - L, 2) - Math.pow(v, 2))));
        ...
        return ((v = Math.abs(v) * X), (d = d * Q), { distances: v, weights: d });
      }
      (dt(t, "getSegmentWeights"), e.startBatch());
      for (const s of Object.values(e.edges()))
        if ((o = s.data) != null && o.call(s)) {
          const { x: c, y: l } = s.source().position(),
            { x: T, y: d } = s.target().position();
          if (c !== T && l !== d) {
            const v = s.sourceEndpoint(),
              L = s.targetEndpoint(),
              { sourceDir: S } = be(s),
              [C, G] = qt(S) ? [v.x, L.y] : [L.x, v.y],
              { weights: K, distances: X } = t(v, L, C, G);
...
var Gr = dt(async (I, D, A, P) => {
    const N = P.db,
      u = N.getServices(),
      h = N.getJunctions(),
      a = N.getGroups(),
      r = N.getEdges(),
      e = N.getDataStructures(),
      f = Ze(D),
      i = f.append("g");
    ...
    (await Sr(i, o, N),
      await Fr(t, o, N),
      Xe(N, o),
      ke(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth")));
  }, "draw"),
  Ur = { draw: Gr },
  Zr = {
    parser: Ge,
