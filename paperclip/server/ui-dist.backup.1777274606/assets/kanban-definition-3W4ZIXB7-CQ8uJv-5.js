...
import { g as Ne } from "./chunk-FMBD7UC4-BPzB7Csq.js";
  ...
  var t = c(function (_, s, n, a) {
    ...
    V = {
      ...
      table: [
        ...
        { 1: [2, 1] },
        { 4: 6, 6: [1, 7], 7: [1, 8], 8: g },
        { 6: d, 7: [1, 10], 9: 9, 12: 11, 13: r, 14: 14, 16: p, 17: E, 18: 17, 19: 18, 20: f, 23: h },
        t(L, [2, 3]),
        { 1: [2, 2] },
        t(L, [2, 4]),
        t(L, [2, 5]),
        { 1: [2, 6], 6: d, 12: 21, 13: r, 14: 14, 16: p, 17: E, 18: 17, 19: 18, 20: f, 23: h },
        { 6: d, 9: 22, 12: 11, 13: r, 14: 14, 16: p, 17: E, 18: 17, 19: 18, 20: f, 23: h },
        { 6: C, 7: w, 10: 23, 11: N },
        ...
        { 21: [1, 33] },
        { 6: C, 7: w, 10: 34, 11: N },
        { 1: [2, 7], 6: d, 12: 21, 13: r, 14: 14, 16: p, 17: E, 18: 17, 19: 18, 20: f, 23: h },
        t(P, [2, 14], { 7: M, 11: U }),
        t(A, [2, 8]),
        t(A, [2, 9]),
        t(A, [2, 10]),
      ...
      parse: c(function (s) {
        ...
        c(ae, "lex");
        for (var k, R, v, Q, G = {}, K, I, oe, X; ; ) {
          if (
            ((R = a[a.length - 1]),
            this.defaultActions[R]
              ? (v = this.defaultActions[R])
              : ((k === null || typeof k > "u") && (k = ae()), (v = B[R] && B[R][k])),
            typeof v > "u" || !v.length || !v[0])
          ) {
            var Z = "";
            X = [];
            for (K in B[R]) this.terminals_[K] && K > ue && X.push("'" + this.terminals_[K] + "'");
            (b.showPosition
              ? (Z =
                  "Parse error on line " +
                  (z + 1) +
...
Expecting ` +
              ...
              : (Z =
                  ...
                  (z + 1) +
                  ": Unexpected " +
                  (k == re ? "end of input" : "'" + (this.terminals_[k] || k) + "'")),
              this.parseError(Z, {
                text: b.match,
          ...
          switch (v[0]) {
            ...
            case 2:
              if (
                ...
                de && (G._$.range = [e[e.length - (I || 1)].range[0], e[e.length - 1].range[1]]),
                (Q = this.performAction.apply(G, [l, ie, z, T.yy, v[1], u, e].concat(ge))),
                typeof Q < "u")
              )
                return Q;
...
` +
  ...
  y = { DEFAULT: 0, NO_BORDER: 0, ROUNDED_RECT: 1, RECT: 2, CIRCLE: 3, CLOUD: 4, BANG: 5, HEXAGON: 6 },
  Ie = c((t, g) => {
...
` + t
    ...
    const C = h.append("g");
    C.attr("class", "items");
    const w = E.nodes.filter((m) => m.isGroup);
    let N = 0;
    const i = 10,
      j = [];
    let x = 25;
    for (const m of w) {
      ...
      ((N = N + 1),
        ...
        (m.rx = 5),
        (m.ry = 5),
        (m.cssClasses = m.cssClasses + " section-" + N));
...
`,
  ...
  Me = je,
  ze = { db: Ve, renderer: Ge, parser: xe, styles: Me };
