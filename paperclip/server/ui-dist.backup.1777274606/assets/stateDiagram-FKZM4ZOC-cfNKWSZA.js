import { s as R, a as W, S as N } from "./chunk-DI55MBZ5-Bdxn9i0H.js";
import {
  _ as f,
  c as t,
  d as H,
...
import { G as O } from "./graph-C_2AnXgs.js";
import { l as J } from "./layout-DSmWHSvD.js";
import "./chunk-55IACEB6-coqV5UWO.js";
import "./chunk-QN33PNHL-DmZbeWJQ.js";
...
var X = f(
  ...
  I = f((e, i) => {
    ...
    const w = e
      ...
      p = x.node().getBBox(),
      o = Math.max(p.width, n.width);
    return (
      w.attr("x2", o + 3 * t().state.padding),
      e
        .insert("rect", ":first-child")
        .attr("x", t().state.padding)
        .attr("y", t().state.padding)
        .attr("width", o + 2 * t().state.padding)
        .attr("height", p.height + l + 2 * t().state.padding)
        .attr("rx", t().state.radius),
      e
    );
  }, "drawDescrState"),
  ...
  Q = f(function (e, i, d) {
    ...
    if (
      ...
      x.attr("marker-end", "url(" + a + "#" + c(N.relationType.DEPENDENCY) + "End)"),
      d.title !== void 0)
    ) {
      const s = e.append("g").attr("class", "stateLabel"),
        { x: w, y: p } = F.calcLabelPosition(i.points),
        o = z.getRows(d.title);
      let g = 0;
      const B = [];
      let m = 0,
      ...
      for (let u = 0; u <= o.length; u++) {
        ...
        ((m = Math.max(m, y.width)),
          (E = Math.min(E, y.x)),
          S.info(y.x, w, p + g),
          g === 0 && ((g = h.node().getBBox().height), S.info("Title height", g, p)),
          B.push(h));
      }
      let k = g * o.length;
      if (o.length > 1) {
      ...
      (s
        .insert("rect", ":first-child")
        .attr("class", "box")
        .attr("x", w - m / 2 - t().state.padding / 2)
        .attr("y", p - k / 2 - t().state.padding / 2 - 3.5)
        .attr("width", m + t().state.padding)
  ...
  et = f(function (e, i, d, c) {
    ...
    let l;
    n === "sandbox" && (l = H("#i" + i));
    const x = n === "sandbox" ? H(l.nodes()[0].contentDocument.body) : H("body"),
    ...
    const p = b.padding,
      ...
      B = o.height + p * 2,
      m = g * 1.75;
    (P(s, B, m, b.useMaxWidth), s.attr("viewBox", `${o.x - b.padding}  ${o.y - b.padding} ` + g + " " + B));
  }, "draw"),
    ...
    for (const r of g) {
      ...
      if (u.note) {
        ...
        (u.note.position === "left of"
          ? (a.setNode(h.id + "-note", v), a.setNode(h.id, h))
          : (a.setNode(h.id, h), a.setNode(h.id + "-note", v)),
