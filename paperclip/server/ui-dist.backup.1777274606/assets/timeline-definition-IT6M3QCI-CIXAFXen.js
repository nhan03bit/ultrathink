...
import { d as nt } from "./arc-COk5UT4S.js";
import "./index-ChLuXRS1.js";
var X = (function () {
  var n = s(function (f, r, a, h) {
    ...
    p = {
      ...
      performAction: s(function (r, a, h, u, y, o, S) {
        var k = o.length - 1;
        switch (y) {
          case 1:
            return o[k - 1];
      ...
      parse: s(function (r) {
        ...
        function A() {
          ...
          return (
            (T = u.pop() || v.lex() || J),
            typeof T != "number" && (T instanceof Array && ((u = T), (T = u.pop())), (T = a.symbols_[T] || T)),
            T
          );
        }
        s(A, "lex");
        for (var w, H, I, K, F = {}, j, P, et, G; ; ) {
          if (
            ((H = h[h.length - 1]),
            this.defaultActions[H]
              ? (I = this.defaultActions[H])
              : ((w === null || typeof w > "u") && (w = A()), (I = S[H] && S[H][w])),
...
Expecting ` +
              ...
              : (Q =
                  ...
                  (M + 1) +
                  ": Unexpected " +
                  (w == J ? "end of input" : "'" + (this.terminals_[w] || w) + "'")),
              this.parseError(Q, {
                text: v.match,
          ...
          switch (I[0]) {
            ...
            case 2:
              if (
                ...
                $ && (F._$.range = [o[o.length - (P || 1)].range[0], o[o.length - 1].range[1]]),
                (K = this.performAction.apply(F, [k, C, M, N.yy, I[1], y, o].concat(O))),
                typeof K < "u")
              )
                return K;
              (P && ((h = h.slice(0, -1 * P * 2)), (y = y.slice(0, -1 * P)), (o = o.slice(0, -1 * P))),
                h.push(this.productions_[I[1]][0]),
                y.push(F.$),
                o.push(F._$),
                (et = S[h[h.length - 2]][h[h.length - 1]]),
                h.push(et));
              break;
            case 3:
              return !0;
...
` +
        ...
        next: s(function () {
          ...
          for (var y = this._currentRules(), o = 0; o < y.length; o++)
            if (((h = this._input.match(this.rules[y[o]])), h && (!a || h[0].length > a[0].length))) {
              if (((a = h), (u = o), this.options.backtrack_lexer)) {
                if (((r = this.test_match(h, y[o])), r !== !1)) return r;
                if (this._backtrack) {
                  a = !1;
                  continue;
                } else return !1;
          ...
          return a
            ? ((r = this.test_match(a, y[u])), r !== !1 ? r : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: s(function (a) {
          return ((a = this.conditionStack.length - 1 - Math.abs(a || 0)), a >= 0 ? this.conditionStack[a] : "INITIAL");
        }, "topState"),
        pushState: s(function (a) {
          this.begin(a);
        }, "pushState"),
        ...
        performAction: s(function (a, h, u, y) {
          switch (u) {
            case 0:
              break;
            case 1:
...
var V = "",
  ...
  mt = (function () {
    ...
    function t(i, d, c, g, m, p, x, _, f) {
      const { taskFontSize: r, taskFontFamily: a } = _,
        h = i.split(/<br\s*\/?>/gi);
      for (let u = 0; u < h.length; u++) {
        const y = u * r - (r * (h.length - 1)) / 2,
          o = d
            .append("text")
            .attr("x", c + m / 2)
            .attr("y", g)
...
var zt = s(function (n, t, e, l) {
  ...
  Vt = s(function (n, t, e) {
    (n
      ...
      .attr("d", `M0 ${t.height - 5} v${-t.height + 10} q0,-5 5,-5 h${t.width - 10} q5,0 5,5 v${t.height - 5} H0 Z`),
      n
        .append("line")
  ...
  Wt = s(function (n, t, e, l) {
    var O, v, N;
    const i = xt(),
      d = ((O = i.timeline) == null ? void 0 : O.leftMargin) ?? 50;
    ...
    (E.debug("task", x), z.initGraphics(p));
    ...
    f.forEach(function (L) {
      const b = { number: S, descr: L, section: S, width: 150, padding: 20, maxHeight: r },
        $ = z.getVirtualNodeHeight(p, b, i);
    ...
    for (const [L, b] of x.entries()) {
      const $ = { number: L, descr: b, section: b.section, width: 150, padding: 20, maxHeight: a },
        R = z.getVirtualNodeHeight(p, $, i);
      (E.debug("taskHeight before draw", R), (a = Math.max(a, R + 20)), (M = Math.max(M, b.events.length)));
      let A = 0;
      for (const w of b.events) {
        const H = { descr: w, section: b.section, number: b.section, width: 150, padding: 20, maxHeight: 50 };
        A += z.getVirtualNodeHeight(p, H, i);
      }
      (b.events.length > 0 && (A += (b.events.length - 1) * 10), (C = Math.max(C, A)));
    }
    (E.debug("maxSectionHeight before draw", r),
      E.debug("maxTaskHeight before draw", a),
      f && f.length > 0
        ? f.forEach((L) => {
            ...
            (E.debug("sectionNode output", A),
              R.attr("transform", `translate(${y}, ${u})`),
              (o += r + 50),
              b.length > 0 && st(p, b, S, y, o, a, i, M, C, r, !1),
              (y += 200 * Math.max(b.length, 1)),
              (o = u),
              S++);
          })
        : ((k = !1), st(p, x, S, y, o, a, i, M, C, r, !0)));
  ...
  st = s(function (n, t, e, l, i, d, c, g, m, p, x) {
    var _;
    for (const f of t) {
      const r = { descr: f.task, section: e, number: e, width: 150, padding: 20, maxHeight: d };
      E.debug("taskNode", r);
      const a = n.append("g").attr("class", "taskWrapper"),
        u = z.drawNode(a, r, e, c).height;
      if (
        (E.debug("taskHeight after draw", u),
  ...
  Bt = s(function (n, t, e, l, i, d) {
    ...
    for (const m of t) {
      ...
      const x = n.append("g").attr("class", "eventWrapper"),
        f = z.drawNode(x, p, e, d).height;
      ((c = c + f), x.attr("transform", `translate(${l}, ${i})`), (i = i + 10 + f));
    }
    return ((i = g), c);
  }, "drawEvents"),
  Ot = { setConf: s(() => {}, "setConf"), draw: Wt },
  jt = s((n) => {
    let t = "";
    for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
      ((n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e]),
        vt(n["lineColor" + e])
          ...
          : (n["lineColor" + e] = bt(n["lineColor" + e], 20)));
    for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
      const l = "" + (17 - 3 * e);
      t += `
