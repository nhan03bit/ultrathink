...
import { K as ae } from "./index-ChLuXRS1.js";
import { b as Gn, t as He, c as jn, a as Qn, l as Jn } from "./linear-BnV7KfkX.js";
import { i as Kn } from "./init-Gi6I4Gst.js";
...
function ln(t, e) {
  var n = [],
    ...
    L = t === Xt || t === Te ? rr : ir;
  function _(S) {
    var Z = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()),
      A = i ?? (e.tickFormat ? e.tickFormat.apply(e, n) : nr),
      U = Math.max(a, 0) + m,
      I = e.range(),
      N = +I[0] + Y,
      W = +I[I.length - 1] + Y,
      q = (e.bandwidth ? ar : sr)(e.copy(), Y),
      j = S.selection ? S.selection() : S,
      p = j.selectAll(".domain").data([null]),
      g = j.selectAll(".tick").data(Z, e).order(),
      y = g.exit(),
      h = g.enter().append("g").attr("class", "tick"),
      D = g.select("line"),
      w = g.select("text");
    ((p = p.merge(p.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor"))),
      ...
      (w = w.merge(
        h
          ...
          .attr(k, C * U)
          .attr("dy", t === Xt ? "0em" : t === Te ? "0.71em" : "0.32em")
      )),
      S !== j &&
        ((p = p.transition(S)),
        (g = g.transition(S)),
      ...
      p.attr(
        ...
        t === Bt || t === ue
          ? c
            ? "M" + C * c + "," + N + "H" + Y + "V" + W + "H" + C * c
            : "M" + Y + "," + N + "V" + W
          : c
            ? "M" + N + "," + C * c + "V" + Y + "H" + W + "V" + C * c
            : "M" + N + "," + Y + "H" + W
      ),
      g.attr("opacity", 1).attr("transform", function (T) {
        return L(q(T) + Y);
      }),
      D.attr(k + "2", C * a),
      w.attr(k, C * U).text(A),
      j
        ...
        .attr("text-anchor", t === ue ? "start" : t === Bt ? "end" : "middle"),
      j.each(function () {
        this.__axis = q;
      }));
  }
...
function yn(t) {
  ...
  var e = he(t.r),
    n = he(t.g),
    r = he(t.b),
    i = le((0.2225045 * e + 0.7168786 * n + 0.0606169 * r) / dn),
    a,
    c;
  return (
    e === n && n === r
      ? (a = c = i)
      : ((a = le((0.4360747 * e + 0.3850649 * n + 0.1430804 * r) / fn)),
        (c = le((0.0139322 * e + 0.0971045 * n + 0.7141733 * r) / hn))),
    new ft(116 * i - 16, 500 * (a - i), 200 * (i - c), t.opacity)
  );
}
function hr(t, e, n, r) {
...
function mr(t) {
  ...
  if ((t instanceof ft || (t = yn(t)), t.a === 0 && t.b === 0))
...
function et(t, e, n, r) {
  ...
  return (
    (i.floor = (a) => (t((a = new Date(+a))), a)),
    (i.ceil = (a) => (t((a = new Date(a - 1))), e(a, 1), t(a), a)),
    (i.round = (a) => {
      const c = i(a),
        m = i.ceil(a);
      return a - c < m - a ? c : m;
    }),
    (i.offset = (a, c) => (e((a = new Date(+a)), c == null ? 1 : Math.floor(c)), a)),
    (i.range = (a, c, m) => {
      const Y = [];
      if (((a = i.ceil(a)), (m = m == null ? 1 : Math.floor(m)), !(a < c) || !(m > 0))) return Y;
      let C;
      do (Y.push((C = new Date(+a))), e(a, m), t(a));
      while (C < a && a < c);
      return Y;
    }),
    (i.filter = (a) =>
      et(
        ...
        (c, m) => {
          if (c >= c)
            if (m < 0) for (; ++m <= 0; ) for (; e(c, -1), !a(c); );
            else for (; --m >= 0; ) for (; e(c, 1), !a(c); );
        }
      )),
    n &&
      ((i.count = (a, c) => (me.setTime(+a), ge.setTime(+c), t(me), t(ge), Math.floor(n(me, ge)))),
      (i.every = (a) => (
        (a = Math.floor(a)),
        !isFinite(a) || !(a > 0)
          ? null
          : a > 1
            ? i.filter(r ? (c) => r(c) % a === 0 : (c) => i.count(0, c) % a === 0)
            : i
      ))),
    i
  );
...
function Cr(t, e, n, r, i, a) {
  ...
  function m(C, k, L) {
    const _ = k < C;
    _ && ([C, k] = [k, C]);
    const S = L && typeof L.range == "function" ? L : Y(C, k, L),
      Z = S ? S.range(C, +k + 1) : [];
    return _ ? Z.reverse() : Z;
  }
  function Y(C, k, L) {
    const _ = Math.abs(k - C) / L,
      S = Gn(([, , U]) => U).right(c, _);
...
function Fr(t) {
  ...
  function p(M, H) {
    return function (V) {
      var l = [],
        ...
        it,
        at;
      for (V instanceof Date || (V = new Date(+V)); ++J < Q; )
        M.charCodeAt(J) === 37 &&
          (l.push(M.slice($, J)),
          (it = Ve[(G = M.charAt(++J))]) != null ? (G = M.charAt(++J)) : (it = G === "e" ? " " : "0"),
          (at = H[G]) && (G = at(V, it)),
          l.push(G),
          ($ = J + 1));
    ...
    return function (V) {
      ...
      if (
        ...
        ("W" in l || "U" in l) &&
          ...
          (Q = "Z" in l ? pe(Lt(l.y, 0, 1)).getUTCDay() : ke(Lt(l.y, 0, 1)).getDay()),
          (l.m = 0),
  ...
  function y(M, H, V, l) {
    for (var J = 0, $ = H.length, Q = V.length, G, it; J < $; ) {
      ...
      } else if (G != V.charCodeAt(l++)) return -1;
    }
    return l;
  }
  function h(M, H, V) {
...
function Sn(t, e, n, r, i, a, c, m, Y, C) {
  ...
  function j(p) {
    return (
      Y(p) < p ? S : m(p) < p ? Z : c(p) < p ? A : a(p) < p ? U : r(p) < p ? (i(p) < p ? I : N) : n(p) < p ? W : q
    )(p);
  }
  return (
    (k.invert = function (p) {
...
function Ei() {
  return Kn.apply(
    Sn(Sr, _r, kt, Nt, Pt, bt, Ot, $t, vt, re).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments
  );
}
var Gt = { exports: {} },
              ...
              (m.isoWeek = function (C) {
                ...
                var k,
                  ...
                  A =
                    ((k = this.isoWeekYear()),
                    (L = this.$u),
                    (_ = (L ? a.utc : a)().year(k).startOf("year")),
                    (S = 4 - _.isoWeekday()),
                    _.isoWeekday() > 4 && (S += 7),
                    _.add(S, n));
      ...
      (function (t, e) {
        (function (n, r) {
              ...
              Do: [
                ...
                function (U) {
                  var I = Y.ordinal,
                    N = U.match(/\d+/);
                  if (((this.day = N[0]), I))
                    for (var W = 1; W <= 31; W += 1) I(W).replace(/\[|\]/g, "") === U && (this.day = W);
                },
              ],
              w: [c, k("week")],
              ww: [a, k("week")],
          ...
          function A(U) {
            ...
            ((I = U), (N = Y && Y.formats));
            for (
              var W = (U = I.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function (D, w, T) {
                  var v = T && T.toUpperCase();
                  return (
                    w ||
                    N[T] ||
                    n[T] ||
                    N[v].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function (u, f, b) {
                      return f || b.slice(1);
                    })
                  );
                })).match(r),
            ...
            W.parse = function (j) {
              ...
              if (typeof h == "string") {
                ...
                (w && (v = y[2]),
                  ...
                  (this.$d = (function (x, F, o, X) {
                    try {
                      ...
                      var Q,
                        ...
                        pt = st || 0;
                      return M
                        ? new Date(Date.UTC(J, $, l, G, it, at, pt + 60 * M.offset * 1e3))
                        : o
                          ? new Date(Date.UTC(J, $, l, G, it, at, pt))
                          : ((Q = new Date(J, $, l, G, it, at, pt)), H && (Q = X(Q).week(H).toDate()), Q);
                    } catch {
                      return new Date("");
                    }
                  })(p, h, g, N)),
                  ...
                  T && p != this.format(h) && (this.$d = new Date("")),
                  (Y = {}));
              } else if (h instanceof Array)
                for (var u = h.length, f = 1; f <= u; f += 1) {
                  y[1] = h[f - 1];
        ...
        (function (n, r) {
          ...
          return function (n, r) {
            ...
            i.format = function (c) {
              ...
              var C = this.$utils(),
                k = (c || "YYYY-MM-DDTHH:mm:ssZ").replace(
      ...
      (function (t, e) {
        (function (n, r) {
          ...
          var n,
            ...
            _ = { years: C, months: k, days: m, hours: c, minutes: a, seconds: i, milliseconds: 1, weeks: 6048e5 },
            S = function (p) {
            ...
            W = function (p, g) {
              return p
                ? U(p)
                  ? { negative: !0, format: "" + N(p) + g }
                  : { negative: !1, format: "" + p + g }
                : { negative: !1, format: "" };
            },
            q = (function () {
              function p(y, h, D) {
                var w = this;
                if (((this.$d = {}), (this.$l = D), y === void 0 && ((this.$ms = 0), this.parseFromMilliseconds()), h))
                  return Z(y * _[A(h)], this);
              ...
              return (
                ...
                (g.parseFromMilliseconds = function () {
                  ...
                  ((this.$d.years = I(y / C)),
                    ...
                    (this.$d.hours = I(y / c)),
                    (y %= c),
                    (this.$d.minutes = I(y / a)),
                    (y %= a),
                    (this.$d.seconds = I(y / i)),
                    (y %= i),
                    (this.$d.milliseconds = y));
                }),
                (g.toISOString = function () {
                  var y = W(this.$d.years, "Y"),
                    h = W(this.$d.months, "M"),
                    D = +this.$d.days || 0;
                  this.$d.weeks && (D += 7 * this.$d.weeks);
                  var w = W(D, "D"),
                    T = W(this.$d.hours, "H"),
                    v = W(this.$d.minutes, "M"),
                    u = this.$d.seconds || 0;
                  this.$d.milliseconds && ((u += this.$d.milliseconds / 1e3), (u = Math.round(1e3 * u) / 1e3));
                  var f = W(u, "S"),
                    b = y.negative || h.negative || w.negative || T.negative || v.negative || f.negative,
                    x = T.format || v.format || f.format ? "T" : "",
                    F = (b ? "-" : "") + "P" + y.format + h.format + w.format + x + T.format + v.format + f.format;
            ...
            j = function (p, g, y) {
              return p
                ...
                .add(g.minutes() * y, "m")
                .add(g.seconds() * y, "s")
                .add(g.milliseconds() * y, "ms");
            };
          return function (p, g, y) {
            ((n = y),
              (r = y().$utils()),
              (y.duration = function (w, T) {
                var v = y.locale();
                return Z(w, { $l: v }, T);
              }),
              (y.isDuration = S));
            var h = g.prototype.add,
              D = g.prototype.subtract;
...
var xe = (function () {
  var t = d(function (v, u, f, b) {
    ...
    D = {
      ...
      performAction: d(function (u, f, b, x, F, o, X) {
        var s = o.length - 1;
        switch (F) {
          case 1:
            return o[s - 1];
      ...
      defaultActions: {},
      parseError: d(function (u, f) {
        if (f.recoverable) this.trace(u);
        else {
          var b = new Error(u);
          throw ((b.hash = f), b);
        }
      ...
      parse: d(function (u) {
        var f = this,
          ...
          z = 2,
          P = 1,
          K = o.slice.call(arguments, 1),
          O = Object.create(this.lexer),
          st = { yy: {} };
        for (var M in this.yy) Object.prototype.hasOwnProperty.call(this.yy, M) && (st.yy[M] = this.yy[M]);
        ...
        function J() {
          ...
          return (
            (ot = x.pop() || O.lex() || P),
            typeof ot != "number" && (ot instanceof Array && ((x = ot), (ot = x.pop())), (ot = f.symbols_[ot] || ot)),
            ot
          );
        }
        d(J, "lex");
        for (var $, Q, G, it, at = {}, pt, ut, Oe, qt; ; ) {
          if (
            ((Q = b[b.length - 1]),
            this.defaultActions[Q]
              ? (G = this.defaultActions[Q])
              : (($ === null || typeof $ > "u") && ($ = J()), (G = X[Q] && X[Q][$])),
            typeof G > "u" || !G.length || !G[0])
          ) {
            var oe = "";
            qt = [];
            for (pt in X[Q]) this.terminals_[pt] && pt > z && qt.push("'" + this.terminals_[pt] + "'");
            (O.showPosition
              ? (oe =
                  "Parse error on line " +
                  (E + 1) +
...
Expecting ` +
              ...
              : (oe =
                  ...
                  (E + 1) +
                  ": Unexpected " +
                  ($ == P ? "end of input" : "'" + (this.terminals_[$] || $) + "'")),
              this.parseError(oe, {
                text: O.match,
          ...
          switch (G[0]) {
            ...
            case 2:
              if (
                ...
                V && (at._$.range = [o[o.length - (ut || 1)].range[0], o[o.length - 1].range[1]]),
                (it = this.performAction.apply(at, [s, R, E, st.yy, G[1], F, o].concat(K))),
                typeof it < "u")
              )
                return it;
              (ut && ((b = b.slice(0, -1 * ut * 2)), (F = F.slice(0, -1 * ut)), (o = o.slice(0, -1 * ut))),
                b.push(this.productions_[G[1]][0]),
                F.push(at.$),
                o.push(at._$),
                (Oe = X[b[b.length - 2]][b[b.length - 1]]),
                b.push(Oe));
              break;
            case 3:
              return !0;
        ...
        unput: d(function (u) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: b
                ? (b.length === x.length ? this.yylloc.first_column : 0) + x[x.length - b.length].length - b[0].length
                : this.yylloc.first_column - f,
            }),
            this.options.ranges && (this.yylloc.range = [F[0], F[0] + this.yyleng - f]),
...
` +
        ...
        test_match: d(function (u, f) {
          ...
          if (
            ...
            (this.matched += u[0]),
            (b = this.performAction.call(this, this.yy, this, f, this.conditionStack[this.conditionStack.length - 1])),
            this.done && this._input && (this.done = !1),
            b)
          )
            return b;
          if (this._backtrack) {
            for (var o in F) this[o] = F[o];
            return !1;
          }
          return !1;
        }, "test_match"),
        next: d(function () {
          ...
          for (var F = this._currentRules(), o = 0; o < F.length; o++)
            if (((b = this._input.match(this.rules[F[o]])), b && (!f || b[0].length > f[0].length))) {
              if (((f = b), (x = o), this.options.backtrack_lexer)) {
                if (((u = this.test_match(b, F[o])), u !== !1)) return u;
                if (this._backtrack) {
                  f = !1;
                  continue;
                } else return !1;
          ...
          return f
            ? ((u = this.test_match(f, F[x])), u !== !1 ? u : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: d(function (f, b, x, F) {
          switch (x) {
            case 0:
...
var nn = { friday: 5, saturday: 6 },
  ...
  It = "",
  Ie = "",
  _n = ["active", "done", "crit", "milestone", "vert"],
  Le = [],
  Rt = !1,
  Ae = !1,
  We = "sunday",
  ...
  Fn = d(function (t, e, n, r) {
    const i = t.format(e.trim()),
      a = t.format("YYYY-MM-DD");
    return r.includes(i) || r.includes(a)
      ? !1
      : (n.includes("weekends") && (t.isoWeekday() === nn[se] || t.isoWeekday() === nn[se] + 1)) ||
  ...
  Yn = d(function (t, e, n, r) {
    ...
    const [c, m] = xs(i, a, e, n, r);
    ((t.endTime = c.toDate()), (t.renderEndTime = m));
  }, "checkTaskDates"),
  xs = d(function (t, e, n, r, i) {
    let a = !1,
      c = null;
    for (; t <= e; ) (a || (c = e.toDate()), (a = Fn(t, n, r, i)), a && (e = e.add(1, "d")), (t = t.add(1, "d")));
    return [e, c];
  }, "fixTaskDates"),
  De = d(function (t, e, n) {
    if (
    ...
    if (c.isValid()) return c.toDate();
    {
      ...
      const m = new Date(n);
      if (m === void 0 || isNaN(m.getTime()) || m.getFullYear() < -1e4 || m.getFullYear() > 1e4)
  ...
  En = d(function (t, e, n, r = !1) {
    ...
    if (a !== null) {
      ...
      if (k) return k.startTime;
      const L = new Date();
      return (L.setHours(0, 0, 0, 0), L);
    }
    let c = rt(n, e.trim(), !0);
    if (c.isValid()) return (r && (c = c.add(1, "d")), c.toDate());
    let m = rt(t);
    const [Y, C] = Un(n);
    if (!Number.isNaN(Y)) {
      const k = m.add(Y, C);
  ...
  ws = d(function (t, e) {
    ...
    const r = n.split(","),
      i = {};
    $e(r, i, _n);
    for (let c = 0; c < r.length; c++) r[c] = r[c].trim();
    let a = "";
    switch (r.length) {
      case 1:
    ...
    return (
      a &&
        ((i.endTime = En(i.startTime, lt, a, Rt)),
        (i.manualEndTime = rt(a, "YYYY-MM-DD", !0).isValid()),
        Yn(i, lt, zt, Vt)),
      i
    );
  }, "compileData"),
  Ds = d(function (t, e) {
    ...
    switch (r.length) {
      case 1:
        ((i.id = Yt()), (i.startTime = { type: "prevTaskEnd", id: t }), (i.endTime = { data: r[0] }));
        break;
      case 2:
        ((i.id = Yt()), (i.startTime = { type: "getStartDate", startData: r[0] }), (i.endTime = { data: r[1] }));
        break;
      case 3:
        ((i.id = Yt(r[0])), (i.startTime = { type: "getStartDate", startData: r[1] }), (i.endTime = { data: r[2] }));
        break;
    }
    return i;
  }, "parseData"),
  ...
  Cs = d(function (t, e) {
    const n = { section: It, type: It, description: t, task: t, classes: [] },
      r = ws(Me, e);
  ...
  rn = d(function () {
    const t = d(function (n) {
      ...
      return (
        tt[n].startTime &&
          ((tt[n].endTime = En(tt[n].startTime, lt, tt[n].raw.endTime.data, Rt)),
          tt[n].endTime &&
            ((tt[n].processed = !0),
            (tt[n].manualEndTime = rt(tt[n].raw.endTime.data, "YYYY-MM-DD", !0).isValid()),
            Yn(tt[n], lt, zt, Vt))),
        tt[n].processed
      );
    }, "compileTask");
    let e = !0;
    for (const [n, r] of tt.entries()) (t(n), (e = e && r.processed));
    return e;
  }, "compileTasks"),
  Ss = d(function (t, e) {
    let n = e;
    (_t().securityLevel !== "loose" && (n = Zn.sanitizeUrl(e)),
  ...
  _s = d(function (t, e, n) {
    if (_t().securityLevel !== "loose" || e === void 0) return;
    let r = [];
    if (typeof n == "string") {
      r = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
  ...
  Us = {
    getConfig: d(() => _t().gantt, "getConfig"),
    clear: ji,
    setDateFormat: rs,
    getDateFormat: ls,
...
var Es = d(function () {
  ...
  sn = { monday: Ht, tuesday: pn, wednesday: vn, thursday: xt, friday: Tn, saturday: bn, sunday: Pt },
  Is = d((t, e) => {
    let n = [...t].map(() => -1 / 0),
      r = [...t].sort((a, c) => a.startTime - c.startTime || a.order - c.order),
      i = 0;
    for (const a of r)
  ...
  dt,
  ve = 1e4,
  Ls = d(function (t, e, n, r) {
    const i = _t().gantt,
      a = _t().securityLevel;
    let c;
    a === "sandbox" && (c = Zt("#i" + e));
    const m = a === "sandbox" ? Zt(c.nodes()[0].contentDocument.body) : Zt("body"),
      Y = a === "sandbox" ? c.nodes()[0].contentDocument : document,
      C = Y.getElementById(e);
    ((dt = C.parentElement.offsetWidth), dt === void 0 && (dt = 1200), i.useWidth !== void 0 && (dt = i.useWidth));
    const k = r.db.getTasks();
    let L = [];
    for (const h of k) L.push(h.type);
    L = y(L);
    const _ = {};
    let S = 2 * i.topPadding;
    if (r.db.getDisplayMode() === "compact" || i.displayMode === "compact") {
      const h = {};
      for (const w of k) h[w.section] === void 0 ? (h[w.section] = [w]) : h[w.section].push(w);
      let D = 0;
      ...
      for (const h of L) _[h] = k.filter((D) => D.type === h).length;
    }
    C.setAttribute("viewBox", "0 0 " + dt + " " + S);
    const Z = m.select(`[id="${e}"]`),
      A = Ei()
        .domain([
          er(k, function (h) {
            return h.startTime;
    ...
    function I(h, D, w) {
      const T = i.barHeight,
        ...
        u = i.topPadding,
        f = i.leftPadding,
        b = Jn().domain([0, L.length]).range(["#00B9FA", "#F95002"]).interpolate(yr);
      (W(v, u, f, D, w, h, r.db.getExcludes(), r.db.getIncludes()),
        j(f, u, D, w),
        N(h, v, u, f, T, b, D),
        p(v, u),
        g(f, u, D, w));
    ...
    function N(h, D, w, T, v, u, f) {
      ...
      Z.append("g")
        ...
        .attr("class", function (s) {
          for (const [E, R] of L.entries()) if (s.type === R) return "section section" + (E % i.numberSectionStyles);
          return "section section0";
        })
        .enter();
      const F = Z.append("g").selectAll("rect").data(h).enter(),
        o = r.db.getLinks();
      if (
        (F.append("rect")
          .attr("id", function (s) {
          ...
          .attr("x", function (s) {
            return s.milestone
              ? A(s.startTime) + T + 0.5 * (A(s.endTime) - A(s.startTime)) - 0.5 * v
              : A(s.startTime) + T;
          })
          .attr("y", function (s, E) {
          ...
          .attr("transform-origin", function (s, E) {
            return (
              (E = s.order),
              (A(s.startTime) + T + 0.5 * (A(s.endTime) - A(s.startTime))).toString() +
                "px " +
                (E * D + w + 0.5 * v).toString() +
                "px"
            );
          })
          .attr("class", function (s) {
            ...
            let z = 0;
            for (const [K, O] of L.entries()) s.type === O && (z = K % i.numberSectionStyles);
            let P = "";
            return (
              s.active
                ? s.crit
        ...
        F.append("text")
          ...
          .attr("y", function (s, E) {
            return s.vert
              ? i.gridLineStartPadding + k.length * (i.barHeight + i.barGap) + 60
              : ((E = s.order), E * D + i.barHeight / 2 + (i.fontSize / 2 - 2) + w);
          })
          .attr("text-height", v)
          .attr("class", function (s) {
            ...
            let K = 0;
            for (const [st, M] of L.entries()) s.type === M && (K = st % i.numberSectionStyles);
            let O = "";
            return (
              s.active && (s.crit ? (O = "activeCritText" + K) : (O = "activeText" + K)),
              s.done
                ? s.crit
                  ? (O = O + " doneCritText" + K)
                  : (O = O + " doneText" + K)
                : s.crit && (O = O + " critText" + K),
              s.milestone && (O += " milestoneText"),
              s.vert && (O += " vertText"),
              z > R - E
                ? R + z + 1.5 * i.leftPadding > f
                  ? P + " taskTextOutsideLeft taskTextOutside" + K + " " + O
                  : P + " taskTextOutsideRight taskTextOutside" + K + " " + O + " width-" + z
                : P + " taskText taskText" + K + " " + O + " width-" + z
            );
          }),
        ...
        F.filter(function (R) {
          ...
          var z = E.querySelector("#" + R.id),
            P = E.querySelector("#" + R.id + "-text");
          const K = z.parentNode;
          var O = E.createElement("a");
          (O.setAttribute("xlink:href", o.get(R.id)),
    ...
    function W(h, D, w, T, v, u, f, b) {
      ...
      let s = null,
        E = rt(x);
      for (; E.valueOf() <= F; )
        (r.db.isInvalidDate(E, o, f, b) ? (s ? (s.end = E) : (s = { start: E, end: E })) : s && (X.push(s), (s = null)),
          (E = E.add(1, "d")));
      Z.append("g")
        .selectAll("rect")
        .data(X)
        .enter()
        .append("rect")
        .attr("id", (z) => "exclude-" + z.start.format("YYYY-MM-DD"))
        .attr("x", (z) => A(z.start.startOf("day")) + w)
        .attr("y", i.gridLineStartPadding)
        .attr("width", (z) => A(z.end.endOf("day")) - A(z.start.startOf("day")))
        .attr("height", v - D - i.gridLineStartPadding)
        .attr("transform-origin", function (z, P) {
          return (
            (A(z.start) + w + 0.5 * (A(z.end) - A(z.start))).toString() + "px " + (P * h + 0.5 * v).toString() + "px"
          );
        })
    ...
    function j(h, D, w, T) {
      ...
      if (F !== null) {
        ...
        if (isNaN(o) || o <= 0) Tt.warn(`Invalid tick interval value: "${F[1]}". Skipping custom tick interval.`);
        else {
          const X = F[2],
            s = r.db.getWeekday() || i.weekday,
            E = A.domain(),
            R = E[0],
            z = E[1],
            P = q(R, z, o, X);
      ...
      if (
        (Z.append("g")
          .attr("class", "grid")
          .attr("transform", "translate(" + h + ", " + (T - 50) + ")")
          .call(b)
          .selectAll("text")
        ...
        if (F !== null) {
          ...
          if (isNaN(X) || X <= 0) Tt.warn(`Invalid tick interval value: "${F[1]}". Skipping custom tick interval.`);
          else {
            const s = F[2],
              E = r.db.getWeekday() || i.weekday,
              R = A.domain(),
              z = R[0],
              P = R[1];
            if (q(z, P, X, s) <= ve)
    ...
    function p(h, D) {
      ...
      Z.append("g")
        ...
        .enter()
        .append(function (v) {
          const u = v[0].split(qn.lineBreakRegex),
            f = -(u.length - 1) / 2,
            b = Y.createElementNS("http://www.w3.org/2000/svg", "text");
          b.setAttribute("dy", f + "em");
          for (const [x, F] of u.entries()) {
            const o = Y.createElementNS("http://www.w3.org/2000/svg", "tspan");
            (o.setAttribute("alignment-baseline", "central"),
              o.setAttribute("x", "10"),
              x > 0 && o.setAttribute("dy", "1em"),
              (o.textContent = F),
              b.appendChild(o));
          }
          return b;
        ...
        .attr("x", 10)
        .attr("y", function (v, u) {
          if (u > 0) for (let f = 0; f < u; f++) return ((w += T[u - 1][1]), (v[1] * h) / 2 + w * h + D);
          else return (v[1] * h) / 2 + D;
        })
        .attr("font-size", i.sectionFontSize)
        .attr("class", function (v) {
          for (const [u, f] of L.entries())
            if (v[0] === f) return "sectionTitle sectionTitle" + (u % i.numberSectionStyles);
          return "sectionTitle";
        });
    }
    d(p, "vertLabels");
    function g(h, D, w, T) {
      ...
      if (v === "off") return;
      const u = Z.append("g").attr("class", "today"),
        f = new Date(),
        b = u.append("line");
      (b
        .attr("x1", A(f) + h)
        ...
        .attr("y2", T - i.titleTopMargin)
        .attr("class", "today"),
        v !== "" && b.attr("style", v.replace(/,/g, ";")));
    }
    d(g, "drawToday");
    function y(h) {
      const D = {},
...
`,
  ...
  $s = Ws,
  zs = { parser: Gi, db: Us, renderer: As, styles: $s };
export { zs as diagram };
