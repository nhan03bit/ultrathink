...
var g =
  ...
  w = /^@[_A-Za-z$][_A-Za-z$0-9]*/,
  z = p(["and", "or", "not", "is", "isnt", "in", "instanceof", "typeof"]),
  l = ["for", "while", "loop", "if", "unless", "else", "switch", "try", "catch", "finally", "class"],
  a = [
    "break",
    "by",
    "continue",
...
var b = /^('{3}|\"{3}|['\"])/,
  A = /^(\/{3}|\/)/,
  S = ["Infinity", "NaN", "undefined", "null", "true", "false", "on", "off", "yes", "no"],
  O = p(S);
function u(e, n) {
  if (e.sol()) {
  ...
  if (e.match(b)) return ((n.tokenize = t(e.current(), !1, "string")), n.tokenize(e, n));
  if (e.match(A)) {
    if (e.current() != "/" || e.match(/^.*\//, !1))
      return ((n.tokenize = t(e.current(), !0, "string.special")), n.tokenize(e, n));
    e.backUp(1);
  }
  return e.match(g) || e.match(z)
    ? "operator"
    : e.match(y)
      ? "punctuation"
      : e.match(O)
        ? "atom"
        : e.match(w) || (n.prop && e.match(h))
          ? "property"
          : e.match(x)
            ? "keyword"
            : e.match(h)
...
function d(e, n, i = "coffee") {
  ...
  (i !== "coffee" ? ((r = null), (c = e.column() + e.current().length)) : n.scope.align && (n.scope.align = !1),
    (n.scope = { offset: f, type: i, prev: n.scope, align: r, alignOffset: c }));
}
function v(e, n) {
  if (n.scope.prev)
...
function E(e, n) {
  ...
  return (
    n.dedent && e.eol() && (n.scope.type == "coffee" && n.scope.prev && (n.scope = n.scope.prev), (n.dedent = !1)),
    i == "indent" || i == "dedent" ? null : i
  );
}
const Z = {
  name: "coffeescript",
  startState: function () {
    return { tokenize: u, scope: { offset: 0, type: "coffee", prev: null, align: !1 }, prop: !1, dedent: 0 };
  },
  token: function (e, n) {
