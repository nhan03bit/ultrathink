import { g as te } from "./chunk-55IACEB6-coqV5UWO.js";
import { s as ee } from "./chunk-QN33PNHL-DmZbeWJQ.js";
import {
  _ as f,
  l as b,
  c as F,
...
var vt = (function () {
  var e = f(function (V, o, h, n) {
    ...
    gt = {
      ...
      performAction: f(function (o, h, n, g, E, r, Z) {
        var c = r.length - 1;
        switch (E) {
          case 3:
      ...
      parse: f(function (o) {
        var h = this,
          ...
          j = { yy: {} };
        for (var Et in this.yy) Object.prototype.hasOwnProperty.call(this.yy, Et) && (j.yy[Et] = this.yy[Et]);
        (D.setInput(o, j.yy), (j.yy.lexer = D), (j.yy.parser = this), typeof D.yylloc > "u" && (D.yylloc = {}));
        var _t = D.yylloc;
        r.push(_t);
        ...
        function Lt() {
          ...
          return (
            (O = g.pop() || D.lex() || tt),
            typeof O != "number" && (O instanceof Array && ((g = O), (O = g.pop())), (O = h.symbols_[O] || O)),
            O
          );
        }
        f(Lt, "lex");
        for (var C, H, w, mt, J = {}, dt, Y, Ot, ft; ; ) {
          if (
            ...
            this.defaultActions[H]
              ? (w = this.defaultActions[H])
              : ((C === null || typeof C > "u") && (C = Lt()), (w = Z[H] && Z[H][C])),
            typeof w > "u" || !w.length || !w[0])
          ) {
            var bt = "";
            ft = [];
            for (dt in Z[H]) this.terminals_[dt] && dt > ut && ft.push("'" + this.terminals_[dt] + "'");
            (D.showPosition
              ? (bt =
                  "Parse error on line " +
                  (U + 1) +
...
Expecting ` +
              ...
              : (bt =
                  ...
                  (U + 1) +
                  ": Unexpected " +
                  (C == tt ? "end of input" : "'" + (this.terminals_[C] || C) + "'")),
              this.parseError(bt, {
                text: D.match,
          ...
          switch (w[0]) {
            ...
            case 2:
              if (
                ...
                (mt = this.performAction.apply(J, [c, X, U, j.yy, w[1], E, r].concat(Tt))),
                typeof mt < "u")
              )
                return mt;
              (Y && ((n = n.slice(0, -1 * Y * 2)), (E = E.slice(0, -1 * Y)), (r = r.slice(0, -1 * Y))),
      ...
      var V = {
        ...
        unput: f(function (o) {
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [E[0], E[0] + this.yyleng - h]),
...
` +
        ...
        next: f(function () {
          ...
          for (var E = this._currentRules(), r = 0; r < E.length; r++)
            if (((n = this._input.match(this.rules[E[r]])), n && (!h || n[0].length > h[0].length))) {
              if (((h = n), (g = r), this.options.backtrack_lexer)) {
                if (((o = this.test_match(n, E[r])), o !== !1)) return o;
                if (this._backtrack) {
                  h = !1;
                  continue;
                } else return !1;
          ...
          return h
            ? ((o = this.test_match(h, E[g])), o !== !1 ? o : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: f(function (h, n, g, E) {
          switch (g) {
            case 0:
              return 38;
            case 1:
...
var Be = vt,
  ...
  Kt = f((e, t = Yt) => {
    if (!e.doc) return t;
    let s = t;
    for (const a of e.doc) a.stmt === "dir" && (s = a.value);
    return s;
  }, "getDir"),
  Ie = f(function (e, t) {
    return t.db.getClasses();
  }, "getClasses"),
  Ne = f(async function (e, t, s, a) {
    ...
    ((S.type = a.type),
      (S.layoutAlgorithm = d),
      (S.nodeSpacing = (l == null ? void 0 : l.nodeSpacing) || 50),
      (S.rankSpacing = (l == null ? void 0 : l.rankSpacing) || 50),
      (S.markers = ["barb"]),
      (S.diagramId = t),
      await se(S, p));
    const T = 8;
    try {
      (typeof a.db.getLinks == "function" ? a.db.getLinks() : new Map()).forEach((m, k) => {
        var I;
        const A = typeof k == "string" ? k : typeof (k == null ? void 0 : k.id) == "string" ? k.id : "";
        if (!A) {
          b.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(k));
          return;
        }
        ...
        if (
          ...
          b.warn("⚠️ Could not find node matching text:", A);
          return;
        }
        const R = x.parentNode;
        if (!R) {
          b.warn("⚠️ Node has no parent, cannot wrap:", A);
          return;
        }
        const u = document.createElementNS("http://www.w3.org/2000/svg", "a"),
          L = m.url.replace(/^"+|"+$/g, "");
        if (
        ...
        (R.replaceChild(u, x), u.appendChild(x), b.info("🔗 Wrapped node in <a> tag for:", A, m.url));
      });
    } catch (_) {
      b.error("❌ Error injecting clickable links:", _);
    }
    (ie.insertTitle(p, "statediagramTitleText", (l == null ? void 0 : l.titleTopMargin) ?? 25, a.db.getDiagramTitle()),
...
var we = f((e, t, s, a, i, l, d, S) => {
    (b.trace("items", t),
      t.forEach((p) => {
        switch (p.stmt) {
          ...
          case Ct:
            {
              (st(e, p.state1, s, a, i, l, d, S), st(e, p.state2, s, a, i, l, d, S));
              const T = {
                id: "edge" + M,
                start: p.state1.id,
                end: p.state2.id,
  ...
  $t = f((e, t = Yt) => {
    let s = t;
    if (e.doc) for (const a of e.doc) a.stmt === "dir" && (s = a.value);
    return s;
  }, "getDir");
function et(e, t, s) {
...
var st = f((e, t, s, a, i, l, d, S) => {
    ...
    const p = t.id,
      ...
      m = Jt(T),
      k = F();
    if ((b.info("dataFetcher parsedItem", t, T, m), p !== "root")) {
      let R = Dt;
      (t.start === !0 ? (R = ye) : t.start === !1 && (R = ge),
        t.type !== it && (R = t.type),
        St.get(p) ||
          St.set(p, { id: p, shape: R, description: z.sanitizeText(p, k), cssClasses: `${_} ${me}`, cssStyles: m }));
      const u = St.get(p);
      (t.description &&
        (Array.isArray(u.description)
          ? ((u.shape = kt), u.description.push(t.description))
          : (A = u.description) != null && A.length && u.description.length > 0
            ? ((u.shape = kt),
              u.description === p
                ? (u.description = [t.description])
                : (u.description = [u.description, t.description]))
            : ((u.shape = Dt), (u.description = t.description)),
        (u.description = z.sanitizeTextOrArray(u.description, k))),
        (($ = u.description) == null ? void 0 : $.length) === 1 &&
          u.shape === kt &&
          (u.type === "group" ? (u.shape = Nt) : (u.shape = Dt)),
        !u.type &&
          t.doc &&
          (b.info("Setting cluster for XCX", p, $t(t)),
          (u.type = "group"),
          (u.isGroup = !0),
          (u.dir = $t(t)),
          (u.shape = t.type === Gt ? It : Nt),
          (u.cssClasses = `${u.cssClasses} ${Ae} ${l ? Le : ""}`)));
      const L = {
        labelStyle: "",
        shape: u.shape,
        label: u.description,
      ...
      if (
        (L.shape === It && (L.label = ""),
        e && e.id !== "root" && (b.trace("Setting node ", p, " to be child of its parent ", e.id), (L.parentId = e.id)),
        (L.centerLabel = !0),
        t.note)
      ) {
        const I = {
        ...
        let P = p,
          B = I.id;
        (t.note.position === "left of" && ((P = I.id), (B = p)),
          i.push({
            id: P + "-" + B,
            start: P,
            end: B,
    ...
    t.doc && (b.trace("Adding nodes children "), we(t, t.doc, s, a, i, !l, d, S));
  }, "dataFetcher"),
  $e = f(() => {
    (St.clear(), (M = 0));
  }, "reset"),
  ...
  pt = f((e) => JSON.parse(JSON.stringify(e)), "clone"),
  W,
  Me =
    ((W = class {
      constructor(t) {
        ((this.version = t),
          ...
          (this.setAccDescription = oe),
          (this.setDiagramTitle = le),
      ...
      handleStyleDef(t) {
        const s = t.id.trim().split(","),
          a = t.styleClass.split(",");
        for (const i of s) {
      ...
      docTranslator(t, s, a) {
        ...
        if (
          (s.stmt === Q &&
            (s.id === v.START_NODE ? ((s.id = t.id + (a ? "_start" : "_end")), (s.start = a)) : (s.id = s.id.trim())),
        ...
        if (i.length > 0 && l.length > 0) {
          const d = { stmt: Q, id: he(), type: "divider", doc: pt(l) };
          (i.push(pt(d)), (s.doc = i));
        }
      ...
      addState(t, s = it, a = void 0, i = void 0, l = void 0, d = void 0, S = void 0, p = void 0) {
        ...
        if (!this.currentDocument.states.has(T))
          ...
          if (!_) throw new Error(`State not found: ${T}`);
        ...
        (d &&
          (b.info("Setting state classes", T, d),
          (Array.isArray(d) ? d : [d]).forEach((m) => this.setCssClass(T, m.trim()))),
          S &&
            (b.info("Setting state styles", T, S),
            (Array.isArray(S) ? S : [S]).forEach((m) => this.setStyle(T, m.trim()))),
          p &&
            (b.info("Setting state styles", T, S),
            (Array.isArray(p) ? p : [p]).forEach((m) => this.setTextStyle(T, m.trim()))));
      }
      clear(t) {
        ((this.nodes = []),
          (this.edges = []),
      ...
      addLink(t, s, a) {
        (this.links.set(t, { url: s, tooltip: a }), b.warn("Adding link", t, s, a));
      }
      getLinks() {
        return this.links;
      }
      ...
      addRelationObjs(t, s, a = "") {
        const i = this.startIdIfNeeded(t.id.trim()),
          l = this.startTypeIfNeeded(t.id.trim(), t.type),
          d = this.startIdIfNeeded(s.id.trim()),
          S = this.startTypeIfNeeded(s.id.trim(), s.type);
        (this.addState(i, l, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles),
          this.addState(d, S, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles),
          this.currentDocument.relations.push({ id1: i, id2: d, relationTitle: z.sanitizeText(a, F()) }));
      }
      addRelation(t, s, a) {
        if (typeof t == "object" && typeof s == "object") this.addRelationObjs(t, s, a);
        else if (typeof t == "string" && typeof s == "string") {
          const i = this.startIdIfNeeded(t.trim()),
            l = this.startTypeIfNeeded(t),
            d = this.endIdIfNeeded(s.trim()),
            S = this.endTypeIfNeeded(s);
          (this.addState(i, l),
            this.addState(d, S),
      ...
      addDescription(t, s) {
        var l;
        const a = this.currentDocument.states.get(t),
      ...
      addStyleClass(t, s = "") {
        ...
        s &&
          a &&
          s.split(v.STYLECLASS_SEP).forEach((i) => {
      ...
      getData() {
        const t = F();
        return { nodes: this.nodes, edges: this.edges, other: {}, config: t, direction: Kt(this.getRootDocV2()) };
      }
      getConfig() {
        return F().state;
      }
    ...
    f(W, "StateDB"),
    (W.relationType = { AGGREGATION: 0, EXTENSION: 1, COMPOSITION: 2, DEPENDENCY: 3 }),
    W),
  Pe = f(
    (e) => `
...
`,
  ...
  Ue = Pe;
export { Me as S, Be as a, Ve as b, Ue as s };
