import { p as Z } from "./chunk-4BX2VUAB-Cb4O8Gqh.js";
import { I as F } from "./chunk-QZHKN3VN-DdlvR2GP.js";
import {
  t as U,
  q as rr,
  s as er,
...
import { p as gr } from "./treemap-GDKQZRPO-qHAS-c0V.js";
import "./index-ChLuXRS1.js";
import "./_baseUniq-LizNW1gx.js";
import "./_basePickBy-DfW1SwLa.js";
import "./clone-CiBR69il.js";
var u = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  yr = hr.gitGraph,
  z = h(() => dr({ ...yr, ...lr().gitGraph }), "getConfig"),
  i = new F(() => {
    const t = z(),
      r = t.mainBranchName,
      a = t.mainBranchOrder;
    return {
      ...
      commits: new Map(),
      head: null,
      branchConfig: new Map([[r, { name: r, order: a }]]),
...
var xr = h(function (t) {
  ...
  br = h(function (t) {
    ...
    const n = z();
    ((a = B.sanitizeText(a, n)),
      (r = B.sanitizeText(r, n)),
      (e = e == null ? void 0 : e.map((o) => B.sanitizeText(o, n))));
    const c = {
    ...
    ((i.records.head = c),
      m.info("main branch", n.mainBranchName),
      i.records.commits.has(c.id) && m.warn(`Commit ID ${c.id} already exists`),
      i.records.commits.set(c.id, c),
      i.records.branches.set(i.records.currBranch, c.id),
      m.debug("in pushCommit " + c.id));
  }, "commit"),
  mr = h(function (t) {
    let r = t.name;
    const a = t.order;
    ...
    (i.records.branches.set(r, i.records.head != null ? i.records.head.id : null),
      i.records.branchConfig.set(r, { name: r, order: a }),
      _(r),
      m.debug("in createBranch"));
  }, "branch"),
  wr = h((t) => {
    let r = t.branch,
      a = t.id;
    ...
    const c = i.records.branches.get(i.records.currBranch),
      o = i.records.branches.get(r),
      $ = c ? i.records.commits.get(c) : void 0,
      l = o ? i.records.commits.get(o) : void 0;
    ...
    if (i.records.currBranch === r) {
      ...
      throw ((d.hash = { text: `merge ${r}`, token: `merge ${r}`, expected: ["branch abc"] }), d);
    }
    if ($ === void 0 || !$) {
      const d = new Error(`Incorrect usage of "merge". Current branch (${i.records.currBranch})has no commits`);
      throw ((d.hash = { text: `merge ${r}`, token: `merge ${r}`, expected: ["commit"] }), d);
    }
    if (!i.records.branches.has(r)) {
      const d = new Error('Incorrect usage of "merge". Branch to be merged (' + r + ") does not exist");
      throw ((d.hash = { text: `merge ${r}`, token: `merge ${r}`, expected: [`branch ${r}`] }), d);
    }
    if (l === void 0 || !l) {
      const d = new Error('Incorrect usage of "merge". Branch to be merged (' + r + ") has no commits");
      throw ((d.hash = { text: `merge ${r}`, token: `merge ${r}`, expected: ['"commit"'] }), d);
    }
    if ($ === l) {
    ...
    if (a && i.records.commits.has(a)) {
      ...
      throw (
        (d.hash = {
          ...
          expected: [`merge ${r} ${a}_UNIQUE ${s} ${e == null ? void 0 : e.join(" ")}`],
        }),
        d
      );
    }
    ...
    ((i.records.head = g),
      ...
      m.debug(i.records.branches),
      m.debug("in mergeBranch"));
  }, "merge"),
  vr = h(function (t) {
    let r = t.id,
      a = t.targetId,
    ...
    if (
      ((r = B.sanitizeText(r, n)),
      (a = B.sanitizeText(a, n)),
      (s = s == null ? void 0 : s.map(($) => B.sanitizeText($, n))),
      (e = B.sanitizeText(e, n)),
      !r || !i.records.commits.has(r))
    ) {
      const $ = new Error('Incorrect usage of "cherryPick". Source commit id should exist and provided');
      throw (
        ($.hash = { text: `cherryPick ${r} ${a}`, token: `cherryPick ${r} ${a}`, expected: ["cherry-pick abc"] }),
        $
      );
    }
    ...
    if (!a || !i.records.commits.has(a)) {
      if (o === i.records.currBranch) {
        ...
        throw (
          (g.hash = { text: `cherryPick ${r} ${a}`, token: `cherryPick ${r} ${a}`, expected: ["cherry-pick abc"] }),
          g
        );
      }
      const $ = i.records.branches.get(i.records.currBranch);
      if ($ === void 0 || !$) {
        const g = new Error(`Incorrect usage of "cherry-pick". Current branch (${i.records.currBranch})has no commits`);
        throw (
          (g.hash = { text: `cherryPick ${r} ${a}`, token: `cherryPick ${r} ${a}`, expected: ["cherry-pick abc"] }),
          g
        );
      ...
      const f = {
        ...
        branch: i.records.currBranch,
        type: u.CHERRY_PICK,
        tags: s ? s.filter(Boolean) : [`cherry-pick:${c.id}${c.type === u.MERGE ? `|parent:${e}` : ""}`],
      };
      ((i.records.head = f),
        i.records.commits.set(f.id, f),
        i.records.branches.set(i.records.currBranch, f.id),
        m.debug(i.records.branches),
        m.debug("in cherryPick"));
    }
  }, "cherryPick"),
  _ = h(function (t) {
...
function D(t) {
  ...
  for (const e in i.records.branches) i.records.branches.get(e) === r.id && s.push(e);
...
var Cr = h(function () {
  ...
  Br = h(function () {
    return [...i.records.branchConfig.values()]
      .map((r, a) => (r.order !== null && r.order !== void 0 ? r : { ...r, order: parseFloat(`0.${a}`) }))
      .sort((r, a) => (r.order ?? 0) - (a.order ?? 0))
      .map(({ name: r }) => ({ name: r }));
  ...
  qr = h((t, r) => {
    const s = {
      Commit: h((e) => r.commit(Or(e)), "Commit"),
      Branch: h((e) => r.branch(zr(e)), "Branch"),
      Merge: h((e) => r.merge(Gr(e)), "Merge"),
      Checkout: h((e) => r.checkout(Hr(e)), "Checkout"),
      CherryPicking: h((e) => r.cherryPick(Pr(e)), "CherryPicking"),
    }[t.$type];
    s ? s(t) : m.error(`Unknown statement type: ${t.$type}`);
  }, "parseStatement"),
  Or = h(
    (t) => ({ id: t.id, msg: t.message ?? "", type: t.type !== void 0 ? u[t.type] : u.NORMAL, tags: t.tags ?? void 0 }),
    "parseCommit"
  ),
  zr = h((t) => ({ name: t.name, order: t.order ?? 0 }), "parseBranch"),
  Gr = h(
    (t) => ({ branch: t.branch, id: t.id ?? "", type: t.type !== void 0 ? u[t.type] : void 0, tags: t.tags ?? void 0 }),
    "parseMerge"
  ),
  Hr = h((t) => t.branch, "parseCheckout"),
  Pr = h((t) => {
    var a;
    return {
      id: t.id,
  ...
  Q = h((t) => {
    ...
    return (
      x === "BT"
        ? ((a = h((e, n) => e <= n, "comparisonFunc")), (s = 1 / 0))
        : ((a = h((e, n) => e >= n, "comparisonFunc")), (s = 0)),
      t.forEach((e) => {
        var c, o;
        const n =
          x === "TB" || x == "BT" ? ((c = E.get(e)) == null ? void 0 : c.y) : (o = E.get(e)) == null ? void 0 : o.x;
  ...
  Yr = h((t) => Dr(t) + I, "calculateCommitPosition"),
  Kr = h((t, r) => {
  ...
  _r = h((t, r, a, s, e, n) => {
    if (n === u.HIGHLIGHT)
      (t
        ...
        .attr("width", 20)
        .attr("height", 20)
        .attr("class", `commit ${r.id} commit-highlight${e % O} ${s}-outer`),
        t
          .append("rect")
          .attr("x", a.x - 6)
          .attr("y", a.y - 6)
          .attr("width", 12)
          .attr("height", 12)
          .attr("class", `commit ${r.id} commit${e % O} ${s}-inner`));
    else if (n === u.CHERRY_PICK)
      (t.append("circle").attr("cx", a.x).attr("cy", a.y).attr("r", 10).attr("class", `commit ${r.id} ${s}`),
        t
          .append("circle")
          .attr("cx", a.x - 3)
          .attr("cy", a.y + 2)
      ...
      if (
        (c.attr("cx", a.x),
        c.attr("cy", a.y),
        c.attr("r", r.type === u.MERGE ? 9 : 10),
        c.attr("class", `commit ${r.id} commit${e % O}`),
        n === u.MERGE)
      ) {
        const o = t.append("circle");
        (o.attr("cx", a.x), o.attr("cy", a.y), o.attr("r", 6), o.attr("class", `commit ${s} ${r.id} commit${e % O}`));
      }
      n === u.REVERSE &&
        t
          .append("path")
  ...
  Vr = h((t, r, a, s) => {
    var e;
    if (
      r.type !== u.CHERRY_PICK &&
      ((r.customId && r.type === u.MERGE) || r.type !== u.MERGE) &&
      b != null &&
      b.showCommitLabel
    ) {
      const n = t.append("g"),
        ...
        o = n
          ...
          .text(r.id),
        $ = (e = o.node()) == null ? void 0 : e.getBBox();
      if (
        $ &&
        (c
          .attr("x", a.posWithOffset - $.width / 2 - L)
          .attr("y", a.y + 13.5)
          .attr("width", $.width + 2 * L)
          .attr("height", $.height + 2 * L),
        x === "TB" || x === "BT"
          ? (c.attr("x", a.x - ($.width + 4 * k + 5)).attr("y", a.y - 12),
            o.attr("x", a.x - ($.width + 4 * k)).attr("y", a.y + $.height - 12))
        ...
        if (x === "TB" || x === "BT")
          ...
          const l = -7.5 - (($.width + 10) / 25) * 9.5,
            f = 10 + ($.width / 25) * 8.5;
          n.attr("transform", "translate(" + l + ", " + f + ") rotate(-45, " + s + ", " + a.y + ")");
        }
    }
  }, "drawCommitLabel"),
  Xr = h((t, r, a, s) => {
  ...
  Qr = h((t, r, a, s) => {
    ...
    } else return r === "TB" ? P : r === "BT" ? (s.get(t.id) ?? e).y - I : 0;
    return 0;
  }, "calculatePosition"),
  Zr = h((t, r, a) => {
    var c, o;
    const s = x === "BT" && a ? r : r + R,
      e = x === "TB" || x === "BT" ? s : (c = C.get(t.branch)) == null ? void 0 : c.pos,
      n = x === "TB" || x === "BT" ? ((o = C.get(t.branch)) == null ? void 0 : o.pos) : s;
    if (n === void 0 || e === void 0) throw new Error(`Position were undefined for commit ${t.id}`);
    return { x: n, y: e, posWithOffset: s };
  }, "getCommitPosition"),
  K = h((t, r, a) => {
    if (!b) throw new Error("GitGraph config not found");
    const s = t.append("g").attr("class", "commit-bullets"),
      e = t.append("g").attr("class", "commit-labels");
    let n = x === "TB" || x === "BT" ? P : 0;
    const c = [...r.keys()],
      o = (b == null ? void 0 : b.parallelCommits) ?? !1,
      $ = h((f, g) => {
        var p, w;
        const d = (p = r.get(f)) == null ? void 0 : p.seq,
          y = (w = r.get(g)) == null ? void 0 : w.seq;
        return d !== void 0 && y !== void 0 ? d - y : 0;
      }, "sortKeys");
    let l = c.sort($);
    (x === "BT" && (o && Ar(l, r, n), (l = l.reverse())),
      l.forEach((f) => {
        var y;
        const g = r.get(f);
        if (!g) throw new Error(`Commit not found for key ${f}`);
        o && (n = Qr(g, x, n, E));
        const d = Zr(g, n, o);
        if (a) {
          const p = Jr(g),
            w = g.customType ?? g.type,
            q = ((y = C.get(g.branch)) == null ? void 0 : y.index) ?? 0;
          (_r(s, g, d, p, q, w), Vr(e, g, d, n), Xr(e, g, d, n));
        }
        (x === "TB" || x === "BT"
          ? E.set(g.id, { x: d.x, y: d.posWithOffset })
          : E.set(g.id, { x: d.posWithOffset, y: d.y }),
          (n = x === "BT" && o ? n + I : n + I + R),
          n > M && (M = n));
      }));
  }, "drawCommits"),
  Fr = h((t, r, a, s, e) => {
    const c = (x === "TB" || x === "BT" ? a.x < s.x : a.y < s.y) ? r.branch : t.branch,
      o = h((l) => l.branch === c, "isOnBranchToGetCurve"),
      $ = h((l) => l.seq > t.seq && l.seq < r.seq, "isBetweenCommits");
  ...
  Ur = h((t, r, a, s) => {
    ...
    const e = E.get(r.id),
      n = E.get(a.id);
    if (e === void 0 || n === void 0) throw new Error(`Commit positions not found for commits ${r.id} and ${a.id}`);
    const c = Fr(r, a, e, n, s);
    let o = "",
      $ = "",
      l = 0,
      f = 0,
      g = (y = C.get(a.branch)) == null ? void 0 : y.index;
    a.type === u.MERGE && r.id !== a.parents[0] && (g = (p = C.get(r.branch)) == null ? void 0 : p.index);
    let d;
    if (c) {
      ((o = "A 10 10, 0, 0, 0,"), ($ = "A 10 10, 0, 0, 1,"), (l = 10), (f = 10));
      const T = e.y < n.y ? H(e.y, n.y) : H(n.y, e.y),
        v = e.x < n.x ? H(e.x, n.x) : H(n.x, e.x);
      x === "TB"
        ? e.x < n.x
          ? (d = `M ${e.x} ${e.y} L ${v - l} ${e.y} ${$} ${v} ${e.y + f} L ${v} ${n.y - l} ${o} ${v + f} ${n.y} L ${n.x} ${n.y}`)
          : ((g = (w = C.get(r.branch)) == null ? void 0 : w.index),
            (d = `M ${e.x} ${e.y} L ${v + l} ${e.y} ${o} ${v} ${e.y + f} L ${v} ${n.y - l} ${$} ${v - f} ${n.y} L ${n.x} ${n.y}`))
        : x === "BT"
          ? e.x < n.x
            ? (d = `M ${e.x} ${e.y} L ${v - l} ${e.y} ${o} ${v} ${e.y - f} L ${v} ${n.y + l} ${$} ${v + f} ${n.y} L ${n.x} ${n.y}`)
            : ((g = (q = C.get(r.branch)) == null ? void 0 : q.index),
              (d = `M ${e.x} ${e.y} L ${v + l} ${e.y} ${$} ${v} ${e.y - f} L ${v} ${n.y + l} ${o} ${v - f} ${n.y} L ${n.x} ${n.y}`))
          : e.y < n.y
            ? (d = `M ${e.x} ${e.y} L ${e.x} ${T - l} ${o} ${e.x + f} ${T} L ${n.x - l} ${T} ${$} ${n.x} ${T + f} L ${n.x} ${n.y}`)
            : ((g = (Y = C.get(r.branch)) == null ? void 0 : Y.index),
              (d = `M ${e.x} ${e.y} L ${e.x} ${T + l} ${$} ${e.x + f} ${T} L ${n.x - l} ${T} ${o} ${n.x} ${T - f} L ${n.x} ${n.y}`));
    } else
      ((o = "A 20 20, 0, 0, 0,"),
        ($ = "A 20 20, 0, 0, 1,"),
        (l = 20),
        ...
        x === "TB"
          ? (e.x < n.x &&
              (a.type === u.MERGE && r.id !== a.parents[0]
                ? (d = `M ${e.x} ${e.y} L ${e.x} ${n.y - l} ${o} ${e.x + f} ${n.y} L ${n.x} ${n.y}`)
                : (d = `M ${e.x} ${e.y} L ${n.x - l} ${e.y} ${$} ${n.x} ${e.y + f} L ${n.x} ${n.y}`)),
            e.x > n.x &&
              ((o = "A 20 20, 0, 0, 0,"),
              ($ = "A 20 20, 0, 0, 1,"),
              (l = 20),
              (f = 20),
              a.type === u.MERGE && r.id !== a.parents[0]
                ? (d = `M ${e.x} ${e.y} L ${e.x} ${n.y - l} ${$} ${e.x - f} ${n.y} L ${n.x} ${n.y}`)
                : (d = `M ${e.x} ${e.y} L ${n.x + l} ${e.y} ${o} ${n.x} ${e.y + f} L ${n.x} ${n.y}`)),
            e.x === n.x && (d = `M ${e.x} ${e.y} L ${n.x} ${n.y}`))
          : x === "BT"
            ? (e.x < n.x &&
                (a.type === u.MERGE && r.id !== a.parents[0]
                  ? (d = `M ${e.x} ${e.y} L ${e.x} ${n.y + l} ${$} ${e.x + f} ${n.y} L ${n.x} ${n.y}`)
            ...
            : (e.y < n.y &&
              ...
              e.y > n.y &&
                (a.type === u.MERGE && r.id !== a.parents[0]
                  ? (d = `M ${e.x} ${e.y} L ${n.x - l} ${e.y} ${o} ${n.x} ${e.y - f} L ${n.x} ${n.y}`)
                  : (d = `M ${e.x} ${e.y} L ${e.x} ${n.y + l} ${$} ${e.x + f} ${n.y} L ${n.x} ${n.y}`)),
              e.y === n.y && (d = `M ${e.x} ${e.y} L ${n.x} ${n.y}`)));
    if (d === void 0) throw new Error("Line definition not found");
    t.append("path")
      .attr("d", d)
      .attr("class", "arrow arrow" + (g % O));
  }, "drawArrow"),
  re = h((t, r) => {
  ...
  ee = h((t, r) => {
    ...
    r.forEach((s, e) => {
      var p;
      const n = e % O,
        c = (p = C.get(s.name)) == null ? void 0 : p.pos;
      ...
      (o.attr("x1", 0),
        ...
        x === "TB"
          ? (o.attr("y1", P), o.attr("x1", c), o.attr("y2", M), o.attr("x2", c))
          : x === "BT" && (o.attr("y1", M), o.attr("x1", c), o.attr("y2", P), o.attr("x2", c)),
        W.push(c));
      const $ = s.name,
        l = J($),
        f = a.insert("rect"),
      ...
      (f
        ...
        .attr("rx", 4)
        .attr("ry", 4)
        .attr("x", -y.width - 4 - ((b == null ? void 0 : b.rotateCommitLabel) === !0 ? 30 : 0))
        .attr("y", -y.height / 2 + 8)
        ...
        d.attr(
          "transform",
          "translate(" +
            (-y.width - 14 - ((b == null ? void 0 : b.rotateCommitLabel) === !0 ? 30 : 0)) +
            ", " +
            (c - y.height / 2 - 1) +
            ")"
        ),
        x === "TB"
          ...
          : x === "BT"
            ? (f.attr("x", c - y.width / 2 - 10).attr("y", M),
              d.attr("transform", "translate(" + (c - y.width / 2 - 5) + ", " + M + ")"))
            : f.attr("transform", "translate(-19, " + (c - y.height / 2) + ")"));
    });
  }, "drawBranches"),
  te = h(function (t, r, a, s, e) {
    return (C.set(t, { pos: r, index: a }), (r += 50 + (e ? 40 : 0) + (x === "TB" || x === "BT" ? s.width / 2 : 0)), r);
  }, "setBranchPosition"),
  ae = h(function (t, r, a, s) {
    if (
      (Sr(),
      m.debug(
...
`,
    ...
    (c.forEach((l, f) => {
      ...
      const g = J(l.name),
        d = o.append("g"),
        y = d.insert("g").attr("class", "branchLabel"),
        p = y.insert("g").attr("class", "label branch-label");
      (q = p.node()) == null || q.appendChild(g);
      const w = g.getBBox();
      (($ = te(l.name, $, f, w, e)), p.remove(), y.remove(), d.remove());
    }),
      K(o, G, !1),
      b.showBranches && ee(o, c),
      re(o, G),
      K(o, G, !0),
      or.insertTitle(o, "gitTitleText", b.titleTopMargin ?? 0, n.getDiagramTitle()),
      cr(void 0, o, b.diagramPadding, b.useMaxWidth));
  }, "draw"),
  ne = { draw: ae },
  se = h(
    (t) => `
...
`,
  ...
  oe = se,
  ye = { parser: Wr, db: X, renderer: ne, styles: oe };
