const r = {
  ...
  token: function (n, e) {
    let i;
    if (
      (!e.inString && (i = n.match(/^('''|"""|'|")/)) && ((e.stringType = i[0]), (e.inString = !0)),
      n.sol() && !e.inString && e.inArray === 0 && (e.lhs = !0),
      e.inString)
    ) {
      for (; e.inString; )
        if (n.match(e.stringType)) e.inString = !1;
      ...
      if (
        e.lhs &&
        n.eatWhile(function (l) {
          return l != "=" && l != " ";
        })
      )
        return "property";
      if (e.lhs && n.peek() === "=") return (n.next(), (e.lhs = !1), null);
