...
var R1 = /([A-Z])/g,
  St = (r) => r.replace(R1, "-$1").toLowerCase(),
  I1 = { "&": "&amp;", ">": "&gt;", "<": "&lt;", '"': "&quot;", "'": "&#x27;" },
  N1 = /[&><"']/g,
  a0 = (r) => String(r).replace(N1, (e) => I1[e]),
  le = (r) =>
...
class zt {
  constructor(e) {
    (e === void 0 && (e = {}), (e = e || {}));
    for (var t of Object.keys(ot)) {
      var a = ot[t],
        n = e[t];
      this[t] = n !== void 0 ? (a.processor ? a.processor(n) : n) : F1(a);
    }
  }
...
var Mt = 0,
  ...
  L1 = [ue, p0, ue, p0, _0, s0, _0, s0],
  P1 = [p0, p0, p0, p0, s0, s0, s0, s0],
  G1 = [Q0, T0, ue, p0, _0, s0, _0, s0],
  U1 = [T0, T0, p0, p0, s0, s0, s0, s0],
  V1 = [De, De, T0, T0, p0, p0, s0, s0],
  X1 = [Mt, De, Q0, T0, Q0, T0, Q0, T0],
  N = { DISPLAY: x0[Mt], TEXT: x0[Q0], SCRIPT: x0[ue], SCRIPTSCRIPT: x0[_0] },
  ht = [
    {
      name: "latin",
      blocks: [
...
function Y1(r) {
  for (var e = 0; e < ht.length; e++)
    for (var t = ht[e], a = 0; a < t.blocks.length; a++) {
      var n = t.blocks[a];
...
var Be = [];
ht.forEach((r) => r.blocks.forEach((e) => Be.push(...e)));
function Cr(r) {
  for (var e = 0; e < Be.length; e += 2) if (r >= Be[e] && r <= Be[e + 1]) return !0;
  return !1;
}
var J0 = 80,
  $1 = function (e, t) {
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`
  ...
  ra = { ex: !0, em: !0, mu: !0 },
  qr = function (e) {
    return (typeof e != "string" && (e = e.unit), e in mt || e in ra || e === "ex");
  },
  Z = function (e, t) {
    var a;
  ...
  Ir = function (e) {
    var t = "<" + e;
    this.classes.length && (t += ' class="' + a0(O0(this.classes)) + '"');
    var a = "";
    for (var n of Object.keys(this.style)) a += St(n) + ":" + this.style[n] + ";";
    a && (t += ' style="' + a0(a) + '"');
    for (var l of Object.keys(this.attributes)) {
      if (aa.test(l)) throw new S("Invalid attribute name '" + l + "'");
...
class na {
  ...
  toMarkup() {
    var e = '<img src="' + a0(this.src) + '"' + (' alt="' + a0(this.alt) + '"'),
      t = "";
    for (var a of Object.keys(this.style)) t += St(a) + ":" + this.style[a] + ";";
    return (t && (e += ' style="' + a0(t) + '"'), (e += "'/>"), e);
  }
}
var ia = { î: "ı̂", ï: "ı̈", í: "ı́", ì: "ı̀" };
class v0 {
  constructor(e, t, a, n, l, u, h, c) {
    ((this.text = e),
      ...
      (this.style = c || {}),
      (this.maxFontSize = 0));
    var p = Y1(this.text.charCodeAt(0));
    (p && this.classes.push(p + "_fallback"), /[îïíì]/.test(this.text) && (this.text = ia[this.text]));
  }
  hasClass(e) {
    return this.classes.includes(e);
  }
  toNode() {
    ...
    (this.italic > 0 && ((t = document.createElement("span")), (t.style.marginRight = M(this.italic))),
      this.classes.length > 0 && ((t = t || document.createElement("span")), (t.className = O0(this.classes))));
  ...
  toMarkup() {
    var e = !1,
      t = "<span";
    this.classes.length && ((e = !0), (t += ' class="'), (t += a0(O0(this.classes))), (t += '"'));
    var a = "";
...
class B0 {
  ...
  toMarkup() {
    ...
    for (var t of Object.keys(this.attributes)) e += " " + t + '="' + a0(this.attributes[t]) + '"';
    e += ">";
...
class F0 {
  ...
  toNode() {
    ...
    return (this.alternate ? t.setAttribute("d", this.alternate) : t.setAttribute("d", Jt[this.pathName]), t);
  }
  toMarkup() {
    return this.alternate ? '<path d="' + a0(this.alternate) + '"/>' : '<path d="' + a0(Jt[this.pathName]) + '"/>';
  }
}
class ct {
  constructor(e) {
...
function Tt(r, e, t) {
  if (!w0[e]) throw new Error("Font metrics not found for font: " + e + ".");
  var a = r.charCodeAt(0),
    n = w0[e][a];
  if (
    (!n && r[0] in _t && ((a = _t[r[0]].charCodeAt(0)), (n = w0[e][a])),
    !n && t === "text" && Cr(a) && (n = w0[e][77]),
    n)
  )
...
function ua(r) {
  var e;
  if ((r >= 5 ? (e = 0) : r >= 3 ? (e = 1) : (e = 2), !We[e])) {
    var t = (We[e] = { cssEmPerMu: ye.quad[e] / 18 });
    for (var a in ye) ye.hasOwnProperty(a) && (t[a] = ye[a][e]);
  }
  return We[e];
}
var oa = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  ha = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
  J = { math: {}, text: {} };
...
i(s, o, u0, "⎱", "\\rmoustache", !0);
i(s, o, d0, "⎰", "\\lmoustache", !0);
i(s, o, u0, "⟯", "\\rgroup", !0);
i(s, o, d0, "⟮", "\\lgroup", !0);
i(s, o, D, "∓", "\\mp", !0);
i(s, o, D, "⊖", "\\ominus", !0);
...
i(s, o, e0, "⨆", "\\bigsqcup");
i(s, o, e0, "∫", "\\smallint");
i(w, o, re, "…", "\\textellipsis");
i(s, o, re, "…", "\\mathellipsis");
i(w, o, re, "…", "\\ldots", !0);
i(s, o, re, "…", "\\ldots", !0);
i(s, o, re, "⋯", "\\@cdots", !0);
i(s, o, re, "⋱", "\\ddots", !0);
...
i(w, o, v, "°", "\\textdegree", !0);
i(s, o, v, "£", "\\pounds");
i(s, o, v, "£", "\\mathsterling", !0);
i(w, o, v, "£", "\\pounds");
i(w, o, v, "£", "\\textsterling", !0);
i(s, d, v, "✠", "\\maltese");
i(w, d, v, "✠", "\\maltese");
var er = '0123456789/@."';
...
var rr = '0123456789!@*()-=+";:?/.,';
for (var Ze = 0; Ze < rr.length; Ze++) {
  var ar = rr.charAt(Ze);
  i(w, o, v, ar, ar);
}
var Ce = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
...
i(w, o, E, "h", "ℎ");
var R = "";
for (var i0 = 0; i0 < Ce.length; i0++) {
  var K = Ce.charAt(i0);
  ((R = String.fromCharCode(55349, 56320 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56372 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56424 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56580 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56684 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56736 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56788 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56840 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    (R = String.fromCharCode(55349, 56944 + i0)),
    i(s, o, E, K, R),
    i(w, o, v, K, R),
    i0 < 26 &&
      ((R = String.fromCharCode(55349, 56632 + i0)),
      i(s, o, E, K, R),
      i(w, o, v, K, R),
      (R = String.fromCharCode(55349, 56476 + i0)),
      i(s, o, E, K, R),
      i(w, o, v, K, R)));
}
R = "𝕜";
...
for (var V0 = 0; V0 < 10; V0++) {
  var H0 = V0.toString();
  ((R = String.fromCharCode(55349, 57294 + V0)),
    i(s, o, E, H0, R),
    i(w, o, v, H0, R),
    (R = String.fromCharCode(55349, 57314 + V0)),
    i(s, o, E, H0, R),
    i(w, o, v, H0, R),
    (R = String.fromCharCode(55349, 57324 + V0)),
    i(s, o, E, H0, R),
    i(w, o, v, H0, R),
    (R = String.fromCharCode(55349, 57334 + V0)),
    i(s, o, E, H0, R),
    i(w, o, v, H0, R));
}
var dt = "ÐÞþ";
...
var Ne = function (e, t, a) {
    ...
    return { value: e, metrics: Tt(e, t, a) };
  },
  l0 = function (e, t, a, n, l) {
    ...
    if (h) {
      ...
      ((a === "text" || (n && n.font === "mathit")) && (p = 0),
        (c = new v0(e, h.height, h.depth, p, h.skew, h.width, l)));
    } else (typeof console < "u", (c = new v0(e, 0, 0, 0, 0, 0, l)));
    if (n) {
  ...
  Bt = function (e, t, a, n) {
    return (
      n === void 0 && (n = []),
      a.font === "boldsymbol" && Ne(e, "Main-Bold", t).metrics
        ? l0(e, "Main-Bold", t, a, n.concat(["mathbf"]))
        : e === "\\" || J[t][e].font === "main"
          ? l0(e, "Main-Regular", t, a, n)
          : l0(e, "AMS-Regular", t, a, n.concat(["amsrm"]))
    );
  },
  ca = function (e, t, a, n, l) {
    return l !== "textord" && Ne(e, "Math-BoldItalic", t).metrics
  ...
  He = function (e, t, a) {
    var n = e.mode,
      ...
      p = "",
      g = "";
    if ((l.charCodeAt(0) === 55349 && ([p, g] = ma(l, n)), p.length > 0)) return l0(l, p, n, t, u.concat(g));
    if (c) {
      var b, y;
      if (c === "boldsymbol") {
        var x = ca(l, n, t, u, a);
        ...
        h
          ? ((b = ft[c].fontName), (y = [c]))
          : ((b = Se(c, t.fontWeight, t.fontShape)), (y = [c, t.fontWeight, t.fontShape]));
      if (Ne(l, b, n).metrics) return l0(l, b, n, t, u.concat(y));
      if (Nr.hasOwnProperty(l) && b.slice(0, 10) === "Typewriter") {
        for (var A = [], T = 0; T < l.length; T++) A.push(l0(l[T], b, n, t, u.concat(y)));
        return q0(A);
      }
    }
    if (a === "mathord") return l0(l, "Math-Italic", n, t, u.concat(["mathnormal"]));
    if (a === "textord") {
  ...
  k = function (e, t, a, n) {
    var l = new he(e, t, a, n);
    return (Dt(l), l);
  },
  L0 = (r, e, t, a) => new he(r, e, t, a),
  ee = function (e, t, a) {
    var n = k([e], [], t);
    return (
  ...
  te = function (e, t) {
    return e instanceof me ? k([], [e], t) : e;
  },
  pa = function (e) {
  ...
  U = function (e, t) {
    for (var { children: a, depth: n } = pa(e), l = 0, u = 0; u < a.length; u++) {
      var h = a[u];
      if (h.type === "elem") {
        var c = h.elem;
    ...
    if (b < 0) {
      var L = k([], []),
        P = k(["vlist"], [L]);
      P.style.height = M(-b);
      var $ = k(["vlist-s"], [new v0("​")]);
      V = [k(["vlist-r"], [F, $]), k(["vlist-r"], [P])];
    } else V = [k(["vlist-r"], [F])];
    var X = k(["vlist-t"], V);
  ...
  M0 = { number: 5, unit: "mu" },
  va = {
    mord: { mop: j, mbin: X0, mrel: M0, minner: j },
    mop: { mord: j, mop: j, mrel: M0, minner: j },
    mbin: { mord: X0, mop: X0, mopen: X0, minner: X0 },
    mrel: { mord: M0, mop: M0, mopen: M0, minner: M0 },
    mopen: {},
    mclose: { mop: j, mbin: X0, mrel: M0, minner: j },
    mpunct: { mord: j, mop: j, mrel: M0, mopen: j, mclose: j, mpunct: j, minner: j },
    minner: { mord: j, mop: j, mbin: X0, mrel: M0, mopen: j, mpunct: j, minner: j },
  },
  ga = {
    mord: { mop: j },
    mop: { mord: j, mop: j },
...
var Re = function (e) {
  ...
  ba = new Set(["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]),
  ya = new Set(["rightmost", "mrel", "mclose", "mpunct"]),
  xa = { display: N.DISPLAY, text: N.TEXT, script: N.SCRIPT, scriptscript: N.SCRIPTSCRIPT },
  wa = {
    mord: "mord",
    mop: "mop",
    mbin: "mbin",
  ...
  r0 = function (e, t, a, n) {
    ...
    if (e.length === 1) {
      var g = e[0];
      g.type === "sizing" ? (p = t.havingSize(g.size)) : g.type === "styling" && (p = t.havingStyle(xa[g.style]));
    }
    ...
    return (
      pt(
        ...
        (A, T) => {
          var C = T.classes[0],
            q = A.classes[0];
          C === "mbin" && ya.has(q) ? (T.classes[0] = "mord") : q === "mbin" && ba.has(C) && (A.classes[0] = "mord");
        },
        { node: b },
        y,
        x
  ...
  pt = function (e, t, a, n, l) {
    n && e.push(n);
    for (var u = 0; u < e.length; u++) {
      var h = e[u],
        c = Gr(h);
      if (c) {
        pt(c.children, t, a, null, l);
        continue;
      }
      ...
      (p ? (a.node = h) : l && h.hasClass("newline") && (a.node = k(["leftmost"])),
        (a.insertAfter = ((b) => (y) => {
          (e.splice(b + 1, 0, y), u++);
        })(u)));
    }
  ...
  Gr = function (e) {
    return e instanceof me || e instanceof At || (e instanceof he && e.hasClass("enclosing")) ? e : null;
  },
  vt = function (e, t) {
    var a = Gr(e);
    if (a) {
...
function bt(r, e) {
  ...
  for (var l = [], u = [], h = 0; h < a.length; h++)
    if ((u.push(a[h]), a[h].hasClass("mbin") || a[h].hasClass("mrel") || a[h].hasClass("allowbreak"))) {
      ...
      c || (l.push(ze(u, e)), (u = []));
    } else a[h].hasClass("newline") && (u.pop(), u.length > 0 && (l.push(ze(u, e)), (u = [])), l.push(a[h]));
  u.length > 0 && l.push(ze(u, e));
  var p;
  t ? ((p = ze(r0(t, e, !0), e)), (p.classes = ["tag"]), l.push(p)) : n && l.push(n);
  ...
  toMarkup() {
    ...
    for (var t in this.attributes)
      Object.prototype.hasOwnProperty.call(this.attributes, t) &&
        ((e += " " + t + '="'), (e += a0(this.attributes[t])), (e += '"'));
    (this.classes.length > 0 && (e += ' class ="' + a0(O0(this.classes)) + '"'), (e += ">"));
    for (var a = 0; a < this.children.length; a++) e += this.children[a].toMarkup();
...
var ka = new Set(["\\imath", "\\jmath"]),
  Sa = new Set(["mrow", "mtable"]),
  g0 = function (e, t, a) {
    return (
      J[t][e] &&
        J[t][e].replace &&
  ...
  qt = function (e, t) {
    ...
    var l = e.text;
    if (ka.has(l)) return null;
    if (J[n][l]) {
      var u = J[n][l].replace;
      u && (l = u);
    }
    var h = ft[a].fontName;
    return Tt(l, h, n) ? ft[a].variant : null;
  };
function Qe(r) {
  if (!r) return !1;
    ...
    for (var l = [], u, h = 0; h < e.length; h++) {
      ...
      if (c instanceof z && u instanceof z) {
        if (
          ...
          u.children.push(...c.children);
          continue;
        } else if (Qe(c) && u.type === "mn") {
          u.children.push(...c.children);
          continue;
        } else if (c.type === "mn" && Qe(u)) ((c.children = [...u.children, ...c.children]), l.pop());
        else if ((c.type === "msup" || c.type === "msub") && c.children.length >= 1 && (u.type === "mn" || Qe(u))) {
          var p = c.children[0];
          p instanceof z && p.type === "mn" && ((p.children = [...u.children, ...p.children]), l.pop());
...
function ir(r, e, t, a, n) {
  var l = f0(r, t),
    u;
  l.length === 1 && l[0] instanceof z && Sa.has(l[0].type) ? (u = l[0]) : (u = new z("mrow", l));
...
var Xr = function (e) {
  ...
  Oe = function (e) {
    var t = new z("mo", [new _(Ta[e.replace(/^\\/, "")])]);
  ...
  Da = new Set(["widehat", "widecheck", "widetilde", "utilde"]),
  Fe = function (e, t) {
    function a() {
      var h = 4e5,
        c = e.label.slice(1);
      if (Da.has(c)) {
        var p = e,
          g = p.base.type === "ordgroup" ? p.base.body.length : 1,
          b,
          y,
          x;
        if (g > 5)
        ...
        var T = new F0(y),
          C = new B0([T], { width: "100%", height: M(x), viewBox: "0 0 " + h + " " + b, preserveAspectRatio: "none" });
        return { span: L0([], [C], t), minWidth: 0, height: x };
      } else {
        var q = [],
          I = Ba[c],
          [H, F, V] = I,
        ...
        if (P === 1) {
          var o0 = I[3];
          (($ = ["hide-tail"]), (X = [o0]));
        } else if (P === 2) (($ = ["halfarrow-left", "halfarrow-right"]), (X = ["xMinYMin", "xMaxYMin"]));
        else if (P === 3)
          (($ = ["brace-left", "brace-center", "brace-right"]), (X = ["xMinYMin", "xMidYMin", "xMaxYMin"]));
        else
          throw new Error(
        ...
        for (var n0 = 0; n0 < P; n0++) {
          var t0 = new F0(H[n0]),
            ...
            h0 = L0([$[n0]], [U0], t);
          if (P === 1) return { span: h0, minWidth: F, height: L };
  ...
  Ca = function (e, t, a, n, l) {
    ...
    if (/fbox|color|angl/.test(t)) {
      ...
      var p = [];
      (/^[bx]cancel$/.test(t) &&
        p.push(new ct({ x1: "0", y1: "0", x2: "100%", y2: "100%", "stroke-width": "0.046em" })),
        /^x?cancel$/.test(t) &&
          p.push(new ct({ x1: "0", y1: "100%", x2: "100%", y2: "0", "stroke-width": "0.046em" })));
      var g = new B0(p, { width: "100%", height: M(h) });
      u = L0([], [g], l);
    }
...
function Pe(r) {
  return r && (r.type === "atom" || ha.hasOwnProperty(r.type)) ? r : null;
}
var Et = (r, e) => {
    var t, a, n;
    r && r.type === "supsub"
      ? ((a = O(r.base, "accent")), (t = a.base), (r.base = t), (n = la(G(r, e))), (r.base = a))
      : ((a = O(r, "accent")), (t = a.base));
    var l = G(t, e.havingCrampedStyle()),
      u = a.isShifty && D0(t),
      h = 0;
    if (u) {
      var c = le(t),
        p = G(c, e.havingCrampedStyle());
      h = Qt(p).skew;
    }
    var g = a.label === "\\c",
    ...
    if (a.isStretchy)
      ...
      (a.label === "\\vec"
        ...
        : ((x = He({ mode: a.mode, text: a.label }, e, "textord")),
          (x = Qt(x)),
          (x.italic = 0),
          (A = x.width),
          g && (b += x.depth)),
  ...
  $r = (r, e) => {
    var t = r.isStretchy ? Oe(r.label) : new z("mo", [g0(r.label, r.mode)]),
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    var u;
    r.below && ((a = e.havingStyle(t.sub())), (u = te(G(r.below, a, e), e)), u.classes.push(l + "-arrow-pad"));
    var h = Fe(r, e),
  ...
  mathmlBuilder(r, e) {
    ...
    if (r.body) {
      var n = Me(Y(r.body, e));
      if (r.below) {
        var l = Me(Y(r.below, e));
        a = new z("munderover", [t, l, n]);
      } else a = new z("mover", [t, n]);
    } else if (r.below) {
      var u = Me(Y(r.below, e));
      a = new z("munder", [t, u]);
    } else ((a = Me()), (a = new z("mover", [t, a])));
    return a;
  },
});
function Wr(r, e) {
...
B({
  ...
  handler(r, e) {
    var { parser: t, funcName: a } = r,
      n = e[0];
    return { type: "mclass", mode: t.mode, mclass: "m" + a.slice(5), body: Q(n), isCharacterBox: D0(n) };
  },
  htmlBuilder: Wr,
  mathmlBuilder: jr,
});
...
B({
  ...
  handler(r, e) {
    var { parser: t } = r;
    return { type: "mclass", mode: t.mode, mclass: Ge(e[0]), body: Q(e[1]), isCharacterBox: D0(e[1]) };
  },
});
B({
  type: "mclass",
  ...
  handler(r, e) {
    ...
    return { type: "mclass", mode: t.mode, mclass: u, body: [c], isCharacterBox: D0(c) };
  },
  htmlBuilder: Wr,
  mathmlBuilder: jr,
});
B({
  ...
  handler(r, e) {
    var { parser: t } = r;
    return { type: "pmb", mode: t.mode, mclass: Ge(e[0]), body: Q(e[0]) };
  },
  htmlBuilder(r, e) {
    var t = r0(r.body, e, !0),
      a = k([r.mclass], t, e);
...
var Ea = {
  ...
  Ra = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function Ia(r, e, t) {
  var a = Ea[r];
  switch (a) {
    case "\\\\cdrightarrow":
          ...
          if ("<>AV".includes(p))
            for (var b = 0; b < 2; b++) {
              for (var y = !0, x = c + 1; x < u.length; x++) {
                ...
                if (or(u[x])) throw new S("Missing a " + p + " character to complete a CD arrow.", u[x]);
                g[b].body.push(u[x]);
              }
              if (y) throw new S("Missing a " + p + " character to complete a CD arrow.", u[c]);
            }
...
var Zr = (r, e) => {
  ...
  Kr = (r, e) => {
    var t = f0(r.body, e.withColor(r.color)),
      a = new z("mstyle", t);
...
B({
  ...
  handler(r, e, t) {
    ...
    return { type: "cr", mode: a.mode, newLine: l, size: n && O(n, "size").value };
  },
  htmlBuilder(r, e) {
    var t = k(["mspace"], [], e);
...
B({
  ...
  handler(r) {
    ...
    var a = e.fetch();
    if (yt[a.text])
      return ((t === "\\global" || t === "\\\\globallong") && (a.text = yt[a.text]), O(e.parseFunction(), "internal"));
...
B({
  ...
  handler(r) {
    ...
    return (
      ...
      e.gullet.macros.set(n, { tokens: c, numArgs: l, delimiters: h }, t === yt[t]),
...
B({
  ...
  handler(r) {
    var { parser: e, funcName: t } = r,
      a = Jr(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var n = Ha(e);
    return (Qr(e, a, n, t === "\\\\globallet"), { type: "internal", mode: e.mode });
  },
});
B({
  type: "internal",
...
var ie = function (e, t, a) {
  ...
  Oa = function (e, t, a, n, l, u) {
    var h = l0(e, "Main-Regular", l, n),
      c = Rt(h, t, n, u);
    return (_r(c, n, t), c);
  },
  Fa = function (e, t, a, n) {
  ...
  e1 = function (e, t, a, n, l, u) {
    var h = Fa(e, t, l, n),
      c = Rt(k(["delimsizing", "size" + t], [h], n), N.TEXT, n, u);
    return (a && _r(c, n, N.TEXT), c);
  },
  _e = function (e, t, a) {
    var n;
    t === "Size1-Regular" ? (n = "delim-size1") : (n = "delim-size4");
    var l = k(["delimsizinginner", n], [k([], [l0(e, t, a)])]);
    return { type: "elem", elem: l };
  },
  et = function (e, t, a) {
    var n = w0["Size4-Regular"][e.charCodeAt(0)]
        ? w0["Size4-Regular"][e.charCodeAt(0)][4]
        : w0["Size1-Regular"][e.charCodeAt(0)][4],
      l = new F0("inner", ea(e, Math.round(1e3 * t))),
      u = new B0([l], {
        width: M(n),
        height: M(t),
        style: "width:" + M(n),
  ...
  xt = 0.008,
  Ae = { type: "kern", size: -1 * xt },
  La = new Set(["|", "\\lvert", "\\rvert", "\\vert"]),
  Pa = new Set(["\\|", "\\lVert", "\\rVert", "\\Vert"]),
  t1 = function (e, t, a, n, l, u) {
            ...
            : e === "\\updownarrow"
              ...
              : e === "\\Updownarrow"
                ...
                : La.has(e)
                  ? ((p = "∣"), (b = "vert"), (y = 333))
                  : Pa.has(e)
                    ? ((p = "∥"), (b = "doublevert"), (y = 556))
                    : e === "[" || e === "\\lbrack"
                      ? ((h = "⎡"), (p = "⎢"), (g = "⎣"), (x = "Size4-Regular"), (b = "lbrack"), (y = 667))
                      : e === "]" || e === "\\rbrack"
                        ? ((h = "⎤"), (p = "⎥"), (g = "⎦"), (x = "Size4-Regular"), (b = "rbrack"), (y = 667))
                        : e === "\\lfloor" || e === "⌊"
                          ? ((p = h = "⎢"), (g = "⎣"), (x = "Size4-Regular"), (b = "lfloor"), (y = 667))
                          : e === "\\lceil" || e === "⌈"
                            ? ((h = "⎡"), (p = g = "⎢"), (x = "Size4-Regular"), (b = "lceil"), (y = 667))
                            : e === "\\rfloor" || e === "⌋"
                              ? ((p = h = "⎥"), (g = "⎦"), (x = "Size4-Regular"), (b = "rfloor"), (y = 667))
                              : e === "\\rceil" || e === "⌉"
                                ? ((h = "⎤"), (p = g = "⎥"), (x = "Size4-Regular"), (b = "rceil"), (y = 667))
                                : e === "(" || e === "\\lparen"
                                  ? ((h = "⎛"), (p = "⎜"), (g = "⎝"), (x = "Size4-Regular"), (b = "lparen"), (y = 875))
                                  : e === ")" || e === "\\rparen"
                                    ? ((h = "⎞"),
                                      (p = "⎟"),
                                      (g = "⎠"),
    ...
    var P = T + H + F,
      $ = Math.max(0, Math.ceil((t - P) / (V * q))),
      X = P + $ * V * q,
      o0 = n.fontMetrics().axisHeight;
    ...
    if (b.length > 0) {
      var U0 = X - T - H,
        h0 = Math.round(X * 1e3),
        b0 = ta(b, Math.round(U0 * 1e3)),
        E0 = new F0(b, b0),
        W0 = (y / 1e3).toFixed(3) + "em",
        j0 = (h0 / 1e3).toFixed(3) + "em",
        Ye = new B0([E0], { width: W0, height: j0, viewBox: "0 0 " + y + " " + h0 }),
        R0 = L0([], [Ye], n);
      ((R0.height = h0 / 1e3), (R0.style.width = W0), (R0.style.height = j0), t0.push({ type: "elem", elem: R0 }));
    } else {
      if ((t0.push(_e(g, x, l)), t0.push(Ae), c === null)) {
        var I0 = X - T - H + 2 * xt;
        t0.push(et(p, I0, n));
      } else {
        var ne = (X - T - H - F) / 2 + 2 * xt;
        (t0.push(et(p, ne, n)), t0.push(Ae), t0.push(_e(c, x, l)), t0.push(Ae), t0.push(et(p, ne, n)));
      }
      (t0.push(Ae), t0.push(_e(h, x, l)));
    }
    var y0 = n.havingBaseStyle(N.TEXT),
      de = U({ positionType: "bottom", positionData: n0, children: t0 });
    return Rt(k(["delimsizing", "mult"], [de], y0), N.TEXT, n, u);
  },
  tt = 80,
  rt = 0.08,
  at = function (e, t, a, n, l) {
    var u = _1(e, n, a),
      h = new F0(e, u),
      c = new B0([h], {
        width: "400em",
    ...
    return L0(["hide-tail"], [c], l);
  },
  Ga = function (e, t) {
    var a = t.havingBaseSizing(),
      n = l1("\\surd", e * a.sizeMultiplier, i1, a),
      l = a.sizeMultiplier,
      ...
      n.type === "small"
        ...
        : n.type === "large"
          ? ((g = (1e3 + tt) * se[n.size]),
            (p = (se[n.size] + u) / l),
            (c = (se[n.size] + u + rt) / l),
            (h = at("sqrtSize" + n.size, c, g, u, t)),
            (h.style.minWidth = "1.02em"),
            (b = 1 / l))
          : ((c = e + u + rt),
            (p = e + u),
            (g = Math.floor(1e3 * e + u) + tt),
            (h = at("sqrtTall", c, g, u, t)),
  ...
  a1 = new Set(["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"]),
  se = [0, 1.2, 1.8, 2.4, 3],
  n1 = function (e, t, a, n, l) {
    if (
      (e === "<" || e === "\\lt" || e === "⟨"
        ? (e = "\\langle")
        : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"),
      ...
      return e1(e, t, !1, a, n, l);
    if (Ua.has(e)) return t1(e, se[t], !1, a, n, l);
  ...
  wt = function (e, t, a, n, l, u) {
    e === "<" || e === "\\lt" || e === "⟨"
      ? (e = "\\langle")
      : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
    var h;
    a1.has(e) ? (h = Va) : r1.has(e) ? (h = i1) : (h = Xa);
    var c = l1(e, t, h, n);
    return c.type === "small"
      ? Oa(e, c.style, a, n, l, u)
      : c.type === "large"
        ? e1(e, c.size, a, n, l, u)
        : t1(e, t, a, n, l, u);
  },
  nt = function (e, t, a, n, l, u) {
    var h = n.fontMetrics().axisHeight * n.sizeMultiplier,
      c = 901,
      p = 5 / n.fontMetrics().ptPerEm,
      g = Math.max(t - h, a + h),
      b = Math.max((g / 500) * c, 2 * g - p);
    return wt(e, b, !0, n, l, u);
  },
  hr = {
...
B({
  ...
  htmlBuilder: (r, e) => (r.delim === "." ? k([r.mclass]) : n1(r.delim, r.size, e, r.mode, [r.mclass])),
  mathmlBuilder: (r) => {
    var e = [];
...
B({
  ...
  handler: (r, e) => {
    ...
    return { type: "leftright-right", mode: r.parser.mode, delim: Ue(e[0], r).text, color: t };
  },
});
B({
  type: "leftright",
  ...
  htmlBuilder: (r, e) => {
    mr(r);
    for (var t = r0(r.body, e, !0, ["mopen", "mclose"]), a = 0, n = 0, l = !1, u = 0; u < t.length; u++)
      t[u].isMiddle ? (l = !0) : ((a = Math.max(t[u].height, a)), (n = Math.max(t[u].depth, n)));
    ((a *= e.sizeMultiplier), (n *= e.sizeMultiplier));
    var h;
    if ((r.left === "." ? (h = oe(e, ["mopen"])) : (h = nt(r.left, a, n, e, r.mode, ["mopen"])), t.unshift(h), l))
      for (var c = 1; c < t.length; c++) {
        var p = t[c],
          g = p.isMiddle;
        g && (t[c] = nt(g.delim, a, n, g.options, r.mode, []));
      }
    var b;
    if (r.right === ".") b = oe(e, ["mclose"]);
    else {
      var y = r.rightColor ? e.withColor(r.rightColor) : e;
      b = nt(r.right, a, n, y, r.mode, ["mclose"]);
    }
...
var It = (r, e) => {
    ...
    if (a === "sout")
      ...
      var y = Math.floor(1e3 * b * n),
        x = J1(y),
        A = new B0([new F0("phase", x)], {
          width: "400em",
          height: M(y / 1e3),
          viewBox: "0 0 400000 " + y,
          preserveAspectRatio: "xMinYMin slice",
        });
      ((l = L0(["hide-tail"], [A], e)), (l.style.height = M(b)), (u = t.depth + c + p));
    } else {
      /cancel/.test(a)
    ...
    if (r.backgroundColor)
      ...
      I = U({
        ...
        children: [
          { type: "elem", elem: t, shift: 0 },
          { type: "elem", elem: l, shift: u, wrapperClasses: H },
        ],
      });
    }
    return (
  ...
  static range(e, t) {
    return t
      ? !e || !e.loc || !t.loc || e.loc.lexer !== t.loc.lexer
        ? null
        : new m0(e.loc.lexer, e.loc.start, t.loc.end)
      : e && e.loc;
  }
}
class c0 {
...
function G0(r, e, t) {
  ...
  function F() {
    I &&
      (r.gullet.macros.get("\\df@tag")
        ? (I.push(r.subparse([new c0("\\df@tag")])), r.gullet.macros.set("\\df@tag", void 0, !0))
  ...
  for (H(), q.push(cr(r)); ; ) {
    ...
    if (P === "&") {
      if (b && A.length === b) {
        if (p || h) throw new S("Too many tab characters: &", r.nextToken);
      ...
      r.consume();
      var $ = void 0;
      (r.gullet.future().text !== " " && ($ = r.parseSizeGroup(!0)),
        C.push($ ? $.value : null),
        F(),
        q.push(cr(r)),
        (A = []),
...
var S0 = function (e, t) {
    ...
    var A = e.colSeparationType === "CD" ? Z({ number: 3, unit: "ex" }, t) : 12 * b,
      ...
      H = 0;
    function F(ge) {
      for (var be = 0; be < ge.length; ++be) (be > 0 && (H += 0.25), p.push({ pos: H, isDashed: ge[be] }));
    }
    for (F(u[0]), a = 0; a < e.body.length; ++a) {
      ...
      var $ = new Array(V.length);
      for (n = 0; n < V.length; ++n) {
        var X = G(V[n], t);
        (P < X.depth && (P = X.depth), L < X.height && (L = X.height), ($[n] = X));
      }
      var o0 = e.rowGaps[a],
        n0 = 0;
      (o0 && ((n0 = Z(o0, t)), n0 > 0 && ((n0 += I), P < n0 && (P = n0), (n0 = 0))),
        e.addJot && (P += T),
        ($.height = L),
        ($.depth = P),
        (H += L),
    ...
    var t0 = H / 2 + t.fontMetrics().axisHeight,
      U0 = e.cols || [],
      h0 = [],
      b0,
      E0,
      W0 = [];
    if (e.tags && e.tags.some((ge) => ge))
      for (a = 0; a < l; ++a) {
        var j0 = c[a],
          Ye = j0.pos - t0,
          R0 = e.tags[a],
          I0 = void 0;
        (R0 === !0 ? (I0 = k(["eqn-num"], [], t)) : R0 === !1 ? (I0 = k([], [], t)) : (I0 = k([], r0(R0, t, !0), t)),
          (I0.depth = j0.depth),
          (I0.height = j0.height),
          W0.push({ type: "elem", elem: I0, shift: Ye }));
      }
    for (n = 0, E0 = 0; n < h || E0 < U0.length; ++n, ++E0) {
      for (var ne, y0 = U0[E0], de = !0; ((Ut = y0) == null ? void 0 : Ut.type) === "separator"; ) {
        var Ut;
        if (
          (de || ((b0 = k(["arraycolsep"], [])), (b0.style.width = M(t.fontMetrics().doubleRuleSep)), h0.push(b0)),
          y0.separator === "|" || y0.separator === ":")
        ) {
          var M1 = y0.separator === "|" ? "solid" : "dashed",
            Z0 = k(["vertical-separator"], [], t);
          ((Z0.style.height = M(H)),
            (Z0.style.borderRightWidth = M(g)),
            (Z0.style.borderRightStyle = M1),
            (Z0.style.margin = "0 " + M(-g / 2)));
          var Vt = H - t0;
          (Vt && (Z0.style.verticalAlign = M(-Vt)), h0.push(Z0));
        } else throw new S("Invalid separator type: " + y0.separator);
        (E0++, (y0 = U0[E0]), (de = !1));
      }
      if (!(n >= h)) {
        var K0 = void 0;
        if (n > 0 || e.hskipBeforeAndAfter) {
          var Xt, Yt;
          ((K0 = (Xt = (Yt = y0) == null ? void 0 : Yt.pregap) != null ? Xt : y),
            K0 !== 0 && ((b0 = k(["arraycolsep"], [])), (b0.style.width = M(K0)), h0.push(b0)));
        }
        var $t = [];
        for (a = 0; a < l; ++a) {
          var fe = c[a],
          ...
          if (pe) {
            var A1 = fe.pos - t0;
            ((pe.depth = fe.depth), (pe.height = fe.height), $t.push({ type: "elem", elem: pe, shift: A1 }));
          }
        }
        var T1 = U({ positionType: "individualShift", children: $t }),
          B1 = k(["col-align-" + (((ne = y0) == null ? void 0 : ne.align) || "c")], [T1]);
        if ((h0.push(B1), n < h - 1 || e.hskipBeforeAndAfter)) {
          var Wt, jt;
          ((K0 = (Wt = (jt = y0) == null ? void 0 : jt.postgap) != null ? Wt : y),
            K0 !== 0 && ((b0 = k(["arraycolsep"], [])), (b0.style.width = M(K0)), h0.push(b0)));
        }
      }
    }
    ...
    if (p.length > 0) {
      for (
        var D1 = ee("hline", t, g), C1 = ee("hdashline", t, g), $e = [{ type: "elem", elem: ve, shift: 0 }];
        p.length > 0;
      ) {
        var Zt = p.pop(),
          Kt = Zt.pos - t0;
        Zt.isDashed ? $e.push({ type: "elem", elem: C1, shift: Kt }) : $e.push({ type: "elem", elem: D1, shift: Kt });
      }
      ve = U({ positionType: "individualShift", children: $e });
    }
    if (W0.length === 0) return k(["mord"], [ve], t);
    var q1 = U({ positionType: "individualShift", children: W0 }),
      E1 = k(["tag"], [q1], t);
    return q0([ve, E1]);
  },
  ...
  z0 = function (e, t) {
    for (
      ...
      for (var h = e.body[u], c = [], p = 0; p < h.length; p++) c.push(new z("mtd", [Y(h[p], t)]));
    ...
    for (var o0 = 1; o0 < X.length - 1; o0++) $ += X[o0].length === 0 ? "none " : X[o0][0] ? "dashed " : "solid ";
    return (
      /[sd]/.test($) && g.setAttribute("rowlines", $.trim()),
...
k0({
  ...
  handler(r, e) {
    ...
    return G0(r.parser, l, Ot(r.envName));
  },
  htmlBuilder: S0,
  mathmlBuilder: z0,
});
k0({
  ...
  handler(r) {
    ...
    var l = G0(r.parser, a, Ot(r.envName)),
...
B({
  ...
  handler(r, e) {
    ...
    for (var l = "", u = 0; u < n.body.length; ++u) l += O(n.body[u], "textord").text;
    if (a === "\\begin") {
      if (!dr.hasOwnProperty(l)) throw new S("No such environment: " + l, n);
      var h = dr[l],
        { args: c, optArgs: p } = t.parseArguments("\\begin{" + l + "}", h),
        g = { mode: t.mode, envName: l, parser: t },
        b = h.handler(g, c, p);
      t.expect("\\end", !1);
      var y = t.nextToken,
        x = O(t.parseFunction(), "environment");
...
var Za = (r, e) => {
    ...
    var p = G(r.denom, l, e),
      ...
      y;
    r.hasBarLine
      ? (r.barSize ? ((b = Z(r.barSize, e)), (g = ee("frac-line", e, b))) : (g = ee("frac-line", e)),
        (b = g.height),
        (y = g.height))
    ...
    if (g) {
      ...
      (x - u.depth - (I + 0.5 * b) < A && (x += A - (x - u.depth - (I + 0.5 * b))),
        I - 0.5 * b - (p.height - T) < A && (T += A - (I - 0.5 * b - (p.height - T))));
      var H = -(I - 0.5 * b);
      C = U({
        positionType: "individualShift",
        children: [
    ...
    var V, L;
    return (
      r.leftDelim == null ? (V = oe(e, ["mopen"])) : (V = wt(r.leftDelim, F, !0, e.havingStyle(t), r.mode, ["mopen"])),
      r.continued
        ? (L = k([]))
        : r.rightDelim == null
          ? (L = oe(e, ["mclose"]))
          : (L = wt(r.rightDelim, F, !0, e.havingStyle(t), r.mode, ["mclose"])),
...
B({
  ...
  handler: (r, e) => {
    ...
    var p = a === "\\cfrac",
      g = null;
    return (
      p || a.startsWith("\\d") ? (g = "display") : a.startsWith("\\t") && (g = "text"),
      c1(
        {
          type: "genfrac",
          mode: t.mode,
...
var pr = ["display", "text", "script", "scriptscript"],
  vr = function (e) {
    var t = null;
...
B({
  ...
  handler(r, e) {
    var { parser: t } = r,
      ...
      n = e[5],
      l = Re(e[0]),
      u = l.type === "atom" && l.family === "open" ? vr(l.text) : null,
      h = Re(e[1]),
      c = h.type === "atom" && h.family === "close" ? vr(h.text) : null,
      p = O(e[2], "size"),
      g,
      b = null;
    ...
    } else ((x = O(x, "textord")), (y = pr[Number(x.text)]));
    return c1(
      {
        type: "genfrac",
        mode: t.mode,
...
B({
  ...
  handler(r, e) {
    ...
    return { type: "infix", mode: t.mode, replaceWith: "\\\\abovefrac", size: O(e[0], "size").value, token: n };
  },
});
B({
  type: "genfrac",
...
var d1 = (r, e) => {
    var t = e.style,
      ...
      n;
    r.type === "supsub"
      ? ((a = r.sup ? G(r.sup, e.havingStyle(t.sup()), e) : G(r.sub, e.havingStyle(t.sub()), e)),
        (n = O(r.base, "horizBrace")))
      : (n = O(r, "horizBrace"));
    var l = G(n.base, e.havingBaseStyle(N.DISPLAY)),
      u = Fe(n, e),
      h;
    if (
      (n.isOver
      ...
      var c = k(["mord", n.isOver ? "mover" : "munder"], [h], e);
      n.isOver
        ? (h = U({
            positionType: "firstBaseline",
            children: [
    ...
    return k(["mord", n.isOver ? "mover" : "munder"], [h], e);
  },
  Ja = (r, e) => {
    var t = Oe(r.label);
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t;
    r.alignment === "clap"
      ? ((t = k([], [G(r.body, e)])), (t = k(["inner"], [t], e)))
      : (t = k(["inner"], [G(r.body, e)]));
    var a = k(["fix"], []),
...
var f1 = (r, e, t, a, n, l, u) => {
    ...
    if (p && c) {
      ...
      y = U({
        ...
        children: [
          ...
          { type: "elem", elem: p.elem, marginLeft: M(l) },
          { type: "kern", size: a.fontMetrics().bigOpSpacing5 },
        ],
      });
    } else if (c) {
  ...
  ae = (r, e) => {
    var t,
      ...
      n = !1,
      l;
    r.type === "supsub" ? ((t = r.sup), (a = r.sub), (l = O(r.base, "op")), (n = !0)) : (l = O(r, "op"));
    var u = e.style,
      h = !1;
    ...
    if (l.symbol) {
      ...
      if (
        ...
        (c = l0(l.name, p, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"])),
        g.length > 0)
      ) {
        var b = c.italic,
          y = Lr(g + "Size" + (h ? "2" : "1"), e);
      ...
      var x = r0(l.body, e, !0);
      x.length === 1 && x[0] instanceof v0 ? ((c = x[0]), (c.classes[0] = "mop")) : (c = k(["mop"], x, e));
    } else {
      for (var A = [], T = 1; T < l.name.length; T++) A.push(Bt(l.name[T], l.mode, e));
      c = k(["mop"], A, e);
    }
    var C = 0,
      q = 0;
    return (
      (c instanceof v0 || l.name === "\\oiint" || l.name === "\\oiiint") &&
        !l.suppressBaseShift &&
        ((C = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight), (q = c.italic || 0)),
      n ? f1(c, t, a, e, u, q, C) : (C && ((c.style.position = "relative"), (c.style.top = M(C))), c)
    );
  },
  ce = (r, e) => {
    var t;
    if (r.symbol) ((t = new z("mo", [g0(r.name, r.mode)])), p1.has(r.name) && t.setAttribute("largeop", "false"));
    else if (r.body) t = new z("mo", f0(r.body, e));
    else {
...
var _a = { "∫": "\\int", "∬": "\\iint", "∭": "\\iiint", "∮": "\\oint", "∯": "\\oiint", "∰": "\\oiiint" };
B({
  type: "op",
  names: [
    "\\arcsin",
...
var v1 = (r, e) => {
    var t,
      ...
      l;
    r.type === "supsub"
      ? ((t = r.sup), (a = r.sub), (l = O(r.base, "operatorname")), (n = !0))
      : (l = O(r, "operatorname"));
    var u;
    if (l.body.length > 0) {
      for (
        var h = l.body.map((b) => {
          ...
          c = r0(h, e.withFont("mathrm"), !0),
          p = 0;
        p < c.length;
        p++
      ) {
        var g = c[p];
        g instanceof v0 && (g.text = g.text.replace(/\u2212/, "-").replace(/\u2217/, "*"));
      }
      u = k(["mop"], c, e);
    } else u = k(["mop"], [], e);
    return n ? f1(u, t, a, e, e.style, 0, 0) : u;
  },
  e4 = (r, e) => {
    ...
    var p = new z("mo", [g0("⁡", "text")]);
    return r.parentIsSupSub ? new z("mrow", [c, p]) : Ur([c, p]);
  };
B({
  type: "operatorname",
...
$0({
  type: "ordgroup",
  htmlBuilder(r, e) {
    return r.semisimple ? q0(r0(r.body, e, !1)) : k(["mord"], r0(r.body, e, !0), e);
  },
  mathmlBuilder(r, e) {
    return P0(r.body, e, !0);
  },
});
B({
  type: "overline",
  ...
  htmlBuilder(r, e) {
    var t = G(r.body, e.havingCrampedStyle()),
      a = ee("overline-line", e),
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t = k(["inner"], [G(r.body, e.withPhantom())]),
      a = k(["fix"], []);
...
B({
  ...
  htmlBuilder(r, e) {
    var t = G(r.body, e),
      a = Z(r.dy, e);
    return U({ positionType: "shift", positionData: -a, children: [{ type: "elem", elem: t }] });
  },
  mathmlBuilder(r, e) {
    var t = new z("mpadded", [Y(r.body, e)]),
...
B({
  ...
  handler(r, e, t) {
    var { parser: a } = r,
      ...
      l = O(e[0], "size"),
      u = O(e[1], "size");
    return { type: "rule", mode: a.mode, shift: n && O(n, "size").value, width: l.value, height: u.value };
  },
  htmlBuilder(r, e) {
    var t = k(["mord", "rule"], [], e),
      a = Z(r.width, e),
...
B({
  ...
  handler: (r, e, t) => {
    var { parser: a } = r,
      n = !1,
      l = !1,
      u = t[0] && O(t[0], "ordgroup");
    if (u)
      for (var h = "", c = 0; c < u.body.length; ++c) {
        var p = u.body[c];
        if (((h = Le(p).text), h === "t")) n = !0;
        else if (h === "b") l = !0;
        else {
          ((n = !1), (l = !1));
          break;
  ...
  htmlBuilder: (r, e) => {
    ...
    var n = U({ positionType: "firstBaseline", children: [{ type: "elem", elem: t }] });
    return k(["mord"], [n], e);
  },
  mathmlBuilder: (r, e) => {
    var t = new z("mpadded", [Y(r.body, e)]);
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    var u = n + l / 4,
      ...
      { span: c, ruleWidth: p, advanceWidth: g } = Ga(h, e),
      b = c.height - p;
    ...
    if (r.index) {
      var A = e.havingStyle(N.SCRIPTSCRIPT),
        ...
        q = U({ positionType: "shift", positionData: -C, children: [{ type: "elem", elem: T }] }),
        I = k(["root"], [q]);
...
var r4 = function (e, t) {
  ...
  if (a)
    if (a.type === "op") {
      ...
      if (a.type === "accent") return D0(a.base) ? Et : null;
      if (a.type === "horizBrace") {
        var u = !e.sub;
        return u === a.isOver ? d1 : null;
      } else return null;
    }
  else return null;
};
$0({
  ...
  htmlBuilder(r, e) {
    ...
    if (n) {
      ...
      ((h = G(n, x, e)), y || (g = u.height - (x.fontMetrics().supDrop * x.sizeMultiplier) / e.sizeMultiplier));
    }
    if (l) {
      var A = e.havingStyle(e.style.sub());
      ((c = G(l, A, e)), y || (b = u.depth + (A.fontMetrics().subDrop * A.sizeMultiplier) / e.sizeMultiplier));
    }
    var T;
    ...
    if (c) {
      ...
      (u instanceof v0 || H) && (I = M(-u.italic));
    }
    var F;
    if (h && c) {
      ((g = Math.max(g, T, h.depth + 0.25 * p.xHeight)), (b = Math.max(b, p.sub2)));
      var V = p.defaultRuleThickness,
        L = 4 * V;
      ...
      F = U({ positionType: "individualShift", children: $ });
    } else if (c) {
      b = Math.max(b, p.sub1, c.height - 0.8 * p.xHeight);
      var X = [{ type: "elem", elem: c, marginLeft: I, marginRight: q }];
      F = U({ positionType: "shift", positionData: b, children: X });
    } else if (h)
      ((g = Math.max(g, T, h.depth + 0.25 * p.xHeight)),
        (F = U({ positionType: "shift", positionData: -g, children: [{ type: "elem", elem: h, marginRight: q }] })));
    else throw new Error("supsub must have either sup or sub.");
    var o0 = gt(u, "right") || "mord";
    return k([o0], [u, k(["msupsub"], [F])], e);
  },
  mathmlBuilder(r, e) {
    var t = !1,
      a,
    ...
    if (t) u = a ? "mover" : "munder";
      ...
      if (r.sup) {
        var p = r.base;
        (p && p.type === "op" && p.limits && e.style === N.DISPLAY) ||
        (p && p.type === "operatorname" && p.alwaysHandleSupSub && (e.style === N.DISPLAY || p.limits))
          ? (u = "munderover")
          : (u = "msubsup");
      } else {
        var c = r.base;
...
$0({
  type: "atom",
  htmlBuilder(r, e) {
    return Bt(r.text, r.mode, e, ["m" + r.family]);
  },
  mathmlBuilder(r, e) {
...
var b1 = { mi: "italic", mn: "normal", mtext: "normal" };
$0({
  type: "mathord",
  htmlBuilder(r, e) {
    return He(r, e, "mathord");
  },
  mathmlBuilder(r, e) {
    var t = new z("mi", [g0(r.text, r.mode, e)]),
      a = qt(r, e) || "italic";
    return (a !== b1[t.type] && t.setAttribute("mathvariant", a), t);
  },
});
$0({
  type: "textord",
  htmlBuilder(r, e) {
    return He(r, e, "textord");
  },
  mathmlBuilder(r, e) {
    var t = g0(r.text, r.mode, e),
      a = qt(r, e) || "normal",
      n;
    return (
      r.mode === "text"
        ...
        : /[0-9]/.test(r.text)
          ...
          : r.text === "\\prime"
            ? (n = new z("mo", [t]))
            : (n = new z("mi", [t])),
      a !== b1[n.type] && n.setAttribute("mathvariant", a),
      n
    );
  },
});
var lt = { "\\nobreak": "nobreak", "\\allowbreak": "allowbreak" },
  st = { " ": {}, "\\ ": {}, "~": { className: "nobreak" }, "\\space": {}, "\\nobreakspace": { className: "nobreak" } };
$0({
  type: "spacing",
  htmlBuilder(r, e) {
    if (st.hasOwnProperty(r.text)) {
      var t = st[r.text].className || "";
      if (r.mode === "text") {
        var a = He(r, e, "textord");
        return (a.classes.push(t), a);
      } else return k(["mspace", t], [Bt(r.text, r.mode, e)], e);
    } else {
      if (lt.hasOwnProperty(r.text)) return k(["mspace", lt[r.text]], [], e);
      throw new S('Unknown type of space "' + r.text + '"');
    }
  },
  mathmlBuilder(r, e) {
    var t;
    if (st.hasOwnProperty(r.text)) t = new z("mtext", [new _(" ")]);
    else {
      if (lt.hasOwnProperty(r.text)) return new z("mspace");
      throw new S('Unknown type of space "' + r.text + '"');
    }
    return t;
  },
...
$0({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new z("mtable", [new z("mtr", [xr(), new z("mtd", [P0(r.body, e)]), xr(), new z("mtd", [P0(r.tag, e)])])]);
...
var wr = {
  ...
  Sr = (r, e) => {
    ...
    return e.withTextFontShape(a4[t]);
  };
B({
  type: "text",
  names: [
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    return U({ positionType: "shift", positionData: n, children: [{ type: "elem", elem: t }] });
  },
  mathmlBuilder(r, e) {
    return new z("mpadded", [Y(r.body, e)], ["vcenter"]);
  },
});
B({
  type: "verb",
  ...
  htmlBuilder(r, e) {
    for (var t = zr(r), a = [], n = e.havingStyle(e.style.text()), l = 0; l < t.length; l++) {
      var u = t[l];
      (u === "~" && (u = "\\textasciitilde"), a.push(l0(u, "Typewriter-Regular", r.mode, n, ["mord", "texttt"])));
    }
    return k(["mord", "text"].concat(n.sizingClasses(e)), Hr(a), n);
  },
  mathmlBuilder(r, e) {
    var t = new _(zr(r)),
      a = new z("mtext", [t]);
...
class Mr {
  constructor(e, t) {
    ((this.input = e),
      (this.settings = t),
      (this.tokenRegex = new RegExp(o4, "g")),
      (this.catcodes = { "%": 14, "~": 13 }));
  }
  setCatcode(e, t) {
    this.catcodes[e] = t;
  ...
  lex() {
    ...
    if (t === e.length) return new c0("EOF", new m0(this, t, t));
    var a = this.tokenRegex.exec(e);
    if (a === null || a.index !== t)
      throw new S("Unexpected character: '" + e[t] + "'", new c0(e[t], new m0(this, t, t + 1)));
    var n = a[6] || a[3] || (a[2] ? "\\ " : " ");
...
m("\\renewcommand", (r) => Ft(r, !0, !1, !1));
m("\\providecommand", (r) => Ft(r, !0, !0, !0));
m("\\message", (r) => {
...
m("\\dots", function (r) {
  ...
  return (
    t in Tr ? (e = Tr[t]) : (t.slice(0, 4) === "\\not" || (t in J.math && c4.has(J.math[t].group))) && (e = "\\dotsb"),
    e
  );
});
var Lt = {
...
m("\\dotso", function (r) {
  var e = r.future().text;
  return e in Lt ? "\\ldots\\," : "\\ldots";
});
m("\\dotsc", function (r) {
  var e = r.future().text;
  return e in Lt && e !== "," ? "\\ldots\\," : "\\ldots";
});
m("\\cdots", function (r) {
  var e = r.future().text;
  return e in Lt ? "\\@cdots\\," : "\\@cdots";
});
m("\\dotsb", "\\cdots");
m("\\dotsm", "\\cdots");
m("\\dotsi", "\\!\\cdots");
...
var x1 = M(w0["Main-Regular"][84][1] - 0.7 * w0["Main-Regular"][65][1]);
m(
  "\\LaTeX",
  "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + x1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}"
);
m(
  "\\KaTeX",
  "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + x1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}"
);
...
var k1 = { "^": !0, _: !0, "\\limits": !0, "\\nolimits": !0 };
class d4 {
  constructor(e, t, a) {
    ((this.settings = t),
      (this.expansionCount = 0),
      this.feed(e),
      (this.macros = new h4(m4, t.macros)),
      (this.mode = a),
      (this.stack = []));
  }
  feed(e) {
  ...
  _getExpansion(e) {
    ...
    if (typeof n == "string") {
      ...
      for (var h = new Mr(n, this.settings), c = [], p = h.lex(); p.text !== "EOF"; ) (c.push(p), (p = h.lex()));
      c.reverse();
  ...
  isExpandable(e) {
    ...
    return t != null
      ...
      : Y0.hasOwnProperty(e) && !Y0[e].primitive;
  }
}
...
class Xe {
  constructor(e, t) {
    ((this.mode = "math"),
      (this.gullet = new d4(e, t, this.mode)),
      (this.settings = t),
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (Xe.endOfExpression.has(n.text) || (t && n.text === t) || (e && Y0[n.text] && Y0[n.text].infix)) break;
  ...
  handleInfixNodes(e) {
    ...
    if (t !== -1 && a) {
      ...
      (c.length === 1 && c[0].type === "ordgroup" ? (u = c[0]) : (u = { type: "ordgroup", mode: this.mode, body: c }),
        p.length === 1 && p[0].type === "ordgroup" ? (h = p[0]) : (h = { type: "ordgroup", mode: this.mode, body: p }));
      var g;
      return (
  ...
  parseAtom(e) {
    ...
    for (var a, n; ; ) {
      ...
      if (l.text === "\\limits" || l.text === "\\nolimits") {
        ...
        var p = Br.test(l.text),
          g = [];
        for (g.push(new c0(Te[l.text])), this.consume(); ; ) {
          var b = this.fetch().text;
          if (!Te[b] || Br.test(b) !== p) break;
          (g.unshift(new c0(Te[b])), this.consume());
        }
        var y = this.subparse(g);
        p ? (n = { type: "ordgroup", mode: "math", body: y }) : (a = { type: "ordgroup", mode: "math", body: y });
      } else break;
    }
  ...
  parseGroup(e, t) {
    ...
    if (n === "{" || n === "\\begingroup") {
      ...
      ((l = this.parseFunction(t, e) || this.parseSymbol()), l == null && n[0] === "\\" && !k1.hasOwnProperty(n))
    ) {
        ...
        if (!(!u || u.type !== "textord")) {
          if (l === "-" && u.text === "-") {
            ...
            a + 1 < t && h && h.type === "textord" && h.text === "-"
              ? (e.splice(a, 3, { type: "textord", mode: "text", loc: m0.range(n, h), text: "---" }), (t -= 2))
              : (e.splice(a, 2, { type: "textord", mode: "text", loc: m0.range(n, u), text: "--" }), (t -= 1));
          }
          (l === "'" || l === "`") &&
            u.text === l &&
            (e.splice(a, 2, { type: "textord", mode: "text", loc: m0.range(n, u), text: l + l }), (t -= 1));
        }
      }
    }
  }
  parseSymbol() {
    ...
    if (J[this.mode][t]) {
      ...
      (this.settings.strict &&
        ...
        (u = { type: "textord", mode: "text", loc: m0.range(e), text: t }));
    else return null;
    if ((this.consume(), l))
      for (var b = 0; b < l[0].length; b++) {
        var y = l[0][b];
        if (!ut[y]) throw new S("Unknown accent ' " + y + "'", e);
        var x = ut[y][this.mode] || ut[y].text;
        if (!x) throw new S("Accent " + y + " unsupported in " + this.mode + " mode", e);
        u = { type: "accent", mode: this.mode, loc: m0.range(e), label: x, isStretchy: !1, isShifty: !0, base: u };
      }
    return u;
  }
}
Xe.endOfExpression = new Set(["}", "\\endgroup", "\\end", "\\right", "&"]);
var Pt = function (e, t) {
    ...
    if (
      ...
      n = [{ type: "tag", mode: "text", body: n, tag: a.subparse([new c0("\\df@tag")]) }];
    }
    return n;
  },
  S1 = function (e, t, a) {
...
var f4 = function (e, t) {
  ...
  g4 = "0.16.37",
  b4 = { Span: he, Anchor: At, SymbolNode: v0, SvgNode: B0, PathNode: F0, LineNode: ct },
  y4 = {
    version: g4,
    render: S1,
    renderToString: f4,
...
export {
  ...
  v4 as __renderToHTMLTree,
  sa as __setFontMetrics,
  y4 as default,
  S1 as render,
  f4 as renderToString,
  g4 as version,
};
