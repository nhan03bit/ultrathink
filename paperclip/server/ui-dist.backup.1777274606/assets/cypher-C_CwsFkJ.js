var l = function (n) {
  ...
  p = function (n) {
    i = null;
    var e = n.next();
    if (e === '"') return (n.match(/^.*?"/), "string");
    if (e === "'") return (n.match(/^.*?'/), "string");
    if (/[{}\(\),\.;\[\]]/.test(e)) return ((i = e), "punctuation");
    if (e === "/" && n.eat("/")) return (n.skipToEnd(), "comment");
    if (u.test(e)) return (n.eatWhile(u), null);
    if ((n.eatWhile(/[_\w\d]/), n.eat(":"))) return (n.eatWhile(/[\w\d_\-]/), "atom");
    var t = n.current();
    return d.test(t) ? "builtin" : f.test(t) ? "def" : h.test(t) || x.test(t) ? "keyword" : "variable";
  },
  o = function (n, e, t) {
    return (n.context = { prev: n.context, indent: n.indent, col: t, type: e });
  },
  c = function (n) {
  ...
  f = l(["all", "and", "any", "contains", "exists", "has", "in", "none", "not", "or", "single", "xor"]),
  h = l([
    "as",
    "asc",
    "ascending",
...
const g = {
  ...
  indent: function (n, e, t) {
    var a = e && e.charAt(0),
      r = n.context;
    if (/[\]\}]/.test(a)) for (; r && r.type === "pattern"; ) r = r.prev;
    var s = r && a === r.type;
