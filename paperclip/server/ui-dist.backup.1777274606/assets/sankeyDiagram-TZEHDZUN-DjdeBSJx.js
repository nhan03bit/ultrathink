...
import { o as Mt } from "./ordinal-Cboi1Yqb.js";
...
function ct(t, e) {
  let i;
  if (e === void 0) for (const a of t) a != null && (i < a || (i === void 0 && a >= a)) && (i = a);
  else {
    let a = -1;
    for (let h of t) (h = e(h, ++a, t)) != null && (i < h || (i === void 0 && h >= h)) && (i = h);
  }
  return i;
}
function pt(t, e) {
...
function nt(t, e) {
  let i = 0;
  if (e === void 0) for (let a of t) (a = +a) && (i += a);
  else {
    let a = -1;
    for (let h of t) (h = +e(h, ++a, t)) && (i += h);
  }
  return i;
}
function Pt(t) {
...
function yt({ nodes: t }) {
  for (const e of t) {
    let i = e.y0,
      a = i;
    for (const h of e.sourceLinks) ((h.y0 = i + h.width / 2), (i += h.width));
    for (const h of e.targetLinks) ((h.y1 = a + h.width / 2), (a += h.width));
  }
}
function Bt() {
  let t = 0,
  ...
  ((b.update = function (n) {
    ...
    (b.extent = function (n) {
      return arguments.length
        ? ((t = +n[0][0]), (i = +n[1][0]), (e = +n[0][1]), (a = +n[1][1]), b)
        : [
            [t, e],
            [i, a],
          ];
  ...
  function M({ nodes: n, links: f }) {
    for (const [c, r] of n.entries()) ((r.index = c), (r.sourceLinks = []), (r.targetLinks = []));
    const u = new Map(n.map((c, r) => [_(c, r, n), c]));
    for (const [c, r] of f.entries()) {
      r.index = c;
      let { source: k, target: w } = r;
      (typeof k != "object" && (k = r.source = ft(u, k)),
        typeof w != "object" && (w = r.target = ft(u, w)),
        k.sourceLinks.push(r),
        w.targetLinks.push(r));
    }
    if (l != null) for (const { sourceLinks: c, targetLinks: r } of n) (c.sort(l), r.sort(l));
  }
  function T({ nodes: n }) {
    for (const f of n)
  ...
  function N({ nodes: n }) {
    ...
    for (; u.size; ) {
      for (const k of u) {
        k.depth = r;
        for (const { target: w } of k.sourceLinks) c.add(w);
      }
  ...
  function C({ nodes: n }) {
    ...
    for (; u.size; ) {
      for (const k of u) {
        k.height = r;
        for (const { source: w } of k.targetLinks) c.add(w);
      }
      if (++r > f) throw new Error("circular link");
      ((u = c), (c = new Set()));
    }
  ...
  function D({ nodes: n }) {
    ...
    if (o) for (const r of c) r.sort(o);
    return c;
  }
  function R(n) {
    ...
    for (const u of n) {
      ...
      for (const r of u) {
        ...
        for (const k of r.sourceLinks) k.width = k.value * f;
      }
      c = (a - c + m) / (u.length + 1);
  ...
  function S(n) {
    ...
    for (let u = 0; u < y; ++u) {
      const c = Math.pow(0.99, u),
        r = Math.max(1 - c, (u + 1) / y);
      (B(f, c, r), P(f, c, r));
    }
  }
  function P(n, f, u) {
  ...
  function A(n) {
    if (l === void 0) for (const { sourceLinks: f, targetLinks: u } of n) (f.sort(ht), u.sort(ut));
  }
  function $(n, f) {
...
ot.prototype = kt.prototype = {
  ...
  arcTo: function (t, e, i, a, h) {
    ...
    if (this._x1 === null) this._ += "M" + (this._x1 = t) + "," + (this._y1 = e);
      ...
      if (!(Math.abs(l * _ - s * o) > V) || !h) this._ += "L" + (this._x1 = t) + "," + (this._y1 = e);
      else {
        var v = i - d,
          y = a - m,
          b = _ * _ + s * s,
          ...
          T = Math.sqrt(b),
          N = Math.sqrt(x),
          C = h * Math.tan((st - Math.acos((b + x - M) / (2 * T * N))) / 2),
          D = C / N,
          R = C / T;
        (Math.abs(D - 1) > V && (this._ += "L" + (t + D * o) + "," + (e + D * l)),
          (this._ +=
            "A" +
            h +
            "," +
  ...
  arc: function (t, e, i, a, h, d) {
    ...
    (this._x1 === null
      ? (this._ += "M" + s + "," + o)
      : (Math.abs(this._x1 - s) > V || Math.abs(this._y1 - o) > V) && (this._ += "L" + s + "," + o),
      i &&
        (x < 0 && (x = (x % rt) + rt),
        x > Rt
          ? (this._ +=
          ...
          : x > V &&
            (this._ +=
              ...
              l +
              "," +
              (this._x1 = t + i * Math.cos(h)) +
              "," +
              (this._y1 = e + i * Math.sin(h)))));
  },
  rect: function (t, e, i, a) {
    this._ +=
      "M" + (this._x0 = this._x1 = +t) + "," + (this._y0 = this._y1 = +e) + "h" + +i + "v" + +a + "h" + -i + "Z";
  },
  toString: function () {
    return this._;
  },
...
function Yt(t) {
  ...
  function m() {
    ...
    if (
      (d || (d = _ = kt()),
      t(d, +a.apply(this, ((s[0] = o), s)), +h.apply(this, s), +a.apply(this, ((s[0] = l), s)), +h.apply(this, s)),
      _)
    )
...
var at = (function () {
  var t = p(function (_, s, o, l) {
    ...
    h = {
      ...
      performAction: p(function (s, o, l, x, v, y, b) {
        var M = y.length - 1;
        switch (v) {
          case 7:
            const T = x.findOrCreateNode(y[M - 4].trim().replaceAll('""', '"')),
              N = x.findOrCreateNode(y[M - 2].trim().replaceAll('""', '"')),
              C = parseFloat(y[M].trim());
            x.addLink(T, N, C);
            break;
          case 8:
          case 9:
      ...
      parse: p(function (s) {
        ...
        typeof P.yy.parseError == "function"
        ...
        function E() {
          ...
          return (
            (L = x.pop() || S.lex() || D),
            typeof L != "number" && (L instanceof Array && ((x = L), (L = x.pop())), (L = o.symbols_[L] || L)),
            L
          );
        }
        p(E, "lex");
        for (var A, $, I, n, f = {}, u, c, r, k; ; ) {
          if (
            ...
            this.defaultActions[$]
              ...
              : ((A === null || typeof A > "u") && (A = E()), (I = b[$] && b[$][A])),
            typeof I > "u" || !I.length || !I[0])
          ) {
            var w = "";
            k = [];
            for (u in b[$]) this.terminals_[u] && u > C && k.push("'" + this.terminals_[u] + "'");
            (S.showPosition
              ? (w =
                  "Parse error on line " +
                  (T + 1) +
...
Expecting ` +
              ...
              : (w =
                  ...
                  (T + 1) +
                  ": Unexpected " +
                  (A == D ? "end of input" : "'" + (this.terminals_[A] || A) + "'")),
              this.parseError(w, {
                text: S.match,
          ...
          switch (I[0]) {
            ...
            case 2:
              if (
                ...
                z && (f._$.range = [y[y.length - (c || 1)].range[0], y[y.length - 1].range[1]]),
                (n = this.performAction.apply(f, [M, N, T, P.yy, I[1], v, y].concat(R))),
                typeof n < "u")
              )
                return n;
              (c && ((l = l.slice(0, -1 * c * 2)), (v = v.slice(0, -1 * c)), (y = y.slice(0, -1 * c))),
                l.push(this.productions_[I[1]][0]),
                v.push(f.$),
                y.push(f._$),
                (r = b[l[l.length - 2]][l[l.length - 1]]),
                l.push(r));
              break;
            case 3:
              return !0;
    ...
    d = (function () {
      var _ = {
        EOF: 1,
        parseError: p(function (o, l) {
          if (this.yy.parser) this.yy.parser.parseError(o, l);
          else throw new Error(o);
        }, "parseError"),
        setInput: p(function (s, o) {
          return (
            (this.yy = o || this.yy || {}),
            (this._input = s),
        ...
        unput: p(function (s) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: l
                ? (l.length === x.length ? this.yylloc.first_column : 0) + x[x.length - l.length].length - l[0].length
                : this.yylloc.first_column - o,
            }),
            this.options.ranges && (this.yylloc.range = [v[0], v[0] + this.yyleng - o]),
...
` +
        ...
        next: p(function () {
          ...
          for (var v = this._currentRules(), y = 0; y < v.length; y++)
            if (((l = this._input.match(this.rules[v[y]])), l && (!o || l[0].length > o[0].length))) {
              if (((o = l), (x = y), this.options.backtrack_lexer)) {
                if (((s = this.test_match(l, v[y])), s !== !1)) return s;
                if (this._backtrack) {
                  o = !1;
                  continue;
                } else return !1;
          ...
          return o
            ? ((s = this.test_match(o, v[x])), s !== !1 ? s : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: p(function (o, l, x, v) {
          switch (x) {
            case 0:
...
var K = at,
  ...
  oe = {
    nodesMap: Z,
    getConfig: p(() => lt().sankey, "getConfig"),
    getNodes: ie,
    getLinks: se,
    getGraph: re,
    addLink: te,
  ...
  gt =
    ...
    (j.count = 0),
    j),
  ae = { left: Ct, right: Ot, center: zt, justify: mt },
  le = p(function (t, e, i, a) {
    const { securityLevel: h, sankey: d } = lt(),
      m = Lt.sankey;
    let _;
    h === "sandbox" && (_ = H("#i" + e));
    const s = h === "sandbox" ? H(_.nodes()[0].contentDocument.body) : H("body"),
      o = h === "sandbox" ? s.select(`[id="${e}"]`) : H(`[id="${e}"]`),
      l = (d == null ? void 0 : d.width) ?? m.width,
      x = (d == null ? void 0 : d.height) ?? m.width,
      v = (d == null ? void 0 : d.useMaxWidth) ?? m.useMaxWidth,
      y = (d == null ? void 0 : d.nodeAlignment) ?? m.nodeAlignment,
      b = (d == null ? void 0 : d.prefix) ?? m.prefix,
      M = (d == null ? void 0 : d.suffix) ?? m.suffix,
      T = (d == null ? void 0 : d.showValues) ?? m.showValues,
      N = a.db.getGraph(),
      C = ae[y];
    Bt()
      .nodeId((g) => g.id)
    ...
    o.append("g")
      ...
      .join("g")
      .attr("class", "node")
      .attr("id", (g) => (g.uid = gt.next("node-")).id)
      ...
      .attr("y", (g) => g.y0)
      .append("rect")
      .attr("height", (g) => g.y1 - g.y0)
      .attr("width", (g) => g.x1 - g.x0)
      .attr("fill", (g) => S(g.id));
    const P = p(
      ({ id: g, value: E }) =>
        T
          ? `${g}
${b}${Math.round(E * 100) / 100}${M}`
          : g,
      "getText"
    );
    o.append("g")
      ...
      .data(N.nodes)
      .join("text")
      .attr("x", (g) => (g.x0 < l / 2 ? g.x1 + 6 : g.x0 - 6))
      .attr("y", (g) => (g.y1 + g.y0) / 2)
      .attr("dy", `${T ? "0" : "0.35"}em`)
      .attr("text-anchor", (g) => (g.x0 < l / 2 ? "start" : "end"))
      .text(P);
    const B = o
        .append("g")
        .attr("class", "links")
      ...
      O = (d == null ? void 0 : d.linkColor) ?? "gradient";
    if (O === "gradient") {
      const g = B.append("linearGradient")
        .attr("id", (E) => (E.uid = gt.next("linearGradient-")).id)
      ...
      (g
        .append("stop")
        .attr("offset", "0%")
        .attr("stop-color", (E) => S(E.source.id)),
        g
          .append("stop")
          .attr("offset", "100%")
          .attr("stop-color", (E) => S(E.target.id)));
    }
    let z;
    switch (O) {
      case "gradient":
        z = p((g) => g.uid, "coloring");
        break;
      case "source":
        z = p((g) => S(g.source.id), "coloring");
        break;
      case "target":
        z = p((g) => S(g.target.id), "coloring");
        break;
      default:
        z = O;
    }
    (B.append("path")
      .attr("d", Kt())
      .attr("stroke", z)
      .attr("stroke-width", (g) => Math.max(1, g.width)),
      Et(void 0, o, 0, v));
  }, "draw"),
  ce = { draw: le },
  ue = p(
...
`
  ...
  ye = K.parse.bind(K);
K.parse = (t) => ye(ue(t));
var ke = { styles: fe, parser: K, db: oe, renderer: ce };
