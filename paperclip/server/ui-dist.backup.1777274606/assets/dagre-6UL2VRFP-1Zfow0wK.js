...
import { G as B } from "./graph-C_2AnXgs.js";
import { l as I } from "./layout-DSmWHSvD.js";
import { i as x } from "./_baseUniq-LizNW1gx.js";
import { c as L } from "./clone-CiBR69il.js";
import { m as A } from "./_basePickBy-DfW1SwLa.js";
...
var f = new Map(),
  ...
  G = X((e, t, n, o) => {
    ...
    (e !== o && c.push(e),
      ...
      c.forEach((a) => {
        if (t.children(a).length > 0) G(a, t, n, o);
        else {
          const r = t.node(a);
          ...
          (i.debug("Copying Edges", u),
            u.forEach((l) => {
              ...
              try {
                se(l, o)
                  ? (i.info("Copying as ", l.v, l.w, v, l.name),
                    n.setEdge(l.v, l.w, v, l.name),
  ...
  R = X((e, t) => {
    ...
    let o = [...n];
    for (const c of n) (J.set(c, e), (o = [...o, ...R(c, t)]));
    return o;
  }, "extractDescendants"),
  ie = X((e, t, n) => {
  ...
  k = X((e) => (!f.has(e) || !f.get(e).externalConnections ? e : f.has(e) ? f.get(e).id : e), "getAnchorId"),
  re = X((e, t) => {
    if (!e || t > 10) {
    ...
    (e.nodes().forEach(function (n) {
      ...
      e.nodes().forEach(function (n) {
        const o = e.children(n),
          c = e.edges();
        o.length > 0
          ? (i.debug("Cluster identified", n, b),
            c.forEach((a) => {
              const r = O(a.v, n),
                u = O(a.w, n);
              r ^ u &&
                (i.warn("Edge: ", a, " leaves cluster ", n),
                i.warn("Descendants of XXX ", n, ": ", b.get(n)),
  ...
  T = X((e, t) => {
    ...
    for (const r of n)
      if (
        ...
        const v = new B({ multigraph: !0, compound: !0 })
          .setGraph({ rankdir: l, nodesep: 50, ranksep: 50, marginx: 8, marginy: 8 })
          .setDefaultEdgeLabel(function () {
            return {};
          });
        (i.warn("Old graph before copy", p(e)),
          G(r, e, v, r),
          e.setNode(r, { clusterNode: !0, id: r, clusterData: f.get(r).clusterData, label: f.get(r).label, graph: v }),
          i.warn("New graph after copy node: (", r, ")", p(v)),
          i.debug("Old graph after copy", p(e)));
      } else
        (i.warn(
          "Cluster ** ",
          r,
  ...
  oe = X((e) => M(e, e.children()), "sortNodesByHierarchy"),
  j = X(async (e, t, n, o, c, a) => {
    ...
    const l = u.insert("g").attr("class", "clusters"),
      v = u.insert("g").attr("class", "edgePaths"),
...
Parent cluster`,
        ...
        if ((i.info("(Insert) Node XXX" + d + ": " + JSON.stringify(t.node(d))), s != null && s.clusterNode)) {
          ...
          const N = await j(g, s.graph, n, o, t.node(d), a),
            S = N.elem;
          (z(s, S),
            (s.diff = N.diff || 0),
          ...
          t.children(d).length > 0
            ...
            : (i.trace("Node - the non recursive path XAX", d, g, t.node(d), r),
              await $(g, t.node(d), { config: a, dir: r }));
      })
    ),
      await X(async () => {
      ...
      i.info("Graph before layout:", JSON.stringify(p(t))),
      i.info("############################################# XXX"),
      i.info("###                Layout                 ### XXX"),
      i.info("############################################# XXX"),
      I(t),
      i.info("Graph after layout:", JSON.stringify(p(t))));
    let E = 0,
      { subGraphTitleTotalMargin: y } = q(a);
    return (
      await Promise.all(
        oe(t).map(async function (d) {
          ...
          if (
            ...
            const m = (s == null ? void 0 : s.padding) / 2 || 0,
              N = ((w = s == null ? void 0 : s.labelBBox) == null ? void 0 : w.height) || 0,
              S = N - m || 0;
      ...
      i.warn("Returning from recursive render XAX", u, E),
      { elem: u, diff: E }
    );
  }, "recursiveRender"),
  we = X(async (e, t) => {
    var a, r, u, l, v, C;
    const n = new B({ multigraph: !0, compound: !0 })
        .setGraph({
          rankdir: e.direction,
          nodesep:
          ...
          ranksep:
            ...
            ((C = (v = e.config) == null ? void 0 : v.flowchart) == null ? void 0 : C.rankSpacing) ||
            e.rankSpacing,
          marginx: 8,
          marginy: 8,
        })
      ...
      o = t.select("g");
    (F(o, e.markers, e.type, e.diagramId),
      Y(),
      _(),
      H(),
      te(),
      ...
      e.edges.forEach((g) => {
        if (g.start === g.end) {
          ...
          ((s.label = ""),
            (s.arrowTypeEnd = "none"),
            (s.id = h + "-cyclic-special-1"),
            (w.arrowTypeStart = "none"),
            (w.arrowTypeEnd = "none"),
            (w.id = h + "-cyclic-special-mid"),
            (m.label = ""),
            d.isGroup && ((s.fromCluster = h), (m.toCluster = h)),
            (m.id = h + "-cyclic-special-2"),
            (m.arrowTypeStart = "none"),
            n.setEdge(h, E, s, h + "-cyclic-special-0"),
            n.setEdge(E, y, w, h + "-cyclic-special-1"),
            n.setEdge(y, h, m, h + "-cyc<lic-special-2"));
        } else n.setEdge(g.start, g.end, { ...g }, g.id);
      }),
      i.warn("Graph at first:", JSON.stringify(p(n))),
      re(n),
      i.warn("Graph after XAX:", JSON.stringify(p(n))));
    const c = V();
    await j(o, n, e.type, e.diagramId, void 0, c);
  }, "render");
export { we as render };
