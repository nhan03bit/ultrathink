        ...
        (ae(T) && (T = y[x] = "" + y[x]),
          T == null || T === ""
            ...
            : a.hasElementWithId(T) ||
              ($e("Can not create edge `" + g + "` with nonexistant " + x + " `" + T + "`"), (E = !0)));
      }
      if (E) {
        c();
        continue;
...
function Uy(r) {
  return r.pstyle("background-fill").value !== "solid" || r.pstyle("background-image").strValue !== "none"
    ? !1
