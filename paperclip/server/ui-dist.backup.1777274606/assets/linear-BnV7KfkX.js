import { aU as j, aV as p, aW as w, aX as k, aY as q } from "./mermaid.core-DrAPKfvO.js";
import { i as D } from "./init-Gi6I4Gst.js";
import { e as g, f as F, a as V, b as z } from "./defaultLocale-DX6XiGOO.js";
function M(n, r) {
...
function R(n) {
  let r, t, e;
  n.length !== 2
    ? ((r = M), (t = (o, c) => M(n(o), c)), (e = (o, c) => n(o) - c))
    : ((r = n === M || n === B ? n : I), (t = n), (e = n));
...
function v(n, r, t) {
  const e = (r - n) / Math.max(0, t),
    u = Math.floor(Math.log10(e)),
    f = e / Math.pow(10, u),
    a = f >= O ? 10 : f >= T ? 5 : f >= U ? 2 : 1;
  let o, c, i;
  return (
    u < 0
      ? ((i = Math.pow(10, -u) / a),
...
function Y(n, r) {
  r || (r = []);
  var t = n ? Math.min(r.length, n.length) : 0,
    e = r.slice(),
    u;
  return function (f) {
...
function H(n, r) {
  ...
  for (u in r) u in n ? (t[u] = d(n[u], r[u])) : (e[u] = r[u]);
  return function (f) {
...
function nn(n, r, t) {
  var e = n[0],
    ...
    a = r[1];
  return (
    u < e ? ((e = N(u, e)), (f = t(a, f))) : ((e = N(e, u)), (f = t(f, a))),
    function (o) {
      return f(e(o));
    }
  );
...
function rn(n, r, t) {
  var e = Math.min(n.length, r.length) - 1,
    u = new Array(e),
    f = new Array(e),
    a = -1;
...
function an(n, r, t, e) {
  ...
  switch (((e = F(e ?? ",f")), e.type)) {
    case "s": {
      ...
      return (e.precision == null && !isNaN((f = L(u, a))) && (e.precision = f), V(e, a));
    }
    case "":
    case "e":
    case "g":
    ...
    case "r": {
      e.precision == null &&
        !isNaN((f = Q(u, Math.max(Math.abs(n), Math.abs(r))))) &&
        (e.precision = f - (e.type === "e"));
      break;
    }
    case "f":
    case "%": {
      e.precision == null && !isNaN((f = K(u))) && (e.precision = f - (e.type === "%") * 2);
      break;
    }
  }
  return z(e);
...
function on(n) {
  ...
  return (
    (n.ticks = function (t) {
      var e = r();
      return W(e[0], e[e.length - 1], t ?? 10);
    }),
    ...
    (n.nice = function (t) {
      ...
      for (o < a && ((i = a), (a = o), (o = i), (i = u), (u = f), (f = i)); h-- > 0; ) {
        if (((i = y(a, o, t)), i === c)) return ((e[u] = a), (e[f] = o), r(e));
...
export { en as a, R as b, un as c, fn as l, X as t };
