                  ...
                  {issuePriorityOrder.map((priority) => (
                    ...
                    >
                      <Checkbox
                        ...
                        onCheckedChange={() =>
                          onChange({ priorities: toggleIssueFilterValue(state.priorities, priority) })
                        }
                      />
                  ...
                  {(agents ?? []).map((agent) => (
                    ...
                    >
                      <Checkbox
                        ...
                        onCheckedChange={() =>
                          onChange({ assignees: toggleIssueFilterValue(state.assignees, agent.id) })
                        }
                      />
                      <span className="text-sm">{formatAgentName(agent.name, agent.title)}</span>
                    </label>
                  ))}
                </div>
              </div>
                      ...
                      {selectedCreatorOptions.map((creator) => (
                        <Badge key={creator.id} variant="secondary" className="gap-1 pr-1">
                          ...
                          <button
                            ...
                            onClick={() =>
                              onChange({ creators: state.creators.filter((value) => value !== creator.id) })
                            }
                    ...
                    {projects.map((project) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() =>
                            onChange({ projects: toggleIssueFilterValue(state.projects, project.id) })
                          }
                        />
                    ...
                    {workspaces.map((workspace) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() =>
                            onChange({ workspaces: toggleIssueFilterValue(state.workspaces, workspace.id) })
                          }
                        />
