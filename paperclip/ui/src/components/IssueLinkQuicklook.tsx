...
import { getIssueDetailQueryOptions, ISSUE_DETAIL_STALE_TIME_MS, prefetchIssueDetail } from "@/lib/issueDetailCache";
      ...
      >
        {data ? (
          ...
          <div className="space-y-2">
            ...
            {!isLoading ? <p className="text-xs text-muted-foreground">Unable to load issue preview.</p> : null}
          </div>
        )}
      </PopoverContent>
    </Popover>
