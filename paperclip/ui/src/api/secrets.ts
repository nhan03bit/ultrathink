...
export const secretsApi = {
  ...
  providers: (companyId: string) => api.get<SecretProviderDescriptor[]>(`/companies/${companyId}/secret-providers`),
  create: (
    companyId: string,
    data: {
      name: string;
  ...
  update: (id: string, data: { name?: string; description?: string | null; externalRef?: string | null }) =>
