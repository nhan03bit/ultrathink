...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is usage required by the Zep SDK; warnings come from dynamic class creation and can be safely ignored
    ...
    def add_text_batches(
        ...
        """Add text to graph in batches; returns a list of UUIDs for all episodes"""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to finish processing (by polling the processed status of each episode)"""
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Fetch complete graph data (including detailed information)
