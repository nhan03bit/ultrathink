...
Used to persist project state server-side, avoiding the need to pass large amounts of data
between API calls on the frontend
"""
...
class Project:
    ...
    # Ontology information (populated after API 1 completes)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph information (populated after API 2 completes)
...
class ProjectManager:
    ...
    def _get_project_files_dir(cls, project_id: str) -> str:
        """Get the project files storage directory"""
        return os.path.join(cls._get_project_dir(project_id), 'files')

    @classmethod
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get the path for the project's extracted text"""
